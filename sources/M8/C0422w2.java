...
/* JADX INFO: renamed from: M8.w2, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes4.dex */
public final class C0422w2 implements NavDirections {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final HashMap f3383a;

    public C0422w2(String str, MayaEKYCSelectedDocument mayaEKYCSelectedDocument, boolean z4) {
    ...
    public final String a() {
        return (String) this.f3383a.get("idPage");
    }

    public final boolean b() {
        return ((Boolean) this.f3383a.get("isSelectedFromSecondaryIdScreen")).booleanValue();
    }

    public final MayaEKYCSelectedDocument c() {
        return (MayaEKYCSelectedDocument) this.f3383a.get("selectedDocument");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj == null || C0422w2.class != obj.getClass()) {
            return false;
        }
        C0422w2 c0422w2 = (C0422w2) obj;
        HashMap map = this.f3383a;
        boolean zContainsKey = map.containsKey("idPage");
        HashMap map2 = c0422w2.f3383a;
        if (zContainsKey != map2.containsKey("idPage")) {
            return false;
        }
        if (a() == null ? c0422w2.a() != null : !a().equals(c0422w2.a())) {
            return false;
        }
        if (map.containsKey("selectedDocument") != map2.containsKey("selectedDocument")) {
            return false;
        }
        if (c() == null ? c0422w2.c() == null : c().equals(c0422w2.c())) {
            return map.containsKey("isSelectedFromSecondaryIdScreen") == map2.containsKey("isSelectedFromSecondaryIdScreen") && b() == c0422w2.b();
        }
        return false;
    }
    ...
    public final int getActionId() {
        return R.id.action_maya_kyc_submit_id_fragment_to_maya_kyc_simple_capture_v3_fragment;
    }
    ...
    public final int hashCode() {
        return (((b() ? 1 : 0) + (((((a() != null ? a().hashCode() : 0) + 31) * 31) + (c() != null ? c().hashCode() : 0)) * 31)) * 31) + R.id.action_maya_kyc_submit_id_fragment_to_maya_kyc_simple_capture_v3_fragment;
    }

    public final String toString() {
        return "ActionMayaKycSubmitIdFragmentToMayaKycSimpleCaptureV3Fragment(actionId=2131361996){idPage=" + a() + ", selectedDocument=" + c() + ", isSelectedFromSecondaryIdScreen=" + b() + "}";
    }
}
