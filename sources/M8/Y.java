...
public final class Y implements NavDirections {
    ...
    public Y(int i, int i4, String str, int i6) {
        HashMap map = new HashMap();
        this.f3252a = map;
        androidx.media3.datasource.cache.c.t(2131231472, map, "drawableRes", i, "titleRes");
    ...
    public final int a() {
        return ((Integer) this.f3252a.get("actionRes")).intValue();
    }

    public final int b() {
        return ((Integer) this.f3252a.get("drawableRes")).intValue();
    }

    public final int c() {
        return ((Integer) this.f3252a.get("errorCode")).intValue();
    }

    public final int d() {
        return ((Integer) this.f3252a.get("messageRes")).intValue();
    }

    public final String e() {
        return (String) this.f3252a.get("pageSource");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        Y y7 = (Y) obj;
        HashMap map = this.f3252a;
        boolean zContainsKey = map.containsKey("drawableRes");
        HashMap map2 = y7.f3252a;
        if (zContainsKey != map2.containsKey("drawableRes") || b() != y7.b() || map.containsKey("titleRes") != map2.containsKey("titleRes") || f() != y7.f() || map.containsKey("messageRes") != map2.containsKey("messageRes") || d() != y7.d() || map.containsKey("actionRes") != map2.containsKey("actionRes") || a() != y7.a() || map.containsKey("pageSource") != map2.containsKey("pageSource")) {
            return false;
        }
        if (e() == null ? y7.e() == null : e().equals(y7.e())) {
            return map.containsKey("errorCode") == map2.containsKey("errorCode") && c() == y7.c();
        }
        return false;
    }

    public final int f() {
        return ((Integer) this.f3252a.get("titleRes")).intValue();
    }
