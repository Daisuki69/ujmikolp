...
public final /* synthetic */ class R1 extends kotlin.jvm.internal.i implements qj.n {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final R1 f3219a = new R1(3, C0471o0.class, "inflate", "inflate(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Z)Lcom/paymaya/databinding/MayaFragmentKycSimpleCaptureV2Binding;", 0);
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        View viewInflate = p02.inflate(R.layout.maya_fragment_kyc_simple_capture_v2, viewGroup, false);
        if (zBooleanValue) {
        ...
        if (viewFindChildViewById != null) {
            ...
            ConstraintLayout constraintLayout = (ConstraintLayout) ViewBindings.findChildViewById(viewFindChildViewById, R.id.constraint_layout_take_id_photo);
            if (constraintLayout != null) {
                i4 = R.id.constraint_view_tips_for_capturing;
                ConstraintLayout constraintLayout2 = (ConstraintLayout) ViewBindings.findChildViewById(viewFindChildViewById, R.id.constraint_view_tips_for_capturing);
                                        ...
                                        if (textView != null) {
                                            ...
                                            if (textView2 != null) {
                                                ...
                                                if (textView3 != null) {
                                                    ...
                                                    TextView textView4 = (TextView) ViewBindings.findChildViewById(viewFindChildViewById, R.id.text_view_focusing_label);
                                                    if (textView4 != null) {
                                                        ...
                                                        if (((TextView) ViewBindings.findChildViewById(viewFindChildViewById, R.id.text_view_position_title)) != null) {
                                                            ...
                                                            if (((ConstraintLayout) ViewBindings.findChildViewById(viewFindChildViewById, R.id.toolbar_content_constraint_layout)) != null) {
                                                                ...
                                                                TextView textView5 = (TextView) ViewBindings.findChildViewById(viewFindChildViewById, R.id.toolbar_title_text_view);
                                                                if (textView5 != null) {
                                                                    ...
                                                                    if (viewFindChildViewById3 != null) {
                                                                        N5.E e = new N5.E((ConstraintLayout) viewFindChildViewById, constraintLayout, constraintLayout2, toolbar, previewView, viewFindChildViewById2, textView, textView2, textView3, textView4, textView5, viewFindChildViewById3);
                                                                        ...
                                                                        if (viewFindChildViewById4 != null) {
                                                                            return new C0471o0((FrameLayout) viewInflate, e, N5.D0.a(viewFindChildViewById4));
                                                                        }
                                                                    }
                                                                }
                                                            }
