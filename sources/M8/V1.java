...
public final class V1 implements NavDirections {
    ...
    public final HashMap f3237a;

    public V1(String str, MayaEKYCSelectedDocument mayaEKYCSelectedDocument, boolean z4) {
    ...
    public final String a() {
        return (String) this.f3237a.get("idPage");
    }

    public final boolean b() {
        return ((Boolean) this.f3237a.get("isFromPhilSysUpload")).booleanValue();
    }

    public final boolean c() {
        return ((Boolean) this.f3237a.get("isSelectedFromSecondaryIdScreen")).booleanValue();
    }

    public final MayaEKYCSelectedDocument d() {
        return (MayaEKYCSelectedDocument) this.f3237a.get("selectedDocument");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        V1 v12 = (V1) obj;
        HashMap map = this.f3237a;
        boolean zContainsKey = map.containsKey("idPage");
        HashMap map2 = v12.f3237a;
        if (zContainsKey != map2.containsKey("idPage")) {
            return false;
        }
        if (a() == null ? v12.a() != null : !a().equals(v12.a())) {
            return false;
        }
        if (map.containsKey("selectedDocument") != map2.containsKey("selectedDocument")) {
            return false;
        }
        if (d() == null ? v12.d() == null : d().equals(v12.d())) {
            return map.containsKey("isSelectedFromSecondaryIdScreen") == map2.containsKey("isSelectedFromSecondaryIdScreen") && c() == v12.c() && map.containsKey("isFromPhilSysUpload") == map2.containsKey("isFromPhilSysUpload") && b() == v12.b();
        }
        return false;
    }
    ...
    public final int getActionId() {
        return R.id.action_maya_kyc_simple_capture_v2_fragment_to_maya_kyc_id_review_fragment;
    }
    ...
    public final int hashCode() {
        return (((b() ? 1 : 0) + (((c() ? 1 : 0) + (((((a() != null ? a().hashCode() : 0) + 31) * 31) + (d() != null ? d().hashCode() : 0)) * 31)) * 31)) * 31) + R.id.action_maya_kyc_simple_capture_v2_fragment_to_maya_kyc_id_review_fragment;
    }

    public final String toString() {
        return "ActionMayaKycSimpleCaptureV2FragmentToMayaKycIdReviewFragment(actionId=2131361983){idPage=" + a() + ", selectedDocument=" + d() + ", isSelectedFromSecondaryIdScreen=" + c() + ", isFromPhilSysUpload=" + b() + "}";
    }
}
