...
public abstract /* synthetic */ class Z2 {
    ...
    static {
        int[] iArr = new int[D8.U.values().length];
        try {
            iArr[0] = 1;
        ...
        try {
            iArr2[KycFieldType.MIDDLE_NAME.ordinal()] = 2;
        } catch (NoSuchFieldError unused4) {
        }
        try {
            iArr2[KycFieldType.LAST_NAME.ordinal()] = 3;
        } catch (NoSuchFieldError unused5) {
        }
        try {
            iArr2[KycFieldType.BIRTH_DATE.ordinal()] = 4;
