...
public final class F2 implements NavDirections {
    ...
    public F2(MayaEKYCSelectedDocument mayaEKYCSelectedDocument, boolean z4) {
    ...
    public final String a() {
        return (String) this.f3163a.get("idPage");
    }

    public final boolean b() {
        return ((Boolean) this.f3163a.get("isSelectedFromSecondaryIdScreen")).booleanValue();
    }

    public final MayaEKYCSelectedDocument c() {
        return (MayaEKYCSelectedDocument) this.f3163a.get("selectedDocument");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        F2 f22 = (F2) obj;
        HashMap map = this.f3163a;
        boolean zContainsKey = map.containsKey("idPage");
        HashMap map2 = f22.f3163a;
        if (zContainsKey != map2.containsKey("idPage")) {
            return false;
        }
        if (a() == null ? f22.a() != null : !a().equals(f22.a())) {
            return false;
        }
        if (map.containsKey("selectedDocument") != map2.containsKey("selectedDocument")) {
            return false;
        }
        if (c() == null ? f22.c() == null : c().equals(f22.c())) {
            return map.containsKey("isSelectedFromSecondaryIdScreen") == map2.containsKey("isSelectedFromSecondaryIdScreen") && b() == f22.b();
        }
        return false;
    }
    ...
    public final int getActionId() {
        return R.id.action_maya_kyc_take_id_photo_fragment_to_maya_kyc_simple_capture_fragment;
    }
    ...
    public final int hashCode() {
        return (((b() ? 1 : 0) + (((((a() != null ? a().hashCode() : 0) + 31) * 31) + (c() != null ? c().hashCode() : 0)) * 31)) * 31) + R.id.action_maya_kyc_take_id_photo_fragment_to_maya_kyc_simple_capture_fragment;
    }

    public final String toString() {
        return "ActionMayaKycTakeIdPhotoFragmentToMayaKycSimpleCaptureFragment(actionId=2131362003){idPage=" + a() + ", selectedDocument=" + c() + ", isSelectedFromSecondaryIdScreen=" + b() + "}";
    }
}
