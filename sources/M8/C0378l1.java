...
/* JADX INFO: renamed from: M8.l1, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes4.dex */
public final class C0378l1 implements NavDirections {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final HashMap f3332a;

    public C0378l1(MayaEKYCSelectedDocument mayaEKYCSelectedDocument, boolean z4) {
    ...
    public final String a() {
        return (String) this.f3332a.get("idPage");
    }

    public final boolean b() {
        return ((Boolean) this.f3332a.get("isSelectedFromSecondaryIdScreen")).booleanValue();
    }

    public final MayaEKYCSelectedDocument c() {
        return (MayaEKYCSelectedDocument) this.f3332a.get("selectedDocument");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        HashMap map = this.f3332a;
        boolean zContainsKey = map.containsKey("idPage");
        HashMap map2 = c0378l1.f3332a;
        if (zContainsKey != map2.containsKey("idPage")) {
            return false;
        }
        if (a() == null ? c0378l1.a() != null : !a().equals(c0378l1.a())) {
            return false;
        }
        if (map.containsKey("selectedDocument") != map2.containsKey("selectedDocument")) {
            return false;
        }
        if (c() == null ? c0378l1.c() == null : c().equals(c0378l1.c())) {
            return map.containsKey("isSelectedFromSecondaryIdScreen") == map2.containsKey("isSelectedFromSecondaryIdScreen") && b() == c0378l1.b();
        }
        return false;
    }
