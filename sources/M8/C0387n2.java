...
/* JADX INFO: renamed from: M8.n2, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes4.dex */
public final /* synthetic */ class C0387n2 extends kotlin.jvm.internal.i implements qj.n {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final C0387n2 f3342a = new C0387n2(3, C0476r0.class, "inflate", "inflate(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Z)Lcom/paymaya/databinding/MayaFragmentKycSsneUploadDocumentsBinding;", 0);
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        View viewInflate = p02.inflate(R.layout.maya_fragment_kyc_ssne_upload_documents, viewGroup, false);
        if (zBooleanValue) {
        ...
        if (button != null) {
            ...
            if (button2 != null) {
                ...
                if (((ConstraintLayout) ViewBindings.findChildViewById(viewInflate, R.id.constraint_layout_steps_container)) != null) {
                    i = R.id.image_view_ssne_upload;
                    if (((ImageView) ViewBindings.findChildViewById(viewInflate, R.id.image_view_ssne_upload)) != null) {
                        ...
                        if (kycMayaInfoSection != null) {
                            ...
                            if (((TextView) ViewBindings.findChildViewById(viewInflate, R.id.maya_kyc_first_step_content_text_view)) != null) {
                                i = R.id.maya_kyc_first_step_sub_content_text_view;
                                if (((LinearLayout) ViewBindings.findChildViewById(viewInflate, R.id.maya_kyc_first_step_sub_content_text_view)) != null) {
                                    ...
                                    if (((TextView) ViewBindings.findChildViewById(viewInflate, R.id.maya_kyc_first_step_text_view)) != null) {
                                        ...
                                        if (viewFindChildViewById != null) {
                                            i = R.id.maya_kyc_fourth_step_content_text_view;
                                            if (((TextView) ViewBindings.findChildViewById(viewInflate, R.id.maya_kyc_fourth_step_content_text_view)) != null) {
                                                i = R.id.maya_kyc_fourth_step_text_view;
                                                if (((TextView) ViewBindings.findChildViewById(viewInflate, R.id.maya_kyc_fourth_step_text_view)) != null) {
                                                            ...
                                                            if (viewFindChildViewById2 != null) {
                                                                ...
                                                                if (((TextView) ViewBindings.findChildViewById(viewInflate, R.id.maya_kyc_third_step_content_text_view)) != null) {
                                                                    ...
                                                                    if (((TextView) ViewBindings.findChildViewById(viewInflate, R.id.maya_kyc_third_step_text_view)) != null) {
                                                                        i = R.id.maya_kyc_third_to_fourth_dotted_image_view;
                                                                        View viewFindChildViewById3 = ViewBindings.findChildViewById(viewInflate, R.id.maya_kyc_third_to_fourth_dotted_image_view);
                                                                            ...
                                                                            if (((NestedScrollView) ViewBindings.findChildViewById(viewInflate, R.id.nested_scroll_view_form_container)) != null) {
                                                                                ...
                                                                                if (((TextView) ViewBindings.findChildViewById(viewInflate, R.id.text_view_header)) != null) {
                                                                                    ...
                                                                                    if (((TextView) ViewBindings.findChildViewById(viewInflate, R.id.text_view_next_step_header)) != null) {
                                                                                        i = R.id.text_view_ssne_statement_download_link;
                                                                                        TextView textView = (TextView) ViewBindings.findChildViewById(viewInflate, R.id.text_view_ssne_statement_download_link);
                                                                                        if (textView != null) {
                                                                                            ...
                                                                                            if (((TextView) ViewBindings.findChildViewById(viewInflate, R.id.text_view_sub_header)) != null) {
                                                                                                ...
                                                                                                TextView textView2 = (TextView) ViewBindings.findChildViewById(viewInflate, R.id.text_view_why_needed);
                                                                                                if (textView2 != null) {
                                                                                                    return new C0476r0((ConstraintLayout) viewInflate, button, button2, kycMayaInfoSection, viewFindChildViewById, viewFindChildViewById2, viewFindChildViewById3, textView, textView2);
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
