...
public final class Retrofit {
    ...
    public Retrofit(Call.Factory factory, HttpUrl httpUrl, List<Converter.Factory> list, int i, List<CallAdapter.Factory> list2, int i4, Executor executor, boolean z4) {
    ...
    public CallAdapter<?, ?> nextCallAdapter(CallAdapter.Factory factory, Type type, Annotation[] annotationArr) {
        ...
        if (factory != null) {
            ...
            for (int i4 = 0; i4 < iIndexOf; i4++) {
                sb2.append("\n   * ");
                sb2.append(this.callAdapterFactories.get(i4).getClass().getName());
            }
            sb2.append('\n');
        }
        sb2.append("  Tried:");
    ...
    public <T> Converter<T, RequestBody> nextRequestBodyConverter(Converter.Factory factory, Type type, Annotation[] annotationArr, Annotation[] annotationArr2) {
        ...
        if (factory != null) {
            ...
            for (int i4 = 0; i4 < iIndexOf; i4++) {
                sb2.append("\n   * ");
                sb2.append(this.converterFactories.get(i4).getClass().getName());
            }
            sb2.append('\n');
        }
        sb2.append("  Tried:");
