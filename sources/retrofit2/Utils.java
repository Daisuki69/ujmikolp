...
final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return s.p(new StringBuilder(), Utils.typeToString(this.componentType), "[]");
        }
    }
    ...
    public static Type getParameterUpperBound(int i, ParameterizedType parameterizedType) {
        ...
        StringBuilder sbT = s.t(i, "Index ", " not in range [0,");
    ...
    public static RuntimeException parameterError(Method method, Throwable th2, int i, String str, Object... objArr) {
        return methodError(method, th2, c.l(str, " (", Platform.reflection.describeMethodParameter(method, i), ")"), objArr);
    }
    ...
    public static RuntimeException methodError(Method method, Throwable th2, String str, Object... objArr) {
        StringBuilder sbV = s.v(String.format(str, objArr), "\n    for method ");
        sbV.append(method.getDeclaringClass().getSimpleName());
        sbV.append(".");
        sbV.append(method.getName());
        return new IllegalArgumentException(sbV.toString(), th2);
    }

    public static RuntimeException parameterError(Method method, int i, String str, Object... objArr) {
        return methodError(method, c.l(str, " (", Platform.reflection.describeMethodParameter(method, i), ")"), objArr);
    }
}
