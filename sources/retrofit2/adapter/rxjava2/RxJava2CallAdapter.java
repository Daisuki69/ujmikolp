...
final class RxJava2CallAdapter<R> implements CallAdapter<R, Object> {
    ...
    public RxJava2CallAdapter(Type type, v vVar, boolean z4, boolean z5, boolean z8, boolean z9, boolean z10, boolean z11, boolean z12) {
    ...
    */
    public java.lang.Object adapt(retrofit2.Call<R> r2) {
        ...
        L1a:
            ...
            goto L18
        L24:
            ch.v r2 = r1.scheduler
            if (r2 == 0) goto L2c
            ch.l r0 = r0.subscribeOn(r2)
        L2c:
            boolean r2 = r1.isFlowable
            if (r2 == 0) goto L37
            ch.a r2 = ch.EnumC1102a.f9365a
            ch.f r2 = r0.toFlowable(r2)
            return r2
        L37:
            boolean r2 = r1.isSingle
            if (r2 == 0) goto L40
            ch.w r2 = r0.singleOrError()
            return r2
        L40:
            boolean r2 = r1.isMaybe
            if (r2 == 0) goto L49
            ch.h r2 = r0.singleElement()
            return r2
        L49:
            boolean r2 = r1.isCompletable
            if (r2 == 0) goto L52
            ch.b r2 = r0.ignoreElements()
            return r2
        L52:
            return r0
        */
