...
final class RequestFactory {
    ...
    public static final class Builder {
        ...
        private Headers parseHeaders(String[] strArr, boolean z4) {
        ...
        private ParameterHandler<?> parseParameter(int i, Type type, Annotation[] annotationArr, boolean z4) {
            ...
            if (z4) {
                try {
                    if (Utils.getRawType(type) == InterfaceC1526a.class) {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (annotation instanceof Part) {
                ...
                Headers headersOf = Headers.of("Content-Disposition", s.j("form-data; name=\"", strValue5, "\""), "Content-Transfer-Encoding", part.encoding());
                if (!Iterable.class.isAssignableFrom(rawType8)) {
                    if (!rawType8.isArray()) {
                        if (MultipartBody.Part.class.isAssignableFrom(rawType8)) {
            ...
            for (int i4 = i - 1; i4 >= 0; i4--) {
                ...
                if ((parameterHandler instanceof ParameterHandler.Tag) && ((ParameterHandler.Tag) parameterHandler).cls.equals(clsBoxIfPrimitive2)) {
                    ...
                    sb2.append(clsBoxIfPrimitive2.getName());
                    sb2.append(" is duplicate of ");
                    throw Utils.parameterError(method, i, s.p(sb2, Platform.reflection.describeMethodParameter(this.method, i4), " and would always overwrite its value."), new Object[0]);
                }
            }
    ...
    public Request create(Object obj, Object[] objArr) throws IOException {
        ...
        if (length != parameterHandlerArr.length) {
            throw new IllegalArgumentException(s.o(s.t(length, "Argument count (", ") doesn't match expected count ("), ")", parameterHandlerArr.length));
        }
