...
public final class Invocation {
    ...
    public static <T> Invocation of(Class<T> cls, T t5, Method method, List<?> list) {
        Objects.requireNonNull(cls, "service == null");
        Objects.requireNonNull(t5, "instance == null");
        Objects.requireNonNull(method, "method == null");
        Objects.requireNonNull(list, "arguments == null");
        return new Invocation(cls, t5, method, new ArrayList(list));
    }
