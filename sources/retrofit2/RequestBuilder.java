...
final class RequestBuilder {
    ...
    public RequestBuilder(String str, HttpUrl httpUrl, String str2, Headers headers, MediaType mediaType, boolean z4, boolean z5, boolean z8) {
        this.method = str;
    ...
    private static String canonicalizeForPath(String str, boolean z4) throws EOFException {
        ...
        while (iCharCount < length) {
            ...
            if (iCodePointAt < 32 || iCodePointAt >= 127 || PATH_SEGMENT_ALWAYS_ENCODE_SET.indexOf(iCodePointAt) != -1 || (!z4 && (iCodePointAt == 47 || iCodePointAt == 37))) {
                ...
                canonicalizeForPath(buffer, str, iCharCount, length, z4);
    ...
    public void addHeader(String str, String str2, boolean z4) {
        if (RtspHeaders.CONTENT_TYPE.equalsIgnoreCase(str)) {
            try {
                ...
                throw new IllegalArgumentException(AbstractC1414e.h("Malformed content type: ", str2), e);
            }
        } else if (z4) {
    ...
    public void addPathParam(String str, String str2, boolean z4) throws EOFException {
        ...
        if (PATH_TRAVERSAL.matcher(strReplace).matches()) {
            throw new IllegalArgumentException(AbstractC1414e.h("@Path parameters shouldn't perform path traversal ('.' or '..'): ", str2));
        }
    ...
    private static void canonicalizeForPath(Buffer buffer, String str, int i, int i4, boolean z4) throws EOFException {
        Buffer buffer2 = null;
        while (i < i4) {
