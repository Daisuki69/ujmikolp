...
public interface BufferedSink extends Sink, WritableByteChannel {
    ...
    BufferedSink write(ByteString byteString, int i, int i4) throws IOException;
    ...
    BufferedSink writeString(String str, int i, int i4, Charset charset) throws IOException;
    ...
    BufferedSink writeUtf8(String str, int i, int i4) throws IOException;
