    ...
    public static final class Companion {
        ...
        public final List<Header> http2HeadersList(Request request) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(lowerCase) || (lowerCase.equals(Http2ExchangeCodec.TE) && j.b(headers.value(i), "trailers"))) {
        ...
        public final Response.Builder readHttp2HeadersList(Headers headerBlock, Protocol protocol) throws IOException {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (j.b(strName, Header.RESPONSE_STATUS_UTF8)) {
