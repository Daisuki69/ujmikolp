...
public final class WebSocketWriter implements Closeable, AutoCloseable {
    ...
    public WebSocketWriter(boolean z4, BufferedSink sink, Random random, boolean z5, boolean z8, long j) {
        j.g(sink, "sink");
        j.g(random, "random");
        this.isClient = z4;
        this.sink = sink;
    ...
    public final void writeMessageFrame(int i, ByteString data) throws IOException {
        ...
        if (this.perMessageDeflate && data.size() >= this.minimumDeflateSize) {
            ...
            i4 = i | PsExtractor.AUDIO_STREAM;
        }
        long size = this.messageBuffer.size();
        this.sinkBuffer.writeByte(i4);
        int i6 = this.isClient ? 128 : 0;
        if (size <= 125) {
            this.sinkBuffer.writeByte(i6 | ((int) size));
