...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    public RealInterceptorChain(RealCall call, List<? extends Interceptor> interceptors, int i, Exchange exchange, Request request, int i4, int i6, int i10) {
        j.g(call, "call");
    ...
    public static /* synthetic */ RealInterceptorChain copy$okhttp$default(RealInterceptorChain realInterceptorChain, int i, Exchange exchange, Request request, int i4, int i6, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        if ((i11 & 8) != 0) {
            i4 = realInterceptorChain.connectTimeoutMillis;
        }
        if ((i11 & 16) != 0) {
        ...
        int i12 = i6;
        int i13 = i10;
        return realInterceptorChain.copy$okhttp(i, exchange, request, i4, i12, i13);
    }
    ...
    public final RealInterceptorChain copy$okhttp(int i, Exchange exchange, Request request, int i4, int i6, int i10) {
        j.g(request, "request");
        return new RealInterceptorChain(this.call, this.interceptors, i, exchange, request, i4, i6, i10);
    }
