...
public final class MultipartReader implements Closeable, AutoCloseable {
    ...
    public final class PartSource implements Source, AutoCloseable {
        ...
        public void close() {
            if (j.b(MultipartReader.this.currentPart, this)) {
        ...
        public long read(Buffer sink, long j) {
            ...
            if (!timeout.hasDeadline()) {
                ...
                try {
                    ...
                    long j7 = jCurrentPartBytesRemaining == 0 ? -1L : multipartReader.source.read(sink, jCurrentPartBytesRemaining);
            ...
            try {
                ...
                long j9 = jCurrentPartBytesRemaining2 == j6 ? -1L : multipartReader.source.read(sink, jCurrentPartBytesRemaining2);
                timeout.timeout(jTimeoutNanos, timeUnit);
                if (timeout2.hasDeadline()) {
    ...
    static {
        ...
        afterBoundaryOptions = companion.of(companion2.encodeUtf8("\r\n"), companion2.encodeUtf8("--"), companion2.encodeUtf8(Global.BLANK), companion2.encodeUtf8("\t"));
    }
    ...
    public final long currentPartBytesRemaining(long j) throws IOException {
        ...
        return jIndexOf == -1 ? Math.min(j, (this.source.getBuffer().size() - ((long) this.crlfDashDashBoundary.size())) + 1) : Math.min(j, jIndexOf);
    }
