...
public final class CipherSuite {
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String a8, String b8) {
                j.g(a8, "a");
                j.g(b8, "b");
                int iMin = Math.min(a8.length(), b8.length());
                for (int i = 4; i < iMin; i++) {
                    char cCharAt = a8.charAt(i);
                    char cCharAt2 = b8.charAt(i);
                    if (cCharAt != cCharAt2) {
                        return j.i(cCharAt, cCharAt2) < 0 ? -1 : 1;
                    }
                }
        ...
        TLS_RSA_WITH_SEED_CBC_SHA = companion.init("TLS_RSA_WITH_SEED_CBC_SHA", ServerConfiguration.DEFAULT_MAX_BEACON_SIZE_KB_SAAS);
    ...
    public final String m288deprecated_javaName() {
