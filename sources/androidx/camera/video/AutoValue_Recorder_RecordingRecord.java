...
final class AutoValue_Recorder_RecordingRecord extends Recorder.RecordingRecord {
    ...
    public AutoValue_Recorder_RecordingRecord(OutputOptions outputOptions, @Nullable Executor executor, @Nullable Consumer<VideoRecordEvent> consumer, boolean z4, boolean z5, long j) {
    ...
    public String toString() {
        ...
        return We.s.h(this.getRecordingId, "}", sb2);
    }
}
