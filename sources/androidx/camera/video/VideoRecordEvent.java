...
public abstract class VideoRecordEvent {
    ...
    public static final class Finalize extends VideoRecordEvent {
        ...
        public Finalize(@NonNull OutputOptions outputOptions, @NonNull RecordingStats recordingStats, @NonNull OutputResults outputResults, int i, @Nullable Throwable th2) {
    ...
    @NonNull
    public static Finalize finalizeWithError(@NonNull OutputOptions outputOptions, @NonNull RecordingStats recordingStats, @NonNull OutputResults outputResults, int i, @Nullable Throwable th2) {
