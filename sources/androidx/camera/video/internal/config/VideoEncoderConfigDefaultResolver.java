...
public class VideoEncoderConfigDefaultResolver implements Supplier<VideoEncoderConfig> {
    ...
    private int resolveFrameRate() {
        ...
        Logger.d(TAG, String.format("Default resolved frame rate: %dfps. [Expected operating range: %s]", Integer.valueOf(iIntValue), Objects.equals(this.mExpectedFrameRateRange, range2) ? this.mExpectedFrameRateRange : "<UNSPECIFIED>"));
        return iIntValue;
    }
