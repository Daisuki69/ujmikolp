...
public final class AudioSettingsAudioProfileResolver implements Supplier<AudioSettings> {
    ...
    public AudioSettings get() {
        ...
        if (channelCount == -1) {
            ...
            Logger.d(TAG, androidx.camera.core.impl.a.h("Media spec AUDIO channel count overrides AudioProfile [AudioProfile channel count: ", channels, ", Resolved Channel Count: ", channelCount, "]"));
        }
        ...
        Logger.d(TAG, androidx.camera.core.impl.a.h("Using resolved AUDIO sample rate or nearest supported from AudioProfile: ", iSelectSampleRateOrNearestSupported, "Hz. [AudioProfile sample rate: ", sampleRate2, "Hz]"));
