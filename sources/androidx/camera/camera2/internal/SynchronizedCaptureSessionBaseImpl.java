...
class SynchronizedCaptureSessionBaseImpl extends SynchronizedCaptureSession.StateCallback implements SynchronizedCaptureSession, SynchronizedCaptureSession.Opener {
    ...
    @Nullable
    @GuardedBy("mLock")
    S1.y mOpenCaptureSessionFuture;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ S1.y lambda$startWithDeferrableSurface$1(List list, List list2) throws Exception {
    ...
    public void close() {
        ...
        getExecutor().execute(new r(this, 6));
    }
    ...
    public boolean isCameraCaptureSessionOpen() {
        boolean z4;
        synchronized (this.mLock) {
            z4 = this.mOpenCaptureSessionFuture != null;
        }
        return z4;
    }
    ...
    public void onClosed(@NonNull SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        synchronized (this.mLock) {
            try {
                if (this.mClosed) {
                    ...
                    yVar = this.mOpenCaptureSessionFuture;
                }
            } catch (Throwable th2) {
                throw th2;
            }
        ...
        finishClose();
        if (yVar != null) {
            yVar.addListener(new V(this, synchronizedCaptureSession, 1), CameraXExecutors.directExecutor());
        }
    }
    ...
    public void onSessionFinished(@NonNull SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        if (yVar != null) {
            yVar.addListener(new V(this, synchronizedCaptureSession, 0), CameraXExecutors.directExecutor());
        }
    }
    ...
    @Override // androidx.camera.camera2.internal.SynchronizedCaptureSession.Opener
    @NonNull
    public S1.y openCaptureSession(@NonNull CameraDevice cameraDevice, @NonNull final SessionConfigurationCompat sessionConfigurationCompat, @NonNull final List<DeferrableSurface> list) {
        synchronized (this.mLock) {
            try {
                ...
                S1.y future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.W
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return this.f7398a.lambda$openCaptureSession$0(list, cameraDeviceCompat, sessionConfigurationCompat, completer);
                    }
                });
    ...
    public S1.y startWithDeferrableSurface(@NonNull List<DeferrableSurface> list, long j) {
        synchronized (this.mLock) {
            try {
                ...
                FutureChain futureChainTransformAsync = FutureChain.from(DeferrableSurfaces.surfaceListWithTimeout(list, false, j, getExecutor(), this.mScheduledExecutorService)).transformAsync(new C0732o(2, this, list), getExecutor());
    ...
    public boolean stop() {
        ...
        try {
            synchronized (this.mLock) {
                try {
                    if (!this.mOpenerDisabled) {
                        S1.y yVar = this.mStartingSurface;
                        yVar = yVar != null ? yVar : null;
                        this.mOpenerDisabled = true;
                    }
                    z4 = !isCameraCaptureSessionOpen();
                } finally {
                }
            }
            return z4;
