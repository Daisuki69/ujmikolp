...
public class Camera2CameraCoordinator implements CameraCoordinator {
    ...
    private static CameraSelector createCameraSelectorById(@NonNull CameraManagerCompat cameraManagerCompat, @NonNull String str) {
        CameraSelector.Builder builderAddCameraFilter = new CameraSelector.Builder().addCameraFilter(new g(str, 1));
        try {
    ...
    public static /* synthetic */ List lambda$createCameraSelectorById$0(String str, List list) {
        ...
        throw new IllegalArgumentException(AbstractC1414e.h("No camera can be find for id: ", str));
    }
        ...
        while (it.hasNext()) {
            ...
            if (arrayList.size() >= 2) {
                ...
                try {
                    ...
                    Logger.d(TAG, s.l("Concurrent camera id pair: (", str, ", ", str2, ") is not backward compatible"));
                }
            }
        }
    }
