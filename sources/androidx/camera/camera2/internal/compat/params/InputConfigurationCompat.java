...
public final class InputConfigurationCompat {
    ...
    public static final class InputConfigurationCompatApi31Impl extends InputConfigurationCompatApi23Impl {
        ...
        public InputConfigurationCompatApi31Impl(int i, int i4, int i6) {
            super(i, i4, i6);
        }
    }
    ...
    public static final class InputConfigurationCompatBaseImpl implements InputConfigurationCompatImpl {
        ...
        public InputConfigurationCompatBaseImpl(int i, int i4, int i6) {
            this.mWidth = i;
            this.mHeight = i4;
            this.mFormat = i6;
        }
        ...
        public int hashCode() {
            ...
            int i4 = this.mHeight ^ ((i << 5) - i);
            return this.mFormat ^ ((i4 << 5) - i4);
        }
    ...
    public InputConfigurationCompat(int i, int i4, int i6) {
        if (Build.VERSION.SDK_INT >= 31) {
            this.mImpl = new InputConfigurationCompatApi31Impl(i, i4, i6);
        } else {
            this.mImpl = new InputConfigurationCompatApi23Impl(i, i4, i6);
        }
    }
    ...
    public static class InputConfigurationCompatApi23Impl implements InputConfigurationCompatImpl {
        ...
        public InputConfigurationCompatApi23Impl(int i, int i4, int i6) {
            this(new InputConfiguration(i, i4, i6));
        }
    }
