...
public interface SynchronizedCaptureSession {
    ...
    public interface Opener {
        ...
        @NonNull
        S1.y openCaptureSession(@NonNull CameraDevice cameraDevice, @NonNull SessionConfigurationCompat sessionConfigurationCompat, @NonNull List<DeferrableSurface> list);

        @NonNull
        S1.y startWithDeferrableSurface(@NonNull List<DeferrableSurface> list, long j);
