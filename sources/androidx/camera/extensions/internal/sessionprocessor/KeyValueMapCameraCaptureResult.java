...
class KeyValueMapCameraCaptureResult implements CameraCaptureResult {
    ...
    public KeyValueMapCameraCaptureResult(long j, @NonNull TagBundle tagBundle, @NonNull Map<CaptureResult.Key, Object> map) {
        this.mKeyValues = map;
    ...
    public void populateExifData(@NonNull ExifData.Builder builder) {
        ...
        Long l6 = (Long) this.mKeyValues.get(CaptureResult.SENSOR_EXPOSURE_TIME);
        if (l6 != null) {
        ...
        Float f3 = (Float) this.mKeyValues.get(CaptureResult.LENS_FOCAL_LENGTH);
        if (f3 != null) {
