...
class CaptureResultImageMatcher {
    ...
    private <T> void addToList(LongSparseArray<List<T>> longSparseArray, long j, T t5) {
    ...
    private <T> void removeFromList(LongSparseArray<List<T>> longSparseArray, long j, T t5) {
