...
final class AutoValue_TakePictureRequest extends TakePictureRequest {
    ...
    public String toString() {
        ...
        sb2.append(this.appExecutor);
        sb2.append(", inMemoryCallback=");
        sb2.append(this.inMemoryCallback);
        sb2.append(", onDiskCallback=");
        sb2.append(this.onDiskCallback);
        sb2.append(", outputFileOptions=");
        sb2.append(this.outputFileOptions);
        sb2.append(", cropRect=");
        sb2.append(this.cropRect);
        sb2.append(", sensorToBufferTransform=");
        sb2.append(this.sensorToBufferTransform);
        sb2.append(", rotationDegrees=");
        sb2.append(this.rotationDegrees);
        sb2.append(", jpegQuality=");
        sb2.append(this.jpegQuality);
        sb2.append(", captureMode=");
        sb2.append(this.captureMode);
        sb2.append(", sessionConfigCameraCaptureCallbacks=");
        return s.r(sb2, this.sessionConfigCameraCaptureCallbacks, "}");
    }
}
