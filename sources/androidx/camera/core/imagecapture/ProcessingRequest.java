...
class ProcessingRequest {
    ...
    public ProcessingRequest(@NonNull CaptureBundle captureBundle, @Nullable ImageCapture.OutputFileOptions outputFileOptions, @NonNull Rect rect, int i, int i4, @NonNull Matrix matrix, @NonNull TakePictureCallback takePictureCallback, @NonNull y yVar) {
        this(captureBundle, outputFileOptions, rect, i, i4, matrix, takePictureCallback, yVar, 0);
    }
    ...
    public ProcessingRequest(@NonNull CaptureBundle captureBundle, @Nullable ImageCapture.OutputFileOptions outputFileOptions, @NonNull Rect rect, int i, int i4, @NonNull Matrix matrix, @NonNull TakePictureCallback takePictureCallback, @NonNull y yVar, int i6) {
