...
final class AutoValue_CaptureNode_In extends CaptureNode.In {
    ...
    public AutoValue_CaptureNode_In(Size size, int i, int i4, boolean z4, @Nullable ImageReaderProxyProvider imageReaderProxyProvider, @Nullable Size size2, int i6, Edge<ProcessingRequest> edge, Edge<TakePictureManager.CaptureError> edge2) {
        if (size == null) {
