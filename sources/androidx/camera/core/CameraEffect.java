...
public abstract class CameraEffect {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public CameraEffect(int i, int i4, @NonNull Executor executor, @NonNull SurfaceProcessor surfaceProcessor, @NonNull Consumer<Throwable> consumer) {
        this(i, 0, i4, executor, surfaceProcessor, consumer);
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public CameraEffect(int i, int i4, int i6, @NonNull Executor executor, @NonNull SurfaceProcessor surfaceProcessor, @NonNull Consumer<Throwable> consumer) {
        TargetUtils.checkSupportedTargets(SURFACE_PROCESSOR_TARGETS, i);
        this.mTargets = i;
        this.mOutputOption = i4;
        this.mTransformation = i6;
        this.mExecutor = executor;
