...
public abstract class Packet<T> {
    ...
    @NonNull
    public static Packet<byte[]> of(@NonNull byte[] bArr, @NonNull Exif exif, int i, @NonNull Size size, @NonNull Rect rect, int i4, @NonNull Matrix matrix, @NonNull CameraCaptureResult cameraCaptureResult) {
        return new AutoValue_Packet(bArr, exif, i, size, rect, i4, matrix, cameraCaptureResult);
    }
}
