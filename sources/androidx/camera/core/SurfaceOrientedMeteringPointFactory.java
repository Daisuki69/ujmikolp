...
public class SurfaceOrientedMeteringPointFactory extends MeteringPointFactory {
    ...
    public SurfaceOrientedMeteringPointFactory(float f, float f3) {
        this.mWidth = f;
        this.mHeight = f3;
    }
    ...
    public PointF convertPoint(float f, float f3) {
        return new PointF(f / this.mWidth, f3 / this.mHeight);
    }

    public SurfaceOrientedMeteringPointFactory(float f, float f3, @NonNull UseCase useCase) {
