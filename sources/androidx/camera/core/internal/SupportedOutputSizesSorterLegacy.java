...
class SupportedOutputSizesSorterLegacy {
    ...
    public SupportedOutputSizesSorterLegacy(@NonNull CameraInfoInternal cameraInfoInternal, @Nullable Rational rational) {
        ...
        this.mIsSensorLandscapeResolution = z4;
    }

    @Nullable
    private static Size flipSizeByRotation(@Nullable Size size, int i, int i4, int i6) {
        return (size == null || !isRotationNeeded(i, i4, i6)) ? size : new Size(size.getHeight(), size.getWidth());
    }
    ...
    private static boolean isRotationNeeded(int i, int i4, int i6) {
        int relativeImageRotation = CameraOrientationUtil.getRelativeImageRotation(CameraOrientationUtil.surfaceRotationToDegrees(i), i6, 1 == i4);
