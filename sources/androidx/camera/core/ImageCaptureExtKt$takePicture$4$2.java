...
public final class ImageCaptureExtKt$takePicture$4$2 extends kotlin.jvm.internal.k implements Function1<Throwable, Unit> {
    final /* synthetic */ kotlin.jvm.internal.y $delegatingCallback;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ImageCaptureExtKt$takePicture$4$2(kotlin.jvm.internal.y yVar) {
        super(1);
