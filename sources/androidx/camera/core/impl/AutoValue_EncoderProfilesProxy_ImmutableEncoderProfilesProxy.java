...
final class AutoValue_EncoderProfilesProxy_ImmutableEncoderProfilesProxy extends EncoderProfilesProxy.ImmutableEncoderProfilesProxy {
    ...
    public AutoValue_EncoderProfilesProxy_ImmutableEncoderProfilesProxy(int i, int i4, List<EncoderProfilesProxy.AudioProfileProxy> list, List<EncoderProfilesProxy.VideoProfileProxy> list2) {
        this.defaultDurationSeconds = i;
        this.recommendedFileFormat = i4;
        if (list == null) {
    ...
    public String toString() {
        ...
        sb2.append(this.defaultDurationSeconds);
        sb2.append(", recommendedFileFormat=");
        sb2.append(this.recommendedFileFormat);
        sb2.append(", audioProfiles=");
        sb2.append(this.audioProfiles);
        sb2.append(", videoProfiles=");
        return We.s.r(sb2, this.videoProfiles, "}");
    }
}
