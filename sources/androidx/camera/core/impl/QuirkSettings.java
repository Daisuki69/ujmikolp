...
public class QuirkSettings {
    ...
    public static class Builder {
        ...
        @NonNull
        public Builder setEnabledWhenDeviceHasQuirk(boolean z4) {
            this.mEnabledWhenDeviceHasQuirk = z4;
            return this;
        }
    }
    ...
    public boolean shouldEnableQuirk(@NonNull Class<? extends Quirk> cls, boolean z4) {
        if (this.mForceEnabledQuirks.contains(cls)) {
            return true;
        }
        return !this.mForceDisabledQuirks.contains(cls) && this.mEnabledWhenDeviceHasQuirk && z4;
    }
    ...
    private QuirkSettings(boolean z4, @Nullable Set<Class<? extends Quirk>> set, @Nullable Set<Class<? extends Quirk>> set2) {
        this.mEnabledWhenDeviceHasQuirk = z4;
