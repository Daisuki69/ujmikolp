...
public class ExifData {
    ...
    public static final class Builder {
        ...
        public Builder setFlashState(@NonNull CameraCaptureMetaData.FlashState flashState) {
            ...
            int i4 = AnonymousClass1.$SwitchMap$androidx$camera$core$impl$CameraCaptureMetaData$FlashState[flashState.ordinal()];
            if (i4 == 1) {
                i = 0;
            } else if (i4 == 2) {
                i = 32;
        ...
        public Builder setOrientationDegrees(int i) {
            ...
            return setAttribute(ExifInterface.TAG_ORIENTATION, String.valueOf(i4));
        }
    ...
    public Map<String, ExifAttribute> getAttributes(int i) {
        Preconditions.checkArgumentInRange(i, 0, EXIF_TAGS.length, s.g(i, "Invalid IFD index: ", ". Index should be between [0, EXIF_TAGS.length] "));
