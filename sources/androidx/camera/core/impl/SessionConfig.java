...
public final class SessionConfig {
    ...
    public static final class ValidatingBuilder extends BaseBuilder {
        ...
        public <T> void addImplementationOption(@NonNull Config.Option<T> option, @NonNull T t5) {
            this.mCaptureConfigBuilder.addImplementationOption(option, t5);
        }
        ...
        public SessionConfig build() {
            ...
            return new SessionConfig(arrayList, new ArrayList(this.mDeviceStateCallbacks), new ArrayList(this.mSessionStateCallbacks), new ArrayList(this.mSingleCameraCaptureCallbacks), this.mCaptureConfigBuilder.build(), !this.mErrorListeners.isEmpty() ? new ErrorListener() { // from class: androidx.camera.core.impl.u
                @Override // androidx.camera.core.impl.SessionConfig.ErrorListener
                public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                    this.f7545a.lambda$build$0(sessionConfig, sessionError);
                }
    ...
    public static int getHigherPriorityTemplateType(int i, int i4) {
        List<Integer> list = SUPPORTED_TEMPLATE_PRIORITY;
        return list.indexOf(Integer.valueOf(i)) >= list.indexOf(Integer.valueOf(i4)) ? i : i4;
    }
