...
public interface RetryPolicy {
    ...
    @NonNull
    public static final RetryPolicy NEVER = new x();

    @NonNull
    public static final RetryPolicy DEFAULT = new CameraProviderInitRetryPolicy.Legacy(y.b());

    @NonNull
    public static final RetryPolicy RETRY_UNAVAILABLE_CAMERA = new CameraProviderInitRetryPolicy(y.b());
    ...
    public static final class RetryConfig {
        ...
        public static final class Builder {
            ...
            @NonNull
            public Builder setRetryDelayInMillis(@IntRange(from = RetryConfig.MINI_DELAY_MILLIS, to = ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS) long j) {
                this.mTimeoutInMillis = j;
                return this;
            }

            @NonNull
            public Builder setShouldRetry(boolean z4) {
                this.mShouldRetry = z4;
                return this;
            }
        }
        ...
        private RetryConfig(boolean z4) {
            this(z4, getDefaultRetryDelayInMillis());
        }

        private RetryConfig(boolean z4, long j) {
            this(z4, j, false);
        }

        private RetryConfig(boolean z4, long j, boolean z5) {
            this.mShouldRetry = z4;
            this.mDelayInMillis = j;
            if (z5) {
                Preconditions.checkArgument(!z4, "shouldRetry must be false when completeWithoutFailure is set to true");
            }
