...
public final class ScreenFlashView extends View {
    ...
    public ValueAnimator animateToFullOpacity(@Nullable final Runnable runnable) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.camera.view.k
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f7732a.lambda$animateToFullOpacity$0(valueAnimator);
            }
        });
        ...
        if (this.mScreenFlashWindow != window) {
            this.mScreenFlash = window == null ? null : new ImageCapture.ScreenFlash() { // from class: androidx.camera.view.ScreenFlashView.1
                ...
                public void apply(long j, @NonNull ImageCapture.ScreenFlashListener screenFlashListener) {
                    ...
                    this.mAnimator = screenFlashView.animateToFullOpacity(new c(screenFlashListener, 2));
                }
    ...
    @UiThread
    public ScreenFlashView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i4) {
