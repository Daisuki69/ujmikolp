...
final class PreviewTransformation {
    ...
    public void overrideWithDisplayRotation(int i, int i4) {
    ...
    public void setTransformationInfo(@NonNull SurfaceRequest.TransformationInfo transformationInfo, Size size, boolean z4) {
        Logger.d(TAG, "Transformation info set: " + transformationInfo + Global.BLANK + size + Global.BLANK + z4);
    ...
    public void transformView(Size size, int i, @NonNull View view) {
        ...
        if (isTransformationInfoReady()) {
            if (view instanceof TextureView) {
                ...
                boolean z4 = false;
                boolean z5 = (!this.mHasCameraTransform || display == null || display.getRotation() == this.mTargetRotation) ? false : true;
