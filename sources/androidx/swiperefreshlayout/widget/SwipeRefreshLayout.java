...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private void moveSpinner(float f) {
        ...
        int i4 = this.mOriginalOffsetTop + ((int) ((f3 * fMin) + (f3 * fPow * 2.0f)));
    ...
    private Animation startAlphaAnimation(final int i, final int i4) {
        Animation animation = new Animation() { // from class: androidx.swiperefreshlayout.widget.SwipeRefreshLayout.4
            ...
            public void applyTransformation(float f, Transformation transformation) {
                SwipeRefreshLayout.this.mProgress.setAlpha((int) (((i4 - r0) * f) + i));
            }
        };
    ...
    */
    public boolean __replaced_14530_2_onInterceptTouchEvent(android.view.MotionEvent r5) {
        /*
            r4 = this;
            r4.ensureTarget()
        ...
        L81:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.swiperefreshlayout.widget.SwipeRefreshLayout.__replaced_14530_2_onInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public boolean dispatchNestedFling(float f, float f3, boolean z4) {
        return this.mNestedScrollingChildHelper.dispatchNestedFling(f, f3, z4);
    }

    @Override // android.view.View, androidx.core.view.NestedScrollingChild
    public boolean dispatchNestedPreFling(float f, float f3) {
        return this.mNestedScrollingChildHelper.dispatchNestedPreFling(f, f3);
    }

    @Override // android.view.View, androidx.core.view.NestedScrollingChild
    public boolean dispatchNestedPreScroll(int i, int i4, int[] iArr, int[] iArr2) {
        return this.mNestedScrollingChildHelper.dispatchNestedPreScroll(i, i4, iArr, iArr2);
    }

    @Override // android.view.View, androidx.core.view.NestedScrollingChild
    public boolean dispatchNestedScroll(int i, int i4, int i6, int i10, int[] iArr) {
        return this.mNestedScrollingChildHelper.dispatchNestedScroll(i, i4, i6, i10, iArr);
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        return __replaced_14530_2_onInterceptTouchEvent(motionEvent);
    }
    ...
    public boolean onNestedFling(View view, float f, float f3, boolean z4) {
        return dispatchNestedFling(f, f3, z4);
    }
        ...
        if (i4 > 0) {
            ...
            if (f > 0.0f) {
                ...
                if (f3 > f) {
                    ...
                    this.mTotalUnconsumed = f - f3;
                    iArr[1] = i4;
                }
                moveSpinner(this.mTotalUnconsumed);
            }
        }
        if (this.mUsingCustomStart && i4 > 0 && this.mTotalUnconsumed == 0.0f && Math.abs(i4 - iArr[1]) > 0) {
            this.mCircleView.setVisibility(8);
        }
    ...
    public void onNestedScroll(View view, int i, int i4, int i6, int i10) {
        dispatchNestedScroll(i, i4, i6, i10, this.mParentOffsetInWindow);
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 1) {
                ...
                if (this.mIsBeingDragged) {
                    float y7 = (motionEvent.getY(iFindPointerIndex) - this.mInitialMotionY) * 0.5f;
                    this.mIsBeingDragged = false;
                    finishSpinner(y7);
                }
            ...
            if (actionMasked == 2) {
                ...
                startDragging(y10);
                if (this.mIsBeingDragged) {
                    float f = (y10 - this.mInitialMotionY) * 0.5f;
                    if (f <= 0.0f) {
                        return false;
                    }
                    moveSpinner(f);
