...
public final class CryptoInfo {
    ...
    public void set(int i, int[] iArr, int[] iArr2, byte[] bArr, byte[] bArr2, int i4, int i6, int i10) {
        ...
        cryptoInfo.mode = i4;
        if (Util.SDK_INT >= 24) {
            ((PatternHolderV24) Assertions.checkNotNull(this.patternHolder)).set(i6, i10);
        }
    }
}
