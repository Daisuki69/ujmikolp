...
final class TrimmingAudioProcessor extends androidx.media3.common.audio.BaseAudioProcessor {
    ...
    public void queueInput(ByteBuffer byteBuffer) {
        ...
        int iConstrainValue2 = Util.constrainValue(length - iConstrainValue, 0, i4);
        byteBuffer.limit(byteBuffer.position() + iConstrainValue2);
        byteBufferReplaceOutputBuffer.put(byteBuffer);
        byteBuffer.limit(iLimit);
        int i6 = i4 - iConstrainValue2;
        int i10 = this.endBufferSize - iConstrainValue;
        this.endBufferSize = i10;
        byte[] bArr = this.endBuffer;
        System.arraycopy(bArr, iConstrainValue, bArr, 0, i10);
