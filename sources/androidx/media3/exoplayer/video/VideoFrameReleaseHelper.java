...
public final class VideoFrameReleaseHelper {
    ...
    private static boolean adjustmentAllowed(long j, long j6) {
        return Math.abs(j - j6) <= MAX_ALLOWED_ADJUSTMENT_NS;
    }
    ...
    private static long closestVsync(long j, long j6, long j7) {
        long j9;
        long j10 = (((j - j6) / j7) * j7) + j6;
        if (j <= j10) {
            j9 = j10 - j7;
        } else {
            j9 = j10;
