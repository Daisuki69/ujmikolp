...
final class ProjectionRenderer {
    ...
    public void draw(int i, float[] fArr, boolean z4) {
        MeshData meshData = z4 ? this.rightMeshData : this.leftMeshData;
        if (meshData == null) {
            return;
        }
        int i4 = this.stereoMode;
        GLES20.glUniformMatrix3fv(this.uTexMatrixHandle, 1, false, i4 == 1 ? z4 ? TEX_MATRIX_BOTTOM : TEX_MATRIX_TOP : i4 == 2 ? z4 ? TEX_MATRIX_RIGHT : TEX_MATRIX_LEFT : TEX_MATRIX_WHOLE, 0);
        ...
        try {
            ...
            Log.e(TAG, "Failed to load position data", e7);
        }
