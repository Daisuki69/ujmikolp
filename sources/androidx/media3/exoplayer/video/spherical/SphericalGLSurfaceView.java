...
public final class SphericalGLSurfaceView extends GLSurfaceView {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture) {
        this.mainHandler.post(new g(3, this, surfaceTexture));
    }
    ...
    private void updateOrientationListenerRegistration() {
        boolean z4 = this.useSensorRotation && this.isStarted;
        Sensor sensor = this.orientationSensor;
        if (sensor == null || z4 == this.isOrientationListenerRegistered) {
            return;
        }
        if (z4) {
        ...
        this.isOrientationListenerRegistered = z4;
    }
    ...
    public void onDetachedFromWindow() {
        ...
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.video.spherical.b
            ...
            public final void run() {
                this.f8140a.lambda$onDetachedFromWindow$0();
            }
        });
    }
