...
final class SceneRenderer implements VideoFrameMetadataListener, CameraMotionListener {
    ...
    private void setProjection(@Nullable byte[] bArr, int i, long j) {
        ...
        if (i4 == i && Arrays.equals(bArr2, this.lastProjectionData)) {
            return;
        }
    ...
    public void drawFrame(float[] fArr, boolean z4) {
        ...
        if (this.frameAvailable.compareAndSet(true, false)) {
            ...
            try {
                ...
                Log.e(TAG, "Failed to draw a frame", e7);
            }
        ...
        this.projectionRenderer.draw(this.textureId, this.tempMatrix, z4);
    }
    ...
    public SurfaceTexture init() {
        ...
        surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: androidx.media3.exoplayer.video.spherical.a
            ...
            public final void onFrameAvailable(SurfaceTexture surfaceTexture2) {
                this.f8139a.lambda$init$0(surfaceTexture2);
            }
        });
    ...
    public void onVideoFrameAboutToBeRendered(long j, long j6, Format format, @Nullable MediaFormat mediaFormat) {
        this.sampleTimestampQueue.add(j6, Long.valueOf(j));
