...
public final class SsMediaSource extends BaseMediaSource implements Loader.Callback<ParsingLoadable<SsManifest>> {
    ...
    private void processManifest() {
        ...
        if (jMax2 == Long.MAX_VALUE) {
            ...
            boolean z4 = ssManifest.isLive;
            singlePeriodTimeline = new SinglePeriodTimeline(j, 0L, 0L, 0L, true, z4, z4, (Object) ssManifest, getMediaItem());
        } else {
            ...
            if (ssManifest2.isLive) {
                ...
                long j7 = jMax2;
                long j9 = jMax - j7;
                long jMsToUs = j9 - Util.msToUs(this.livePresentationDelayMs);
                if (jMsToUs < 5000000) {
                    jMsToUs = Math.min(5000000L, j9 / 2);
                }
                singlePeriodTimeline = new SinglePeriodTimeline(C.TIME_UNSET, j9, j7, jMsToUs, true, true, true, (Object) this.manifest, getMediaItem());
            } else {
                ...
                long j11 = j10;
                singlePeriodTimeline = new SinglePeriodTimeline(jMax2 + j11, j11, jMax2, 0L, true, false, false, (Object) this.manifest, getMediaItem());
            }
        }
    ...
    private void scheduleManifestRefresh() {
        if (this.manifest.isLive) {
            this.manifestRefreshHandler.postDelayed(new l(this, 23), Math.max(0L, (this.manifestLoadStartTimestamp + 5000) - SystemClock.elapsedRealtime()));
        }
    }
    ...
    public void onLoadCanceled(ParsingLoadable<SsManifest> parsingLoadable, long j, long j6, boolean z4) {
    ...
    @Override // androidx.media3.exoplayer.upstream.Loader.Callback
    public void onLoadCompleted(ParsingLoadable<SsManifest> parsingLoadable, long j, long j6) {
        LoadEventInfo loadEventInfo = new LoadEventInfo(parsingLoadable.loadTaskId, parsingLoadable.dataSpec, parsingLoadable.getUri(), parsingLoadable.getResponseHeaders(), j, j6, parsingLoadable.bytesLoaded());
        this.loadErrorHandlingPolicy.onLoadTaskConcluded(parsingLoadable.loadTaskId);
        this.manifestEventDispatcher.loadCompleted(loadEventInfo, parsingLoadable.type);
        this.manifest = parsingLoadable.getResult();
        this.manifestLoadStartTimestamp = j - j6;
        processManifest();
        scheduleManifestRefresh();
    }

    @Override // androidx.media3.exoplayer.upstream.Loader.Callback
    public Loader.LoadErrorAction onLoadError(ParsingLoadable<SsManifest> parsingLoadable, long j, long j6, IOException iOException, int i) {
        LoadEventInfo loadEventInfo = new LoadEventInfo(parsingLoadable.loadTaskId, parsingLoadable.dataSpec, parsingLoadable.getUri(), parsingLoadable.getResponseHeaders(), j, j6, parsingLoadable.bytesLoaded());
