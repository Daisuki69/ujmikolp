...
public final class HlsDownloader extends SegmentDownloader<HlsPlaylist> {
    ...
    public List<SegmentDownloader.Segment> getSegments(DataSource dataSource, HlsPlaylist hlsPlaylist, boolean z4) throws InterruptedException, IOException {
        ...
        for (DataSpec dataSpec : arrayList) {
            ...
            try {
                HlsMediaPlaylist hlsMediaPlaylist = (HlsMediaPlaylist) getManifest(dataSource, dataSpec, z4);
