...
public final class HlsPlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
    ...
    private static boolean checkPlaylistHeader(BufferedReader bufferedReader) throws IOException {
        ...
        for (int i4 = 0; i4 < 7; i4++) {
            if (iSkipIgnorableWhitespace != PLAYLIST_HEADER.charAt(i4)) {
                return false;
            }
  ...
  0x031a: PHI (r13v7 java.lang.String) = (r13v5 java.lang.String), (r13v2 java.lang.String) binds: [B:117:0x0329, B:111:0x030d] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    private static boolean parseOptionalBooleanAttribute(String str, Pattern pattern, boolean z4) {
        Matcher matcher = pattern.matcher(str);
        return matcher.find() ? BOOLEAN_TRUE.equals(matcher.group(1)) : z4;
    }
    ...
    private static HlsMediaPlaylist.ServerControl parseServerControl(String str) {
        ...
        long j = C.TIME_UNSET;
        long j6 = optionalDoubleAttr == -9.223372036854776E18d ? -9223372036854775807L : (long) (optionalDoubleAttr * 1000000.0d);
        ...
        long j7 = optionalDoubleAttr2 == -9.223372036854776E18d ? -9223372036854775807L : (long) (optionalDoubleAttr2 * 1000000.0d);
        ...
        return new HlsMediaPlaylist.ServerControl(j6, optionalBooleanAttribute, j7, j, parseOptionalBooleanAttribute(str, REGEX_CAN_BLOCK_RELOAD, false));
    }
    ...
    private static int skipIgnorableWhitespace(BufferedReader bufferedReader, boolean z4, int i) throws IOException {
        while (i != -1 && Character.isWhitespace(i) && (z4 || !Util.isLinebreak(i))) {
            i = bufferedReader.read();
        }
        return i;
    }
