...
public final class HlsMultivariantPlaylist extends HlsPlaylist {
    ...
    public HlsMultivariantPlaylist(String str, List<String> list, List<Variant> list2, List<Rendition> list3, List<Rendition> list4, List<Rendition> list5, List<Rendition> list6, @Nullable Format format, @Nullable List<Format> list7, boolean z4, Map<String, String> map, List<DrmInitData> list8) {
        super(str, list, z4);
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            while (true) {
                if (i6 < list2.size()) {
                    ...
                    if (streamKey.groupIndex == i && streamKey.streamIndex == i4) {
                        arrayList.add(t5);
                        break;
                    }
                    i6++;
