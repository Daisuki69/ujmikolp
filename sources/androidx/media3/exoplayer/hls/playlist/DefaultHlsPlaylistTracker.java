...
public final class DefaultHlsPlaylistTracker implements HlsPlaylistTracker, Loader.Callback<ParsingLoadable<HlsPlaylist>> {
    ...
    public final class MediaPlaylistBundle implements Loader.Callback<ParsingLoadable<HlsPlaylist>> {
                ...
                if (serverControl.skipUntilUs != C.TIME_UNSET || serverControl.canBlockReload) {
                    ...
                    if (hlsMediaPlaylist2.serverControl.canBlockReload) {
                        ...
                        if (hlsMediaPlaylist3.partTargetDurationUs != C.TIME_UNSET) {
                            ...
                            int size = list.size();
                            if (!list.isEmpty() && ((HlsMediaPlaylist.Part) AbstractC0529x.k(list)).isPreload) {
                                size--;
                            }
            ...
            if (jElapsedRealtime >= this.earliestNextLoadTimeMs) {
                ...
                DefaultHlsPlaylistTracker.this.playlistRefreshHandler.postDelayed(new Runnable() { // from class: androidx.media3.exoplayer.hls.playlist.b
                    ...
                    public final void run() {
                        this.f8027a.lambda$loadPlaylistInternal$0(uri);
                    }
        ...
        public void processLoadedPlaylist(HlsMediaPlaylist hlsMediaPlaylist, LoadEventInfo loadEventInfo) {
            ...
            if (latestPlaylistSnapshot != hlsMediaPlaylist2) {
                ...
                if (playlistStuckException != null) {
                    ...
                    DefaultHlsPlaylistTracker.this.notifyPlaylistError(this.playlistUrl, new LoadErrorHandlingPolicy.LoadErrorInfo(loadEventInfo, new MediaLoadData(4), playlistStuckException, 1), z4);
                }
            }
            HlsMediaPlaylist hlsMediaPlaylist3 = this.playlistSnapshot;
            this.earliestNextLoadTimeMs = (Util.usToMs(!hlsMediaPlaylist3.serverControl.canBlockReload ? hlsMediaPlaylist3 != hlsMediaPlaylist2 ? hlsMediaPlaylist3.targetDurationUs : hlsMediaPlaylist3.targetDurationUs / 2 : 0L) + jElapsedRealtime) - loadEventInfo.loadDurationMs;
        ...
        public void loadPlaylist(boolean z4) {
            loadPlaylistInternal(z4 ? getMediaPlaylistUriForReload() : this.playlistUrl);
        }
        ...
        public void setActiveForPlayback(boolean z4) {
            this.activeForPlayback = z4;
        }

        @Override // androidx.media3.exoplayer.upstream.Loader.Callback
        public void onLoadCanceled(ParsingLoadable<HlsPlaylist> parsingLoadable, long j, long j6, boolean z4) {
        ...
        @Override // androidx.media3.exoplayer.upstream.Loader.Callback
        public void onLoadCompleted(ParsingLoadable<HlsPlaylist> parsingLoadable, long j, long j6) {
        ...
        @Override // androidx.media3.exoplayer.upstream.Loader.Callback
        public Loader.LoadErrorAction onLoadError(ParsingLoadable<HlsPlaylist> parsingLoadable, long j, long j6, IOException iOException, int i) {
            Loader.LoadErrorAction loadErrorActionCreateRetryAction;
            LoadEventInfo loadEventInfo = new LoadEventInfo(parsingLoadable.loadTaskId, parsingLoadable.dataSpec, parsingLoadable.getUri(), parsingLoadable.getResponseHeaders(), j, j6, parsingLoadable.bytesLoaded());
            boolean z4 = iOException instanceof HlsPlaylistParser.DeltaUpdateException;
            if ((parsingLoadable.getUri().getQueryParameter(BLOCK_MSN_PARAM) != null) || z4) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean notifyPlaylistError(Uri uri, LoadErrorHandlingPolicy.LoadErrorInfo loadErrorInfo, boolean z4) {
        Iterator<HlsPlaylistTracker.PlaylistEventListener> it = this.listeners.iterator();
        boolean z5 = false;
        while (it.hasNext()) {
            z5 |= !it.next().onPlaylistError(uri, loadErrorInfo, z4);
        }
        return z5;
    }
    ...
    public void onLoadCompleted(ParsingLoadable<HlsPlaylist> parsingLoadable, long j, long j6) {
        ...
        HlsMultivariantPlaylist hlsMultivariantPlaylistCreateSingleVariantMultivariantPlaylist = z4 ? HlsMultivariantPlaylist.createSingleVariantMultivariantPlaylist(result.baseUri) : (HlsMultivariantPlaylist) result;
    ...
    public Loader.LoadErrorAction onLoadError(ParsingLoadable<HlsPlaylist> parsingLoadable, long j, long j6, IOException iOException, int i) {
        ...
        this.eventDispatcher.loadError(loadEventInfo, parsingLoadable.type, iOException, z4);
        if (z4) {
            this.loadErrorHandlingPolicy.onLoadTaskConcluded(parsingLoadable.loadTaskId);
        }
