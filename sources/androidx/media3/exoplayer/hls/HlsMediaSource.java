...
public final class HlsMediaSource extends BaseMediaSource implements HlsPlaylistTracker.PrimaryPlaylistListener {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public Factory setAllowChunklessPreparation(boolean z4) {
        ...
        public Factory setUseSessionKeys(boolean z4) {
        ...
        public Factory experimentalParseSubtitlesDuringExtraction(boolean z4) {
            this.extractorFactory.experimentalParseSubtitlesDuringExtraction(z4);
            return this;
        }
    ...
    private SinglePeriodTimeline createTimelineForLive(HlsMediaPlaylist hlsMediaPlaylist, long j, long j6, HlsManifest hlsManifest) {
        ...
        long j9 = this.liveConfiguration.targetOffsetMs;
        updateLiveConfiguration(hlsMediaPlaylist, Util.constrainValue(j9 != C.TIME_UNSET ? Util.msToUs(j9) : getTargetLiveOffsetUs(hlsMediaPlaylist, liveEdgeOffsetUs), liveEdgeOffsetUs, hlsMediaPlaylist.durationUs + liveEdgeOffsetUs));
        return new SinglePeriodTimeline(j, j6, C.TIME_UNSET, j7, hlsMediaPlaylist.durationUs, initialStartTimeUs, getLiveWindowDefaultStartPositionUs(hlsMediaPlaylist, liveEdgeOffsetUs), true, !hlsMediaPlaylist.hasEndTag, hlsMediaPlaylist.playlistType == 2 && hlsMediaPlaylist.hasPositiveStartOffset, hlsManifest, getMediaItem(), this.liveConfiguration);
    }
    ...
    */
    private androidx.media3.exoplayer.source.SinglePeriodTimeline createTimelineForOnDemand(androidx.media3.exoplayer.hls.playlist.HlsMediaPlaylist r25, long r26, long r28, androidx.media3.exoplayer.hls.HlsManifest r30) {
        ...
        L31:
            ...
            goto L2b
        L34:
            androidx.media3.exoplayer.source.SinglePeriodTimeline r3 = new androidx.media3.exoplayer.source.SinglePeriodTimeline
    ...
    private static long getTargetLiveOffsetUs(HlsMediaPlaylist hlsMediaPlaylist, long j) {
        ...
        if (j7 != C.TIME_UNSET) {
            ...
            if (j9 == C.TIME_UNSET || hlsMediaPlaylist.partTargetDurationUs == C.TIME_UNSET) {
                long j10 = serverControl.holdBackUs;
                j6 = j10 != C.TIME_UNSET ? j10 : hlsMediaPlaylist.targetDurationUs * 3;
            } else {
                j6 = j9;
            }
        }
    ...
    */
    ...
    private HlsMediaSource(MediaItem mediaItem, HlsDataSourceFactory hlsDataSourceFactory, HlsExtractorFactory hlsExtractorFactory, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory, @Nullable CmcdConfiguration cmcdConfiguration, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, HlsPlaylistTracker hlsPlaylistTracker, long j, boolean z4, int i, boolean z5, long j6) {
        this.mediaItem = mediaItem;
