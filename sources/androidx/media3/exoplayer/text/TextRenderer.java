...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    private void clearOutput() {
        updateOutput(new CueGroup(t0.e, getPresentationTimeUs(this.lastRendererPositionUs)));
    }
    ...
    private void renderFromCuesWithTiming(long j) {
        ...
        if (andDecodeCuesWithTiming) {
            S cuesAtTimeUs = this.cuesResolver.getCuesAtTimeUs(j);
    ...
    @Override // androidx.media3.exoplayer.Renderer
    public void render(long j, long j6) throws DecoderException {
    ...
    public int supportsFormat(Format format) {
        ...
        return MimeTypes.isText(format.sampleMimeType) ? K.c(1) : K.c(0);
    }
