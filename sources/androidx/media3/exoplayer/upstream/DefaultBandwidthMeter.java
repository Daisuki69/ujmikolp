...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    private void maybeNotifyBandwidthSample(int i, long j, long j6) {
        if (i == 0 && j == 0 && j6 == this.lastReportedBitrateEstimate) {
            return;
        }
    ...
    */
    ...
    public static final class Builder {
        ...
        private static Map<Integer, Long> getInitialBitrateEstimatesForCountry(String str) {
            ...
            map.put(0, 1000000L);
            S s9 = DefaultBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_WIFI;
    ...
    private DefaultBandwidthMeter(@Nullable Context context, Map<Integer, Long> map, int i, Clock clock, boolean z4) {
        ...
        networkTypeObserver.register(new f(this, 0));
    }
}
