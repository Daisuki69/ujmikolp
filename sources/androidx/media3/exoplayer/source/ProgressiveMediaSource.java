...
public final class ProgressiveMediaSource extends BaseMediaSource implements ProgressiveMediaPeriod.Listener {
    ...
    public void onSourceInfoRefreshed(long j, boolean z4, boolean z5) {
        if (j == C.TIME_UNSET) {
            j = this.timelineDurationUs;
        }
        if (!this.timelineIsPlaceholder && this.timelineDurationUs == j && this.timelineIsSeekable == z4 && this.timelineIsLive == z5) {
            return;
        }
