...
public abstract class CompositeMediaSource<T> extends BaseMediaSource {
    ...
    public final class ForwardingEventListener implements MediaSourceEventListener, DrmSessionEventListener {
        ...
        public void onLoadError(int i, @Nullable MediaSource.MediaPeriodId mediaPeriodId, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData, IOException iOException, boolean z4) {
            if (maybeUpdateEventDispatcher(i, mediaPeriodId)) {
                this.mediaSourceEventDispatcher.loadError(loadEventInfo, maybeUpdateMediaLoadData(mediaLoadData, mediaPeriodId), iOException, z4);
            }
        }
    ...
    public long getMediaTimeForChildMediaTime(@UnknownNull T t5, long j, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {
        return j;
    }

    public int getWindowIndexForChildWindowIndex(@UnknownNull T t5, int i) {
        return i;
    }
    ...
    public final void prepareChildSource(@UnknownNull final T t5, MediaSource mediaSource) {
        ...
        MediaSource.MediaSourceCaller mediaSourceCaller = new MediaSource.MediaSourceCaller() { // from class: androidx.media3.exoplayer.source.a
            ...
            public final void onSourceInfoRefreshed(MediaSource mediaSource2, Timeline timeline) {
                this.f8074a.lambda$prepareChildSource$0(t5, mediaSource2, timeline);
            }
        };
