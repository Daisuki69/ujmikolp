...
public interface AdsLoader {
    ...
    @UnstableApi
    void handlePrepareComplete(AdsMediaSource adsMediaSource, int i, int i4);

    @UnstableApi
    void handlePrepareError(AdsMediaSource adsMediaSource, int i, int i4, IOException iOException);
