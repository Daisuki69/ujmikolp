...
public class ChunkSampleStream<T extends ChunkSource> implements SampleStream, SequenceableLoader, Loader.Callback<Chunk>, Loader.ReleaseCallback {
    ...
    public ChunkSampleStream(int i, @Nullable int[] iArr, @Nullable Format[] formatArr, T t5, SequenceableLoader.Callback<ChunkSampleStream<T>> callback, Allocator allocator, long j, DrmSessionManager drmSessionManager, DrmSessionEventListener.EventDispatcher eventDispatcher, LoadErrorHandlingPolicy loadErrorHandlingPolicy, MediaSourceEventListener.EventDispatcher eventDispatcher2) {
        ...
        while (i4 < length) {
            ...
            this.embeddedSampleQueues[i4] = sampleQueueCreateWithoutDrm;
            int i10 = i4 + 1;
            sampleQueueArr[i10] = sampleQueueCreateWithoutDrm;
            iArr2[i10] = this.embeddedTrackTypes[i4];
            i4 = i10;
        }
    ...
    private BaseMediaChunk getLastMediaChunk() {
        return (BaseMediaChunk) androidx.camera.core.impl.a.b(1, this.mediaChunks);
    }
    ...
    private int primarySampleIndexToMediaChunkIndex(int i, int i4) {
        do {
            i4++;
            if (i4 >= this.mediaChunks.size()) {
                return this.mediaChunks.size() - 1;
            }
        } while (this.mediaChunks.get(i4).getFirstSampleIndex(0) <= i);
        return i4 - 1;
    }
    ...
    public void discardBuffer(long j, boolean z4) {
        ...
        this.primarySampleQueue.discardTo(j, z4, true);
        ...
        if (firstIndex2 > firstIndex) {
            ...
            while (true) {
                ...
                sampleQueueArr[i].discardTo(firstTimestampUs, z4, this.embeddedTracksSelected[i]);
                i++;
            }
        }
    ...
    public long getBufferedPositionUs() {
        ...
        if (!lastMediaChunk.isLoadCompleted()) {
            lastMediaChunk = this.mediaChunks.size() > 1 ? (BaseMediaChunk) androidx.camera.core.impl.a.b(2, this.mediaChunks) : null;
        }
    ...
    public void seekToUs(long j) throws Throwable {
        ...
        int i = 0;
        for (int i4 = 0; i4 < this.mediaChunks.size(); i4++) {
            baseMediaChunk = this.mediaChunks.get(i4);
            long j6 = baseMediaChunk.startTimeUs;
            if (j6 == j && baseMediaChunk.clippedStartTimeUs == C.TIME_UNSET) {
                break;
            } else {
                if (j6 > j) {
                    break;
    ...
    public Loader.LoadErrorAction onLoadError(Chunk chunk, long j, long j6, IOException iOException, int i) {
        ...
        boolean z4 = (jBytesLoaded != 0 && zIsMediaChunk && haveReadFromMediaChunk(size)) ? false : true;
        ...
        if (!this.chunkSource.onChunkLoadError(chunk, z4, loadErrorInfo, this.loadErrorHandlingPolicy)) {
