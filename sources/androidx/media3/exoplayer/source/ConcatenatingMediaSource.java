...
public final class ConcatenatingMediaSource extends CompositeMediaSource<MediaSourceHolder> {
    ...
    public static final class MessageData<T> {
        ...
        public MessageData(int i, T t5, @Nullable HandlerAndRunnable handlerAndRunnable) {
            this.index = i;
            this.customData = t5;
    ...
    private void correctOffsets(int i, int i4, int i6) {
    ...
    public boolean handleMessage(Message message) {
        switch (message.what) {
            ...
            case 2:
                ...
                for (int i4 = iIntValue - 1; i4 >= i; i4--) {
            ...
            case 3:
                ...
                ShuffleOrder shuffleOrderCloneAndRemove = shuffleOrder.cloneAndRemove(i6, i6 + 1);
    ...
    @GuardedBy("this")
    private void movePublicMediaSource(int i, int i4, @Nullable Handler handler, @Nullable Runnable runnable) {
        Assertions.checkArgument((handler == null) == (runnable == null));
        Handler handler2 = this.playbackThreadHandler;
        List<MediaSourceHolder> list = this.mediaSourcesPublic;
        list.add(i4, list.remove(i));
        if (handler2 != null) {
            handler2.obtainMessage(3, new MessageData(i, Integer.valueOf(i4), createOnCompletionAction(handler, runnable))).sendToTarget();
        } else {
            if (runnable == null || handler == null) {
                return;
            }
    ...
    @GuardedBy("this")
    private void removePublicMediaSources(int i, int i4, @Nullable Handler handler, @Nullable Runnable runnable) {
        Assertions.checkArgument((handler == null) == (runnable == null));
        Handler handler2 = this.playbackThreadHandler;
        Util.removeRange(this.mediaSourcesPublic, i, i4);
        if (handler2 != null) {
            handler2.obtainMessage(2, new MessageData(i, Integer.valueOf(i4), createOnCompletionAction(handler, runnable))).sendToTarget();
        } else {
            if (runnable == null || handler == null) {
                return;
            }
