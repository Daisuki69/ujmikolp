...
public final class ClippingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public ClippingMediaPeriod(MediaPeriod mediaPeriod, boolean z4, long j, long j6) {
        this.mediaPeriod = mediaPeriod;
        this.pendingInitialDiscontinuityPositionUs = z4 ? j : C.TIME_UNSET;
        this.startUs = j;
        this.endUs = j6;
    }
    ...
    private SeekParameters clipSeekParameters(long j, SeekParameters seekParameters) {
        ...
        long j7 = this.endUs;
        long jConstrainValue2 = Util.constrainValue(j6, 0L, j7 == Long.MIN_VALUE ? Long.MAX_VALUE : j7 - j);
    ...
    public long readDiscontinuity() {
        ...
        long j6 = this.endUs;
        Assertions.checkState(j6 == Long.MIN_VALUE || discontinuity2 <= j6);
    ...
    */
    ...
    public void updateClipping(long j, long j6) {
        this.startUs = j;
        this.endUs = j6;
    }
