...
class DefaultDrmSession implements DrmSession {
    ...
    public class RequestHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            try {
                ...
                Log.w(DefaultDrmSession.TAG, "Key/provisioning request produced an unexpected exception. Not retrying.", e7);
                objExecuteProvisionRequest = e7;
            }
        ...
        public void post(int i, Object obj, boolean z4) {
            obtainMessage(i, new RequestTask(LoadEventInfo.getNewId(), z4, SystemClock.elapsedRealtime(), obj)).sendToTarget();
        }
    ...
    public static final class RequestTask {
        ...
        public RequestTask(long j, boolean z4, long j6, Object obj) {
            this.taskId = j;
            this.allowRetry = z4;
            this.startTimeMs = j6;
            this.request = obj;
    ...
    public DefaultDrmSession(UUID uuid, ExoMediaDrm exoMediaDrm, ProvisioningManager provisioningManager, ReferenceCountListener referenceCountListener, @Nullable List<DrmInitData.SchemeData> list, int i, boolean z4, boolean z5, @Nullable byte[] bArr, HashMap<String, String> map, MediaDrmCallback mediaDrmCallback, Looper looper, LoadErrorHandlingPolicy loadErrorHandlingPolicy, PlayerId playerId) {
        if (i == 1 || i == 3) {
    ...
    private void doLicense(boolean z4) {
        ...
        if (i != 0 && i != 1) {
            ...
            postKeyRequest(this.offlineLicenseKeySetId, 3, z4);
            return;
        }
    ...
    private void onError(Throwable th2, int i) {
        this.lastException = new DrmSession.DrmSessionException(th2, DrmUtil.getErrorCodeForMediaDrmException(th2, i));
    ...
    private void onKeysError(Throwable th2, boolean z4) {
    ...
    */
    ...
    private void postKeyRequest(byte[] bArr, int i, boolean z4) {
        try {
            this.currentKeyRequest = this.mediaDrm.getKeyRequest(bArr, this.schemeDatas, i, this.keyRequestParameters);
            ((RequestHandler) Util.castNonNull(this.requestHandler)).post(2, Assertions.checkNotNull(this.currentKeyRequest), z4);
