...
public final class DownloadNotificationHelper {
    ...
    private Notification buildEndStateNotification(Context context, @DrawableRes int i, @Nullable PendingIntent pendingIntent, @Nullable String str, @StringRes int i4) {
        return buildNotification(context, i, pendingIntent, str, i4, 0, 0, false, false, true);
    }

    private Notification buildNotification(Context context, @DrawableRes int i, @Nullable PendingIntent pendingIntent, @Nullable String str, @StringRes int i4, int i6, int i10, boolean z4, boolean z5, boolean z8) {
        ...
        this.notificationBuilder.setProgress(i6, i10, z4);
        this.notificationBuilder.setOngoing(z5);
        this.notificationBuilder.setShowWhen(z8);
        if (Util.SDK_INT >= 31) {
