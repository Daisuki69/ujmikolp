...
public abstract class DownloadService extends Service {
    ...
    public static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void attachService(DownloadService downloadService) {
            ...
            if (this.downloadManager.isInitialized()) {
                Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new j(0, this, downloadService));
            }
        }
        ...
        public void onWaitingForRequirementsChanged(DownloadManager downloadManager, boolean z4) {
            if (z4 || downloadManager.getDownloadsPaused() || !serviceMayNeedRestart()) {
                return;
            }
    ...
    public final class ForegroundNotificationUpdater {
        ...
        public void update() {
            ...
            if (this.periodicUpdatesStarted) {
                ...
                this.handler.postDelayed(new k(this, 0), this.updateInterval);
            }
        }
    ...
    public static Intent buildAddDownloadIntent(Context context, Class<? extends DownloadService> cls, DownloadRequest downloadRequest, boolean z4) {
        return buildAddDownloadIntent(context, cls, downloadRequest, 0, z4);
    }

    public static Intent buildPauseDownloadsIntent(Context context, Class<? extends DownloadService> cls, boolean z4) {
        return getIntent(context, cls, ACTION_PAUSE_DOWNLOADS, z4);
    }

    public static Intent buildRemoveAllDownloadsIntent(Context context, Class<? extends DownloadService> cls, boolean z4) {
        return getIntent(context, cls, ACTION_REMOVE_ALL_DOWNLOADS, z4);
    }

    public static Intent buildRemoveDownloadIntent(Context context, Class<? extends DownloadService> cls, String str, boolean z4) {
        return getIntent(context, cls, ACTION_REMOVE_DOWNLOAD, z4).putExtra(KEY_CONTENT_ID, str);
    }

    public static Intent buildResumeDownloadsIntent(Context context, Class<? extends DownloadService> cls, boolean z4) {
        return getIntent(context, cls, ACTION_RESUME_DOWNLOADS, z4);
    }

    public static Intent buildSetRequirementsIntent(Context context, Class<? extends DownloadService> cls, Requirements requirements, boolean z4) {
        return getIntent(context, cls, ACTION_SET_REQUIREMENTS, z4).putExtra(KEY_REQUIREMENTS, requirements);
    }

    public static Intent buildSetStopReasonIntent(Context context, Class<? extends DownloadService> cls, @Nullable String str, int i, boolean z4) {
        return getIntent(context, cls, ACTION_SET_STOP_REASON, z4).putExtra(KEY_CONTENT_ID, str).putExtra(KEY_STOP_REASON, i);
    }
    ...
    private static Intent getIntent(Context context, Class<? extends DownloadService> cls, String str, boolean z4) {
    ...
    public static void sendSetStopReason(Context context, Class<? extends DownloadService> cls, @Nullable String str, int i, boolean z4) {
        startService(context, buildSetStopReasonIntent(context, cls, str, i, z4), z4);
    }
    ...
    public void onCreate() {
        ...
        if (downloadManagerHelper == null) {
            ...
            Scheduler scheduler = (z4 && (Util.SDK_INT < 31)) ? getScheduler() : null;
            DownloadManager downloadManager = getDownloadManager();
            downloadManager.resumeDownloads();
            DownloadManagerHelper downloadManagerHelper2 = new DownloadManagerHelper(getApplicationContext(), downloadManager, z4, scheduler, cls);
    ...
    public static Intent buildAddDownloadIntent(Context context, Class<? extends DownloadService> cls, DownloadRequest downloadRequest, int i, boolean z4) {
        return getIntent(context, cls, ACTION_ADD_DOWNLOAD, z4).putExtra(KEY_DOWNLOAD_REQUEST, downloadRequest).putExtra(KEY_STOP_REASON, i);
    }
    ...
    public DownloadService(int i, long j, @Nullable String str, @StringRes int i4, @StringRes int i6) {
        if (i == 0) {
    ...
    public static void sendAddDownload(Context context, Class<? extends DownloadService> cls, DownloadRequest downloadRequest, int i, boolean z4) {
        startService(context, buildAddDownloadIntent(context, cls, downloadRequest, i, z4), z4);
    }
}
