...
public final class DownloadManager {
    ...
    public static final class DownloadUpdate {
        ...
        public DownloadUpdate(Download download, boolean z4, List<Download> list, @Nullable Exception exc) {
    ...
    public static class Task extends Thread implements Downloader.ProgressListener {
        ...
        public void onProgress(long j, long j6, float f) {
        ...
        private Task(DownloadRequest downloadRequest, Downloader downloader, DownloadProgress downloadProgress, boolean z4, int i, InternalHandler internalHandler) {
    ...
    public static Download mergeRequest(Download download, DownloadRequest downloadRequest, int i, long j) {
        ...
        long j6 = (i4 == 5 || download.isTerminalState()) ? j : download.startTimeMs;
        int i6 = 7;
        if (i4 != 5 && i4 != 7) {
            i6 = i != 0 ? 1 : 0;
        }
        return new Download(download.request.copyWithMergedRequest(downloadRequest), i6, j6, j, -1L, i, 0);
    }
    ...
    private void onMessageProcessed(int i, int i4) {
    ...
    private void setDownloadsPaused(boolean z4) {
        if (this.downloadsPaused == z4) {
            return;
        }
        this.downloadsPaused = z4;
        this.pendingMessages++;
        this.internalHandler.obtainMessage(2, z4 ? 1 : 0, 0).sendToTarget();
        boolean zUpdateWaitingForRequirements = updateWaitingForRequirements();
        Iterator<Listener> it = this.listeners.iterator();
        while (it.hasNext()) {
    ...
    private boolean updateWaitingForRequirements() {
        ...
        boolean z5 = this.waitingForRequirements != z4;
        this.waitingForRequirements = z4;
        return z5;
    }
    ...
    public DownloadManager(Context context, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory) {
        ...
        Handler handlerCreateHandlerForCurrentOrMainLooper = Util.createHandlerForCurrentOrMainLooper(new f(this, 1));
        ...
        this.internalHandler = internalHandler;
        g gVar = new g(this);
        this.requirementsListener = gVar;
        RequirementsWatcher requirementsWatcher = new RequirementsWatcher(context, gVar, DEFAULT_REQUIREMENTS);
        this.requirementsWatcher = requirementsWatcher;
    ...
    public static final class InternalHandler extends Handler {
        ...
        public InternalHandler(HandlerThread handlerThread, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory, Handler handler, int i, int i4, boolean z4) {
        ...
        private static Download copyDownloadWithState(Download download, int i, int i4) {
        ...
        @Nullable
        private Download getDownload(String str, boolean z4) {
        ...
        private void onTaskStopped(Task task) {
            ...
            if (exc != null) {
                Log.e(DownloadManager.TAG, "Task failed: " + task.request + ", " + z4, exc);
            }
        ...
        private Download putDownload(Download download) {
            ...
            if (downloadIndex == -1) {
                ...
                boolean z4 = download.startTimeMs != this.downloads.get(downloadIndex).startTimeMs;
        ...
        private Download putDownloadWithState(Download download, int i, int i4) {
            Assertions.checkState((i == 3 || i == 4) ? false : true);
            return putDownload(copyDownloadWithState(download, i, i4));
        }
        ...
        private void removeAllDownloads() {
            ...
            for (int i6 = 0; i6 < this.downloads.size(); i6++) {
                this.mainHandler.obtainMessage(3, new DownloadUpdate(this.downloads.get(i6), false, arrayList3, null)).sendToTarget();
            }
            syncTasks();
        }
        ...
        private void setStopReason(@Nullable String str, int i) {
            if (str == null) {
                for (int i4 = 0; i4 < this.downloads.size(); i4++) {
                    setStopReason(this.downloads.get(i4), i);
                }
                try {
                ...
                if (download != null) {
                    ...
                    try {
                        ...
                        Log.e(DownloadManager.TAG, "Failed to set manual stop reason: ".concat(str), e7);
                    }
                }
            }
            syncTasks();
        ...
        private void setStopReason(Download download, int i) {
            if (i == 0) {
                ...
                putDownload(new Download(download.request, i4, download.startTimeMs, System.currentTimeMillis(), download.contentLength, i, 0, download.progress));
            }
        }
    }
}
