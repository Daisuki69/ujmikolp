...
public class DefaultDownloaderFactory implements DownloaderFactory {
    ...
    public DefaultDownloaderFactory(CacheDataSource.Factory factory) {
        this(factory, new androidx.arch.core.executor.a(2));
    }
    ...
    public Downloader createDownloader(DownloadRequest downloadRequest) {
        ...
        throw new IllegalArgumentException(s.f(iInferContentTypeForUriAndMimeType, "Unsupported type: "));
    }
    ...
    private Downloader createDownloader(DownloadRequest downloadRequest, int i) {
        ...
        if (constructor != null) {
            try {
                ...
                throw new IllegalStateException(s.f(i, "Failed to instantiate downloader for content type "), e);
            }
        }
        throw new IllegalStateException(s.f(i, "Module missing for content type "));
    }
}
