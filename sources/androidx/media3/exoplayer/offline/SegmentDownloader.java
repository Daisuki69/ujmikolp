...
public abstract class SegmentDownloader<M extends FilterableManifest<M>> implements Downloader {
    ...
    public static final class ProgressNotifier implements CacheWriter.ProgressListener {
        ...
        public ProgressNotifier(Downloader.ProgressListener progressListener, long j, int i, long j6, int i4) {
        ...
        public void onProgress(long j, long j6, long j7) {
            long j9 = this.bytesDownloaded + j7;
    ...
    private static void mergeSegments(List<Segment> list, CacheKeyFactory cacheKeyFactory, long j) {
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            if (segment2 == null || segment.startTimeUs > segment2.startTimeUs + j || !canMergeSegments(segment2.dataSpec, segment.dataSpec)) {
                ...
                long j6 = segment.dataSpec.length;
                list.set(((Integer) Assertions.checkNotNull(num)).intValue(), new Segment(segment2.startTimeUs, segment2.dataSpec.subrange(0L, j6 != -1 ? segment2.dataSpec.length + j6 : -1L)));
            }
        }
        ...
        try {
            ...
            for (int size2 = segments.size() - 1; size2 >= 0; size2--) {
                ...
                if (j7 == -1) {
                    ...
                    if (jA != -1) {
                        j7 = jA - dataSpec.position;
                    }
                }
                long j9 = j7;
                long cachedBytes = this.cache.getCachedBytes(strBuildCacheKey, dataSpec.position, j9);
                j6 += cachedBytes;
                if (j9 != -1) {
                    if (j9 == cachedBytes) {
                        i++;
            ...
            ProgressNotifier progressNotifier = progressListener != null ? new ProgressNotifier(progressListener, j, size, j6, i) : null;
    ...
    */
    ...
    public final M getManifest(final DataSource dataSource, final DataSpec dataSpec, boolean z4) throws InterruptedException, IOException {
    ...
    public abstract List<Segment> getSegments(DataSource dataSource, M m, boolean z4) throws InterruptedException, IOException;
