...
public interface AnalyticsListener {
    ...
    public static final class EventTime {
        ...
        public EventTime(long j, Timeline timeline, int i, @Nullable MediaSource.MediaPeriodId mediaPeriodId, long j6, Timeline timeline2, int i4, @Nullable MediaSource.MediaPeriodId mediaPeriodId2, long j7, long j9) {
            this.realtimeMs = j;
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (obj != null && EventTime.class == obj.getClass()) {
                ...
                if (this.realtimeMs == eventTime.realtimeMs && this.windowIndex == eventTime.windowIndex && this.eventPlaybackPositionMs == eventTime.eventPlaybackPositionMs && this.currentWindowIndex == eventTime.currentWindowIndex && this.currentPlaybackPositionMs == eventTime.currentPlaybackPositionMs && this.totalBufferedDurationMs == eventTime.totalBufferedDurationMs && of.p.p(this.timeline, eventTime.timeline) && of.p.p(this.mediaPeriodId, eventTime.mediaPeriodId) && of.p.p(this.currentTimeline, eventTime.currentTimeline) && of.p.p(this.currentMediaPeriodId, eventTime.currentMediaPeriodId)) {
                    return true;
                }
            }
            return false;
    ...
    @UnstableApi
    void onAudioDecoderInitialized(EventTime eventTime, String str, long j, long j6);
    ...
    @UnstableApi
    void onAudioUnderrun(EventTime eventTime, int i, long j, long j6);

    @UnstableApi
    void onAvailableCommandsChanged(EventTime eventTime, Player.Commands commands);

    @UnstableApi
    void onBandwidthEstimate(EventTime eventTime, int i, long j, long j6);
    ...
    @UnstableApi
    void onDeviceVolumeChanged(EventTime eventTime, int i, boolean z4);
    ...
    @UnstableApi
    void onIsPlayingChanged(EventTime eventTime, boolean z4);
    ...
    @UnstableApi
    void onLoadError(EventTime eventTime, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData, IOException iOException, boolean z4);
    ...
    @UnstableApi
    void onPlayWhenReadyChanged(EventTime eventTime, boolean z4, int i);
    ...
    @UnstableApi
    @Deprecated
    void onPlayerStateChanged(EventTime eventTime, boolean z4, int i);
    ...
    @UnstableApi
    void onSkipSilenceEnabledChanged(EventTime eventTime, boolean z4);

    @UnstableApi
    void onSurfaceSizeChanged(EventTime eventTime, int i, int i4);
    ...
    @UnstableApi
    void onVideoDecoderInitialized(EventTime eventTime, String str, long j, long j6);
    ...
    @UnstableApi
    @Deprecated
    void onVideoSizeChanged(EventTime eventTime, int i, int i4, int i6, float f);
