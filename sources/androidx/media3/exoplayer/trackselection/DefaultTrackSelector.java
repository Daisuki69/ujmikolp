...
public class DefaultTrackSelector extends MappingTrackSelector implements RendererCapabilities.Listener {
    ...
    private static final s0 FORMAT_VALUE_ORDERING = new D(new b(7));
    ...
    public static final class AudioTrackInfo extends TrackInfo<AudioTrackInfo> implements Comparable<AudioTrackInfo> {
        ...
        public AudioTrackInfo(int i, TrackGroup trackGroup, int i4, Parameters parameters, int i6, boolean z4, j jVar, int i10) {
            int i11;
            int formatLanguageScore;
            int formatLanguageScore2;
            super(i, trackGroup, i4);
            this.parameters = parameters;
            int i12 = parameters.allowAudioNonSeamlessAdaptiveness ? 24 : 16;
            this.allowMixedMimeTypes = parameters.allowAudioMixedMimeTypeAdaptiveness && (i10 & i12) != 0;
            this.language = DefaultTrackSelector.normalizeUndeterminedLanguageToNull(this.format.language);
            this.isWithinRendererCapabilities = K.n(i6, false);
            int i13 = 0;
            while (true) {
                ...
                if (i13 >= parameters.preferredAudioLanguages.size()) {
                    ...
                    formatLanguageScore = DefaultTrackSelector.getFormatLanguageScore(this.format, (String) parameters.preferredAudioLanguages.get(i13), false);
            ...
            this.bitrate = i16;
            this.isWithinConstraints = (i16 == -1 || i16 <= parameters.maxAudioBitrate) && (i15 == -1 || i15 <= parameters.maxAudioChannelCount) && jVar.apply(format);
            ...
            while (true) {
                if (i17 >= systemLanguageCodes.length) {
                    ...
                    formatLanguageScore2 = DefaultTrackSelector.getFormatLanguageScore(this.format, systemLanguageCodes[i17], false);
            ...
            this.usesPrimaryDecoder = K.j(i6) == 128;
            this.usesHardwareAcceleration = K.l(i6) == 64;
            this.selectionEligibility = evaluateSelectionEligibility(i6, z4, i12);
        }
        ...
        public static S createForTrackGroup(int i, TrackGroup trackGroup, Parameters parameters, int[] iArr, boolean z4, j jVar, int i4) {
            O oJ = S.j();
            for (int i6 = 0; i6 < trackGroup.length; i6++) {
                oJ.a(new AudioTrackInfo(i, trackGroup, i6, parameters, iArr[i6], z4, jVar, i4));
            }
            return oJ.g();
        }

        private int evaluateSelectionEligibility(int i, boolean z4, int i4) {
            if (!K.n(i, this.parameters.exceedRendererCapabilitiesIfNecessary)) {
                return 0;
            }
            ...
            if (!K.n(i, false) || !this.isWithinConstraints || this.format.bitrate == -1) {
                return 1;
            }
            ...
            return ((!parameters2.allowMultipleAdaptiveSelections && z4) || parameters2.audioOffloadPreferences.audioOffloadMode == 2 || (i & i4) == 0) ? 1 : 2;
        }
        ...
        public int compareTo(AudioTrackInfo audioTrackInfo) {
            s0 s0VarA = (this.isWithinConstraints && this.isWithinRendererCapabilities) ? DefaultTrackSelector.FORMAT_VALUE_ORDERING : DefaultTrackSelector.FORMAT_VALUE_ORDERING.a();
            G gD = G.f4543a.d(this.isWithinRendererCapabilities, audioTrackInfo.isWithinRendererCapabilities);
            ...
            r0 r0Var = r0.c;
            G gC = gD.c(numValueOf, numValueOf2, r0Var).a(this.preferredLanguageScore, audioTrackInfo.preferredLanguageScore).a(this.preferredRoleFlagsScore, audioTrackInfo.preferredRoleFlagsScore).d(this.isDefaultSelectionFlag, audioTrackInfo.isDefaultSelectionFlag).d(this.hasMainOrNoRoleFlag, audioTrackInfo.hasMainOrNoRoleFlag).c(Integer.valueOf(this.localeLanguageMatchIndex), Integer.valueOf(audioTrackInfo.localeLanguageMatchIndex), r0Var).a(this.localeLanguageScore, audioTrackInfo.localeLanguageScore).d(this.isWithinConstraints, audioTrackInfo.isWithinConstraints).c(Integer.valueOf(this.preferredMimeTypeMatchIndex), Integer.valueOf(audioTrackInfo.preferredMimeTypeMatchIndex), r0Var);
            if (this.parameters.forceLowestBitrate) {
                gC = gC.c(Integer.valueOf(this.bitrate), Integer.valueOf(audioTrackInfo.bitrate), DefaultTrackSelector.FORMAT_VALUE_ORDERING.a());
            }
            G gC2 = gC.d(this.usesPrimaryDecoder, audioTrackInfo.usesPrimaryDecoder).d(this.usesHardwareAcceleration, audioTrackInfo.usesHardwareAcceleration).c(Integer.valueOf(this.channelCount), Integer.valueOf(audioTrackInfo.channelCount), s0VarA).c(Integer.valueOf(this.sampleRate), Integer.valueOf(audioTrackInfo.sampleRate), s0VarA);
            if (Util.areEqual(this.language, audioTrackInfo.language)) {
                gC2 = gC2.c(Integer.valueOf(this.bitrate), Integer.valueOf(audioTrackInfo.bitrate), s0VarA);
            }
            return gC2.f();
        }
        ...
        public boolean isCompatibleForAdaptationWith(AudioTrackInfo audioTrackInfo) {
            ...
            String str;
            int i4;
            if (!this.parameters.allowAudioMixedChannelCountAdaptiveness && ((i4 = this.format.channelCount) == -1 || i4 != audioTrackInfo.format.channelCount)) {
                return false;
            }
    ...
    public static final class ImageTrackInfo extends TrackInfo<ImageTrackInfo> implements Comparable<ImageTrackInfo> {
        ...
        public ImageTrackInfo(int i, TrackGroup trackGroup, int i4, Parameters parameters, int i6) {
            super(i, trackGroup, i4);
            this.selectionEligibility = K.n(i6, parameters.exceedRendererCapabilitiesIfNecessary) ? 1 : 0;
        ...
        public static S createForTrackGroup(int i, TrackGroup trackGroup, Parameters parameters, int[] iArr) {
            O oJ = S.j();
            int i4 = 0;
            while (i4 < trackGroup.length) {
                ...
                oJ.a(new ImageTrackInfo(i6, trackGroup2, i4, parameters2, iArr[i4]));
                i4++;
                i = i6;
    ...
    public static final class OtherTrackScore implements Comparable<OtherTrackScore> {
        ...
        public OtherTrackScore(Format format, int i) {
            ...
            this.isWithinRendererCapabilities = K.n(i, false);
        }

        @Override // java.lang.Comparable
        public int compareTo(OtherTrackScore otherTrackScore) {
            return G.f4543a.d(this.isWithinRendererCapabilities, otherTrackScore.isWithinRendererCapabilities).d(this.isDefault, otherTrackScore.isDefault).f();
        }
    }
    ...
    public static final class Parameters extends TrackSelectionParameters {
        ...
        public static final class Builder extends TrackSelectionParameters.Builder {
            ...
            private void setSelectionOverridesFromBundle(Bundle bundle) {
                ...
                if (parcelableArrayList == null) {
                    P p10 = S.f4555b;
                    listFromBundleList = t0.e;
                } else {
                    listFromBundleList = BundleCollectionUtil.fromBundleList(new c(2), parcelableArrayList);
                }
                SparseArray sparseParcelableArray = bundle.getSparseParcelableArray(Parameters.FIELD_SELECTION_OVERRIDES);
                SparseArray sparseArray = sparseParcelableArray == null ? new SparseArray() : BundleCollectionUtil.fromBundleSparseArray(new c(3), sparseParcelableArray);
                if (intArray == null || intArray.length != listFromBundleList.size()) {
                    return;
                }
                for (int i = 0; i < intArray.length; i++) {
                    setSelectionOverride(intArray[i], (TrackGroupArray) listFromBundleList.get(i), (SelectionOverride) sparseArray.get(i));
                }
            }
            ...
            public Builder setAllowAudioNonSeamlessAdaptiveness(boolean z4) {
                this.allowAudioNonSeamlessAdaptiveness = z4;
                return this;
            }

            public Builder setAllowInvalidateSelectionsOnRendererCapabilitiesChange(boolean z4) {
            ...
            public Builder setRendererDisabled(int i, boolean z4) {
                if (this.rendererDisabledFlags.get(i) == z4) {
                    return this;
                }
                if (z4) {
            ...
            @Override // androidx.media3.common.TrackSelectionParameters.Builder
            public Builder setMaxVideoSize(int i, int i4) {
                super.setMaxVideoSize(i, i4);
                return this;
            }
            ...
            @Override // androidx.media3.common.TrackSelectionParameters.Builder
            public Builder setMinVideoSize(int i, int i4) {
                super.setMinVideoSize(i, i4);
                return this;
            }
            ...
            @Override // androidx.media3.common.TrackSelectionParameters.Builder
            public Builder setTrackTypeDisabled(int i, boolean z4) {
                super.setTrackTypeDisabled(i, z4);
                return this;
            }

            @Override // androidx.media3.common.TrackSelectionParameters.Builder
            public Builder setViewportSize(int i, int i4, boolean z4) {
                super.setViewportSize(i, i4, z4);
                return this;
            }
        ...
        private static void putSelectionOverridesToBundle(Bundle bundle, SparseArray<Map<TrackGroupArray, SelectionOverride>> sparseArray) {
            ...
            for (int i = 0; i < sparseArray.size(); i++) {
                ...
                bundle.putIntArray(FIELD_SELECTION_OVERRIDES_RENDERER_INDICES, AbstractC1955a.A(arrayList));
                bundle.putParcelableArrayList(FIELD_SELECTION_OVERRIDES_TRACK_GROUP_ARRAYS, BundleCollectionUtil.toBundleArrayList(arrayList2, new c(0)));
                bundle.putSparseParcelableArray(FIELD_SELECTION_OVERRIDES, BundleCollectionUtil.toBundleSparseArray(sparseArray2, new c(1)));
            }
        }
    ...
    public static final class ParametersBuilder extends TrackSelectionParameters.Builder {
        ...
        public ParametersBuilder setExceedAudioConstraintsIfNecessary(boolean z4) {
            this.delegate.setExceedAudioConstraintsIfNecessary(z4);
            return this;
        }

        public ParametersBuilder setExceedRendererCapabilitiesIfNecessary(boolean z4) {
            this.delegate.setExceedRendererCapabilitiesIfNecessary(z4);
            return this;
        }

        public ParametersBuilder setExceedVideoConstraintsIfNecessary(boolean z4) {
            this.delegate.setExceedVideoConstraintsIfNecessary(z4);
            return this;
        }

        public ParametersBuilder setRendererDisabled(int i, boolean z4) {
            this.delegate.setRendererDisabled(i, z4);
            return this;
        }
        ...
        public ParametersBuilder setTunnelingEnabled(boolean z4) {
            this.delegate.setTunnelingEnabled(z4);
            return this;
        }
        ...
        public ParametersBuilder setForceHighestSupportedBitrate(boolean z4) {
            this.delegate.setForceHighestSupportedBitrate(z4);
            return this;
        }

        @Override // androidx.media3.common.TrackSelectionParameters.Builder
        public ParametersBuilder setForceLowestBitrate(boolean z4) {
            this.delegate.setForceLowestBitrate(z4);
            return this;
        }
        ...
        @Override // androidx.media3.common.TrackSelectionParameters.Builder
        public ParametersBuilder setMaxVideoSize(int i, int i4) {
        ...
        @Override // androidx.media3.common.TrackSelectionParameters.Builder
        public ParametersBuilder setMinVideoSize(int i, int i4) {
        ...
        @Override // androidx.media3.common.TrackSelectionParameters.Builder
        public ParametersBuilder setPrioritizeImageOverVideoEnabled(boolean z4) {
            this.delegate.setPrioritizeImageOverVideoEnabled(z4);
            return this;
        }

        @Override // androidx.media3.common.TrackSelectionParameters.Builder
        public ParametersBuilder setSelectUndeterminedTextLanguage(boolean z4) {
            this.delegate.setSelectUndeterminedTextLanguage(z4);
            return this;
        }

        @Override // androidx.media3.common.TrackSelectionParameters.Builder
        public ParametersBuilder setTrackTypeDisabled(int i, boolean z4) {
            this.delegate.setTrackTypeDisabled(i, z4);
            return this;
        }

        @Override // androidx.media3.common.TrackSelectionParameters.Builder
        public ParametersBuilder setViewportSize(int i, int i4, boolean z4) {
            this.delegate.setViewportSize(i, i4, z4);
            return this;
        }

        @Override // androidx.media3.common.TrackSelectionParameters.Builder
        public ParametersBuilder setViewportSizeToPhysicalDisplaySize(Context context, boolean z4) {
            this.delegate.setViewportSizeToPhysicalDisplaySize(context, z4);
            return this;
        }
    ...
    public static final class SelectionOverride {
        ...
        public static SelectionOverride fromBundle(Bundle bundle) {
            ...
            return new SelectionOverride(i, intArray, i4);
        }
        ...
        @UnstableApi
        public SelectionOverride(int i, int[] iArr, int i4) {
            this.groupIndex = i;
    ...
    public static class SpatializerWrapperV32 {
        ...
        public void ensureInitialized(final DefaultTrackSelector defaultTrackSelector, Looper looper) {
            if (this.listener == null && this.handler == null) {
                ...
                this.spatializer.addOnSpatializerStateChangedListener(new androidx.emoji2.text.a(handler), this.listener);
            }
        }
    ...
    public static final class TextTrackInfo extends TrackInfo<TextTrackInfo> implements Comparable<TextTrackInfo> {
        ...
        public TextTrackInfo(int i, TrackGroup trackGroup, int i4, Parameters parameters, int i6, @Nullable String str) {
            int formatLanguageScore;
            super(i, trackGroup, i4);
            int i10 = 0;
            this.isWithinRendererCapabilities = K.n(i6, false);
            ...
            S sP = parameters.preferredTextLanguages.isEmpty() ? S.p("") : parameters.preferredTextLanguages;
            int i12 = 0;
            while (true) {
                if (i12 >= sP.size()) {
                    ...
                    formatLanguageScore = DefaultTrackSelector.getFormatLanguageScore(this.format, (String) sP.get(i12), parameters.selectUndeterminedTextLanguage);
                    if (formatLanguageScore > 0) {
                        break;
                    } else {
                        i12++;
            ...
            boolean z4 = formatLanguageScore > 0 || (parameters.preferredTextLanguages.isEmpty() && roleFlagMatchScore > 0) || this.isDefault || (this.isForced && formatLanguageScore2 > 0);
            if (K.n(i6, parameters.exceedRendererCapabilitiesIfNecessary) && z4) {
                i10 = 1;
            }
        ...
        public static S createForTrackGroup(int i, TrackGroup trackGroup, Parameters parameters, int[] iArr, @Nullable String str) {
            O oJ = S.j();
            int i4 = 0;
            while (i4 < trackGroup.length) {
                int i6 = i;
                ...
                Parameters parameters2 = parameters;
                String str2 = str;
                oJ.a(new TextTrackInfo(i6, trackGroup2, i4, parameters2, iArr[i4], str2));
                i4++;
                i = i6;
                trackGroup = trackGroup2;
                parameters = parameters2;
        ...
        public int compareTo(TextTrackInfo textTrackInfo) {
            G gD = G.f4543a.d(this.isWithinRendererCapabilities, textTrackInfo.isWithinRendererCapabilities);
            Integer numValueOf = Integer.valueOf(this.preferredLanguageIndex);
            Integer numValueOf2 = Integer.valueOf(textTrackInfo.preferredLanguageIndex);
            r0 r0Var = r0.c;
            G gD2 = gD.c(numValueOf, numValueOf2, r0Var).a(this.preferredLanguageScore, textTrackInfo.preferredLanguageScore).a(this.preferredRoleFlagsScore, textTrackInfo.preferredRoleFlagsScore).d(this.isDefault, textTrackInfo.isDefault);
            ...
            G gA = gD2.c(boolValueOf, boolValueOf2, r0Var).a(this.selectedAudioLanguageScore, textTrackInfo.selectedAudioLanguageScore);
            if (this.preferredRoleFlagsScore == 0) {
                gA = gA.e(this.hasCaptionRoleFlags, textTrackInfo.hasCaptionRoleFlags);
            }
            return gA.f();
        }
    }
    ...
    public static abstract class TrackInfo<T extends TrackInfo<T>> {
        ...
        public TrackInfo(int i, TrackGroup trackGroup, int i4) {
            this.rendererIndex = i;
            this.trackGroup = trackGroup;
            this.trackIndex = i4;
            this.format = trackGroup.getFormat(i4);
        }
    ...
    public static final class VideoTrackInfo extends TrackInfo<VideoTrackInfo> {
        ...
        */
        ...
        public static int compareQualityPreferences(VideoTrackInfo videoTrackInfo, VideoTrackInfo videoTrackInfo2) {
            s0 s0VarA = (videoTrackInfo.isWithinMaxConstraints && videoTrackInfo.isWithinRendererCapabilities) ? DefaultTrackSelector.FORMAT_VALUE_ORDERING : DefaultTrackSelector.FORMAT_VALUE_ORDERING.a();
            G gC = G.f4543a;
            if (videoTrackInfo.parameters.forceLowestBitrate) {
                gC = gC.c(Integer.valueOf(videoTrackInfo.bitrate), Integer.valueOf(videoTrackInfo2.bitrate), DefaultTrackSelector.FORMAT_VALUE_ORDERING.a());
            }
            return gC.c(Integer.valueOf(videoTrackInfo.pixelCount), Integer.valueOf(videoTrackInfo2.pixelCount), s0VarA).c(Integer.valueOf(videoTrackInfo.bitrate), Integer.valueOf(videoTrackInfo2.bitrate), s0VarA).f();
        }

        public static int compareSelections(List<VideoTrackInfo> list, List<VideoTrackInfo> list2) {
            return E.g(compareNonQualityPreferences((VideoTrackInfo) Collections.max(list, new b(4)), (VideoTrackInfo) Collections.max(list2, new b(4)))).a(list.size(), list2.size()).c((VideoTrackInfo) Collections.max(list, new b(5)), (VideoTrackInfo) Collections.max(list2, new b(5)), new b(5)).f();
        }

        public static S createForTrackGroup(int i, TrackGroup trackGroup, Parameters parameters, int[] iArr, int i4) {
            ...
            while (i6 < trackGroup.length) {
                ...
                Parameters parameters2 = parameters;
                int i11 = i4;
                oJ.a(new VideoTrackInfo(i10, trackGroup2, i6, parameters2, iArr[i6], i11, maxVideoPixelsToRetainForViewport == Integer.MAX_VALUE || (pixelCount != -1 && pixelCount <= maxVideoPixelsToRetainForViewport)));
                i6++;
                i = i10;
                trackGroup = trackGroup2;
                parameters = parameters2;
        ...
        private int evaluateSelectionEligibility(int i, int i4) {
            if ((this.format.roleFlags & 16384) != 0 || !K.n(i, this.parameters.exceedRendererCapabilitiesIfNecessary)) {
                return 0;
            }
            if (!this.isWithinMaxConstraints && !this.parameters.exceedVideoConstraintsIfNecessary) {
                return 0;
            }
            if (!K.n(i, false) || !this.isWithinMinConstraints || !this.isWithinMaxConstraints || this.format.bitrate == -1) {
                return 1;
            }
            Parameters parameters = this.parameters;
            return (parameters.forceHighestSupportedBitrate || parameters.forceLowestBitrate || (i & i4) == 0) ? 1 : 2;
        }
    ...
    private static void applyTrackSelectionOverrides(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, TrackSelectionParameters trackSelectionParameters, ExoTrackSelection.Definition[] definitionArr) {
        ...
        for (int i4 = 0; i4 < rendererCount; i4++) {
            TrackSelectionOverride trackSelectionOverride = (TrackSelectionOverride) map.get(Integer.valueOf(mappedTrackInfo.getRendererType(i4)));
            if (trackSelectionOverride != null) {
                definitionArr[i4] = (trackSelectionOverride.trackIndices.isEmpty() || mappedTrackInfo.getTrackGroups(i4).indexOf(trackSelectionOverride.mediaTrackGroup) == -1) ? null : new ExoTrackSelection.Definition(trackSelectionOverride.mediaTrackGroup, AbstractC1955a.A(trackSelectionOverride.trackIndices));
            }
        }
    }
    ...
    public static int getFormatLanguageScore(Format format, @Nullable String str, boolean z4) {
        ...
        if (strNormalizeUndeterminedLanguageToNull2 == null || strNormalizeUndeterminedLanguageToNull == null) {
            return (z4 && strNormalizeUndeterminedLanguageToNull2 == null) ? 1 : 0;
        }
        ...
        return Util.splitAtFirst(strNormalizeUndeterminedLanguageToNull2, Global.HYPHEN)[0].equals(Util.splitAtFirst(strNormalizeUndeterminedLanguageToNull, Global.HYPHEN)[0]) ? 2 : 0;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static int getMaxVideoPixelsToRetainForViewport(TrackGroup trackGroup, int i, int i4, boolean z4) {
        int i6;
        ...
        if (i != Integer.MAX_VALUE && i4 != Integer.MAX_VALUE) {
            for (int i11 = 0; i11 < trackGroup.length; i11++) {
                ...
                if (i12 > 0 && (i6 = format.height) > 0) {
                    Point maxVideoSizeInViewport = getMaxVideoSizeInViewport(z4, i, i4, i12, i6);
                    int i13 = format.width;
                    int i14 = format.height;
                    int i15 = i13 * i14;
                    if (i13 >= ((int) (maxVideoSizeInViewport.x * FRACTION_TO_CONSIDER_FULLSCREEN)) && i14 >= ((int) (maxVideoSizeInViewport.y * FRACTION_TO_CONSIDER_FULLSCREEN)) && i15 < i10) {
                        i10 = i15;
                    }
                }
            }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static int getRoleFlagMatchScore(int i, int i4) {
        if (i == 0 || i != i4) {
        ...
        synchronized (this.lock) {
            try {
                if (this.parameters.constrainAudioChannelCountToDeviceCapabilities && !this.deviceIsTV && format.channelCount > 2 && (!isDolbyAudio(format) || (Util.SDK_INT >= 32 && (spatializerWrapperV322 = this.spatializer) != null && spatializerWrapperV322.isSpatializationSupported()))) {
                    z4 = Util.SDK_INT >= 32 && (spatializerWrapperV32 = this.spatializer) != null && spatializerWrapperV32.isSpatializationSupported() && this.spatializer.isAvailable() && this.spatializer.isEnabled() && this.spatializer.canBeSpatialized(this.audioAttributes, format);
                }
            } finally {
            }
        }
    ...
    @Deprecated
    public static boolean isSupported(int i, boolean z4) {
        return K.n(i, z4);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ List lambda$selectAudioTrack$2(Parameters parameters, boolean z4, int[] iArr, int i, TrackGroup trackGroup, int[] iArr2) {
        return AudioTrackInfo.createForTrackGroup(i, trackGroup, parameters, iArr2, z4, new j() { // from class: androidx.media3.exoplayer.trackselection.a
            @Override // N1.j
            public final boolean apply(Object obj) {
                return this.f8113a.isAudioFormatWithinAudioChannelCountConstraints((Format) obj);
            }
        }, iArr[i]);
    }
    ...
    private static void maybeConfigureRendererForOffload(Parameters parameters, MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, RendererConfiguration[] rendererConfigurationArr, ExoTrackSelection[] exoTrackSelectionArr) {
        ...
        for (int i6 = 0; i6 < mappedTrackInfo.getRendererCount(); i6++) {
            ...
            if (rendererType == 1 && exoTrackSelection != null && exoTrackSelection.length() == 1) {
                if (rendererSupportsOffload(parameters, iArr[i6][mappedTrackInfo.getTrackGroups(i6).indexOf(exoTrackSelection.getTrackGroup())][exoTrackSelection.getIndexInTrackGroup(0)], exoTrackSelection.getSelectedFormat())) {
                    i4++;
                    i = i6;
                }
            }
        ...
        if (i4 == 1) {
            int i10 = parameters.audioOffloadPreferences.isGaplessSupportRequired ? 1 : 2;
            RendererConfiguration rendererConfiguration = rendererConfigurationArr[i];
            if (rendererConfiguration != null && rendererConfiguration.tunneling) {
                z4 = true;
            }
            rendererConfigurationArr[i] = new RendererConfiguration(i10, z4);
        }
    }
    ...
    public void maybeInvalidateForAudioChannelCountConstraints() {
        ...
        synchronized (this.lock) {
            try {
                z4 = this.parameters.constrainAudioChannelCountToDeviceCapabilities && !this.deviceIsTV && Util.SDK_INT >= 32 && (spatializerWrapperV32 = this.spatializer) != null && spatializerWrapperV32.isSpatializationSupported();
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public static boolean rendererSupportsOffload(Parameters parameters, int i, Format format) {
        ...
        if (parameters.audioOffloadPreferences.isSpeedChangeSupportRequired && (K.i(i) & 2048) == 0) {
            return false;
        }
    ...
    private static boolean rendererSupportsTunneling(int[][] iArr, TrackGroupArray trackGroupArray, ExoTrackSelection exoTrackSelection) {
        ...
        for (int i = 0; i < exoTrackSelection.length(); i++) {
            if (K.m(iArr[iIndexOf][exoTrackSelection.getIndexInTrackGroup(i)]) != 32) {
                return false;
            }
        }
        return true;
    ...
    private <T extends TrackInfo<T>> Pair<ExoTrackSelection.Definition, Integer> selectTracksForType(int i, MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, TrackInfo.Factory<T> factory, Comparator<List<T>> comparator) {
        ...
        while (i6 < rendererCount) {
            if (i == mappedTrackInfo2.getRendererType(i6)) {
                ...
                for (int i10 = 0; i10 < trackGroups.length; i10++) {
                    ...
                    List<T> listCreate = factory.create(i6, trackGroup, iArr[i6][i10]);
                    boolean[] zArr = new boolean[trackGroup.length];
                    int i11 = 0;
                    while (i11 < trackGroup.length) {
                        T t5 = listCreate.get(i11);
                        int selectionEligibility = t5.getSelectionEligibility();
                        if (zArr[i11] || selectionEligibility == 0) {
                            i4 = rendererCount;
                        } else {
                            if (selectionEligibility == 1) {
                                randomAccessP = S.p(t5);
                            } else {
                                ArrayList arrayList2 = new ArrayList();
                                arrayList2.add(t5);
                                int i12 = i11 + 1;
                                while (i12 < trackGroup.length) {
                                    T t10 = listCreate.get(i12);
                                    int i13 = rendererCount;
                                    if (t10.getSelectionEligibility() == 2 && t5.isCompatibleForAdaptationWith(t10)) {
                                        arrayList2.add(t10);
                                        zArr[i12] = true;
                                    }
                                    i12++;
        ...
        for (int i14 = 0; i14 < list.size(); i14++) {
            iArr2[i14] = ((TrackInfo) list.get(i14)).trackIndex;
        }
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, iArr, new l(z4, this, parameters, iArr2), new b(1));
    }
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectImageTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(4, mappedTrackInfo, iArr, new Xa.c(parameters, 22), new b(0));
    }
    ...
    public ExoTrackSelection.Definition selectOtherTrack(int i, TrackGroupArray trackGroupArray, int[][] iArr, Parameters parameters) throws ExoPlaybackException {
        ...
        for (int i6 = 0; i6 < trackGroupArray.length; i6++) {
            ...
            for (int i10 = 0; i10 < trackGroup2.length; i10++) {
                if (K.n(iArr2[i10], parameters.exceedRendererCapabilitiesIfNecessary)) {
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectTextTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, Parameters parameters, @Nullable String str) throws ExoPlaybackException {
        ...
        return selectTracksForType(3, mappedTrackInfo, iArr, new androidx.camera.lifecycle.a(13, parameters, str), new b(3));
    }
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectVideoTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(2, mappedTrackInfo, iArr, new androidx.camera.lifecycle.a(12, parameters, iArr2), new b(2));
    }
