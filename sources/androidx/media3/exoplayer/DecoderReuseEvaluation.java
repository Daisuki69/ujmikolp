...
public final class DecoderReuseEvaluation {
    ...
    public DecoderReuseEvaluation(String str, Format format, Format format2, int i, int i4) {
    ...
    public int hashCode() {
        return this.newFormat.hashCode() + ((this.oldFormat.hashCode() + AbstractC1414e.c((((527 + this.result) * 31) + this.discardReasons) * 31, 31, this.decoderName)) * 31);
    }
}
