...
public final class RequirementsWatcher {
    ...
    public int start() {
        ...
        ht2aO8.registerReceiver(this.context, deviceStatusChangeReceiver, intentFilter, null, this.handler);
        return this.notMetRequirements;
    }

    public void stop() {
        ht2aO8.unregisterReceiver(this.context, (BroadcastReceiver) Assertions.checkNotNull(this.receiver));
        this.receiver = null;
