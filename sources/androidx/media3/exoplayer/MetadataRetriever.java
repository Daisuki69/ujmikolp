...
public final class MetadataRetriever {
    ...
    public static final class MetadataRetrieverInternal {
        ...
        private final S1.E trackGroupsFuture;
            ...
            public boolean handleMessage(Message message) {
                ...
                if (i == 2) {
                    try {
                        ...
                        MetadataRetrieverInternal.this.trackGroupsFuture.k(e);
                        MetadataRetrieverInternal.this.mediaSourceHandler.obtainMessage(4).sendToTarget();
                        return true;
                    }
                }
        ...
        public MetadataRetrieverInternal(MediaSource.Factory factory, Clock clock) {
            ...
            this.trackGroupsFuture = new S1.E();
        }

        public S1.y retrieveMetadata(MediaItem mediaItem) {
    ...
    public static S1.y retrieveMetadata(Context context, MediaItem mediaItem) {
        return retrieveMetadata(context, mediaItem, Clock.DEFAULT);
    }

    public static S1.y retrieveMetadata(MediaSource.Factory factory, MediaItem mediaItem) {
        return retrieveMetadata(factory, mediaItem, Clock.DEFAULT);
    }

    @VisibleForTesting
    public static S1.y retrieveMetadata(Context context, MediaItem mediaItem, Clock clock) {
    ...
    private static S1.y retrieveMetadata(MediaSource.Factory factory, MediaItem mediaItem, Clock clock) {
