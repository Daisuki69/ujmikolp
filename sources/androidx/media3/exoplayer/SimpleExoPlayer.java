...
public class SimpleExoPlayer extends BasePlayer implements ExoPlayer, ExoPlayer.AudioComponent, ExoPlayer.VideoComponent, ExoPlayer.TextComponent, ExoPlayer.DeviceComponent {
    ...
    public SimpleExoPlayer(Context context, RenderersFactory renderersFactory, TrackSelector trackSelector, MediaSource.Factory factory, LoadControl loadControl, BandwidthMeter bandwidthMeter, AnalyticsCollector analyticsCollector, boolean z4, Clock clock, Looper looper) {
        this(new ExoPlayer.Builder(context, renderersFactory, factory, trackSelector, loadControl, bandwidthMeter, analyticsCollector).setUseLazyPreparation(z4).setClock(clock).setLooper(looper));
    }
    ...
    public void moveMediaItems(int i, int i4, int i6) {
        blockUntilConstructorFinished();
        this.player.moveMediaItems(i, i4, i6);
    }
    ...
    public void setHandleAudioBecomingNoisy(boolean z4) {
        blockUntilConstructorFinished();
        this.player.setHandleAudioBecomingNoisy(z4);
    }
    ...
    public void setSkipSilenceEnabled(boolean z4) {
        blockUntilConstructorFinished();
        this.player.setSkipSilenceEnabled(z4);
    }

    public void setThrowsWhenUsingWrongThread(boolean z4) {
        blockUntilConstructorFinished();
        this.player.setThrowsWhenUsingWrongThread(z4);
    }
    ...
    public void setMediaSource(MediaSource mediaSource, boolean z4) {
        blockUntilConstructorFinished();
        this.player.setMediaSource(mediaSource, z4);
    }
    ...
    public void prepare(MediaSource mediaSource, boolean z4, boolean z5) {
        blockUntilConstructorFinished();
        this.player.prepare(mediaSource, z4, z5);
    }
