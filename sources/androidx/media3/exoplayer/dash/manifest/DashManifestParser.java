...
public class DashManifestParser extends DefaultHandler implements ParsingLoadable.Parser<DashManifest> {
    ...
    private long addSegmentTimelineElementsToList(List<SegmentBase.SegmentTimelineElement> list, long j, long j6, int i, long j7) {
        int iCeilDivide = i >= 0 ? i + 1 : (int) Util.ceilDivide(j7 - j, j6);
        for (int i4 = 0; i4 < iCeilDivide; i4++) {
            list.add(buildSegmentTimelineElement(j, j6));
            j += j6;
        }
        return j;
    }

    private static int checkContentTypeConsistency(int i, int i4) {
        if (i == -1) {
            return i4;
        }
        if (i4 == -1) {
    ...
    private static void fillInClearKeyInformation(ArrayList<DrmInitData.SchemeData> arrayList) {
        ...
        for (int i4 = 0; i4 < arrayList.size(); i4++) {
            DrmInitData.SchemeData schemeData2 = arrayList.get(i4);
            if (C.COMMON_PSSH_UUID.equals(schemeData2.uuid) && schemeData2.licenseServerUrl == null) {
                arrayList.set(i4, new DrmInitData.SchemeData(C.CLEARKEY_UUID, str, schemeData2.mimeType, schemeData2.data));
            }
        }
    }
    ...
    private static long getFinalAvailabilityTimeOffset(long j, long j6) {
        if (j6 != C.TIME_UNSET) {
            j = j6;
        }
    ...
    public static long parseLastSegmentNumberSupplementalProperty(List<Descriptor> list) {
        for (int i = 0; i < list.size(); i++) {
            Descriptor descriptor = list.get(i);
            if (v0.i("http://dashif.org/guidelines/last-segment-number", descriptor.schemeIdUri)) {
    ...
    public EventMessage buildEvent(String str, String str2, long j, long j6, byte[] bArr) {
        return new EventMessage(str, str2, j6, j, bArr);
    }
    ...
    public Format buildFormat(@Nullable String str, @Nullable String str2, int i, int i4, float f, int i6, int i10, int i11, @Nullable String str3, List<Descriptor> list, List<Descriptor> list2, @Nullable String str4, List<Descriptor> list3, List<Descriptor> list4) {
        String str5 = str4;
        ...
        Format.Builder language = new Format.Builder().setId(str).setContainerMimeType(str2).setSampleMimeType(sampleMimeType).setCodecs(str5).setPeakBitrate(i11).setSelectionFlags(selectionFlagsFromRoleDescriptors).setRoleFlags(roleFlagsFromRoleDescriptors).setLanguage(str3);
        ...
        if (MimeTypes.isVideo(sampleMimeType)) {
            tileCountVertical.setWidth(i).setHeight(i4).setFrameRate(f);
        } else if (MimeTypes.isAudio(sampleMimeType)) {
            tileCountVertical.setChannelCount(i6).setSampleRate(i10);
            ...
            tileCountVertical.setWidth(i).setHeight(i4);
        }
        return tileCountVertical.build();
    }

    public DashManifest buildMediaPresentationDescription(long j, long j6, long j7, boolean z4, long j9, long j10, long j11, long j12, @Nullable ProgramInformation programInformation, @Nullable UtcTimingElement utcTimingElement, @Nullable ServiceDescriptionElement serviceDescriptionElement, @Nullable Uri uri, List<Period> list) {
        return new DashManifest(j, j6, j7, z4, j9, j10, j11, j12, programInformation, utcTimingElement, serviceDescriptionElement, uri, list);
    }
    ...
    public RangedUri buildRangedUri(String str, long j, long j6) {
        return new RangedUri(str, j, j6);
    }
    ...
    public SegmentBase.SegmentList buildSegmentList(RangedUri rangedUri, long j, long j6, long j7, long j9, @Nullable List<SegmentBase.SegmentTimelineElement> list, long j10, @Nullable List<RangedUri> list2, long j11, long j12) {
        return new SegmentBase.SegmentList(rangedUri, j, j6, j7, j9, list, j10, list2, Util.msToUs(j11), Util.msToUs(j12));
    }

    public SegmentBase.SegmentTemplate buildSegmentTemplate(RangedUri rangedUri, long j, long j6, long j7, long j9, long j10, List<SegmentBase.SegmentTimelineElement> list, long j11, @Nullable UrlTemplate urlTemplate, @Nullable UrlTemplate urlTemplate2, long j12, long j13) {
        return new SegmentBase.SegmentTemplate(rangedUri, j, j6, j7, j9, j10, list, j11, urlTemplate, urlTemplate2, Util.msToUs(j12), Util.msToUs(j13));
    }

    public SegmentBase.SegmentTimelineElement buildSegmentTimelineElement(long j, long j6) {
        return new SegmentBase.SegmentTimelineElement(j, j6);
    }

    public SegmentBase.SingleSegmentBase buildSingleSegmentBase(RangedUri rangedUri, long j, long j6, long j7, long j9) {
        return new SegmentBase.SingleSegmentBase(rangedUri, j, j6, j7, j9);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:75:0x0346 A[EDGE_INSN: B:75:0x0346->B:68:0x0346 BREAK  A[LOOP:0: B:3:0x0093->B:74:0x0396], SYNTHETIC] */
    /*
    ...
    */
    ...
    public List<BaseUrl> parseBaseUrl(XmlPullParser xmlPullParser, List<BaseUrl> list, boolean z4) throws XmlPullParserException, IOException {
        String attributeValue = xmlPullParser.getAttributeValue(null, "dvb:priority");
        int i = attributeValue != null ? Integer.parseInt(attributeValue) : z4 ? 1 : Integer.MIN_VALUE;
        String attributeValue2 = xmlPullParser.getAttributeValue(null, "dvb:weight");
        int i4 = attributeValue2 != null ? Integer.parseInt(attributeValue2) : 1;
        ...
        if (UriUtil.isAbsolute(text)) {
            ...
            return AbstractC0529x.p(new BaseUrl(text, attributeValue3, i, i4));
        }
        ...
        for (int i6 = 0; i6 < list.size(); i6++) {
            ...
            arrayList.add(new BaseUrl(strResolve, str, i, i4));
        }
        return arrayList;
    }
    ...
    */
    ...
    public Pair<Long, EventMessage> parseEvent(XmlPullParser xmlPullParser, String str, String str2, long j, long j6, ByteArrayOutputStream byteArrayOutputStream) throws XmlPullParserException, IOException {
        long j7 = parseLong(xmlPullParser, TtmlNode.ATTR_ID, 0L);
        long j9 = parseLong(xmlPullParser, "duration", C.TIME_UNSET);
        long j10 = parseLong(xmlPullParser, "presentationTime", 0L);
        long jScaleLargeTimestamp = Util.scaleLargeTimestamp(j9, 1000L, j);
        long jScaleLargeTimestamp2 = Util.scaleLargeTimestamp(j10 - j6, 1000000L, j);
        ...
        return Pair.create(lValueOf, buildEvent(str, str2, j7, jScaleLargeTimestamp, eventObject));
    }
    ...
    public byte[] parseEventObject(XmlPullParser xmlPullParser, ByteArrayOutputStream byteArrayOutputStream) throws XmlPullParserException, IOException {
        ...
        xmlSerializerNewSerializer.setOutput(byteArrayOutputStream, e.c.name());
    ...
    public EventStream parseEventStream(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        long j6 = parseLong(xmlPullParser, "timescale", 1L);
        long j7 = parseLong(xmlPullParser, "presentationTimeOffset", 0L);
        ArrayList arrayList = new ArrayList();
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "Event")) {
                ...
                arrayList.add(parseEvent(xmlPullParser2, str2, str, j, j7, byteArrayOutputStream));
            } else {
                j = j6;
                str = string2;
                str2 = string;
    ...
    /* JADX WARN: Removed duplicated region for block: B:81:0x01c0 A[LOOP:0: B:25:0x00a4->B:81:0x01c0, LOOP_END] */
    ...
    */
    ...
    public RangedUri parseRangedUrl(XmlPullParser xmlPullParser, String str, String str2) {
        ...
        if (attributeValue2 != null) {
            String[] strArrSplit = attributeValue2.split(Global.HYPHEN);
            j = Long.parseLong(strArrSplit[0]);
            if (strArrSplit.length == 2) {
                j6 = (Long.parseLong(strArrSplit[1]) - j) + 1;
            }
            return buildRangedUri(attributeValue, j, j6);
        }
        j = 0;
        j6 = -1;
        return buildRangedUri(attributeValue, j, j6);
    ...
    */
    ...
    public int parseRoleFlagsFromAccessibilityDescriptors(List<Descriptor> list) {
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            if (v0.i("urn:mpeg:dash:role:2011", descriptor.schemeIdUri)) {
                tvaAudioPurposeCsValue = parseRoleFlagsFromDashRoleScheme(descriptor.value);
            } else if (v0.i("urn:tva:metadata:cs:AudioPurposeCS:2007", descriptor.schemeIdUri)) {
    ...
    public int parseRoleFlagsFromProperties(List<Descriptor> list) {
        int i = 0;
        for (int i4 = 0; i4 < list.size(); i4++) {
            if (v0.i("http://dashif.org/guidelines/trickmode", list.get(i4).schemeIdUri)) {
                i = 16384;
            }
        }
        return i;
    ...
    public SegmentBase.SingleSegmentBase parseSegmentBase(XmlPullParser xmlPullParser, @Nullable SegmentBase.SingleSegmentBase singleSegmentBase) throws XmlPullParserException, IOException {
        ...
        long j6 = parseLong(xmlPullParser, "presentationTimeOffset", singleSegmentBase != null ? singleSegmentBase.presentationTimeOffset : 0L);
        long j7 = singleSegmentBase != null ? singleSegmentBase.indexStart : 0L;
        long j9 = singleSegmentBase != null ? singleSegmentBase.indexLength : 0L;
        String attributeValue = xmlPullParser.getAttributeValue(null, "indexRange");
        if (attributeValue != null) {
            String[] strArrSplit = attributeValue.split(Global.HYPHEN);
            j7 = Long.parseLong(strArrSplit[0]);
            j9 = (Long.parseLong(strArrSplit[1]) - j7) + 1;
        }
        long j10 = j9;
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isEndTag(xmlPullParser, "SegmentBase")) {
                return buildSingleSegmentBase(rangedUri, j, j6, j7, j10);
            }
            initialization = rangedUri;
        }
    }

    public SegmentBase.SegmentList parseSegmentList(XmlPullParser xmlPullParser, @Nullable SegmentBase.SegmentList segmentList, long j, long j6, long j7, long j9, long j10) throws XmlPullParserException, IOException {
        long j11;
        long j12 = parseLong(xmlPullParser, "timescale", segmentList != null ? segmentList.timescale : 1L);
        long j13 = parseLong(xmlPullParser, "presentationTimeOffset", segmentList != null ? segmentList.presentationTimeOffset : 0L);
        long j14 = parseLong(xmlPullParser, "duration", segmentList != null ? segmentList.duration : C.TIME_UNSET);
        long j15 = parseLong(xmlPullParser, "startNumber", segmentList != null ? segmentList.startNumber : 1L);
        long finalAvailabilityTimeOffset = getFinalAvailabilityTimeOffset(j7, j9);
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "Initialization")) {
                ...
                j11 = j12;
                segmentTimeline = parseSegmentTimeline(xmlPullParser, j11, j6);
            } else {
                j11 = j12;
        ...
        return buildSegmentList(initialization, j11, j13, j15, j14, segmentTimeline, finalAvailabilityTimeOffset, arrayList, j10, j);
    }

    public SegmentBase.SegmentTemplate parseSegmentTemplate(XmlPullParser xmlPullParser, @Nullable SegmentBase.SegmentTemplate segmentTemplate, List<Descriptor> list, long j, long j6, long j7, long j9, long j10) throws XmlPullParserException, IOException {
        long j11;
        DashManifestParser dashManifestParser = this;
        long j12 = parseLong(xmlPullParser, "timescale", segmentTemplate != null ? segmentTemplate.timescale : 1L);
        long j13 = parseLong(xmlPullParser, "presentationTimeOffset", segmentTemplate != null ? segmentTemplate.presentationTimeOffset : 0L);
        long j14 = parseLong(xmlPullParser, "duration", segmentTemplate != null ? segmentTemplate.duration : C.TIME_UNSET);
        long j15 = parseLong(xmlPullParser, "startNumber", segmentTemplate != null ? segmentTemplate.startNumber : 1L);
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "Initialization")) {
                ...
                j11 = j12;
                segmentTimeline = dashManifestParser.parseSegmentTimeline(xmlPullParser, j11, j6);
            } else {
                j11 = j12;
                maybeSkipTag(xmlPullParser);
            }
        ...
        return buildSegmentTemplate(initialization, j11, j13, j15, lastSegmentNumberSupplementalProperty, j14, segmentTimeline, finalAvailabilityTimeOffset, urlTemplate2, urlTemplate, j10, j);
    }

    public List<SegmentBase.SegmentTimelineElement> parseSegmentTimeline(XmlPullParser xmlPullParser, long j, long j6) throws XmlPullParserException, IOException {
        ArrayList arrayList = new ArrayList();
        ...
        do {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "S")) {
                long j9 = parseLong(xmlPullParser, "t", C.TIME_UNSET);
                if (z4) {
                    ArrayList arrayList2 = arrayList;
                    jAddSegmentTimelineElementsToList = addSegmentTimelineElementsToList(arrayList2, jAddSegmentTimelineElementsToList, j7, i, j9);
                    arrayList = arrayList2;
                }
                if (j9 != C.TIME_UNSET) {
                    jAddSegmentTimelineElementsToList = j9;
                }
                j7 = parseLong(xmlPullParser, "d", C.TIME_UNSET);
        ...
        if (z4) {
            addSegmentTimelineElementsToList(arrayList, jAddSegmentTimelineElementsToList, j7, i, Util.scaleLargeTimestamp(j6, j, 1000L));
        }
        return arrayList;
    }
    ...
    public ServiceDescriptionElement parseServiceDescription(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "Latency")) {
                ...
                j7 = parseLong(xmlPullParser, "max", C.TIME_UNSET);
            ...
            if (XmlPullParserUtil.isEndTag(xmlPullParser, "ServiceDescription")) {
                return new ServiceDescriptionElement(j9, j10, j11, f7, f10);
            }
            j = j9;
            j6 = j10;
            j7 = j11;
    ...
    public Pair<Integer, Integer> parseTileCountFromProperties(List<Descriptor> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            Descriptor descriptor = list.get(i);
            if ((v0.i("http://dashif.org/thumbnail_tile", descriptor.schemeIdUri) || v0.i("http://dashif.org/guidelines/thumbnail_tile", descriptor.schemeIdUri)) && (str = descriptor.value) != null) {
