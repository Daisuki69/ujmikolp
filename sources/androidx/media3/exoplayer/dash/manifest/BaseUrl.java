...
public final class BaseUrl {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.priority == baseUrl.priority && this.weight == baseUrl.weight && p.p(this.url, baseUrl.url) && p.p(this.serviceLocation, baseUrl.serviceLocation);
    }
    ...
    public BaseUrl(String str, String str2, int i, int i4) {
        this.url = str;
