...
public final class PlayerEmsgHandler implements Handler.Callback {
    ...
    public static final class ManifestExpiryEventInfo {
        ...
        public ManifestExpiryEventInfo(long j, long j6) {
            this.eventTimeUs = j;
    ...
    public final class PlayerTrackEmsgHandler implements TrackOutput {
        ...
        private void onManifestExpiredMessageEncountered(long j, long j6) {
            PlayerEmsgHandler.this.handler.sendMessage(PlayerEmsgHandler.this.handler.obtainMessage(1, new ManifestExpiryEventInfo(j, j6)));
        }
        ...
        public void sampleMetadata(long j, int i, int i4, int i6, @Nullable TrackOutput.CryptoData cryptoData) {
            this.sampleQueue.sampleMetadata(j, i, i4, i6, cryptoData);
        ...
        public int sampleData(DataReader dataReader, int i, boolean z4, int i4) throws IOException {
            ...
            return androidx.media3.extractor.d.a(sampleQueue, dataReader, i, z4);
        }
        ...
        public void sampleData(ParsableByteArray parsableByteArray, int i, int i4) {
            SampleQueue sampleQueue = this.sampleQueue;
            sampleQueue.getClass();
            androidx.media3.extractor.d.b(sampleQueue, parsableByteArray, i);
        }
    }
    ...
    private void handleManifestExpiredMessage(long j, long j6) {
        Long l6 = this.manifestPublishTimeToExpiryTimeUs.get(Long.valueOf(j6));
        if (l6 == null) {
            this.manifestPublishTimeToExpiryTimeUs.put(Long.valueOf(j6), Long.valueOf(j));
    ...
    public static boolean isPlayerEmsgEvent(String str, String str2) {
        if ("urn:mpeg:dash:event:2012".equals(str)) {
            return IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(str2) || ExifInterface.GPS_MEASUREMENT_2D.equals(str2) || ExifInterface.GPS_MEASUREMENT_3D.equals(str2);
        }
        return false;
    }
    ...
    public boolean onChunkLoadError(boolean z4) {
