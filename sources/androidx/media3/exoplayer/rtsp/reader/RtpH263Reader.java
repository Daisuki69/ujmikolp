...
final class RtpH263Reader implements RtpPayloadReader {
    ...
    private void parseVopHeader(ParsableByteArray parsableByteArray, boolean z4) {
    ...
    public void consume(ParsableByteArray parsableByteArray, long j, int i, boolean z4) {
        ...
        boolean z5 = (unsignedShort & 1024) > 0;
        ...
        if (this.fragmentedSampleSizeBytes == 0) {
            ...
            if (!this.isOutputFormatSet && this.isKeyFrame) {
                ...
                if (i4 != format.width || this.height != format.height) {
