...
final class SessionDescription {
    ...
    public final S mediaDescriptionList;
    ...
    public static final class Builder {
        ...
        private final O mediaDescriptionListBuilder = new O(4);
    ...
    public int hashCode() {
        int iHashCode = (this.mediaDescriptionList.hashCode() + ((this.attributes.hashCode() + MfaTencentErrorResult.TENCENT_ERROR_FACE_DETECTION_TIMED_OUT) * 31)) * 31;
    ...
    private SessionDescription(Builder builder) {
        this.attributes = X.a(builder.attributes);
