...
public interface Renderer extends PlayerMessage.Target {
    ...
    void enable(RendererConfiguration rendererConfiguration, Format[] formatArr, SampleStream sampleStream, long j, boolean z4, boolean z5, long j6, long j7, MediaSource.MediaPeriodId mediaPeriodId) throws ExoPlaybackException;

    void enableMayRenderStartOfStream();

    RendererCapabilities getCapabilities();

    long getDurationToProgressUs(long j, long j6);
    ...
    void render(long j, long j6) throws ExoPlaybackException;

    void replaceStream(Format[] formatArr, SampleStream sampleStream, long j, long j6, MediaSource.MediaPeriodId mediaPeriodId) throws ExoPlaybackException;
