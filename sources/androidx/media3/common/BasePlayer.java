...
public abstract class BasePlayer implements Player {
    ...
    private void seekToDefaultPositionInternal(int i, int i4) {
        seekTo(i, C.TIME_UNSET, i4, false);
    }
    ...
    public final void replaceMediaItem(int i, MediaItem mediaItem) {
        replaceMediaItems(i, i + 1, S.p(mediaItem));
    }
    ...
    public abstract void seekTo(int i, long j, int i4, boolean z4);
    ...
    public final void setMediaItem(MediaItem mediaItem, long j) {
        setMediaItems(S.p(mediaItem), 0, j);
    }
    ...
    public final void setMediaItem(MediaItem mediaItem, boolean z4) {
        setMediaItems(S.p(mediaItem), z4);
    }
}
