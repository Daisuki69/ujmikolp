...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    private final HashSet<y> pendingOperations;
    ...
    public static final class MediaItemData {
            ...
            public Builder setPeriods(List<PeriodData> list) {
                ...
                while (i < size - 1) {
                    ...
                    for (int i6 = i4; i6 < size; i6++) {
                        Assertions.checkArgument(!list.get(i).uid.equals(list.get(i6).uid), "Duplicate PeriodData UIDs in period list");
                    }
                    i = i4;
                }
                this.periods = S.k(list);
                return this;
            }
        ...
        public Timeline.Period getPeriod(int i, int i4, Timeline.Period period) {
            if (this.periods.isEmpty()) {
                Object obj = this.uid;
                period.set(obj, obj, i, this.positionInFirstPeriodUs + this.durationUs, 0L, AdPlaybackState.NONE, this.isPlaceholder);
                return period;
            }
            PeriodData periodData = (PeriodData) this.periods.get(i4);
            Object obj2 = periodData.uid;
            period.set(obj2, Pair.create(this.uid, obj2), i, periodData.durationUs, this.periodPositionInWindowUs[i4], periodData.adPlaybackState, periodData.isPlaceholder);
            return period;
        }
        ...
        public int hashCode() {
            int iHashCode = (this.mediaItem.hashCode() + ((this.tracks.hashCode() + ((this.uid.hashCode() + MfaTencentErrorResult.TENCENT_ERROR_FACE_DETECTION_TIMED_OUT) * 31)) * 31)) * 31;
            ...
            int i6 = (((((i4 + ((int) (j7 ^ (j7 >>> 32)))) * 31) + (this.isSeekable ? 1 : 0)) * 31) + (this.isDynamic ? 1 : 0)) * 31;
            long j9 = this.defaultPositionUs;
            int i10 = (i6 + ((int) (j9 ^ (j9 >>> 32)))) * 31;
            long j10 = this.durationUs;
            int i11 = (i10 + ((int) (j10 ^ (j10 >>> 32)))) * 31;
            long j11 = this.positionInFirstPeriodUs;
            return this.periods.hashCode() + ((((i11 + ((int) (j11 ^ (j11 >>> 32)))) * 31) + (this.isPlaceholder ? 1 : 0)) * 31);
        }
    ...
    public static final class PeriodData {
        ...
        public int hashCode() {
            int iHashCode = (this.uid.hashCode() + MfaTencentErrorResult.TENCENT_ERROR_FACE_DETECTION_TIMED_OUT) * 31;
    ...
    public static final class PlaylistTimeline extends Timeline {
        ...
        public PlaylistTimeline(S s9) {
            ...
            for (int i6 = 0; i6 < size; i6++) {
                MediaItemData mediaItemData2 = (MediaItemData) s9.get(i6);
                for (int i10 = 0; i10 < getPeriodCountInMediaItem(mediaItemData2); i10++) {
                    this.periodIndexByUid.put(mediaItemData2.getPeriodUid(i10), Integer.valueOf(i4));
                    this.windowIndexByPeriodIndex[i4] = i6;
                    i4++;
                }
            }
        }
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z4) {
            int i4 = this.windowIndexByPeriodIndex[i];
            return ((MediaItemData) this.playlist.get(i4)).getPeriod(i4, i - this.firstPeriodIndexByWindowIndex[i4], period);
        }
        ...
        public Object getUidOfPeriod(int i) {
            int i4 = this.windowIndexByPeriodIndex[i];
            return ((MediaItemData) this.playlist.get(i4)).getPeriodUid(i - this.firstPeriodIndexByWindowIndex[i4]);
        }
    ...
    public interface PositionSupplier {
        public static final PositionSupplier ZERO = v.a(0);
    ...
    public static final class State {
        ...
        public static final class Builder {
            ...
            public Builder setNewlyRenderedFirstFrame(boolean z4) {
                this.newlyRenderedFirstFrame = z4;
                return this;
            }
        ...
        public int hashCode() {
            int iHashCode = (((((((((this.availableCommands.hashCode() + MfaTencentErrorResult.TENCENT_ERROR_FACE_DETECTION_TIMED_OUT) * 31) + (this.playWhenReady ? 1 : 0)) * 31) + this.playWhenReadyChangeReason) * 31) + this.playbackState) * 31) + this.playbackSuppressionReason) * 31;
        ...
        private State(Builder builder) {
            ...
            PositionSupplier positionSupplierB = builder.contentPositionMs != null ? (builder.currentAdGroupIndex == -1 && builder.playWhenReady && builder.playbackState == 3 && builder.playbackSuppressionReason == 0 && builder.contentPositionMs.longValue() != C.TIME_UNSET) ? v.b(builder.contentPositionMs.longValue(), builder.playbackParameters.speed) : v.a(builder.contentPositionMs.longValue()) : builder.contentPositionMsSupplier;
            PositionSupplier positionSupplierB2 = builder.adPositionMs != null ? (builder.currentAdGroupIndex != -1 && builder.playWhenReady && builder.playbackState == 3 && builder.playbackSuppressionReason == 0) ? v.b(builder.adPositionMs.longValue(), 1.0f) : v.a(builder.adPositionMs.longValue()) : builder.adPositionMsSupplier;
    ...
    private static State buildStateForNewPosition(State.Builder builder, State state, long j, List<MediaItemData> list, int i, long j6, boolean z4) {
        ...
        if (!list.isEmpty() && j6 == C.TIME_UNSET) {
            j6 = Util.usToMs(list.get(i).defaultPositionUs);
        }
        boolean z8 = state.playlist.isEmpty() || list.isEmpty();
        if (!z8 && !((MediaItemData) state.playlist.get(getCurrentMediaItemIndexInternal(state))).uid.equals(list.get(i).uid)) {
            z5 = true;
        }
        if (z8 || z5 || j6 < positionOrDefaultInMediaItem) {
            builder.setCurrentMediaItemIndex(i).setCurrentAd(-1, -1).setContentPositionMs(j6).setContentBufferedPositionMs(v.a(j6)).setTotalBufferedDurationMs(PositionSupplier.ZERO);
        } else if (j6 == positionOrDefaultInMediaItem) {
            builder.setCurrentMediaItemIndex(i);
            if (state.currentAdGroupIndex == -1 || !z4) {
                builder.setCurrentAd(-1, -1).setTotalBufferedDurationMs(v.a(getContentBufferedPositionMsInternal(state) - positionOrDefaultInMediaItem));
            } else {
                builder.setTotalBufferedDurationMs(v.a(state.adBufferedPositionMsSupplier.get() - state.adPositionMsSupplier.get()));
            }
        } else {
            builder.setCurrentMediaItemIndex(i).setCurrentAd(-1, -1).setContentPositionMs(j6).setContentBufferedPositionMs(v.a(Math.max(getContentBufferedPositionMsInternal(state), j6))).setTotalBufferedDurationMs(v.a(Math.max(0L, state.totalBufferedDurationMsSupplier.get() - (j6 - positionOrDefaultInMediaItem))));
        }
    ...
    private void clearVideoOutput(@Nullable Object obj) {
        ...
        if (shouldHandleCommand(27)) {
            updateStateForPendingOperation(handleClearVideoOutput(obj), new m(state, 4));
        }
    }
    ...
    private static int getMediaItemTransitionReason(State state, State state2, int i, boolean z4, Timeline.Window window) {
    ...
    private static int getPositionDiscontinuityReason(State state, State state2, boolean z4, Timeline.Window window, Timeline.Period period) {
    ...
    private static Player.PositionInfo getPositionInfo(State state, boolean z4, Timeline.Window window, Timeline.Period period) {
        MediaItem mediaItem;
        Object obj;
        int i;
        int i4;
        ...
        return new Player.PositionInfo(obj2, currentMediaItemIndexInternal, mediaItem, obj, i4, j, contentPositionMsInternal, state.currentAdGroupIndex, state.currentAdIndexInAdGroup);
    }
    ...
    private static State getStateWithNewPlaylist(State state, List<MediaItemData> list, Timeline.Period period) {
        ...
        long j6 = mediaItemIndexInNewPlaylist == -1 ? C.TIME_UNSET : j;
        ...
        return buildStateForNewPosition(builderBuildUpon, state, j, list, mediaItemIndexInNewPlaylist, j6, true);
    }
    ...
    public /* synthetic */ State lambda$addMediaItems$3(State state, List list, int i) {
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            arrayList.add(i4 + i, getPlaceholderMediaItemData((MediaItem) list.get(i4)));
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ y lambda$handleReplaceMediaItems$31(y yVar, Object obj) throws Exception {
        return yVar;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ State lambda$moveMediaItems$4(State state, int i, int i4, int i6) {
        ArrayList arrayList = new ArrayList(state.playlist);
        Util.moveItems(arrayList, i, i4, i6);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ State lambda$removeMediaItems$6(State state, int i, int i4) {
        ArrayList arrayList = new ArrayList(state.playlist);
        Util.removeRange(arrayList, i, i4);
        return getStateWithNewPlaylist(state, arrayList, this.period);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ State lambda$replaceMediaItems$5(State state, List list, int i, int i4) {
        ArrayList arrayList = new ArrayList(state.playlist);
        for (int i6 = 0; i6 < list.size(); i6++) {
            arrayList.add(i6 + i, getPlaceholderMediaItemData((MediaItem) list.get(i6)));
        }
        ...
        Util.removeRange(arrayList, i4, i);
        return getStateWithNewPlaylist(stateWithNewPlaylist, arrayList, this.period);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ State lambda$seekTo$10(boolean z4, State state, int i, long j) {
        return z4 ? state : getStateWithNewPlaylistAndPosition(state, state.playlist, i, j);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ State lambda$setDeviceMuted$28(State state, boolean z4) {
        return state.buildUpon().setIsDeviceMuted(z4).build();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ State lambda$setDeviceMuted$29(State state, boolean z4) {
        return state.buildUpon().setIsDeviceMuted(z4).build();
    }
    ...
    public /* synthetic */ State lambda$setMediaItemsInternal$2(List list, State state, int i, long j) {
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            arrayList.add(getPlaceholderMediaItemData((MediaItem) list.get(i4)));
        }
        return getStateWithNewPlaylistAndPosition(state, arrayList, i, j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ State lambda$setPlayWhenReady$1(State state, boolean z4) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ State lambda$setShuffleModeEnabled$9(State state, boolean z4) {
    ...
    public static /* synthetic */ State lambda$stop$12(State state) {
        return state.buildUpon().setPlaybackState(1).setTotalBufferedDurationMs(PositionSupplier.ZERO).setContentBufferedPositionMs(v.a(getContentPositionMsInternal(state))).setAdBufferedPositionMs(state.adPositionMsSupplier).setIsLoading(false).build();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateStateForPendingOperation$62(y yVar) {
        Util.castNonNull(this.state);
        this.pendingOperations.remove(yVar);
    ...
    private void setMediaItemsInternal(final List<MediaItem> list, final int i, final long j) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i, j), new N1.o() { // from class: androidx.media3.common.l
                @Override // N1.o
                public final Object get() {
                    return this.f7885a.lambda$setMediaItemsInternal$2(list, state, i, j);
                }
            });
        }
    }
    ...
    private void updateStateAndInformListeners(final State state, boolean z4, boolean z5) {
        ...
        boolean z8 = state2.playWhenReady != state.playWhenReady;
        boolean z9 = state2.playbackState != state.playbackState;
        ...
        int positionDiscontinuityReason = getPositionDiscontinuityReason(state2, state, z4, this.window, this.period);
        ...
        if (!zEquals) {
            ...
            final int i = 1;
            this.listeners.queueEvent(0, new ListenerSet.Event() { // from class: androidx.media3.common.i
        ...
        if (positionDiscontinuityReason != -1) {
            this.listeners.queueEvent(11, new G6.b(getPositionInfo(state2, false, this.window, this.period), getPositionInfo(state, state.hasPositionDiscontinuity, this.window, this.period), positionDiscontinuityReason));
        }
        if (mediaItemTransitionReason != -1) {
            final MediaItem mediaItem = state.timeline.isEmpty() ? null : ((MediaItemData) state.playlist.get(getCurrentMediaItemIndexInternal(state))).mediaItem;
            final int i4 = 0;
        ...
        if (!Util.areEqual(state2.playerError, state.playerError)) {
            final int i6 = 14;
            this.listeners.queueEvent(10, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i6) {
                        case 0:
        ...
        if (!state2.trackSelectionParameters.equals(state.trackSelectionParameters)) {
            final int i11 = 16;
            this.listeners.queueEvent(19, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i11) {
                        case 0:
        ...
        if (!currentTracksInternal.equals(currentTracksInternal2)) {
            this.listeners.queueEvent(2, new Xa.c(currentTracksInternal2, 19));
        }
        if (!mediaMetadataInternal.equals(mediaMetadataInternal2)) {
            this.listeners.queueEvent(14, new Xa.c(mediaMetadataInternal2, 20));
        }
        if (state2.isLoading != state.isLoading) {
            final int i12 = 17;
            this.listeners.queueEvent(3, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i12) {
                        case 0:
        ...
        if (z8 || z9) {
            final int i13 = 18;
            this.listeners.queueEvent(-1, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i13) {
                        case 0:
        ...
        if (z9) {
            final int i14 = 19;
            this.listeners.queueEvent(4, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i14) {
                        case 0:
        ...
        if (z8 || state2.playWhenReadyChangeReason != state.playWhenReadyChangeReason) {
            final int i15 = 20;
            this.listeners.queueEvent(5, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i15) {
                        case 0:
        ...
        if (state2.playbackSuppressionReason != state.playbackSuppressionReason) {
            final int i16 = 21;
            this.listeners.queueEvent(6, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i16) {
                        case 0:
        ...
        if (isPlaying(state2) != isPlaying(state)) {
            final int i17 = 22;
            this.listeners.queueEvent(7, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i17) {
                        case 0:
        ...
        if (!state2.playbackParameters.equals(state.playbackParameters)) {
            final int i18 = 23;
            this.listeners.queueEvent(12, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i18) {
                        case 0:
        ...
        if (state2.repeatMode != state.repeatMode) {
            final int i19 = 24;
            this.listeners.queueEvent(8, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i19) {
                        case 0:
        ...
        if (state2.shuffleModeEnabled != state.shuffleModeEnabled) {
            final int i20 = 0;
            this.listeners.queueEvent(9, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i20) {
                        case 0:
        ...
        if (state2.seekBackIncrementMs != state.seekBackIncrementMs) {
            final int i21 = 1;
            this.listeners.queueEvent(16, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i21) {
                        case 0:
        ...
        if (state2.seekForwardIncrementMs != state.seekForwardIncrementMs) {
            final int i22 = 2;
            this.listeners.queueEvent(17, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i22) {
                        case 0:
        ...
        if (state2.maxSeekToPreviousPositionMs != state.maxSeekToPreviousPositionMs) {
            final int i23 = 3;
            this.listeners.queueEvent(18, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i23) {
                        case 0:
        ...
        if (!state2.audioAttributes.equals(state.audioAttributes)) {
            final int i24 = 4;
            this.listeners.queueEvent(20, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i24) {
                        case 0:
        ...
        if (!state2.videoSize.equals(state.videoSize)) {
            final int i25 = 5;
            this.listeners.queueEvent(25, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i25) {
                        case 0:
        ...
        if (!state2.deviceInfo.equals(state.deviceInfo)) {
            final int i26 = 6;
            this.listeners.queueEvent(29, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i26) {
                        case 0:
        ...
        if (!state2.playlistMetadata.equals(state.playlistMetadata)) {
            final int i27 = 7;
            this.listeners.queueEvent(15, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i27) {
                        case 0:
        ...
        if (state.newlyRenderedFirstFrame) {
            this.listeners.queueEvent(26, new androidx.constraintlayout.core.state.a(11));
        }
        if (!state2.surfaceSize.equals(state.surfaceSize)) {
            final int i28 = 8;
            this.listeners.queueEvent(24, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i28) {
                        case 0:
        ...
        if (state2.volume != state.volume) {
            final int i29 = 9;
            this.listeners.queueEvent(22, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i29) {
                        case 0:
        ...
        if (state2.deviceVolume != state.deviceVolume || state2.isDeviceMuted != state.isDeviceMuted) {
            final int i30 = 10;
            this.listeners.queueEvent(30, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i30) {
                        case 0:
        ...
        if (!state2.currentCues.equals(state.currentCues)) {
            final int i31 = 11;
            this.listeners.queueEvent(27, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i31) {
                        case 0:
        ...
        if (!state2.timedMetadata.equals(state.timedMetadata) && state.timedMetadata.presentationTimeUs != C.TIME_UNSET) {
            final int i32 = 12;
            this.listeners.queueEvent(28, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i32) {
                        case 0:
        ...
        if (!state2.availableCommands.equals(state.availableCommands)) {
            final int i33 = 13;
            this.listeners.queueEvent(13, new ListenerSet.Event() { // from class: androidx.media3.common.g
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    switch (i33) {
                        case 0:
    ...
    private void updateStateForPendingOperation(y yVar, N1.o oVar) {
        updateStateForPendingOperation(yVar, oVar, false, false);
    }
    ...
    public final void addMediaItems(int i, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleAddMediaItems(iMin, list), new N1.o() { // from class: androidx.media3.common.o
            @Override // N1.o
            public final Object get() {
                return this.f7892a.lambda$addMediaItems$3(state, list, iMin);
            }
        });
    }
    ...
    public final void decreaseDeviceVolume() {
        ...
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(1), new m(state, 2));
        }
    }
    ...
    public y handleAddMediaItems(int i, List<MediaItem> list) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_CHANGE_MEDIA_ITEMS");
    }

    public y handleClearVideoOutput(@Nullable Object obj) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_VIDEO_SURFACE");
    }

    public y handleDecreaseDeviceVolume(int i) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_ADJUST_DEVICE_VOLUME or COMMAND_ADJUST_DEVICE_VOLUME_WITH_FLAGS");
    }

    public y handleIncreaseDeviceVolume(int i) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_ADJUST_DEVICE_VOLUME or COMMAND_ADJUST_DEVICE_VOLUME_WITH_FLAGS");
    }

    public y handleMoveMediaItems(int i, int i4, int i6) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_CHANGE_MEDIA_ITEMS");
    }
    ...
    public y handleRemoveMediaItems(int i, int i4) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_CHANGE_MEDIA_ITEMS");
    }

    public y handleReplaceMediaItems(int i, int i4, List<MediaItem> list) {
        return Util.transformFutureAsync(handleAddMediaItems(i4, list), new androidx.camera.core.impl.utils.futures.a(2, handleRemoveMediaItems(i, i4)));
    }

    public y handleSeek(int i, long j, int i4) {
        throw new IllegalStateException("Missing implementation to handle one of the COMMAND_SEEK_*");
    }

    public y handleSetAudioAttributes(AudioAttributes audioAttributes, boolean z4) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_AUDIO_ATTRIBUTES");
    }

    public y handleSetDeviceMuted(boolean z4, int i) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_ADJUST_DEVICE_VOLUME or COMMAND_ADJUST_DEVICE_VOLUME_WITH_FLAGS");
    }

    public y handleSetDeviceVolume(@IntRange(from = 0) int i, int i4) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_DEVICE_VOLUME or COMMAND_SET_DEVICE_VOLUME_WITH_FLAGS");
    }

    public y handleSetMediaItems(List<MediaItem> list, int i, long j) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_MEDIA_ITEM(S)");
    }

    public y handleSetPlayWhenReady(boolean z4) {
    ...
    public y handleSetRepeatMode(int i) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_REPEAT_MODE");
    }

    public y handleSetShuffleModeEnabled(boolean z4) {
    ...
    public y handleSetVolume(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f) {
    ...
    public final void increaseDeviceVolume() {
        ...
        State state = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleIncreaseDeviceVolume(1), new m(state, 5));
        }
    }
    ...
    @Override // androidx.media3.common.Player
    public final void moveMediaItems(final int i, int i4, int i6) {
        verifyApplicationThreadAndInitState();
        Assertions.checkArgument(i >= 0 && i4 >= i && i6 >= 0);
        final State state = this.state;
        int size = state.playlist.size();
        if (shouldHandleCommand(20) && size != 0 && i < size) {
            final int iMin = Math.min(i4, size);
            final int iMin2 = Math.min(i6, state.playlist.size() - (iMin - i));
            if (i != iMin && iMin2 != i) {
                updateStateForPendingOperation(handleMoveMediaItems(i, iMin, iMin2), new N1.o() { // from class: androidx.media3.common.q
                    @Override // N1.o
                    public final Object get() {
                        return this.f7897a.lambda$moveMediaItems$4(state, i, iMin, iMin2);
                    }
                });
            }
        }
    ...
    public final void prepare() {
        ...
        if (shouldHandleCommand(2)) {
            updateStateForPendingOperation(handlePrepare(), new m(state, 7));
        }
    }
    ...
    public final void release() {
        ...
        if (shouldHandleCommand(32)) {
            updateStateForPendingOperation(handleRelease(), new m(state, 3));
            this.released = true;
            this.listeners.release();
            this.state = this.state.buildUpon().setPlaybackState(1).setTotalBufferedDurationMs(PositionSupplier.ZERO).setContentBufferedPositionMs(v.a(getContentPositionMsInternal(state))).setAdBufferedPositionMs(state.adPositionMsSupplier).setIsLoading(false).build();
        }
    }
    ...
    public final void removeMediaItems(final int i, int i4) {
        ...
        final State state = this.state;
        int size = state.playlist.size();
        if (!shouldHandleCommand(20) || size == 0 || i >= size || i == (iMin = Math.min(i4, size))) {
            return;
        }
        updateStateForPendingOperation(handleRemoveMediaItems(i, iMin), new N1.o() { // from class: androidx.media3.common.s
            @Override // N1.o
            public final Object get() {
                return this.f7903a.lambda$removeMediaItems$6(state, i, iMin);
            }
        });
    }
    ...
    public final void replaceMediaItems(final int i, int i4, final List<MediaItem> list) {
        ...
        final int iMin = Math.min(i4, size);
        updateStateForPendingOperation(handleReplaceMediaItems(i, iMin, list), new N1.o() { // from class: androidx.media3.common.k
            @Override // N1.o
            public final Object get() {
                return this.f7882a.lambda$replaceMediaItems$5(state, list, iMin, i);
            }
        });
    }
    ...
    public final void seekTo(final int i, final long j, int i4, boolean z4) {
        verifyApplicationThreadAndInitState();
        Assertions.checkArgument(i == -1 || i >= 0);
        final State state = this.state;
        if (shouldHandleCommand(i4)) {
            final boolean z5 = i == -1 || isPlayingAd() || (!state.playlist.isEmpty() && i >= state.playlist.size());
            updateStateForPendingOperation(handleSeek(i, j, i4), new N1.o() { // from class: androidx.media3.common.r
                @Override // N1.o
                public final Object get() {
                    return SimpleBasePlayer.lambda$seekTo$10(z5, state, i, j);
                }
            }, !z5, z4);
        }
    }
    ...
    public final void setAudioAttributes(AudioAttributes audioAttributes, boolean z4) {
        ...
        if (shouldHandleCommand(35)) {
            updateStateForPendingOperation(handleSetAudioAttributes(audioAttributes, z4), new j(state, audioAttributes, 4));
        }
    }
    ...
    public final void setDeviceMuted(boolean z4) {
        ...
        State state = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z4, 1), new f(state, z4, 2));
        }
    }
    ...
    public final void setDeviceVolume(int i) {
        ...
        if (shouldHandleCommand(25)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i, 1), new h(state, i, 0));
        }
    }
    ...
    public final void setMediaItems(List<MediaItem> list, boolean z4) {
        verifyApplicationThreadAndInitState();
        setMediaItemsInternal(list, z4 ? -1 : this.state.currentMediaItemIndex, z4 ? C.TIME_UNSET : this.state.contentPositionMsSupplier.get());
    }
    ...
    public final void setPlayWhenReady(boolean z4) {
        ...
        if (shouldHandleCommand(1)) {
            updateStateForPendingOperation(handleSetPlayWhenReady(z4), new f(state, z4, 0));
        }
    }
    ...
    public final void setPlaybackParameters(PlaybackParameters playbackParameters) {
        ...
        if (shouldHandleCommand(13)) {
            updateStateForPendingOperation(handleSetPlaybackParameters(playbackParameters), new j(state, playbackParameters, 5));
        }
    }
    ...
    public final void setPlaylistMetadata(MediaMetadata mediaMetadata) {
        ...
        if (shouldHandleCommand(19)) {
            updateStateForPendingOperation(handleSetPlaylistMetadata(mediaMetadata), new j(state, mediaMetadata, 1));
        }
    }
    ...
    public final void setRepeatMode(int i) {
        ...
        if (shouldHandleCommand(15)) {
            updateStateForPendingOperation(handleSetRepeatMode(i), new h(state, i, 2));
        }
    }
    ...
    public final void setShuffleModeEnabled(boolean z4) {
        ...
        if (shouldHandleCommand(14)) {
            updateStateForPendingOperation(handleSetShuffleModeEnabled(z4), new f(state, z4, 1));
        }
    }
    ...
    public final void setTrackSelectionParameters(TrackSelectionParameters trackSelectionParameters) {
        ...
        if (shouldHandleCommand(29)) {
            updateStateForPendingOperation(handleSetTrackSelectionParameters(trackSelectionParameters), new j(state, trackSelectionParameters, 6));
        }
    }
    ...
    public final void setVideoSurface(@Nullable Surface surface) {
        ...
        if (shouldHandleCommand(27)) {
            if (surface == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surface), new m(state, 0));
            }
        }
    }
    ...
    public final void setVideoSurfaceHolder(@Nullable SurfaceHolder surfaceHolder) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceHolder == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceHolder), new j(state, surfaceHolder, 2));
            }
        }
    }
    ...
    public final void setVideoSurfaceView(@Nullable SurfaceView surfaceView) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceView == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceView), new j(state, surfaceView, 3));
            }
        }
    }
    ...
    public final void setVideoTextureView(@Nullable TextureView textureView) {
        ...
        if (shouldHandleCommand(27)) {
            if (textureView == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(textureView), new j(state, textureView.isAvailable() ? new Size(textureView.getWidth(), textureView.getHeight()) : Size.ZERO, 0));
            }
        }
    }
    ...
    public final void setVolume(final float f) {
        ...
        if (shouldHandleCommand(24)) {
            updateStateForPendingOperation(handleSetVolume(f), new N1.o() { // from class: androidx.media3.common.p
                @Override // N1.o
                public final Object get() {
    ...
    public final void stop() {
        ...
        if (shouldHandleCommand(3)) {
            updateStateForPendingOperation(handleStop(), new m(state, 6));
        }
    }
    ...
    public SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new Xa.c(this, 21));
    }

    private void updateStateForPendingOperation(y yVar, N1.o oVar, boolean z4, boolean z5) {
        if (yVar.isDone() && this.pendingOperations.isEmpty()) {
            updateStateAndInformListeners(getState(), z4, z5);
            return;
        }
        this.pendingOperations.add(yVar);
        updateStateAndInformListeners(getPlaceholderState((State) oVar.get()), z4, z5);
        yVar.addListener(new B5.g(28, this, yVar), new n(this, 0));
    }
    ...
    public final void decreaseDeviceVolume(int i) {
        ...
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(i), new m(state, 8));
        }
    }
    ...
    public final void increaseDeviceVolume(int i) {
        ...
        State state = this.state;
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleIncreaseDeviceVolume(i), new m(state, 1));
        }
    }
    ...
    public final void setDeviceMuted(boolean z4, int i) {
        ...
        State state = this.state;
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z4, i), new f(state, z4, 3));
        }
    }
    ...
    public final void setDeviceVolume(int i, int i4) {
        ...
        if (shouldHandleCommand(33)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i, i4), new h(state, i, 1));
        }
    }
}
