...
public final class GlProgram {
    ...
    public static final class Attribute {
        ...
        public static Attribute create(int i, int i4) {
            int[] iArr = new int[1];
            GLES20.glGetProgramiv(i, 35722, iArr, 0);
            int i6 = iArr[0];
            byte[] bArr = new byte[i6];
            GLES20.glGetActiveAttrib(i, i4, i6, new int[1], 0, new int[1], 0, new int[1], 0, bArr, 0);
    ...
    public static final class Uniform {
        ...
        private Uniform(String str, int i, int i4) {
            this.name = str;
            this.location = i;
            this.type = i4;
        }

        public static Uniform create(int i, int i4) {
            int[] iArr = new int[1];
            GLES20.glGetProgramiv(i, 35719, iArr, 0);
            int[] iArr2 = new int[1];
            int i6 = iArr[0];
            byte[] bArr = new byte[i6];
            GLES20.glGetActiveUniform(i, i4, i6, new int[1], 0, new int[1], 0, iArr2, 0, bArr, 0);
            String str = new String(bArr, 0, GlProgram.getCStringLength(bArr));
            return new Uniform(str, GlProgram.getUniformLocation(i, str), iArr2[0]);
        }

        public void bind(boolean z4) throws GlUtil.GlException {
            int i = this.type;
            if (i == 5124) {
            ...
            if (i == 35678 || i == GlProgram.GL_SAMPLER_EXTERNAL_2D_Y2Y_EXT || i == 36198) {
                ...
                GlUtil.checkGlError();
                int i4 = this.type;
                GlUtil.bindTexture(i4 == 35678 ? 3553 : 36197, this.texIdValue, (i4 != 35678 || z4) ? 9728 : 9729);
        ...
        public void setSamplerTexId(int i, int i4) {
            this.texIdValue = i;
    ...
    private static void addShader(int i, int i4, String str) throws GlUtil.GlException {
    ...
    public void setExternalTexturesRequireNearestSampling(boolean z4) {
        this.externalTexturesRequireNearestSampling = z4;
    }
    ...
    public void setSamplerTexIdUniform(String str, int i, int i4) {
        ((Uniform) Assertions.checkNotNull(this.uniformByName.get(str))).setSamplerTexId(i, i4);
    }
    ...
    public GlProgram(String str, String str2) throws GlUtil.GlException {
        ...
        for (int i4 = 0; i4 < iArr3[0]; i4++) {
            Uniform uniformCreate = Uniform.create(this.programId, i4);
            this.uniforms[i4] = uniformCreate;
