...
public class PlaybackException extends Exception {
    ...
    @UnstableApi
    public PlaybackException(@Nullable String str, @Nullable Throwable th2, int i) {
        this(str, th2, i, Bundle.EMPTY, Clock.DEFAULT.elapsedRealtime());
    }
    ...
    @UnstableApi
    public PlaybackException(@Nullable String str, @Nullable Throwable th2, int i, Bundle bundle) {
        this(str, th2, i, bundle, Clock.DEFAULT.elapsedRealtime());
    }
    ...
    @UnstableApi
    public PlaybackException(@Nullable String str, @Nullable Throwable th2, int i, Bundle bundle, long j) {
        super(str, th2);
        this.errorCode = i;
        this.extras = bundle;
        this.timestampMs = j;
