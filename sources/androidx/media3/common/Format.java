...
public final class Format {
    ...
    @Nullable
    private static <T> T defaultIfNull(@Nullable T t5, @Nullable T t10) {
    ...
    public static Format fromBundle(Bundle bundle) {
        ...
        if (parcelableArrayList == null) {
            ...
            listFromBundleList = BundleCollectionUtil.fromBundleList(new androidx.constraintlayout.core.state.a(5), parcelableArrayList);
        }
    ...
    private static String keyForInitializationData(int i) {
        return FIELD_INITIALIZATION_DATA + Global.UNDERSCORE + Integer.toString(i, 36);
    }
    ...
    public static String toLogString(@Nullable Format format) {
        ...
        StringBuilder sbW = androidx.camera.core.impl.a.w("id=");
        sbW.append(format.id);
        sbW.append(", mimeType=");
        sbW.append(format.sampleMimeType);
        if (format.containerMimeType != null) {
            sbW.append(", container=");
            sbW.append(format.containerMimeType);
        }
        if (format.bitrate != -1) {
            sbW.append(", bitrate=");
            sbW.append(format.bitrate);
        }
        if (format.codecs != null) {
            sbW.append(", codecs=");
            sbW.append(format.codecs);
        }
        if (format.drmInitData != null) {
            ...
            sbW.append(", drm=[");
            new N1.h(String.valueOf(',')).a(sbW, linkedHashSet.iterator());
            sbW.append(']');
        }
        if (format.width != -1 && format.height != -1) {
            sbW.append(", res=");
            sbW.append(format.width);
            sbW.append("x");
            sbW.append(format.height);
        }
        ColorInfo colorInfo = format.colorInfo;
        if (colorInfo != null && colorInfo.isValid()) {
            sbW.append(", color=");
            sbW.append(format.colorInfo.toLogString());
        }
        if (format.frameRate != -1.0f) {
            sbW.append(", fps=");
            sbW.append(format.frameRate);
        }
        if (format.channelCount != -1) {
            sbW.append(", channels=");
            sbW.append(format.channelCount);
        }
        if (format.sampleRate != -1) {
            sbW.append(", sample_rate=");
            sbW.append(format.sampleRate);
        }
        if (format.language != null) {
            sbW.append(", language=");
            sbW.append(format.language);
        }
        if (!format.labels.isEmpty()) {
            sbW.append(", labels=[");
            new N1.h(String.valueOf(',')).a(sbW, format.labels.iterator());
            sbW.append("]");
        }
        if (format.selectionFlags != 0) {
            sbW.append(", selectionFlags=[");
            new N1.h(String.valueOf(',')).a(sbW, Util.getSelectionFlagStrings(format.selectionFlags).iterator());
            sbW.append("]");
        }
        if (format.roleFlags != 0) {
            sbW.append(", roleFlags=[");
            new N1.h(String.valueOf(',')).a(sbW, Util.getRoleFlagStrings(format.roleFlags).iterator());
            sbW.append("]");
        }
        if (format.customData != null) {
            sbW.append(", customData=");
            sbW.append(format.customData);
        }
        return sbW.toString();
    }
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            ...
            this.hashCode = ((((((((((((((((((((Float.floatToIntBits(this.pixelWidthHeightRatio) + ((((Float.floatToIntBits(this.frameRate) + ((((((((((iHashCode7 + (str6 != null ? str6.hashCode() : 0)) * 31) + this.maxInputSize) * 31) + ((int) this.subsampleOffsetUs)) * 31) + this.width) * 31) + this.height) * 31)) * 31) + this.rotationDegrees) * 31)) * 31) + this.stereoMode) * 31) + this.channelCount) * 31) + this.sampleRate) * 31) + this.pcmEncoding) * 31) + this.encoderDelay) * 31) + this.encoderPadding) * 31) + this.accessibilityChannel) * 31) + this.tileCountHorizontal) * 31) + this.tileCountVertical) * 31) + this.cryptoType;
        }
    ...
    public String toString() {
        ...
        sb2.append(", ");
        return We.s.o(sb2, "])", this.sampleRate);
    }
    ...
    public Format withManifestFormatInfo(Format format) {
        ...
        return buildUpon().setId(str2).setLabel(str3).setLabels(list).setLanguage(str4).setSelectionFlags(this.selectionFlags | format.selectionFlags).setRoleFlags(this.roleFlags | format.roleFlags).setAverageBitrate(i6).setPeakBitrate(i10).setCodecs(str5).setMetadata(metadataCopyWithAppendedEntriesFrom).setDrmInitData(DrmInitData.createSessionCreationData(format.drmInitData, this.drmInitData)).setFrameRate(f).setTileCountHorizontal(i).setTileCountVertical(i4).build();
    }
    ...
    private Format(Builder builder) {
        ...
        if (builder.labels.isEmpty() && builder.label != null) {
            this.labels = S.p(new Label(strNormalizeLanguageCode, builder.label));
        ...
        this.averageBitrate = i;
        int i4 = builder.peakBitrate;
        this.peakBitrate = i4;
        this.bitrate = i4 != -1 ? i4 : i;
    ...
    public Bundle toBundle(boolean z4) {
        ...
        bundle.putParcelableArrayList(FIELD_LABELS, BundleCollectionUtil.toBundleArrayList(this.labels, new androidx.constraintlayout.core.state.a(6)));
