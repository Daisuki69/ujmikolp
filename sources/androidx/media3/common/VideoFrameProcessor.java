...
public interface VideoFrameProcessor {
    ...
    public interface Factory {
        VideoFrameProcessor create(Context context, DebugViewProvider debugViewProvider, ColorInfo colorInfo, boolean z4, Executor executor, Listener listener) throws VideoFrameProcessingException;
    }
