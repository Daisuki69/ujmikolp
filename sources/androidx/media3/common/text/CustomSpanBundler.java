...
final class CustomSpanBundler {
    ...
    public static void unbundleAndApplyCustomSpan(Bundle bundle, Spannable spannable) {
        ...
        int i4 = bundle.getInt(FIELD_END_INDEX);
        int i6 = bundle.getInt(FIELD_FLAGS);
        int i10 = bundle.getInt(FIELD_TYPE, -1);
        Bundle bundle2 = bundle.getBundle(FIELD_PARAMS);
        if (i10 == 1) {
            spannable.setSpan(RubySpan.fromBundle((Bundle) Assertions.checkNotNull(bundle2)), i, i4, i6);
        } else if (i10 == 2) {
            spannable.setSpan(TextEmphasisSpan.fromBundle((Bundle) Assertions.checkNotNull(bundle2)), i, i4, i6);
        } else {
            if (i10 != 3) {
                return;
            }
            spannable.setSpan(new HorizontalTextInVerticalContextSpan(), i, i4, i6);
        }
    }
}
