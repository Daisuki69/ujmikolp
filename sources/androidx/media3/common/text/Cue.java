...
public final class Cue {
    ...
    private Cue(@Nullable CharSequence charSequence, @Nullable Layout.Alignment alignment, @Nullable Layout.Alignment alignment2, @Nullable Bitmap bitmap, float f, int i, int i4, float f3, int i6, int i10, float f7, float f10, float f11, boolean z4, int i11, int i12, float f12) {
        if (charSequence == null) {
