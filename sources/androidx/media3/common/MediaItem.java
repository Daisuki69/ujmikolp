...
public final class MediaItem {
    ...
    public static final class Builder {
        ...
        private S subtitleConfigurations;
        ...
        @UnstableApi
        @Deprecated
        public Builder setClipRelativeToDefaultPosition(boolean z4) {
        ...
        @UnstableApi
        @Deprecated
        public Builder setClipRelativeToLiveWindow(boolean z4) {
        ...
        @UnstableApi
        @Deprecated
        public Builder setClipStartsAtKeyFrame(boolean z4) {
        ...
        @UnstableApi
        @Deprecated
        public Builder setDrmForceDefaultLicenseUri(boolean z4) {
        ...
        @UnstableApi
        @Deprecated
        public Builder setDrmMultiSession(boolean z4) {
        ...
        @UnstableApi
        @Deprecated
        public Builder setDrmPlayClearContentWithoutKey(boolean z4) {
        ...
        @UnstableApi
        @Deprecated
        public Builder setDrmSessionForClearPeriods(boolean z4) {
        ...
        public Builder setSubtitleConfigurations(List<SubtitleConfiguration> list) {
            this.subtitleConfigurations = S.k(list);
            return this;
        }
        ...
        public Builder setSubtitles(@Nullable List<Subtitle> list) {
            ...
            this.subtitleConfigurations = sK;
            return this;
        }
        ...
        public Builder() {
            ...
            P p10 = S.f4555b;
            this.subtitleConfigurations = t0.e;
    ...
    public static class ClippingConfiguration {
        ...
        public static final class Builder {
            ...
            public Builder setRelativeToDefaultPosition(boolean z4) {
                this.relativeToDefaultPosition = z4;
                return this;
            }

            public Builder setRelativeToLiveWindow(boolean z4) {
            ...
            public Builder setStartsAtKeyFrame(boolean z4) {
        ...
        public static ClippingProperties fromBundle(Bundle bundle) {
            ...
            long j6 = bundle.getLong(FIELD_END_POSITION_US, clippingConfiguration.endPositionUs);
            if (j6 != clippingConfiguration.endPositionUs) {
                startsAtKeyFrame.setEndPositionUs(j6);
            }
        ...
        public int hashCode() {
            ...
            return ((((((i + ((int) ((j6 >>> 32) ^ j6))) * 31) + (this.relativeToLiveWindow ? 1 : 0)) * 31) + (this.relativeToDefaultPosition ? 1 : 0)) * 31) + (this.startsAtKeyFrame ? 1 : 0);
        }
        ...
        public Bundle toBundle() {
            ...
            boolean z8 = this.startsAtKeyFrame;
            if (z8 != clippingConfiguration.startsAtKeyFrame) {
                bundle.putBoolean(FIELD_STARTS_AT_KEY_FRAME, z8);
            }
            return bundle;
        }
    ...
    public static final class DrmConfiguration {
        ...
        public final S forcedSessionTrackTypes;

        @Nullable
        private final byte[] keySetId;
        public final X licenseRequestHeaders;
        ...
        @UnstableApi
        @Deprecated
        public final X requestHeaders;
        public final UUID scheme;

        @UnstableApi
        @Deprecated
        public final S sessionForClearTypes;
        ...
        public static final class Builder {
            ...
            private S forcedSessionTrackTypes;

            @Nullable
            private byte[] keySetId;
            private X licenseRequestHeaders;
            ...
            @UnstableApi
            @Deprecated
            public Builder forceSessionsForAudioAndVideoTracks(boolean z4) {
                return setForceSessionsForAudioAndVideoTracks(z4);
            }

            public Builder setForceDefaultLicenseUri(boolean z4) {
                this.forceDefaultLicenseUri = z4;
                return this;
            }

            public Builder setForceSessionsForAudioAndVideoTracks(boolean z4) {
                t0 t0VarQ;
                if (z4) {
                    t0VarQ = S.q(2, 1);
                } else {
                ...
                setForcedSessionTrackTypes(t0VarQ);
                return this;
            }

            public Builder setForcedSessionTrackTypes(List<Integer> list) {
                this.forcedSessionTrackTypes = S.k(list);
                return this;
            }
            ...
            public Builder setLicenseRequestHeaders(Map<String, String> map) {
                this.licenseRequestHeaders = X.a(map);
                return this;
            }
            ...
            public Builder setPlayClearContentWithoutKey(boolean z4) {
            ...
            @Deprecated
            private Builder() {
                this.licenseRequestHeaders = y0.f4618g;
                this.playClearContentWithoutKey = true;
                P p10 = S.f4555b;
                this.forcedSessionTrackTypes = t0.e;
            }
        ...
        public static DrmConfiguration fromBundle(Bundle bundle) {
            ...
            X xBundleToStringImmutableMap = BundleCollectionUtil.bundleToStringImmutableMap(BundleCollectionUtil.getBundleWithDefault(bundle, FIELD_LICENSE_REQUEST_HEADERS, Bundle.EMPTY));
            ...
            boolean z8 = bundle.getBoolean(FIELD_FORCE_DEFAULT_LICENSE_URI, false);
            S sK = S.k(BundleCollectionUtil.getIntegerArrayListWithDefault(bundle, FIELD_FORCED_SESSION_TRACK_TYPES, new ArrayList()));
            return new Builder(uuidFromString).setLicenseUri(uri).setLicenseRequestHeaders(xBundleToStringImmutableMap).setMultiSession(z4).setForceDefaultLicenseUri(z8).setPlayClearContentWithoutKey(z5).setForcedSessionTrackTypes(sK).setKeySetId(bundle.getByteArray(FIELD_KEY_SET_ID)).build();
        }
        ...
        public Bundle toBundle() {
            ...
            boolean z8 = this.forceDefaultLicenseUri;
            if (z8) {
                bundle.putBoolean(FIELD_FORCE_DEFAULT_LICENSE_URI, z8);
            }
    ...
    public static final class LiveConfiguration {
        ...
        public Bundle toBundle() {
            ...
            long j6 = this.minOffsetMs;
            if (j6 != liveConfiguration.minOffsetMs) {
                bundle.putLong(FIELD_MIN_OFFSET_MS, j6);
            }
            long j7 = this.maxOffsetMs;
            if (j7 != liveConfiguration.maxOffsetMs) {
                bundle.putLong(FIELD_MAX_OFFSET_MS, j7);
            }
            float f = this.minPlaybackSpeed;
        ...
        @UnstableApi
        @Deprecated
        public LiveConfiguration(long j, long j6, long j7, float f, float f3) {
            this.targetOffsetMs = j;
            this.minOffsetMs = j6;
            this.maxOffsetMs = j7;
            this.minPlaybackSpeed = f;
    ...
    public static final class LocalConfiguration {
        ...
        public final S subtitleConfigurations;
        ...
        public static LocalConfiguration fromBundle(Bundle bundle) {
            ...
            if (parcelableArrayList == null) {
                ...
                listFromBundleList = BundleCollectionUtil.fromBundleList(new androidx.constraintlayout.core.state.a(9), parcelableArrayList);
            }
            ...
            if (parcelableArrayList2 == null) {
                P p11 = S.f4555b;
                sFromBundleList = t0.e;
            } else {
                sFromBundleList = BundleCollectionUtil.fromBundleList(new androidx.constraintlayout.core.state.a(10), parcelableArrayList2);
            }
            return new LocalConfiguration((Uri) Assertions.checkNotNull((Uri) bundle.getParcelable(FIELD_URI)), bundle.getString(FIELD_MIME_TYPE), drmConfigurationFromBundle, adsConfigurationFromBundle, list, bundle.getString(FIELD_CUSTOM_CACHE_KEY), sFromBundleList, null, bundle.getLong(FIELD_IMAGE_DURATION_MS, C.TIME_UNSET));
        }
        ...
        public Bundle toBundle() {
            ...
            if (!this.streamKeys.isEmpty()) {
                bundle.putParcelableArrayList(FIELD_STREAM_KEYS, BundleCollectionUtil.toBundleArrayList(this.streamKeys, new androidx.constraintlayout.core.state.a(7)));
            }
            String str2 = this.customCacheKey;
            if (str2 != null) {
            ...
            if (!this.subtitleConfigurations.isEmpty()) {
                bundle.putParcelableArrayList(FIELD_SUBTITLE_CONFIGURATION, BundleCollectionUtil.toBundleArrayList(this.subtitleConfigurations, new androidx.constraintlayout.core.state.a(8)));
            }
        ...
        private LocalConfiguration(Uri uri, @Nullable String str, @Nullable DrmConfiguration drmConfiguration, @Nullable AdsConfiguration adsConfiguration, List<StreamKey> list, @Nullable String str2, S s9, @Nullable Object obj, long j) {
            this.uri = uri;
            ...
            this.subtitleConfigurations = s9;
            O oJ = S.j();
            for (int i = 0; i < s9.size(); i++) {
                oJ.a(((SubtitleConfiguration) s9.get(i)).buildUpon().buildSubtitle());
            }
            this.subtitles = oJ.g();
            this.tag = obj;
            this.imageDurationMs = j;
    ...
    public static final class Subtitle extends SubtitleConfiguration {
        ...
        @UnstableApi
        @Deprecated
        public Subtitle(Uri uri, String str, @Nullable String str2, int i, int i4, @Nullable String str3) {
            super(uri, str, str2, i, i4, str3, null);
        }
    ...
    @UnstableApi
    private Bundle toBundle(boolean z4) {
        LocalConfiguration localConfiguration;
        Bundle bundle = new Bundle();
        ...
        if (z4 && (localConfiguration = this.localConfiguration) != null) {
    ...
    public static class SubtitleConfiguration {
        ...
        public static SubtitleConfiguration fromBundle(Bundle bundle) {
            ...
            return new Builder(uri).setMimeType(string).setLanguage(string2).setSelectionFlags(i).setRoleFlags(i4).setLabel(string3).setId(bundle.getString(FIELD_ID)).build();
        }
        ...
        private SubtitleConfiguration(Uri uri, String str, @Nullable String str2, int i, int i4, @Nullable String str3, @Nullable String str4) {
            this.uri = uri;
            this.mimeType = MimeTypes.normalizeMimeType(str);
            this.language = str2;
            this.selectionFlags = i;
