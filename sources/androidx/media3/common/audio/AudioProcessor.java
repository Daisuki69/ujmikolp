...
public interface AudioProcessor {
    ...
    public static final class AudioFormat {
        ...
        public String toString() {
            ...
            sb2.append(", encoding=");
            return s.m(sb2, this.encoding, ']');
        }

        public AudioFormat(int i, int i4, int i6) {
            this.sampleRate = i;
            this.channelCount = i4;
            this.encoding = i6;
            this.bytesPerFrame = Util.isEncodingLinearPcm(i6) ? Util.getPcmFrameSize(i6, i4) : -1;
        }
    }
    ...
    public static final class UnhandledAudioFormatException extends Exception {
        ...
        public UnhandledAudioFormatException(String str, AudioFormat audioFormat) {
            super(str + Global.BLANK + audioFormat);
