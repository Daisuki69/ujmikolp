...
public class ForwardingPlayer implements Player {
    ...
    public static final class ForwardingListener implements Player.Listener {
        ...
        public void onDeviceVolumeChanged(int i, boolean z4) {
            this.listener.onDeviceVolumeChanged(i, z4);
        }
        ...
        public void onPlayWhenReadyChanged(boolean z4, int i) {
            this.listener.onPlayWhenReadyChanged(z4, i);
        }
        ...
        public void onPlayerStateChanged(boolean z4, int i) {
            this.listener.onPlayerStateChanged(z4, i);
        }
        ...
        public void onSurfaceSizeChanged(int i, int i4) {
            this.listener.onSurfaceSizeChanged(i, i4);
        }
    ...
    public void moveMediaItem(int i, int i4) {
        this.player.moveMediaItem(i, i4);
    }
