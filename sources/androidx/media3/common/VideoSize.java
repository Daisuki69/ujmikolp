...
public final class VideoSize {
    ...
    @UnstableApi
    public VideoSize(@IntRange(from = 0) int i, @IntRange(from = 0) int i4) {
        this(i, i4, 0, 1.0f);
    }
    ...
    public int hashCode() {
        return Float.floatToRawIntBits(this.pixelWidthHeightRatio) + ((((((MfaTencentErrorResult.TENCENT_ERROR_FACE_DETECTION_TIMED_OUT + this.width) * 31) + this.height) * 31) + this.unappliedRotationDegrees) * 31);
    }
    ...
    @UnstableApi
    public VideoSize(@IntRange(from = 0) int i, @IntRange(from = 0) int i4, @IntRange(from = 0, to = 359) int i6, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, fromInclusive = false) float f) {
        this.width = i;
        this.height = i4;
        this.unappliedRotationDegrees = i6;
