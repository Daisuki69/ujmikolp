...
public class StandaloneDatabaseProvider extends SQLiteOpenHelper implements DatabaseProvider {
    ...
    private static void wipeDatabase(SQLiteDatabase sQLiteDatabase) {
        Cursor cursorQuery = sQLiteDatabase.query("sqlite_master", new String[]{SessionDescription.ATTR_TYPE, AppMeasurementSdk.ConditionalUserProperty.NAME}, null, null, null, null, null);
