...
public final class DefaultExtractorsFactory implements ExtractorsFactory {
    ...
    private static final ExtensionLoader FLAC_EXTENSION_LOADER = new ExtensionLoader(new androidx.constraintlayout.core.state.a(25));
    private static final ExtensionLoader MIDI_EXTENSION_LOADER = new ExtensionLoader(new androidx.constraintlayout.core.state.a(26));
    ...
    public synchronized DefaultExtractorsFactory setConstantBitrateSeekingAlwaysEnabled(boolean z4) {
        this.constantBitrateSeekingAlwaysEnabled = z4;
        return this;
    }
    ...
    public synchronized DefaultExtractorsFactory setTsSubtitleFormats(List<Format> list) {
        this.tsSubtitleFormats = S.k(list);
        return this;
    }
    ...
    public synchronized Extractor[] createExtractors(Uri uri, Map<String, List<String>> map) {
        ...
        try {
            ...
            for (int i4 = 0; i4 < arrayList.size(); i4++) {
                Extractor subtitleTranscodingExtractor = (Extractor) arrayList.get(i4);
                ...
                extractorArr[i4] = subtitleTranscodingExtractor;
            }
        } catch (Throwable th2) {
            throw th2;
        }
    ...
    public synchronized DefaultExtractorsFactory experimentalSetTextTrackTranscodingEnabled(boolean z4) {
        this.textTrackTranscodingEnabled = z4;
        return this;
    }

    @Override // androidx.media3.extractor.ExtractorsFactory
    /* JADX INFO: renamed from: setSubtitleParserFactory */
    public synchronized DefaultExtractorsFactory mo74setSubtitleParserFactory(SubtitleParser.Factory factory) {
