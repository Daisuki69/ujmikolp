...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public static final class MetadataSampleInfo {
        ...
        public MetadataSampleInfo(long j, boolean z4, int i) {
            this.sampleTimeUs = j;
    ...
    public static final class TrackBundle {
        ...
        public int outputSampleEncryptionData(int i, int i4) {
            ...
            boolean z4 = zSampleHasSubsampleEncryptionTable || i4 != 0;
            this.encryptionSignalByte.getData()[0] = (byte) ((z4 ? 128 : 0) | length);
    ...
    public FragmentedMp4Extractor() {
        ...
        P p10 = S.f4555b;
        this(factory, 32, null, null, t0.e, null);
    }
    ...
    private void initExtraTracks() {
        ...
        while (i4 < this.ceaTrackOutputs.length) {
            TrackOutput trackOutputTrack = this.extractorOutput.track(i6, 3);
            trackOutputTrack.format(this.closedCaptionFormats.get(i4));
            this.ceaTrackOutputs[i4] = trackOutputTrack;
            i4++;
            i6++;
        }
    }
    ...
    private void onEmsgLeafAtomRead(ParsableByteArray parsableByteArray) {
        ...
        if (fullAtomVersion == 0) {
            ...
            long j6 = j != C.TIME_UNSET ? j + jScaleLargeTimestamp : -9223372036854775807L;
            ...
            jAdjustSampleTimestamp = j6;
        } else {
            if (fullAtomVersion != 1) {
                androidx.camera.core.impl.a.y(fullAtomVersion, "Skipping unsupported emsg version: ", TAG);
                return;
            }
        ...
        long j7 = jAdjustSampleTimestamp;
        for (TrackOutput trackOutput2 : this.emsgTrackOutputs) {
            trackOutput2.sampleMetadata(j7, 1, iBytesLeft, 0, null);
        }
    }
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> traks = AtomParsers.parseTraks(containerAtom, new GaplessInfoHolder(), mehd, drmInitDataFromAtoms, (this.flags & 16) != 0, false, new c(this, 25));
    ...
    private void outputPendingMetadataSamples(long j) {
        while (!this.pendingMetadataSampleInfos.isEmpty()) {
            ...
            long j6 = jAdjustSampleTimestamp;
            for (TrackOutput trackOutput : this.emsgTrackOutputs) {
                trackOutput.sampleMetadata(j6, 1, metadataSampleInfoRemoveFirst.size, this.pendingMetadataSampleBytes, null);
            }
        }
    }
    ...
    private static void parseMoof(Atom.ContainerAtom containerAtom, SparseArray<TrackBundle> sparseArray, boolean z4, int i, byte[] bArr) throws ParserException {
        int size = containerAtom.containerChildren.size();
        for (int i4 = 0; i4 < size; i4++) {
            Atom.ContainerAtom containerAtom2 = containerAtom.containerChildren.get(i4);
            if (containerAtom2.type == 1953653094) {
                parseTraf(containerAtom2, sparseArray, z4, i, bArr);
            }
        }
    }
    ...
    private static void parseSaiz(TrackEncryptionBox trackEncryptionBox, ParsableByteArray parsableByteArray, TrackFragment trackFragment) throws ParserException {
        ...
        if (unsignedIntToInt > trackFragment.sampleCount) {
            StringBuilder sbT = s.t(unsignedIntToInt, "Saiz sample count ", " is greater than fragment sample count");
        ...
        if (unsignedByte == 0) {
            ...
            for (int i6 = 0; i6 < unsignedIntToInt; i6++) {
                ...
                i += unsignedByte2;
                zArr[i6] = unsignedByte2 > i4;
            }
        } else {
            i = unsignedByte * unsignedIntToInt;
            Arrays.fill(trackFragment.sampleHasSubsampleEncryptionTable, 0, unsignedIntToInt, unsignedByte > i4);
        }
    ...
    private static void parseSampleGroups(Atom.ContainerAtom containerAtom, @Nullable String str, TrackFragment trackFragment) throws ParserException {
        ...
        int i6 = (unsignedByte & PsExtractor.VIDEO_STREAM_MASK) >> 4;
        ...
        if (z4) {
            ...
            trackFragment.trackEncryptionBox = new TrackEncryptionBox(z4, str, unsignedByte2, bArr2, i6, i10, bArr);
        }
    }
    ...
    @Nullable
    private static TrackBundle parseTfhd(ParsableByteArray parsableByteArray, SparseArray<TrackBundle> sparseArray, boolean z4) {
        parsableByteArray.setPosition(8);
        int fullAtomFlags = Atom.parseFullAtomFlags(parsableByteArray.readInt());
        TrackBundle trackBundleValueAt = z4 ? sparseArray.valueAt(0) : sparseArray.get(parsableByteArray.readInt());
    ...
    private static void parseTraf(Atom.ContainerAtom containerAtom, SparseArray<TrackBundle> sparseArray, boolean z4, int i, byte[] bArr) throws ParserException {
        TrackBundle tfhd = parseTfhd(((Atom.LeafAtom) Assertions.checkNotNull(containerAtom.getLeafAtomOfType(Atom.TYPE_tfhd))).data, sparseArray, z4);
        if (tfhd == null) {
            return;
        }
    ...
    private static int parseTrun(TrackBundle trackBundle, int i, int i4, ParsableByteArray parsableByteArray, int i6) throws ParserException {
        boolean z4;
        int i10;
        int i11;
        int i12;
        ...
        long j6 = isEdtsListDurationForEntireMediaTimeline(track) ? ((long[]) Util.castNonNull(track.editListMediaTimes))[0] : 0L;
        int[] iArr = trackFragment.sampleSizeTable;
        long[] jArr2 = trackFragment.samplePresentationTimesUs;
        boolean[] zArr = trackFragment.sampleIsSyncFrameTable;
        boolean z12 = z11;
        boolean z13 = track.type == 2 && (i4 & 1) != 0;
        int i18 = i6 + trackFragment.trunLength[i];
        boolean z14 = z5;
        long j7 = track.timescale;
        long j9 = trackFragment.nextFragmentDecodeTime;
        int i19 = i6;
        while (i19 < i18) {
            if (z8) {
            ...
            int iCheckNonNegative = checkNonNegative(i10);
            if (z9) {
            ...
            int i20 = i19;
            long jScaleLargeTimestamp = Util.scaleLargeTimestamp((((long) i16) + j9) - j6, 1000000L, j7);
            jArr2[i20] = jScaleLargeTimestamp;
            if (!trackFragment.nextFragmentDecodeTimeIncludesMoov) {
                jArr2[i20] = jScaleLargeTimestamp + trackBundle.moovSampleTable.durationUs;
            }
            iArr[i20] = i13;
            zArr[i20] = ((i15 >> 16) & 1) == 0 && (!z4 || i20 == 0);
            j9 += (long) iCheckNonNegative;
            i19 = i20 + 1;
            i18 = i11;
            z13 = z4;
        }
    ...
    private static void parseTruns(Atom.ContainerAtom containerAtom, TrackBundle trackBundle, int i) throws ParserException {
        ...
        trackBundle.fragment.initTables(i4, i6);
        int i11 = 0;
        int trun = 0;
        for (int i12 = 0; i12 < size; i12++) {
            Atom.LeafAtom leafAtom2 = list.get(i12);
            if (leafAtom2.type == 1953658222) {
                trun = parseTrun(trackBundle, i11, i, leafAtom2.data, trun);
                i11++;
            }
        }
    }
        ...
        if (track.nalUnitLengthFieldLength == 0) {
            ...
            while (this.sampleBytesWritten < this.sampleSize) {
                ...
                if (i15 == 0) {
                    ...
                    this.sampleCurrentNalBytesRemaining = i16 - 1;
                    this.nalStartCode.setPosition(0);
                    trackOutput.sampleData(this.nalStartCode, i4);
                    trackOutput.sampleData(this.nalPrefix, i6);
                    this.processSeiNalUnitPayload = (this.ceaTrackOutputs.length <= 0 || !NalUnitUtil.isNalUnitSei(track.format.sampleMimeType, data[i4])) ? 0 : i6;
                    ...
                    if (this.processSeiNalUnitPayload) {
                        ...
                        i = i6;
                        iSampleData = trackOutput.sampleData((DataReader) extractorInput, i15, false);
                    }
    ...
    public boolean sniff(ExtractorInput extractorInput) throws IOException {
        ...
        if (sniffFailureSniffFragmented != null) {
            t0VarP = S.p(sniffFailureSniffFragmented);
        } else {
            P p10 = S.f4555b;
            t0VarP = t0.e;
        }
    ...
    private static void parseSenc(ParsableByteArray parsableByteArray, int i, TrackFragment trackFragment) throws ParserException {
        ...
        if (unsignedIntToInt != trackFragment.sampleCount) {
            StringBuilder sbT = s.t(unsignedIntToInt, "Senc sample count ", " is different from fragment sample count");
            sbT.append(trackFragment.sampleCount);
            throw ParserException.createForMalformedContainer(sbT.toString(), null);
        }
        Arrays.fill(trackFragment.sampleHasSubsampleEncryptionTable, 0, unsignedIntToInt, z4);
    ...
    public FragmentedMp4Extractor(SubtitleParser.Factory factory) {
        this(factory, 0, null, null, t0.e, null);
        P p10 = S.f4555b;
    }
    ...
    public FragmentedMp4Extractor(int i) {
        ...
        int i4 = i | 32;
        P p10 = S.f4555b;
        this(factory, i4, null, null, t0.e, null);
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public FragmentedMp4Extractor(SubtitleParser.Factory factory, int i) {
        this(factory, i, null, null, t0.e, null);
        P p10 = S.f4555b;
    }
    ...
    public FragmentedMp4Extractor(int i, @Nullable TimestampAdjuster timestampAdjuster) {
        ...
        int i4 = i | 32;
        P p10 = S.f4555b;
        this(factory, i4, timestampAdjuster, null, t0.e, null);
    }
    ...
    public FragmentedMp4Extractor(int i, @Nullable TimestampAdjuster timestampAdjuster, @Nullable Track track) {
        ...
        int i4 = i | 32;
        P p10 = S.f4555b;
        this(factory, i4, timestampAdjuster, track, t0.e, null);
    }
