...
public final class AacUtil {
    ...
    public static final class Config {
        ...
        private Config(int i, int i4, String str) {
            this.sampleRateHz = i;
    ...
    public static byte[] buildAacLcAudioSpecificConfig(int i, int i4) {
        int i6 = 0;
        int i10 = -1;
        int i11 = 0;
        while (true) {
        ...
        if (i == -1 || i12 == -1) {
            throw new IllegalArgumentException(androidx.camera.core.impl.a.c(i, i4, "Invalid sample rate or number of channels: ", ", "));
        }
        return buildAudioSpecificConfig(2, i10, i12);
    }

    public static byte[] buildAudioSpecificConfig(int i, int i4, int i6) {
    ...
    private static void parseGaSpecificConfig(ParsableBitArray parsableBitArray, int i, int i4) {
    ...
    public static Config parseAudioSpecificConfig(ParsableBitArray parsableBitArray, boolean z4) throws ParserException {
        int audioObjectType = getAudioObjectType(parsableBitArray);
        int samplingFrequency = getSamplingFrequency(parsableBitArray);
        int bits = parsableBitArray.readBits(4);
        String strF = s.f(audioObjectType, CODECS_STRING_PREFIX);
        ...
        if (i != -1) {
            return new Config(samplingFrequency, i, strF);
        }
