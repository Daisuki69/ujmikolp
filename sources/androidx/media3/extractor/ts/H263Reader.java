...
public final class H263Reader implements ElementaryStreamReader {
    ...
    public static final class SampleReader {
        ...
        public void onData(byte[] bArr, int i, int i4) {
            if (this.lookingForVopCodingType) {
                ...
                int i10 = (i + 1) - i6;
                if (i10 >= i4) {
                    this.vopBytesRead = (i4 - i) + i6;
                } else {
                    this.sampleIsKeyframe = ((bArr[i10] & 192) >> 6) == 0;
         ...
         */
        public void onDataEnd(long j, int i, boolean z4) {
            Assertions.checkState(this.sampleTimeUs != C.TIME_UNSET);
            if (this.startCodeValue == H263Reader.START_CODE_VALUE_VOP && z4 && this.readingSample) {
    ...
    public void consume(ParsableByteArray parsableByteArray) {
        ...
        while (true) {
            ...
            int i4 = parsableByteArray.getData()[i] & 255;
            ...
            if (!this.hasOutputFormat) {
                ...
                if (this.csdBuffer.onStartCode(i4, i6 < 0 ? -i6 : 0)) {
            ...
            if (nalUnitTargetBuffer != null) {
                ...
                if (i4 == START_CODE_VALUE_USER_DATA && parsableByteArray.getData()[iFindNalUnit + 2] == 1) {
