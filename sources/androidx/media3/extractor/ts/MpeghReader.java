...
public final class MpeghReader implements ElementaryStreamReader {
    ...
    private void copyData(ParsableByteArray parsableByteArray, ParsableByteArray parsableByteArray2, boolean z4) {
    ...
    private void parseConfig(ParsableBitArray parsableBitArray) throws ParserException {
        ...
        long j6 = this.header.packetLabel;
        if (j != j6) {
            this.mainStreamLabel = j6;
            ...
            this.output.format(new Format.Builder().setId(this.formatId).setSampleMimeType(MimeTypes.AUDIO_MPEGH_MHM1).setSampleRate(this.samplingRate).setCodecs(strConcat).setInitializationData((bArr == null || bArr.length <= 0) ? null : S.q(Util.EMPTY_BYTE_ARRAY, bArr)).build());
        }
    ...
    private boolean skipToNextSync(ParsableByteArray parsableByteArray) {
        ...
        while (parsableByteArray.bytesLeft() > 0) {
            ...
            this.syncBytes = i4;
            int unsignedByte = i4 | parsableByteArray.readUnsignedByte();
