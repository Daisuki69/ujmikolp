...
public final class TsExtractor implements Extractor {
    ...
    @Deprecated
    public static final ExtractorsFactory FACTORY = new a(15);
        ...
        */
        ...
        public void consume(ParsableByteArray parsableByteArray) {
            ...
            while (iBytesLeft > 0) {
                ...
                int bits2 = this.pmtScratch.readBits(i4);
                ...
                iBytesLeft -= bits3 + 5;
                int i10 = TsExtractor.this.mode == 2 ? bits : bits2;
                if (!TsExtractor.this.trackIds.get(i10)) {
                    ...
                    if (TsExtractor.this.mode != 2 || bits2 < this.trackIdToPidScratch.get(i10, 8192)) {
                        this.trackIdToPidScratch.put(i10, bits2);
                        this.trackIdToReaderScratch.put(i10, tsPayloadReaderCreatePayloadReader);
                    }
                }
                i = 3;
                i6 = 4;
            ...
            for (int i11 = 0; i11 < size; i11++) {
                int iKeyAt = this.trackIdToPidScratch.keyAt(i11);
                int iValueAt = this.trackIdToPidScratch.valueAt(i11);
                TsExtractor.this.trackIds.put(iKeyAt, true);
                TsExtractor.this.trackPids.put(iValueAt, true);
                TsPayloadReader tsPayloadReaderValueAt = this.trackIdToReaderScratch.valueAt(i11);
    ...
    private int findEndOfFirstTsPacketInBuffer() throws ParserException {
        ...
        int i4 = (iFindSyncBytePosition - position) + this.bytesSinceLastSync;
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        boolean z4 = this.mode == 2;
        if (this.tracksEnded) {
            if (length != -1 && !z4 && !this.durationReader.isDurationReadFinished()) {
        ...
        if (!fillBufferWithAtLeastOnePacket(extractorInput)) {
            for (int i4 = 0; i4 < this.tsPayloadReaders.size(); i4++) {
                TsPayloadReader tsPayloadReaderValueAt = this.tsPayloadReaders.valueAt(i4);
                if (tsPayloadReaderValueAt instanceof PesReader) {
                    PesReader pesReader = (PesReader) tsPayloadReaderValueAt;
                    if (pesReader.canConsumeSynthesizedEmptyPusi(z4)) {
        ...
        int i6 = this.tsPacketBuffer.readInt();
        if ((8388608 & i6) != 0) {
            this.tsPacketBuffer.setPosition(iFindEndOfFirstTsPacketInBuffer);
            return 0;
        }
        int i10 = (4194304 & i6) != 0 ? 1 : 0;
        int i11 = (2096896 & i6) >> 8;
        boolean z5 = (i6 & 32) != 0;
        TsPayloadReader tsPayloadReader = (i6 & 16) != 0 ? this.tsPayloadReaders.get(i11) : null;
        ...
        if (z5) {
            ...
            i10 |= (this.tsPacketBuffer.readUnsignedByte() & 64) != 0 ? 2 : i;
    ...
    public void seek(long j, long j6) {
        ...
        if (j6 != 0 && (tsBinarySearchSeeker = this.tsBinarySearchSeeker) != null) {
            tsBinarySearchSeeker.setSeekTargetUs(j6);
        }
    ...
    */
    ...
    @Deprecated
    public TsExtractor(int i, int i4, int i6) {
        this(i, 1, SubtitleParser.Factory.UNSUPPORTED, new TimestampAdjuster(0L), new DefaultTsPayloadReaderFactory(i4), i6);
    }
    ...
    public TsExtractor(int i, TimestampAdjuster timestampAdjuster, TsPayloadReader.Factory factory, int i4) {
        this(i, 1, SubtitleParser.Factory.UNSUPPORTED, timestampAdjuster, factory, i4);
    }

    public TsExtractor(int i, int i4, SubtitleParser.Factory factory, TimestampAdjuster timestampAdjuster, TsPayloadReader.Factory factory2, int i6) {
        this.payloadReaderFactory = (TsPayloadReader.Factory) Assertions.checkNotNull(factory2);
        this.timestampSearchBytes = i6;
        this.mode = i;
        this.extractorFlags = i4;
        ...
        this.durationReader = new TsDurationReader(i6);
