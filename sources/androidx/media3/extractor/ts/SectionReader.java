...
public final class SectionReader implements TsPayloadReader {
    ...
    public void consume(ParsableByteArray parsableByteArray, int i) {
        boolean z4 = (i & 1) != 0;
        int position = z4 ? parsableByteArray.getPosition() + parsableByteArray.readUnsignedByte() : -1;
        ...
        while (parsableByteArray.bytesLeft() > 0) {
            ...
            if (i4 < 3) {
                ...
                if (i6 == 3) {
                    ...
                    if (iCapacity < i10) {
                        this.sectionData.ensureCapacity(Math.min(4098, Math.max(i10, this.sectionData.capacity() * 2)));
                    }
                }
            } else {
