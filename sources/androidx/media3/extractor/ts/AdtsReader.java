...
public final class AdtsReader implements ElementaryStreamReader {
    ...
    private boolean checkSyncPositionValid(ParsableByteArray parsableByteArray, int i) {
        ...
        if (b8 == -1) {
            ...
            return isAdtsSyncBytes((byte) -1, data[i10]) && ((data[i10] & 8) >> 3) == bits;
        }
        if (b8 != 73) {
            return false;
        }
    ...
    private void findNextSample(ParsableByteArray parsableByteArray) {
        ...
        while (position < iLimit) {
            ...
            int i4 = b8 & 255;
            if (this.matchState == 512 && isAdtsSyncBytes((byte) -1, (byte) i4) && (this.foundFirstFrame || checkSyncPositionValid(parsableByteArray, position - 1))) {
    ...
    private void setReadingSampleState(TrackOutput trackOutput, long j, int i, int i4) {
        this.state = 4;
        this.bytesRead = i;
    ...
    public AdtsReader(boolean z4, @Nullable String str, int i) {
