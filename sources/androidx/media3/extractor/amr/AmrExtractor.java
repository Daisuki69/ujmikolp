...
public final class AmrExtractor implements Extractor {
    ...
    private SeekMap getConstantBitrateSeekMap(long j, boolean z4) {
        return new ConstantBitrateSeekMap(j, this.firstSamplePosition, getBitrateFromFrameSize(this.firstSampleSize, 20000L), this.firstSampleSize, z4);
    }
    ...
    private void maybeOutputFormat() {
        ...
        this.trackOutput.format(new Format.Builder().setSampleMimeType(z4 ? MimeTypes.AUDIO_AMR_WB : MimeTypes.AUDIO_AMR_NB).setMaxInputSize(MAX_FRAME_SIZE_BYTES).setChannelCount(1).setSampleRate(z4 ? 16000 : 8000).build());
    }
    ...
    private void maybeOutputSeekMap(long j, int i) {
        ...
        int i6 = this.flags;
        if ((i6 & 1) == 0 || j == -1 || !((i4 = this.firstSampleSize) == -1 || i4 == this.currentSampleSize)) {
        ...
        if (this.numSamplesWithSameSize >= 20 || i == -1) {
            SeekMap constantBitrateSeekMap = getConstantBitrateSeekMap(j, (i6 & 2) != 0);
