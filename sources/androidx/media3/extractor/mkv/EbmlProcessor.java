...
public interface EbmlProcessor {
    ...
    void binaryElement(int i, int i4, ExtractorInput extractorInput) throws IOException;

    void endMasterElement(int i) throws ParserException;

    void floatElement(int i, double d10) throws ParserException;
    ...
    void startMasterElement(int i, long j, long j6) throws ParserException;
