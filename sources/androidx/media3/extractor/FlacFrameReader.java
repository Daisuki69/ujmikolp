...
public final class FlacFrameReader {
    ...
    private static boolean checkAndReadFirstSampleNumber(ParsableByteArray parsableByteArray, FlacStreamMetadata flacStreamMetadata, boolean z4, SampleNumberHolder sampleNumberHolder) {
        try {
    ...
    public static long getFirstSampleNumber(ExtractorInput extractorInput, FlacStreamMetadata flacStreamMetadata) throws IOException {
        ...
        if (checkAndReadFirstSampleNumber(parsableByteArray, flacStreamMetadata, z4, sampleNumberHolder)) {
