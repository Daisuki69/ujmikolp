...
public final class SlowMotionData implements Metadata.Entry {
    ...
    public static final class Segment implements Parcelable {
        public static final Comparator<Segment> BY_START_THEN_END_THEN_DIVISOR = new l(5);
        ...
        public Segment(long j, long j6, int i) {
            Assertions.checkArgument(j < j6);
            this.startTimeMs = j;
            this.endTimeMs = j6;
            this.speedDivisor = i;
        }
        ...
        public static /* synthetic */ int lambda$static$0(Segment segment, Segment segment2) {
            return G.f4543a.b(segment.startTimeMs, segment2.startTimeMs).b(segment.endTimeMs, segment2.endTimeMs).a(segment.speedDivisor, segment2.speedDivisor).f();
        }
