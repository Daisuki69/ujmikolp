...
public final class FlacExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new a(29);
    ...
    private long findFrame(ParsableByteArray parsableByteArray, boolean z4) {
    ...
    private SeekMap getSeekMap(long j, long j6) {
        Assertions.checkNotNull(this.flacStreamMetadata);
        ...
        FlacBinarySearchSeeker flacBinarySearchSeeker = new FlacBinarySearchSeeker(flacStreamMetadata, this.frameStartMarker, j, j6);
    ...
    private int readFrames(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        int i6 = this.minFrameSize;
        if (i4 < i6) {
            ParsableByteArray parsableByteArray = this.buffer;
            parsableByteArray.skipBytes(Math.min(i6 - i4, parsableByteArray.bytesLeft()));
        }
        long jFindFrame = findFrame(this.buffer, z4);
