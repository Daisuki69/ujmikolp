...
final class JpegMotionPhotoExtractor implements Extractor {
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        int i4 = ((Mp4Extractor) Assertions.checkNotNull(this.mp4Extractor)).read(this.mp4ExtractorStartOffsetExtractorInput, positionHolder);
        if (i4 == 1) {
    ...
    public void seek(long j, long j6) {
        if (j == 0) {
            ...
            ((Mp4Extractor) Assertions.checkNotNull(this.mp4Extractor)).seek(j, j6);
        }
    }
