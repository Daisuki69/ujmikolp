...
public final class Cea708Decoder extends CeaDecoder {
    ...
    public static final class Cea708CueInfo {
        ...
        public Cea708CueInfo(CharSequence charSequence, Layout.Alignment alignment, float f, int i, int i4, float f3, int i6, float f7, boolean z4, int i10, int i11) {
            Cue.Builder size = new Cue.Builder().setText(charSequence).setTextAlignment(alignment).setLine(f, i).setLineAnchor(i4).setPosition(f3).setPositionAnchor(i6).setSize(f7);
            if (z4) {
    ...
    public static final class CueInfoBuilder {
        ...
        public static int getArgbColorFromCeaColor(int i, int i4, int i6) {
            return getArgbColorFromCeaColor(i, i4, i6, 0);
        }
        ...
        public Cea708CueInfo build() {
            ...
            return new Cea708CueInfo(spannableStringBuilder, alignment, f11, 0, i4, f7, i11, -3.4028235E38f, i13 != COLOR_SOLID_BLACK, i13, this.priority);
        }
        ...
        public void defineWindow(boolean z4, int i, boolean z5, int i4, int i6, int i10, int i11, int i12, int i13) {
            this.defined = true;
            this.visible = z4;
            this.priority = i;
            this.relativePositioning = z5;
            this.verticalAnchor = i4;
            this.horizontalAnchor = i6;
            this.anchorId = i11;
            int i14 = i10 + 1;
            if (this.rowCount != i14) {
                this.rowCount = i14;
                while (true) {
                    if (this.rolledUpCaptions.size() < this.rowCount && this.rolledUpCaptions.size() < 15) {
                        break;
            ...
            if (i12 != 0 && this.windowStyleId != i12) {
            ...
            if (i13 == 0 || this.penStyleId == i13) {
                return;
            }
            this.penStyleId = i13;
            int i16 = i13 - 1;
            setPenAttributes(0, 1, 1, false, false, PEN_STYLE_EDGE_TYPE[i16], PEN_STYLE_FONT_STYLE[i16]);
            setPenColor(COLOR_SOLID_WHITE, PEN_STYLE_BACKGROUND[i16], COLOR_SOLID_BLACK);
        }
        ...
        public void setPenAttributes(int i, int i4, int i6, boolean z4, boolean z5, int i10, int i11) {
            if (this.italicsStartPosition != -1) {
                if (!z4) {
        ...
        public void setPenColor(int i, int i4, int i6) {
        ...
        public void setWindowAttributes(int i, int i4, boolean z4, int i6, int i10, int i11, int i12) {
            this.windowFillColor = i;
            this.justification = i12;
        }
    ...
    private void handleC0Command(int i) {
        if (i != 0) {
            ...
            switch (i) {
                ...
                default:
                    if (i >= 17 && i <= 23) {
                        androidx.camera.core.impl.a.y(i, "Currently unsupported COMMAND_EXT1 Command: ", TAG);
                        this.captionChannelPacketData.skipBits(8);
                    } else if (i >= 24 && i <= 31) {
                        androidx.camera.core.impl.a.y(i, "Currently unsupported COMMAND_P16 Command: ", TAG);
                        this.captionChannelPacketData.skipBits(16);
                    } else {
                        androidx.camera.core.impl.a.y(i, "Invalid C0 command: ", TAG);
                    }
                    break;
            }
        }
        ...
        switch (i) {
            ...
            case COMMAND_DSW /* 137 */:
                for (int i10 = 1; i10 <= 8; i10++) {
                    if (this.captionChannelPacketData.readBit()) {
                        this.cueInfoBuilders[8 - i10].setVisibility(true);
                    }
                }
                break;
            case 138:
                while (i4 <= 8) {
                    if (this.captionChannelPacketData.readBit()) {
                        this.cueInfoBuilders[8 - i4].setVisibility(false);
                    }
                    i4++;
                }
                break;
            case 139:
                for (int i11 = 1; i11 <= 8; i11++) {
                    if (this.captionChannelPacketData.readBit()) {
                        this.cueInfoBuilders[8 - i11].setVisibility(!r0.isVisible());
                    }
                }
                break;
            case COMMAND_DLW /* 140 */:
                while (i4 <= 8) {
                    if (this.captionChannelPacketData.readBit()) {
                        this.cueInfoBuilders[8 - i4].reset();
                    }
                    i4++;
                }
                break;
            ...
            default:
                androidx.camera.core.impl.a.y(i, "Invalid C1 command: ", TAG);
                break;
            ...
            default:
                switch (i) {
                    ...
                    case 127:
                        ...
                        break;
                    default:
                        androidx.camera.core.impl.a.y(i, "Invalid G2 character: ", TAG);
                        break;
                }
                break;
        }
    ...
    private void handleG3Character(int i) {
        if (i == 160) {
            ...
            androidx.camera.core.impl.a.y(i, "Invalid G3 character: ", TAG);
    ...
    private void processCurrentPacket() {
        ...
        while (true) {
            ...
            if (bits == 7) {
                ...
                if (bits < 7) {
                    androidx.camera.core.impl.a.y(bits, "Invalid extended service number: ", TAG);
                }
            }
            if (bits2 == 0) {
                if (bits != 0) {
                    ...
                    if (bits3 == 16) {
                        ...
                        if (bits4 <= 31) {
                            ...
                            if (bits4 <= 127) {
                                ...
                                androidx.camera.core.impl.a.y(bits4, "Invalid extended command: ", TAG);
                            }
                            z4 = true;
                        }
                    } else if (bits3 <= 31) {
                        ...
                        if (bits3 <= 127) {
                            ...
                            androidx.camera.core.impl.a.y(bits3, "Invalid base command: ", TAG);
                        }
                        z4 = true;
                    }
                }
            ...
            if (i == 2 || i == 3) {
                if (z4) {
                    if (i == 3) {
                        ...
                        int i10 = unsignedByte2 & Utf8.REPLACEMENT_BYTE;
                        if (i10 == 0) {
                            i10 = 64;
                        }
                        DtvCcPacket dtvCcPacket = new DtvCcPacket(i4, i10);
                        ...
                        if (dtvCcPacket2 == null) {
                            ...
                            bArr2[i12] = unsignedByte2;
                            dtvCcPacket2.currentIndex = i12 + 2;
                            bArr2[i13] = unsignedByte3;
                        }
                    }
