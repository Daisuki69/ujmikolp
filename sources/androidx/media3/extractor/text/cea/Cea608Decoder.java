...
public final class Cea608Decoder extends CeaDecoder {
    ...
    private static final int[] SPECIAL_ES_FR_CHARACTER_SET = {193, 201, MfaTencentErrorResult.TENCENT_ERROR_LOCAL_REF_FAILED, MfaTencentErrorResult.TENCENT_ERROR_PERMISSION_CHECK, MfaTencentErrorResult.TENCENT_ERROR_LIVE_DATA, 252, 8216, 161, 42, 39, 8212, 169, 8480, 8226, 8220, 8221, PsExtractor.AUDIO_STREAM, 194, 199, 200, 202, 203, 235, 206, 207, 239, MfaTencentErrorResult.TENCENT_ERROR_USER_STOPS, MfaTencentErrorResult.TENCENT_ERROR_FACE_DETECTION_TIMED_OUT, 249, MfaTencentErrorResult.TENCENT_ERROR_APP_STOP, 171, 187};
    private static final int[] SPECIAL_PT_DE_CHARACTER_SET = {195, 227, 205, 204, 236, 210, 242, MfaTencentErrorResult.TENCENT_ERROR_INNER_ERROR_CODE, 245, 123, 125, 92, 94, 95, 124, 126, 196, MfaTencentErrorResult.TENCENT_ERROR_NO_FACE_WHILE_CAPTURING, MfaTencentErrorResult.TENCENT_ERROR_APP_SWITCH, 246, MfaTencentErrorResult.TENCENT_ERROR_PREPARE_TIME_OUT, 165, 164, 9474, 197, 229, MfaTencentErrorResult.TENCENT_ERROR_INIT_SDK, 248, 9484, 9488, 9492, 9496};
    ...
    public static final class CueBuilder {
        ...
        public static class CueStyle {
            ...
            public CueStyle(int i, boolean z4, int i4) {
                this.style = i;
                this.underline = z4;
                this.start = i4;
            }
        ...
        public CueBuilder(int i, int i4) {
            reset(i);
        ...
        private SpannableString buildCurrentLine() {
            ...
            while (i11 < this.cueStyles.size()) {
                ...
                int i13 = cueStyle.style;
                if (i13 != 8) {
                    boolean z8 = i13 == 7;
                    if (i13 != 7) {
                        i10 = Cea608Decoder.STYLE_COLORS[i13];
                    }
                    z4 = z8;
                }
                int i14 = cueStyle.start;
                i11++;
                if (i14 != (i11 < this.cueStyles.size() ? this.cueStyles.get(i11).start : length)) {
                    ...
                    if (i4 != -1 && !z4) {
                        setItalicSpan(spannableStringBuilder, i4, i14);
                        i4 = -1;
                    } else if (i4 == -1 && z4) {
                        i4 = i14;
                    }
                    if (i10 != i6) {
                        setColorSpan(spannableStringBuilder, i12, i14, i6);
                        i6 = i10;
                        i12 = i14;
                    }
                }
            ...
            if (i12 != length) {
                setColorSpan(spannableStringBuilder, i12, length, i6);
            }
            return new SpannableString(spannableStringBuilder);
        }

        private static void setColorSpan(SpannableStringBuilder spannableStringBuilder, int i, int i4, int i6) {
            if (i6 == -1) {
                return;
            }
        ...
        private static void setItalicSpan(SpannableStringBuilder spannableStringBuilder, int i, int i4) {
            spannableStringBuilder.setSpan(new StyleSpan(2), i, i4, 33);
        }

        private static void setUnderlineSpan(SpannableStringBuilder spannableStringBuilder, int i, int i4) {
        ...
        public Cue build(int i) {
            ...
            if (i == Integer.MIN_VALUE) {
                i = (this.captionMode != 2 || (Math.abs(i10) >= 3 && length >= 0)) ? (this.captionMode != 2 || i10 <= 0) ? 0 : 2 : 1;
            }
            if (i != 1) {
                if (i == 2) {
                    i6 = 32 - length;
            ...
            return new Cue.Builder().setText(spannableStringBuilder).setTextAlignment(Layout.Alignment.ALIGN_NORMAL).setLine(i11, 1).setPosition(f).setPositionAnchor(i).build();
        }
        ...
        public void setStyle(int i, boolean z4) {
            this.cueStyles.add(new CueStyle(i, z4, this.captionStringBuilder.length()));
        }
    }
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            if (cue != null) {
                if (cue.positionAnchor != iMin) {
                    cue = (Cue) Assertions.checkNotNull(this.cueBuilders.get(i4).build(iMin));
                }
                arrayList2.add(cue);
            }
        }
    ...
    private void handlePreambleAddressCode(byte b8, byte b10) {
        ...
        boolean z5 = (b10 & 1) == 1;
        int i4 = (b10 >> 1) & 7;
        this.currentCueBuilder.setStyle(z4 ? 8 : i4, z5);
        if (z4) {
            this.currentCueBuilder.indent = COLUMN_INDICES[i4];
        }
    }
    ...
    private boolean isRepeatedCommand(boolean z4, byte b8, byte b10) {
        if (!z4 || !isRepeatable(b8)) {
    ...
    private void setCaptionMode(int i) {
        ...
        this.captionMode = i;
        if (i == 3) {
            for (int i6 = 0; i6 < this.cueBuilders.size(); i6++) {
                this.cueBuilders.get(i6).setCaptionMode(i);
            }
            return;
        }
        resetCueBuilders();
