...
public final class WebvttCssStyle {
    ...
    private static int updateScoreForMatch(int i, String str, @Nullable String str2, int i4) {
        if (str.isEmpty() || i == -1) {
            return i;
        }
        if (str.equals(str2)) {
    ...
    public WebvttCssStyle setCombineUpright(boolean z4) {
        this.combineUpright = z4;
        return this;
    }
    ...
    public WebvttCssStyle setFontFamily(@Nullable String str) {
        this.fontFamily = str == null ? null : v0.H(str);
        return this;
    }
