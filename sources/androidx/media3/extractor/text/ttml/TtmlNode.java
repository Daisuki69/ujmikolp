...
final class TtmlNode {
    ...
    private TtmlNode(@Nullable String str, @Nullable String str2, long j, long j6, @Nullable TtmlStyle ttmlStyle, @Nullable String[] strArr, String str3, @Nullable String str4, @Nullable TtmlNode ttmlNode) {
        this.tag = str;
        this.text = str2;
        this.imageId = str4;
    ...
    private void applyStyleToOutput(Map<String, TtmlStyle> map, Cue.Builder builder, int i, int i4, int i6) {
        ...
        if (ttmlStyleResolveStyle != null) {
            TtmlRenderUtil.applyStylesToSpan(spannableStringBuilder2, i, i4, ttmlStyleResolveStyle, this.parent, map, i6);
    ...
    public static TtmlNode buildNode(@Nullable String str, long j, long j6, @Nullable TtmlStyle ttmlStyle, @Nullable String[] strArr, String str2, @Nullable String str3, @Nullable TtmlNode ttmlNode) {
        return new TtmlNode(str, null, j, j6, ttmlStyle, strArr, str2, str3, ttmlNode);
    }
    ...
    private void getEventTimes(TreeSet<Long> treeSet, boolean z4) {
        ...
        if (z4 || zEquals || (zEquals2 && this.imageId != null)) {
        ...
        for (int i = 0; i < this.children.size(); i++) {
            this.children.get(i).getEventTimes(treeSet, z4 || zEquals);
        }
    }
    ...
    private void traverseForText(long j, boolean z4, String str, Map<String, Cue.Builder> map) {
        boolean z5;
    ...
    public boolean isActive(long j) {
        ...
        if (j6 <= j && this.endTimeUs == C.TIME_UNSET) {
            return true;
        }
        if (j6 != C.TIME_UNSET || j >= this.endTimeUs) {
            return j6 <= j && j < this.endTimeUs;
        }
        return true;
    }
}
