...
public interface SubtitleParser {
    ...
    public static class OutputOptions {
        ...
        private OutputOptions(long j, boolean z4) {
            this.startTimeUs = j;
    ...
    void parse(byte[] bArr, int i, int i4, OutputOptions outputOptions, Consumer<CuesWithTiming> consumer);

    void parse(byte[] bArr, OutputOptions outputOptions, Consumer<CuesWithTiming> consumer);

    Subtitle parseToLegacySubtitle(byte[] bArr, int i, int i4);
