...
public final class TrueHdSampleRechunker {
    ...
    public void sampleMetadata(TrackOutput trackOutput, long j, int i, int i4, int i6, @Nullable TrackOutput.CryptoData cryptoData) {
        Assertions.checkState(this.chunkOffset <= i4 + i6, "TrueHD chunk samples must be contiguous in the sample queue.");
