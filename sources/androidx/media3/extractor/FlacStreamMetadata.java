...
public final class FlacStreamMetadata {
    ...
    public long getApproxBytesPerFrame() {
        ...
        if (i > 0) {
            ...
            j = ((((i4 != this.maxBlockSizeSamples || i4 <= 0) ? PlaybackStateCompat.ACTION_SKIP_TO_QUEUE_ITEM : i4) * ((long) this.channels)) * ((long) this.bitsPerSample)) / 8;
            j6 = 64;
        }
        return j + j6;
    }
    ...
    public FlacStreamMetadata(int i, int i4, int i6, int i10, int i11, int i12, int i13, long j, ArrayList<String> arrayList, ArrayList<PictureFrame> arrayList2) {
        this(i, i4, i6, i10, i11, i12, i13, j, (SeekTable) null, concatenateVorbisMetadata(arrayList, arrayList2));
    }

    private FlacStreamMetadata(int i, int i4, int i6, int i10, int i11, int i12, int i13, long j, @Nullable SeekTable seekTable, @Nullable Metadata metadata) {
