...
final class VorbisReader extends StreamReader {
    ...
    @VisibleForTesting
    public static int readBits(byte b8, int i, int i4) {
        return (b8 >> i4) & (255 >>> (8 - i));
    }
