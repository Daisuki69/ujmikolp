...
final class OggPageHeader {
    ...
    public boolean populate(ExtractorInput extractorInput, boolean z4) throws IOException {
        reset();
        this.scratch.reset(27);
        if (!ExtractorUtil.peekFullyQuietly(extractorInput, this.scratch.getData(), 0, 27, z4) || this.scratch.readUnsignedInt() != 1332176723) {
            return false;
        }
        ...
        if (!ExtractorUtil.peekFullyQuietly(extractorInput, this.scratch.getData(), 0, this.pageSegmentCount, z4)) {
            return false;
        }
