...
public final class AviExtractor implements Extractor {
    ...
    private void parseHdrlBody(ParsableByteArray parsableByteArray) throws IOException {
        ...
        P pListIterator = from.children.listIterator(0);
        int i = 0;
        while (pListIterator.hasNext()) {
            AviChunk aviChunk = (AviChunk) pListIterator.next();
    ...
    private long peekSeekOffset(ParsableByteArray parsableByteArray) {
        ...
        long j6 = littleEndianInt <= j ? 8 + j : 0L;
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        switch (this.state) {
            ...
            case 3:
                ...
                if (i4 != 1414744396 || littleEndianInt != 1769369453) {
