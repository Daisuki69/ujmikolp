...
final class SimpleCacheSpan extends CacheSpan {
    ...
    private SimpleCacheSpan(String str, long j, long j6, long j7, @Nullable File file) {
        super(str, j, j6, j7, file);
    }
    ...
    public static SimpleCacheSpan createHole(String str, long j, long j6) {
        return new SimpleCacheSpan(str, j, j6, C.TIME_UNSET, null);
    }
    ...
    public static File getCacheFile(File file, int i, long j, long j6) {
        StringBuilder sb2 = new StringBuilder();
        sb2.append(i);
        sb2.append(".");
        sb2.append(j);
        sb2.append(".");
        return new File(file, s.h(j6, SUFFIX, sb2));
    }
    ...
    @Nullable
    public static SimpleCacheSpan createCacheEntry(File file, long j, long j6, CachedContentIndex cachedContentIndex) {
        String keyForId;
        String name = file.getName();
        ...
        return new SimpleCacheSpan(keyForId, Long.parseLong((String) Assertions.checkNotNull(matcher.group(2))), j7, j6 == C.TIME_UNSET ? Long.parseLong((String) Assertions.checkNotNull(matcher.group(3))) : j6, file2);
    }
}
