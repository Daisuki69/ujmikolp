...
public interface Cache {
    ...
    long getCachedBytes(String str, long j, long j6);

    long getCachedLength(String str, long j, long j6);
    ...
    boolean isCached(String str, long j, long j6);
    ...
    @WorkerThread
    File startFile(String str, long j, long j6) throws CacheException;

    @WorkerThread
    CacheSpan startReadWrite(String str, long j, long j6) throws InterruptedException, CacheException;

    @Nullable
    @WorkerThread
    CacheSpan startReadWriteNonBlocking(String str, long j, long j6) throws CacheException;
}
