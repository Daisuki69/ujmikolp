...
public final class UdpDataSource extends BaseDataSource {
    ...
    public int read(byte[] bArr, int i, int i4) throws UdpDataSourceException {
        if (i4 == 0) {
            return 0;
        }
        ...
        System.arraycopy(this.packetBuffer, length2 - i6, bArr, i, iMin);
    ...
    public UdpDataSource(int i, int i4) {
        super(true);
