...
public final class DefaultDataSource implements DataSource {
    ...
    public int read(byte[] bArr, int i, int i4) throws IOException {
        return ((DataSource) Assertions.checkNotNull(this.dataSource)).read(bArr, i, i4);
    }
    ...
    @UnstableApi
    public DefaultDataSource(Context context, @Nullable String str, int i, int i4, boolean z4) {
        this(context, new DefaultHttpDataSource.Factory().setUserAgent(str).setConnectTimeoutMs(i).setReadTimeoutMs(i4).setAllowCrossProtocolRedirects(z4).createDataSource());
    }
