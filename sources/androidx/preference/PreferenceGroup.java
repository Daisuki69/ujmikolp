...
public abstract class PreferenceGroup extends Preference {
    ...
    public PreferenceGroup(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i4) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.PreferenceGroup, i, i4);
        int i6 = R.styleable.PreferenceGroup_orderingFromXml;
        this.mOrderingAsAdded = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, i6, i6, true);
        int i10 = R.styleable.PreferenceGroup_initialExpandedChildrenCount;
        if (typedArrayObtainStyledAttributes.hasValue(i10)) {
            setInitialExpandedChildrenCount(TypedArrayUtils.getInt(typedArrayObtainStyledAttributes, i10, i10, Integer.MAX_VALUE));
        }
    ...
    public void notifyDependencyChange(boolean z4) {
        ...
        int preferenceCount = getPreferenceCount();
        for (int i = 0; i < preferenceCount; i++) {
            getPreference(i).onParentChanged(this, z4);
        }
    }
