...
public class SeekBarPreference extends Preference {
    ...
    public SeekBarPreference(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i4) {
        ...
        this.mSeekBarChangeListener = new SeekBar.OnSeekBarChangeListener() { // from class: androidx.preference.SeekBarPreference.1
            ...
            public void onProgressChanged(SeekBar seekBar, int i6, boolean z4) {
                ...
                seekBarPreference2.updateLabelValue(i6 + seekBarPreference2.mMin);
            }
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.SeekBarPreference, i, i4);
    ...
    private void setValueInternal(int i, boolean z4) {
        int i4 = this.mMin;
        if (i < i4) {
            i = i4;
        }
