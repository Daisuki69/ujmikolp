...
public class PreferenceManager {
    ...
    public static void setDefaultValues(@NonNull Context context, int i, boolean z4) {
        setDefaultValues(context, getDefaultSharedPreferencesName(context), getDefaultSharedPreferencesMode(), i, z4);
    }
    ...
    public static void setDefaultValues(@NonNull Context context, String str, int i, int i4, boolean z4) {
        ...
        if (z4 || !sharedPreferences.getBoolean(KEY_HAS_SET_DEFAULT_VALUES, false)) {
            ...
            androidx.camera.core.impl.a.A(sharedPreferences, KEY_HAS_SET_DEFAULT_VALUES, true);
        }
    }
}
