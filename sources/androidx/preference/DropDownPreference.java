...
public class DropDownPreference extends ListPreference {
    ...
    public DropDownPreference(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i4) {
        ...
        this.mItemSelectedListener = new AdapterView.OnItemSelectedListener() { // from class: androidx.preference.DropDownPreference.1
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i6, long j) {
                Callback.onItemSelected_enter(view, i6);
                if (i6 >= 0) {
                    try {
                        String string = DropDownPreference.this.getEntryValues()[i6].toString();
