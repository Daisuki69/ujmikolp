...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private void init() {
        ...
        addOnConfigurationChangedListener(new Consumer(this) { // from class: androidx.fragment.app.f
            ...
            public final /* synthetic */ FragmentActivity f7857b;
            ...
            public final void accept(Object obj) {
                switch (i) {
                    case 0:
                        this.f7857b.lambda$init$1((Configuration) obj);
                        break;
                    default:
                        this.f7857b.lambda$init$2((Intent) obj);
                        break;
                }
            }
        });
        ...
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: androidx.fragment.app.g
            ...
            public final void onContextAvailable(Context context) {
                this.f7858a.lambda$init$3(context);
            }
        });
    }
    ...
    @Deprecated
    public void startIntentSenderFromFragment(@NonNull Fragment fragment, @NonNull IntentSender intentSender, int i, @Nullable Intent intent, int i4, int i6, int i10, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (i == -1) {
            ActivityCompat.startIntentSenderForResult(this, intentSender, i, intent, i4, i6, i10, bundle);
        } else {
            fragment.startIntentSenderForResult(intentSender, i, intent, i4, i6, i10, bundle);
        }
    }
