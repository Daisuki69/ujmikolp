...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(@NonNull final ActivityResultContract<I, O> activityResultContract, @NonNull final Function<Void, ActivityResultRegistry> function, @NonNull final ActivityResultCallback<O> activityResultCallback) {
        if (this.mState > 1) {
            throw new IllegalStateException(androidx.camera.core.impl.a.i("Fragment ", this, " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate())."));
        }
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(s.i(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        throw new IllegalStateException(androidx.camera.core.impl.a.i("Fragment ", this, " has not been attached yet."));
    }
    ...
    public final FragmentManager getParentFragmentManager() {
        ...
        throw new IllegalStateException(androidx.camera.core.impl.a.i("Fragment ", this, " not associated with a fragment manager."));
    }
    ...
    public LifecycleOwner getViewLifecycleOwner() {
        ...
        throw new IllegalStateException(androidx.camera.core.impl.a.i("Can't access the Fragment View's LifecycleOwner for ", this, " when getView() is null i.e., before onCreateView() or after onDestroyView()"));
    }
    ...
    public void onActivityResult(int i, int i4, @Nullable Intent intent) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v(FragmentManager.TAG, "Fragment " + this + " received the following in onActivityResult(): requestCode: " + i + " resultCode: " + i4 + " data: " + intent);
        }
    }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.impl.a.i("Fragment ", this, " did not call through to super.onActivityCreated()"));
        }
        restoreViewState();
    ...
    public void performAttach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.impl.a.i("Fragment ", this, " did not call through to super.onAttach()"));
        }
    ...
    public void performCreate(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.impl.a.i("Fragment ", this, " did not call through to super.onCreate()"));
        }
    ...
    public boolean performCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater menuInflater) {
        ...
        return this.mChildFragmentManager.dispatchCreateOptionsMenu(menu, menuInflater) | z4;
    }

    public void performCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        this.mChildFragmentManager.noteStateNotSaved();
        this.mPerformedCreateView = true;
        this.mViewLifecycleOwner = new FragmentViewLifecycleOwner(this, getViewModelStore(), new b(this, 2));
    ...
    public void performDestroy() {
        ...
        onDestroy();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.impl.a.i("Fragment ", this, " did not call through to super.onDestroy()"));
        }
    }
    ...
    public void performDestroyView() {
        ...
        onDestroyView();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.impl.a.i("Fragment ", this, " did not call through to super.onDestroyView()"));
        }
    ...
    public void performDetach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.impl.a.i("Fragment ", this, " did not call through to super.onDetach()"));
        }
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.impl.a.i("Fragment ", this, " did not call through to super.onPause()"));
        }
    }
    ...
    public boolean performPrepareOptionsMenu(@NonNull Menu menu) {
        ...
        return this.mChildFragmentManager.dispatchPrepareOptionsMenu(menu) | z4;
    }
    ...
    public void performResume() {
        ...
        onResume();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.impl.a.i("Fragment ", this, " did not call through to super.onResume()"));
        }
    ...
    public void performStart() {
        ...
        onStart();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.impl.a.i("Fragment ", this, " did not call through to super.onStart()"));
        }
        LifecycleRegistry lifecycleRegistry = this.mLifecycleRegistry;
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.impl.a.i("Fragment ", this, " did not call through to super.onStop()"));
        }
    }
    ...
    public final void requestPermissions(@NonNull String[] strArr, int i) {
        if (this.mHost == null) {
            throw new IllegalStateException(androidx.camera.core.impl.a.i("Fragment ", this, " not attached to Activity"));
        }
    ...
    public final FragmentActivity requireActivity() {
        ...
        throw new IllegalStateException(androidx.camera.core.impl.a.i("Fragment ", this, " not attached to an activity."));
    }
    ...
    public final Bundle requireArguments() {
        ...
        throw new IllegalStateException(androidx.camera.core.impl.a.i("Fragment ", this, " does not have any arguments."));
    }
    ...
    public final Context requireContext() {
        ...
        throw new IllegalStateException(androidx.camera.core.impl.a.i("Fragment ", this, " not attached to a context."));
    }
    ...
    public final Object requireHost() {
        ...
        throw new IllegalStateException(androidx.camera.core.impl.a.i("Fragment ", this, " not attached to a host."));
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            throw new IllegalStateException(androidx.camera.core.impl.a.i("Fragment ", this, " is not attached to any Fragment or host"));
        }
    ...
    public final View requireView() {
        ...
        throw new IllegalStateException(androidx.camera.core.impl.a.i("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView()."));
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.impl.a.i("Fragment ", this, " did not call through to super.onViewStateRestored()"));
        }
        if (this.mView != null) {
    ...
    public void setAnimations(@AnimRes int i, @AnimRes int i4, @AnimRes int i6, @AnimRes int i10) {
        if (this.mAnimationInfo == null && i == 0 && i4 == 0 && i6 == 0 && i10 == 0) {
            return;
        }
        ensureAnimationInfo().mEnterAnim = i;
        ensureAnimationInfo().mExitAnim = i4;
    ...
    public void setTargetFragment(@Nullable Fragment fragment, int i) {
        ...
        if (fragmentManager != null && fragmentManager2 != null && fragmentManager != fragmentManager2) {
            throw new IllegalArgumentException(androidx.camera.core.impl.a.i("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment"));
        }
    ...
    @Deprecated
    public void startIntentSenderForResult(@NonNull IntentSender intentSender, int i, @Nullable Intent intent, int i4, int i6, int i10, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        Bundle bundle2;
        if (this.mHost == null) {
            throw new IllegalStateException(androidx.camera.core.impl.a.i("Fragment ", this, " not attached to Activity"));
        }
        ...
        getParentFragmentManager().launchStartIntentSenderForResult(this, intentSender, i, intent, i4, i6, i10, bundle2);
    }
    ...
    public static Fragment instantiate(@NonNull Context context, @NonNull String str, @Nullable Bundle bundle) {
        try {
            ...
            throw new InstantiationException(s.j("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e);
        } catch (java.lang.InstantiationException e7) {
            throw new InstantiationException(s.j("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e7);
        } catch (NoSuchMethodException e10) {
            throw new InstantiationException(s.j("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e10);
        } catch (InvocationTargetException e11) {
            throw new InstantiationException(s.j("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e11);
        }
    }
