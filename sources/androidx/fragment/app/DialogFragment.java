...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    private void dismissInternal(boolean z4, boolean z5, boolean z8) {
        if (this.mDismissed) {
            return;
        }
    ...
    public void setStyle(int i, @StyleRes int i4) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.d(FragmentManager.TAG, "Setting style and theme for DialogFragment " + this + " to " + i + ", " + i4);
        }
        this.mStyle = i;
        if (i == 2 || i == 3) {
