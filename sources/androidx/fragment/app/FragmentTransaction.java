...
public abstract class FragmentTransaction {
    ...
    public FragmentTransaction addSharedElement(@NonNull View view, @NonNull String str) {
        ...
        if (this.mSharedElementSourceNames == null) {
            ...
            if (this.mSharedElementTargetNames.contains(str)) {
                throw new IllegalArgumentException(s.j("A shared element with the target name '", str, "' has already been added to the transaction."));
            }
            if (this.mSharedElementSourceNames.contains(transitionName)) {
                throw new IllegalArgumentException(s.j("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
            }
        }
    ...
    public void doAddOp(int i, Fragment fragment, @Nullable String str, int i4) {
        ...
        if (str != null) {
            ...
            if (str3 != null && !str.equals(str3)) {
                ...
                sb2.append(fragment);
                sb2.append(": was ");
                throw new IllegalStateException(s.q(sb2, fragment.mTag, " now ", str));
            }
            fragment.mTag = str;
        }
        if (i != 0) {
    ...
    @NonNull
    public FragmentTransaction setCustomAnimations(@AnimRes @AnimatorRes int i, @AnimRes @AnimatorRes int i4) {
    ...
    @NonNull
    public FragmentTransaction setCustomAnimations(@AnimRes @AnimatorRes int i, @AnimRes @AnimatorRes int i4, @AnimRes @AnimatorRes int i6, @AnimRes @AnimatorRes int i10) {
        this.mEnterAnim = i;
        this.mExitAnim = i4;
