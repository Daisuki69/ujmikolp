...
class FragmentStateManager {
    ...
    public void attach() {
        ...
        if (fragment2 != null) {
            ...
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                ...
                throw new IllegalStateException(s.p(sb2, this.mFragment.mTargetWho, " that does not belong to this FragmentManager!"));
            }
        }
    ...
    public int computeExpectedState() {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder sbT = s.t(iMin, "computeExpectedState() of ", " for ");
    ...
    public void destroy() {
        ...
        if ((z4 && !this.mFragment.mBeingSaved) || zIsChangingConfigurations) {
        ...
        try {
            ...
            while (true) {
                ...
                if (iComputeExpectedState == i) {
                    if (!z4 && i == -1 && fragment.mRemoving && !fragment.isInBackStack() && !this.mFragment.mBeingSaved) {
                        if (FragmentManager.isLoggingEnabled(3)) {
    ...
    public void resume() {
        ...
        if (focusedView != null && isFragmentViewChild(focusedView)) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                ...
                sb2.append(zRequestFocus ? "succeeded" : StateEvent.ProcessResult.FAILED);
