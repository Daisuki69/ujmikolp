...
final class BackStackRecordState implements Parcelable {
    ...
    public BackStackRecordState(BackStackRecord backStackRecord) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            int[] iArr = this.mOps;
            iArr[i6] = op.mFromExpandedOp ? 1 : 0;
    ...
    private void fillInBackStackRecord(@NonNull BackStackRecord backStackRecord) {
        ...
        while (true) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v("FragmentManager", "Instantiate " + backStackRecord + " op #" + i4 + " base fragment #" + this.mOps[i6]);
            }
            op.mOldMaxState = Lifecycle.State.values()[this.mOldMaxLifecycleStates[i4]];
            op.mCurrentMaxState = Lifecycle.State.values()[this.mCurrentMaxLifecycleStates[i4]];
            int[] iArr = this.mOps;
            int i10 = i + 2;
            if (iArr[i6] == 0) {
                z4 = false;
        ...
        for (int i = 0; i < this.mFragmentWhos.size(); i++) {
            ...
            if (str != null) {
                ...
                if (fragment != null) {
                    ...
                    throw new IllegalStateException(androidx.camera.core.impl.a.p(new StringBuilder("Restoring FragmentTransaction "), this.mName, " failed due to missing saved state for Fragment (", str, ")"));
                }
            }
        }
        return backStackRecord;
