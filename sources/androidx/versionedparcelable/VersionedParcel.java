...
public abstract class VersionedParcel {
    ...
    private Class findParcelClass(Class<? extends VersionedParcelable> cls) throws ClassNotFoundException {
        ...
        Class<?> cls3 = Class.forName(c.l(cls.getPackage().getName(), ".", cls.getSimpleName(), "Parcelizer"), false, cls.getClassLoader());
    ...
    private <T> int getType(T t5) {
        ...
        throw new IllegalArgumentException(t5.getClass().getName().concat(" cannot be VersionedParcelled"));
    }
    ...
    public boolean readBoolean(boolean z4, int i) {
        return !readField(i) ? z4 : readBoolean();
    }
    ...
    public byte readByte(byte b8, int i) {
        return !readField(i) ? b8 : (byte) (readInt() & 255);
    }
    ...
    public int readInt(int i, int i4) {
        return !readField(i4) ? i : readInt();
    }
    ...
    public <T extends Parcelable> T readParcelable(T t5, int i) {
        return !readField(i) ? t5 : (T) readParcelable();
    }
    ...
    public Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException(s.j("VersionedParcelable encountered IOException reading a Serializable object (name = ", string, ")"), e);
        } catch (ClassNotFoundException e7) {
            throw new RuntimeException(s.j("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = ", string, ")"), e7);
        }
    }
    ...
    public SparseBooleanArray readSparseBooleanArray(SparseBooleanArray sparseBooleanArray, int i) {
        ...
        SparseBooleanArray sparseBooleanArray2 = new SparseBooleanArray(i4);
        for (int i6 = 0; i6 < i4; i6++) {
    ...
    public <T extends VersionedParcelable> T readVersionedParcelable(T t5, int i) {
        return !readField(i) ? t5 : (T) readVersionedParcelable();
    }
    ...
    public void writeBoolean(boolean z4, int i) {
        setOutputField(i);
        writeBoolean(z4);
    }
    ...
    public void writeByte(byte b8, int i) {
        setOutputField(i);
        writeInt(b8);
    }
    ...
    public abstract void writeByteArray(byte[] bArr, int i, int i4);
    ...
    public void writeException(Exception exc, int i) {
        ...
        int i4 = ((exc instanceof Parcelable) && exc.getClass().getClassLoader() == Parcelable.class.getClassLoader()) ? EX_PARCELABLE : exc instanceof SecurityException ? -1 : exc instanceof BadParcelableException ? -2 : exc instanceof IllegalArgumentException ? -3 : exc instanceof NullPointerException ? -4 : exc instanceof IllegalStateException ? -5 : exc instanceof NetworkOnMainThreadException ? -6 : exc instanceof UnsupportedOperationException ? EX_UNSUPPORTED_OPERATION : 0;
        writeInt(i4);
        if (i4 == 0) {
    ...
    public void writeInt(int i, int i4) {
        setOutputField(i4);
        writeInt(i);
    }
    ...
    private void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            throw new RuntimeException(s.j("VersionedParcelable encountered IOException writing serializable object (name = ", name, ")"), e);
        }
    }
    ...
    public void writeByteArray(byte[] bArr, int i, int i4, int i6) {
        setOutputField(i6);
        writeByteArray(bArr, i, i4);
    }
