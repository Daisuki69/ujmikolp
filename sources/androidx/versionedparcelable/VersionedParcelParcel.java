...
class VersionedParcelParcel extends VersionedParcel {
    ...
    public VersionedParcel createSubParcel() {
        ...
        return new VersionedParcelParcel(parcel, iDataPosition, i, s.p(new StringBuilder(), this.mPrefix, "  "), this.mReadCache, this.mWriteCache, this.mParcelizerCache);
    }
    ...
    private VersionedParcelParcel(Parcel parcel, int i, int i4, String str, ArrayMap<String, Method> arrayMap, ArrayMap<String, Method> arrayMap2, ArrayMap<String, Class> arrayMap3) {
    ...
    @Override // androidx.versionedparcelable.VersionedParcel
    public void writeByteArray(byte[] bArr, int i, int i4) {
        if (bArr != null) {
            this.mParcel.writeInt(bArr.length);
            this.mParcel.writeByteArray(bArr, i, i4);
        } else {
            this.mParcel.writeInt(-1);
        }
    }
