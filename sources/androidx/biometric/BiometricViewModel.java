...
public class BiometricViewModel extends ViewModel {
    ...
    private static <T> void updateValue(MutableLiveData<T> mutableLiveData, T t5) {
    ...
    public void setAuthenticationFailurePending(boolean z4) {
        ...
        updateValue(this.mIsAuthenticationFailurePending, Boolean.valueOf(z4));
    }
    ...
    public void setConfirmingDeviceCredential(boolean z4) {
        this.mIsConfirmingDeviceCredential = z4;
    }
    ...
    public void setFingerprintDialogCancelPending(boolean z4) {
        ...
        updateValue(this.mIsFingerprintDialogCancelPending, Boolean.valueOf(z4));
    }

    public void setFingerprintDialogDismissedInstantly(boolean z4) {
        this.mIsFingerprintDialogDismissedInstantly = z4;
    }
    ...
    public void setNegativeButtonPressPending(boolean z4) {
        ...
        updateValue(this.mIsNegativeButtonPressPending, Boolean.valueOf(z4));
    }
