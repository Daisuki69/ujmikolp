...
public class BiometricFragment extends Fragment {
    ...
    public static class Api29Impl {
        ...
        public static void setConfirmationRequired(@NonNull BiometricPrompt.Builder builder, boolean z4) {
            builder.setConfirmationRequired(z4);
        }

        public static void setDeviceCredentialAllowed(@NonNull BiometricPrompt.Builder builder, boolean z4) {
    ...
    public void onActivityResult(int i, int i4, @Nullable Intent intent) {
        ...
        if (i == 1) {
            ...
            handleConfirmCredentialResult(i4);
        }
    }
    ...
    public void onAuthenticationError(final int i, @Nullable final CharSequence charSequence) {
        ...
        if (!isUsingFingerprintDialog()) {
            if (charSequence == null) {
                charSequence = getString(R.string.default_error_msg) + Global.BLANK + i;
            }
