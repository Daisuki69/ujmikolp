...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
    ...
    public class MyNodeProvider extends AccessibilityNodeProviderCompat {
        ...
        public AccessibilityNodeInfoCompat findFocus(int i) {
            int i4 = i == 2 ? ExploreByTouchHelper.this.mAccessibilityFocusedVirtualViewId : ExploreByTouchHelper.this.mKeyboardFocusedVirtualViewId;
    ...
    private AccessibilityEvent createEvent(int i, int i4) {
        return i != -1 ? createEventForChild(i, i4) : createEventForHost(i4);
    }
    ...
    private AccessibilityNodeInfoCompat createNodeForChild(int i) {
        ...
        boolean z4 = this.mKeyboardFocusedVirtualViewId == i;
        if (z4) {
        ...
        accessibilityNodeInfoCompatObtain.setFocused(z4);
    ...
    private boolean moveFocus(int i, @Nullable Rect rect) {
        ...
        AccessibilityNodeInfoCompat accessibilityNodeInfoCompat2 = i4 == Integer.MIN_VALUE ? null : allNodes.get(i4);
        if (i == 1 || i == 2) {
    ...
    private boolean performActionForChild(int i, int i4, Bundle bundle) {
        return i4 != 1 ? i4 != 2 ? i4 != 64 ? i4 != 128 ? onPerformActionForVirtualView(i, i4, bundle) : clearAccessibilityFocus(i) : requestAccessibilityFocus(i) : clearKeyboardFocusForVirtualView(i) : requestKeyboardFocusForVirtualView(i);
    }
    ...
    */
    ...
    public abstract int getVirtualViewAt(float f, float f3);
    ...
    public abstract boolean onPerformActionForVirtualView(int i, int i4, @Nullable Bundle bundle);
    ...
    public void onVirtualViewKeyboardFocusChanged(int i, boolean z4) {
    }

    public boolean performAction(int i, int i4, Bundle bundle) {
        return i != -1 ? performActionForChild(i, i4, bundle) : performActionForHost(i4, bundle);
    }

    public final boolean requestKeyboardFocusForVirtualView(int i) {
        int i4;
        if ((!this.mHost.isFocused() && !this.mHost.requestFocus()) || (i4 = this.mKeyboardFocusedVirtualViewId) == i) {
            return false;
        }
        if (i4 != Integer.MIN_VALUE) {
            clearKeyboardFocusForVirtualView(i4);
    ...
    public final boolean sendEventForVirtualView(int i, int i4) {
        ViewParent parent;
        if (i == Integer.MIN_VALUE || !this.mManager.isEnabled() || (parent = this.mHost.getParent()) == null) {
            return false;
        }
        return parent.requestSendAccessibilityEvent(this.mHost, createEvent(i, i4));
    }

    public final void invalidateVirtualView(int i, int i4) {
        ViewParent parent;
        if (i == Integer.MIN_VALUE || !this.mManager.isEnabled() || (parent = this.mHost.getParent()) == null) {
            return;
        }
        AccessibilityEvent accessibilityEventCreateEvent = createEvent(i, 2048);
        AccessibilityEventCompat.setContentChangeTypes(accessibilityEventCreateEvent, i4);
