...
final class ToContinuation<T> implements Runnable {
    ...
    public ToContinuation(y futureToObserve, InterfaceC0147j continuation) {
        j.h(futureToObserve, "futureToObserve");
    ...
    public void run() {
        ...
        try {
            ...
            interfaceC0147j.resumeWith(AbstractResolvableFuture.getUninterruptibly(this.futureToObserve));
        } catch (ExecutionException e) {
            InterfaceC0147j interfaceC0147j2 = this.continuation;
            Throwable thNonNullCause = ListenableFutureKt.nonNullCause(e);
            C1037h.a aVar2 = C1037h.f9166b;
            interfaceC0147j2.resumeWith(AbstractC1039j.a(thNonNullCause));
        }
    }
}
