...
public final class MutableFloatSet extends FloatSet {
    ...
    private final void resizeStorage(int i) {
        ...
        while (i6 < i4) {
            if (((jArr2[i6 >> 3] >> ((i6 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableFloatSet.findFirstAvailableSlot(i10 >>> 7);
                long j = i10 & 127;
                long[] jArr3 = mutableFloatSet.metadata;
                int i11 = iFindFirstAvailableSlot >> 3;
                int i12 = (iFindFirstAvailableSlot & 7) << 3;
                jArr3[i11] = ((~(255 << i12)) & jArr3[i11]) | (j << i12);
                int i13 = mutableFloatSet._capacity;
    ...
    */
    ...
    public /* synthetic */ MutableFloatSet(int i, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? 6 : i);
    }
