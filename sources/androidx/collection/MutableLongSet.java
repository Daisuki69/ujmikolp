...
public final class MutableLongSet extends LongSet {
    ...
    private final void resizeStorage(int i) {
        ...
        while (i6 < i4) {
            if (((jArr2[i6 >> 3] >> ((i6 & 7) << 3)) & 255) < 128) {
                ...
                int i17 = (i15 & 7) << 3;
                jArr = jArr2;
                jArr5[i16] = ((~(255 << i17)) & jArr5[i16]) | (j6 << i17);
    ...
    */
    ...
    public /* synthetic */ MutableLongSet(int i, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? 6 : i);
    }
