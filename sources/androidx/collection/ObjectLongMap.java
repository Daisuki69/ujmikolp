...
public abstract class ObjectLongMap<K> {
    ...
    public static /* synthetic */ String joinToString$default(ObjectLongMap objectLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i4, Object obj) {
        if (obj != null) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i6 = 0; i6 < i4; i6++) {
                    if ((255 & j) < 128) {
                        int i10 = (i << 3) + i6;
                        if (!((Boolean) predicate.invoke(objArr[i10], Long.valueOf(jArr[i10]))).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
    ...
    */
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i6 = 0; i6 < i4; i6++) {
                    if ((255 & j) < 128) {
                        int i10 = (i << 3) + i6;
                        block.invoke(objArr[i10], Long.valueOf(jArr[i10]));
                    }
                    j >>= 8;
                }
                if (i4 != 8) {
    ...
    public final long getOrDefault(K k8, long j) {
        int iFindKeyIndex = findKeyIndex(k8);
        return iFindKeyIndex >= 0 ? this.values[iFindKeyIndex] : j;
    }

    public final long getOrElse(K k8, Function0<Long> defaultValue) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i11 < i10) {
                    if ((255 & j) < 128) {
                        ...
                        long j6 = jArr[i12];
                        i4 = i6;
                        iHashCode += ((int) (j6 ^ (j6 >>> 32))) ^ (obj != null ? obj.hashCode() : 0);
                    } else {
                        i4 = i6;
                    }
                    j >>= 8;
    ...
    */
    ...
    public static /* synthetic */ String joinToString$default(ObjectLongMap objectLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, Function2 function2, int i4, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i6;
        if (obj == null) {
                    ...
                    if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i16 < i15) {
                            if ((j & 255) < 128) {
                                ...
                                jArr2 = jArr4;
                                sbV.append((CharSequence) function2.invoke(obj2, Long.valueOf(j6)));
                                i12++;
                            } else {
                                jArr2 = jArr4;
                                i6 = i14;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i12 < i11) {
                        if ((j & 255) < 128) {
                            ...
                            sbV.append((CharSequence) function2.invoke(obj, Long.valueOf(j6)));
                            i6++;
                        } else {
                            objArr2 = objArr3;
                        }
  ...
  0x0089: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x003a, B:20:0x0087] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.String joinToString(java.lang.CharSequence r21, java.lang.CharSequence r22, java.lang.CharSequence r23, int r24, kotlin.jvm.functions.Function2<? super K, ? super java.lang.Long, ? extends java.lang.CharSequence> r25) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
  ...
  0x0088: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x003a, B:20:0x0086] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.String joinToString(java.lang.CharSequence r21, java.lang.CharSequence r22, java.lang.CharSequence r23, kotlin.jvm.functions.Function2<? super K, ? super java.lang.Long, ? extends java.lang.CharSequence> r24) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
  ...
  0x007c: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x0030, B:20:0x007a] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.String joinToString(java.lang.CharSequence r21, java.lang.CharSequence r22, kotlin.jvm.functions.Function2<? super K, ? super java.lang.Long, ? extends java.lang.CharSequence> r23) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
  ...
  0x0083: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0035, B:20:0x0081] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.String joinToString(java.lang.CharSequence r22, kotlin.jvm.functions.Function2<? super K, ? super java.lang.Long, ? extends java.lang.CharSequence> r23) {
        /*
            r21 = this;
            r0 = r21
            r1 = r22
  ...
  0x0079: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x002b, B:20:0x0077] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.String joinToString(kotlin.jvm.functions.Function2<? super K, ? super java.lang.Long, ? extends java.lang.CharSequence> r21) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
