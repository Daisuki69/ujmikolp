...
public final class MutableFloatFloatMap extends FloatFloatMap {
    ...
    private final void resizeStorage(int i) {
        ...
        while (i6 < i4) {
            if (((jArr2[i6 >> 3] >> ((i6 & 7) << 3)) & 255) < 128) {
                ...
                fArr4[iFindFirstAvailableSlot] = fArr2[i6];
            } else {
                jArr = jArr2;
            }
            i6++;
    ...
    public final void put(float f, float f3) {
        set(f, f3);
    }
    ...
    public final void set(float f, float f3) {
    ...
    public /* synthetic */ MutableFloatFloatMap(int i, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? 6 : i);
    }
    ...
    public final float put(float f, float f3, float f7) {
        int iFindInsertIndex = findInsertIndex(f);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
    ...
    public final boolean remove(float f, float f3) {
        int iFindKeyIndex = findKeyIndex(f);
