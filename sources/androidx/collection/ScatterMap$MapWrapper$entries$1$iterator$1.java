...
@InterfaceC1611e(c = "androidx.collection.ScatterMap$MapWrapper$entries$1$iterator$1", f = "ScatterMap.kt", l = {TypedValues.TransitionType.TYPE_FROM}, m = "invokeSuspend")
public final class ScatterMap$MapWrapper$entries$1$iterator$1 extends AbstractC1615i implements Function2<k, InterfaceC1526a<? super Unit>, Object> {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    public ScatterMap$MapWrapper$entries$1$iterator$1(ScatterMap<K, V> scatterMap, InterfaceC1526a<? super ScatterMap$MapWrapper$entries$1$iterator$1> interfaceC1526a) {
    ...
    public final InterfaceC1526a<Unit> create(Object obj, InterfaceC1526a<?> interfaceC1526a) {
        ScatterMap$MapWrapper$entries$1$iterator$1 scatterMap$MapWrapper$entries$1$iterator$1 = new ScatterMap$MapWrapper$entries$1$iterator$1(this.this$0, interfaceC1526a);
    ...
    */
    ...
    public final Object invoke(k kVar, InterfaceC1526a<? super Unit> interfaceC1526a) {
        return ((ScatterMap$MapWrapper$entries$1$iterator$1) create(kVar, interfaceC1526a)).invokeSuspend(Unit.f18162a);
    }
}
