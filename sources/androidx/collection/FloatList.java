...
public abstract class FloatList {
    ...
    public static /* synthetic */ String joinToString$default(FloatList floatList, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i4, Object obj) {
        if (obj != null) {
    ...
    public final float elementAtOrElse(@androidx.annotation.IntRange(from = 0) int i, Function1<? super Integer, Float> defaultValue) {
    ...
    public final <R> R fold(R r9, Function2<? super R, ? super Float, ? extends R> operation) {
        j.g(operation, "operation");
        float[] fArr = this.content;
        int i = this._size;
        for (int i4 = 0; i4 < i; i4++) {
            r9 = (R) operation.invoke(r9, Float.valueOf(fArr[i4]));
        }
        return r9;
    }
    ...
    public final <R> R foldIndexed(R r9, n operation) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            R r10 = r9;
            r9 = (R) operation.invoke(Integer.valueOf(i4), r10, Float.valueOf(fArr[i4]));
        }
        return r9;
    }

    public final <R> R foldRight(R r9, Function2<? super Float, ? super R, ? extends R> operation) {
        j.g(operation, "operation");
        float[] fArr = this.content;
        int i = this._size;
        while (true) {
            ...
            r9 = (R) operation.invoke(Float.valueOf(fArr[i]), r9);
        }
    }
    ...
    public final <R> R foldRightIndexed(R r9, n operation) {
        ...
        while (true) {
            ...
            r9 = (R) operation.invoke(Integer.valueOf(i), Float.valueOf(fArr[i]), r9);
        }
    }
    ...
    public int hashCode() {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            iFloatToIntBits += Float.floatToIntBits(fArr[i4]) * 31;
        }
    ...
    public static /* synthetic */ String joinToString$default(FloatList floatList, CharSequence separator, CharSequence prefix, CharSequence postfix, int i, CharSequence charSequence, Function1 function1, int i4, Object obj) {
        if (obj == null) {
            if ((i4 & 1) != 0) {
                separator = ", ";
            }
    ...
    public final String joinToString(CharSequence separator, Function1<? super Float, ? extends CharSequence> transform) {
        ...
        while (true) {
            if (i4 < i) {
                ...
                sb2.append((CharSequence) transform.invoke(Float.valueOf(f)));
                i4++;
            } else {
                sb2.append((CharSequence) "");
                break;
