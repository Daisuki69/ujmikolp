...
public abstract class ScatterMap<K, V> {
    ...
    public class MapWrapper implements Map<K, V>, InterfaceC2210a {
        public MapWrapper() {
        }
    ...
    public static /* synthetic */ String joinToString$default(ScatterMap scatterMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, Function2 function2, int i4, Object obj) {
        if (obj != null) {
    ...
    public final String asDebugString$collection() {
        ...
        for (int i4 = 0; i4 < length; i4++) {
            sb2.append(this.keys[i4]);
            sb2.append(", ");
        }
        sb2.append("], values=[");
        int length2 = this.values.length;
        for (int i6 = 0; i6 < length2; i6++) {
            sb2.append(this.values[i6]);
            sb2.append(", ");
        }
        sb2.append("]}");
    ...
    */
    ...
    public final V getOrElse(K k8, Function0<? extends V> defaultValue) {
                    ...
                    while (i12 < i11) {
                        if ((j & 255) < 128) {
                            ...
                            if (function2 == null) {
                                ...
                                sbT.append((CharSequence) function2.invoke(obj, obj2));
                            }
                            i6++;
                        } else {
                            objArr3 = objArr5;
