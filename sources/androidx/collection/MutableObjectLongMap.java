...
public final class MutableObjectLongMap<K> extends ObjectLongMap<K> {
    ...
    private final void resizeStorage(int i) {
        ...
        while (i10 < i6) {
            if (((jArr[i10 >> 3] >> ((i10 & 7) << 3)) & 255) < 128) {
                ...
                int i16 = i15 >> 3;
                int i17 = (i15 & 7) << 3;
                jArr4[i16] = (jArr4[i16] & (~(255 << i17))) | (j << i17);
                objArr2[iFindFirstAvailableSlot] = obj;
                jArr3[iFindFirstAvailableSlot] = jArr2[i4];
            } else {
                i4 = i10;
            }
            i10 = i4 + 1;
    ...
    public final long getOrPut(K k8, Function0<Long> defaultValue) {
    ...
    public final void put(K k8, long j) {
        set(k8, j);
    }
    ...
    public final void set(K k8, long j) {
    ...
    public /* synthetic */ MutableObjectLongMap(int i, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? 6 : i);
    }
    ...
    public final long put(K k8, long j, long j6) {
        int iFindIndex = findIndex(k8);
        if (iFindIndex < 0) {
            iFindIndex = ~iFindIndex;
        } else {
            j6 = this.values[iFindIndex];
        }
        this.keys[iFindIndex] = k8;
        this.values[iFindIndex] = j;
        return j6;
    ...
    public final boolean remove(K k8, long j) {
        int iFindKeyIndex = findKeyIndex(k8);
