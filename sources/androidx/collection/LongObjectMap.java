...
public abstract class LongObjectMap<V> {
    ...
    public static /* synthetic */ String joinToString$default(LongObjectMap longObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i4, Object obj) {
        if (obj != null) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i6 = 0; i6 < i4; i6++) {
                    if ((255 & j) < 128) {
                        int i10 = (i << 3) + i6;
                        if (!((Boolean) predicate.invoke(Long.valueOf(jArr[i10]), objArr[i10])).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i6 = 0; i6 < i4; i6++) {
                    if ((255 & j) < 128) {
                        int i10 = (i << 3) + i6;
                        block.invoke(Long.valueOf(jArr[i10]), objArr[i10]);
                    }
                    j >>= 8;
                }
                if (i4 != 8) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i6 = 0; i6 < i4; i6++) {
                    if ((255 & j) < 128) {
                        ...
                        iHashCode += (obj != null ? obj.hashCode() : 0) ^ ((int) (j6 ^ (j6 >>> 32)));
                    }
                    j >>= 8;
                }
                if (i4 != 8) {
    ...
    */
    ...
    public static /* synthetic */ String joinToString$default(LongObjectMap longObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, Function2 function2, int i4, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i6;
        if (obj == null) {
                    ...
                    if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i16 < i15) {
                            if ((j & 255) < 128) {
                                ...
                                jArr2 = jArr4;
                                sbV.append((CharSequence) function2.invoke(Long.valueOf(j6), obj2));
                                i12++;
                            } else {
                                jArr2 = jArr4;
                                i6 = i14;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i12 < i11) {
                        if ((j & 255) < 128) {
                            ...
                            sbV.append((CharSequence) function2.invoke(Long.valueOf(j6), obj));
                            i6++;
                        } else {
                            jArr2 = jArr3;
                        }
