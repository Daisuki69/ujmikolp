...
public final class MutableObjectIntMap<K> extends ObjectIntMap<K> {
    ...
    public final int getOrPut(K k8, Function0<Integer> defaultValue) {
    ...
    public final void put(K k8, int i) {
        set(k8, i);
    }
    ...
    public final void set(K k8, int i) {
    ...
    public /* synthetic */ MutableObjectIntMap(int i, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? 6 : i);
    }
    ...
    public final int put(K k8, int i, int i4) {
        int iFindIndex = findIndex(k8);
        if (iFindIndex < 0) {
            iFindIndex = ~iFindIndex;
        } else {
            i4 = this.values[iFindIndex];
        }
        this.keys[iFindIndex] = k8;
        this.values[iFindIndex] = i;
        return i4;
    ...
    public final boolean remove(K k8, int i) {
        int iFindKeyIndex = findKeyIndex(k8);
