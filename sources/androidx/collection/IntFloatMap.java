...
public abstract class IntFloatMap {
    ...
    public static /* synthetic */ String joinToString$default(IntFloatMap intFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i4, Object obj) {
        if (obj != null) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i6 = 0; i6 < i4; i6++) {
                    if ((255 & j) < 128) {
                        int i10 = (i << 3) + i6;
                        if (!((Boolean) predicate.invoke(Integer.valueOf(iArr[i10]), Float.valueOf(fArr[i10]))).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i6 = 0; i6 < i4; i6++) {
                    if ((255 & j) < 128) {
                        int i10 = (i << 3) + i6;
                        block.invoke(Integer.valueOf(iArr[i10]), Float.valueOf(fArr[i10]));
                    }
                    j >>= 8;
                }
                if (i4 != 8) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i6 = 0; i6 < i4; i6++) {
                    if ((255 & j) < 128) {
                        int i10 = (i << 3) + i6;
                        iFloatToIntBits += Float.floatToIntBits(fArr[i10]) ^ iArr[i10];
                    }
                    j >>= 8;
                }
                if (i4 != 8) {
  ...
  0x0068: PHI (r8v2 int) = (r8v1 int), (r8v3 int) binds: [B:10:0x002e, B:19:0x0066] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public static /* synthetic */ String joinToString$default(IntFloatMap intFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, Function2 function2, int i4, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i6;
        if (obj == null) {
                    ...
                    if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i16 < i15) {
                            if ((j & 255) < 128) {
                                ...
                                jArr2 = jArr3;
                                sbV.append((CharSequence) function2.invoke(numValueOf, Float.valueOf(f)));
                                i12++;
                            } else {
                                jArr2 = jArr3;
                                i6 = i14;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((j & 255) < 128) {
                            ...
                            sbV.append((CharSequence) function2.invoke(Integer.valueOf(i15), Float.valueOf(f)));
                            i10++;
                        } else {
                            i4 = i11;
                        }
