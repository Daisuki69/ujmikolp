...
public final class MutableLongIntMap extends LongIntMap {
    ...
    private final void resizeStorage(int i) {
        ...
        while (i6 < i4) {
            if (((jArr2[i6 >> 3] >> ((i6 & 7) << 3)) & 255) < 128) {
                ...
                int i11 = i10 ^ (i10 << 16);
                int iFindFirstAvailableSlot = mutableLongIntMap.findFirstAvailableSlot(i11 >>> 7);
                long j6 = i11 & 127;
                ...
                int i14 = mutableLongIntMap._capacity;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i6 = 0; i6 < i4; i6++) {
                    if ((255 & j) < 128) {
                        int i10 = (i << 3) + i6;
                        if (((Boolean) predicate.invoke(Long.valueOf(this.keys[i10]), Integer.valueOf(this.values[i10]))).booleanValue()) {
                            removeValueAt(i10);
                        }
                    }
                    j >>= 8;
    ...
    public /* synthetic */ MutableLongIntMap(int i, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? 6 : i);
    }
    ...
    public final int put(long j, int i, int i4) {
        int iFindInsertIndex = findInsertIndex(j);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
