...
public final class MutableIntIntMap extends IntIntMap {
    ...
    private final void resizeStorage(int i) {
        ...
        while (i6 < i4) {
            if (((jArr2[i6 >> 3] >> ((i6 & 7) << 3)) & 255) < 128) {
                ...
                iArr4[iFindFirstAvailableSlot] = iArr2[i6];
            } else {
                jArr = jArr2;
            }
            i6++;
    ...
    public final void put(int i, int i4) {
        set(i, i4);
    }
    ...
    public /* synthetic */ MutableIntIntMap(int i, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? 6 : i);
    }
    ...
    public final int put(int i, int i4, int i6) {
        int iFindInsertIndex = findInsertIndex(i);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
            i6 = this.values[iFindInsertIndex];
        }
        this.keys[iFindInsertIndex] = i;
        this.values[iFindInsertIndex] = i4;
        return i6;
    ...
    public final boolean remove(int i, int i4) {
        int iFindKeyIndex = findKeyIndex(i);
        if (iFindKeyIndex < 0 || this.values[iFindKeyIndex] != i4) {
            return false;
        }
        removeValueAt(iFindKeyIndex);
        return true;
