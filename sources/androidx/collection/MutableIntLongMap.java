...
public final class MutableIntLongMap extends IntLongMap {
    ...
    private final void resizeStorage(int i) {
        ...
        while (i6 < i4) {
            if (((jArr2[i6 >> 3] >> ((i6 & 7) << 3)) & 255) < 128) {
                ...
                int i12 = i11 ^ (i11 << 16);
                int iFindFirstAvailableSlot = mutableIntLongMap.findFirstAvailableSlot(i12 >>> 7);
                long j = i12 & 127;
                long[] jArr5 = mutableIntLongMap.metadata;
                int i13 = iFindFirstAvailableSlot >> 3;
                int i14 = (iFindFirstAvailableSlot & 7) << 3;
                jArr5[i13] = (jArr5[i13] & (~(255 << i14))) | (j << i14);
                int i15 = mutableIntLongMap._capacity;
                int i16 = ((iFindFirstAvailableSlot - 7) & i15) + (i15 & 7);
                int i17 = i16 >> 3;
                int i18 = (i16 & 7) << 3;
                jArr = jArr2;
                jArr5[i17] = ((~(255 << i18)) & jArr5[i17]) | (j << i18);
    ...
    public /* synthetic */ MutableIntLongMap(int i, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? 6 : i);
    }
    ...
    public final long put(int i, long j, long j6) {
        int iFindInsertIndex = findInsertIndex(i);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
