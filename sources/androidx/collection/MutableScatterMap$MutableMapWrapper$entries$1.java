...
public final class MutableScatterMap$MutableMapWrapper$entries$1<K, V> implements Set<Map.Entry<K, V>>, InterfaceC2211b {
    ...
    public final boolean contains(Object obj) {
        ...
        if (!(obj instanceof InterfaceC2210a) || (obj instanceof InterfaceC2213d)) {
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        while (it.hasNext()) {
            ...
            if (!j.b(mutableScatterMap.get((K) entry.getKey()), entry.getValue())) {
                return false;
            }
        }
        return true;
                ...
                while (i11 < i10) {
                    if ((255 & j) < 128) {
                        ...
                        while (it.hasNext()) {
                            Map.Entry entry = (Map.Entry) it.next();
                            i = i6;
                            if (j.b(entry.getKey(), mutableScatterMap.keys[i12]) && j.b(entry.getValue(), mutableScatterMap.values[i12])) {
    ...
    */
    public boolean remove(java.util.Map.Entry<K, V> r22) {
        ...
        L55:
            ...
            r11 = r11[r13]
            boolean r11 = kotlin.jvm.internal.j.b(r11, r3)
            if (r11 == 0) goto L71
            goto L86
        L71:
            r11 = 1
