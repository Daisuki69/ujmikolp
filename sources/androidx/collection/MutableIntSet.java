...
public final class MutableIntSet extends IntSet {
    ...
    private final void resizeStorage(int i) {
        ...
        while (i6 < i4) {
            if (((jArr2[i6 >> 3] >> ((i6 & 7) << 3)) & 255) < 128) {
                ...
                int i12 = i11 ^ (i11 << 16);
                int iFindFirstAvailableSlot = mutableIntSet.findFirstAvailableSlot(i12 >>> 7);
                long j = i12 & 127;
                long[] jArr3 = mutableIntSet.metadata;
                int i13 = iFindFirstAvailableSlot >> 3;
                int i14 = (iFindFirstAvailableSlot & 7) << 3;
                jArr3[i13] = ((~(255 << i14)) & jArr3[i13]) | (j << i14);
                int i15 = mutableIntSet._capacity;
    ...
    */
    ...
    public /* synthetic */ MutableIntSet(int i, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? 6 : i);
    }
