...
final class FakeDrag {
    ...
    private void addFakeMotionEvent(long j, int i, float f, float f3) {
        MotionEvent motionEventObtain = MotionEvent.obtain(this.mFakeDragBeginTime, j, i, f, f3, 0);
    ...
    public boolean fakeDragBy(float f) {
        ...
        float f10 = z4 ? 0.0f : this.mRequestedDragDistance;
        this.mRecyclerView.scrollBy(i, i4);
        addFakeMotionEvent(jUptimeMillis, 2, f7, f10);
        return true;
    }
