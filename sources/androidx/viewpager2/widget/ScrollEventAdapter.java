...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    private void dispatchScrolled(int i, float f, int i4) {
        ViewPager2.OnPageChangeCallback onPageChangeCallback = this.mCallback;
        if (onPageChangeCallback != null) {
            onPageChangeCallback.onPageScrolled(i, f, i4);
        }
    }
    ...
    private void updateScrollEventValues() {
        ...
        if (i >= 0) {
            ...
            throw new IllegalStateException(s.f(scrollEventValues.mOffsetPx, "Page can only be offset by a positive amount, not by "));
        }
    }
    ...
    public void notifyProgrammaticScroll(int i, boolean z4) {
        this.mAdapterState = z4 ? 2 : 3;
        this.mFakeDragging = false;
        boolean z5 = this.mTarget != i;
        this.mTarget = i;
        dispatchStateChanged(2);
        if (z5) {
            dispatchSelected(i);
    ...
    public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int i) {
        ...
        if (isInAnyDraggingState() && i == 0) {
            ...
            if (this.mScrollHappened) {
                ...
                int i10 = this.mScrollValues.mPosition;
                if (i10 != -1) {
                    dispatchScrolled(i10, 0.0f, 0);
                }
            }
            dispatchStateChanged(0);
            resetState();
