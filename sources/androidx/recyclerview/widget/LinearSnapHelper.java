...
public class LinearSnapHelper extends SnapHelper {
    ...
    private int estimateNextPositionDiffForFling(RecyclerView.LayoutManager layoutManager, OrientationHelper orientationHelper, int i, int i4) {
        int[] iArrCalculateScrollDistance = calculateScrollDistance(i, i4);
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int i, int i4) {
        ...
        if (layoutManager.canScrollVertically()) {
            iEstimateNextPositionDiffForFling2 = estimateNextPositionDiffForFling(layoutManager, getVerticalHelper(layoutManager), 0, i4);
