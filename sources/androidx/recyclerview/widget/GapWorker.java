...
final class GapWorker implements Runnable {
    ...
    public static class LayoutPrefetchRegistryImpl implements RecyclerView.LayoutManager.LayoutPrefetchRegistry {
        ...
        public void setPrefetchVector(int i, int i4) {
            this.mPrefetchDx = i;
            this.mPrefetchDy = i4;
        }
    }
    ...
    public void postFromTraversal(RecyclerView recyclerView, int i, int i4) {
        ...
        recyclerView.mPrefetchRegistry.setPrefetchVector(i, i4);
    }
