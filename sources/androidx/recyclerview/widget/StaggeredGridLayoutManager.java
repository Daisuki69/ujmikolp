...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
        ...
        if (i > 0) {
            if (i == this.mSpanCount) {
                for (int i4 = 0; i4 < this.mSpanCount; i4++) {
                    ...
                    int endAfterPadding = savedState2.mSpanOffsets[i4];
                    ...
                    this.mSpans[i4].setLine(endAfterPadding);
                }
            } else {
    ...
    private boolean checkSpanForGap(Span span) {
        if (this.mShouldReverseLayout) {
            if (span.getEndLine() < this.mPrimaryOrientation.getEndAfterPadding()) {
                return !span.getLayoutParams((View) a.b(1, span.mViews)).mFullSpan;
            }
    ...
    private LazySpanLookup.FullSpanItem createFullSpanItemFromEnd(int i) {
        ...
        for (int i4 = 0; i4 < this.mSpanCount; i4++) {
            fullSpanItem.mGapPerSpan[i4] = i - this.mSpans[i4].getEndLine(i);
        }
        return fullSpanItem;
    }
    ...
    private LazySpanLookup.FullSpanItem createFullSpanItemFromStart(int i) {
        ...
        fullSpanItem.mGapPerSpan = new int[this.mSpanCount];
        for (int i4 = 0; i4 < this.mSpanCount; i4++) {
            fullSpanItem.mGapPerSpan[i4] = this.mSpans[i4].getStartLine(i) - i;
        }
        return fullSpanItem;
    }
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (r03.mLayoutState.mInfinite || !r03.mRemainingSpans.isEmpty())) {
            ...
            ?? r52 = span == -1 ? 1 : r82;
            if (r52 != 0) {
                nextSpan = layoutParams.mFullSpan ? r03.mSpans[r82] : r03.getNextSpan(layoutState);
            ...
            if (layoutState.mLayoutDirection == 1) {
                ...
                r03.addView(next, r82);
            }
            r03.measureChildWithDecorationsAndMargin(next, layoutParams, r82);
            if (layoutState.mLayoutDirection == 1) {
            ...
            if (r03.mOrientation == 1) {
                r03.layoutDecoratedWithMargins(next, i6, decoratedMeasurement, i4, minStart);
                r02 = this;
            } else {
                r03.layoutDecoratedWithMargins(next, decoratedMeasurement, i6, minStart, i4);
                r02 = r03;
            }
            if (layoutParams.mFullSpan) {
    ...
    private int getMaxEnd(int i) {
        ...
        for (int i4 = 1; i4 < this.mSpanCount; i4++) {
            int endLine2 = this.mSpans[i4].getEndLine(i);
            if (endLine2 > endLine) {
                endLine = endLine2;
            }
        }
    ...
    private int getMaxStart(int i) {
        ...
        for (int i4 = 1; i4 < this.mSpanCount; i4++) {
            int startLine2 = this.mSpans[i4].getStartLine(i);
    ...
    */
    ...
    private void measureChildWithDecorationsAndMargin(View view, LayoutParams layoutParams, boolean z4) {
        if (layoutParams.mFullSpan) {
            if (this.mOrientation != 1) {
                measureChildWithDecorationsAndMargin(view, RecyclerView.LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingRight() + getPaddingLeft(), ((ViewGroup.MarginLayoutParams) layoutParams).width, true), this.mFullSizeSpec, z4);
                return;
            }
            measureChildWithDecorationsAndMargin(view, this.mFullSizeSpec, RecyclerView.LayoutManager.getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingBottom() + getPaddingTop(), ((ViewGroup.MarginLayoutParams) layoutParams).height, true), z4);
            return;
        }
        if (this.mOrientation != 1) {
        ...
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            if (!layoutParams.mFullSpan) {
                if (isLayoutRTL() && this.mOrientation == 1) {
                    ...
                    childAt2.offsetLeftAndRight(((-((i10 - 1) - i11)) * this.mSizePerSpan) - ((-((i10 - 1) - i11)) * i4));
                } else {
    ...
    private void updateAllRemainingSpans(int i, int i4) {
        for (int i6 = 0; i6 < this.mSpanCount; i6++) {
            if (!this.mSpans[i6].mViews.isEmpty()) {
                updateRemainingSpans(this.mSpans[i6], i, i4);
            }
        }
    }
    ...
    private void updateRemainingSpans(Span span, int i, int i4) {
        int deletedSize = span.getDeletedSize();
        if (i == -1) {
            if (span.getStartLine() + deletedSize <= i4) {
                this.mRemainingSpans.set(span.mIndex, false);
            }
        } else if (span.getEndLine() - deletedSize >= i4) {
            this.mRemainingSpans.set(span.mIndex, false);
        }
    }

    private int updateSpecWithExtra(int i, int i4, int i6) {
        int mode;
    ...
    public boolean checkForGaps() {
        ...
        LazySpanLookup.FullSpanItem firstFullSpanItemInRange = this.mLazySpanLookup.getFirstFullSpanItemInRange(firstChildPosition, i4, i, true);
    ...
    public void collectAdjacentPrefetchPositions(int i, int i4, RecyclerView.State state, RecyclerView.LayoutManager.LayoutPrefetchRegistry layoutPrefetchRegistry) {
        ...
        for (int i10 = 0; i10 < this.mSpanCount; i10++) {
            ...
            if (i11 >= 0) {
                this.mPrefetchDistances[i6] = i11;
                i6++;
            }
        }
        Arrays.sort(this.mPrefetchDistances, 0, i6);
        for (int i12 = 0; i12 < i6 && this.mLayoutState.hasMore(state); i12++) {
    ...
    */
    ...
    public View onFocusSearchFailed(View view, int i, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (!z4 && (focusableViewAfter = span.getFocusableViewAfter(lastChildPosition, iConvertFocusDirectionToLayoutDirection)) != null && focusableViewAfter != viewFindContainingItemView) {
            return focusableViewAfter;
        }
        if (preferLastSpan(iConvertFocusDirectionToLayoutDirection)) {
            for (int i4 = this.mSpanCount - 1; i4 >= 0; i4--) {
                View focusableViewAfter2 = this.mSpans[i4].getFocusableViewAfter(lastChildPosition, iConvertFocusDirectionToLayoutDirection);
        ...
        boolean z5 = (this.mReverseLayout ^ true) == (iConvertFocusDirectionToLayoutDirection == -1);
        if (!z4) {
            View viewFindViewByPosition = findViewByPosition(z5 ? span.findFirstPartiallyVisibleItemPosition() : span.findLastPartiallyVisibleItemPosition());
        ...
        if (preferLastSpan(iConvertFocusDirectionToLayoutDirection)) {
            for (int i10 = this.mSpanCount - 1; i10 >= 0; i10--) {
                if (i10 != span.mIndex) {
                    View viewFindViewByPosition2 = findViewByPosition(z5 ? this.mSpans[i10].findFirstPartiallyVisibleItemPosition() : this.mSpans[i10].findLastPartiallyVisibleItemPosition());
            ...
            for (int i11 = 0; i11 < this.mSpanCount; i11++) {
                View viewFindViewByPosition3 = findViewByPosition(z5 ? this.mSpans[i11].findFirstPartiallyVisibleItemPosition() : this.mSpans[i11].findLastPartiallyVisibleItemPosition());
    ...
    public void setMeasuredDimension(Rect rect, int i, int i4) {
        ...
        if (this.mOrientation == 1) {
            iChooseSize2 = RecyclerView.LayoutManager.chooseSize(i4, rect.height() + paddingBottom, getMinimumHeight());
            ...
            iChooseSize2 = RecyclerView.LayoutManager.chooseSize(i4, (this.mSizePerSpan * this.mSpanCount) + paddingBottom, getMinimumHeight());
        }
    ...
    */
    ...
    public class Span {
        ...
        public void cacheReferenceLineAndClear(boolean z4, int i) {
            int endLine = z4 ? getEndLine(Integer.MIN_VALUE) : getStartLine(Integer.MIN_VALUE);
            clear();
            if (endLine == Integer.MIN_VALUE) {
                return;
            }
            if (!z4 || endLine >= StaggeredGridLayoutManager.this.mPrimaryOrientation.getEndAfterPadding()) {
                if (z4 || endLine <= StaggeredGridLayoutManager.this.mPrimaryOrientation.getStartAfterPadding()) {
        ...
        public void calculateCachedEnd() {
            ...
            View view = (View) a.b(1, this.mViews);
            LayoutParams layoutParams = getLayoutParams(view);
        ...
        public int findOnePartiallyOrCompletelyVisibleChild(int i, int i4, boolean z4, boolean z5, boolean z8) {
        ...
        public int findOnePartiallyVisibleChild(int i, int i4, boolean z4) {
            return findOnePartiallyOrCompletelyVisibleChild(i, i4, false, false, z4);
        }

        public int findOneVisibleChild(int i, int i4, boolean z4) {
            return findOnePartiallyOrCompletelyVisibleChild(i, i4, z4, true, false);
        }
        ...
        public View getFocusableViewAfter(int i, int i4) {
            View view = null;
            if (i4 != -1) {
        ...
        public void onOffset(int i) {
            int i4 = this.mCachedStart;
            if (i4 != Integer.MIN_VALUE) {
                this.mCachedStart = i4 + i;
            }
            int i6 = this.mCachedEnd;
            if (i6 != Integer.MIN_VALUE) {
                this.mCachedEnd = i6 + i;
            }
        }
    ...
    public static class LazySpanLookup {
        ...
        private int invalidateFullSpansAfter(int i) {
            ...
            while (true) {
                ...
                if (this.mFullSpanItems.get(i4).mPosition >= i) {
                    break;
                }
                i4++;
            }
        ...
        private void offsetFullSpansForAddition(int i, int i4) {
        ...
        private void offsetFullSpansForRemoval(int i, int i4) {
            List<FullSpanItem> list = this.mFullSpanItems;
            if (list == null) {
                return;
            }
        ...
        public FullSpanItem getFirstFullSpanItemInRange(int i, int i4, int i6, boolean z4) {
            List<FullSpanItem> list = this.mFullSpanItems;
            if (list == null) {
                return null;
            }
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                if (i11 >= i && (i6 == 0 || fullSpanItem.mGapDir == i6 || (z4 && fullSpanItem.mHasUnwantedGapAfter))) {
                    return fullSpanItem;
                }
            }
            return null;
        ...
        public void offsetForAddition(int i, int i4) {
            ...
            Arrays.fill(this.mData, i, i6, -1);
            offsetFullSpansForAddition(i, i4);
        }
        ...
        public void offsetForRemoval(int i, int i4) {
            ...
            offsetFullSpansForRemoval(i, i4);
        }
    ...
    private void measureChildWithDecorationsAndMargin(View view, int i, int i4, boolean z4) {
        boolean zShouldMeasureChild;
        calculateItemDecorationsForChild(view, this.mTmpRect);
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        int i6 = ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin;
        Rect rect = this.mTmpRect;
        int iUpdateSpecWithExtra = updateSpecWithExtra(i, i6 + rect.left, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin + rect.right);
        int i10 = ((ViewGroup.MarginLayoutParams) layoutParams).topMargin;
        Rect rect2 = this.mTmpRect;
        int iUpdateSpecWithExtra2 = updateSpecWithExtra(i4, i10 + rect2.top, ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin + rect2.bottom);
        if (z4) {
