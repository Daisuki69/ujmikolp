...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public class AnonymousClass1 implements ThreadUtil.MainThreadCallback<T> {
        ...
        @Override // androidx.recyclerview.widget.ThreadUtil.MainThreadCallback
        public void removeTile(int i, int i4) {
            sendMessage(SyncQueueItem.obtainMessage(3, i, i4));
        }

        @Override // androidx.recyclerview.widget.ThreadUtil.MainThreadCallback
        public void updateItemCount(int i, int i4) {
            sendMessage(SyncQueueItem.obtainMessage(1, i, i4));
        }
    }
    ...
    public class AnonymousClass2 implements ThreadUtil.BackgroundCallback<T> {
        ...
        public void loadTile(int i, int i4) {
            sendMessage(SyncQueueItem.obtainMessage(3, i, i4));
        }
        ...
        @Override // androidx.recyclerview.widget.ThreadUtil.BackgroundCallback
        public void updateRange(int i, int i4, int i6, int i10, int i11) {
            sendMessageAtFrontOfQueue(SyncQueueItem.obtainMessage(2, i, i4, i6, i10, i11, null));
        }
    }
    ...
    public static class SyncQueueItem {
        ...
        public static SyncQueueItem obtainMessage(int i, int i4, int i6, int i10, int i11, int i12, Object obj) {
            SyncQueueItem syncQueueItem;
        ...
        public static SyncQueueItem obtainMessage(int i, int i4, int i6) {
            return obtainMessage(i, i4, i6, 0, 0, 0, null);
        }

        public static SyncQueueItem obtainMessage(int i, int i4, Object obj) {
            return obtainMessage(i, i4, 0, 0, 0, 0, obj);
        }
    }
}
