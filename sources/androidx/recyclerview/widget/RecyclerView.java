...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(@NonNull VH vh2, int i) {
        ...
        public final VH createViewHolder(@NonNull ViewGroup viewGroup, int i) {
            try {
                ...
                VH vh2 = (VH) onCreateViewHolder(viewGroup, i);
        ...
        public final void notifyItemMoved(int i, int i4) {
            this.mObservable.notifyItemMoved(i, i4);
        }

        public final void notifyItemRangeChanged(int i, int i4) {
            this.mObservable.notifyItemRangeChanged(i, i4);
        }

        public final void notifyItemRangeInserted(int i, int i4) {
            this.mObservable.notifyItemRangeInserted(i, i4);
        }

        public final void notifyItemRangeRemoved(int i, int i4) {
            this.mObservable.notifyItemRangeRemoved(i, i4);
        }
        ...
        public abstract void onBindViewHolder(@NonNull VH vh2, int i);
        ...
        public final void notifyItemRangeChanged(int i, int i4, @Nullable Object obj) {
            this.mObservable.notifyItemRangeChanged(i, i4, obj);
        }
    }
    ...
    public static class AdapterDataObservable extends Observable<AdapterDataObserver> {
        ...
        public void notifyItemMoved(int i, int i4) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeMoved(i, i4, 1);
            }
        }

        public void notifyItemRangeChanged(int i, int i4) {
            notifyItemRangeChanged(i, i4, null);
        }

        public void notifyItemRangeInserted(int i, int i4) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeInserted(i, i4);
            }
        }

        public void notifyItemRangeRemoved(int i, int i4) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeRemoved(i, i4);
            }
        }
        ...
        public void notifyItemRangeChanged(int i, int i4, @Nullable Object obj) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeChanged(i, i4, obj);
            }
        }
    }
    ...
    public interface ChildDrawingOrderCallback {
        int onGetChildDrawingOrder(int i, int i4);
    }
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i, boolean z4) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (iIndexOfChild == -1) {
                    ...
                    throw new IllegalStateException(c.k(this.mRecyclerView, sb2));
                }
                if (iIndexOfChild != i) {
        ...
        public static int chooseSize(int i, int i4, int i6) {
  ...
  0x000c: PHI (r3v5 int) = (r3v0 int), (r3v2 int), (r3v0 int) binds: [B:7:0x0010, B:11:0x0016, B:4:0x000a] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        */
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i4) {
            Properties properties = new Properties();
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, androidx.recyclerview.R.styleable.RecyclerView, i, i4);
        ...
        private boolean isFocusedChildVisibleAfterScrolling(RecyclerView recyclerView, int i, int i4) {
            ...
            return rect.left - i < width && rect.right - i > paddingLeft && rect.top - i4 < height && rect.bottom - i4 > paddingTop;
        }

        private static boolean isMeasurementUpToDate(int i, int i4, int i6) {
        ...
        @SuppressLint({"UnknownNullness"})
        public void collectAdjacentPrefetchPositions(int i, int i4, State state, LayoutPrefetchRegistry layoutPrefetchRegistry) {
        }
        ...
        public void ignoreView(@NonNull View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                throw new IllegalArgumentException(c.k(this.mRecyclerView, new StringBuilder("View should be fully attached to be ignored")));
            }
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
        ...
        public void layoutDecorated(@NonNull View view, int i, int i4, int i6, int i10) {
            Rect rect = ((LayoutParams) view.getLayoutParams()).mDecorInsets;
            view.layout(i + rect.left, i4 + rect.top, i6 - rect.right, i10 - rect.bottom);
        }

        public void layoutDecoratedWithMargins(@NonNull View view, int i, int i4, int i6, int i10) {
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            Rect rect = layoutParams.mDecorInsets;
            view.layout(i + rect.left + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i4 + rect.top + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin, (i6 - rect.right) - ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, (i10 - rect.bottom) - ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
        }

        public void measureChild(@NonNull View view, int i, int i4) {
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            Rect itemDecorInsetsForChild = this.mRecyclerView.getItemDecorInsetsForChild(view);
            int i6 = itemDecorInsetsForChild.left + itemDecorInsetsForChild.right + i;
        ...
        public void moveView(int i, int i4) {
        ...
        public boolean onAddFocusables(@NonNull RecyclerView recyclerView, @NonNull ArrayList<View> arrayList, int i, int i4) {
            return false;
        }
        ...
        public void onItemsMoved(@NonNull RecyclerView recyclerView, int i, int i4, int i6) {
        }
        ...
        public void onMeasure(@NonNull Recycler recycler, @NonNull State state, int i, int i4) {
            this.mRecyclerView.defaultOnMeasure(i, i4);
        }
        ...
        public void setMeasureSpecs(int i, int i4) {
        ...
        public void setMeasuredDimension(Rect rect, int i, int i4) {
            setMeasuredDimension(chooseSize(i, getPaddingRight() + getPaddingLeft() + rect.width(), getMinimumWidth()), chooseSize(i4, getPaddingBottom() + getPaddingTop() + rect.height(), getMinimumHeight()));
        }

        public void setMeasuredDimensionFromChildren(int i, int i4) {
            int childCount = getChildCount();
            if (childCount == 0) {
                this.mRecyclerView.defaultOnMeasure(i, i4);
                return;
            ...
            this.mRecyclerView.mTempRect.set(i12, i10, i6, i11);
            setMeasuredDimension(this.mRecyclerView.mTempRect, i, i4);
        }
        ...
        public boolean shouldMeasureChild(View view, int i, int i4, LayoutParams layoutParams) {
            return (!view.isLayoutRequested() && this.mMeasurementCacheEnabled && isMeasurementUpToDate(view.getWidth(), i, ((ViewGroup.MarginLayoutParams) layoutParams).width) && isMeasurementUpToDate(view.getHeight(), i4, ((ViewGroup.MarginLayoutParams) layoutParams).height)) ? false : true;
        }
        ...
        public boolean shouldReMeasureChild(View view, int i, int i4, LayoutParams layoutParams) {
            return (this.mMeasurementCacheEnabled && isMeasurementUpToDate(view.getMeasuredWidth(), i, ((ViewGroup.MarginLayoutParams) layoutParams).width) && isMeasurementUpToDate(view.getMeasuredHeight(), i4, ((ViewGroup.MarginLayoutParams) layoutParams).height)) ? false : true;
        }
        ...
        public void onItemsUpdated(@NonNull RecyclerView recyclerView, int i, int i4, @Nullable Object obj) {
            onItemsUpdated(recyclerView, i, i4);
        }
        ...
        public boolean performAccessibilityAction(@NonNull Recycler recycler, @NonNull State state, int i, @Nullable Bundle bundle) {
            ...
            this.mRecyclerView.smoothScrollBy(i6, i4, null, Integer.MIN_VALUE, true);
            return true;
        }
        ...
        public boolean requestChildRectangleOnScreen(@NonNull RecyclerView recyclerView, @NonNull View view, @NonNull Rect rect, boolean z4, boolean z5) {
            ...
            if ((z5 && !isFocusedChildVisibleAfterScrolling(recyclerView, i, i4)) || (i == 0 && i4 == 0)) {
                return false;
            }
            if (z4) {
                recyclerView.scrollBy(i, i4);
            } else {
                recyclerView.smoothScrollBy(i, i4);
            }
            return true;
        }
        ...
        */
        ...
        public void setMeasuredDimension(int i, int i4) {
            this.mRecyclerView.setMeasuredDimension(i, i4);
        }
    ...
    public static abstract class OnFlingListener {
        public abstract boolean onFling(int i, int i4);
    }
    ...
    public static class RecycledViewPool {
        ...
        public void setMaxRecycledViews(int i, int i4) {
            ScrapData scrapDataForType = getScrapDataForType(i);
        ...
        public boolean willBindInTime(int i, long j, long j6) {
            long j7 = getScrapDataForType(i).mBindRunningAverageNs;
            return j7 == 0 || j + j7 < j6;
        }

        public boolean willCreateInTime(int i, long j, long j6) {
            long j7 = getScrapDataForType(i).mCreateRunningAverageNs;
            return j7 == 0 || j + j7 < j6;
        }
    }
    ...
    public final class Recycler {
        ...
        private boolean tryBindViewHolderByDeadline(@NonNull ViewHolder viewHolder, int i, int i4, long j) {
        ...
        public void bindViewToPosition(@NonNull View view, int i) {
            ...
            if (childViewHolderInt == null) {
                throw new IllegalArgumentException(c.k(RecyclerView.this, new StringBuilder("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter")));
            }
            ...
            if (iFindPositionOffset < 0 || iFindPositionOffset >= RecyclerView.this.mAdapter.getItemCount()) {
                StringBuilder sbU = s.u("Inconsistency detected. Invalid item position ", i, "(offset:", iFindPositionOffset, ").state:");
                sbU.append(RecyclerView.this.mState.getItemCount());
                throw new IndexOutOfBoundsException(c.k(RecyclerView.this, sbU));
            }
        ...
        public int convertPreLayoutPositionToPostLayout(int i) {
            ...
            StringBuilder sbT = s.t(i, "invalid position ", ". State item count is ");
            sbT.append(RecyclerView.this.mState.getItemCount());
            throw new IndexOutOfBoundsException(c.k(RecyclerView.this, sbT));
        }
        ...
        public ViewHolder getScrapOrCachedViewForId(long j, int i, boolean z4) {
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z4) {
            ...
            if (!z4 && (viewFindHiddenNonRemovedView = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(i)) != null) {
                ...
                if (iIndexOfChild == -1) {
                    ...
                    throw new IllegalStateException(c.k(RecyclerView.this, sb2));
                }
        ...
        public void offsetPositionRecordsForInsert(int i, int i4) {
            int size = this.mCachedViews.size();
            for (int i6 = 0; i6 < size; i6++) {
                ViewHolder viewHolder = this.mCachedViews.get(i6);
                if (viewHolder != null && viewHolder.mPosition >= i) {
                    if (RecyclerView.sVerboseLoggingEnabled) {
                        Log.d(RecyclerView.TAG, "offsetPositionRecordsForInsert cached " + i6 + " holder " + viewHolder + " now at position " + (viewHolder.mPosition + i4));
                    }
        ...
        public void offsetPositionRecordsForMove(int i, int i4) {
            int i6;
            int i10;
            int i11;
            int i12;
            ...
            for (int i13 = 0; i13 < size; i13++) {
                ...
                if (viewHolder != null && (i12 = viewHolder.mPosition) >= i11 && i12 <= i10) {
                    if (i12 == i) {
                        viewHolder.offsetPosition(i4 - i, false);
                    } else {
                        viewHolder.offsetPosition(i6, false);
                    }
                    if (RecyclerView.sVerboseLoggingEnabled) {
                        Log.d(RecyclerView.TAG, "offsetPositionRecordsForMove cached child " + i13 + " holder " + viewHolder);
                    }
                }
            }
        }

        public void offsetPositionRecordsForRemove(int i, int i4, boolean z4) {
            int i6 = i + i4;
            for (int size = this.mCachedViews.size() - 1; size >= 0; size--) {
                ...
                if (viewHolder != null) {
                    ...
                    if (i10 >= i6) {
                        if (RecyclerView.sVerboseLoggingEnabled) {
                            Log.d(RecyclerView.TAG, "offsetPositionRecordsForRemove cached " + size + " holder " + viewHolder + " now at position " + (viewHolder.mPosition - i4));
                        }
                        viewHolder.offsetPosition(-i4, z4);
                    } else if (i10 >= i) {
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                ...
                throw new IllegalArgumentException(c.k(RecyclerView.this, sb2));
            }
            if (viewHolder.isTmpDetached()) {
                ...
                throw new IllegalArgumentException(c.k(RecyclerView.this, sb3));
            }
            if (viewHolder.shouldIgnore()) {
                throw new IllegalArgumentException(c.k(RecyclerView.this, new StringBuilder("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
            boolean zDoesTransientStatePreventRecycling = viewHolder.doesTransientStatePreventRecycling();
            Adapter adapter = RecyclerView.this.mAdapter;
            boolean z8 = adapter != null && zDoesTransientStatePreventRecycling && adapter.onFailedToRecycleView(viewHolder);
            if (RecyclerView.sDebugAssertionsEnabled && this.mCachedViews.contains(viewHolder)) {
                ...
                throw new IllegalArgumentException(c.k(RecyclerView.this, sb4));
            }
            ...
            if (z || z5 || !zDoesTransientStatePreventRecycling) {
                return;
            }
            PoolingContainer.callPoolingContainerOnRelease(viewHolder.itemView);
            viewHolder.mBindingAdapter = null;
        ...
        public void scrapView(View view) {
            ...
            if (childViewHolderInt.isInvalid() && !childViewHolderInt.isRemoved() && !RecyclerView.this.mAdapter.hasStableIds()) {
                throw new IllegalArgumentException(c.k(RecyclerView.this, new StringBuilder("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        ...
        */
        ...
        public boolean validateViewHolderForOffsetPosition(ViewHolder viewHolder) {
            if (viewHolder.isRemoved()) {
                ...
                throw new IllegalStateException(c.k(RecyclerView.this, new StringBuilder("should not receive a removed view unless it is pre layout")));
            }
            int i = viewHolder.mPosition;
            if (i < 0 || i >= RecyclerView.this.mAdapter.getItemCount()) {
                StringBuilder sb2 = new StringBuilder("Inconsistency detected. Invalid view holder adapter position");
                sb2.append(viewHolder);
                throw new IndexOutOfBoundsException(c.k(RecyclerView.this, sb2));
            }
        ...
        public void viewRangeUpdate(int i, int i4) {
            int i6;
            int i10 = i4 + i;
            for (int size = this.mCachedViews.size() - 1; size >= 0; size--) {
                ViewHolder viewHolder = this.mCachedViews.get(size);
                if (viewHolder != null && (i6 = viewHolder.mPosition) >= i && i6 < i10) {
        ...
        public View getViewForPosition(int i, boolean z4) {
            return tryGetViewHolderForPositionByDeadline(i, z4, Long.MAX_VALUE).itemView;
        }
    ...
    public class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        public void onItemRangeChanged(int i, int i4, Object obj) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeChanged(i, i4, obj)) {
        ...
        public void onItemRangeInserted(int i, int i4) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeInserted(i, i4)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeMoved(int i, int i4, int i6) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeMoved(i, i4, i6)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeRemoved(int i, int i4) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeRemoved(i, i4)) {
                triggerUpdateProcessor();
            }
        }
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@Px int i, @Px int i4) {
            ...
            public void update(@Px int i, @Px int i4, int i6, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i4;
                this.mDuration = i6;
                this.mInterpolator = interpolator;
            ...
            public Action(@Px int i, @Px int i4, int i6) {
                this(i, i4, i6, null);
            }

            public Action(@Px int i, @Px int i4, int i6, @Nullable Interpolator interpolator) {
                this.mJumpToPosition = -1;
                this.mChanged = false;
                this.mConsecutiveUpdates = 0;
                this.mDx = i;
        ...
        public void onAnimation(int i, int i4) {
            ...
            if (this.mRunning) {
                onSeekTargetStep(i, i4, recyclerView.mState, this.mRecyclingAction);
        ...
        public abstract void onSeekTargetStep(@Px int i, @Px int i4, @NonNull State state, @NonNull Action action);
    ...
    public static class State {
        ...
        public String toString() {
            ...
            return a.q(sb2, this.mRunPredictiveAnimations, '}');
        }
    ...
    public static abstract class ViewCacheExtension {
        @Nullable
        public abstract View getViewForPositionAndType(@NonNull Recycler recycler, int i, int i4);
    }
    ...
    public class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i, int i4) {
            int iAbs = Math.abs(i);
        ...
        public void fling(int i, int i4) {
            ...
            this.mOverScroller.fling(0, 0, i, i4, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE);
            postOnAnimation();
        }
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                int iConsumeFlingInHorizontalStretch = RecyclerView.this.consumeFlingInHorizontalStretch(i6);
                int iConsumeFlingInVerticalStretch = RecyclerView.this.consumeFlingInVerticalStretch(i10);
                RecyclerView recyclerView2 = RecyclerView.this;
                ...
                if (recyclerView3.mAdapter != null) {
                    ...
                    iConsumeFlingInVerticalStretch -= i12;
                ...
                int i13 = iConsumeFlingInHorizontalStretch;
                int i14 = iConsumeFlingInVerticalStretch;
                ...
                iArr5[0] = 0;
                iArr5[1] = 0;
                recyclerView5.dispatchNestedScroll(i, i4, i13, i14, null, 1, iArr5);
                RecyclerView recyclerView6 = RecyclerView.this;
                int[] iArr6 = recyclerView6.mReusableIntPair;
                int i15 = i13 - iArr6[0];
                int i16 = i14 - iArr6[1];
                if (i != 0 || i4 != 0) {
                    recyclerView6.dispatchOnScrolled(i, i4);
                }
                ...
                if ((smoothScroller2 == null || !smoothScroller2.isPendingInitialRun()) && z4) {
                    ...
                    if (gapWorker != null) {
                        gapWorker.postFromTraversal(recyclerView7, i, i4);
                    }
                }
            }
        ...
        public void smoothScrollBy(int i, int i4, int i6, @Nullable Interpolator interpolator) {
            if (i6 == Integer.MIN_VALUE) {
                i6 = computeScrollDuration(i, i4);
            }
            int i10 = i6;
            ...
            this.mLastFlingX = 0;
            RecyclerView.this.setScrollState(2);
            this.mOverScroller.startScroll(0, 0, i, i4, i10);
            postOnAnimation();
        }
    ...
    public static abstract class ViewHolder {
        ...
        public void flagRemovedAndOffsetPosition(int i, int i4, boolean z4) {
            addFlags(8);
        ...
        public void offsetPosition(int i, boolean z4) {
        ...
        public final void setIsRecyclable(boolean z4) {
            ...
            if (RecyclerView.sVerboseLoggingEnabled) {
                Log.d(RecyclerView.TAG, "setIsRecyclable val:" + z4 + Global.COLON + this);
            }
        }
        ...
        public String toString() {
            StringBuilder sbV = s.v(getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName(), "{");
            ...
            StringBuilder sb2 = new StringBuilder(sbV.toString());
            if (isScrap()) {
                sb2.append(" scrap ");
    ...
    private int consumeFlingInStretch(int i, EdgeEffect edgeEffect, EdgeEffect edgeEffect2, int i4) {
        if (i > 0 && edgeEffect != null && EdgeEffectCompat.getDistance(edgeEffect) != 0.0f) {
            int iRound = Math.round(EdgeEffectCompat.onPullDistance(edgeEffect, ((-i) * FLING_DESTRETCH_FACTOR) / i4, 0.5f) * ((-i4) / FLING_DESTRETCH_FACTOR));
            if (iRound != i) {
                edgeEffect.finish();
            }
            return i - iRound;
    ...
    private void createLayoutManager(Context context, String str, AttributeSet attributeSet, int i, int i4) {
        Object[] objArr;
        ...
        if (str != null) {
            ...
            try {
                ...
                try {
                    ...
                    objArr = new Object[]{context, attributeSet, Integer.valueOf(i), Integer.valueOf(i4)};
    ...
    private boolean didChildRangeChange(int i, int i4) {
        findMinMaxChildLayoutPositions(this.mMinMaxLayoutPositions);
        int[] iArr = this.mMinMaxLayoutPositions;
        return (iArr[0] == i && iArr[1] == i4) ? false : true;
    }
    ...
    private View findNextViewToFocus() {
        ...
        for (int i4 = i; i4 < itemCount; i4++) {
            ViewHolder viewHolderFindViewHolderForAdapterPosition2 = findViewHolderForAdapterPosition(i4);
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childViewHolderInt != viewHolder && getChangedHolderKey(childViewHolderInt) == j) {
                ...
                if (adapter == null || !adapter.hasStableIds()) {
                    ...
                    sb2.append(" \n View Holder 2:");
                    sb2.append(viewHolder);
                    throw new IllegalStateException(c.k(this, sb2));
                }
                ...
                sb3.append(" \n View Holder 2:");
                sb3.append(viewHolder);
                throw new IllegalStateException(c.k(this, sb3));
            }
        }
    ...
    private void nestedScrollByInternal(int i, int i4, @Nullable MotionEvent motionEvent, int i6) {
        ...
        int i10 = zCanScrollVertically ? (zCanScrollHorizontally ? 1 : 0) | 2 : zCanScrollHorizontally ? 1 : 0;
        float height = motionEvent == null ? getHeight() / 2.0f : motionEvent.getY();
        float width = motionEvent == null ? getWidth() / 2.0f : motionEvent.getX();
        int iReleaseHorizontalGlow = i - releaseHorizontalGlow(i, height);
        int iReleaseVerticalGlow = i4 - releaseVerticalGlow(i4, width);
        startNestedScroll(i10, i6);
        if (dispatchNestedPreScroll(zCanScrollHorizontally ? iReleaseHorizontalGlow : 0, zCanScrollVertically ? iReleaseVerticalGlow : 0, this.mReusableIntPair, this.mScrollOffset, i6)) {
            int[] iArr2 = this.mReusableIntPair;
            iReleaseHorizontalGlow -= iArr2[0];
            iReleaseVerticalGlow -= iArr2[1];
        }
        scrollByInternal(zCanScrollHorizontally ? iReleaseHorizontalGlow : 0, zCanScrollVertically ? iReleaseVerticalGlow : 0, motionEvent, i6);
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        this.mState.mRunSimpleAnimations = this.mFirstLayoutComplete && this.mItemAnimator != null && ((z4 = this.mDataSetHasChangedAfterLayout) || z5 || this.mLayout.mRequestedSimpleAnimations) && (!z4 || this.mAdapter.hasStableIds());
        State state = this.mState;
        state.mRunPredictiveAnimations = state.mRunSimpleAnimations && z5 && !this.mDataSetHasChangedAfterLayout && predictiveItemAnimationsEnabled();
    }
    ...
    */
    ...
    private boolean shouldAbsorb(@NonNull EdgeEffect edgeEffect, int i, int i4) {
        if (i > 0) {
            return true;
        }
        return getSplineFlingDistance(-i) < EdgeEffectCompat.getDistance(edgeEffect) * ((float) i4);
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public boolean __replaced_14529_2_onInterceptTouchEvent(MotionEvent motionEvent) {
        boolean z4;
        if (this.mLayoutSuppressed) {
            return false;
        }
        ...
        if (actionMasked == 0) {
            ...
            if (this.mScrollState != 1) {
                int i4 = x8 - this.mInitialTouchX;
                int i6 = y10 - this.mInitialTouchY;
    ...
    public void absorbGlows(int i, int i4) {
        if (i < 0) {
            ensureLeftGlow();
    ...
    public void addFocusables(ArrayList<View> arrayList, int i, int i4) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null || !layoutManager.onAddFocusables(this, arrayList, i, i4)) {
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str != null) {
            throw new IllegalStateException(c.k(this, a.w(str)));
        }
        throw new IllegalStateException(c.k(this, new StringBuilder("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
    }
    ...
    public void assertNotInLayoutOrScroll(String str) {
        ...
        if (this.mDispatchScrollCounter > 0) {
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(c.k(this, new StringBuilder(""))));
        }
    }
    ...
    public void considerReleasingGlowsOnScroll(int i, int i4) {
        boolean zIsFinished;
        EdgeEffect edgeEffect = this.mLeftGlow;
    ...
    public void defaultOnMeasure(int i, int i4) {
        setMeasuredDimension(LayoutManager.chooseSize(i, getPaddingRight() + getPaddingLeft(), ViewCompat.getMinimumWidth(this)), LayoutManager.chooseSize(i4, getPaddingBottom() + getPaddingTop(), ViewCompat.getMinimumHeight(this)));
    }
    ...
    public boolean dispatchNestedFling(float f, float f3, boolean z4) {
        return getScrollingChildHelper().dispatchNestedFling(f, f3, z4);
    }
    ...
    public boolean dispatchNestedPreScroll(int i, int i4, int[] iArr, int[] iArr2) {
        return getScrollingChildHelper().dispatchNestedPreScroll(i, i4, iArr, iArr2);
    }

    @Override // android.view.View, androidx.core.view.NestedScrollingChild
    public boolean dispatchNestedScroll(int i, int i4, int i6, int i10, int[] iArr) {
        return getScrollingChildHelper().dispatchNestedScroll(i, i4, i6, i10, iArr);
    }
    ...
    public void dispatchOnScrolled(int i, int i4) {
        ...
        OnScrollListener onScrollListener = this.mScrollListener;
        if (onScrollListener != null) {
            onScrollListener.onScrolled(this, i, i4);
        }
        List<OnScrollListener> list = this.mScrollListeners;
        if (list != null) {
            for (int size = list.size() - 1; size >= 0; size--) {
                this.mScrollListeners.get(size).onScrolled(this, i, i4);
            }
        }
        this.mDispatchScrollCounter--;
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if ((z4 || this.mItemAnimator == null || this.mItemDecorations.size() <= 0 || !this.mItemAnimator.isRunning()) ? z4 : true) {
            ViewCompat.postInvalidateOnAnimation(this);
        }
    }
    ...
    public View findChildViewUnder(float f, float f3) {
        for (int childCount = this.mChildHelper.getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if (f >= childAt.getLeft() + translationX && f <= childAt.getRight() + translationX && f3 >= childAt.getTop() + translationY && f3 <= childAt.getBottom() + translationY) {
                return childAt;
            }
        }
        return null;
    ...
    public boolean fling(int i, int i4) {
        ...
        if (!zCanScrollVertically || Math.abs(i4) < this.mMinFlingVelocity) {
            i4 = 0;
        }
        if (i == 0 && i4 == 0) {
            return false;
        ...
        if (i == 0) {
            ...
            if (edgeEffect == null || EdgeEffectCompat.getDistance(edgeEffect) == 0.0f) {
                ...
                int i10 = -i;
                if (shouldAbsorb(this.mLeftGlow, i10, getWidth())) {
        ...
        if (i4 == 0) {
            ...
            if (edgeEffect3 == null || EdgeEffectCompat.getDistance(edgeEffect3) == 0.0f) {
                ...
                int i11 = -i4;
                if (shouldAbsorb(this.mTopGlow, i11, getHeight())) {
        ...
        if (iMax != 0 || i4 != 0) {
            ...
            i4 = Math.max(-i13, Math.min(i4, i13));
            this.mViewFlinger.fling(iMax, i4);
        }
        if (i == 0 && i6 == 0) {
        ...
        if (!dispatchNestedPreFling(f, f3)) {
            boolean z4 = iCanScrollHorizontally != 0 || zCanScrollVertically;
            dispatchNestedFling(f, f3, z4);
            ...
            if (z4) {
                ...
                int iMax2 = Math.max(-i14, Math.min(i, i14));
                int i15 = this.mMaxFlingVelocity;
                this.mViewFlinger.fling(iMax2, Math.max(-i15, Math.min(i6, i15)));
                return true;
            }
        }
        return false;
    ...
    public View focusSearch(View view, int i) {
        ...
        if (z5 && (i == 2 || i == 1)) {
            if (this.mLayout.canScrollVertically()) {
                int i4 = i == 2 ? 130 : 33;
                z4 = focusFinder.findNextFocus(this, view, i4) == null;
            ...
            if (!z4 && this.mLayout.canScrollHorizontally()) {
                int i6 = (this.mLayout.getLayoutDirection() == 1) ^ (i == 2) ? 66 : 17;
                boolean z8 = focusFinder.findNextFocus(this, view, i6) == null;
                if (FORCE_ABS_FOCUS_SEARCH_DIRECTION) {
                    i = i6;
                }
                z4 = z8;
    ...
    public int getChildDrawingOrder(int i, int i4) {
        ...
        return childDrawingOrderCallback == null ? super.getChildDrawingOrder(i, i4) : childDrawingOrderCallback.onGetChildDrawingOrder(i, i4);
    }
    ...
    public void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.6
            ...
            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void markViewHoldersUpdated(int i, int i4, Object obj) {
                RecyclerView.this.viewRangeUpdate(i, i4, obj);
                RecyclerView.this.mItemsChanged = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForAdd(int i, int i4) {
                RecyclerView.this.offsetPositionRecordsForInsert(i, i4);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForMove(int i, int i4) {
                RecyclerView.this.offsetPositionRecordsForMove(i, i4);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForRemovingInvisible(int i, int i4) {
                RecyclerView.this.offsetPositionRecordsForRemove(i, i4, true);
                RecyclerView recyclerView = RecyclerView.this;
            ...
            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForRemovingLaidOutOrNewView(int i, int i4) {
                RecyclerView.this.offsetPositionRecordsForRemove(i, i4, false);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }
    ...
    public void nestedScrollBy(int i, int i4) {
        nestedScrollByInternal(i, i4, null, 1);
    }

    public void offsetChildrenHorizontal(@Px int i) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i4 = 0; i4 < childCount; i4++) {
            this.mChildHelper.getChildAt(i4).offsetLeftAndRight(i);
        }
    }
    ...
    public void offsetChildrenVertical(@Px int i) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i4 = 0; i4 < childCount; i4++) {
            this.mChildHelper.getChildAt(i4).offsetTopAndBottom(i);
        }
    }
        ...
        for (int i6 = 0; i6 < unfilteredChildCount; i6++) {
            ...
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore() && childViewHolderInt.mPosition >= i) {
                if (sVerboseLoggingEnabled) {
                    Log.d(TAG, "offsetPositionRecordsForInsert attached child " + i6 + " holder " + childViewHolderInt + " now at position " + (childViewHolderInt.mPosition + i4));
                }
                childViewHolderInt.offsetPosition(i4, false);
                this.mState.mStructureChanged = true;
            }
        }
        this.mRecycler.offsetPositionRecordsForInsert(i, i4);
        requestLayout();
    }
    ...
    public void offsetPositionRecordsForMove(int i, int i4) {
        ...
        for (int i13 = 0; i13 < unfilteredChildCount; i13++) {
            ...
            if (childViewHolderInt != null && (i12 = childViewHolderInt.mPosition) >= i10 && i12 <= i6) {
                if (sVerboseLoggingEnabled) {
                    Log.d(TAG, "offsetPositionRecordsForMove attached child " + i13 + " holder " + childViewHolderInt);
                }
                if (childViewHolderInt.mPosition == i) {
                    childViewHolderInt.offsetPosition(i4 - i, false);
                } else {
        ...
        this.mRecycler.offsetPositionRecordsForMove(i, i4);
        requestLayout();
    }
        ...
        for (int i10 = 0; i10 < unfilteredChildCount; i10++) {
            ...
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore()) {
                ...
                if (i11 >= i6) {
                    ...
                    childViewHolderInt.offsetPosition(-i4, z4);
                    this.mState.mStructureChanged = true;
                } else if (i11 >= i) {
                    if (sVerboseLoggingEnabled) {
                        Log.d(TAG, "offsetPositionRecordsForRemove attached child " + i10 + " holder " + childViewHolderInt + " now REMOVED");
                    }
                    childViewHolderInt.flagRemovedAndOffsetPosition(i - 1, -i4, z4);
                    this.mState.mStructureChanged = true;
                }
            }
        }
        this.mRecycler.offsetPositionRecordsForRemove(i, i4, z4);
        requestLayout();
    }
    ...
    */
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        return __replaced_14529_2_onInterceptTouchEvent(motionEvent);
    }
    ...
    public void onMeasure(int i, int i4) {
        ...
        if (layoutManager.isAutoMeasureEnabled()) {
            int mode = View.MeasureSpec.getMode(i);
            int mode2 = View.MeasureSpec.getMode(i4);
            this.mLayout.onMeasure(this.mRecycler, this.mState, i, i4);
            ...
            this.mLayout.setMeasureSpecs(i, i4);
            this.mState.mIsMeasuring = true;
            dispatchLayoutStep2();
            this.mLayout.setMeasuredDimensionFromChildren(i, i4);
    ...
    public void onScrolled(@Px int i, @Px int i4) {
    }
  ...
  0x00dc: PHI (r1v46 int) = (r1v26 int), (r1v50 int) binds: [B:41:0x00c5, B:45:0x00d8] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public void requestDisallowInterceptTouchEvent(boolean z4) {
        int size = this.mOnItemTouchListeners.size();
        for (int i = 0; i < size; i++) {
            this.mOnItemTouchListeners.get(i).onRequestDisallowInterceptTouchEvent(z4);
        }
    ...
    public void saveOldPositions() {
        ...
        for (int i = 0; i < unfilteredChildCount; i++) {
            ...
            if (sDebugAssertionsEnabled && childViewHolderInt.mPosition == -1 && !childViewHolderInt.isRemoved()) {
                throw new IllegalStateException(c.k(this, new StringBuilder("view holder cannot have position -1 unless it is removed")));
            }
            if (!childViewHolderInt.shouldIgnore()) {
    ...
    public void scrollBy(int i, int i4) {
        ...
        if (zCanScrollHorizontally || zCanScrollVertically) {
            ...
            scrollByInternal(i, i4, null, 0);
        }
    }

    public boolean scrollByInternal(int i, int i4, MotionEvent motionEvent, int i6) {
        int i10;
        int i11;
        int i12;
        int i13;
        ...
        iArr3[0] = 0;
        iArr3[1] = 0;
        dispatchNestedScroll(i10, i11, i12, i13, this.mScrollOffset, i6, iArr3);
        ...
        if (getOverScrollMode() != 2) {
            ...
            considerReleasingGlowsOnScroll(i, i4);
        }
        if (i10 != 0 || i11 != 0) {
        ...
        return (!z4 && i10 == 0 && i11 == 0) ? false : true;
    }

    public void scrollStep(int i, int i4, @Nullable int[] iArr) {
        startInterceptRequestLayout();
        onEnterLayoutOrScroll();
        TraceCompat.beginSection(TRACE_SCROLL_TAG);
        fillRemainingScrollValues(this.mState);
        int iScrollHorizontallyBy = i != 0 ? this.mLayout.scrollHorizontallyBy(i, this.mRecycler, this.mState) : 0;
        int iScrollVerticallyBy = i4 != 0 ? this.mLayout.scrollVerticallyBy(i4, this.mRecycler, this.mState) : 0;
        TraceCompat.endSection();
    ...
    public void setLayoutManager(@Nullable LayoutManager layoutManager) {
        ...
        if (layoutManager != null) {
            if (layoutManager.mRecyclerView != null) {
                ...
                throw new IllegalArgumentException(c.k(layoutManager.mRecyclerView, sb2));
            }
    ...
    public void setScrollState(int i) {
        ...
        if (sVerboseLoggingEnabled) {
            StringBuilder sbT = s.t(i, "setting scroll state to ", " from ");
    ...
    public void smoothScrollBy(@Px int i, @Px int i4) {
        smoothScrollBy(i, i4, null);
    }
    ...
    public void viewRangeUpdate(int i, int i4, Object obj) {
        int i6;
        int unfilteredChildCount = this.mChildHelper.getUnfilteredChildCount();
        int i10 = i + i4;
        for (int i11 = 0; i11 < unfilteredChildCount; i11++) {
            ...
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore() && (i6 = childViewHolderInt.mPosition) >= i && i6 < i10) {
                childViewHolderInt.addFlags(2);
                childViewHolderInt.addChangePayload(obj);
                ((LayoutParams) unfilteredChildAt.getLayoutParams()).mInsetsDirty = true;
            }
        }
        this.mRecycler.viewRangeUpdate(i, i4);
    }
    ...
    public boolean dispatchNestedPreScroll(int i, int i4, int[] iArr, int[] iArr2, int i6) {
        return getScrollingChildHelper().dispatchNestedPreScroll(i, i4, iArr, iArr2, i6);
    }

    @Override // androidx.core.view.NestedScrollingChild2
    public boolean dispatchNestedScroll(int i, int i4, int i6, int i10, int[] iArr, int i11) {
        return getScrollingChildHelper().dispatchNestedScroll(i, i4, i6, i10, iArr, i11);
    }
    ...
    */
    ...
    public void smoothScrollBy(@Px int i, @Px int i4, @Nullable Interpolator interpolator) {
        smoothScrollBy(i, i4, interpolator, Integer.MIN_VALUE);
    }

    @Override // androidx.core.view.NestedScrollingChild2
    public boolean startNestedScroll(int i, int i4) {
        return getScrollingChildHelper().startNestedScroll(i, i4);
    }
    ...
    public final void dispatchNestedScroll(int i, int i4, int i6, int i10, int[] iArr, int i11, @NonNull int[] iArr2) {
        getScrollingChildHelper().dispatchNestedScroll(i, i4, i6, i10, iArr, i11, iArr2);
    }

    public void smoothScrollBy(@Px int i, @Px int i4, @Nullable Interpolator interpolator, int i6) {
        smoothScrollBy(i, i4, interpolator, i6, false);
    }
    ...
    public void smoothScrollBy(@Px int i, @Px int i4, @Nullable Interpolator interpolator, int i6, boolean z4) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
            return;
        ...
        this.mViewFlinger.smoothScrollBy(i, i4, i6, interpolator);
    }
