...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    private int clampApplyScroll(int i, int i4) {
        int i6 = i - i4;
        if (i * i6 <= 0) {
            return 0;
        }
    ...
    public int calculateDtToFit(int i, int i4, int i6, int i10, int i11) {
        if (i11 == -1) {
            return i6 - i;
        }
        if (i11 != 0) {
    ...
    @SuppressLint({"UnknownNullness"})
    public void onSeekTargetStep(int i, int i4, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
        this.mInterimTargetDx = clampApplyScroll(this.mInterimTargetDx, i);
        int iClampApplyScroll = clampApplyScroll(this.mInterimTargetDy, i4);
