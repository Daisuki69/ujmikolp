...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class MoveInfo {
        ...
        public MoveInfo(RecyclerView.ViewHolder viewHolder, int i, int i4, int i6, int i10) {
    ...
    @Override // androidx.recyclerview.widget.SimpleItemAnimator
    @SuppressLint({"UnknownNullness"})
    public boolean animateChange(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i, int i4, int i6, int i10) {
        if (viewHolder == viewHolder2) {
            return animateMove(viewHolder, i, i4, i6, i10);
        }
        float translationX = viewHolder.itemView.getTranslationX();
        float translationY = viewHolder.itemView.getTranslationY();
        float alpha = viewHolder.itemView.getAlpha();
        resetAnimation(viewHolder);
        int i11 = (int) ((i6 - i) - translationX);
        int i12 = (int) ((i10 - i4) - translationY);
        ...
        this.mPendingChanges.add(new ChangeInfo(viewHolder, viewHolder2, i, i4, i6, i10));
        return true;
    }
    ...
    @Override // androidx.recyclerview.widget.SimpleItemAnimator
    @SuppressLint({"UnknownNullness"})
    public boolean animateMove(RecyclerView.ViewHolder viewHolder, int i, int i4, int i6, int i10) {
        ...
        this.mPendingMoves.add(new MoveInfo(viewHolder, translationX, translationY, i6, i10));
        return true;
    }

    public void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int i, int i4, int i6, int i10) {
        final View view = viewHolder.itemView;
        final int i11 = i6 - i;
        final int i12 = i10 - i4;
        if (i11 != 0) {
    ...
    public static class ChangeInfo {
        ...
        public String toString() {
            ...
            sb2.append(this.toX);
            sb2.append(", toY=");
            return s.m(sb2, this.toY, '}');
        }

        public ChangeInfo(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i, int i4, int i6, int i10) {
