...
public final class LocaleListCompat {
    ...
    public static Locale forLanguageTagCompat(String str) {
        if (str.contains(Global.HYPHEN)) {
            ...
            if (!str.contains(Global.UNDERSCORE)) {
                return new Locale(str);
            }
            String[] strArrSplit2 = str.split(Global.UNDERSCORE, -1);
        ...
        throw new IllegalArgumentException(s.j("Can not parse language tag: [", str, "]"));
    }
    ...
    public static LocaleListCompat wrap(Object obj) {
        return wrap(androidx.core.location.a.h(obj));
    }
