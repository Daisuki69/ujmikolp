...
public final class Insets {
    ...
    public static class Api29Impl {
        ...
        public static android.graphics.Insets of(int i, int i4, int i6, int i10) {
            return android.graphics.Insets.of(i, i4, i6, i10);
        }
    }

    private Insets(int i, int i4, int i6, int i10) {
        this.left = i;
        this.top = i4;
        this.right = i6;
        this.bottom = i10;
    ...
    public static Insets of(int i, int i4, int i6, int i10) {
        return (i == 0 && i4 == 0 && i6 == 0 && i10 == 0) ? NONE : new Insets(i, i4, i6, i10);
    }
