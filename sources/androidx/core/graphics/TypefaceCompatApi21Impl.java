...
class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
    ...
    private static boolean addFontWeightStyle(Object obj, String str, int i, boolean z4) throws NoSuchMethodException {
        init();
        try {
            try {
                return ((Boolean) sAddFontWeightStyle.invoke(obj, str, Integer.valueOf(i), Boolean.valueOf(z4))).booleanValue();
