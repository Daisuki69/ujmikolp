...
public class TypefaceCompatApi29Impl extends TypefaceCompatBaseImpl {
    ...
    private Font findBaseFont(FontFamily fontFamily, int i) {
        FontStyle fontStyle = new FontStyle((i & 1) != 0 ? TypedValues.TransitionType.TYPE_DURATION : YTAGReflectLiveCheckInterface.LightLiveCheckResult.INIT_ERROR, (i & 2) != 0 ? 1 : 0);
    ...
    public Typeface createFromFontInfoWithFallback(Context context, CancellationSignal cancellationSignal, List<FontsContractCompat.FontInfo[]> list, int i) {
        ...
        try {
            ...
            for (int i4 = 1; i4 < list.size(); i4++) {
                FontFamily fontFamily2 = getFontFamily(cancellationSignal, list.get(i4), contentResolver);
                if (fontFamily2 != null) {
