...
class RequestExecutor {
    ...
    public static ThreadPoolExecutor createDefaultExecutor(String str, int i, @IntRange(from = 0) int i4) {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(0, 1, i4, TimeUnit.MILLISECONDS, new LinkedBlockingDeque(), new DefaultThreadFactory(str, i));
    ...
    public static <T> T submit(ExecutorService executorService, Callable<T> callable, @IntRange(from = 0) int i) throws InterruptedException {
        try {
