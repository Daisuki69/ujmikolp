...
public final class TextViewCompat {
    ...
    public static class Api26Impl {
        ...
        public static void setAutoSizeTextTypeUniformWithConfiguration(TextView textView, int i, int i4, int i6, int i10) {
            textView.setAutoSizeTextTypeUniformWithConfiguration(i, i4, i6, i10);
        }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static void setAutoSizeTextTypeUniformWithConfiguration(TextView textView, int i, int i4, int i6, int i10) throws IllegalArgumentException {
        if (Build.VERSION.SDK_INT >= 27) {
            Api26Impl.setAutoSizeTextTypeUniformWithConfiguration(textView, i, i4, i6, i10);
        } else if (textView instanceof AutoSizeableTextView) {
            ((AutoSizeableTextView) textView).setAutoSizeTextTypeUniformWithConfiguration(i, i4, i6, i10);
        }
    }
    ...
    @ReplaceWith(expression = "textView.setCompoundDrawablesRelativeWithIntrinsicBounds(start, top, end, bottom)")
    @Deprecated
    public static void setCompoundDrawablesRelativeWithIntrinsicBounds(TextView textView, @DrawableRes int i, @DrawableRes int i4, @DrawableRes int i6, @DrawableRes int i10) {
        textView.setCompoundDrawablesRelativeWithIntrinsicBounds(i, i4, i6, i10);
    }
