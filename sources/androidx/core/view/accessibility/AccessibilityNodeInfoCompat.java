...
public class AccessibilityNodeInfoCompat {
    ...
    public static class Api30Impl {
        ...
        public static Object createRangeInfo(int i, float f, float f3, float f7) {
            return new AccessibilityNodeInfo.RangeInfo(i, f, f3, f7);
        }
    ...
    public static class Api33Impl {
        ...
        public static CollectionItemInfoCompat buildCollectionItemInfoCompat(boolean z4, int i, int i4, int i6, int i10, boolean z5, String str, String str2) {
            return new CollectionItemInfoCompat(new AccessibilityNodeInfo.CollectionItemInfo.Builder().setHeading(z4).setColumnIndex(i).setRowIndex(i4).setColumnSpan(i6).setRowSpan(i10).setSelected(z5).setRowTitle(str).setColumnTitle(str2).build());
        }

        public static AccessibilityNodeInfoCompat getChild(AccessibilityNodeInfo accessibilityNodeInfo, int i, int i4) {
            return AccessibilityNodeInfoCompat.wrapNonNullInstance(accessibilityNodeInfo.getChild(i, i4));
        }
    ...
    public static class Api35Impl {
        ...
        public static CollectionInfoCompat buildCollectionInfoCompat(int i, int i4, boolean z4, int i6, int i10, int i11) {
            return new CollectionInfoCompat(new AccessibilityNodeInfo.CollectionInfo.Builder().setRowCount(i).setColumnCount(i4).setHierarchical(z4).setSelectionMode(i6).setItemCount(i10).setImportantForAccessibilityItemCount(i11).build());
        }
    ...
    public static class CollectionInfoCompat {
        ...
        public static final class Builder {
            ...
            public Builder setHierarchical(boolean z4) {
                this.mHierarchical = z4;
                return this;
            }
        ...
        public static CollectionInfoCompat obtain(int i, int i4, boolean z4, int i6) {
            return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(i, i4, z4, i6));
        }
        ...
        public static CollectionInfoCompat obtain(int i, int i4, boolean z4) {
            return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(i, i4, z4));
        }
    }
    ...
    public static class CollectionItemInfoCompat {
        ...
        public static CollectionItemInfoCompat obtain(int i, int i4, int i6, int i10, boolean z4, boolean z5) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i, i4, i6, i10, z4, z5));
        }
        ...
        public static CollectionItemInfoCompat obtain(int i, int i4, int i6, int i10, boolean z4) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i, i4, i6, i10, z4));
        }
    }
    ...
    private int idForClickableSpan(ClickableSpan clickableSpan, SparseArray<WeakReference<ClickableSpan>> sparseArray) {
        ...
        int i4 = sClickableSpanId;
        sClickableSpanId = i4 + 1;
        return i4;
    }
    ...
    private void removeCollectedSpans(View view) {
        ...
        if (spansFromViewTags != null) {
            ...
            for (int i4 = 0; i4 < arrayList.size(); i4++) {
                spansFromViewTags.remove(((Integer) arrayList.get(i4)).intValue());
            }
        }
    }

    private void setBooleanProperty(int i, boolean z4) {
        Bundle extras = getExtras();
        if (extras != null) {
    ...
    public void setFieldRequired(boolean z4) {
        this.mInfo.getExtras().putBoolean(IS_REQUIRED_KEY, z4);
    }
    ...
    public void setTextSelection(int i, int i4) {
        this.mInfo.setTextSelection(i, i4);
    }
    ...
    public static class RangeInfoCompat {
        ...
        public static RangeInfoCompat obtain(int i, float f, float f3, float f7) {
            return new RangeInfoCompat(AccessibilityNodeInfo.RangeInfo.obtain(i, f, f3, f7));
        }
        ...
        public RangeInfoCompat(int i, float f, float f3, float f7) {
            if (Build.VERSION.SDK_INT >= 30) {
                this.mInfo = Api30Impl.createRangeInfo(i, f, f3, f7);
            } else {
                this.mInfo = AccessibilityNodeInfo.RangeInfo.obtain(i, f, f3, f7);
            }
        }
    }
    ...
    public AccessibilityNodeInfoCompat getChild(int i, int i4) {
        return Build.VERSION.SDK_INT >= 33 ? Api33Impl.getChild(this.mInfo, i, i4) : getChild(i);
    }
