...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl21 extends Impl {
        ...
        public static class Impl21OnApplyWindowInsetsListener implements View.OnApplyWindowInsetsListener {
            ...
            public WindowInsets onApplyWindowInsets(final View view, WindowInsets windowInsets) {
                ...
                final WindowInsetsAnimationCompat windowInsetsAnimationCompat = new WindowInsetsAnimationCompat(i6, Impl21.createInsetInterpolator(i, i4), (WindowInsetsCompat.Type.ime() & i6) != 0 ? 160L : 250L);
                ...
                final BoundsCompat boundsCompatComputeAnimationBounds = Impl21.computeAnimationBounds(windowInsetsCompat, windowInsetsCompat2, i6);
                ...
                duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.core.view.WindowInsetsAnimationCompat.Impl21.Impl21OnApplyWindowInsetsListener.1
                    ...
                    public void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ...
                        Impl21.dispatchOnProgress(view, Impl21.interpolateInsets(windowInsetsCompat, windowInsetsCompat2, windowInsetsAnimationCompat.getInterpolatedFraction(), i6), Collections.singletonList(windowInsetsAnimationCompat));
                    }
                });
        ...
        public static void buildAnimationMask(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, int[] iArr, int[] iArr2) {
            for (int i = 1; i <= 512; i <<= 1) {
                ...
                int i4 = insets.left;
                int i6 = insets2.left;
                boolean z4 = i4 > i6 || insets.top > insets2.top || insets.right > insets2.right || insets.bottom > insets2.bottom;
                if (z4 != (i4 < i6 || insets.top < insets2.top || insets.right < insets2.right || insets.bottom < insets2.bottom)) {
                    if (z4) {
                        iArr[0] = iArr[0] | i;
                    } else {
                        iArr2[0] = iArr2[0] | i;
        ...
        public static void dispatchOnPrepare(View view, WindowInsetsAnimationCompat windowInsetsAnimationCompat, WindowInsetsCompat windowInsetsCompat, boolean z4) {
            Callback callback = getCallback(view);
            if (callback != null) {
            ...
            if (view instanceof ViewGroup) {
                ViewGroup viewGroup = (ViewGroup) view;
                for (int i = 0; i < viewGroup.getChildCount(); i++) {
                    dispatchOnPrepare(viewGroup.getChildAt(i), windowInsetsAnimationCompat, windowInsetsCompat, z4);
                }
            }
        }
        ...
        public static WindowInsetsCompat interpolateInsets(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f, int i) {
            ...
            for (int i4 = 1; i4 <= 512; i4 <<= 1) {
                if ((i & i4) == 0) {
                    ...
                    float f3 = 1.0f - f;
                    builder.setInsets(i4, WindowInsetsCompat.insetInsets(insets, (int) (((double) ((insets.left - insets2.left) * f3)) + 0.5d), (int) (((double) ((insets.top - insets2.top) * f3)) + 0.5d), (int) (((double) ((insets.right - insets2.right) * f3)) + 0.5d), (int) (((double) ((insets.bottom - insets2.bottom) * f3)) + 0.5d)));
                }
            }
    ...
    public static class Impl30 extends Impl {
        ...
        public static class ProxyCallback extends WindowInsetsAnimation$Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation windowInsetsAnimationH = q.h(list.get(size));
                    WindowInsetsAnimationCompat windowInsetsAnimationCompat = getWindowInsetsAnimationCompat(windowInsetsAnimationH);
                    windowInsetsAnimationCompat.setFraction(windowInsetsAnimationH.getFraction());
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(BoundsCompat boundsCompat) {
            D.o();
            return D.h(boundsCompat.getLowerBound().toPlatformInsets(), boundsCompat.getUpperBound().toPlatformInsets());
        }
