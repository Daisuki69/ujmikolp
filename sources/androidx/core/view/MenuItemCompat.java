...
public final class MenuItemCompat {
    ...
    public static class Api26Impl {
        ...
        public static MenuItem setShortcut(MenuItem menuItem, char c, char c10, int i, int i4) {
            return menuItem.setShortcut(c, c10, i, i4);
        }
    ...
    public static void setShortcut(MenuItem menuItem, char c, char c10, int i, int i4) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setShortcut(c, c10, i, i4);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setShortcut(menuItem, c, c10, i, i4);
        }
    }
