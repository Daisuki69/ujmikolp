    ...
    public SystemBarStateMonitor(final ViewGroup viewGroup) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(view, new OnApplyWindowInsetsListener() { // from class: androidx.core.view.insets.c
            ...
            public final WindowInsetsCompat onApplyWindowInsets(View view2, WindowInsetsCompat windowInsetsCompat) {
                return this.f7815a.lambda$new$0(view2, windowInsetsCompat);
            }
        });
        ViewCompat.setWindowInsetsAnimationCallback(view, new WindowInsetsAnimationCompat.Callback(i) { // from class: androidx.core.view.insets.SystemBarStateMonitor.2
            ...
            public WindowInsetsCompat onProgress(WindowInsetsCompat windowInsetsCompat, List<WindowInsetsAnimationCompat> list) {
                ...
                for (int size2 = SystemBarStateMonitor.this.mCallbacks.size() - 1; size2 >= 0; size2--) {
                    ((Callback) SystemBarStateMonitor.this.mCallbacks.get(size2)).onAnimationProgress(i4, insets2, rectF);
                }
            ...
            public WindowInsetsAnimationCompat.BoundsCompat onStart(WindowInsetsAnimationCompat windowInsetsAnimationCompat, WindowInsetsAnimationCompat.BoundsCompat boundsCompat) {
                ...
                int i4 = upperBound.left != lowerBound.left ? 1 : 0;
                ...
                this.mAnimationSidesMap.put(windowInsetsAnimationCompat, Integer.valueOf(i4));
                return boundsCompat;
            }
        });
    ...
    public void detachFromWindow() {
        this.mDetector.post(new Runnable() { // from class: androidx.core.view.insets.d
            ...
            public final void run() {
                this.f7816a.lambda$detachFromWindow$1();
            }
        });
    }
