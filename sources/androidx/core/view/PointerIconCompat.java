...
public final class PointerIconCompat {
    ...
    public static class Api24Impl {
        ...
        public static PointerIcon create(Bitmap bitmap, float f, float f3) {
    ...
    public static PointerIconCompat create(Bitmap bitmap, float f, float f3) {
        return Build.VERSION.SDK_INT >= 24 ? new PointerIconCompat(Api24Impl.create(bitmap, f, f3)) : new PointerIconCompat(null);
    }
