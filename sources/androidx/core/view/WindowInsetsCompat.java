...
public class WindowInsetsCompat {
    ...
    public static class BuilderImpl {
        ...
        public void setInsets(int i, Insets insets) {
            ...
            for (int i4 = 1; i4 <= 512; i4 <<= 1) {
                if ((i & i4) != 0) {
                    this.mInsetsTypeMask[Type.indexOf(i4)] = insets;
                }
            }
        }
        ...
        public void setVisible(int i, boolean z4) {
        }
    ...
    public static class BuilderImpl30 extends BuilderImpl29 {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setVisible(int i, boolean z4) {
            this.mPlatBuilder.setVisible(TypeImpl30.toPlatformType(i), z4);
        }
    ...
    public static class BuilderImpl34 extends BuilderImpl30 {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl30, androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setVisible(int i, boolean z4) {
            this.mPlatBuilder.setVisible(TypeImpl34.toPlatformType(i), z4);
        }
    ...
    public static class Impl {
        ...
        public WindowInsetsCompat inset(int i, int i4, int i6, int i10) {
            return CONSUMED;
        }
    ...
    public static class Impl20 extends Impl {
        ...
        public static boolean systemBarVisibilityEquals(int i, int i4) {
            return (i & 6) == (i4 & 6);
        }
        ...
        public Insets getInsetsForType(int i, boolean z4) {
            Insets stableInsets;
            int i4;
            if (i == 1) {
                return z4 ? Insets.of(0, Math.max(getRootStableInsets().top, getSystemWindowInsets().top), 0, 0) : (this.mSystemUiVisibility & 4) != 0 ? Insets.NONE : Insets.of(0, getSystemWindowInsets().top, 0, 0);
            }
            if (i == 2) {
                if (z4) {
            ...
            return (insets == null || insets.equals(Insets.NONE) || (i4 = this.mRootViewVisibleInsets.bottom) <= rootStableInsets2.bottom) ? Insets.NONE : Insets.of(0, 0, 0, i4);
        }
        ...
        public WindowInsetsCompat inset(int i, int i4, int i6, int i10) {
            ...
            builder.setSystemWindowInsets(WindowInsetsCompat.insetInsets(getSystemWindowInsets(), i, i4, i6, i10));
            builder.setStableInsets(WindowInsetsCompat.insetInsets(getStableInsets(), i, i4, i6, i10));
        ...
        @SuppressLint({"WrongConstant"})
        private Insets getInsets(int i, boolean z4) {
            Insets insetsMax = Insets.NONE;
            for (int i4 = 1; i4 <= 512; i4 <<= 1) {
                if ((i & i4) != 0) {
                    insetsMax = Insets.max(insetsMax, getInsetsForType(i4, z4));
                }
            }
            return insetsMax;
        }
    ...
    public static final class Type {
        ...
        public static int indexOf(int i) {
            ...
            throw new IllegalArgumentException(We.s.f(i, "type needs to be >= FIRST and <= LAST, type="));
        }
    ...
    public static Insets insetInsets(Insets insets, int i, int i4, int i6, int i10) {
        int iMax = Math.max(0, insets.left - i);
        int iMax2 = Math.max(0, insets.top - i4);
        int iMax3 = Math.max(0, insets.right - i6);
        int iMax4 = Math.max(0, insets.bottom - i10);
        return (iMax == i && iMax2 == i4 && iMax3 == i6 && iMax4 == i10) ? insets : Insets.of(iMax, iMax2, iMax3, iMax4);
    }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i, int i4, int i6, int i10) {
        return new Builder(this).setSystemWindowInsets(Insets.of(i, i4, i6, i10)).build();
    }
    ...
    public static class BuilderImpl29 extends BuilderImpl {
        ...
        public BuilderImpl29() {
            this.mPlatBuilder = androidx.coordinatorlayout.widget.a.d();
        }
        ...
        public BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            ...
            if (windowInsets != null) {
                builderD = androidx.coordinatorlayout.widget.a.e(windowInsets);
            } else {
                builderD = androidx.coordinatorlayout.widget.a.d();
            }
            this.mPlatBuilder = builderD;
        }
    }
    ...
    public WindowInsetsCompat inset(@IntRange(from = 0) int i, @IntRange(from = 0) int i4, @IntRange(from = 0) int i6, @IntRange(from = 0) int i10) {
        return this.mImpl.inset(i, i4, i6, i10);
    }
    ...
    public static class Impl29 extends Impl28 {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.Impl20, androidx.core.view.WindowInsetsCompat.Impl
        public WindowInsetsCompat inset(int i, int i4, int i6, int i10) {
            return WindowInsetsCompat.toWindowInsetsCompat(this.mPlatformInsets.inset(i, i4, i6, i10));
        }
    ...
    public static final class Builder {
        ...
        public Builder setVisible(int i, boolean z4) {
            this.mImpl.setVisible(i, z4);
            return this;
        }
