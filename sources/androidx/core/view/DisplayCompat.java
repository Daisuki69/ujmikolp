...
public final class DisplayCompat {
        ...
        public static ModeCompat[] getSupportedModes(Context context, Display display) {
            ...
            if (currentDisplaySizeFromWorkarounds == null || physicalSizeEquals(mode, currentDisplaySizeFromWorkarounds)) {
                ...
                for (int i4 = 0; i4 < supportedModes.length; i4++) {
                    modeCompatArr[i4] = physicalSizeEquals(supportedModes[i4], mode) ? new ModeCompat(supportedModes[i4], currentDisplaySizeFromWorkarounds) : new ModeCompat(supportedModes[i4], false);
                }
            }
    ...
    public static final class ModeCompat {
        ...
        @RequiresApi(23)
        public ModeCompat(Display.Mode mode, boolean z4) {
