...
public class PrecomputedTextCompat implements Spannable {
    ...
    @Override // android.text.Spanned
    public <T> T[] getSpans(int i, int i4, Class<T> cls) {
        return Build.VERSION.SDK_INT >= 29 ? (T[]) this.mWrapped.getSpans(i, i4, cls) : (T[]) this.mText.getSpans(i, i4, cls);
    }
    ...
    @Override // android.text.Spanned
    public int nextSpanTransition(int i, int i4, Class cls) {
        return this.mText.nextSpanTransition(i, i4, cls);
    }
    ...
    @Override // android.text.Spannable
    public void setSpan(Object obj, int i, int i4, int i6) {
        if (obj instanceof MetricAffectingSpan) {
            throw new IllegalArgumentException("MetricAffectingSpan can not be set to PrecomputedText.");
        }
        if (Build.VERSION.SDK_INT >= 29) {
            this.mWrapped.setSpan(obj, i, i4, i6);
        } else {
            this.mText.setSpan(obj, i, i4, i6);
        }
    }

    @Override // java.lang.CharSequence
    public CharSequence subSequence(int i, int i4) {
        return this.mText.subSequence(i, i4);
    }
    ...
    public static final class Params {
        ...
        public Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i4) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped = h.m(textPaint).setBreakStrategy(i).setHyphenationFrequency(i4).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.mWrapped = null;
            }
            this.mPaint = textPaint;
