...
public final class LocalePreferences {
    ...
    private static String getBaseHourCycle(Locale locale) {
        return android.text.format.DateFormat.getBestDateTimePattern(locale, "jm").contains(i.f16182n) ? HourCycle.H23 : HourCycle.H12;
    }
    ...
    public static String getCalendarType(boolean z4) {
        ...
        return getCalendarType(defaultLocale, z4);
    }
    ...
    public static String getFirstDayOfWeek(boolean z4) {
        ...
        return getFirstDayOfWeek(defaultLocale, z4);
    }
    ...
    public static String getHourCycle(boolean z4) {
        ...
        return getHourCycle(defaultLocale, z4);
    }
    ...
    public static String getTemperatureUnit(boolean z4) {
        ...
        return getTemperatureUnit(defaultLocale, z4);
    }

    public static String getCalendarType(Locale locale, boolean z4) {
        ...
        return z4 ? CalendarType.GREGORIAN : "";
    }

    public static String getFirstDayOfWeek(Locale locale, boolean z4) {
    ...
    public static String getHourCycle(Locale locale, boolean z4) {
    ...
    public static String getTemperatureUnit(Locale locale, boolean z4) {
