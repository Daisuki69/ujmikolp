...
public final class LinkifyCompat {
    ...
    private static void applyLink(String str, int i, int i4, Spannable spannable) {
        spannable.setSpan(new URLSpan(str), i, i4, 33);
    }
    ...
    private static String makeUrl(String str, String[] strArr, Matcher matcher, Linkify.TransformFilter transformFilter) {
        ...
        while (true) {
            ...
            if (string.regionMatches(true, 0, str2, 0, str2.length())) {
                ...
                if (!string.regionMatches(false, 0, str2, 0, str2.length())) {
                    StringBuilder sbW = androidx.camera.core.impl.a.w(str2);
                    sbW.append(string.substring(str2.length()));
                    string = sbW.toString();
                }
            } else {
                i++;
        ...
        return (z4 || strArr.length <= 0) ? string : s.p(new StringBuilder(), strArr[0], string);
    }
    ...
    private static void pruneOverlaps(ArrayList<LinkSpec> arrayList, Spannable spannable) {
        ...
        while (i4 < size - 1) {
            ...
            if (i10 <= i11 && (i = linkSpec2.end) > i11) {
                int i12 = linkSpec3.end;
                int i13 = (i12 > i && i - i10 <= i12 - i11) ? i - i10 < i12 - i11 ? i4 : -1 : i6;
                if (i13 != -1) {
                    Object obj = arrayList.get(i13).frameworkAddedSpan;
                    if (obj != null) {
