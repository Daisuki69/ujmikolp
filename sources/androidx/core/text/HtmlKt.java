...
public final class HtmlKt {
    ...
    public static /* synthetic */ Spanned parseAsHtml$default(String str, int i, Html.ImageGetter imageGetter, Html.TagHandler tagHandler, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = 0;
        }
        if ((i4 & 2) != 0) {
    ...
    public static /* synthetic */ String toHtml$default(Spanned spanned, int i, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = 0;
        }
        return HtmlCompat.toHtml(spanned, i);
