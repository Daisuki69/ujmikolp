...
public class ShortcutInfoCompat {
            ...
            if (this.mCapabilityBindingParams != null) {
                ...
                for (String str : this.mCapabilityBindingParams.keySet()) {
                    ...
                    for (String str2 : map.keySet()) {
                        ...
                        this.mInfo.mExtras.putStringArray(androidx.camera.core.impl.a.j(str, "/", str2), list == null ? new String[0] : (String[]) list.toArray(new String[0]));
                    }
                }
            }
    ...
    private PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            while (i < this.mPersons.length) {
                ...
                int i4 = i + 1;
                sb2.append(i4);
                persistableBundle.putPersistableBundle(sb2.toString(), this.mPersons[i].toPersistableBundle());
                i = i4;
            }
        }
    ...
    public static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, Oe.a.l(it.next())).build());
        }
        return arrayList;
    }
    ...
    public static Person[] getPersonsFromExtra(PersistableBundle persistableBundle) {
        ...
        while (i4 < i) {
            ...
            int i6 = i4 + 1;
            sb2.append(i6);
            personArr[i4] = Person.fromPersistableBundle(persistableBundle.getPersistableBundle(sb2.toString()));
            i4 = i6;
        }
        return personArr;
    }
    ...
    public ShortcutInfo toShortcutInfo() {
        Oe.a.r();
        ShortcutInfo.Builder intents = Oe.a.d(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
