...
public final class PackageInfoCompat {
    ...
    public static boolean hasSignatures(PackageManager packageManager, String str, @Size(min = 1) Map<byte[], Integer> map, boolean z4) throws PackageManager.NameNotFoundException {
        byte[][] bArr;
        if (map.isEmpty()) {
            return false;
        }
        ...
        for (byte[] bArr2 : setKeySet) {
            if (bArr2 == null) {
                throw new IllegalArgumentException(AbstractC1414e.h("Cert byte array cannot be null when verifying ", str));
            }
            Integer num = map.get(bArr2);
            if (num == null) {
                throw new IllegalArgumentException(AbstractC1414e.h("Type must be specified for cert when verifying ", str));
            }
