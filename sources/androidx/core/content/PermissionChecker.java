...
public final class PermissionChecker {
    ...
    public static int checkPermission(Context context, String str, int i, int i4, String str2) {
        ...
        return ((Process.myUid() != i4 || !ObjectsCompat.equals(context.getPackageName(), str2)) ? AppOpsManagerCompat.noteProxyOpNoThrow(context, strPermissionToOp, str2) : AppOpsManagerCompat.checkOrNoteProxyOp(context, i4, strPermissionToOp, str2)) == 0 ? 0 : -2;
    }
