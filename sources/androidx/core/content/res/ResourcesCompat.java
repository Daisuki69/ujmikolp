...
public final class ResourcesCompat {
    ...
    public static class Api21Impl {
        ...
        public static Drawable getDrawableForDensity(Resources resources, int i, int i4, Resources.Theme theme) {
    ...
    public static abstract class FontCallback {
        ...
        public final void callbackFailAsync(int i, Handler handler) {
            getHandler(handler).post(new p(this, i, 3));
        }

        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public final void callbackSuccessAsync(Typeface typeface, Handler handler) {
            getHandler(handler).post(new g(26, this, typeface));
        }
    ...
    */
    ...
    public static Drawable getDrawableForDensity(Resources resources, @DrawableRes int i, int i4, Resources.Theme theme) throws Resources.NotFoundException {
        return Api21Impl.getDrawableForDensity(resources, i, i4, theme);
    }
    ...
    private static Typeface loadFont(Context context, int i, TypedValue typedValue, int i4, FontCallback fontCallback, Handler handler, boolean z4, boolean z5) {
        Resources resources = context.getResources();
        resources.getValue(i, typedValue, true);
        Typeface typefaceLoadFont = loadFont(context, resources, typedValue, i, i4, fontCallback, handler, z4, z5);
        if (typefaceLoadFont != null || fontCallback != null || z5) {
    ...
    */
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public static Typeface getFont(Context context, @FontRes int i, TypedValue typedValue, int i4, FontCallback fontCallback) throws Resources.NotFoundException {
        if (context.isRestricted()) {
            return null;
        }
        return loadFont(context, i, typedValue, i4, fontCallback, null, true, false);
    }
}
