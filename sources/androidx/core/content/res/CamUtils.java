...
final class CamUtils {
    ...
    public static int intFromLStar(float f) {
        ...
        float f7 = f > 8.0f ? f3 * f3 * f3 : f / 903.2963f;
        float f10 = f3 * f3 * f3;
        boolean z4 = f10 > 0.008856452f;
        float f11 = z4 ? f10 : ((f3 * 116.0f) - 16.0f) / 903.2963f;
        if (!z4) {
            f10 = ((f3 * 116.0f) - 16.0f) / 903.2963f;
        }
        float[] fArr = WHITE_POINT_D65;
        return ColorUtils.XYZToColor(f11 * fArr[0], f7 * fArr[1], f10 * fArr[2]);
    }
