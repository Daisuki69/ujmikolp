...
public final class ColorStateListInflaterCompat {
    ...
    @ColorInt
    private static int modulateColorAlpha(@ColorInt int i, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 100.0d) float f3) {
        boolean z4 = f3 >= 0.0f && f3 <= 100.0f;
        if (f == 1.0f && !z4) {
            return i;
        }
