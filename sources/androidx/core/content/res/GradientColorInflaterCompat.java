...
final class GradientColorInflaterCompat {
    ...
    private static ColorStops checkColors(ColorStops colorStops, @ColorInt int i, @ColorInt int i4, boolean z4, @ColorInt int i6) {
        return colorStops != null ? colorStops : z4 ? new ColorStops(i, i6, i4) : new ColorStops(i, i4);
    }
    ...
    public static Shader createFromXmlInner(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        int namedInt = TypedArrayUtils.getNamedInt(typedArrayObtainAttributes, xmlPullParser, SessionDescription.ATTR_TYPE, R.styleable.GradientColor_android_type, 0);
    ...
    */
    ...
    public static final class ColorStops {
        ...
        public ColorStops(@ColorInt int i, @ColorInt int i4) {
            this.mColors = new int[]{i, i4};
            this.mOffsets = new float[]{0.0f, 1.0f};
        }

        public ColorStops(@ColorInt int i, @ColorInt int i4, @ColorInt int i6) {
            this.mColors = new int[]{i, i4, i6};
