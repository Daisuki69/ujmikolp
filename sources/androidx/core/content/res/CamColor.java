...
public class CamColor {
    ...
    public CamColor(float f, float f3, float f7, float f10, float f11, float f12, float f13, float f14, float f15) {
        this.mHue = f;
        this.mChroma = f3;
        this.mJ = f7;
        this.mQ = f10;
    ...
    private static CamColor findCamByJ(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 360.0d) float f, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = Double.POSITIVE_INFINITY, toInclusive = false) float f3, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 100.0d) float f7) {
        float f10 = 100.0f;
        float f11 = 1000.0f;
        float f12 = 0.0f;
        ...
        while (Math.abs(f12 - f10) > LIGHTNESS_SEARCH_ENDPOINT) {
            ...
            int iViewedInSrgb = fromJch(f14, f3, f).viewedInSrgb();
    ...
    public static void fromColorInViewingConditions(@ColorInt int i, ViewingConditions viewingConditions, @Size(7) float[] fArr, @Size(ImageCapture.SCREEN_FLASH_UI_APPLY_TIMEOUT_SECONDS) float[] fArr2) {
        ...
        float f3 = fArr4[0] * f;
        float f7 = fArr2[1];
        float f10 = (fArr4[1] * f7) + f3;
        float f11 = fArr2[2];
        float f12 = (fArr4[2] * f11) + f10;
        float[] fArr5 = fArr3[1];
        float f13 = (fArr5[2] * f11) + (fArr5[1] * f7) + (fArr5[0] * f);
        float[] fArr6 = fArr3[2];
        float f14 = (f11 * fArr6[2]) + (f7 * fArr6[1]) + (f * fArr6[0]);
        ...
        double d10 = fSignum3;
        float f18 = ((float) (((((double) fSignum2) * (-12.0d)) + (((double) fSignum) * 11.0d)) + d10)) / 11.0f;
        float f19 = ((float) (((double) (fSignum + fSignum2)) - (d10 * 2.0d))) / 9.0f;
    ...
    private static CamColor fromJch(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 100.0d) float f, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = Double.POSITIVE_INFINITY, toInclusive = false) float f3, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 360.0d) float f7) {
        return fromJchInFrame(f, f3, f7, ViewingConditions.DEFAULT);
    }

    private static CamColor fromJchInFrame(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 100.0d) float f, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = Double.POSITIVE_INFINITY, toInclusive = false) float f3, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 360.0d) float f7, ViewingConditions viewingConditions) {
        ...
        return new CamColor(f7, f3, f, aw, flRoot, fSqrt, f10, ((float) Math.cos(d10)) * fLog, fLog * ((float) Math.sin(d10)));
    }

    public static void getM3HCTfromColor(@ColorInt int i, @Size(ImageCapture.SCREEN_FLASH_UI_APPLY_TIMEOUT_SECONDS) float[] fArr) {
        fromColorInViewingConditions(i, ViewingConditions.DEFAULT, null, fArr);
        fArr[2] = CamUtils.lStarFromInt(i);
    }

    public static int toColor(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 360.0d) float f, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = Double.POSITIVE_INFINITY, toInclusive = false) float f3, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 100.0d) float f7) {
        return toColor(f, f3, f7, ViewingConditions.DEFAULT);
    }
    ...
    @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = Double.POSITIVE_INFINITY, toInclusive = false)
    public float getChroma() {
        return this.mChroma;
    }

    @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 360.0d, toInclusive = false)
    public float getHue() {
        return this.mHue;
    }

    @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 100.0d)
    public float getJ() {
        return this.mJ;
    }
    ...
    @ColorInt
    public static int toColor(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 360.0d) float f, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = Double.POSITIVE_INFINITY, toInclusive = false) float f3, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 100.0d) float f7, ViewingConditions viewingConditions) {
        ...
        while (Math.abs(f10 - f3) >= CHROMA_SEARCH_ENDPOINT) {
            CamColor camColorFindCamByJ = findCamByJ(fMin, f11, f7);
            if (!z4) {
        ...
        return camColor == null ? CamUtils.intFromLStar(f7) : camColor.viewed(viewingConditions);
    }
}
