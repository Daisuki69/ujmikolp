...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        private boolean mAllowSourceBounds;
        private int mAllowedFlags;
        private Predicate<String> mAllowedActions = new c(2);
        private Predicate<Uri> mAllowedData = new c(3);
        private Predicate<String> mAllowedTypes = new c(4);
        private Predicate<String> mAllowedCategories = new c(5);
        private Predicate<String> mAllowedPackages = new c(6);
        private Predicate<ComponentName> mAllowedComponents = new c(7);
        private Map<String, Predicate<Object>> mAllowedExtras = new HashMap();
        private boolean mAllowClipDataText = false;
        private Predicate<Uri> mAllowedClipDataUri = new c(8);
        private Predicate<ClipData> mAllowedClipData = new c(9);
        ...
        public Builder allowAnyComponent() {
            ...
            this.mAllowedComponents = new c(0);
            return this;
        }
        ...
        public Builder allowCategory(String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowCategory(new a(str, 1));
        }
        ...
        public Builder allowClipDataUriWithAuthority(String str) {
            Preconditions.checkNotNull(str);
            return allowClipDataUri(new a(str, 4));
        }
        ...
        public Builder allowComponentWithPackage(String str) {
            Preconditions.checkNotNull(str);
            return allowComponent(new a(str, 2));
        }
        ...
        public Builder allowDataWithAuthority(String str) {
            Preconditions.checkNotNull(str);
            allowData(new a(str, 3));
            return this;
        }

        @SuppressLint({"BuilderSetStyle"})
        public Builder allowExtra(String str, Class<?> cls) {
            return allowExtra(str, cls, new c(10));
        }
        ...
        public Builder allowExtraStreamUriWithAuthority(String str) {
            Preconditions.checkNotNull(str);
            allowExtra("android.intent.extra.STREAM", Uri.class, new a(str, 5));
            return this;
        }
        ...
        public Builder allowPackage(String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowPackage(new a(str, 1));
        }
    ...
    */
    public static void sanitizeClipData(android.content.Intent r7, android.content.Intent r8, androidx.core.util.Predicate<android.content.ClipData> r9, boolean r10, androidx.core.util.Predicate<android.net.Uri> r11, androidx.core.util.Consumer<java.lang.String> r12) {
        ...
        L35:
            ...
            java.lang.StringBuilder r3 = We.s.t(r0, r3, r4)
        ...
        L52:
            ...
            if (r6 == 0) goto L94
            java.lang.StringBuilder r4 = We.s.t(r0, r5, r4)
    ...
    public Intent sanitizeByFiltering(Intent intent) {
        return sanitize(intent, new f(11));
    }

    public Intent sanitizeByThrowing(Intent intent) {
        return sanitize(intent, new f(10));
    }
