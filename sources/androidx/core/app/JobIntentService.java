...
public abstract class JobIntentService extends Service {
    ...
    public static final class JobWorkEnqueuer extends WorkEnqueuer {
        ...
        @Override // androidx.core.app.JobIntentService.WorkEnqueuer
        public void enqueueWork(Intent intent) {
            this.mJobScheduler.enqueue(this.mJobInfo, androidx.camera.camera2.internal.compat.workaround.a.j(intent));
        }
    }
    ...
    public static abstract class WorkEnqueuer {
        ...
        public void ensureJobId(int i) {
            if (!this.mHasJobId) {
                ...
                StringBuilder sbT = s.t(i, "Given job ID ", " is different than previous ");
    ...
    public static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z4, int i) {
