...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            private Builder(IconCompat iconCompat, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, boolean z4, int i, boolean z5, boolean z8, boolean z9) {
        ...
        public Action(int i, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, RemoteInput[] remoteInputArr2, boolean z4, int i4, boolean z5, boolean z8, boolean z9) {
            this(i != 0 ? IconCompat.createWithResource(null, "", i) : null, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z4, i4, z5, z8, z9);
        }

        public Action(IconCompat iconCompat, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, RemoteInput[] remoteInputArr2, boolean z4, int i, boolean z5, boolean z8, boolean z9) {
            this.mShowsUserInterface = true;
            this.mIcon = iconCompat;
    ...
    public static final class BubbleMetadata {
        ...
        public static final class Builder {
            ...
            private Builder setFlag(int i, boolean z4) {
                if (z4) {
                    this.mFlags = i | this.mFlags;
                    return this;
                }
        ...
        private BubbleMetadata(PendingIntent pendingIntent, PendingIntent pendingIntent2, IconCompat iconCompat, int i, @DimenRes int i4, int i6, String str) {
            this.mPendingIntent = pendingIntent;
            this.mIcon = iconCompat;
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(h.g(it2.next())));
                }
            }
            int i = Build.VERSION.SDK_INT;
        ...
        public Builder setLights(@ColorInt int i, int i4, int i6) {
            Notification notification = this.mNotification;
            notification.ledARGB = i;
            notification.ledOnMS = i4;
            notification.ledOffMS = i6;
            notification.flags = ((i4 == 0 || i6 == 0) ? 0 : 1) | (notification.flags & (-2));
            return this;
        }
    ...
    public static class CallStyle extends Style {
        ...
        public static class Api31Impl {
            ...
            public static Notification.CallStyle setIsVideo(Notification.CallStyle callStyle, boolean z4) {
        ...
        @RequiresApi(20)
        private Action makeAction(int i, int i4, Integer num, int i6, PendingIntent pendingIntent) {
            if (num == null) {
                num = Integer.valueOf(ContextCompat.getColor(this.mBuilder.mContext, i6));
            }
        ...
        private Action makeAnswerAction() {
            ...
            return makeAction(z4 ? i : i4, z4 ? R.string.call_notification_answer_video_action : R.string.call_notification_answer_action, this.mAnswerButtonColor, R.color.call_notification_answer_color, pendingIntent);
        }
        ...
        public void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(h.f(bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z4) {
            ...
            if (!z4 || nonContextualActions == null || (iMin = Math.min(nonContextualActions.size(), 3)) <= 0) {
                i = 8;
            } else {
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z4 ? R.layout.notification_action_tombstone : R.layout.notification_action);
        ...
        public static List<CharSequence> getTextsFromContentView(Context context, Notification notification) {
            if (!Ue.b.B().getName().equals(notification.extras.getString("android.template"))) {
    ...
    public static abstract class Style {
        ...
        public static class Api24Impl {
            ...
            public static void setChronometerCountDown(RemoteViews remoteViews, int i, boolean z4) {
                remoteViews.setChronometerCountDown(i, z4);
            }
        }
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (str.equals(Ue.b.D().getName())) {
                return new MessagingStyle();
            }
            if (str.equals(Ue.b.B().getName())) {
                return new DecoratedCustomViewStyle();
            }
            return null;
        }
        ...
        private Bitmap createIconWithBackground(int i, int i4, int i6, int i10) {
            int i11 = R.drawable.notification_icon_background;
            if (i10 == 0) {
                i10 = 0;
            }
            Bitmap bitmapCreateColoredBitmap = createColoredBitmap(i11, i10, i4);
        ...
        */
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public Bitmap createColoredBitmap(int i, int i4) {
            return createColoredBitmap(i, i4, 0);
        }
        ...
        private Bitmap createColoredBitmap(int i, int i4, int i6) {
            return createColoredBitmap(IconCompat.createWithResource(this.mBuilder.mContext, i), i4, i6);
        }

        private Bitmap createColoredBitmap(IconCompat iconCompat, int i, int i4) {
            Drawable drawableLoadDrawable = iconCompat.loadDrawable(this.mBuilder.mContext);
            int intrinsicWidth = i4 == 0 ? drawableLoadDrawable.getIntrinsicWidth() : i4;
            if (i4 == 0) {
                i4 = drawableLoadDrawable.getIntrinsicHeight();
            }
            Bitmap bitmapCreateBitmap = Bitmap.createBitmap(intrinsicWidth, i4, Bitmap.Config.ARGB_8888);
            drawableLoadDrawable.setBounds(0, 0, intrinsicWidth, i4);
            if (i != 0) {
    ...
    public static Action getActionCompatFromAction(Notification.Action action) {
        ...
        boolean z4 = i6 >= 24 ? Api20Impl.getExtras(action).getBoolean("android.support.allowGeneratedReplies") || Api24Impl.getAllowGeneratedReplies(action) : Api20Impl.getExtras(action).getBoolean("android.support.allowGeneratedReplies");
        boolean z5 = Api20Impl.getExtras(action).getBoolean("android.support.action.showsUserInterface", true);
        int semanticAction = i6 >= 28 ? Api28Impl.getSemanticAction(action) : Api20Impl.getExtras(action).getInt("android.support.action.semanticAction", 0);
        boolean zIsContextual = i6 >= 29 ? Api29Impl.isContextual(action) : false;
        boolean zIsAuthenticationRequired = i6 >= 31 ? Api31Impl.isAuthenticationRequired(action) : false;
        if (Api23Impl.getIcon(action) != null || (i = action.icon) == 0) {
            return new Action(Api23Impl.getIcon(action) != null ? IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action)) : null, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z4, semanticAction, z5, zIsContextual, zIsAuthenticationRequired);
        }
        return new Action(i, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z4, semanticAction, z5, zIsContextual, zIsAuthenticationRequired);
    }
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(h.g(it.next())));
                }
            }
        } else {
            String[] stringArray = notification.extras.getStringArray("android.people");
    ...
    public static final class CarExtender implements Extender {
        ...
        public static class Api20Impl {
            ...
            public static RemoteInput.Builder setAllowFreeFormInput(RemoteInput.Builder builder, boolean z4) {
    ...
    public static class MessagingStyle extends Style {
        ...
        public static class Api28Impl {
            ...
            public static Notification.MessagingStyle setGroupConversation(Notification.MessagingStyle messagingStyle, boolean z4) {
        ...
        private Message findLatestIncomingMessage() {
            ...
            return (Message) s.e(1, this.mMessages);
        }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i >= 24) {
                ...
                while (it.hasNext()) {
                    Api24Impl.addMessage(Ue.b.g(messagingStyleCreateMessagingStyle), it.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it2 = this.mHistoricMessages.iterator();
                    while (it2.hasNext()) {
                        Api26Impl.addHistoricMessage(Ue.b.g(messagingStyleCreateMessagingStyle), it2.next().toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(Ue.b.g(messagingStyleCreateMessagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(Ue.b.g(messagingStyleCreateMessagingStyle), this.mIsGroupConversation.booleanValue());
                }
            ...
            for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                Message message = this.mMessages.get(size);
                CharSequence charSequenceMakeMessageLine = z4 ? makeMessageLine(message) : message.getText();
                if (size != this.mMessages.size() - 1) {
                    spannableStringBuilder.insert(0, (CharSequence) Global.NEWLINE);
                }
