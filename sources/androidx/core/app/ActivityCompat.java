...
public class ActivityCompat extends ContextCompat {
    ...
    public interface PermissionCompatDelegate {
        boolean onActivityResult(Activity activity, @IntRange(from = 0) int i, int i4, Intent intent);
        ...
        if (permissionCompatDelegate == null || !permissionCompatDelegate.requestPermissions(activity, strArr, i)) {
            ...
            for (int i4 = 0; i4 < strArr.length; i4++) {
                if (TextUtils.isEmpty(strArr[i4])) {
                    throw new IllegalArgumentException(s.p(new StringBuilder("Permission request for permissions "), Arrays.toString(strArr), " must not contain null or empty values"));
                }
    ...
    public static void startIntentSenderForResult(Activity activity, IntentSender intentSender, int i, Intent intent, int i4, int i6, int i10, Bundle bundle) throws IntentSender.SendIntentException {
        activity.startIntentSenderForResult(intentSender, i, intent, i4, i6, i10, bundle);
    }
