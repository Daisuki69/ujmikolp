...
public final class NotificationManagerCompat {
            ...
            if (string != null) {
                try {
                    if (!string.equals(sEnabledNotificationListeners)) {
                        String[] strArrSplit = string.split(Global.COLON, -1);
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannel notificationChannelG = androidx.camera.camera2.internal.compat.workaround.a.g(it.next());
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        while (it.hasNext()) {
            NotificationChannelGroup notificationChannelGroupH = androidx.camera.camera2.internal.compat.workaround.a.h(it.next());
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(androidx.camera.camera2.internal.compat.workaround.a.g(it.next())));
                }
                return arrayList;
            }
        }
