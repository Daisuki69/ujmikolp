...
public class NotificationChannelCompat {
    ...
    public static class Api26Impl {
        ...
        public static void enableLights(NotificationChannel notificationChannel, boolean z4) {
            notificationChannel.enableLights(z4);
        }

        public static void enableVibration(NotificationChannel notificationChannel, boolean z4) {
        ...
        public static void setShowBadge(NotificationChannel notificationChannel, boolean z4) {
