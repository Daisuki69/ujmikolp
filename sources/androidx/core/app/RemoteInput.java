...
public final class RemoteInput {
    ...
    public static class Api26Impl {
        ...
        public static RemoteInput.Builder setAllowDataType(RemoteInput.Builder builder, String str, boolean z4) {
    ...
    public static final class Builder {
        ...
        public Builder setAllowDataType(String str, boolean z4) {
            if (z4) {
    ...
    public RemoteInput(String str, CharSequence charSequence, CharSequence[] charSequenceArr, boolean z4, int i, Bundle bundle, Set<String> set) {
        this.mResultKey = str;
        this.mLabel = charSequence;
        this.mChoices = charSequenceArr;
        this.mAllowFreeFormTextInput = z4;
    ...
    private static String getExtraResultsKeyForData(String str) {
        return AbstractC1414e.h(EXTRA_DATA_TYPE_RESULTS_DATA, str);
    }
