...
public class AnimatedStateListDrawableCompat extends StateListDrawableCompat implements TintAwareDrawable {
    ...
    public static class AnimatedStateListState extends StateListDrawableCompat.StateListState {
        ...
        private static long generateTransitionKey(int i, int i4) {
            return ((long) i4) | (((long) i) << 32);
        }
        ...
        public int addTransition(int i, int i4, @NonNull Drawable drawable, boolean z4) {
            int iAddChild = addChild(drawable);
            long jGenerateTransitionKey = generateTransitionKey(i, i4);
            long j = z4 ? REVERSIBLE_FLAG_BIT : 0L;
            long j6 = iAddChild;
            this.mTransitions.append(jGenerateTransitionKey, Long.valueOf(j6 | j));
            if (z4) {
                this.mTransitions.append(generateTransitionKey(i4, i), Long.valueOf(REVERSED_BIT | j6 | j));
            }
            return iAddChild;
        }
        ...
        public int indexOfTransition(int i, int i4) {
            return (int) this.mTransitions.get(generateTransitionKey(i, i4), -1L).longValue();
        }

        public boolean isTransitionReversed(int i, int i4) {
            return (this.mTransitions.get(generateTransitionKey(i, i4), -1L).longValue() & REVERSED_BIT) != 0;
        }
        ...
        public void mutate() {
            this.mTransitions = this.mTransitions.m70clone();
        ...
        public boolean transitionHasReversibleFlag(int i, int i4) {
            return (this.mTransitions.get(generateTransitionKey(i, i4), -1L).longValue() & REVERSIBLE_FLAG_BIT) != 0;
        }
    ...
    public static class AnimationDrawableTransition extends Transition {
        ...
        public AnimationDrawableTransition(AnimationDrawable animationDrawable, boolean z4, boolean z5) {
            super();
            ...
            ObjectAnimator objectAnimatorOfInt = ObjectAnimator.ofInt(animationDrawable, "currentIndex", i, i4);
    ...
    public static class FrameInterpolator implements TimeInterpolator {
        ...
        public FrameInterpolator(AnimationDrawable animationDrawable, boolean z4) {
        ...
        public float getInterpolation(float f) {
            ...
            return (i6 / i4) + (i6 < i4 ? i / this.mTotalDuration : 0.0f);
        }
    ...
    private int parseTransition(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        boolean z4 = typedArrayObtainAttributes.getBoolean(R.styleable.AnimatedStateListDrawableTransition_android_reversible, false);
        typedArrayObtainAttributes.recycle();
        if (drawable == null) {
            do {
                next = xmlPullParser.next();
    ...
    public <T extends Drawable & Animatable> void addTransition(int i, int i4, @NonNull T t5, boolean z4) {
        ObjectsCompat.requireNonNull(t5);
        this.mState.addTransition(i, i4, t5, z4);
    }
    ...
    public boolean onStateChange(@NonNull int[] iArr) {
        ...
        boolean z4 = iIndexOfKeyframe != getCurrentIndex() && (selectTransition(iIndexOfKeyframe) || selectDrawable(iIndexOfKeyframe));
        Drawable current = getCurrent();
        return current != null ? current.setState(iArr) | z4 : z4;
    }
