...
public class DrawableContainerCompat extends Drawable implements Drawable.Callback {
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
            ...
            if (theme != null) {
                ...
                for (int i4 = 0; i4 < i; i4++) {
                    ...
                    if (drawable != null && DrawableCompat.canApplyTheme(drawable)) {
                        ...
                        this.mChildrenChangingConfigurations |= drawableArr[i4].getChangingConfigurations();
                    }
                }
        ...
        public void growArray(int i, int i4) {
        ...
        public final boolean setLayoutDirection(int i, int i4) {
    ...
    */
    ...
    public void setHotspotBounds(int i, int i4, int i6, int i10) {
        Rect rect = this.mHotspotBounds;
        if (rect == null) {
            this.mHotspotBounds = new Rect(i, i4, i6, i10);
        } else {
            rect.set(i, i4, i6, i10);
        }
        Drawable drawable = this.mCurrDrawable;
        if (drawable != null) {
            DrawableCompat.setHotspotBounds(drawable, i, i4, i6, i10);
        }
    }
