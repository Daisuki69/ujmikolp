...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public static class Api33Impl {
        ...
        public static OnBackInvokedCallback registerOnBackPressedCallback(Object obj, final AppCompatDelegateImpl appCompatDelegateImpl) {
            ...
            Ke.c.j(obj).registerOnBackInvokedCallback(PlaybackException.CUSTOM_ERROR_CODE_BASE, r02);
            return r02;
        }

        @DoNotInline
        public static void unregisterOnBackInvokedCallback(Object obj, Object obj2) {
            Ke.c.j(obj).unregisterOnBackInvokedCallback(Ke.c.g(obj2));
        }
    }
    ...
    public abstract class AutoNightModeManager {
        ...
        public void cleanup() {
            ...
            if (broadcastReceiver != null) {
                try {
                    ht2aO8.unregisterReceiver(AppCompatDelegateImpl.this.mContext, broadcastReceiver);
        ...
        public void setup() {
            ...
            ht2aO8.registerReceiver(AppCompatDelegateImpl.this.mContext, this.mReceiver, intentFilterCreateIntentFilterForBroadcastReceiver);
        }
    }
    ...
    public class ListMenuDecorView extends ContentFrameLayout {
        ...
        public boolean __replaced_14526_6_onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        @Override // androidx.appcompat.widget.ContentFrameLayout, android.view.ViewGroup
        public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
            Context context = getContext();
            hxOD26.getInstance().gSVOV1(new eTp7v2(motionEvent, context instanceof Activity ? (Activity) context : null));
            return __replaced_14526_6_onInterceptTouchEvent(motionEvent);
        }
    ...
    public final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(@NonNull MenuBuilder menuBuilder, boolean z4) {
            ...
            if (panelFeatureStateFindMenuPanel != null) {
                if (!z5) {
                    AppCompatDelegateImpl.this.closePanel(panelFeatureStateFindMenuPanel, z4);
                } else {
    ...
    @NonNull
    private Configuration createOverrideAppConfiguration(@NonNull Context context, int i, @Nullable LocaleListCompat localeListCompat, @Nullable Configuration configuration, boolean z4) {
    ...
    private ViewGroup createSubDecor() {
        ...
        if (viewGroup == null) {
            ...
            throw new IllegalArgumentException(s.s(sb2, this.mWindowNoTitle, " }"));
        }
    ...
    */
    ...
    private boolean performPanelShortcut(PanelFeatureState panelFeatureState, int i, KeyEvent keyEvent, int i4) {
        MenuBuilder menuBuilder;
        ...
        if ((panelFeatureState.isPrepared || preparePanel(panelFeatureState, keyEvent)) && (menuBuilder = panelFeatureState.menu) != null) {
            zPerformShortcut = menuBuilder.performShortcut(i, keyEvent, i4);
        }
    ...
    */
    ...
    private void updateResourcesConfiguration(int i, @Nullable LocaleListCompat localeListCompat, boolean z4, @Nullable Configuration configuration) {
    ...
    public PanelFeatureState getPanelState(int i, boolean z4) {
        PanelFeatureState[] panelFeatureStateArr = this.mPanels;
    ...
    */
    ...
    private boolean applyApplicationSpecificConfig(boolean z4, boolean z5) {
        ...
        if (!z5 && localeListCompatCalculateApplicationLocales != null) {
            localeListCompatCalculateApplicationLocales = getConfigurationLocales(this.mContext.getResources().getConfiguration());
        }
        boolean zUpdateAppConfiguration = updateAppConfiguration(iMapNightMode, localeListCompatCalculateApplicationLocales, z4);
