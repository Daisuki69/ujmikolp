...
class TwilightCalculator {
    ...
    private static final float f7333C1 = 0.0334196f;

    /* JADX INFO: renamed from: C2, reason: collision with root package name */
    private static final float f7334C2 = 3.49066E-4f;

    /* JADX INFO: renamed from: C3, reason: collision with root package name */
    private static final float f7335C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* JADX INFO: renamed from: J0, reason: collision with root package name */
    private static final float f7336J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long j, double d10, double d11) {
        ...
        double dSin2 = (Math.sin(2.0d * dSin) * (-0.0069d)) + (Math.sin(d12) * 0.0053d) + ((double) (Math.round(((double) (r2 - f7336J0)) - r6) + f7336J0)) + ((-d11) / 360.0d);
