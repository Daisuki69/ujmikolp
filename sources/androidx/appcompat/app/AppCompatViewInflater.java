...
public class AppCompatViewInflater {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z4, boolean z5) {
        ...
        int resourceId = z4 ? typedArrayObtainStyledAttributes.getResourceId(androidx.appcompat.R.styleable.View_android_theme, 0) : 0;
        if (z5 && resourceId == 0 && (resourceId = typedArrayObtainStyledAttributes.getResourceId(androidx.appcompat.R.styleable.View_theme, 0)) != 0) {
    ...
    @Nullable
    public final View createView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet, boolean z4, boolean z5, boolean z8, boolean z9) {
        Context context2;
        View viewCreateRatingBar;
        context2 = (!z4 || view == null) ? context : view.getContext();
        if (z5 || z8) {
            context2 = themifyContext(context2, attributeSet, z5, z8);
        }
        if (z9) {
