...
class AlertController {
                ...
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.AlertParams.4
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i4, long j) {
                        ...
                        try {
                            ...
                            AlertParams.this.mOnCheckboxClickListener.onClick(alertController2.mDialog, i4, recycleListView.isItemChecked(i4));
                            Callback.onItemClick_exit();
                        } catch (Throwable th2) {
                            Callback.onItemClick_exit();
                            throw th2;
    ...
    public static class CheckedItemAdapter extends ArrayAdapter<CharSequence> {
        public CheckedItemAdapter(Context context, int i, int i4, CharSequence[] charSequenceArr) {
            super(context, i, i4, charSequenceArr);
        }
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i4) {
        ...
        ViewCompat.setScrollIndicators(view, i, i4);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (!z4 || !canTextInput(viewInflate)) {
            dLgao9.setFlags(this.mWindow, 131072, 131072);
        }
        if (!z4) {
            viewGroup.setVisibility(8);
            return;
    ...
    private void setupView() {
        ...
        int i4 = androidx.appcompat.R.id.contentPanel;
        ...
        boolean z5 = (viewGroupResolvePanel == null || viewGroupResolvePanel.getVisibility() == 8) ? 0 : 1;
        ...
        if (listView instanceof RecycleListView) {
            ((RecycleListView) listView).setHasDecor(z5, z8);
        }
        if (!z4) {
            ...
            if (view != null) {
                setScrollIndicators(viewGroupResolvePanel2, view, z5 | (z8 ? 2 : 0), 3);
            }
        }
