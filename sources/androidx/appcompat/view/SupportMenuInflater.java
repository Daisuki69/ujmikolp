    ...
    public static class InflatedOnMenuItemClickListener implements MenuItem.OnMenuItemClickListener {
        ...
        public InflatedOnMenuItemClickListener(Object obj, String str) {
            ...
            try {
                ...
                StringBuilder sbW = s.w("Couldn't resolve menu item onClick handler ", str, " in class ");
                sbW.append(cls.getName());
                InflateException inflateException = new InflateException(sbW.toString());
    ...
    public class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(i4)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(i4, -1), this.itemIconTintMode);
            } else {
