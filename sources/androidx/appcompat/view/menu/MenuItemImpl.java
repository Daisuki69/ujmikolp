...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public MenuItemImpl(MenuBuilder menuBuilder, int i, int i4, int i6, int i10, CharSequence charSequence, int i11) {
    ...
    private static void appendModifier(StringBuilder sb2, int i, int i4, String str) {
        if ((i & i4) == i4) {
            sb2.append(str);
        }
    }
    ...
    public String getShortcutLabel() {
        ...
        appendModifier(sb2, i, 65536, resources.getString(R.string.abc_menu_meta_shortcut_label));
        appendModifier(sb2, i, 4096, resources.getString(R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(sb2, i, 2, resources.getString(R.string.abc_menu_alt_shortcut_label));
        appendModifier(sb2, i, 1, resources.getString(R.string.abc_menu_shift_shortcut_label));
        appendModifier(sb2, i, 4, resources.getString(R.string.abc_menu_sym_shortcut_label));
        appendModifier(sb2, i, 8, resources.getString(R.string.abc_menu_function_shortcut_label));
        if (shortcut == '\b') {
    ...
    @Override // androidx.core.internal.view.SupportMenuItem, android.view.MenuItem
    @NonNull
    public MenuItem setShortcut(char c, char c10, int i, int i4) {
        this.mShortcutNumericChar = c;
        this.mShortcutNumericModifiers = KeyEvent.normalizeMetaState(i);
        this.mShortcutAlphabeticChar = Character.toLowerCase(c10);
