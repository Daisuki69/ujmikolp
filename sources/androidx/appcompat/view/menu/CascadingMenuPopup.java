...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i, @StyleRes int i4, boolean z4) {
    ...
    private int getNextMenuPosition(int i) {
        ListView listView = ((CascadingMenuInfo) s.e(1, this.mShowingMenus)).getListView();
        int[] iArr = new int[2];
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (this.mShowingMenus.size() > 0) {
            cascadingMenuInfo = (CascadingMenuInfo) s.e(1, this.mShowingMenus);
        ...
        if (viewFindParentViewForSubmenu != null) {
            ...
            if ((this.mDropDownGravity & 5) != 5) {
                width = z4 ? i + viewFindParentViewForSubmenu.getWidth() : i - iMeasureIndividualMenuWidth;
                menuPopupWindowCreatePopupWindow.setHorizontalOffset(width);
                menuPopupWindowCreatePopupWindow.setOverlapAnchor(true);
                menuPopupWindowCreatePopupWindow.setVerticalOffset(i4);
            } else if (z4) {
    ...
    public ListView getListView() {
        ...
        return ((CascadingMenuInfo) s.e(1, this.mShowingMenus)).getListView();
    }
