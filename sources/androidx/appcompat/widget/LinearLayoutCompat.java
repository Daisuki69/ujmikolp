...
public class LinearLayoutCompat extends ViewGroup {
    ...
    */
    ...
    public void measureChildBeforeLayout(View view, int i, int i4, int i6, int i10, int i11) {
    ...
    */
    ...
    public LinearLayoutCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int i4 = tintTypedArrayObtainStyledAttributes.getInt(androidx.appcompat.R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (i4 >= 0) {
            setOrientation(i4);
        }
        int i6 = tintTypedArrayObtainStyledAttributes.getInt(androidx.appcompat.R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (i6 >= 0) {
            setGravity(i6);
        }
        boolean z4 = tintTypedArrayObtainStyledAttributes.getBoolean(androidx.appcompat.R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!z4) {
