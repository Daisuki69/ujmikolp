...
public class VectorEnabledTintResources extends ResourcesWrapper {
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ Drawable getDrawableForDensity(int i, int i4) throws Resources.NotFoundException {
        return super.getDrawableForDensity(i, i4);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ float getFraction(int i, int i4, int i6) {
        return super.getFraction(i, i4, i6);
    }
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ String getQuantityString(int i, int i4) throws Resources.NotFoundException {
        return super.getQuantityString(i, i4);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ CharSequence getQuantityText(int i, int i4) throws Resources.NotFoundException {
        return super.getQuantityText(i, i4);
    }
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ void getValue(int i, TypedValue typedValue, boolean z4) throws Resources.NotFoundException {
        super.getValue(i, typedValue, z4);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ void getValueForDensity(int i, int i4, TypedValue typedValue, boolean z4) throws Resources.NotFoundException {
        super.getValueForDensity(i, i4, typedValue, z4);
    }
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    @RequiresApi(21)
    public /* bridge */ /* synthetic */ Drawable getDrawableForDensity(int i, int i4, Resources.Theme theme) {
        return super.getDrawableForDensity(i, i4, theme);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ String getQuantityString(int i, int i4, Object[] objArr) throws Resources.NotFoundException {
        return super.getQuantityString(i, i4, objArr);
    }
