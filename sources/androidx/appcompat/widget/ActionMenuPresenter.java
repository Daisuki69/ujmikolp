...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public class OverflowMenuButton extends AppCompatImageView implements ActionMenuView.ActionMenuChildView {
        ...
        public boolean setFrame(int i, int i4, int i6, int i10) {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z4 || i12 + i11 > i6)) {
            i6--;
        }
        int i14 = i6 - i11;
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            ...
            i = ((i10 % i15) / iMeasureChildForCells) + i15;
        } else {
        ...
        while (i16 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                boolean z8 = (i14 > 0 || z5) && i10 > 0 && (!r03.mStrictWidthLimit || iMeasureChildForCells > 0);
                boolean z9 = z8;
                i4 = size;
                if (z8) {
                    ...
                    z8 = z10 & (!r03.mStrictWidthLimit ? i10 + i17 <= 0 : i10 < 0);
                }
                if (z8 && groupId2 != 0) {
