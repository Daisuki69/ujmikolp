...
class AppCompatCompoundButtonHelper {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i) {
        ...
        try {
            int i6 = R.styleable.CompoundButton_buttonCompat;
            if (!tintTypedArrayObtainStyledAttributes.hasValue(i6) || (resourceId2 = tintTypedArrayObtainStyledAttributes.getResourceId(i6, 0)) == 0) {
                i4 = R.styleable.CompoundButton_android_button;
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(i10)) {
                CompoundButtonCompat.setButtonTintList(this.mView, tintTypedArrayObtainStyledAttributes.getColorStateList(i10));
            }
            int i11 = R.styleable.CompoundButton_buttonTintMode;
            if (tintTypedArrayObtainStyledAttributes.hasValue(i11)) {
                CompoundButtonCompat.setButtonTintMode(this.mView, DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(i11, -1), null));
            }
