...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder sbT = s.t(iconResource, "Invalid icon resource ", " for ");
            sbT.append(componentName.flattenToShortString());
            Log.w(LOG_TAG, sbT.toString());
            return null;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Log.e(LOG_TAG, "Error closing icon stream for " + uri, e7);
                }
            }
