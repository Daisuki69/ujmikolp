...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    private int getViewListMeasuredWidth(List<View> list, int[] iArr) {
        ...
        while (i6 < size) {
            ...
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            int i10 = ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin - i;
            int i11 = ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin - i4;
    ...
    private int measureChildCollapseMargins(View view, int i, int i4, int i6, int i10, int[] iArr) {
        ...
        view.measure(ViewGroup.getChildMeasureSpec(i, getPaddingRight() + getPaddingLeft() + iMax + i4, marginLayoutParams.width), ViewGroup.getChildMeasureSpec(i6, getPaddingBottom() + getPaddingTop() + marginLayoutParams.topMargin + marginLayoutParams.bottomMargin + i10, marginLayoutParams.height));
    ...
    */
    ...
    public void onMeasure(int i, int i4) {
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i, i11 + i13, i4, i12, iArr);
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            iMax2 = Math.max(iMax2, measureChildCollapseMargins(this.mSubtitleTextView, i, i11 + i13, i4, i12 + measuredHeight, iArr));
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(getPaddingRight() + getPaddingLeft() + i11 + iMax2, getSuggestedMinimumWidth()), i, (-16777216) & iCombineMeasuredStates2), shouldCollapse() ? 0 : View.resolveSizeAndState(Math.max(getPaddingBottom() + getPaddingTop() + Math.max(iMax, measuredHeight), getSuggestedMinimumHeight()), i4, iCombineMeasuredStates2 << 16));
    }
    ...
    public void setTitleMargin(int i, int i4, int i6, int i10) {
    ...
    public void updateBackInvokedCallbackState() {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            boolean z4 = hasExpandedActionView() && onBackInvokedDispatcherFindOnBackInvokedDispatcher != null && isAttachedToWindow() && this.mBackInvokedCallbackEnabled;
            if (z4 && this.mBackInvokedDispatcher == null) {
                if (this.mBackInvokedCallback == null) {
                    this.mBackInvokedCallback = Api33Impl.newOnBackInvokedCallback(new c(this, 0));
                }
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new c(this, 1));
        ...
        dimensionPixelOffset = tintTypedArrayObtainStyledAttributes.hasValue(i4) ? tintTypedArrayObtainStyledAttributes.getDimensionPixelOffset(i4, dimensionPixelOffset) : dimensionPixelOffset;
