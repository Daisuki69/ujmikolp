...
class AppCompatTextHelper {
    ...
    public static class Api28Impl {
        ...
        @DoNotInline
        public static Typeface create(Typeface typeface, int i, boolean z4) {
    ...
    */
    ...
    public void onSetTextAppearance(Context context, int i) {
        ...
        if (tintTypedArrayObtainStyledAttributes.hasValue(i4)) {
            setAllCaps(tintTypedArrayObtainStyledAttributes.getBoolean(i4, false));
        }
        ...
        if (i6 >= 26) {
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(i11) && (string = tintTypedArrayObtainStyledAttributes.getString(i11)) != null) {
    ...
    public void setAutoSizeTextTypeUniformWithConfiguration(int i, int i4, int i6, int i10) throws IllegalArgumentException {
        this.mAutoSizeTextHelper.setAutoSizeTextTypeUniformWithConfiguration(i, i4, i6, i10);
    }
