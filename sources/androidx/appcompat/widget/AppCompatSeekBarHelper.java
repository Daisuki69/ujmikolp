...
class AppCompatSeekBarHelper extends AppCompatProgressBarHelper {
    ...
    public void drawTickMarks(Canvas canvas) {
        if (this.mTickMark != null) {
            ...
            if (max > 1) {
                ...
                this.mTickMark.setBounds(-i, -i4, i, i4);
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        if (tintTypedArrayObtainStyledAttributes.hasValue(i4)) {
            this.mTickMarkTintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(i4, -1), this.mTickMarkTintMode);
