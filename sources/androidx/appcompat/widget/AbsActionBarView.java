...
abstract class AbsActionBarView extends ViewGroup {
    ...
    public static int next(int i, int i4, boolean z4) {
        return z4 ? i - i4 : i + i4;
    }
    ...
    public int measureChildView(View view, int i, int i4, int i6) {
    ...
    public int positionChild(View view, int i, int i4, int i6, boolean z4) {
        int measuredWidth = view.getMeasuredWidth();
        int measuredHeight = view.getMeasuredHeight();
        int i10 = ((i6 - measuredHeight) / 2) + i4;
        if (z4) {
