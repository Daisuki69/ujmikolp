...
class ResourcesWrapper extends Resources {
    ...
    @Override // android.content.res.Resources
    public Drawable getDrawableForDensity(int i, int i4) throws Resources.NotFoundException {
        return ResourcesCompat.getDrawableForDensity(this.mResources, i, i4, null);
    }

    @Override // android.content.res.Resources
    public float getFraction(int i, int i4, int i6) {
        return this.mResources.getFraction(i, i4, i6);
    }
    ...
    @Override // android.content.res.Resources
    public String getQuantityString(int i, int i4, Object... objArr) throws Resources.NotFoundException {
        return this.mResources.getQuantityString(i, i4, objArr);
    }

    @Override // android.content.res.Resources
    public CharSequence getQuantityText(int i, int i4) throws Resources.NotFoundException {
        return this.mResources.getQuantityText(i, i4);
    }
    ...
    @Override // android.content.res.Resources
    public void getValue(int i, TypedValue typedValue, boolean z4) throws Resources.NotFoundException {
        this.mResources.getValue(i, typedValue, z4);
    }

    @Override // android.content.res.Resources
    public void getValueForDensity(int i, int i4, TypedValue typedValue, boolean z4) throws Resources.NotFoundException {
        this.mResources.getValueForDensity(i, i4, typedValue, z4);
    }
    ...
    @Override // android.content.res.Resources
    @RequiresApi(21)
    public Drawable getDrawableForDensity(int i, int i4, Resources.Theme theme) {
        return ResourcesCompat.getDrawableForDensity(this.mResources, i, i4, theme);
    }

    @Override // android.content.res.Resources
    public String getQuantityString(int i, int i4) throws Resources.NotFoundException {
        return this.mResources.getQuantityString(i, i4);
    }
