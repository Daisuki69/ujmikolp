...
public final class ResourceManagerInternal {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i, boolean z4, @NonNull Drawable drawable) {
        ...
        ResourceManagerHooks resourceManagerHooks = this.mHooks;
        if ((resourceManagerHooks == null || !resourceManagerHooks.tintDrawable(context, i, drawable)) && !tintDrawableUsingColorFilter(context, i, drawable) && z4) {
            return null;
        }
        return drawable;
    }
    ...
    public synchronized Drawable getDrawable(@NonNull Context context, @DrawableRes int i, boolean z4) {
        ...
        try {
            ...
            if (drawableLoadDrawableFromDelegates != null) {
                drawableLoadDrawableFromDelegates = tintDrawable(context, i, z4, drawableLoadDrawableFromDelegates);
            }
            if (drawableLoadDrawableFromDelegates != null) {
