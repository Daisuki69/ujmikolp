...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView, EmojiCompatConfigurationView {
    ...
    public interface SuperCaller {
        ...
        void setAutoSizeTextTypeUniformWithConfiguration(int i, int i4, int i6, int i10);
        ...
        void setLineHeight(int i, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE) float f);
    ...
    public class SuperCallerApi26 implements SuperCaller {
        ...
        @Override // androidx.appcompat.widget.AppCompatTextView.SuperCaller
        public void setAutoSizeTextTypeUniformWithConfiguration(int i, int i4, int i6, int i10) {
            AppCompatTextView.super.setAutoSizeTextTypeUniformWithConfiguration(i, i4, i6, i10);
        }
    ...
    public void onLayout(boolean z4, int i, int i4, int i6, int i10) {
        ...
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.onLayout(z4, i, i4, i6, i10);
        }
    }
    ...
    public void setAutoSizeTextTypeUniformWithConfiguration(int i, int i4, int i6, int i10) throws IllegalArgumentException {
        if (ViewUtils.SDK_LEVEL_SUPPORTS_AUTOSIZE) {
            getSuperCaller().setAutoSizeTextTypeUniformWithConfiguration(i, i4, i6, i10);
            return;
        }
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.setAutoSizeTextTypeUniformWithConfiguration(i, i4, i6, i10);
        }
    }
    ...
    @Override // android.widget.TextView
    public void setCompoundDrawablesRelativeWithIntrinsicBounds(int i, int i4, int i6, int i10) {
        Context context = getContext();
        setCompoundDrawablesRelativeWithIntrinsicBounds(i != 0 ? AppCompatResources.getDrawable(context, i) : null, i4 != 0 ? AppCompatResources.getDrawable(context, i4) : null, i6 != 0 ? AppCompatResources.getDrawable(context, i6) : null, i10 != 0 ? AppCompatResources.getDrawable(context, i10) : null);
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.onSetCompoundDrawables();
        }
    ...
    @Override // android.widget.TextView
    public void setCompoundDrawablesWithIntrinsicBounds(int i, int i4, int i6, int i10) {
        Context context = getContext();
        setCompoundDrawablesWithIntrinsicBounds(i != 0 ? AppCompatResources.getDrawable(context, i) : null, i4 != 0 ? AppCompatResources.getDrawable(context, i4) : null, i6 != 0 ? AppCompatResources.getDrawable(context, i6) : null, i10 != 0 ? AppCompatResources.getDrawable(context, i10) : null);
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.onSetCompoundDrawables();
        }
