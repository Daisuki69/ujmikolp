...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    */
    ...
    public void onMeasure(int i, int i4) {
        ...
        if (this.mOverlayMode || z4 || !decorFitsSystemWindows()) {
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(getPaddingRight() + getPaddingLeft() + iMax3, getSuggestedMinimumWidth()), i, iCombineMeasuredStates2), View.resolveSizeAndState(Math.max(getPaddingBottom() + getPaddingTop() + iMax4, getSuggestedMinimumHeight()), i4, iCombineMeasuredStates2 << 16));
    }
    ...
    public void onNestedScroll(View view, int i, int i4, int i6, int i10, int i11, int[] iArr) {
        onNestedScroll(view, i, i4, i6, i10, i11);
    }
    ...
    public void onNestedScroll(View view, int i, int i4, int i6, int i10, int i11) {
        if (i11 == 0) {
            onNestedScroll(view, i, i4, i6, i10);
        }
    }
