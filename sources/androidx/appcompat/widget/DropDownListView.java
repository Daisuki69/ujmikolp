...
class DropDownListView extends ListView {
    ...
    public static class Api21Impl {
        ...
        @DoNotInline
        public static void drawableHotspotChanged(View view, float f, float f3) {
            view.drawableHotspotChanged(f, f3);
        }
    }
    ...
    private void positionSelectorLikeTouchCompat(int i, View view, float f, float f3) {
    ...
    private void setPressedItem(View view, int i, float f, float f3) {
        ...
        Api21Impl.drawableHotspotChanged(this, f, f3);
        if (!isPressed()) {
            setPressed(true);
        }
        layoutChildren();
        ...
        Api21Impl.drawableHotspotChanged(view, f - view.getLeft(), f3 - view.getTop());
        if (!view.isPressed()) {
