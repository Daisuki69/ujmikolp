...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i4, long j) {
                    ...
                    try {
                        ...
                        if (AppCompatSpinner.this.getOnItemClickListener() != null) {
                            ...
                            AppCompatSpinner.this.performItemClick(view, i4, dropdownPopup.mAdapter.getItemId(i4));
                        }
        ...
        public void computeContentWidth() {
            ...
            if (i4 == -2) {
                ...
                int i10 = (i6 - rect2.left) - rect2.right;
    ...
    public AppCompatSpinner(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i4) {
