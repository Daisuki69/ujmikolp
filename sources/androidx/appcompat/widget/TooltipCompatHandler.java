...
class TooltipCompatHandler implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    private TooltipCompatHandler(View view, CharSequence charSequence) {
        final int i = 0;
        this.mShowRunnable = new Runnable(this) { // from class: androidx.appcompat.widget.e

            /* JADX INFO: renamed from: b, reason: collision with root package name */
            public final /* synthetic */ TooltipCompatHandler f7347b;
        ...
        final int i4 = 1;
        this.mHideRunnable = new Runnable(this) { // from class: androidx.appcompat.widget.e
    ...
    private boolean updateAnchorPos(MotionEvent motionEvent) {
        ...
        if (!this.mForceNextChangeSignificant && Math.abs(x6 - this.mAnchorX) <= this.mHoverSlop && Math.abs(y7 - this.mAnchorY) <= this.mHoverSlop) {
            return false;
        }
        this.mAnchorX = x6;
        this.mAnchorY = y7;
