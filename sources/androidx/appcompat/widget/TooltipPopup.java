...
class TooltipPopup {
    ...
    private void computePosition(View view, int i, int i4, boolean z4, WindowManager.LayoutParams layoutParams) {
        int height;
        int i6;
        ...
        layoutParams.x = (i11 + i) - (appRootView.getWidth() / 2);
    ...
    public void show(View view, int i, int i4, boolean z4, CharSequence charSequence) {
        if (isShowing()) {
            hide();
        }
        this.mMessageView.setText(charSequence);
        computePosition(view, i, i4, z4, this.mLayoutParams);
