...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        public static void setTouchModal(PopupWindow popupWindow, boolean z4) {
    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public /* bridge */ /* synthetic */ int lookForSelectablePosition(int i, boolean z4) {
            return super.lookForSelectablePosition(i, z4);
        }

        @Override // androidx.appcompat.widget.DropDownListView
        public /* bridge */ /* synthetic */ int measureHeightOfChildrenCompat(int i, int i4, int i6, int i10, int i11) {
            return super.measureHeightOfChildrenCompat(i, i4, i6, i10, i11);
        }
    ...
    public MenuPopupWindow(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i4) {
