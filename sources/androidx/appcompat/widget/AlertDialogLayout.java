...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    */
    ...
    private boolean tryOnMeasure(int i, int i4) {
        ...
        setMeasuredDimension(View.resolveSizeAndState(getPaddingRight() + getPaddingLeft() + iMax, i, iCombineMeasuredStates), View.resolveSizeAndState(paddingBottom, i4, 0));
        if (mode2 == 1073741824) {
            return true;
        }
