...
public class TintTypedArray {
    ...
    @Nullable
    public Typeface getFont(@StyleableRes int i, int i4, @Nullable ResourcesCompat.FontCallback fontCallback) {
        ...
        return ResourcesCompat.getFont(this.mContext, resourceId, this.mTypedValue, i4, fontCallback);
    }
