...
public class PopupMenu {
    ...
    public PopupMenu(@NonNull Context context, @NonNull View view, int i, @AttrRes int i4, @StyleRes int i6) {
        ...
        MenuPopupHelper menuPopupHelper = new MenuPopupHelper(context, menuBuilder, view, false, i4, i6);
