...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            ...
            return s.s(sb2, this.isIconified, "}");
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action != 0) {
                if (action == 1 || action == 2) {
                    ...
                    if (z5 && !this.mSlopBounds.contains(x6, y7)) {
                        z8 = z5;
                        z4 = false;
                    }
                } else {
                ...
                z8 = z5;
                z4 = true;
            } else if (this.mTargetBounds.contains(x6, y7)) {
            ...
            if (!z4 || this.mActualBounds.contains(x6, y7)) {
                Rect rect = this.mActualBounds;
                motionEvent.setLocation(x6 - rect.left, y7 - rect.top);
            } else {
    ...
    private void getChildBoundsWithinSearchView(View view, Rect rect) {
        ...
        rect.set(i6, i4, view.getWidth() + i6, view.getHeight() + i4);
    }
    ...
    public void onLayout(boolean z4, int i, int i4, int i6, int i10) {
        ...
        if (z4) {
            ...
            rect.set(rect2.left, 0, rect2.right, i10 - i4);
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mTextKeyListener = new View.OnKeyListener() { // from class: androidx.appcompat.widget.SearchView.6
            ...
            public boolean onKey(View view, int i4, KeyEvent keyEvent) {
                ...
                if (SearchView.this.mSearchSrcTextView.isEmpty() || !keyEvent.hasNoModifiers() || keyEvent.getAction() != 1 || i4 != 66) {
                    return false;
                }
        ...
        AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.widget.SearchView.8
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i4, long j) {
                Callback.onItemClick_enter(view, i4);
                try {
        ...
        AdapterView.OnItemSelectedListener onItemSelectedListener = new AdapterView.OnItemSelectedListener() { // from class: androidx.appcompat.widget.SearchView.9
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i4, long j) {
                Callback.onItemSelected_enter(view, i4);
                try {
        ...
        int i4 = androidx.appcompat.R.styleable.SearchView_searchIcon;
        imageView.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(i4));
        ...
        imageView5.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(i4));
        ...
        int i6 = tintTypedArrayObtainStyledAttributes.getInt(androidx.appcompat.R.styleable.SearchView_android_imeOptions, -1);
        if (i6 != -1) {
            setImeOptions(i6);
        }
