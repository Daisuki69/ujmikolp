...
public final class MultiDex {
    ...
    private static void doInstallation(Context context, File file, File file2, String str, String str2, boolean z4) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, InstantiationException, IOException, SecurityException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
    ...
    public static Field findField(Object obj, String str) throws NoSuchFieldException {
        ...
        StringBuilder sbW = s.w("Field ", str, " not found in ");
        sbW.append(obj.getClass());
        throw new NoSuchFieldException(sbW.toString());
    }
    ...
    public static Method findMethod(Object obj, String str, Class<?>... clsArr) throws NoSuchMethodException {
        ...
        StringBuilder sbW = s.w("Method ", str, " with parameters ");
        sbW.append(Arrays.asList(clsArr));
        sbW.append(" not found in ");
        sbW.append(obj.getClass());
        throw new NoSuchMethodException(sbW.toString());
    }
    ...
    public static boolean isVMMultidexCapable(String str) {
        ...
        sb2.append(str);
        sb2.append(z4 ? " has multidex support" : " does not have multidex support");
