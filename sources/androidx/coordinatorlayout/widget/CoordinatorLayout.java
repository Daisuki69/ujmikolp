...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public static abstract class Behavior<V extends View> {
        ...
        public boolean onNestedFling(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v7, @NonNull View view, float f, float f3, boolean z4) {
            return false;
        }
        ...
        @Deprecated
        public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v7, @NonNull View view, int i, int i4, @NonNull int[] iArr) {
        }

        @Deprecated
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v7, @NonNull View view, int i, int i4, int i6, int i10) {
        }

        @Deprecated
        public void onNestedScrollAccepted(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v7, @NonNull View view, @NonNull View view2, int i) {
        }

        public boolean onRequestChildRectangleOnScreen(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v7, @NonNull Rect rect, boolean z4) {
            return false;
        }
        ...
        @Deprecated
        public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v7, @NonNull View view, @NonNull View view2, int i) {
            return false;
        }
        ...
        public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v7, @NonNull View view, int i, int i4, @NonNull int[] iArr, int i6) {
            if (i6 == 0) {
                onNestedPreScroll(coordinatorLayout, v7, view, i, i4, iArr);
            }
        }

        @Deprecated
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v7, @NonNull View view, int i, int i4, int i6, int i10, int i11) {
            if (i11 == 0) {
                onNestedScroll(coordinatorLayout, v7, view, i, i4, i6, i10);
            }
        }

        public void onNestedScrollAccepted(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v7, @NonNull View view, @NonNull View view2, int i, int i4) {
            if (i4 == 0) {
                onNestedScrollAccepted(coordinatorLayout, v7, view, view2, i);
            }
        }
        ...
        public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v7, @NonNull View view, @NonNull View view2, int i, int i4) {
            if (i4 == 0) {
                return onStartNestedScroll(coordinatorLayout, v7, view, view2, i);
            }
            return false;
        }

        public void onStopNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v7, @NonNull View view, int i) {
            if (i == 0) {
        ...
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v7, @NonNull View view, int i, int i4, int i6, int i10, int i11, @NonNull int[] iArr) {
            iArr[0] = iArr[0] + i6;
            iArr[1] = iArr[1] + i10;
            onNestedScroll(coordinatorLayout, v7, view, i, i4, i6, i10, i11);
        }
    }
    ...
    private void constrainChildRect(LayoutParams layoutParams, Rect rect, int i, int i4) {
        int width = getWidth();
        ...
        int iMax2 = Math.max(getPaddingTop() + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin, Math.min(rect.top, ((height - getPaddingBottom()) - i4) - ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin));
        rect.set(iMax, iMax2, i + iMax, i4 + iMax2);
    }
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View view, int i, Rect rect, Rect rect2, LayoutParams layoutParams, int i4, int i6) {
        ...
        rect2.set(iWidth, iHeight, i4 + iWidth, i6 + iHeight);
    }
    ...
    private void layoutChildWithKeyline(View view, int i, int i4) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
    ...
    private void offsetChildByInset(View view, Rect rect, int i) {
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            if ((absoluteGravity & 3) != 3 || (i6 = (rectAcquireTempRect.left - ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin) - layoutParams.mInsetOffsetX) >= (i10 = rect.left)) {
                z5 = false;
            } else {
                setInsetOffsetX(view, i10 - i6);
                z5 = true;
            }
            if ((absoluteGravity & 5) != 5 || (width = ((getWidth() - rectAcquireTempRect.right) - ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin) + layoutParams.mInsetOffsetX) >= (i4 = rect.right)) {
                z8 = z5;
            } else {
    ...
    public static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) {
        ...
        try {
            ...
            throw new RuntimeException(AbstractC1414e.h("Could not inflate Behavior subclass ", str), e);
        }
    }
    ...
    private boolean performIntercept(MotionEvent motionEvent, int i) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            Behavior behavior = layoutParams.getBehavior();
            if (!(zOnInterceptTouchEvent || z4) || actionMasked == 0) {
                ...
                z4 = zIsBlockingInteractionBelow && !zDidBlockInteraction;
    ...
    private void resetTouchBehaviors(boolean z4) {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ((LayoutParams) getChildAt(i4).getLayoutParams()).resetTouchBehaviorTracking();
        }
    ...
    private void setInsetOffsetX(View view, int i) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        int i4 = layoutParams.mInsetOffsetX;
        if (i4 != i) {
            ViewCompat.offsetLeftAndRight(view, i - i4);
    ...
    private void setInsetOffsetY(View view, int i) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        int i4 = layoutParams.mInsetOffsetY;
        if (i4 != i) {
            ViewCompat.offsetTopAndBottom(view, i - i4);
    ...
    public boolean __replaced_14527_5_onInterceptTouchEvent(MotionEvent motionEvent) {
        int actionMasked = motionEvent.getActionMasked();
        if (actionMasked == 0) {
    ...
    */
    ...
    public boolean isPointInChildBounds(@NonNull View view, int i, int i4) {
        Rect rectAcquireTempRect = acquireTempRect();
        getDescendantRect(view, rectAcquireTempRect);
        try {
            return rectAcquireTempRect.contains(i, i4);
        } finally {
            releaseTempRect(rectAcquireTempRect);
        }
    }
    ...
    public void offsetChildToAnchor(View view, int i) {
        ...
        if (layoutParams.mAnchorView != null) {
            ...
            boolean z4 = (rectAcquireTempRect3.left == rectAcquireTempRect2.left && rectAcquireTempRect3.top == rectAcquireTempRect2.top) ? false : true;
            constrainChildRect(layoutParams, rectAcquireTempRect3, measuredWidth, measuredHeight);
            int i4 = rectAcquireTempRect3.left - rectAcquireTempRect2.left;
    ...
    */
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        return __replaced_14527_5_onInterceptTouchEvent(motionEvent);
    }
    ...
    public void onLayoutChild(@NonNull View view, int i) {
        ...
        if (i4 >= 0) {
            layoutChildWithKeyline(view, i4, i);
        } else {
            layoutChild(view, i);
        }
    }
    ...
    */
    ...
    public void onMeasureChild(View view, int i, int i4, int i6, int i10) {
        measureChildWithMargins(view, i, i4, i6, i10);
    }
    ...
    */
    ...
    public void onNestedScroll(View view, int i, int i4, int i6, int i10) {
        onNestedScroll(view, i, i4, i6, i10, 0);
    }
  ...
  0x0015: PHI (r3v4 boolean) = (r3v2 boolean), (r3v5 boolean) binds: [B:10:0x0024, B:5:0x0012] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i6) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    iArr2[0] = 0;
                    iArr2[1] = 0;
                    behavior.onNestedPreScroll(this, childAt, view, i, i4, iArr2, i6);
    ...
    public void onNestedScroll(View view, int i, int i4, int i6, int i10, int i11) {
        onNestedScroll(view, i, i4, i6, i10, 0, this.mNestedScrollingV2ConsumedCompat);
    }
    ...
    public void onNestedScrollAccepted(View view, View view2, int i, int i4) {
        ...
        int i6;
        int i10;
        this.mNestedScrollingParentHelper.onNestedScrollAccepted(view, view2, i, i4);
        ...
        while (i11 < childCount) {
            ...
            if (layoutParams.isNestedScrollAccepted(i4) && (behavior = layoutParams.getBehavior()) != null) {
                ...
                i6 = i;
                i10 = i4;
                behavior.onNestedScrollAccepted(this, childAt, view3, view4, i6, i10);
            } else {
                view3 = view;
                view4 = view2;
                i6 = i;
    ...
    public boolean onStartNestedScroll(View view, View view2, int i, int i4) {
        ...
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                Behavior behavior = layoutParams.getBehavior();
                if (behavior != null) {
                    boolean zOnStartNestedScroll = behavior.onStartNestedScroll(this, childAt, view, view2, i, i4);
                    z4 |= zOnStartNestedScroll;
                    layoutParams.setNestedScrollAccepted(i4, zOnStartNestedScroll);
                } else {
                    layoutParams.setNestedScrollAccepted(i4, false);
                }
            }
        }
        return z4;
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i) {
        ...
        if (resourceId != 0) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                coordinatorLayout.mKeylines[i4] = (int) (r11[i4] * f);
            }
        }
    ...
    public void onNestedScroll(@NonNull View view, int i, int i4, int i6, int i10, int i11, @NonNull int[] iArr) {
        Behavior behavior;
        int childCount = getChildCount();
        boolean z4 = false;
        int iMax = 0;
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i11) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    iArr2[0] = 0;
                    iArr2[1] = 0;
                    behavior.onNestedScroll(this, childAt, view, i, i4, i6, i10, i11, iArr2);
                    int[] iArr3 = this.mBehaviorConsumed;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcel parcel, ClassLoader classLoader) {
            ...
            for (int i4 = 0; i4 < i; i4++) {
                this.behaviorStates.append(iArr[i4], parcelableArray[i4]);
            }
        }
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                iArr[i4] = this.behaviorStates.keyAt(i4);
                parcelableArr[i4] = this.behaviorStates.valueAt(i4);
            }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public boolean isBlockingInteractionBelow(CoordinatorLayout coordinatorLayout, View view) {
            ...
            Behavior behavior = this.mBehavior;
            boolean zBlocksInteractionBelow = (behavior != null ? behavior.blocksInteractionBelow(coordinatorLayout, view) : false) | z4;
        ...
        public void setNestedScrollAccepted(int i, boolean z4) {
            if (i == 0) {
