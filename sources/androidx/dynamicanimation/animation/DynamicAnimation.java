...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    public static final ViewProperty f7829X = new ViewProperty("x") { // from class: androidx.dynamicanimation.animation.DynamicAnimation.9
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
            return view.getX();
        }
    ...
    public static final ViewProperty f7830Y = new ViewProperty("y") { // from class: androidx.dynamicanimation.animation.DynamicAnimation.10
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
            return view.getY();
        }
    ...
    public static final ViewProperty f7831Z = new ViewProperty("z") { // from class: androidx.dynamicanimation.animation.DynamicAnimation.11
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
    ...
    public interface OnAnimationEndListener {
        void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z4, float f, float f3);
    }
    ...
    private void endAnimationInternal(boolean z4) {
        ...
        for (int i = 0; i < this.mEndListeners.size(); i++) {
            if (this.mEndListeners.get(i) != null) {
                this.mEndListeners.get(i).onAnimationEnd(this, z4, this.mValue, this.mVelocity);
            }
        }
    ...
    private static <T> void removeEntry(ArrayList<T> arrayList, T t5) {
        int iIndexOf = arrayList.indexOf(t5);
        if (iIndexOf >= 0) {
    ...
    public boolean doAnimationFrame(long j) {
        ...
        this.mLastFrameTime = j;
        boolean zUpdateValueAndVelocity = updateValueAndVelocity(j - j6);
    ...
    public abstract float getAcceleration(float f, float f3);
    ...
    public abstract boolean isAtEquilibrium(float f, float f3);
    ...
    public T setMinimumVisibleChange(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, fromInclusive = false) float f) {
        if (f <= 0.0f) {
