...
public final class SpringAnimation extends DynamicAnimation<SpringAnimation> {
    ...
    public float getAcceleration(float f, float f3) {
        return this.mSpring.getAcceleration(f, f3);
    }
    ...
    public boolean isAtEquilibrium(float f, float f3) {
        return this.mSpring.isAtEquilibrium(f, f3);
    }
    ...
    public boolean updateValueAndVelocity(long j) {
        ...
        if (this.mPendingPosition != Float.MAX_VALUE) {
            ...
            long j6 = j / 2;
            DynamicAnimation.MassState massStateUpdateValues = this.mSpring.updateValues(this.mValue, this.mVelocity, j6);
