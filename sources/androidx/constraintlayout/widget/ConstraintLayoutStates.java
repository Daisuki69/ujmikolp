...
public class ConstraintLayoutStates {
    ...
    */
    ...
    public void updateConstraints(int i, float f, float f3) {
        int iFindMatch;
        int i4 = this.mCurrentStateId;
        if (i4 == i) {
            State stateValueAt = i == -1 ? this.mStateList.valueAt(0) : this.mStateList.get(i4);
            int i6 = this.mCurrentConstraintNumber;
            if ((i6 == -1 || !stateValueAt.mVariants.get(i6).match(f, f3)) && this.mCurrentConstraintNumber != (iFindMatch = stateValueAt.findMatch(f, f3))) {
                ConstraintSet constraintSet = iFindMatch == -1 ? this.mDefaultConstraintSet : stateValueAt.mVariants.get(iFindMatch).mConstraintSet;
                int i10 = iFindMatch == -1 ? stateValueAt.mConstraintID : stateValueAt.mVariants.get(iFindMatch).mConstraintID;
        ...
        int i11 = iFindMatch2 == -1 ? state.mConstraintID : state.mVariants.get(iFindMatch2).mConstraintID;
        if (constraintSet2 == null) {
            Log.v("ConstraintLayoutStates", "NO Constraint set found ! id=" + i + ", dim =" + f + ", " + f3);
            return;
        }
        this.mCurrentConstraintNumber = iFindMatch2;
        ConstraintsChangedListener constraintsChangedListener3 = this.mConstraintsChangedListener;
        if (constraintsChangedListener3 != null) {
            constraintsChangedListener3.preLayoutChange(i, i11);
        }
        constraintSet2.applyTo(this.mConstraintLayout);
        ConstraintsChangedListener constraintsChangedListener4 = this.mConstraintsChangedListener;
        if (constraintsChangedListener4 != null) {
            constraintsChangedListener4.postLayoutChange(i, i11);
        }
    }
}
