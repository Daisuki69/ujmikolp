...
public class ConstraintSet {
        ...
        public static class Delta {
            ...
            public void applyDelta(Constraint constraint) {
                ...
                for (int i4 = 0; i4 < this.mCountFloat; i4++) {
                    ConstraintSet.setDeltaValue(constraint, this.mTypeFloat[i4], this.mValueFloat[i4]);
                }
                for (int i6 = 0; i6 < this.mCountString; i6++) {
                    ConstraintSet.setDeltaValue(constraint, this.mTypeString[i6], this.mValueString[i6]);
                }
                for (int i10 = 0; i10 < this.mCountBoolean; i10++) {
                    ConstraintSet.setDeltaValue(constraint, this.mTypeBoolean[i10], this.mValueBoolean[i10]);
                }
            }
            ...
            public void printDelta(String str) {
                ...
                Log.v(str, "strings");
                for (int i6 = 0; i6 < this.mCountString; i6++) {
                    Log.v(str, this.mTypeString[i6] + " = " + this.mValueString[i6]);
                }
                Log.v(str, TypedValues.Custom.S_BOOLEAN);
                for (int i10 = 0; i10 < this.mCountBoolean; i10++) {
                    Log.v(str, this.mTypeBoolean[i10] + " = " + this.mValueBoolean[i10]);
                }
            }
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet, boolean z4) {
        Constraint constraint = new Constraint();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, z4 ? R.styleable.ConstraintOverride : R.styleable.Constraint);
        populateConstraint(context, constraint, typedArrayObtainStyledAttributes, z4);
        typedArrayObtainStyledAttributes.recycle();
        return constraint;
    }
    ...
    public static String getDebugName(int i) {
        for (Field field : ConstraintSet.class.getDeclaredFields()) {
            if (field.getName().contains(Global.UNDERSCORE) && field.getType() == Integer.TYPE && Modifier.isStatic(field.getModifiers()) && Modifier.isFinal(field.getModifiers())) {
                try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static int lookupID(TypedArray typedArray, int i, int i4) {
    ...
    */
        ...
        if (str != null) {
            ...
            if (iIndexOf > 0 && iIndexOf < length - 1) {
                ...
                if (strSubstring.equalsIgnoreCase(ExifInterface.LONGITUDE_WEST)) {
                    i = 0;
                } else if (strSubstring.equalsIgnoreCase(i.f16182n)) {
                    i = 1;
                }
                i4 = iIndexOf + 1;
            }
            ...
            try {
                if (iIndexOf2 < 0 || iIndexOf2 >= length - 1) {
                    ...
                    if (strSubstring3.length() > 0 && strSubstring4.length() > 0) {
                        ...
                        if (f > 0.0f && f3 > 0.0f) {
                            fAbs = i == 1 ? Math.abs(f3 / f) : Math.abs(f / f3);
                        }
                    }
                }
            } catch (NumberFormatException unused) {
    ...
    public void addToHorizontalChain(int i, int i4, int i6) {
        connect(i, 1, i4, i4 == 0 ? 1 : 2, 0);
        connect(i, 2, i6, i6 == 0 ? 2 : 1, 0);
        if (i4 != 0) {
            connect(i4, 2, i, 1, 0);
        }
        if (i6 != 0) {
    ...
    public void addToHorizontalChainRTL(int i, int i4, int i6) {
        connect(i, 6, i4, i4 == 0 ? 6 : 7, 0);
        connect(i, 7, i6, i6 == 0 ? 7 : 6, 0);
        if (i4 != 0) {
            connect(i4, 7, i, 6, 0);
        }
        if (i6 != 0) {
    ...
    public void addToVerticalChain(int i, int i4, int i6) {
        connect(i, 3, i4, i4 == 0 ? 3 : 4, 0);
        connect(i, 4, i6, i6 == 0 ? 4 : 3, 0);
        if (i4 != 0) {
            connect(i4, 4, i, 3, 0);
        }
        if (i6 != 0) {
    ...
    public void center(int i, int i4, int i6, int i10, int i11, int i12, int i13, float f) {
        if (i10 < 0) {
        ...
        if (i6 == 1 || i6 == 2) {
            connect(i, 1, i4, i6, i10);
            connect(i, 2, i11, i12, i13);
        ...
        if (i6 == 6 || i6 == 7) {
            connect(i, 6, i4, i6, i10);
            connect(i, 7, i11, i12, i13);
        ...
        connect(i, 3, i4, i6, i10);
        connect(i, 4, i11, i12, i13);
    ...
    public void centerHorizontally(int i, int i4, int i6, int i10, int i11, int i12, int i13, float f) {
        connect(i, 1, i4, i6, i10);
        connect(i, 2, i11, i12, i13);
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i));
        if (constraint != null) {
    ...
    public void centerHorizontallyRtl(int i, int i4, int i6, int i10, int i11, int i12, int i13, float f) {
        connect(i, 6, i4, i6, i10);
        connect(i, 7, i11, i12, i13);
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i));
        if (constraint != null) {
    ...
    public void centerVertically(int i, int i4, int i6, int i10, int i11, int i12, int i13, float f) {
        connect(i, 3, i4, i6, i10);
        connect(i, 4, i11, i12, i13);
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i));
        if (constraint != null) {
    ...
    public void connect(int i, int i4, int i6, int i10, int i11) {
        if (!this.mConstraints.containsKey(Integer.valueOf(i))) {
            this.mConstraints.put(Integer.valueOf(i), new Constraint());
        }
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i));
        ...
        switch (i4) {
            case 1:
                if (i10 == 1) {
                    ...
                    if (i10 != 2) {
                        throw new IllegalArgumentException(s.p(new StringBuilder("Left to "), sideToString(i10), " undefined"));
                    }
                    Layout layout2 = constraint.layout;
            ...
            case 2:
                if (i10 == 1) {
                    ...
                    if (i10 != 2) {
                        throw new IllegalArgumentException(s.p(new StringBuilder("right to "), sideToString(i10), " undefined"));
                    }
                    Layout layout4 = constraint.layout;
            ...
            default:
                ...
                sb2.append(" to ");
                throw new IllegalArgumentException(s.p(sb2, sideToString(i10), " unknown"));
        }
    }

    public void constrainCircle(int i, int i4, int i6, float f) {
    ...
    public void constrainDefaultHeight(int i, int i4) {
        get(i).layout.heightDefault = i4;
    }

    public void constrainDefaultWidth(int i, int i4) {
        get(i).layout.widthDefault = i4;
    }

    public void constrainHeight(int i, int i4) {
        get(i).layout.mHeight = i4;
    }

    public void constrainMaxHeight(int i, int i4) {
        get(i).layout.heightMax = i4;
    }

    public void constrainMaxWidth(int i, int i4) {
        get(i).layout.widthMax = i4;
    }

    public void constrainMinHeight(int i, int i4) {
        get(i).layout.heightMin = i4;
    }

    public void constrainMinWidth(int i, int i4) {
        get(i).layout.widthMin = i4;
    }
    ...
    public void constrainWidth(int i, int i4) {
        get(i).layout.mWidth = i4;
    }

    public void constrainedHeight(int i, boolean z4) {
        get(i).layout.constrainedHeight = z4;
    }

    public void constrainedWidth(int i, boolean z4) {
        get(i).layout.constrainedWidth = z4;
    }

    public void create(int i, int i4) {
        Layout layout = get(i).layout;
        layout.mIsGuideline = true;
        layout.orientation = i4;
    }

    public void createBarrier(int i, int i4, int i6, int... iArr) {
        Layout layout = get(i).layout;
        layout.mHelperType = 1;
        layout.mBarrierDirection = i4;
        layout.mBarrierMargin = i6;
        layout.mIsGuideline = false;
        layout.mReferenceIds = iArr;
    }

    public void createHorizontalChain(int i, int i4, int i6, int i10, int[] iArr, float[] fArr, int i11) {
        createHorizontalChain(i, i4, i6, i10, iArr, fArr, i11, 1, 2);
    }

    public void createHorizontalChainRtl(int i, int i4, int i6, int i10, int[] iArr, float[] fArr, int i11) {
        createHorizontalChain(i, i4, i6, i10, iArr, fArr, i11, 6, 7);
    }

    public void createVerticalChain(int i, int i4, int i6, int i10, int[] iArr, float[] fArr, int i11) {
        if (iArr.length < 2) {
        ...
        connect(iArr[0], 3, i, i4, 0);
        for (int i12 = 1; i12 < iArr.length; i12++) {
            int i13 = i12 - 1;
            connect(iArr[i12], 3, iArr[i13], 4, 0);
            connect(iArr[i13], 4, iArr[i12], 3, 0);
            if (fArr != null) {
                get(iArr[i12]).layout.verticalWeight = fArr[i12];
            }
        }
        connect(iArr[iArr.length - 1], 4, i6, i10, 0);
    }
    ...
    public void removeFromHorizontalChain(int i) {
        ...
        if (i12 != -1 || i13 != -1) {
            if (i12 != -1 && i13 != -1) {
                ...
                connect(i13, 6, i4, 7, 0);
            } else if (i13 != -1) {
                int i14 = layout.rightToRight;
                if (i14 != -1) {
                    connect(i4, 7, i14, 7, 0);
                } else {
    ...
    */
    ...
    public void setApplyElevation(int i, boolean z4) {
        get(i).transform.applyElevation = z4;
    }

    public void setBarrierType(int i, int i4) {
        get(i).layout.mHelperType = i4;
    }

    public void setColorValue(int i, String str, int i4) {
        get(i).setColorValue(str, i4);
    }
    ...
    public void setEditorAbsoluteX(int i, int i4) {
        get(i).layout.editorAbsoluteX = i4;
    }

    public void setEditorAbsoluteY(int i, int i4) {
        get(i).layout.editorAbsoluteY = i4;
    }
    ...
    public void setGoneMargin(int i, int i4, int i6) {
    ...
    public void setGuidelineBegin(int i, int i4) {
        get(i).layout.guideBegin = i4;
        get(i).layout.guideEnd = -1;
        get(i).layout.guidePercent = -1.0f;
    }

    public void setGuidelineEnd(int i, int i4) {
        get(i).layout.guideEnd = i4;
    ...
    public void setHorizontalChainStyle(int i, int i4) {
        get(i).layout.horizontalChainStyle = i4;
    }
    ...
    public void setIntValue(int i, String str, int i4) {
        get(i).setIntValue(str, i4);
    }

    public void setLayoutWrapBehavior(int i, int i4) {
        if (i4 < 0 || i4 > 3) {
            return;
        }
        get(i).layout.mWrapBehavior = i4;
    }

    public void setMargin(int i, int i4, int i6) {
        Constraint constraint = get(i);
        switch (i4) {
            case 1:
    ...
    public void setTransformPivot(int i, float f, float f3) {
    ...
    public void setTranslation(int i, float f, float f3) {
        Transform transform = get(i).transform;
    ...
    public void setVerticalChainStyle(int i, int i4) {
        get(i).layout.verticalChainStyle = i4;
    }
    ...
    public void setVisibility(int i, int i4) {
        get(i).propertySet.visibility = i4;
    }

    public void setVisibilityMode(int i, int i4) {
        get(i).propertySet.mVisibilityMode = i4;
    }
    ...
    private void createHorizontalChain(int i, int i4, int i6, int i10, int[] iArr, float[] fArr, int i11, int i12, int i13) {
        if (iArr.length < 2) {
            throw new IllegalArgumentException("must have 2 or more widgets in a chain");
        }
        if (fArr != null && fArr.length != iArr.length) {
        ...
        connect(iArr[0], i12, i, i4, -1);
        for (int i14 = 1; i14 < iArr.length; i14++) {
            int i15 = i14 - 1;
            connect(iArr[i14], i12, iArr[i15], i13, -1);
            connect(iArr[i15], i13, iArr[i14], i12, -1);
            if (fArr != null) {
                get(iArr[i14]).layout.horizontalWeight = fArr[i14];
            }
        }
        connect(iArr[iArr.length - 1], i13, i6, i10, -1);
    }

    public void clear(int i, int i4) {
        Constraint constraint;
        if (!this.mConstraints.containsKey(Integer.valueOf(i)) || (constraint = this.mConstraints.get(Integer.valueOf(i))) == null) {
            return;
        }
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            Constraint constraint = constraintSet.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m76clone());
            }
        }
    }
    ...
    public class WriteJsonEngine {
        ...
        private void writeDimension(String str, int i, int i4, float f, int i6, int i10, boolean z4) throws IOException {
            if (i != 0) {
                if (i == -2) {
                ...
                if (i != -1) {
                    this.writer.write(a.d(i, SPACE, str, ": ", ",\n"));
                    return;
                }
            ...
            if (i4 == 0) {
                ...
                StringBuilder sbR = a.r(i6, SPACE, str, ": {'spread' ,", ", ");
                sbR.append(i10);
                sbR.append("}\n");
            ...
            if (i4 == 1) {
                ...
                StringBuilder sbR2 = a.r(i6, SPACE, str, ": {'wrap' ,", ", ");
                sbR2.append(i10);
                sbR2.append("}\n");
                writer2.write(sbR2.toString());
                return;
            }
            if (i4 != 2) {
                return;
            }
            this.writer.write(SPACE + str + ": {'" + f + "'% ," + i6 + ", " + i10 + "}\n");
        }

        private void writeGuideline(int i, int i4, int i6, float f) {
        }

        public String getName(int i) {
            if (this.idMap.containsKey(Integer.valueOf(i))) {
                return s.p(new StringBuilder("'"), this.idMap.get(Integer.valueOf(i)), "'");
            }
            if (i == 0) {
                return "'parent'";
            }
        ...
        public void writeCircle(int i, float f, int i4) throws IOException {
            if (i == -1) {
                return;
            }
        ...
        public void writeConstraint(String str, int i, String str2, int i4, int i6) throws IOException {
            if (i == -1) {
                return;
            }
            this.writer.write(SPACE + str);
        ...
        public void writeVariable(String str, int i) throws IOException {
            ...
            this.writer.write(SPACE + str);
            this.writer.write(Global.COLON);
            this.writer.write(", " + i);
            this.writer.write(Global.NEWLINE);
        }
        ...
        public void writeVariable(String str, float f, float f3) throws IOException {
            if (f == f3) {
                return;
            }
            this.writer.write(SPACE + str);
    ...
    public void centerHorizontally(int i, int i4) {
        if (i4 == 0) {
            center(i, 0, 1, 0, 0, 2, 0, 0.5f);
        } else {
            center(i, i4, 2, 0, i4, 1, 0, 0.5f);
        }
    }

    public void centerHorizontallyRtl(int i, int i4) {
        if (i4 == 0) {
            center(i, 0, 6, 0, 0, 7, 0, 0.5f);
        } else {
            center(i, i4, 7, 0, i4, 6, 0, 0.5f);
        }
    }

    public void centerVertically(int i, int i4) {
        if (i4 == 0) {
            center(i, 0, 3, 0, 0, 4, 0, 0.5f);
        } else {
            center(i, i4, 4, 0, i4, 3, 0, 0.5f);
        }
    }
    ...
    public class WriteXmlEngine {
        ...
        private void writeBaseDimension(String str, int i, int i4) throws IOException {
            if (i != i4) {
                if (i == -2) {
                ...
                if (i != -1) {
                    this.writer.write(a.d(i, SPACE, str, "=\"", "dp\""));
                    return;
                }
        ...
        private void writeDimension(String str, int i, int i4) throws IOException {
            if (i != i4) {
                this.writer.write(a.d(i, SPACE, str, "=\"", "dp\""));
            }
        }

        private void writeEnum(String str, int i, String[] strArr, int i4) throws IOException {
            if (i != i4) {
                Writer writer = this.writer;
                StringBuilder sbW = s.w(SPACE, str, "=\"");
                sbW.append(strArr[i]);
                sbW.append("\"");
        ...
        public String getName(int i) {
            if (this.idMap.containsKey(Integer.valueOf(i))) {
                return s.p(new StringBuilder("@+id/"), this.idMap.get(Integer.valueOf(i)), "");
            }
            if (i == 0) {
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void setDeltaValue(Constraint constraint, int i, int i4) {
        if (i == 6) {
            constraint.layout.editorAbsoluteX = i4;
            return;
        }
        if (i == 7) {
            constraint.layout.editorAbsoluteY = i4;
            return;
        }
        if (i == 8) {
        ...
        if (i == 27) {
            constraint.layout.orientation = i4;
            return;
        }
        if (i == 28) {
        ...
        if (i == 41) {
            constraint.layout.horizontalChainStyle = i4;
            return;
        }
        if (i == 42) {
            constraint.layout.verticalChainStyle = i4;
            return;
        }
        if (i == 61) {
            constraint.layout.circleConstraint = i4;
            return;
        }
        if (i == 62) {
            constraint.layout.circleRadius = i4;
            return;
        }
        if (i == 72) {
            constraint.layout.mBarrierDirection = i4;
            return;
        }
        if (i != 73) {
            switch (i) {
                ...
                case 16:
                    ...
                    break;
                case 17:
                    constraint.layout.guideBegin = i4;
                    break;
                case 18:
                    constraint.layout.guideEnd = i4;
                    break;
                case 31:
                ...
                case 34:
                    ...
                    break;
                case 38:
                    constraint.mViewId = i4;
                    break;
                case 64:
                    constraint.motion.mAnimateRelativeTo = i4;
                    break;
                case 66:
                    constraint.motion.mDrawPath = i4;
                    break;
                case 76:
                    constraint.motion.mPathMotionArc = i4;
                    break;
                case 78:
                    constraint.propertySet.mVisibilityMode = i4;
                    break;
                case 93:
                ...
                case 94:
                    ...
                    break;
                case 97:
                    constraint.layout.mWrapBehavior = i4;
                    break;
                default:
                    switch (i) {
                        case 21:
                            constraint.layout.mHeight = i4;
                            break;
                        case 22:
                            constraint.propertySet.visibility = i4;
                            break;
                        case 23:
                            constraint.layout.mWidth = i4;
                            break;
                        case 24:
                        ...
                        default:
                            switch (i) {
                                case 54:
                                    constraint.layout.widthDefault = i4;
                                    break;
                                case 55:
                                    constraint.layout.heightDefault = i4;
                                    break;
                                case 56:
                                    constraint.layout.widthMax = i4;
                                    break;
                                case 57:
                                    constraint.layout.heightMax = i4;
                                    break;
                                case 58:
                                    constraint.layout.widthMin = i4;
                                    break;
                                case 59:
                                    constraint.layout.heightMin = i4;
                                    break;
                                default:
                                    switch (i) {
                                        case 82:
                                            constraint.motion.mAnimateCircleAngleTo = i4;
                                            break;
                                        case 83:
                                            constraint.transform.transformPivotTarget = i4;
                                            break;
                                        case 84:
                                            constraint.motion.mQuantizeMotionSteps = i4;
                                            break;
                                        default:
                                            switch (i) {
                                                case 87:
                                                    break;
                                                case 88:
                                                    constraint.motion.mQuantizeInterpolatorType = i4;
                                                    break;
                                                case 89:
                                                    constraint.motion.mQuantizeInterpolatorID = i4;
                                                    break;
                                                default:
                                                    Log.w(TAG, "Unknown attribute 0x");
                                                    break;
        ...
        constraint.layout.mBarrierMargin = i4;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void setDeltaValue(Constraint constraint, int i, boolean z4) {
        if (i == 44) {
    ...
    public void connect(int i, int i4, int i6, int i10) {
        if (!this.mConstraints.containsKey(Integer.valueOf(i))) {
            this.mConstraints.put(Integer.valueOf(i), new Constraint());
        }
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i));
