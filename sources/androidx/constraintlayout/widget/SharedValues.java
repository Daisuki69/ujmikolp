...
public class SharedValues {
    ...
    public interface SharedValuesListener {
        void onNewValue(int i, int i4, int i6);
    }
    ...
    public void fireNewValue(int i, int i4) {
        int i6 = this.mValues.get(i, -1);
        if (i6 == i4) {
            return;
        }
        this.mValues.put(i, i4);
        HashSet<WeakReference<SharedValuesListener>> hashSet = this.mValuesListeners.get(Integer.valueOf(i));
        if (hashSet == null) {
            return;
        }
        ...
        while (it.hasNext()) {
            ...
            if (sharedValuesListener != null) {
                sharedValuesListener.onNewValue(i, i4, i6);
            } else {
                z4 = true;
            }
        }
