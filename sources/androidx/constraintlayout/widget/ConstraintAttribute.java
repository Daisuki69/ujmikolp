...
public class ConstraintAttribute {
    ...
    public static void parse(Context context, XmlPullParser xmlPullParser, HashMap<String, ConstraintAttribute> map) {
        ...
        if (string != null && objValueOf2 != null) {
            map.put(string, new ConstraintAttribute(string, attributeType2, objValueOf2, z4));
        }
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> map) {
        ...
        for (String str : map.keySet()) {
            ConstraintAttribute constraintAttribute = map.get(str);
            String strH = !constraintAttribute.mMethod ? AbstractC1414e.h("set", str) : str;
            try {
                ...
                switch (i) {
                    case 1:
                        cls.getMethod(strH, cls3).invoke(view, Integer.valueOf(constraintAttribute.mIntegerValue));
                        break;
                    case 2:
                        cls.getMethod(strH, Boolean.TYPE).invoke(view, Boolean.valueOf(constraintAttribute.mBooleanValue));
                        break;
                    case 3:
                        cls.getMethod(strH, CharSequence.class).invoke(view, constraintAttribute.mStringValue);
                        break;
                    case 4:
                        cls.getMethod(strH, cls3).invoke(view, Integer.valueOf(constraintAttribute.mColorValue));
                        break;
                    case 5:
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        cls.getMethod(strH, cls2).invoke(view, Float.valueOf(constraintAttribute.mFloatValue));
                        break;
                    case 8:
                        cls.getMethod(strH, cls2).invoke(view, Float.valueOf(constraintAttribute.mFloatValue));
                        break;
                ...
                StringBuilder sbW = s.w(" Custom Attribute \"", str, "\" not found on ");
                sbW.append(cls.getName());
                Log.e(TAG, sbW.toString());
                e.printStackTrace();
            } catch (NoSuchMethodException e7) {
                Log.e(TAG, e7.getMessage());
                Log.e(TAG, " Custom Attribute \"" + str + "\" not found on " + cls.getName());
                Log.e(TAG, cls.getName() + " must have a method " + strH);
            } catch (InvocationTargetException e10) {
                StringBuilder sbW2 = s.w(" Custom Attribute \"", str, "\" not found on ");
                sbW2.append(cls.getName());
                Log.e(TAG, sbW2.toString());
                e10.printStackTrace();
            }
        }
    }
    ...
    public void applyCustom(View view) {
        ...
        String strH = !this.mMethod ? AbstractC1414e.h("set", str) : str;
        try {
            ...
            switch (i) {
                case 1:
                case 6:
                    cls.getMethod(strH, cls2).invoke(view, Integer.valueOf(this.mIntegerValue));
                    break;
                case 2:
                    cls.getMethod(strH, Boolean.TYPE).invoke(view, Boolean.valueOf(this.mBooleanValue));
                    break;
                case 3:
                    cls.getMethod(strH, CharSequence.class).invoke(view, this.mStringValue);
                    break;
                case 4:
                    cls.getMethod(strH, cls2).invoke(view, Integer.valueOf(this.mColorValue));
                    break;
                case 5:
                    Method method = cls.getMethod(strH, Drawable.class);
                    ColorDrawable colorDrawable = new ColorDrawable();
                    ...
                    break;
                case 7:
                    cls.getMethod(strH, cls3).invoke(view, Float.valueOf(this.mFloatValue));
                    break;
                case 8:
                    cls.getMethod(strH, cls3).invoke(view, Float.valueOf(this.mFloatValue));
                    break;
