...
public class ReactiveGuide extends View implements SharedValues.SharedValuesListener {
    ...
    private void changeValue(int i, int i4, MotionLayout motionLayout, int i6) {
        ConstraintSet constraintSet = motionLayout.getConstraintSet(i6);
        constraintSet.setGuidelineEnd(i4, i);
    ...
    public void onNewValue(int i, int i4, int i6) {
        ...
        if (id > 0 && (getParent() instanceof MotionLayout)) {
            ...
            if (!this.mAnimateChange) {
                if (!this.mApplyToAllConstraintSets) {
                    changeValue(i4, id, motionLayout, currentState);
                    return;
                }
                int[] constraintSetIds = motionLayout.getConstraintSetIds();
                while (i11 < constraintSetIds.length) {
                    changeValue(i4, id, motionLayout, constraintSetIds[i11]);
                    i11++;
                }
                return;
            }
    ...
    public ReactiveGuide(Context context, AttributeSet attributeSet, int i, int i4) {
        super(context, attributeSet, i);
        this.mAttributeId = -1;
        this.mAnimateChange = false;
        this.mApplyToConstraintSetId = 0;
