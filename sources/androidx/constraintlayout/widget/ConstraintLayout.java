...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        private boolean isSimilarSpec(int i, int i4, int i6) {
            if (i == i4) {
                return true;
            }
        ...
        public void captureLayoutInfo(int i, int i4, int i6, int i10, int i11, int i12) {
            this.paddingTop = i6;
            this.paddingBottom = i10;
            this.paddingWidth = i11;
            this.paddingHeight = i12;
            this.layoutWidthSpec = i;
            this.layoutHeightSpec = i4;
        }
        ...
        public final void didMeasures() {
            ...
            if (size > 0) {
                for (int i4 = 0; i4 < size; i4++) {
                    ((ConstraintHelper) this.layout.mConstraintHelpers.get(i4)).updatePostMeasure(this.layout);
                }
            }
        }
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (i12 == 1) {
                ...
                iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i11, -2);
                boolean z4 = constraintWidget.mMatchConstraintDefaultWidth == 1;
                ...
                if (i13 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i13 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                    boolean z5 = view.getMeasuredHeight() == constraintWidget.getHeight();
                    if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z4 || ((z4 && z5) || (view instanceof Placeholder) || constraintWidget.isResolvedHorizontally())) {
            ...
            if (i14 == 1) {
                ...
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i10, -2);
            } else if (i14 == 3) {
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, constraintWidget.getVerticalMargin() + i10, -1);
            } else if (i14 != 4) {
                iMakeMeasureSpec2 = 0;
            } else {
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i10, -2);
            ...
            if (i16 != BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS && i16 != BasicMeasure.Measure.USE_GIVEN_DIMENSIONS && z10 && constraintWidget.mMatchConstraintDefaultWidth == 0 && z11 && constraintWidget.mMatchConstraintDefaultHeight == 0) {
                iMax2 = 0;
                i = -1;
                baseline = 0;
                iMax = 0;
    ...
    private void init(AttributeSet attributeSet, int i, int i4) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, R.styleable.ConstraintLayout_Layout, i, i4);
    ...
    */
            ...
            for (int i4 = 0; i4 < childCount; i4++) {
                ...
                if (childAt.getVisibility() != 8 && (tag = childAt.getTag()) != null && (tag instanceof String)) {
                    ...
                    if (strArrSplit.length == 4) {
                        ...
                        int i12 = (int) ((i6 / 1080.0f) * width);
                        int i13 = (int) ((i10 / 1920.0f) * height);
                        Paint paint = new Paint();
                        paint.setColor(-65536);
                        float f = i12;
                        float f3 = i13;
                        float f7 = i12 + ((int) ((i11 / 1080.0f) * width));
                        canvas.drawLine(f, f3, f7, f3, paint);
                        float f10 = i13 + ((int) ((Integer.parseInt(strArrSplit[3]) / 1920.0f) * height));
                        canvas.drawLine(f7, f3, f7, f10, paint);
                        canvas.drawLine(f7, f10, f, f10, paint);
                        canvas.drawLine(f, f10, f, f3, paint);
                        paint.setColor(-16711936);
                        canvas.drawLine(f, f3, f7, f10, paint);
                        canvas.drawLine(f, f10, f7, f3, paint);
                    }
                }
            }
        }
    ...
    public void onLayout(boolean z4, int i, int i4, int i6, int i10) {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if ((childAt.getVisibility() != 8 || layoutParams.isGuideline || layoutParams.isHelper || layoutParams.isVirtualGroup || zIsInEditMode) && !layoutParams.isInPlaceholder) {
                ...
                childAt.layout(x6, y7, width, height);
                if ((childAt instanceof Placeholder) && (content = ((Placeholder) childAt).getContent()) != null) {
                    content.setVisibility(0);
                    content.layout(x6, y7, width, height);
                }
            }
        }
        int size = this.mConstraintHelpers.size();
    ...
    public void onMeasure(int i, int i4) {
        ...
        resolveMeasuredDimension(i, i4, this.mLayoutWidget.getWidth(), this.mLayoutWidget.getHeight(), this.mLayoutWidget.isWidthMeasuredTooSmall(), this.mLayoutWidget.isHeightMeasuredTooSmall());
    }
    ...
    public void resolveMeasuredDimension(int i, int i4, int i6, int i10, boolean z4, boolean z5) {
        Measurer measurer = this.mMeasurer;
        int i11 = measurer.paddingHeight;
        int iResolveSizeAndState = View.resolveSizeAndState(i6 + measurer.paddingWidth, i, 0);
    ...
    public void resolveSystem(ConstraintWidgetContainer constraintWidgetContainer, int i, int i4, int i6) {
        int i10;
        ...
        this.mMeasurer.captureLayoutInfo(i4, i6, iMax, iMax2, paddingWidth, i11);
        ...
        if (iMax3 > 0 || iMax4 > 0) {
            ...
            constraintWidgetContainer.measure(i, mode, i12, mode2, i13, this.mLastMeasureWidth, this.mLastMeasureHeight, i10, iMax);
        }
        ...
        constraintWidgetContainer.measure(i, mode, i122, mode2, i132, this.mLastMeasureWidth, this.mLastMeasureHeight, i10, iMax);
    }
 ...
 binds: [B:21:0x004a, B:17:0x003c] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public void setState(int i, int i4, int i6) {
        ConstraintLayoutStates constraintLayoutStates = this.mConstraintLayoutSpec;
        if (constraintLayoutStates != null) {
            constraintLayoutStates.updateConstraints(i, i4, i6);
        }
    }
    ...
    @TargetApi(21)
    public ConstraintLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i4) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                switch (i4) {
                    ...
                    case 32:
                        ...
                        this.matchConstraintDefaultHeight = i10;
                        if (i10 == 1) {
