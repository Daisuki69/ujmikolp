...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            canvas.drawRGB(MfaTencentErrorResult.TENCENT_ERROR_PREPARE_TIME_OUT, MfaTencentErrorResult.TENCENT_ERROR_PREPARE_TIME_OUT, MfaTencentErrorResult.TENCENT_ERROR_PREPARE_TIME_OUT);
            ...
            paint.getTextBounds(Global.QUESTION, 0, 1, rect);
            canvas.drawText(Global.QUESTION, ((iWidth / 2.0f) - (rect.width() / 2.0f)) - rect.left, ((rect.height() / 2.0f) + (iHeight / 2.0f)) - rect.bottom, paint);
        }
    }
    ...
    public Placeholder(Context context, AttributeSet attributeSet, int i, int i4) {
        super(context, attributeSet, i);
        this.mContentId = -1;
        this.mContent = null;
        this.mEmptyVisibility = 4;
