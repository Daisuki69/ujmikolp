...
public class ConstraintProperties {
    ...
    public ConstraintProperties addToHorizontalChain(int i, int i4) {
        connect(1, i, i == 0 ? 1 : 2, 0);
        connect(2, i4, i4 == 0 ? 2 : 1, 0);
        if (i != 0) {
            new ConstraintProperties(((ViewGroup) this.mView.getParent()).findViewById(i)).connect(2, this.mView.getId(), 1, 0);
        }
        if (i4 != 0) {
            new ConstraintProperties(((ViewGroup) this.mView.getParent()).findViewById(i4)).connect(1, this.mView.getId(), 2, 0);
        }
        return this;
    }

    public ConstraintProperties addToHorizontalChainRTL(int i, int i4) {
        connect(6, i, i == 0 ? 6 : 7, 0);
        connect(7, i4, i4 == 0 ? 7 : 6, 0);
        if (i != 0) {
            new ConstraintProperties(((ViewGroup) this.mView.getParent()).findViewById(i)).connect(7, this.mView.getId(), 6, 0);
        }
        if (i4 != 0) {
            new ConstraintProperties(((ViewGroup) this.mView.getParent()).findViewById(i4)).connect(6, this.mView.getId(), 7, 0);
        }
        return this;
    }

    public ConstraintProperties addToVerticalChain(int i, int i4) {
        connect(3, i, i == 0 ? 3 : 4, 0);
        connect(4, i4, i4 == 0 ? 4 : 3, 0);
        if (i != 0) {
            new ConstraintProperties(((ViewGroup) this.mView.getParent()).findViewById(i)).connect(4, this.mView.getId(), 3, 0);
        }
        if (i4 != 0) {
            new ConstraintProperties(((ViewGroup) this.mView.getParent()).findViewById(i4)).connect(3, this.mView.getId(), 4, 0);
        }
        return this;
    }
    ...
    public ConstraintProperties center(int i, int i4, int i6, int i10, int i11, int i12, float f) {
        if (i6 < 0) {
    ...
    public ConstraintProperties centerHorizontally(int i, int i4, int i6, int i10, int i11, int i12, float f) {
        connect(1, i, i4, i6);
        connect(2, i10, i11, i12);
        this.mParams.horizontalBias = f;
        return this;
    ...
    public ConstraintProperties centerHorizontallyRtl(int i, int i4, int i6, int i10, int i11, int i12, float f) {
        connect(6, i, i4, i6);
        connect(7, i10, i11, i12);
        this.mParams.horizontalBias = f;
        return this;
    ...
    public ConstraintProperties centerVertically(int i, int i4, int i6, int i10, int i11, int i12, float f) {
        connect(3, i, i4, i6);
        connect(4, i10, i11, i12);
        this.mParams.verticalBias = f;
        return this;
    ...
    public ConstraintProperties connect(int i, int i4, int i6, int i10) {
        switch (i) {
            case 1:
                if (i6 == 1) {
                    ...
                    if (i6 != 2) {
                        throw new IllegalArgumentException(s.p(new StringBuilder("Left to "), sideToString(i6), " undefined"));
                    }
            ...
            case 2:
                if (i6 == 1) {
                    ...
                    if (i6 != 2) {
                        throw new IllegalArgumentException(s.p(new StringBuilder("right to "), sideToString(i6), " undefined"));
                    }
            ...
            case 5:
                if (i6 == 5) {
                    ...
                    layoutParams9.baselineToBaseline = i4;
                ...
                if (i6 == 3) {
                    ...
                    layoutParams10.baselineToTop = i4;
            ...
            default:
                ...
                sb2.append(sideToString(i));
                sb2.append(" to ");
                throw new IllegalArgumentException(s.p(sb2, sideToString(i6), " unknown"));
        }
    }
    ...
    public ConstraintProperties goneMargin(int i, int i4) {
        switch (i) {
            case 1:
                this.mParams.goneLeftMargin = i4;
                return this;
            case 2:
                this.mParams.goneRightMargin = i4;
                return this;
            case 3:
                this.mParams.goneTopMargin = i4;
                return this;
            case 4:
                this.mParams.goneBottomMargin = i4;
                return this;
            case 5:
                throw new IllegalArgumentException("baseline does not support margins");
            case 6:
                this.mParams.goneStartMargin = i4;
                return this;
            case 7:
                this.mParams.goneEndMargin = i4;
                return this;
            default:
    ...
    public ConstraintProperties margin(int i, int i4) {
        switch (i) {
            case 1:
    ...
    public ConstraintProperties removeFromHorizontalChain() {
        ...
        if (i != -1 || i4 != -1) {
            ...
            ConstraintLayout.LayoutParams layoutParams2 = this.mParams;
            if (i != -1 && i4 != -1) {
                constraintProperties.connect(2, i4, 1, 0);
                constraintProperties2.connect(1, i, 2, 0);
            } else if (i != -1 || i4 != -1) {
                int i6 = layoutParams2.rightToRight;
                if (i6 != -1) {
                    constraintProperties.connect(2, i6, 2, 0);
                } else {
                    int i10 = layoutParams2.leftToLeft;
                    if (i10 != -1) {
                        constraintProperties2.connect(1, i10, 1, 0);
                    }
                }
            }
            removeConstraints(1);
        ...
        if (i11 != -1 || i12 != -1) {
            ConstraintProperties constraintProperties3 = new ConstraintProperties(((ViewGroup) this.mView.getParent()).findViewById(i11));
            ConstraintProperties constraintProperties4 = new ConstraintProperties(((ViewGroup) this.mView.getParent()).findViewById(i12));
            ConstraintLayout.LayoutParams layoutParams3 = this.mParams;
            if (i11 != -1 && i12 != -1) {
                constraintProperties3.connect(7, i12, 6, 0);
                constraintProperties4.connect(6, i, 7, 0);
            } else if (i != -1 || i12 != -1) {
                int i13 = layoutParams3.rightToRight;
                if (i13 != -1) {
                    constraintProperties3.connect(7, i13, 7, 0);
                } else {
                    int i14 = layoutParams3.leftToLeft;
                    if (i14 != -1) {
                        constraintProperties4.connect(6, i14, 6, 0);
                    }
                }
            }
        }
    ...
    public ConstraintProperties transformPivot(float f, float f3) {
    ...
    public ConstraintProperties translation(float f, float f3) {
