...
public class ViewTransition {
    ...
    public static class Animate {
        ...
        public Animate(ViewTransitionController viewTransitionController, MotionController motionController, int i, int i4, int i6, Interpolator interpolator, int i10, int i11) {
        ...
        public void reactTo(int i, float f, float f3) {
            if (i == 1) {
                if (this.reverse) {
                    return;
                }
                ...
                if (this.mTempRec.contains((int) f, (int) f3) || this.reverse) {
                    return;
                }
                reverse(true);
            }
    ...
    */
    ...
    private void updateTransition(MotionScene.Transition transition, View view) {
        ...
        if (keyFrames != null) {
            ...
            while (it.hasNext()) {
                keyFrames2.addKey(it.next().mo75clone().setViewId(id));
            }
    ...
    public void applyTransition(ViewTransitionController viewTransitionController, MotionLayout motionLayout, int i, ConstraintSet constraintSet, View... viewArr) {
        ...
        if (i4 == 1) {
            for (int i6 : motionLayout.getConstraintSetIds()) {
                if (i6 != i) {
                    ConstraintSet constraintSet2 = motionLayout.getConstraintSet(i6);
                    for (View view : viewArr) {
        ...
        MotionScene.Transition transition = new MotionScene.Transition(-1, motionLayout.mScene, i10, i);
        for (View view3 : viewArr) {
            updateTransition(transition, view3);
        }
        motionLayout.setTransition(transition);
        motionLayout.transitionToEnd(new g(25, this, viewArr));
    }

    public boolean checkTags(View view) {
        int i = this.mIfTagSet;
        boolean z4 = i == -1 || view.getTag(i) != null;
        int i4 = this.mIfTagNotSet;
    ...
    public boolean supports(int i) {
        ...
        return i4 == 1 ? i == 0 : i4 == 2 ? i == 1 : i4 == 3 && i == 0;
    }
