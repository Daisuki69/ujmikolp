    ...
    private void fire(String str, View view) {
        ...
        if (method == null) {
            try {
                ...
                Log.e(TypedValues.TriggerType.NAME, "Could not find method \"" + str + "\"on class " + view.getClass().getSimpleName() + Global.BLANK + Debug.getName(view));
                return;
            }
        }
        try {
            ...
            Log.e(TypedValues.TriggerType.NAME, "Exception in call \"" + this.mCross + "\"on class " + view.getClass().getSimpleName() + Global.BLANK + Debug.getName(view));
        }
    }
