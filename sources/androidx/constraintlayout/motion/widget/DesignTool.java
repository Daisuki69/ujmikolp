...
public class DesignTool implements ProxyInterface {
    ...
    private static void Connect(int i, ConstraintSet constraintSet, View view, HashMap<String, String> map, int i4, int i6) {
        String str = allAttributes.get(Pair.create(Integer.valueOf(i4), Integer.valueOf(i6)));
        String str2 = map.get(str);
        if (str2 != null) {
            String str3 = allMargins.get(str);
            constraintSet.connect(view.getId(), i4, Integer.parseInt(str2), i6, str3 != null ? GetPxFromDp(i, map.get(str3)) : 0);
        }
    }
    ...
    private static void SetDimensions(int i, ConstraintSet constraintSet, View view, HashMap<String, String> map, int i4) {
        String str = map.get(i4 == 1 ? "layout_height" : "layout_width");
        if (str != null) {
    ...
    public int designAccess(int i, String str, Object obj, float[] fArr, int i4, float[] fArr2, int i6) {
    ...
    public void dumpConstraintSet(String str) {
        ...
        System.out.println(a.d(iLookUpConstraintId, " dumping  ", str, " (", ")"));
        try {
    ...
    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public float getKeyFramePosition(Object obj, int i, float f, float f3) {
        MotionController motionController;
        if ((obj instanceof View) && (motionController = this.mMotionLayout.mFrameArrayList.get((View) obj)) != null) {
            return motionController.getKeyFrameParameter(i, f, f3);
        }
        return 0.0f;
    }
    ...
    public Object getKeyframe(int i, int i4, int i6) {
        MotionLayout motionLayout = this.mMotionLayout;
        MotionScene motionScene = motionLayout.mScene;
        if (motionScene == null) {
            return null;
        }
        return motionScene.getKeyFrame(motionLayout.getContext(), i, i4, i6);
    }

    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public Object getKeyframeAtLocation(Object obj, float f, float f3) {
        MotionController motionController;
        View view = (View) obj;
        MotionLayout motionLayout = this.mMotionLayout;
        if (motionLayout.mScene == null) {
        ...
        return motionController.getPositionKeyframe(viewGroup.getWidth(), viewGroup.getHeight(), f, f3);
    }

    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public Boolean getPositionKeyframe(Object obj, Object obj2, float f, float f3, String[] strArr, float[] fArr) {
        if (!(obj instanceof KeyPositionBase)) {
            return Boolean.FALSE;
        }
        View view = (View) obj2;
        this.mMotionLayout.mFrameArrayList.get(view).positionKeyframe(view, (KeyPositionBase) obj, f, f3, strArr, fArr);
    ...
    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public boolean setKeyFramePosition(Object obj, int i, int i4, float f, float f3) {
        ...
        if (motionLayout.mScene != null) {
            ...
            if (motionController != null) {
                ...
                if (motionLayout2.mScene.hasKeyFramePosition(view, i6)) {
                    float keyFrameParameter = motionController.getKeyFrameParameter(2, f, f3);
                    float keyFrameParameter2 = motionController.getKeyFrameParameter(5, f, f3);
    ...
    public Object getKeyframe(Object obj, int i, int i4) {
        if (this.mMotionLayout.mScene == null) {
            return null;
        }
        int id = ((View) obj).getId();
        MotionLayout motionLayout = this.mMotionLayout;
        return motionLayout.mScene.getKeyFrame(motionLayout.getContext(), i, id, i4);
    }
}
