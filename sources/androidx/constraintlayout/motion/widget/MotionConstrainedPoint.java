...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    private float f7755x;

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    private float f7756y;
    ...
    public void different(MotionConstrainedPoint motionConstrainedPoint, HashSet<String> hashSet) {
        ...
        if (i != i4 && this.mVisibilityMode == 0 && (i == 0 || i4 == 0)) {
            hashSet.add("alpha");
        }
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        int i = 0;
        float[] fArr = {this.position, this.f7755x, this.f7756y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        for (int i4 : iArr) {
            if (i4 < 18) {
                dArr[i] = fArr[r4];
                i++;
    ...
    public void setState(Rect rect, ConstraintSet constraintSet, int i, int i4) {
        setBounds(rect.left, rect.top, rect.width(), rect.height());
    ...
    public void applyParameters(ConstraintSet.Constraint constraint) {
        ...
        this.visibility = i4;
        this.alpha = (i4 == 0 || i != 0) ? propertySet.alpha : 0.0f;
    ...
    public void different(MotionConstrainedPoint motionConstrainedPoint, boolean[] zArr, String[] strArr) {
        ...
        zArr[1] = zArr[1] | diff(this.f7755x, motionConstrainedPoint.f7755x);
        zArr[2] = zArr[2] | diff(this.f7756y, motionConstrainedPoint.f7756y);
