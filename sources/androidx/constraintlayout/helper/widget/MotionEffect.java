        ...
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == R.styleable.MotionEffect_motionEffect_start) {
                    int i4 = typedArrayObtainStyledAttributes.getInt(index, this.motionEffectStart);
                    this.motionEffectStart = i4;
                    this.motionEffectStart = Math.max(Math.min(i4, 99), 0);
                } else if (index == R.styleable.MotionEffect_motionEffect_end) {
                    int i6 = typedArrayObtainStyledAttributes.getInt(index, this.motionEffectEnd);
            ...
            int i10 = this.motionEffectStart;
            int i11 = this.motionEffectEnd;
            if (i10 == i11) {
                if (i10 > 0) {
                    this.motionEffectStart = i10 - 1;
                } else {
                    this.motionEffectEnd = i11 + 1;
                }
            }
