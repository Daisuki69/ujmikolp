...
public class Carousel extends MotionHelper {
    ...
    private boolean enableTransition(int i, boolean z4) {
        MotionLayout motionLayout;
        MotionScene.Transition transition;
        if (i == -1 || (motionLayout = this.mMotionLayout) == null || (transition = motionLayout.getTransition(i)) == null || z4 == transition.isEnabled()) {
            return false;
        }
    ...
    public void updateItems() {
        ...
        if (i10 != -1 && i10 != this.mIndex) {
            this.mMotionLayout.post(new l(this, 21));
        } else if (i10 == this.mIndex) {
            this.mTargetIndex = -1;
        }
    ...
    private boolean updateViewVisibility(View view, int i) {
        ...
        for (int i4 : motionLayout.getConstraintSetIds()) {
            zUpdateViewVisibility |= updateViewVisibility(i4, view, i);
        }
    ...
    private boolean updateViewVisibility(int i, View view, int i4) {
