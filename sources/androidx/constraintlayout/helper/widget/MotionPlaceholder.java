...
public class MotionPlaceholder extends VirtualLayout {
    ...
    public void onMeasure(int i, int i4) {
        onMeasure(this.mPlaceholder, i, i4);
    }
    ...
    public void onMeasure(androidx.constraintlayout.core.widgets.VirtualLayout virtualLayout, int i, int i4) {
    ...
    public MotionPlaceholder(Context context, AttributeSet attributeSet, int i, int i4) {
        super(context, attributeSet, i);
    }
}
