...
public class MotionWidget implements TypedValues {
    ...
    public void setCustomAttribute(String str, int i, int i4) {
        this.widgetFrame.setCustomAttribute(str, i, i4);
    }

    @Override // androidx.constraintlayout.core.motion.utils.TypedValues
    public boolean setValue(int i, int i4) {
        return setValueAttributes(i, i4);
    }

    public void setCustomAttribute(String str, int i, boolean z4) {
        this.widgetFrame.setCustomAttribute(str, i, z4);
    }
