...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    public void different(MotionConstrainedPoint motionConstrainedPoint, HashSet<String> hashSet) {
        ...
        if (i != i4 && this.mVisibilityMode == 0 && (i == 4 || i4 == 4)) {
            hashSet.add("alpha");
        }
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        int i = 0;
        float[] fArr = {this.position, this.f7742x, this.f7743y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        for (int i4 : iArr) {
            if (i4 < 18) {
                dArr[i] = fArr[r4];
                i++;
    ...
    public void different(MotionConstrainedPoint motionConstrainedPoint, boolean[] zArr, String[] strArr) {
        ...
        zArr[1] = zArr[1] | diff(this.f7742x, motionConstrainedPoint.f7742x);
        zArr[2] = zArr[2] | diff(this.f7743y, motionConstrainedPoint.f7743y);
