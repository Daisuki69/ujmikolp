...
public class CustomVariable {
    ...
    public static String colorString(int i) {
        return "#" + a.e(i, new StringBuilder("00000000")).substring(r2.length() - 8);
    }

    public static int hsvToRgb(float f, float f3, float f7) {
        float f10 = f * 6.0f;
        int i = (int) f10;
        float f11 = f10 - i;
        float f12 = f7 * 255.0f;
        int iA = (int) s.a(1.0f, f3, f12, 0.5f);
        int i4 = (int) (((1.0f - (f11 * f3)) * f12) + 0.5f);
        int i6 = (int) (((1.0f - ((1.0f - f11) * f3)) * f12) + 0.5f);
        int i10 = (int) (f12 + 0.5f);
        if (i == 0) {
            return ((i10 << 16) + (i6 << 8) + iA) | (-16777216);
        }
        if (i == 1) {
            return ((i4 << 16) + (i10 << 8) + iA) | (-16777216);
        }
        if (i == 2) {
            return ((iA << 16) + (i10 << 8) + i6) | (-16777216);
        }
        if (i == 3) {
            return ((iA << 16) + (i4 << 8) + i10) | (-16777216);
        }
        if (i == 4) {
            return ((i6 << 16) + (iA << 8) + i10) | (-16777216);
        }
        if (i != 5) {
            return 0;
        }
        return ((i10 << 16) + (iA << 8) + i4) | (-16777216);
    }
    ...
    public String toString() {
        String strN = a.n(new StringBuilder(), this.mName, ':');
        switch (this.mType) {
            case 900:
                StringBuilder sbW = a.w(strN);
                sbW.append(this.mIntegerValue);
                return sbW.toString();
            case TypedValues.Custom.TYPE_FLOAT /* 901 */:
                StringBuilder sbW2 = a.w(strN);
                sbW2.append(this.mFloatValue);
                return sbW2.toString();
            case TypedValues.Custom.TYPE_COLOR /* 902 */:
                StringBuilder sbW3 = a.w(strN);
                sbW3.append(colorString(this.mIntegerValue));
                return sbW3.toString();
            case TypedValues.Custom.TYPE_STRING /* 903 */:
                StringBuilder sbW4 = a.w(strN);
                sbW4.append(this.mStringValue);
                return sbW4.toString();
            case TypedValues.Custom.TYPE_BOOLEAN /* 904 */:
                StringBuilder sbW5 = a.w(strN);
                sbW5.append(Boolean.valueOf(this.mBooleanValue));
                return sbW5.toString();
            case TypedValues.Custom.TYPE_DIMENSION /* 905 */:
                StringBuilder sbW6 = a.w(strN);
                sbW6.append(this.mFloatValue);
                return sbW6.toString();
            default:
                return s.i(strN, "????");
        }
    }
