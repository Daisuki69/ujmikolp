...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public void add(SolverVariable solverVariable, float f, boolean z4) {
        ...
        if (f <= (-f3) || f >= f3) {
            ...
            int i6 = -1;
            for (int i10 = 0; i != -1 && i10 < this.currentSize; i10++) {
                int i11 = this.mArrayIndices[i];
    ...
    public SolverVariable getVariable(int i) {
        int i4 = this.mHead;
        for (int i6 = 0; i4 != -1 && i6 < this.currentSize; i6++) {
            if (i6 == i) {
                return this.mCache.mIndexedVariables[this.mArrayIndices[i4]];
            }
    ...
    public String toString() {
        ...
        String string = "";
        for (int i4 = 0; i != -1 && i4 < this.currentSize; i4++) {
            StringBuilder sbW = a.w(s.n(a.w(s.i(string, " -> ")), " : ", this.mArrayValues[i]));
            sbW.append(this.mCache.mIndexedVariables[this.mArrayIndices[i]]);
            string = sbW.toString();
            i = this.mArrayNextIndices[i];
        }
        return string;
    ...
    public float use(ArrayRow arrayRow, boolean z4) {
        ...
        for (int i = 0; i < currentSize; i++) {
            ...
            add(variable, arrayRowVariables.get(variable) * f, z4);
        }
        return f;
    }
}
