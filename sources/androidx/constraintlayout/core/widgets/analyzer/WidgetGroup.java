...
public class WidgetGroup {
    ...
    private String getOrientationString() {
        ...
        return i == 0 ? "Horizontal" : i == 1 ? "Vertical" : i == 2 ? h.j : "Unknown";
    }
    ...
    private int solverMeasure(LinearSystem linearSystem, ArrayList<ConstraintWidget> arrayList, int i) {
        ...
        for (int i6 = 0; i6 < arrayList.size(); i6++) {
            this.results.add(new MeasureResult(arrayList.get(i6), linearSystem, i));
        }
        if (i == 0) {
    ...
    public String toString() {
        ...
        sb2.append(" [");
        String strO = s.o(sb2, "] <", this.id);
        for (ConstraintWidget constraintWidget : this.widgets) {
            StringBuilder sbV = s.v(strO, Global.BLANK);
