...
public abstract class WidgetRun implements Dependency {
    ...
    private void resolveDimension(int i, int i4) {
        int i6 = this.matchConstraintsType;
        if (i6 == 0) {
            this.dimension.resolve(getLimitedDimension(i4, i));
            return;
        }
        if (i6 == 1) {
            this.dimension.resolve(Math.min(getLimitedDimension(this.dimension.wrapValue, i), i4));
            return;
        }
        if (i6 == 2) {
    ...
    public final int getLimitedDimension(int i, int i4) {
        if (i4 == 0) {
            ConstraintWidget constraintWidget = this.widget;
    ...
    public boolean isCenterConnection() {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            if (this.start.targets.get(i4).run != this) {
                i++;
            }
        }
