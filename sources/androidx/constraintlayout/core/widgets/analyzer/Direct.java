...
public class Direct {
    ...
    private static void horizontalSolvingPass(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, boolean z4) {
        ...
        if (!(constraintWidget instanceof ConstraintWidgetContainer) && constraintWidget.isMeasureRequested()) {
            int i4 = i + 1;
            if (canMeasure(i4, constraintWidget)) {
        ...
        if (anchor.getDependents() != null && anchor.hasFinalValue()) {
            ...
            while (it.hasNext()) {
                ...
                int i6 = i + 1;
                boolean zCanMeasure = canMeasure(i6, constraintWidget2);
                ...
                boolean z9 = ((next == constraintWidget2.mLeft && (constraintAnchor4 = constraintWidget2.mRight.mTarget) != null && constraintAnchor4.hasFinalValue()) || (next == constraintWidget2.mRight && (constraintAnchor3 = constraintWidget2.mLeft.mTarget) != null && constraintAnchor3.hasFinalValue())) ? z5 : false;
                ...
                if (horizontalDimensionBehaviour2 != dimensionBehaviour2 || zCanMeasure2) {
                    if (!constraintWidget3.isMeasureRequested()) {
                        ...
                        if (next2 == constraintAnchor7 && constraintWidget3.mRight.mTarget == null) {
                            ...
                            horizontalSolvingPass(i10, constraintWidget3, measurer, z4);
                        } else {
                            ...
                            if (next2 == constraintAnchor8 && constraintAnchor7.mTarget == null) {
                                ...
                                solveHorizontalCenterConstraints(i10, measurer, constraintWidget3, z4);
                            }
                        }
                    }
                    ...
                    if (!constraintWidget3.isInHorizontalChain() && !constraintWidget3.isInVirtualLayout() && z11 && !constraintWidget3.isInHorizontalChain()) {
                        solveHorizontalMatchConstraint(i10, constraintWidget, measurer, constraintWidget3, z4);
                    }
                }
            }
        }
    ...
    private static void solveBarrier(int i, Barrier barrier, BasicMeasure.Measurer measurer, int i4, boolean z4) {
        if (barrier.allSolved()) {
            if (i4 == 0) {
                horizontalSolvingPass(i + 1, barrier, measurer, z4);
            } else {
    ...
    */
    ...
    private static void solveHorizontalCenterConstraints(int i, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget, boolean z4) {
        ...
        int i6 = ((int) (i4 > 0 ? (horizontalBiasPercent * i4) + 0.5f : horizontalBiasPercent * i4)) + finalValue;
        int i10 = i6 + width;
        if (finalValue > finalValue2) {
            i10 = i6 - width;
        }
        constraintWidget.setFinalHorizontal(i6, i10);
        horizontalSolvingPass(i + 1, constraintWidget, measurer, z4);
    }

    private static void solveHorizontalMatchConstraint(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget2, boolean z4) {
        ...
        if (finalValue >= margin) {
            ...
            horizontalSolvingPass(i + 1, constraintWidget2, measurer, z4);
        }
    }
    ...
    private static void solveVerticalCenterConstraints(int i, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget) {
        ...
        int i6 = (int) (i4 > 0 ? (verticalBiasPercent * i4) + 0.5f : verticalBiasPercent * i4);
        int i10 = finalValue + i6;
        int i11 = i10 + height;
        if (finalValue > finalValue2) {
            i10 = finalValue - i6;
            i11 = i10 - height;
    ...
    private static void verticalSolvingPass(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer) {
        ...
        if (anchor.getDependents() != null && anchor.hasFinalValue()) {
            ...
            while (it.hasNext()) {
                ...
                boolean z5 = ((next == constraintWidget2.mTop && (constraintAnchor4 = constraintWidget2.mBottom.mTarget) != null && constraintAnchor4.hasFinalValue()) || (next == constraintWidget2.mBottom && (constraintAnchor3 = constraintWidget2.mTop.mTarget) != null && constraintAnchor3.hasFinalValue())) ? z4 : false;
