...
public class ConstraintWidget {
    ...
    */
    ...
    private boolean isChainHead(int i) {
        ...
        return (constraintAnchor4 == null || constraintAnchor4.mTarget == constraintAnchor3 || (constraintAnchor2 = (constraintAnchor = constraintAnchorArr[i4 + 1]).mTarget) == null || constraintAnchor2.mTarget != constraintAnchor) ? false : true;
    }
    ...
    private void serializeAttribute(StringBuilder sb2, String str, float f, float f3) {
        if (f == f3) {
            return;
        }
        sb2.append(str);
    ...
    private void serializeDimensionRatio(StringBuilder sb2, String str, float f, int i) {
        if (f == 0.0f) {
            return;
        }
        sb2.append(str);
    ...
    private void serializeSize(StringBuilder sb2, String str, int i, int i4, int i6, int i10, int i11, int i12, float f, float f3) {
        sb2.append(str);
        sb2.append(" :  {\n");
        serializeAttribute(sb2, "size", i, Integer.MIN_VALUE);
        serializeAttribute(sb2, "min", i4, 0);
        serializeAttribute(sb2, "max", i6, Integer.MAX_VALUE);
        serializeAttribute(sb2, "matchMin", i11, 0);
        serializeAttribute(sb2, "matchDef", i12, 0);
        serializeAttribute(sb2, "matchPercent", i12, 1);
        sb2.append("},\n");
    }

    public void addChildrenToSolverByDependency(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, HashSet<ConstraintWidget> hashSet, int i, boolean z4) {
        if (z4) {
    ...
    */
    ...
    public boolean hasResolvedTargets(int i, int i4) {
        ConstraintAnchor constraintAnchor;
        ConstraintAnchor constraintAnchor2;
        if (i == 0) {
            ...
            if (constraintAnchor3 != null && constraintAnchor3.hasFinalValue() && (constraintAnchor2 = this.mRight.mTarget) != null && constraintAnchor2.hasFinalValue()) {
                return (this.mRight.mTarget.getFinalValue() - this.mRight.getMargin()) - (this.mLeft.getMargin() + this.mLeft.mTarget.getFinalValue()) >= i4;
            }
        } else {
            ...
            if (constraintAnchor4 != null && constraintAnchor4.hasFinalValue() && (constraintAnchor = this.mBottom.mTarget) != null && constraintAnchor.hasFinalValue()) {
                if ((this.mBottom.mTarget.getFinalValue() - this.mBottom.getMargin()) - (this.mTop.getMargin() + this.mTop.mTarget.getFinalValue()) >= i4) {
                    return true;
                }
            }
        }
    ...
    public void immediateConnect(ConstraintAnchor.Type type, ConstraintWidget constraintWidget, ConstraintAnchor.Type type2, int i, int i4) {
        getAnchor(type).connect(constraintWidget.getAnchor(type2), i, i4, true);
    }
    ...
    public void setDimension(int i, int i4) {
        this.mWidth = i;
  ...
  0x0086: PHI (r0v2 int) = (r0v1 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int) binds: [B:46:0x0086, B:36:0x007f, B:24:0x0051, B:26:0x0057, B:28:0x0063, B:30:0x0067] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public void setFinalBaseline(int i) {
        if (this.hasBaseline) {
            int i4 = i - this.mBaselineDistance;
    ...
    public void setFinalFrame(int i, int i4, int i6, int i10, int i11, int i12) {
        setFrame(i, i4, i6, i10);
    ...
    public void setFinalHorizontal(int i, int i4) {
        if (this.resolvedHorizontal) {
            return;
        }
    ...
    public void setFinalVertical(int i, int i4) {
        if (this.resolvedVertical) {
            return;
        }
        this.mTop.setFinalValue(i);
    ...
    public void setFrame(int i, int i4, int i6, int i10) {
        int i11;
        int i12;
        int i13 = i6 - i;
        int i14 = i10 - i4;
    ...
    public void setHorizontalDimension(int i, int i4) {
        this.mX = i;
        int i6 = i4 - i;
        this.mWidth = i6;
    ...
    public void setHorizontalMatchStyle(int i, int i4, int i6, float f) {
    ...
    public void setInBarrier(int i, boolean z4) {
        this.mIsInBarrier[i] = z4;
    }
    ...
    public void setLastMeasureSpec(int i, int i4) {
        this.mLastHorizontalMeasureSpec = i;
        this.mLastVerticalMeasureSpec = i4;
        setMeasureRequested(false);
    }

    public void setLength(int i, int i4) {
        if (i4 == 0) {
            setWidth(i);
        } else if (i4 == 1) {
            setHeight(i);
    ...
    public void setOrigin(int i, int i4) {
        this.mX = i;
        this.mY = i4;
    }
    ...
    public void setRelativePositioning(int i, int i4) {
        if (i4 == 0) {
            this.mRelX = i;
        } else if (i4 == 1) {
            this.mRelY = i;
    ...
    public void setVerticalDimension(int i, int i4) {
        this.mY = i;
        int i6 = i4 - i;
        this.mHeight = i6;
        int i10 = this.mMinHeight;
    ...
    public void setVerticalMatchStyle(int i, int i4, int i6, float f) {
    ...
    public void setupDimensionRatio(boolean z4, boolean z5, boolean z8, boolean z9) {
    ...
    public String toString() {
        ...
        sb2.append(this.mType != null ? s.p(new StringBuilder("type: "), this.mType, Global.BLANK) : "");
        sb2.append(this.mDebugName != null ? s.p(new StringBuilder("id: "), this.mDebugName, Global.BLANK) : "");
        sb2.append("(");
        sb2.append(this.mX);
        sb2.append(", ");
        sb2.append(this.mY);
        ...
        sb2.append(" x ");
        return s.o(sb2, ")", this.mHeight);
    }

    public void updateFromRuns(boolean z4, boolean z5) {
        int i;
        int i4;
        boolean zIsResolved = z4 & this.horizontalRun.isResolved();
        boolean zIsResolved2 = z5 & this.verticalRun.isResolved();
        ...
        int i13 = i12 - i10;
        if (i11 - i6 < 0 || i13 < 0 || i6 == Integer.MIN_VALUE || i6 == Integer.MAX_VALUE || i10 == Integer.MIN_VALUE || i10 == Integer.MAX_VALUE || i11 == Integer.MIN_VALUE || i11 == Integer.MAX_VALUE || i12 == Integer.MIN_VALUE || i12 == Integer.MAX_VALUE) {
            i11 = 0;
            i6 = 0;
            i12 = 0;
            i10 = 0;
        ...
        if (zIsResolved) {
            if (this.mListDimensionBehaviors[0] == DimensionBehaviour.FIXED && i14 < (i4 = this.mWidth)) {
                i14 = i4;
            }
            this.mWidth = i14;
            int i16 = this.mMinWidth;
        ...
        if (zIsResolved2) {
            if (this.mListDimensionBehaviors[1] == DimensionBehaviour.FIXED && i15 < (i = this.mHeight)) {
                i15 = i;
            }
            this.mHeight = i15;
    ...
    private void serializeAttribute(StringBuilder sb2, String str, int i, int i4) {
        if (i == i4) {
            return;
        }
        sb2.append(str);
    ...
    public void setFrame(int i, int i4, int i6) {
        if (i6 == 0) {
            setHorizontalDimension(i, i4);
        } else if (i6 == 1) {
            setVerticalDimension(i, i4);
        }
    }

    private void getSceneString(StringBuilder sb2, String str, int i, int i4, int i6, int i10, int i11, int i12, float f, float f3) {
        sb2.append(str);
        sb2.append(" :  {\n");
        serializeAttribute(sb2, "      size", i, 0);
        serializeAttribute(sb2, "      min", i4, 0);
        serializeAttribute(sb2, "      max", i6, Integer.MAX_VALUE);
        serializeAttribute(sb2, "      matchMin", i11, 0);
        serializeAttribute(sb2, "      matchDef", i12, 0);
    ...
    public ConstraintWidget(int i, int i4, int i6, int i10) {
        this.measured = false;
        this.run = new WidgetRun[2];
        this.horizontalRun = null;
        this.verticalRun = null;
    ...
    public ConstraintWidget(String str, int i, int i4, int i6, int i10) {
        this(i, i4, i6, i10);
        setDebugName(str);
    }

    public ConstraintWidget(int i, int i4) {
        this(0, 0, i, i4);
    }

    public ConstraintWidget(String str, int i, int i4) {
        this(i, i4);
        setDebugName(str);
    }
}
