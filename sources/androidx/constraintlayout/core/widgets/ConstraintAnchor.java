...
public class ConstraintAnchor {
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int i, int i4, boolean z4) {
    ...
    public boolean isValidConnection(ConstraintAnchor constraintAnchor) {
        ...
        switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type[type2.ordinal()]) {
            ...
            case 3:
                ...
                return constraintAnchor.getOwner() instanceof Guideline ? z4 || type == Type.CENTER_X : z4;
            case 4:
            case 5:
                boolean z5 = type == Type.TOP || type == Type.BOTTOM;
                return constraintAnchor.getOwner() instanceof Guideline ? z5 || type == Type.CENTER_Y : z5;
            case 6:
    ...
    public String toString() {
        return this.mOwner.getDebugName() + Global.COLON + this.mType.toString();
    }
