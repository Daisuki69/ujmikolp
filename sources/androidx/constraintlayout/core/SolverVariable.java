...
public class SolverVariable implements Comparable<SolverVariable> {
    ...
    public void setFinalValue(LinearSystem linearSystem, float f) {
        ...
        this.definitionId = -1;
        for (int i4 = 0; i4 < i; i4++) {
            this.mClientEquations[i4].updateFromFinalVariable(linearSystem, this, false);
        }
        this.mClientEquationsCount = 0;
    }
    ...
    public void setSynonym(LinearSystem linearSystem, SolverVariable solverVariable, float f) {
        ...
        this.definitionId = -1;
        for (int i4 = 0; i4 < i; i4++) {
            this.mClientEquations[i4].updateFromSynonymVariable(linearSystem, this, false);
        }
        this.mClientEquationsCount = 0;
    ...
    public String strengthsToString() {
        ...
        while (i < this.strengthVector.length) {
            ...
            sbW.append(this.strengthVector[i]);
            ...
            strI = i < fArr.length - 1 ? s.i(string, ", ") : s.i(string, "] ");
            i++;
        }
        if (z4) {
            strI = s.i(strI, " (-)");
        }
        return z5 ? s.i(strI, " (*)") : strI;
    }
    ...
    public final void updateReferencesWithNewDefinition(LinearSystem linearSystem, ArrayRow arrayRow) {
        int i = this.mClientEquationsCount;
        for (int i4 = 0; i4 < i; i4++) {
            this.mClientEquations[i4].updateFromRow(linearSystem, arrayRow, false);
        }
        this.mClientEquationsCount = 0;
    }
