...
public class Transition implements TypedValues {
    ...
    private int mDuration = YTAGReflectLiveCheckInterface.LightLiveCheckResult.INIT_ERROR;
    ...
    public static class KeyPosition {
        ...
        public KeyPosition(String str, int i, int i4, float f, float f3) {
            this.target = str;
            this.frame = i;
            this.type = i4;
            this.f7750x = f;
    ...
    public static class WidgetState {
        ...
        public void interpolate(int i, int i4, float f, Transition transition) {
            this.myParentHeight = i4;
            this.myParentWidth = i;
            this.motionControl.setup(i, i4, 1.0f, System.nanoTime());
            WidgetFrame.interpolate(i, i4, this.interpolated, this.start, this.end, transition, f);
    ...
    public void addCustomColor(int i, String str, String str2, int i4) {
        getWidgetState(str, null, i).getFrame(i).addCustomColor(str2, i4);
    }
    ...
    public void fillKeyPositions(WidgetFrame widgetFrame, float[] fArr, float[] fArr2, float[] fArr3) {
        ...
        for (int i4 = 0; i4 <= 100; i4++) {
            HashMap<String, KeyPosition> map = this.keyPositions.get(Integer.valueOf(i4));
            if (map != null && (keyPosition = map.get(widgetFrame.widget.stringId)) != null) {
                fArr[i] = keyPosition.f7750x;
                fArr2[i] = keyPosition.f7751y;
    ...
    public void interpolate(int i, int i4, float f) {
        ...
        while (it.hasNext()) {
            this.state.get(it.next()).interpolate(i, i4, f, this);
        }
    }
    ...
    public void addKeyPosition(String str, int i, int i4, float f, float f3) {
        ...
        getWidgetState(str, null, 0).setKeyPosition(typedBundle);
        KeyPosition keyPosition = new KeyPosition(str, i, i4, f, f3);
        HashMap<String, KeyPosition> map = this.keyPositions.get(Integer.valueOf(i));
        if (map == null) {
            map = new HashMap<>();
