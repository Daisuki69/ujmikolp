...
public class ArrayRow implements LinearSystem.Row {
    ...
    public interface ArrayRowVariables {
        void add(SolverVariable solverVariable, float f, boolean z4);
    ...
    public ArrayRow createRowCentering(SolverVariable solverVariable, SolverVariable solverVariable2, int i, float f, SolverVariable solverVariable3, SolverVariable solverVariable4, int i4) {
    ...
    public ArrayRow createRowEqualDimension(float f, float f3, float f7, SolverVariable solverVariable, int i, SolverVariable solverVariable2, int i4, SolverVariable solverVariable3, int i6, SolverVariable solverVariable4, int i10) {
        if (f3 == 0.0f || f == f7) {
            this.constantValue = ((-i) - i4) + i6 + i10;
            this.variables.put(solverVariable, 1.0f);
            this.variables.put(solverVariable2, -1.0f);
            this.variables.put(solverVariable4, 1.0f);
            this.variables.put(solverVariable3, -1.0f);
        ...
        float f10 = (f / f3) / (f7 / f3);
        this.constantValue = (i10 * f10) + (i6 * f10) + ((-i) - i4);
        this.variables.put(solverVariable, 1.0f);
        this.variables.put(solverVariable2, -1.0f);
    ...
    public ArrayRow createRowEqualMatchDimensions(float f, float f3, float f7, SolverVariable solverVariable, SolverVariable solverVariable2, SolverVariable solverVariable3, SolverVariable solverVariable4) {
        this.constantValue = 0.0f;
        if (f3 == 0.0f || f == f7) {
            this.variables.put(solverVariable, 1.0f);
            this.variables.put(solverVariable2, -1.0f);
    ...
    */
    public java.lang.String toReadableString() {
        ...
        L17:
            java.lang.String r1 = " = "
            java.lang.String r0 = We.s.i(r0, r1)
        ...
        L76:
            ...
            if (r1 != 0) goto L81
            java.lang.String r0 = We.s.i(r0, r6)
            goto L98
        L81:
    ...
    public void updateFromRow(LinearSystem linearSystem, ArrayRow arrayRow, boolean z4) {
        float fUse = this.variables.use(arrayRow, z4);
    ...
    public void updateFromSynonymVariable(LinearSystem linearSystem, SolverVariable solverVariable, boolean z4) {
        ...
        this.variables.add(linearSystem.mCache.mIndexedVariables[solverVariable.synonym], f, z4);
        if (LinearSystem.SIMPLIFY_SYNONYMS && this.variables.getCurrentSize() == 0) {
            this.isSimpleDefinition = true;
            linearSystem.hasSimpleDefinition = true;
        }
        ...
        while (!z4) {
            ...
            if (size > 0) {
                for (int i4 = 0; i4 < size; i4++) {
                    SolverVariable solverVariable = this.variablesToUpdate.get(i4);
