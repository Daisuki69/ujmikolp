...
public class MockView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mDrawDiagonals) {
            ...
            float f3 = height;
            canvas2 = canvas;
            canvas2.drawLine(0.0f, 0.0f, f, f3, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, f3, f, 0.0f, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, 0.0f, f, 0.0f, this.mPaintDiagonals);
            canvas2.drawLine(f, 0.0f, f, f3, this.mPaintDiagonals);
            canvas2.drawLine(f, f3, 0.0f, f3, this.mPaintDiagonals);
        ...
        int i = rect.left;
        int i4 = this.mMargin;
        rect.set(i - i4, rect.top - i4, rect.right + i4, rect.bottom + i4);
