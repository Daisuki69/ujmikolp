...
public class EmojiCompat {
    ...
    public static class CompatInternal {
        ...
        public CharSequence process(@NonNull CharSequence charSequence, @IntRange(from = 0) int i, @IntRange(from = 0) int i4, @IntRange(from = 0) int i6, boolean z4) {
            return charSequence;
        }
    ...
    public static final class CompatInternal19 extends CompatInternal {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public CharSequence process(@NonNull CharSequence charSequence, int i, int i4, int i6, boolean z4) {
            return this.mProcessor.process(charSequence, i, i4, i6, z4);
        }
    ...
    public interface GlyphChecker {
        boolean hasGlyph(@NonNull CharSequence charSequence, @IntRange(from = 0) int i, @IntRange(from = 0) int i4, @IntRange(from = 0) int i6);
    }
    ...
    public static class ListenerDispatcher implements Runnable {
        ...
        public ListenerDispatcher(@NonNull Collection<InitCallback> collection, int i, @Nullable Throwable th2) {
    ...
    public static boolean handleDeleteSurroundingText(@NonNull InputConnection inputConnection, @NonNull Editable editable, @IntRange(from = 0) int i, @IntRange(from = 0) int i4, boolean z4) {
        return EmojiProcessor.handleDeleteSurroundingText(inputConnection, editable, i, i4, z4);
    }
    ...
    @Nullable
    @CheckResult
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = 0) int i, @IntRange(from = 0) int i4) {
        return process(charSequence, i, i4, Integer.MAX_VALUE);
    }
    ...
    @Nullable
    @CheckResult
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = 0) int i, @IntRange(from = 0) int i4, @IntRange(from = 0) int i6) {
        return process(charSequence, i, i4, i6, 0);
    }

    @Nullable
    @CheckResult
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = 0) int i, @IntRange(from = 0) int i4, @IntRange(from = 0) int i6, int i10) {
        boolean z4;
        Preconditions.checkState(isInitialized(), "Not initialized yet");
        ...
        Preconditions.checkArgument(i <= i4, "start should be <= than end");
        ...
        if (i10 != 1) {
            z4 = i10 != 2 ? this.mReplaceAll : false;
        } else {
            z4 = true;
        }
        return this.mHelper.process(charSequence, i, i4, i6, z4);
    }
