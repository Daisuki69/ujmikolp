...
public abstract class EmojiSpan extends ReplacementSpan {
    ...
    public int getSize(@NonNull Paint paint, @SuppressLint({"UnknownNullness"}) CharSequence charSequence, int i, int i4, @Nullable Paint.FontMetricsInt fontMetricsInt) {
