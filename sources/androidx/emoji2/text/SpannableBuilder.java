...
public final class SpannableBuilder extends SpannableStringBuilder {
    ...
    public static class WatcherWrapper implements TextWatcher, SpanWatcher {
        ...
        public void beforeTextChanged(CharSequence charSequence, int i, int i4, int i6) {
            ((TextWatcher) this.mObject).beforeTextChanged(charSequence, i, i4, i6);
        }
        ...
        public void onSpanAdded(Spannable spannable, Object obj, int i, int i4) {
            if (this.mBlockCalls.get() <= 0 || !isEmojiSpan(obj)) {
                ((SpanWatcher) this.mObject).onSpanAdded(spannable, obj, i, i4);
            }
        }
  ...
  0x001e: PHI (r11v1 int) = (r11v0 int), (r11v3 int) binds: [B:8:0x0013, B:12:0x0019] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        */
        ...
        @Override // android.text.SpanWatcher
        public void onSpanRemoved(Spannable spannable, Object obj, int i, int i4) {
            if (this.mBlockCalls.get() <= 0 || !isEmojiSpan(obj)) {
                ((SpanWatcher) this.mObject).onSpanRemoved(spannable, obj, i, i4);
            }
        }

        @Override // android.text.TextWatcher
        public void onTextChanged(CharSequence charSequence, int i, int i4, int i6) {
            ((TextWatcher) this.mObject).onTextChanged(charSequence, i, i4, i6);
        }
    ...
    public <T> T[] getSpans(int i, int i4, @NonNull Class<T> cls) {
        if (!isWatcher((Class<?>) cls)) {
            return (T[]) super.getSpans(i, i4, cls);
        }
        WatcherWrapper[] watcherWrapperArr = (WatcherWrapper[]) super.getSpans(i, i4, WatcherWrapper.class);
    ...
    @Override // android.text.SpannableStringBuilder, android.text.Spanned
    public int nextSpanTransition(int i, int i4, @Nullable Class cls) {
    ...
    @Override // android.text.SpannableStringBuilder, android.text.Spannable
    public void setSpan(@Nullable Object obj, int i, int i4, int i6) {
        if (isWatcher(obj)) {
    ...
    public CharSequence subSequence(int i, int i4) {
        return new SpannableBuilder(this.mWatcherClass, this, i, i4);
    }
    ...
    @SuppressLint({"UnknownNullness"})
    public SpannableStringBuilder delete(int i, int i4) {
        super.delete(i, i4);
        return this;
    }
    ...
    @Override // android.text.SpannableStringBuilder, android.text.Editable
    @SuppressLint({"UnknownNullness"})
    public SpannableStringBuilder replace(int i, int i4, CharSequence charSequence) {
        blockWatchers();
    ...
    @Override // android.text.SpannableStringBuilder, android.text.Editable
    @SuppressLint({"UnknownNullness"})
    public SpannableStringBuilder insert(int i, CharSequence charSequence, int i4, int i6) {
    ...
    @Override // android.text.SpannableStringBuilder, android.text.Editable
    @SuppressLint({"UnknownNullness"})
    public SpannableStringBuilder replace(int i, int i4, CharSequence charSequence, int i6, int i10) {
        blockWatchers();
        super.replace(i, i4, charSequence, i6, i10);
        unblockwatchers();
        return this;
    }
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public SpannableBuilder(@NonNull Class<?> cls, @NonNull CharSequence charSequence, int i, int i4) {
        super(charSequence, i, i4);
        this.mWatchers = new ArrayList();
        Preconditions.checkNotNull(cls, "watcherClass cannot be null");
        this.mWatcherClass = cls;
    }
    ...
    @Override // android.text.SpannableStringBuilder, android.text.Editable, java.lang.Appendable
    @NonNull
    public SpannableStringBuilder append(@SuppressLint({"UnknownNullness"}) CharSequence charSequence, int i, int i4) {
