...
class UnprecomputeTextOnModificationSpannable implements Spannable {
    ...
    public static class PrecomputedTextDetector_28 extends PrecomputedTextDetector {
        ...
        public boolean isPrecomputedText(CharSequence charSequence) {
            return androidx.core.view.accessibility.a.y(charSequence) || (charSequence instanceof PrecomputedTextCompat);
        }
    }
    ...
    public <T> T[] getSpans(int i, int i4, Class<T> cls) {
        return (T[]) this.mDelegate.getSpans(i, i4, cls);
    }
    ...
    public int nextSpanTransition(int i, int i4, Class cls) {
        return this.mDelegate.nextSpanTransition(i, i4, cls);
    }
    ...
    public void setSpan(Object obj, int i, int i4, int i6) {
        ensureSafeWrites();
        this.mDelegate.setSpan(obj, i, i4, i6);
    }

    @Override // java.lang.CharSequence
    @NonNull
    public CharSequence subSequence(int i, int i4) {
        return this.mDelegate.subSequence(i, i4);
    }
