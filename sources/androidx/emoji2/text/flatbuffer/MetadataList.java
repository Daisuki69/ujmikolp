...
public final class MetadataList extends Table {
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataList get(MetadataList metadataList, int i) {
            return metadataList.__assign(Table.__indirect(__element(i), this.f7838bb), this.f7838bb);
        }
    }
    ...
    public static int createMetadataList(FlatBufferBuilder flatBufferBuilder, int i, int i4, int i6) {
    ...
    public MetadataItem list(MetadataItem metadataItem, int i) {
        ...
        return metadataItem.__assign(__indirect((i * 4) + __vector(i__offset)), this.f7844bb);
    }

    public MetadataItem.Vector listVector(MetadataItem.Vector vector) {
        int i__offset = __offset(6);
        if (i__offset != 0) {
            return vector.__assign(__vector(i__offset), 4, this.f7844bb);
        }
        return null;
    }
}
