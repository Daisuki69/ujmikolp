...
final class EmojiTextWatcher implements TextWatcher {
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i4, int i6) {
        if (this.mEditText.isInEditMode() || shouldSkipForDisabledOrNotConfigured() || i4 > i6 || !(charSequence instanceof Spannable)) {
            return;
        }
        int loadState = EmojiCompat.get().getLoadState();
        if (loadState != 0) {
            if (loadState == 1) {
                EmojiCompat.get().process((Spannable) charSequence, i, i + i6, this.mMaxEmojiCount, this.mEmojiReplaceStrategy);
                return;
            } else if (loadState != 3) {
                return;
            }
