...
final class EmojiInputFilter implements InputFilter {
    ...
    public static void updateSelection(Spannable spannable, int i, int i4) {
        if (i >= 0 && i4 >= 0) {
            Selection.setSelection(spannable, i, i4);
        } else if (i >= 0) {
    ...
    public CharSequence filter(CharSequence charSequence, int i, int i4, Spanned spanned, int i6, int i10) {
        ...
        if (loadState != 0) {
            if (loadState == 1) {
                if ((i10 == 0 && i6 == 0 && spanned.length() == 0 && charSequence == this.mTextView.getText()) || charSequence == null) {
                    return charSequence;
                }
