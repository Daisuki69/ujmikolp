...
class CardViewBaseImpl implements CardViewImpl {
    ...
    private RoundRectDrawableWithShadow createBackground(Context context, ColorStateList colorStateList, float f, float f3, float f7) {
        return new RoundRectDrawableWithShadow(context.getResources(), colorStateList, f, f3, f7);
    }
    ...
    public void initialize(CardViewDelegate cardViewDelegate, Context context, ColorStateList colorStateList, float f, float f3, float f7) {
        RoundRectDrawableWithShadow roundRectDrawableWithShadowCreateBackground = createBackground(context, colorStateList, f, f3, f7);
