...
public class CardView extends FrameLayout {
    ...
    public void onMeasure(int i, int i4) {
        ...
        if (mode2 == Integer.MIN_VALUE || mode2 == 1073741824) {
            i4 = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil(r0.getMinHeight(this.mCardViewDelegate)), View.MeasureSpec.getSize(i4)), mode2);
        }
        super.onMeasure(i, i4);
    }
    ...
    public void setContentPadding(@Px int i, @Px int i4, @Px int i6, @Px int i10) {
        this.mContentPadding.set(i, i4, i6, i10);
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        CardViewDelegate cardViewDelegate = new CardViewDelegate() { // from class: androidx.cardview.widget.CardView.1
            ...
            @Override // androidx.cardview.widget.CardViewDelegate
            public void setMinWidthHeightInternal(int i4, int i6) {
            ...
            @Override // androidx.cardview.widget.CardViewDelegate
            public void setShadowPadding(int i4, int i6, int i10, int i11) {
                CardView.this.mShadowBounds.set(i4, i6, i10, i11);
                CardView cardView = CardView.this;
                Rect rect2 = cardView.mContentPadding;
                CardView.super.setPadding(i4 + rect2.left, i6 + rect2.top, i10 + rect2.right, i11 + rect2.bottom);
            }
        };
