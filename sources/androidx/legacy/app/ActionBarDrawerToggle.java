...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, @DrawableRes int i, @StringRes int i4, @StringRes int i6) {
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, boolean z4, @DrawableRes int i, @StringRes int i4, @StringRes int i6) {
