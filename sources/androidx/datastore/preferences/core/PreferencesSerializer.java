...
public final class PreferencesSerializer implements OkioSerializer<Preferences> {
    ...
    public Object readFrom(BufferedSource bufferedSource, InterfaceC1526a<? super Preferences> interfaceC1526a) throws IOException {
        PreferencesProto.PreferenceMap from = PreferencesMapCompat.Companion.readFrom(bufferedSource.inputStream());
    ...
    @Override // androidx.datastore.core.okio.OkioSerializer
    public /* bridge */ /* synthetic */ Object writeTo(Preferences preferences, BufferedSink bufferedSink, InterfaceC1526a interfaceC1526a) {
        return writeTo2(preferences, bufferedSink, (InterfaceC1526a<? super Unit>) interfaceC1526a);
    }
    ...
    public Object writeTo2(Preferences preferences, BufferedSink bufferedSink, InterfaceC1526a<? super Unit> interfaceC1526a) throws IOException {
