...
public final class Internal {
    ...
    public static class MapAdapter<K, V, RealValue> extends AbstractMap<K, V> {
        ...
        public class EntryAdapter implements Map.Entry<K, V> {
            ...
            public V setValue(V v7) {
                RealValue value = this.realEntry.setValue((RealValue) MapAdapter.this.valueConverter.doBackward(v7));
                if (value == null) {
                    return null;
                }
        ...
        public static <T extends EnumLite> Converter<Integer, T> newEnumConverter(final EnumLiteMap<T> enumLiteMap, final T t5) {
            return (Converter<Integer, T>) new Converter<Integer, T>() { // from class: androidx.datastore.preferences.protobuf.Internal.MapAdapter.1
                ...
                public EnumLite doForward(Integer num) {
                    ...
                    return enumLiteFindValueByNumber == null ? t5 : enumLiteFindValueByNumber;
                }
            };
        }
        ...
        public V put(K k8, V v7) {
            RealValue realvaluePut = this.realMap.put(k8, this.valueConverter.doBackward(v7));
    ...
    public static <T extends MessageLite> T getDefaultInstance(Class<T> cls) {
        try {
            ...
            throw new RuntimeException(androidx.camera.core.impl.a.g(cls, "Failed to get default instance for "), e);
        }
    }
    ...
    public static int partialHash(int i, byte[] bArr, int i4, int i6) {
    ...
    public static int hashCode(byte[] bArr, int i, int i4) {
        int iPartialHash = partialHash(i4, bArr, i, i4);
        if (iPartialHash == 0) {
            return 1;
        }
        return iPartialHash;
