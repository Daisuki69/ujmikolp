...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        public final void bufferTag(int i, int i4) {
            bufferUInt32NoTag(WireFormat.makeTag(i, i4));
        }
        ...
        public final void bufferUInt32NoTag(int i) {
            ...
            while ((i & WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT) != 0) {
                ...
                this.position = i10 + 1;
                UnsafeUtil.putByte(bArr3, i10, (byte) ((i | 128) & 255));
                i >>>= 7;
            }
        ...
        public final void bufferUInt64NoTag(long j) {
            ...
            while ((j & (-128)) != 0) {
                ...
                int i6 = this.position;
                this.position = i6 + 1;
                UnsafeUtil.putByte(bArr3, i6, (byte) ((((int) j) | 128) & 255));
                j >>>= 7;
            }
            byte[] bArr4 = this.buffer;
            int i10 = this.position;
    ...
    public static class ArrayEncoder extends CodedOutputStream {
        ...
        public ArrayEncoder(byte[] bArr, int i, int i4) {
            super();
            if (bArr == null) {
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public final void writeBool(int i, boolean z4) throws IOException {
            writeTag(i, 0);
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public final void writeByteArrayNoTag(byte[] bArr, int i, int i4) throws IOException {
            writeUInt32NoTag(i4);
            write(bArr, i, i4);
        }
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public final void writeFixed32(int i, int i4) throws IOException {
            writeTag(i, 5);
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public final void writeInt32(int i, int i4) throws IOException {
            writeTag(i, 0);
            writeInt32NoTag(i4);
        }
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream, androidx.datastore.preferences.protobuf.ByteOutput
        public final void writeLazy(byte[] bArr, int i, int i4) throws IOException {
            write(bArr, i, i4);
        }
        ...
        public final void writeStringNoTag(String str) throws IOException {
            ...
            try {
                ...
                this.position = i4;
                int iEncode = Utf8.encode(str, this.buffer, i4, spaceLeft());
                this.position = i;
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public final void writeTag(int i, int i4) throws IOException {
            writeUInt32NoTag(WireFormat.makeTag(i, i4));
        }

        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public final void writeUInt32(int i, int i4) throws IOException {
            writeTag(i, 0);
            writeUInt32NoTag(i4);
        }
        ...
        public final void writeUInt64NoTag(long j) throws IOException {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS && spaceLeft() >= 10) {
                ...
                int i4 = this.position;
                this.position = 1 + i4;
                UnsafeUtil.putByte(bArr2, i4, (byte) j);
                return;
            }
            while ((j & (-128)) != 0) {
                try {
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public final void writeByteArray(int i, byte[] bArr, int i4, int i6) throws IOException {
            writeTag(i, 2);
        ...
        public final void write(byte[] bArr, int i, int i4) throws IOException {
            try {
                ...
                throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), Integer.valueOf(i4)), e);
            }
        }
    ...
    public static final class ByteOutputEncoder extends AbstractBufferedEncoder {
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public void writeByteArrayNoTag(byte[] bArr, int i, int i4) throws IOException {
            writeUInt32NoTag(i4);
            write(bArr, i, i4);
        }
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream, androidx.datastore.preferences.protobuf.ByteOutput
        public void writeLazy(byte[] bArr, int i, int i4) throws IOException {
            flush();
            this.out.writeLazy(bArr, i, i4);
        ...
        public void writeStringNoTag(String str) throws IOException {
            ...
            try {
                ...
                int i10 = i6 + iComputeUInt32SizeNoTag2;
                this.position = i10;
                int iEncode2 = Utf8.encode(str, this.buffer, i10, this.limit - i10);
                this.position = i6;
                int i11 = (iEncode2 - i6) - iComputeUInt32SizeNoTag2;
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public void writeByteArray(int i, byte[] bArr, int i4, int i6) throws IOException {
            writeTag(i, 2);
            writeByteArrayNoTag(bArr, i4, i6);
        }
    ...
    public static class OutOfSpaceException extends IOException {
        ...
        public OutOfSpaceException(String str) {
            super(AbstractC1414e.h("CodedOutputStream was writing to a flat byte array and ran out of space.: ", str));
        }
        ...
        public OutOfSpaceException(String str, Throwable th2) {
            super(AbstractC1414e.h("CodedOutputStream was writing to a flat byte array and ran out of space.: ", str), th2);
        }
    }
    ...
    public static final class OutputStreamEncoder extends AbstractBufferedEncoder {
            ...
            try {
                ...
                try {
                    if (iComputeUInt32SizeNoTag2 == iComputeUInt32SizeNoTag) {
                        ...
                        int iEncode2 = Utf8.encode(str, this.buffer, i10, this.limit - i10);
                        this.position = i6;
                        iEncodedLength = (iEncode2 - i6) - iComputeUInt32SizeNoTag2;
                        bufferUInt32NoTag(iEncodedLength);
                        this.position = iEncode2;
                    } else {
        ...
        public void write(byte[] bArr, int i, int i4) throws IOException {
            ...
            int i10 = this.position;
            if (i6 - i10 >= i4) {
                System.arraycopy(bArr, i, this.buffer, i10, i4);
                this.position += i4;
                this.totalBytesWritten += i4;
                return;
            }
        ...
        public void write(ByteBuffer byteBuffer) throws IOException {
            ...
            int i4 = this.position;
            if (i - i4 >= iRemaining) {
                byteBuffer.get(this.buffer, i4, iRemaining);
                this.position += iRemaining;
                this.totalBytesWritten += iRemaining;
                return;
            }
            int i6 = i - i4;
            byteBuffer.get(this.buffer, i4, i6);
        ...
        public void writeUInt32NoTag(int i) throws IOException {
            ...
            while (true) {
                ...
                if ((i & WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT) == 0) {
                    ...
                    this.position = j7 + 1;
                    UnsafeUtil.putByte(j7, (byte) ((i | 128) & 255));
                    i >>>= 7;
                }
            }
        }
        ...
        public void writeUInt64NoTag(long j) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((j & (-128)) != 0) {
                    long j6 = this.position;
                    this.position = j6 + 1;
                    UnsafeUtil.putByte(j6, (byte) ((((int) j) | 128) & 255));
                    j >>>= 7;
                }
                long j7 = this.position;
                this.position = 1 + j7;
            ...
            while (true) {
                ...
                if ((j & (-128)) == 0) {
                    ...
                    this.position = j9 + 1;
                    UnsafeUtil.putByte(j9, (byte) ((((int) j) | 128) & 255));
                    j >>>= 7;
                }
            }
        }
    ...
    public static int computeBoolSize(int i, boolean z4) {
        return computeBoolSizeNoTag(z4) + computeTagSize(i);
    }
    ...
    public static int computeFixed32Size(int i, int i4) {
        return computeFixed32SizeNoTag(i4) + computeTagSize(i);
    }
    ...
    public static int computeSFixed32Size(int i, int i4) {
        return computeSFixed32SizeNoTag(i4) + computeTagSize(i);
    }
    ...
    public static int computeSInt32Size(int i, int i4) {
        return computeSInt32SizeNoTag(i4) + computeTagSize(i);
    }
    ...
    public static int computeUInt32Size(int i, int i4) {
        return computeUInt32SizeNoTag(i4) + computeTagSize(i);
    }
    ...
    public abstract void writeBool(int i, boolean z4) throws IOException;
    ...
    public abstract void writeByteArray(int i, byte[] bArr, int i4, int i6) throws IOException;

    public final void writeByteArrayNoTag(byte[] bArr) throws IOException {
        writeByteArrayNoTag(bArr, 0, bArr.length);
    }

    public abstract void writeByteArrayNoTag(byte[] bArr, int i, int i4) throws IOException;
    ...
    public abstract void writeFixed32(int i, int i4) throws IOException;
    ...
    public abstract void writeInt32(int i, int i4) throws IOException;
    ...
    @Override // androidx.datastore.preferences.protobuf.ByteOutput
    public abstract void writeLazy(byte[] bArr, int i, int i4) throws IOException;
    ...
    public final void writeSInt32(int i, int i4) throws IOException {
        writeUInt32(i, encodeZigZag32(i4));
    }
    ...
    public abstract void writeTag(int i, int i4) throws IOException;

    public abstract void writeUInt32(int i, int i4) throws IOException;
    ...
    public final void writeRawBytes(byte[] bArr, int i, int i4) throws IOException {
        write(bArr, i, i4);
    }
    ...
    public static CodedOutputStream newInstance(byte[] bArr, int i, int i4) {
        return new ArrayEncoder(bArr, i, i4);
    }
