...
interface Reader {
    ...
    <T> void mergeGroupField(T t5, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    <T> void mergeMessageField(T t5, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException;
