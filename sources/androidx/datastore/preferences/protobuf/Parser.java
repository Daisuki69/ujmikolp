...
public interface Parser<MessageType> {
    ...
    MessageType parseFrom(byte[] bArr, int i, int i4) throws InvalidProtocolBufferException;

    MessageType parseFrom(byte[] bArr, int i, int i4, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException;
    ...
    MessageType parsePartialFrom(byte[] bArr, int i, int i4) throws InvalidProtocolBufferException;

    MessageType parsePartialFrom(byte[] bArr, int i, int i4, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException;
