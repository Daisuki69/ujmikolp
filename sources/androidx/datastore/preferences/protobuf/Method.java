...
public final class Method extends GeneratedMessageLite<Method, Builder> implements MethodOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Method, Builder> implements MethodOrBuilder {
        ...
        public Builder setRequestStreaming(boolean z4) {
            copyOnWrite();
            ((Method) this.instance).setRequestStreaming(z4);
            return this;
        }
        ...
        public Builder setResponseStreaming(boolean z4) {
            copyOnWrite();
            ((Method) this.instance).setResponseStreaming(z4);
            return this;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setRequestStreaming(boolean z4) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setResponseStreaming(boolean z4) {
