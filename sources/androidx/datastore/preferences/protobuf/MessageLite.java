...
public interface MessageLite extends MessageLiteOrBuilder {
    ...
    public interface Builder extends MessageLiteOrBuilder, Cloneable {
        ...
        @CanIgnoreReturnValue
        Builder mergeFrom(byte[] bArr, int i, int i4) throws InvalidProtocolBufferException;

        @CanIgnoreReturnValue
        Builder mergeFrom(byte[] bArr, int i, int i4, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException;
