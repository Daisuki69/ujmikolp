...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        private FieldSet<T> buildImpl(boolean z4) {
            ...
            if (this.hasNestedBuilders) {
                ...
                replaceBuilders(smallSortedMapCloneAllFieldsMap, z4);
            }
        ...
        private void mergeFromField(Map.Entry<T, Object> entry) {
            ...
            boolean z4 = value instanceof LazyField;
            if (key.isRepeated()) {
                if (z4) {
        ...
        private static Object replaceBuilder(Object obj, boolean z4) {
            ...
            return z4 ? builder.buildPartial() : builder.build();
        }
        ...
        private static <T extends FieldDescriptorLite<T>> void replaceBuilders(SmallSortedMap<T, Object> smallSortedMap, boolean z4) {
            ...
            for (int i = 0; i < numArrayEntries; i++) {
                replaceBuilders(smallSortedMap.getArrayEntryAt(i), z4);
            }
            Iterator it = smallSortedMap.getOverflowEntries().iterator();
            while (it.hasNext()) {
                replaceBuilders((Map.Entry) it.next(), z4);
            }
        }
        ...
        public Object getFieldAllowBuilders(T t5) {
            Object obj = this.fields.get(t5);
            return obj instanceof LazyField ? ((LazyField) obj).getValue() : obj;
        }

        public Object getRepeatedField(T t5, int i) {
            if (this.hasNestedBuilders) {
                ensureIsMutable();
            }
            return replaceBuilder(getRepeatedFieldAllowBuilders(t5, i), true);
        }

        public Object getRepeatedFieldAllowBuilders(T t5, int i) {
            if (!t5.isRepeated()) {
        ...
        public boolean hasField(T t5) {
            ...
            return this.fields.get(t5) != null;
        }
        ...
        public void setRepeatedField(T t5, int i, Object obj) {
            ensureIsMutable();
            if (!t5.isRepeated()) {
                throw new IllegalArgumentException("getRepeatedField() can only be called on repeated fields.");
            }
        ...
        private static <T extends FieldDescriptorLite<T>> void replaceBuilders(Map.Entry<T, Object> entry, boolean z4) {
            entry.setValue(replaceBuilders(entry.getKey(), entry.getValue(), z4));
        }

        private static <T extends FieldDescriptorLite<T>> Object replaceBuilders(T t5, Object obj, boolean z4) {
            ...
            if (t5.isRepeated()) {
                if (obj instanceof List) {
                    ...
                    for (int i = 0; i < arrayList.size(); i++) {
                        Object obj2 = arrayList.get(i);
                        Object objReplaceBuilder = replaceBuilder(obj2, z4);
    ...
    public static <T extends FieldDescriptorLite<T>> SmallSortedMap<T, Object> cloneAllFieldsMap(SmallSortedMap<T, Object> smallSortedMap, boolean z4, boolean z5) {
        SmallSortedMap<T, Object> smallSortedMapNewFieldMap = SmallSortedMap.newFieldMap();
        int numArrayEntries = smallSortedMap.getNumArrayEntries();
        for (int i = 0; i < numArrayEntries; i++) {
            cloneFieldEntry(smallSortedMapNewFieldMap, smallSortedMap.getArrayEntryAt(i), z4, z5);
        }
        Iterator it = smallSortedMap.getOverflowEntries().iterator();
        while (it.hasNext()) {
            cloneFieldEntry(smallSortedMapNewFieldMap, (Map.Entry) it.next(), z4, z5);
        }
        return smallSortedMapNewFieldMap;
    }

    private static <T extends FieldDescriptorLite<T>> void cloneFieldEntry(Map<T, Object> map, Map.Entry<T, Object> entry, boolean z4, boolean z5) {
        T key = entry.getKey();
        Object value = entry.getValue();
        if (z5 && (value instanceof LazyField)) {
    ...
    public static Object readPrimitiveField(CodedInputStream codedInputStream, WireFormat.FieldType fieldType, boolean z4) throws IOException {
        return z4 ? WireFormat.readPrimitiveField(codedInputStream, fieldType, WireFormat.Utf8Validation.STRICT) : WireFormat.readPrimitiveField(codedInputStream, fieldType, WireFormat.Utf8Validation.LOOSE);
    }
    ...
    public static void writeField(FieldDescriptorLite<?> fieldDescriptorLite, Object obj, CodedOutputStream codedOutputStream) throws IOException {
        ...
        if (!fieldDescriptorLite.isPacked()) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                iComputeElementSizeNoTag += computeElementSizeNoTag(liteType, list.get(i4));
            }
