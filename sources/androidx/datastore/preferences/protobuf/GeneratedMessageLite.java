...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
    ...
    public static abstract class Builder<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite.Builder<MessageType, BuilderType> {
        ...
        public BuilderType mergeFrom(byte[] bArr, int i, int i4, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            copyOnWrite();
            try {
                Protobuf.getInstance().schemaFor(this.instance).mergeFrom(this.instance, bArr, i, i + i4, new ArrayDecoders.Registers(extensionRegistryLite));
                return this;
        ...
        @Override // androidx.datastore.preferences.protobuf.AbstractMessageLite.Builder, androidx.datastore.preferences.protobuf.MessageLite.Builder
        public BuilderType mergeFrom(byte[] bArr, int i, int i4) throws InvalidProtocolBufferException {
            return (BuilderType) mergeFrom(bArr, i, i4, ExtensionRegistryLite.getEmptyRegistry());
        }
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        private FieldSet<ExtensionDescriptor> ensureExtensionsAreMutable() {
            ...
            FieldSet fieldSetClone = fieldSet.m87clone();
        ...
        public void copyOnWriteInternal() {
            ...
            if (((ExtendableMessage) this.instance).extensions != FieldSet.emptySet()) {
                ...
                ((ExtendableMessage) messagetype).extensions = ((ExtendableMessage) messagetype).extensions.m87clone();
            }
        }
    ...
    public static final class ExtensionDescriptor implements FieldSet.FieldDescriptorLite<ExtensionDescriptor> {
        ...
        public ExtensionDescriptor(Internal.EnumLiteMap<?> enumLiteMap, int i, WireFormat.FieldType fieldType, boolean z4, boolean z5) {
    ...
    public static <ContainingType extends MessageLite, Type> GeneratedExtension<ContainingType, Type> newRepeatedGeneratedExtension(ContainingType containingtype, MessageLite messageLite, Internal.EnumLiteMap<?> enumLiteMap, int i, WireFormat.FieldType fieldType, boolean z4, Class cls) {
        return new GeneratedExtension<>(containingtype, Collections.EMPTY_LIST, messageLite, new ExtensionDescriptor(enumLiteMap, i, fieldType, true, z4), cls);
    }
    ...
    public static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T t5, CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        ...
        try {
            ...
            throw e7.asInvalidProtocolBufferException().setUnfinishedMessage(t10);
        } catch (IOException e10) {
    ...
    public int getSerializedSize(Schema schema) {
        if (isMutable()) {
            ...
            throw new IllegalStateException(s.f(iComputeSerializedSize, "serialized size must be non-negative, was "));
        }
    ...
    public void setMemoizedSerializedSize(int i) {
        if (i < 0) {
            throw new IllegalStateException(s.f(i, "serialized size must be non-negative, was "));
        }
    ...
    public static final <T extends GeneratedMessageLite<T, ?>> boolean isInitialized(T t5, boolean z4) {
        ...
        boolean zIsInitialized = Protobuf.getInstance().schemaFor(t5).isInitialized(t5);
        if (z4) {
    ...
    public static class DefaultInstanceBasedParser<T extends GeneratedMessageLite<T, ?>> extends AbstractParser<T> {
        ...
        public T parsePartialFrom(byte[] bArr, int i, int i4, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            return (T) GeneratedMessageLite.parsePartialFrom(this.defaultInstance, bArr, i, i4, extensionRegistryLite);
        }
    }
    ...
    public static abstract class ExtendableMessage<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends GeneratedMessageLite<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        public class ExtensionWriter {
            ...
            public /* synthetic */ ExtensionWriter(ExtendableMessage extendableMessage, boolean z4, AnonymousClass1 anonymousClass1) {
                this(z4);
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T t5, byte[] bArr, int i, int i4, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        if (i4 == 0) {
            return t5;
        }
        T t10 = (T) t5.newMutableInstance();
        try {
            Schema schemaSchemaFor = Protobuf.getInstance().schemaFor(t10);
            schemaSchemaFor.mergeFrom(t10, bArr, i, i + i4, new ArrayDecoders.Registers(extensionRegistryLite));
            schemaSchemaFor.makeImmutable(t10);
            return t10;
        } catch (InvalidProtocolBufferException e) {
