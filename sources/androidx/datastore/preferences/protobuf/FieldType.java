...
public final class FieldType {
    ...
    private FieldType(String str, int i, int i4, Collection collection, JavaType javaType) {
        int i6;
        this.id = i4;
        this.collection = collection;
        this.javaType = javaType;
        int i10 = AnonymousClass1.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i10 == 1 || i10 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i6 = AnonymousClass1.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i6 == 2 || i6 == 3) ? false : true;
    }
                    ...
                    if (type instanceof TypeVariable) {
                        ...
                        for (int i6 = 0; i6 < typeParameters.length; i6++) {
                            if (type == typeParameters[i6]) {
                                actualTypeArguments[i4] = typeArr[i6];
                            }
                        }
