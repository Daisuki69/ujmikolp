...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    private FieldInfo(java.lang.reflect.Field field, int i, FieldType fieldType, Class<?> cls, java.lang.reflect.Field field2, int i4, boolean z4, boolean z5, OneofInfo oneofInfo, Class<?> cls2, Object obj, Internal.EnumVerifier enumVerifier, java.lang.reflect.Field field3) {
        this.field = field;
        this.type = fieldType;
    ...
    private static void checkFieldNumber(int i) {
        if (i <= 0) {
            throw new IllegalArgumentException(s.f(i, "fieldNumber must be positive: "));
        }
    }

    public static FieldInfo forExplicitPresenceField(java.lang.reflect.Field field, int i, FieldType fieldType, java.lang.reflect.Field field2, int i4, boolean z4, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
        if (field2 == null || isExactlyOneBitSet(i4)) {
            return new FieldInfo(field, i, fieldType, null, field2, i4, false, z4, null, null, null, enumVerifier, null);
        }
        throw new IllegalArgumentException(s.f(i4, "presenceMask must have exactly one bit set: "));
    }

    public static FieldInfo forField(java.lang.reflect.Field field, int i, FieldType fieldType, boolean z4) {
        checkFieldNumber(i);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        ...
        return new FieldInfo(field, i, fieldType, null, null, 0, false, z4, null, null, null, null, null);
    }
    ...
    public static FieldInfo forLegacyRequiredField(java.lang.reflect.Field field, int i, FieldType fieldType, java.lang.reflect.Field field2, int i4, boolean z4, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
        if (field2 == null || isExactlyOneBitSet(i4)) {
            return new FieldInfo(field, i, fieldType, null, field2, i4, true, z4, null, null, null, enumVerifier, null);
        }
        throw new IllegalArgumentException(s.f(i4, "presenceMask must have exactly one bit set: "));
    }
    ...
    public static FieldInfo forOneofMemberField(int i, FieldType fieldType, OneofInfo oneofInfo, Class<?> cls, boolean z4, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i);
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(oneofInfo, "oneof");
        Internal.checkNotNull(cls, "oneofStoredType");
        if (fieldType.isScalar()) {
            return new FieldInfo(null, i, fieldType, null, null, 0, false, z4, oneofInfo, cls, null, enumVerifier, null);
        }
