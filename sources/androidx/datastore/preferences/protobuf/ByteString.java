...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    public static final class ArraysByteArrayCopier implements ByteArrayCopier {
        ...
        public byte[] copyFrom(byte[] bArr, int i, int i4) {
    ...
    public static final class BoundedByteString extends LiteralByteString {
        ...
        @Override // androidx.datastore.preferences.protobuf.ByteString.LiteralByteString, androidx.datastore.preferences.protobuf.ByteString
        public void copyToInternal(byte[] bArr, int i, int i4, int i6) {
            System.arraycopy(this.bytes, getOffsetIntoBytes() + i, bArr, i4, i6);
        }
    ...
    public interface ByteArrayCopier {
        byte[] copyFrom(byte[] bArr, int i, int i4);
    }
    ...
    public static abstract class LeafByteString extends ByteString {
        ...
        public abstract boolean equalsRange(ByteString byteString, int i, int i4);
    ...
    public static class LiteralByteString extends LeafByteString {
        ...
        @Override // androidx.datastore.preferences.protobuf.ByteString
        public void copyToInternal(byte[] bArr, int i, int i4, int i6) {
            System.arraycopy(this.bytes, i, bArr, i4, i6);
        }
        ...
        public final boolean equalsRange(ByteString byteString, int i, int i4) {
            ...
            if (i6 > byteString.size()) {
                ...
                sbU.append(byteString.size());
                throw new IllegalArgumentException(sbU.toString());
            }
            if (!(byteString instanceof LiteralByteString)) {
                return byteString.substring(i, i6).equals(substring(0, i4));
            }
        ...
        @Override // androidx.datastore.preferences.protobuf.ByteString
        public final int partialHash(int i, int i4, int i6) {
            return Internal.partialHash(i, this.bytes, getOffsetIntoBytes() + i4, i6);
        }

        @Override // androidx.datastore.preferences.protobuf.ByteString
        public final int partialIsValidUtf8(int i, int i4, int i6) {
            int offsetIntoBytes = getOffsetIntoBytes() + i4;
            return Utf8.partialIsValidUtf8(i, this.bytes, offsetIntoBytes, i6 + offsetIntoBytes);
        }
        ...
        @Override // androidx.datastore.preferences.protobuf.ByteString
        public final ByteString substring(int i, int i4) {
            int iCheckRange = ByteString.checkRange(i, i4, size());
        ...
        @Override // androidx.datastore.preferences.protobuf.ByteString
        public final void writeToInternal(OutputStream outputStream, int i, int i4) throws IOException {
    ...
    public static final class NioByteString extends LeafByteString {
        ...
        private ByteBuffer slice(int i, int i4) {
            if (i < this.buffer.position() || i4 > this.buffer.limit() || i > i4) {
                throw new IllegalArgumentException(String.format("Invalid indices [%d, %d]", Integer.valueOf(i), Integer.valueOf(i4)));
            }
            ByteBuffer byteBufferSlice = this.buffer.slice();
            Java8Compatibility.position(byteBufferSlice, i - this.buffer.position());
            Java8Compatibility.limit(byteBufferSlice, i4 - this.buffer.position());
        ...
        public void copyToInternal(byte[] bArr, int i, int i4, int i6) {
            ...
            byteBufferSlice.get(bArr, i4, i6);
        }
        ...
        @Override // androidx.datastore.preferences.protobuf.ByteString.LeafByteString
        public boolean equalsRange(ByteString byteString, int i, int i4) {
            return substring(0, i4).equals(byteString.substring(i, i4 + i));
        }
        ...
        public InputStream newInput() {
            return new InputStream() { // from class: androidx.datastore.preferences.protobuf.ByteString.NioByteString.1
                ...
                public int read(byte[] bArr, int i, int i4) throws IOException {
                    ...
                    int iMin = Math.min(i4, this.buf.remaining());
        ...
        @Override // androidx.datastore.preferences.protobuf.ByteString
        public int partialHash(int i, int i4, int i6) {
        ...
        @Override // androidx.datastore.preferences.protobuf.ByteString
        public int partialIsValidUtf8(int i, int i4, int i6) {
            return Utf8.partialIsValidUtf8(i, this.buffer, i4, i6 + i4);
        }
        ...
        public ByteString substring(int i, int i4) {
            try {
                return new NioByteString(slice(i, i4));
            } catch (ArrayIndexOutOfBoundsException e) {
                throw e;
            } catch (IndexOutOfBoundsException e7) {
                throw new ArrayIndexOutOfBoundsException(e7.getMessage());
        ...
        public void writeToInternal(OutputStream outputStream, int i, int i4) throws IOException {
            if (!this.buffer.hasArray()) {
                ByteBufferWriter.write(slice(i, i4 + i), outputStream);
                return;
            }
            outputStream.write(this.buffer.array(), this.buffer.position() + this.buffer.arrayOffset() + i, i4);
        }
    ...
    public static void checkIndex(int i, int i4) {
        if (((i4 - (i + 1)) | i) < 0) {
            if (i >= 0) {
    ...
    public static int checkRange(int i, int i4, int i6) {
        int i10 = i4 - i;
        if ((i | i4 | i10 | (i6 - i4)) >= 0) {
            return i10;
        }
    ...
    public static ByteString copyFrom(byte[] bArr, int i, int i4) {
        checkRange(i, i + i4, bArr.length);
        return new LiteralByteString(byteArrayCopier.copyFrom(bArr, i, i4));
    }
    ...
    private static int extractHexDigit(String str, int i) {
        ...
        StringBuilder sbW = s.w("Invalid hexString ", str, " must only contain [0-9a-fA-F] but contained ");
        sbW.append(str.charAt(i));
        sbW.append(" at index ");
        sbW.append(i);
    ...
    public static ByteString fromHex(@CompileTimeConstant String str) {
        if (str.length() % 2 != 0) {
            StringBuilder sbW = s.w("Invalid hexString ", str, " of length ");
            sbW.append(str.length());
            sbW.append(" must be even.");
            throw new NumberFormatException(sbW.toString());
        }
        ...
        for (int i = 0; i < length; i++) {
            int i4 = i * 2;
            bArr[i] = (byte) (extractHexDigit(str, i4 + 1) | (extractHexDigit(str, i4) << 4));
        }
    ...
    private String truncateAndEscapeForDisplay() {
        return size() <= 50 ? TextFormatEscaper.escapeBytes(this) : s.p(new StringBuilder(), TextFormatEscaper.escapeBytes(substring(0, 47)), "...");
    }
    ...
    public abstract void copyToInternal(byte[] bArr, int i, int i4, int i6);
    ...
    public abstract int partialHash(int i, int i4, int i6);

    public abstract int partialIsValidUtf8(int i, int i4, int i6);
    ...
    public abstract ByteString substring(int i, int i4);
    ...
    public final void writeTo(OutputStream outputStream, int i, int i4) throws IOException {
    ...
    @Deprecated
    public final void copyTo(byte[] bArr, int i, int i4, int i6) {
        checkRange(i, i + i6, size());
        checkRange(i4, i4 + i6, bArr.length);
        if (i6 > 0) {
            copyToInternal(bArr, i, i4, i6);
        }
    }
    ...
    public static ByteString readFrom(InputStream inputStream, int i, int i4) throws IOException {
    ...
    public static ByteString wrap(byte[] bArr, int i, int i4) {
        return new BoundedByteString(bArr, i, i4);
    }
    ...
    public final String toString() {
        ...
        int size = size();
        return s.p(androidx.camera.core.impl.a.r(size, "<ByteString@", hexString, " size=", " contents=\""), truncateAndEscapeForDisplay(), "\">");
    }
