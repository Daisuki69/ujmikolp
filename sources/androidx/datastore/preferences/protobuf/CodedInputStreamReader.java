...
final class CodedInputStreamReader implements Reader {
    ...
    private <T> void mergeGroupFieldInternal(T t5, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException {
    ...
    private <T> void mergeMessageFieldInternal(T t5, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException {
