...
final class UnsafeUtil {
    ...
    public static final class Android32MemoryAccessor extends MemoryAccessor {
        ...
        public void copyMemory(long j, byte[] bArr, long j6, long j7) {
        ...
        @Override // androidx.datastore.preferences.protobuf.UnsafeUtil.MemoryAccessor
        public void putBoolean(Object obj, long j, boolean z4) {
            if (UnsafeUtil.IS_BIG_ENDIAN) {
                UnsafeUtil.putBooleanBigEndian(obj, j, z4);
            } else {
                UnsafeUtil.putBooleanLittleEndian(obj, j, z4);
            }
        }

        @Override // androidx.datastore.preferences.protobuf.UnsafeUtil.MemoryAccessor
        public void putByte(Object obj, long j, byte b8) {
            if (UnsafeUtil.IS_BIG_ENDIAN) {
                UnsafeUtil.putByteBigEndian(obj, j, b8);
            } else {
                UnsafeUtil.putByteLittleEndian(obj, j, b8);
            }
        }
        ...
        @Override // androidx.datastore.preferences.protobuf.UnsafeUtil.MemoryAccessor
        public void copyMemory(byte[] bArr, long j, long j6, long j7) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override // androidx.datastore.preferences.protobuf.UnsafeUtil.MemoryAccessor
        public void putByte(long j, byte b8) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    public static final class JvmMemoryAccessor extends MemoryAccessor {
        ...
        @Override // androidx.datastore.preferences.protobuf.UnsafeUtil.MemoryAccessor
        public void copyMemory(long j, byte[] bArr, long j6, long j7) {
            this.unsafe.copyMemory((Object) null, j, bArr, UnsafeUtil.BYTE_ARRAY_BASE_OFFSET + j6, j7);
        }
        ...
        @Override // androidx.datastore.preferences.protobuf.UnsafeUtil.MemoryAccessor
        public void putBoolean(Object obj, long j, boolean z4) {
            this.unsafe.putBoolean(obj, j, z4);
        }

        @Override // androidx.datastore.preferences.protobuf.UnsafeUtil.MemoryAccessor
        public void putByte(Object obj, long j, byte b8) {
            this.unsafe.putByte(obj, j, b8);
        }
        ...
        @Override // androidx.datastore.preferences.protobuf.UnsafeUtil.MemoryAccessor
        public void copyMemory(byte[] bArr, long j, long j6, long j7) {
            this.unsafe.copyMemory(bArr, UnsafeUtil.BYTE_ARRAY_BASE_OFFSET + j, (Object) null, j6, j7);
        }
    ...
    public static abstract class MemoryAccessor {
        ...
        public abstract void copyMemory(long j, byte[] bArr, long j6, long j7);

        public abstract void copyMemory(byte[] bArr, long j, long j6, long j7);
        ...
        public abstract void putBoolean(Object obj, long j, boolean z4);

        public abstract void putByte(long j, byte b8);

        public abstract void putByte(Object obj, long j, byte b8);
    ...
    public static void copyMemory(byte[] bArr, long j, long j6, long j7) {
        MEMORY_ACCESSOR.copyMemory(bArr, j, j6, j7);
    }
    ...
    public static int mismatch(byte[] bArr, int i, byte[] bArr2, int i4, int i6) {
        if (i < 0 || i4 < 0 || i6 < 0 || i + i6 > bArr.length || i4 + i6 > bArr2.length) {
            throw new IndexOutOfBoundsException();
        }
        int i10 = 0;
        if (HAS_UNSAFE_ARRAY_OPERATIONS) {
            for (int i11 = (BYTE_ARRAY_ALIGNMENT + i) & 7; i10 < i6 && (i11 & 7) != 0; i11++) {
                if (bArr[i + i10] != bArr2[i4 + i10]) {
                    return i10;
                }
                i10++;
            }
            int i12 = ((i6 - i10) & (-8)) + i10;
            while (i10 < i12) {
                long j = BYTE_ARRAY_BASE_OFFSET;
                long j6 = i10;
                long j7 = getLong((Object) bArr, ((long) i) + j + j6);
                long j9 = getLong((Object) bArr2, j + ((long) i4) + j6);
                if (j7 != j9) {
                    return i10 + firstDifferingByteIndexNativeEndian(j7, j9);
                }
                i10 += 8;
            }
        }
    ...
    public static void putBoolean(Object obj, long j, boolean z4) {
        MEMORY_ACCESSOR.putBoolean(obj, j, z4);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static void putBooleanBigEndian(Object obj, long j, boolean z4) {
        putByteBigEndian(obj, j, z4 ? (byte) 1 : (byte) 0);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static void putBooleanLittleEndian(Object obj, long j, boolean z4) {
        putByteLittleEndian(obj, j, z4 ? (byte) 1 : (byte) 0);
    }

    public static void putByte(Object obj, long j, byte b8) {
        MEMORY_ACCESSOR.putByte(obj, j, b8);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static void putByteBigEndian(Object obj, long j, byte b8) {
        long j6 = (-4) & j;
        int i = getInt(obj, j6);
        int i4 = ((~((int) j)) & 3) << 3;
        putInt(obj, j6, ((255 & b8) << i4) | (i & (~(255 << i4))));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static void putByteLittleEndian(Object obj, long j, byte b8) {
        long j6 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        putInt(obj, j6, ((255 & b8) << i) | (getInt(obj, j6) & (~(255 << i))));
    }
    ...
    public static void copyMemory(long j, byte[] bArr, long j6, long j7) {
        MEMORY_ACCESSOR.copyMemory(j, bArr, j6, j7);
    }
    ...
    public static void putBoolean(boolean[] zArr, long j, boolean z4) {
        MEMORY_ACCESSOR.putBoolean(zArr, (j * BOOLEAN_ARRAY_INDEX_SCALE) + BOOLEAN_ARRAY_BASE_OFFSET, z4);
    }

    public static void putByte(byte[] bArr, long j, byte b8) {
        MEMORY_ACCESSOR.putByte(bArr, BYTE_ARRAY_BASE_OFFSET + j, b8);
    }
    ...
    public static void copyMemory(byte[] bArr, long j, byte[] bArr2, long j6, long j7) {
        System.arraycopy(bArr, (int) j, bArr2, (int) j6, (int) j7);
    }
    ...
    public static void putByte(long j, byte b8) {
        MEMORY_ACCESSOR.putByte(j, b8);
    }
