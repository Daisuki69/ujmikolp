...
final class RopeByteString extends ByteString {
    ...
    private boolean equalsFragments(ByteString byteString) {
        ...
        while (true) {
            ...
            if (!(i == 0 ? next.equalsRange(next2, i4, iMin) : next2.equalsRange(next, i, iMin))) {
                return false;
            }
            i6 += iMin;
    ...
    public void copyToInternal(byte[] bArr, int i, int i4, int i6) {
        ...
        if (i10 <= i11) {
            this.left.copyToInternal(bArr, i, i4, i6);
        } else {
            if (i >= i11) {
                this.right.copyToInternal(bArr, i - i11, i4, i6);
                return;
            }
            int i12 = i11 - i;
            this.left.copyToInternal(bArr, i, i4, i12);
            this.right.copyToInternal(bArr, 0, i4 + i12, i6 - i12);
        }
    }
    ...
    public byte internalByteAt(int i) {
        ...
        return i < i4 ? this.left.internalByteAt(i) : this.right.internalByteAt(i - i4);
    }
    ...
    public int partialHash(int i, int i4, int i6) {
        ...
        int i11 = this.leftLength;
        if (i10 <= i11) {
            return this.left.partialHash(i, i4, i6);
        }
        if (i4 >= i11) {
            return this.right.partialHash(i, i4 - i11, i6);
        }
        int i12 = i11 - i4;
        return this.right.partialHash(this.left.partialHash(i, i4, i12), 0, i6 - i12);
    }
    ...
    public int partialIsValidUtf8(int i, int i4, int i6) {
        ...
        int i11 = this.leftLength;
        if (i10 <= i11) {
            return this.left.partialIsValidUtf8(i, i4, i6);
        }
        if (i4 >= i11) {
            return this.right.partialIsValidUtf8(i, i4 - i11, i6);
        }
        int i12 = i11 - i4;
        return this.right.partialIsValidUtf8(this.left.partialIsValidUtf8(i, i4, i12), 0, i6 - i12);
    }
    ...
    public ByteString substring(int i, int i4) {
        int iCheckRange = ByteString.checkRange(i, i4, this.totalLength);
        if (iCheckRange == 0) {
        ...
        return i4 <= i6 ? this.left.substring(i, i4) : i >= i6 ? this.right.substring(i - i6, i4 - i6) : new RopeByteString(this.left.substring(i), this.right.substring(0, i4 - this.leftLength));
    }
    ...
    public void writeToInternal(OutputStream outputStream, int i, int i4) throws IOException {
        ...
        if (i6 <= i10) {
            ...
            if (i >= i10) {
                this.right.writeToInternal(outputStream, i - i10, i4);
                return;
            }
            int i11 = i10 - i;
    ...
    public class RopeInputStream extends InputStream {
        ...
        private int readSkipInternal(byte[] bArr, int i, int i4) {
            ...
            while (i6 > 0) {
                ...
                int iMin = Math.min(this.currentPieceSize - this.currentPieceIndex, i6);
                if (bArr != null) {
        ...
        public int read(byte[] bArr, int i, int i4) {
            ...
            int skipInternal = readSkipInternal(bArr, i, i4);
            if (skipInternal != 0) {
                return skipInternal;
            }
