...
public class WorkContinuationImpl extends WorkContinuation {
    ...
    public Operation enqueue() {
        if (this.mEnqueued) {
            ...
            this.mOperation = OperationKt.launchOperation(this.mWorkManagerImpl.getConfiguration().getTracer(), "EnqueueRunnable_" + getExistingWorkPolicy().name(), this.mWorkManagerImpl.getWorkTaskExecutor().getSerialTaskExecutor(), new W4.b(this, 4));
        }
