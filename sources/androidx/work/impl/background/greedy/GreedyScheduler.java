...
public class GreedyScheduler implements Scheduler, OnConstraintsStateChangedListener, ExecutionListener {
    ...
    private final Map<WorkGenerationalId, InterfaceC0156n0> mConstrainedWorkSpecs = new HashMap();
    private final Object mLock = new Object();
    private final StartStopTokens mStartStopTokens = d.c();
    ...
    private void removeConstraintTrackingFor(@NonNull WorkGenerationalId workGenerationalId) {
        InterfaceC0156n0 interfaceC0156n0Remove;
        synchronized (this.mLock) {
            interfaceC0156n0Remove = this.mConstrainedWorkSpecs.remove(workGenerationalId);
        }
