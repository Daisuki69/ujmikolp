...
abstract class ConstraintProxy extends BroadcastReceiver {
    ...
    public static void updateAll(Context context, List<WorkSpec> list) {
        ...
        while (it.hasNext()) {
            ...
            if (zRequiresBatteryNotLow && zRequiresCharging && zRequiresStorageNotLow && z4) {
                break;
            }
        }
        kKDWJ7.sendBroadcast(context, ConstraintProxyUpdateReceiver.newConstraintProxyUpdateIntent(context, zRequiresBatteryNotLow, zRequiresCharging, zRequiresStorageNotLow, z4));
    }
