...
public class ConstraintProxyUpdateReceiver extends BroadcastReceiver {
    ...
    @NonNull
    public static Intent newConstraintProxyUpdateIntent(@NonNull Context context, boolean z4, boolean z5, boolean z8, boolean z9) {
        Intent intent = new Intent(ACTION);
        intent.setComponent(new ComponentName(context, (Class<?>) ConstraintProxyUpdateReceiver.class));
        intent.putExtra(KEY_BATTERY_NOT_LOW_PROXY_ENABLED, z4).putExtra(KEY_BATTERY_CHARGING_PROXY_ENABLED, z5).putExtra(KEY_STORAGE_NOT_LOW_PROXY_ENABLED, z8).putExtra(KEY_NETWORK_STATE_PROXY_ENABLED, z9);
        return intent;
    }
