...
class SystemJobInfoConverter {
    ...
    public SystemJobInfoConverter(@NonNull Context context, Clock clock, boolean z4) {
        this.mClock = clock;
    ...
    private static JobInfo.TriggerContentUri convertContentUriTrigger(Constraints.ContentUriTrigger contentUriTrigger) {
        ...
        a.q();
        return a.h(contentUriTrigger.getUri(), zIsTriggeredForDescendants ? 1 : 0);
    }
    ...
    public JobInfo convert(WorkSpec workSpec, int i) {
        ...
        if (i4 < 28 || requiredNetworkRequest == null) {
        ...
        if (i4 >= 24 && constraints.hasContentUriTriggers()) {
        ...
        boolean z5 = jMax > 0;
        if (i6 >= 31 && workSpec.expedited && !z4 && !z5) {
            extras.setExpedited(true);
        }
        if (i6 >= 35 && (traceTag = workSpec.getTraceTag()) != null) {
