...
public class ForceStopRunnable implements Runnable {
    ...
    public boolean isForceStopped() {
        try {
            ...
            PendingIntent pendingIntent = getPendingIntent(this.mContext, i >= 31 ? 570425344 : C.BUFFER_FLAG_LAST_SAMPLE);
            if (i >= 30) {
                ...
                if (historicalProcessExitReasons != null && !historicalProcessExitReasons.isEmpty()) {
                    ...
                    for (int i4 = 0; i4 < historicalProcessExitReasons.size(); i4++) {
                        ApplicationExitInfo applicationExitInfoE = f.e(historicalProcessExitReasons.get(i4));
                        if (applicationExitInfoE.getReason() == 10 && applicationExitInfoE.getTimestamp() >= lastForceStopEventMillis) {
                            return true;
                        }
                    }
                }
