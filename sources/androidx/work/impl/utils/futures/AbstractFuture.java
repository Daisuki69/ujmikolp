...
public abstract class AbstractFuture<V> implements y {
    ...
    public static final class SetFuture<V> implements Runnable {
        ...
        public SetFuture(AbstractFuture<V> abstractFuture, y yVar) {
    ...
    public static Object getFutureValue(y yVar) {
        if (yVar instanceof AbstractFuture) {
            Object obj = ((AbstractFuture) yVar).value;
            if (!(obj instanceof Cancellation)) {
                return obj;
            }
    ...
    public final boolean cancel(boolean z4) {
        ...
        while (true) {
            if (ATOMIC_HELPER.casValue(abstractFuture, obj, cancellation)) {
                ...
                abstractFuture = (AbstractFuture) yVar;
