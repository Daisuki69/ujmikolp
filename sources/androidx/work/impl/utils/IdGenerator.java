...
public final class IdGenerator {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Integer nextJobSchedulerIdWithRange$lambda$0(IdGenerator idGenerator, int i, int i4) {
        int iNextId = IdGeneratorKt.nextId(idGenerator.workDatabase, IdGeneratorKt.NEXT_JOB_SCHEDULER_ID_KEY);
        if (i > iNextId || iNextId > i4) {
    ...
    public final int nextAlarmManagerId() {
        Object objRunInTransaction = this.workDatabase.runInTransaction(new CallableC0168a(this, 11));
        j.f(objRunInTransaction, "workDatabase.runInTransa…NAGER_ID_KEY) }\n        )");
    ...
    public final int nextJobSchedulerIdWithRange(final int i, final int i4) {
        Object objRunInTransaction = this.workDatabase.runInTransaction((Callable<Object>) new Callable() { // from class: androidx.work.impl.utils.c
            ...
            public final Object call() {
                return IdGenerator.nextJobSchedulerIdWithRange$lambda$0(this.f8257a, i, i4);
            }
        });
        j.f(objRunInTransaction, "workDatabase.runInTransa…d\n            }\n        )");
        return ((Number) objRunInTransaction).intValue();
    }
}
