...
public class WorkManagerImpl extends WorkManager {
    ...
    private final E mWorkManagerScope;
    ...
    public WorkManagerImpl(@NonNull Context context, @NonNull Configuration configuration, @NonNull TaskExecutor taskExecutor, @NonNull WorkDatabase workDatabase, @NonNull List<Scheduler> list, @NonNull Processor processor, @NonNull Trackers trackers) {
        ...
        E eCreateWorkManagerScope = WorkManagerImplExtKt.createWorkManagerScope(taskExecutor);
        this.mWorkManagerScope = eCreateWorkManagerScope;
        ...
        UnfinishedWorkListenerKt.maybeLaunchUnfinishedWorkListener(eCreateWorkManagerScope, this.mContext, configuration, workDatabase);
    }
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public y getLastCancelAllTimeMillis() {
        ...
        return ListenableFutureKt.executeAsync(serialTaskExecutor, "getLastCancelAllTimeMillis", new W4.b(preferenceUtils, 5));
    }
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public y getWorkInfoById(@NonNull UUID uuid) {
        return StatusRunnable.forUUID(this.mWorkDatabase, this.mWorkTaskExecutor, uuid);
    }

    @Override // androidx.work.WorkManager
    @NonNull
    public InterfaceC0230h getWorkInfoByIdFlow(@NonNull UUID uuid) {
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public y getWorkInfos(@NonNull WorkQuery workQuery) {
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public y getWorkInfosByTag(@NonNull String str) {
        return StatusRunnable.forTag(this.mWorkDatabase, this.mWorkTaskExecutor, str);
    }

    @Override // androidx.work.WorkManager
    @NonNull
    public InterfaceC0230h getWorkInfosByTagFlow(@NonNull String str) {
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public InterfaceC0230h getWorkInfosFlow(@NonNull WorkQuery workQuery) {
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public y getWorkInfosForUniqueWork(@NonNull String str) {
        return StatusRunnable.forUniqueWork(this.mWorkDatabase, this.mWorkTaskExecutor, str);
    }

    @Override // androidx.work.WorkManager
    @NonNull
    public InterfaceC0230h getWorkInfosForUniqueWorkFlow(@NonNull String str) {
    ...
    public void rescheduleEligibleWork() {
        TracerKt.traced(getConfiguration().getTracer(), "ReschedulingWork", new W4.b(this, 6));
    }
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public y updateWork(@NonNull WorkRequest workRequest) {
