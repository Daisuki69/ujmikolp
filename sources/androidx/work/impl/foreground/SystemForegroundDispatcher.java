...
public class SystemForegroundDispatcher implements OnConstraintsStateChangedListener, ExecutionListener {
    ...
    final Map<WorkGenerationalId, InterfaceC0156n0> mTrackedWorkSpecs;
    ...
    public interface Callback {
        ...
        @MainThread
        void startForeground(int i, int i4, @NonNull Notification notification);
    ...
    public void onDestroy() {
        ...
        synchronized (this.mLock) {
            try {
                Iterator<InterfaceC0156n0> it = this.mTrackedWorkSpecs.values().iterator();
                while (it.hasNext()) {
                    it.next().b(null);
                }
            } catch (Throwable th2) {
    ...
    public void onExecuted(@NonNull WorkGenerationalId workGenerationalId, boolean z4) {
        ...
        synchronized (this.mLock) {
            try {
                InterfaceC0156n0 interfaceC0156n0Remove = this.mWorkSpecById.remove(workGenerationalId) != null ? this.mTrackedWorkSpecs.remove(workGenerationalId) : null;
                if (interfaceC0156n0Remove != null) {
                    interfaceC0156n0Remove.b(null);
                }
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public void onTimeout(int i, int i4) {
        Logger.get().info(TAG, "Foreground service timed out, FGS type: " + i4);
        for (Map.Entry<WorkGenerationalId, ForegroundInfo> entry : this.mForegroundInfoById.entrySet()) {
            if (entry.getValue().getForegroundServiceType() == i4) {
