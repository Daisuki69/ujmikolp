...
public class CustomTabsCallback {
    ...
    public void onActivityLayout(@Dimension(unit = 1) int i, @Dimension(unit = 1) int i4, @Dimension(unit = 1) int i6, @Dimension(unit = 1) int i10, int i11, @NonNull Bundle bundle) {
    }

    public void onActivityResized(@Dimension(unit = 1) int i, @Dimension(unit = 1) int i4, @NonNull Bundle bundle) {
    }
