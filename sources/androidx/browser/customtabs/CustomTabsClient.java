...
public class CustomTabsClient {
    ...
    private android.support.customtabs.b createCallbackWrapper(@Nullable final CustomTabsCallback customTabsCallback) {
        return new android.support.customtabs.b() { // from class: androidx.browser.customtabs.CustomTabsClient.2
            ...
            @Override // android.support.customtabs.c
            public void onActivityLayout(final int i, final int i4, final int i6, final int i10, final int i11, @NonNull final Bundle bundle) throws RemoteException {
                if (customTabsCallback == null) {
                    return;
                }
                this.mHandler.post(new Runnable() { // from class: androidx.browser.customtabs.CustomTabsClient.2.8
                    @Override // java.lang.Runnable
                    public void run() {
                        customTabsCallback.onActivityLayout(i, i4, i6, i10, i11, bundle);
                    }
                });
            }

            @Override // android.support.customtabs.c
            public void onActivityResized(final int i, final int i4, @Nullable final Bundle bundle) throws RemoteException {
                if (customTabsCallback == null) {
                    return;
                }
                this.mHandler.post(new Runnable() { // from class: androidx.browser.customtabs.CustomTabsClient.2.6
                    @Override // java.lang.Runnable
                    public void run() {
                        customTabsCallback.onActivityResized(i, i4, bundle);
                    }
                });
            }
            ...
            @Override // android.support.customtabs.c
            public void onRelationshipValidationResult(final int i, final Uri uri, final boolean z4, @Nullable final Bundle bundle) throws RemoteException {
                if (customTabsCallback == null) {
                    return;
                }
                this.mHandler.post(new Runnable() { // from class: androidx.browser.customtabs.CustomTabsClient.2.5
                    @Override // java.lang.Runnable
                    public void run() {
                        customTabsCallback.onRelationshipValidationResult(i, uri, z4, bundle);
                    }
                });
            }
    ...
    private CustomTabsSession newSessionInternal(@Nullable CustomTabsCallback customTabsCallback, @Nullable PendingIntent pendingIntent) {
        boolean zNewSession;
        android.support.customtabs.b bVarCreateCallbackWrapper = createCallbackWrapper(customTabsCallback);
        try {
            if (pendingIntent != null) {
                Bundle bundle = new Bundle();
                bundle.putParcelable(CustomTabsIntent.EXTRA_SESSION_ID, pendingIntent);
                zNewSession = this.mService.newSessionWithExtras(bVarCreateCallbackWrapper, bundle);
            } else {
                zNewSession = this.mService.newSession(bVarCreateCallbackWrapper);
            }
            if (zNewSession) {
                return new CustomTabsSession(this.mService, bVarCreateCallbackWrapper, this.mServiceComponentName, pendingIntent);
            }
            return null;
