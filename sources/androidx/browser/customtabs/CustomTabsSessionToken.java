...
public class CustomTabsSessionToken {
    ...
    public static class MockCallback extends android.support.customtabs.b {
        ...
        @Override // android.support.customtabs.c
        public void onActivityLayout(int i, int i4, int i6, int i10, int i11, @NonNull Bundle bundle) {
        }
    ...
    public CustomTabsSessionToken(@Nullable android.support.customtabs.c cVar, @Nullable PendingIntent pendingIntent) {
        ...
        this.mCallback = cVar == null ? null : new CustomTabsCallback() { // from class: androidx.browser.customtabs.CustomTabsSessionToken.1
            ...
            public void onActivityLayout(int i, int i4, int i6, int i10, int i11, @NonNull Bundle bundle) {
                try {
                    CustomTabsSessionToken.this.mCallbackBinder.onActivityLayout(i, i4, i6, i10, i11, bundle);
                } catch (RemoteException unused) {
                    Log.e(CustomTabsSessionToken.TAG, "RemoteException during ICustomTabsCallback transaction");
                }
            }
            ...
            @Override // androidx.browser.customtabs.CustomTabsCallback
            public void onActivityResized(int i, int i4, @NonNull Bundle bundle) {
                try {
                    CustomTabsSessionToken.this.mCallbackBinder.onActivityResized(i, i4, bundle);
                } catch (RemoteException unused) {
                    Log.e(CustomTabsSessionToken.TAG, "RemoteException during ICustomTabsCallback transaction");
                }
            }
            ...
            @Override // androidx.browser.customtabs.CustomTabsCallback
            public void onRelationshipValidationResult(int i, @NonNull Uri uri, boolean z4, @Nullable Bundle bundle) {
                try {
                    CustomTabsSessionToken.this.mCallbackBinder.onRelationshipValidationResult(i, uri, z4, bundle);
                } catch (RemoteException unused) {
                    Log.e(CustomTabsSessionToken.TAG, "RemoteException during ICustomTabsCallback transaction");
                }
            }
