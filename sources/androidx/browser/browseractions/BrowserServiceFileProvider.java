...
public final class BrowserServiceFileProvider extends FileProvider {
        ...
        public Void doInBackground(Void... voidArr) {
            ...
            synchronized (BrowserServiceFileProvider.sFileCleanupLock) {
                try {
                    ...
                    long jCurrentTimeMillis2 = z4 ? System.currentTimeMillis() : (System.currentTimeMillis() - CLEANUP_REQUIRED_TIME_SPAN) + DELETION_FAILED_REATTEMPT_DURATION;
    ...
    private static Uri generateUri(Context context, String str) {
        return new Uri.Builder().scheme(CONTENT_SCHEME).authority(context.getPackageName() + AUTHORITY_SUFFIX).path(s.j(FILE_SUB_DIR_NAME, str, FILE_EXTENSION)).build();
    }
    ...
    @NonNull
    public static y loadBitmap(@NonNull final ContentResolver contentResolver, @NonNull final Uri uri) {
