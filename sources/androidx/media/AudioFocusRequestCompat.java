...
public class AudioFocusRequestCompat {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static AudioFocusRequest createInstance(int i, AudioAttributes audioAttributes, boolean z4, AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener, Handler handler) {
    ...
    public static final class Builder {
        ...
        public Builder setFocusGain(int i) {
            if (!isValidFocusGain(i)) {
                throw new IllegalArgumentException(s.f(i, "Illegal audio focus gain type "));
            }
            this.mFocusGain = i;
            return this;
        }
    ...
    public AudioFocusRequestCompat(int i, AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener, Handler handler, AudioAttributesCompat audioAttributesCompat, boolean z4) {
        ...
        if (i4 >= 26) {
            this.mFrameworkAudioFocusRequest = Api26Impl.createInstance(i, getAudioAttributes(), z4, this.mOnAudioFocusChangeListener, handler);
        } else {
    ...
    public AudioFocusRequest getAudioFocusRequest() {
        return a.n(this.mFrameworkAudioFocusRequest);
    }
