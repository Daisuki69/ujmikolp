...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static int toVolumeStreamType(boolean z4, int i, int i4) {
        if ((i & 1) == 1) {
            return z4 ? 1 : 7;
        }
        if ((i & 4) == 4) {
        ...
        switch (i4) {
            ...
            default:
                if (z4) {
                    throw new IllegalArgumentException(s.g(i4, "Unknown usage value ", " in audio attributes"));
                }
                return 3;
        }
    }
