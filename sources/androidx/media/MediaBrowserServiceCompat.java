...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class ConnectionRecord implements IBinder.DeathRecipient {
        ...
        public ConnectionRecord(String str, int i, int i4, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            ...
            this.pid = i;
            this.uid = i4;
            this.browserInfo = new MediaSessionManager.RemoteUserInfo(str, i, i4);
    ...
    public class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        public BrowserRoot onGetRoot(String str, int i, Bundle bundle) {
            ...
            if (bundle == null || bundle.getInt(MediaBrowserProtocol.EXTRA_CLIENT_VERSION, 0) == 0) {
                ...
                if (mediaSessionCompat$Token != null) {
                    c cVarB = mediaSessionCompat$Token.b();
                    BundleCompat.putBinder(extras, MediaBrowserProtocol.EXTRA_SESSION_BINDER, cVarB == null ? null : cVarB.asBinder());
                } else {
            ...
            ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.new ConnectionRecord(str, i4, i, bundle, null);
        ...
        public void setSessionToken(final MediaSessionCompat$Token mediaSessionCompat$Token) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21.1
                @Override // java.lang.Runnable
                public void run() {
                    MediaBrowserServiceImplApi21.this.setSessionTokenOnHandler(mediaSessionCompat$Token);
                }
            });
        }
        ...
        public void setSessionTokenOnHandler(MediaSessionCompat$Token mediaSessionCompat$Token) {
            if (!this.mRootExtrasList.isEmpty()) {
                ...
                if (cVarB != null) {
                    ...
                    while (it.hasNext()) {
                        BundleCompat.putBinder(it.next(), MediaBrowserProtocol.EXTRA_SESSION_BINDER, cVarB.asBinder());
                    }
                }
                this.mRootExtrasList.clear();
            }
            this.mServiceFwk.setSessionToken((MediaSession.Token) mediaSessionCompat$Token.f7288b);
        }
    ...
    public class MediaBrowserServiceImplApi23 extends MediaBrowserServiceImplApi21 {
        ...
        public void onLoadItem(String str, final ResultWrapper<Parcel> resultWrapper) {
            Result<MediaBrowserCompat$MediaItem> result = new Result<MediaBrowserCompat$MediaItem>(str) { // from class: androidx.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi23.1
                ...
                @Override // androidx.media.MediaBrowserServiceCompat.Result
                public void onResultSent(@Nullable MediaBrowserCompat$MediaItem mediaBrowserCompat$MediaItem) {
    ...
    public static class Result<T> {
        ...
        public void onResultSent(@Nullable T t5) {
        }
        ...
        public void sendResult(@Nullable T t5) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
    ...
    public static class ResultWrapper<T> {
        ...
        public void sendResult(T t5) {
            if (t5 instanceof List) {
                this.mResultFwk.sendResult(parcelListToItemList((List) t5));
                return;
            }
    ...
    public class ServiceBinderImpl {
        ...
        public void connect(final String str, final int i, final int i4, final Bundle bundle, final ServiceCallbacks serviceCallbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(str, i4)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.1
                    ...
                    public void run() {
                        ...
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.new ConnectionRecord(str, i, i4, bundle, serviceCallbacks);
                        MediaBrowserServiceCompat mediaBrowserServiceCompat = MediaBrowserServiceCompat.this;
                        mediaBrowserServiceCompat.mCurConnection = connectionRecord;
                        BrowserRoot browserRootOnGetRoot = mediaBrowserServiceCompat.onGetRoot(str, i4, bundle);
        ...
        public void registerCallbacks(final ServiceCallbacks serviceCallbacks, final String str, final int i, final int i4, final Bundle bundle) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.6
                ...
                public void run() {
                    ...
                    if (connectionRecord == null) {
                        connectionRecord = MediaBrowserServiceCompat.this.new ConnectionRecord(str, i, i4, bundle, serviceCallbacks);
                    }
    ...
    public void performLoadChildren(final String str, final ConnectionRecord connectionRecord, final Bundle bundle, final Bundle bundle2) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(s.q(new StringBuilder("onLoadChildren must call detach() or sendResult() before returning for package="), connectionRecord.pkg, " id=", str));
        }
    }
    ...
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(AbstractC1414e.h("onLoadItem must call detach() or sendResult() before returning for id=", str));
        }
    }
    ...
    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(AbstractC1414e.h("onSearch must call detach() or sendResult() before returning for query=", str));
        }
    }
