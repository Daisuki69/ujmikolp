...
public class AnimatorInflaterCompat {
    ...
    private static void distributeKeyframes(Keyframe[] keyframeArr, float f, int i, int i4) {
        float f3 = f / ((i4 - i) + 2);
        while (i <= i4) {
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            StringBuilder sbT = s.t(i, "Keyframe ", ": fraction ");
            Object value = "null";
            sbT.append(keyframe.getFraction() < 0.0f ? "null" : Float.valueOf(keyframe.getFraction()));
            sbT.append(", , value : ");
    ...
    private static PropertyValuesHolder getPVH(TypedArray typedArray, int i, int i4, int i6, String str) {
        PropertyValuesHolder propertyValuesHolderOfFloat;
        TypedValue typedValuePeekValue = typedArray.peekValue(i4);
        boolean z4 = typedValuePeekValue != null;
        int i10 = z4 ? typedValuePeekValue.type : 0;
        TypedValue typedValuePeekValue2 = typedArray.peekValue(i6);
        boolean z5 = typedValuePeekValue2 != null;
        int i11 = z5 ? typedValuePeekValue2.type : 0;
        if (i == 4) {
            i = ((z4 && isColorType(i10)) || (z5 && isColorType(i11))) ? 3 : 0;
        }
        boolean z8 = i == 0;
        ...
        if (i == 2) {
            ...
            if (pathDataNodeArrCreateNodesFromPathData != null || pathDataNodeArrCreateNodesFromPathData2 != null) {
                if (pathDataNodeArrCreateNodesFromPathData != null) {
                    ...
                    throw new InflateException(s.k(" Can't morph from ", string, " to ", string2));
                }
                if (pathDataNodeArrCreateNodesFromPathData2 != null) {
        ...
        if (z8) {
            if (z4) {
                float dimension = i10 == 5 ? typedArray.getDimension(i4, 0.0f) : typedArray.getFloat(i4, 0.0f);
                if (z5) {
                    propertyValuesHolderOfFloat = PropertyValuesHolder.ofFloat(str, dimension, i11 == 5 ? typedArray.getDimension(i6, 0.0f) : typedArray.getFloat(i6, 0.0f));
                } else {
                    propertyValuesHolderOfFloat = PropertyValuesHolder.ofFloat(str, dimension);
                }
            } else {
                propertyValuesHolderOfFloat = PropertyValuesHolder.ofFloat(str, i11 == 5 ? typedArray.getDimension(i6, 0.0f) : typedArray.getFloat(i6, 0.0f));
            }
            propertyValuesHolderOfInt = propertyValuesHolderOfFloat;
        } else if (z4) {
            int dimension2 = i10 == 5 ? (int) typedArray.getDimension(i4, 0.0f) : isColorType(i10) ? typedArray.getColor(i4, 0) : typedArray.getInt(i4, 0);
            if (z5) {
                propertyValuesHolderOfInt = PropertyValuesHolder.ofInt(str, dimension2, i11 == 5 ? (int) typedArray.getDimension(i6, 0.0f) : isColorType(i11) ? typedArray.getColor(i6, 0) : typedArray.getInt(i6, 0));
            } else {
                propertyValuesHolderOfInt = PropertyValuesHolder.ofInt(str, dimension2);
            }
        } else if (z5) {
            propertyValuesHolderOfInt = PropertyValuesHolder.ofInt(str, i11 == 5 ? (int) typedArray.getDimension(i6, 0.0f) : isColorType(i11) ? typedArray.getColor(i6, 0) : typedArray.getInt(i6, 0));
        }
    ...
    private static int inferValueTypeFromValues(TypedArray typedArray, int i, int i4) {
        TypedValue typedValuePeekValue = typedArray.peekValue(i);
        boolean z4 = typedValuePeekValue != null;
        int i6 = z4 ? typedValuePeekValue.type : 0;
        TypedValue typedValuePeekValue2 = typedArray.peekValue(i4);
        boolean z5 = typedValuePeekValue2 != null;
        int i10 = z5 ? typedValuePeekValue2.type : 0;
        if (z4 && isColorType(i6)) {
            return 3;
        }
        return (z5 && isColorType(i10)) ? 3 : 0;
    }
    ...
    private static Keyframe loadKeyframe(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        TypedValue typedValuePeekNamedValue = TypedArrayUtils.peekNamedValue(typedArrayObtainAttributes, xmlPullParser, "value", 0);
        boolean z4 = typedValuePeekNamedValue != null;
        if (i == 4) {
            i = (z4 && isColorType(typedValuePeekNamedValue.type)) ? 3 : 0;
        }
        Keyframe keyframeOfInt = z4 ? i != 0 ? (i == 1 || i == 3) ? Keyframe.ofInt(namedFloat, TypedArrayUtils.getNamedInt(typedArrayObtainAttributes, xmlPullParser, "value", 0, 0)) : null : Keyframe.ofFloat(namedFloat, TypedArrayUtils.getNamedFloat(typedArrayObtainAttributes, xmlPullParser, "value", 0, 0.0f)) : i == 0 ? Keyframe.ofFloat(namedFloat) : Keyframe.ofInt(namedFloat);
    ...
    private static PropertyValuesHolder loadPvh(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, String str, int i) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (xmlPullParser.getName().equals("keyframe")) {
                ...
                Keyframe keyframeLoadKeyframe = loadKeyframe(context2, resources, theme2, Xml.asAttributeSet(xmlPullParser), i4, xmlPullParser2);
            ...
            if (keyframe3.getFraction() < 0.0f) {
                if (i6 == 0) {
                    ...
                    if (i6 == i10) {
                        ...
                        int i11 = i6;
                        for (int i12 = i6 + 1; i12 < i10 && keyframeArr[i12].getFraction() < 0.0f; i12++) {
                            i11 = i12;
                        }
                        distributeKeyframes(keyframeArr, keyframeArr[i11 + 1].getFraction() - keyframeArr[i6 - 1].getFraction(), i6, i11);
                    }
                }
            }
        }
