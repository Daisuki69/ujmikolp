...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public boolean canReuseBitmap(int i, int i4) {
            return i == this.mCachedBitmap.getWidth() && i4 == this.mCachedBitmap.getHeight();
        }
        ...
        public void createCachedBitmapIfNeeded(int i, int i4) {
            if (this.mCachedBitmap == null || !canReuseBitmap(i, i4)) {
                this.mCachedBitmap = Bitmap.createBitmap(i, i4, Bitmap.Config.ARGB_8888);
        ...
        public void updateCachedBitmap(int i, int i4) {
            this.mCachedBitmap.eraseColor(0);
            this.mVPathRenderer.draw(new Canvas(this.mCachedBitmap), i, i4, null);
        }
    ...
    private void printGroupTree(VGroup vGroup, int i) {
        ...
        StringBuilder sbV = s.v(strI, "current group is :");
        sbV.append(vGroup.getGroupName());
        sbV.append(" rotation is ");
        sbV.append(vGroup.mRotate);
        Log.v(LOGTAG, sbV.toString());
        Log.v(LOGTAG, strI + "matrix is :" + vGroup.getLocalMatrix().toString());
    ...
    @Override // androidx.vectordrawable.graphics.drawable.VectorDrawableCommon, android.graphics.drawable.Drawable
    public /* bridge */ /* synthetic */ void setHotspot(float f, float f3) {
        super.setHotspot(f, f3);
    }

    @Override // androidx.vectordrawable.graphics.drawable.VectorDrawableCommon, android.graphics.drawable.Drawable
    public /* bridge */ /* synthetic */ void setHotspotBounds(int i, int i4, int i6, int i10) {
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            String string = Global.BLANK;
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                StringBuilder sbW = a.w(string);
                sbW.append(pathDataNodeArr[i].mType);
                sbW.append(Global.COLON);
                string = sbW.toString();
                for (float f : pathDataNodeArr[i].mParams) {
                    string = s.n(a.w(string), ",", f);
                }
            }
            return string;
        }
        ...
        public void printVPath(int i) {
            ...
            StringBuilder sbV = s.v(strI, "current path is :");
            sbV.append(this.mPathName);
            sbV.append(" pathData is ");
            sbV.append(nodesToString(this.mNodes));
            Log.v(VectorDrawableCompat.LOGTAG, sbV.toString());
        }
    ...
    public static class VPathRenderer {
        ...
        private static float cross(float f, float f3, float f7, float f10) {
            return (f * f10) - (f3 * f7);
        }

        private void drawGroupTree(VGroup vGroup, Matrix matrix, Canvas canvas, int i, int i4, ColorFilter colorFilter) {
            VGroup vGroup2 = vGroup;
            vGroup2.mStackedMatrix.set(matrix);
            vGroup2.mStackedMatrix.preConcat(vGroup2.mLocalMatrix);
            canvas.save();
            int i6 = 0;
            while (i6 < vGroup2.mChildren.size()) {
                VObject vObject = vGroup2.mChildren.get(i6);
                if (vObject instanceof VGroup) {
                    drawGroupTree((VGroup) vObject, vGroup2.mStackedMatrix, canvas, i, i4, colorFilter);
                } else if (vObject instanceof VPath) {
                    drawPath(vGroup2, (VPath) vObject, canvas, i, i4, colorFilter);
                }
                i6++;
                vGroup2 = vGroup;
            }
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i, int i4, ColorFilter colorFilter) {
            float f = i / this.mViewportWidth;
            float f3 = i4 / this.mViewportHeight;
            float fMin = Math.min(f, f3);
            Matrix matrix = vGroup.mStackedMatrix;
            this.mFinalPathMatrix.set(matrix);
            this.mFinalPathMatrix.postScale(f, f3);
        ...
        public void draw(Canvas canvas, int i, int i4, ColorFilter colorFilter) {
            drawGroupTree(this.mRootGroup, IDENTITY_MATRIX, canvas, i, i4, colorFilter);
        }
