...
public class TransitionSet extends Transition {
    ...
    public TransitionSet setOrdering(int i) {
        ...
        if (i != 1) {
            throw new AndroidRuntimeException(s.f(i, "Invalid parameter for TransitionSet ordering: "));
        }
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            StringBuilder sbV = s.v(string, Global.NEWLINE);
            sbV.append(this.mTransitions.get(i).toString(str + "  "));
            string = sbV.toString();
        }
        return string;
    }
    ...
    public Transition mo132clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo132clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo132clone());
        }
    ...
    @Override // androidx.transition.Transition
    @NonNull
    public Transition excludeTarget(int i, boolean z4) {
        for (int i4 = 0; i4 < this.mTransitions.size(); i4++) {
