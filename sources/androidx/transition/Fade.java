...
public class Fade extends Visibility {
    ...
    private Animator createAnimation(final View view, float f, float f3) {
        if (f == f3) {
            return null;
        }
    ...
    private static float getStartAlpha(TransitionValues transitionValues, float f) {
        Float f3;
        return (transitionValues == null || (f3 = (Float) transitionValues.values.get(PROPNAME_TRANSITION_ALPHA)) == null) ? f : f3.floatValue();
    }
