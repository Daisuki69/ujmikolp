...
public class ChangeTransform extends Transition {
    ...
    public static void setTransforms(View view, float f, float f3, float f7, float f10, float f11, float f12, float f13, float f14) {
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        ObjectAnimator objectAnimatorCreateTransformAnimator = createTransformAnimator(transitionValues, transitionValues2, z4);
        if (z4 && objectAnimatorCreateTransformAnimator != null && this.mUseOverlay) {
