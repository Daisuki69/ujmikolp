...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo132clone = transition.mo132clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo132clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo132clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo132clone);
    }
    ...
    public static void beginDelayedTransition(@NonNull ViewGroup viewGroup, @Nullable Transition transition) {
        ...
        Transition transitionMo132clone = transition.mo132clone();
        sceneChangeSetup(viewGroup, transitionMo132clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo132clone);
    }
