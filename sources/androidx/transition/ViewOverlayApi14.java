...
class ViewOverlayApi14 implements ViewOverlayImpl {
    ...
    public static class OverlayViewGroup extends ViewGroup {
        ...
        public ViewParent invalidateChildInParentFast(int i, int i4, Rect rect) {
            if (this.mHostView == null || sInvalidateChildInParentFastMethod == null) {
                return null;
            }
            try {
                getOffset(new int[2]);
                sInvalidateChildInParentFastMethod.invoke(this.mHostView, Integer.valueOf(i), Integer.valueOf(i4), rect);
                return null;
