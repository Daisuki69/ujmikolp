...
class TranslationAnimationCreator {
    ...
    public static class TransitionPositionListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public TransitionPositionListener(View view, View view2, int i, int i4, float f, float f3) {
            this.mMovingView = view;
            this.mViewInHierarchy = view2;
            this.mStartX = i - Math.round(view.getTranslationX());
            this.mStartY = i4 - Math.round(view.getTranslationY());
            this.mTerminalX = f;
            this.mTerminalY = f3;
    ...
    @Nullable
    public static Animator createAnimation(@NonNull View view, @NonNull TransitionValues transitionValues, int i, int i4, float f, float f3, float f7, float f10, @Nullable TimeInterpolator timeInterpolator, @NonNull Transition transition) {
        float f11;
        float f12;
        float translationX = view.getTranslationX();
        float translationY = view.getTranslationY();
        if (((int[]) transitionValues.view.getTag(R.id.transition_position)) != null) {
            f11 = (r5[0] - i) + translationX;
            f12 = (r5[1] - i4) + translationY;
        } else {
            f11 = f;
            f12 = f3;
        }
        int iRound = Math.round(f11 - translationX) + i;
        int iRound2 = Math.round(f12 - translationY) + i4;
