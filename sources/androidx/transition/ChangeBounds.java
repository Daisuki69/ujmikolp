...
public class ChangeBounds extends Transition {
    ...
    public Animator createAnimator(@NonNull final ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            ...
            int i6 = rect2.left;
            final int i10 = rect3.left;
            int i11 = rect2.top;
            final int i12 = rect3.top;
            int i13 = rect2.right;
            final int i14 = rect3.right;
            int i15 = rect2.bottom;
            final int i16 = rect3.bottom;
            animator = null;
            int i17 = i13 - i6;
            int i18 = i15 - i11;
            int i19 = i14 - i10;
            ...
            if (i > 0) {
                if (this.mResizeClip) {
                    ViewUtils.setLeftTopRightBottom(view2, i6, i11, Math.max(i17, i19) + i6, Math.max(i18, i20) + i11);
                    ObjectAnimator objectAnimatorOfPointF = (i6 == i10 && i11 == i12) ? null : ObjectAnimatorUtils.ofPointF(view2, POSITION_PROPERTY, getPathMotion().getPath(i6, i11, i10, i12));
                    if (rect4 == null) {
                        i4 = 0;
                    ...
                    Rect rect6 = rect5 == null ? new Rect(i4, i4, i19, i20) : rect5;
                    ...
                    ViewUtils.setLeftTopRightBottom(view2, i6, i11, i13, i15);
                    if (i != 2) {
                        animatorMergeAnimators = (i6 == i10 && i11 == i12) ? ObjectAnimatorUtils.ofPointF(view2, BOTTOM_RIGHT_ONLY_PROPERTY, getPathMotion().getPath(i13, i15, i14, i16)) : ObjectAnimatorUtils.ofPointF(view2, TOP_LEFT_ONLY_PROPERTY, getPathMotion().getPath(i6, i11, i10, i12));
                    } else if (i17 == i19 && i18 == i20) {
                        animatorMergeAnimators = ObjectAnimatorUtils.ofPointF(view2, POSITION_PROPERTY, getPathMotion().getPath(i6, i11, i10, i12));
                    } else {
                        ViewBounds viewBounds = new ViewBounds(view2);
                        ObjectAnimator objectAnimatorOfPointF2 = ObjectAnimatorUtils.ofPointF(viewBounds, TOP_LEFT_PROPERTY, getPathMotion().getPath(i6, i11, i10, i12));
                        ObjectAnimator objectAnimatorOfPointF3 = ObjectAnimatorUtils.ofPointF(viewBounds, BOTTOM_RIGHT_PROPERTY, getPathMotion().getPath(i13, i15, i14, i16));
            ...
            if (iIntValue != iIntValue3 || iIntValue2 != iIntValue4) {
                ...
                int i21 = iArr[0];
                int i22 = iArr[1];
                ObjectAnimator objectAnimatorOfPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(bitmapDrawable, PropertyValuesHolderUtils.ofPointF(DRAWABLE_ORIGIN_PROPERTY, pathMotion.getPath(iIntValue - i21, iIntValue2 - i22, iIntValue3 - i21, iIntValue4 - i22)));
