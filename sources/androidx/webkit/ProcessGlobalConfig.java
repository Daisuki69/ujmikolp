...
public class ProcessGlobalConfig {
    ...
    public ProcessGlobalConfig setDataDirectorySuffix(Context context, String str) {
        ...
        if (str.indexOf(File.separatorChar) >= 0) {
            throw new IllegalArgumentException(s.j("Suffix ", str, " contains a path separator"));
        }
    ...
    public ProcessGlobalConfig setPartitionedCookiesEnabled(Context context, boolean z4) {
        if (!WebViewFeatureInternal.STARTUP_FEATURE_CONFIGURE_PARTITIONED_COOKIES.isSupported(context)) {
            throw WebViewFeatureInternal.getUnsupportedOperationException();
        }
        this.mPartitionedCookiesEnabled = Boolean.valueOf(z4);
        return this;
    }
}
