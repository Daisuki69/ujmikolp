...
public class WebViewRenderProcessClientAdapter implements WebViewRendererClientBoundaryInterface {
    ...
    public final void onRendererResponsive(WebView webView, InvocationHandler invocationHandler) {
        ...
        if (executor == null) {
            ...
            executor.execute(new i(webViewRenderProcessClient, webView, webViewRenderProcessImplForInvocationHandler, 0));
        }
    }
    ...
    public final void onRendererUnresponsive(WebView webView, InvocationHandler invocationHandler) {
        ...
        if (executor == null) {
            ...
            executor.execute(new i(webViewRenderProcessClient, webView, webViewRenderProcessImplForInvocationHandler, 1));
        }
    }
}
