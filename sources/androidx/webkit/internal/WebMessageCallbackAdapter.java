...
public class WebMessageCallbackAdapter implements WebMessageCallbackBoundaryInterface {
    ...
    public void onMessage(InvocationHandler invocationHandler, InvocationHandler invocationHandler2) {
        WebMessageCompat webMessageCompatWebMessageCompatFromBoundaryInterface = WebMessageAdapter.webMessageCompatFromBoundaryInterface((WebMessageBoundaryInterface) jk.b.c(WebMessageBoundaryInterface.class, invocationHandler2));
