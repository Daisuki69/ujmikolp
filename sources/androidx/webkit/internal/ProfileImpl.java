...
public class ProfileImpl implements Profile {
    ...
    public void prefetchUrlAsync(String str, CancellationSignal cancellationSignal, Executor executor, SpeculativeLoadingParameters speculativeLoadingParameters, OutcomeReceiverCompat<Void, PrefetchException> outcomeReceiverCompat) {
        ...
        this.mProfileImpl.prefetchUrl(str, cancellationSignal, executor, new jk.a(new SpeculativeLoadingParametersAdapter(speculativeLoadingParameters)), PrefetchOperationCallbackAdapter.buildInvocationHandler(outcomeReceiverCompat));
    }
    ...
    public void setSpeculativeLoadingConfig(SpeculativeLoadingConfig speculativeLoadingConfig) {
        ...
        this.mProfileImpl.setSpeculativeLoadingConfig(new jk.a(new SpeculativeLoadingConfigAdapter(speculativeLoadingConfig)));
    }
