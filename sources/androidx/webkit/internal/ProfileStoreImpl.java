...
public class ProfileStoreImpl implements ProfileStore {
    ...
    public Profile getOrCreateProfile(String str) {
        if (WebViewFeatureInternal.MULTI_PROFILE.isSupportedByWebView()) {
            return new ProfileImpl((ProfileBoundaryInterface) jk.b.c(ProfileBoundaryInterface.class, this.mProfileStoreImpl.getOrCreateProfile(str)));
        }
        throw WebViewFeatureInternal.getUnsupportedOperationException();
    }
    ...
    public Profile getProfile(String str) {
        ...
        if (profile != null) {
            return new ProfileImpl((ProfileBoundaryInterface) jk.b.c(ProfileBoundaryInterface.class, profile));
        }
        return null;
    }
