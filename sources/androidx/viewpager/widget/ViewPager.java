...
public class ViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
        ...
        void onPageScrolled(int i, float f, @Px int i4);
    ...
    public static class ViewPositionComparator implements Comparator<View> {
        ...
        public int compare(View view, View view2) {
            ...
            return z4 != layoutParams2.isDecor ? z4 ? 1 : -1 : layoutParams.position - layoutParams2.position;
        }
    }
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i, ItemInfo itemInfo2) {
            ...
            if (i10 < i11) {
                ...
                while (i12 <= itemInfo.position && i13 < this.mItems.size()) {
                    ...
                    while (i12 < itemInfo4.position) {
                        pageWidth += this.mAdapter.getPageWidth(i12) + f;
                        i12++;
                    }
                ...
                while (true) {
                    ...
                    while (i10 > itemInfo3.position) {
                        pageWidth2 -= this.mAdapter.getPageWidth(i10) + f;
                        i10--;
                    }
        ...
        while (i17 >= 0) {
            ...
            while (true) {
                ...
                pageWidth3 -= this.mAdapter.getPageWidth(i15) + f;
                i15--;
            }
        ...
        while (i19 < size2) {
            ...
            while (true) {
                ...
                pageWidth4 += this.mAdapter.getPageWidth(i18) + f;
                i18++;
            }
            if (i4 == i16) {
    ...
    private int determineTargetPage(int i, float f, int i4, int i6) {
        ...
        if (this.mItems.size() > 0) {
            return Math.max(this.mItems.get(0).position, Math.min(i, ((ItemInfo) a.b(1, this.mItems)).position));
        }
        return i;
    }

    private void dispatchOnPageScrolled(int i, float f, int i4) {
        ...
        if (list != null) {
            ...
            for (int i6 = 0; i6 < size; i6++) {
                ...
                if (onPageChangeListener2 != null) {
                    onPageChangeListener2.onPageScrolled(i, f, i4);
                }
            }
        }
        OnPageChangeListener onPageChangeListener3 = this.mInternalPageChangeListener;
        if (onPageChangeListener3 != null) {
            onPageChangeListener3.onPageScrolled(i, f, i4);
        }
    }
    ...
    private void enableLayers(boolean z4) {
        ...
        for (int i = 0; i < childCount; i++) {
            getChildAt(i).setLayerType(z4 ? this.mPageTransformerLayerType : 0, null);
        }
    }
    ...
    private ItemInfo infoForCurrentScrollPosition() {
        ...
        while (i4 < this.mItems.size()) {
            ...
            if (!z4 && itemInfo2.position != (i = i6 + 1)) {
            ...
            f = itemInfo3.offset;
            float f10 = itemInfo3.widthFactor + f + f3;
            if (!z4 && scrollX < f) {
                break;
            }
            ...
            float f11 = itemInfo3.widthFactor;
            i4++;
            i6 = i10;
            f7 = f11;
            itemInfo = itemInfo3;
    ...
    private boolean isGutterDrag(float f, float f3) {
        if (f >= this.mGutterSize || f3 <= 0.0f) {
            return f > ((float) (getWidth() - this.mGutterSize)) && f3 < 0.0f;
        }
        return true;
    }
    ...
    private boolean performDrag(float f) {
        ...
        ItemInfo itemInfo2 = (ItemInfo) a.b(1, this.mItems);
    ...
    private void recomputeScrollPosition(int i, int i4, int i6, int i10) {
        if (i4 > 0 && !this.mItems.isEmpty()) {
            if (!this.mScroller.isFinished()) {
                ...
                scrollTo((int) ((getScrollX() / (((i4 - getPaddingLeft()) - getPaddingRight()) + i10)) * (((i - getPaddingLeft()) - getPaddingRight()) + i6)), getScrollY());
                return;
            }
        }
    ...
    public boolean __replaced_14530_8_onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (i != -1) {
                ...
                if (fAbs > i4 && fAbs * 0.5f > fAbs2) {
                    ...
                    this.mLastMotionX = f > 0.0f ? f3 + f7 : f3 - f7;
                    this.mLastMotionY = y10;
    ...
    public ItemInfo addNewItem(int i, int i4) {
    ...
    */
            ...
            if (itemPosition != -1) {
                if (itemPosition == -2) {
                    ...
                    if (i4 == itemInfo.position) {
                        iMax = Math.max(0, Math.min(i4, count - 1));
                    }
                } else {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        return __replaced_14530_8_onInterceptTouchEvent(motionEvent);
    }
    ...
    */
    ...
    public void setCurrentItemInternal(int i, boolean z4, boolean z5) {
    ...
    public void smoothScrollTo(int i, int i4) {
  ...
  0x00cc: PHI (r14v6 float) = (r14v4 float), (r14v5 float), (r14v3 float) binds: [B:64:0x00f0, B:61:0x00da, B:53:0x00c1] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public void setCurrentItemInternal(int i, boolean z4, boolean z5, int i4) {
        PagerAdapter pagerAdapter = this.mAdapter;
    ...
    public void setPageTransformer(boolean z4, @Nullable PageTransformer pageTransformer, int i) {
    ...
    public void smoothScrollTo(int i, int i4, int i6) {
        int scrollX;
        if (getChildCount() == 0) {
            setScrollingCacheEnabled(false);
            return;
        ...
        float f = clientWidth;
        float f3 = i13;
        float fDistanceInfluenceForSnapDuration = (distanceInfluenceForSnapDuration(Math.min(1.0f, (Math.abs(i11) * 1.0f) / f)) * f3) + f3;
        int iAbs = Math.abs(i6);
        int iMin = Math.min(iAbs > 0 ? Math.round(Math.abs(fDistanceInfluenceForSnapDuration / iAbs) * 1000.0f) * 4 : (int) (((Math.abs(i11) / ((this.mAdapter.getPageWidth(this.mCurItem) * f) + this.mPageMargin)) + 1.0f) * 100.0f), 600);
