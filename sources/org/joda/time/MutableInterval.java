...
public class MutableInterval extends BaseInterval implements ReadWritableInterval, Cloneable, Serializable {
    ...
    @Override // org.joda.time.ReadWritableInterval
    public void setInterval(long j, long j6) {
        super.setInterval(j, j6, getChronology());
    }
    ...
    public MutableInterval(long j, long j6) {
        super(j, j6, null);
    }
    ...
    public MutableInterval(long j, long j6, Chronology chronology) {
        super(j, j6, chronology);
    }
