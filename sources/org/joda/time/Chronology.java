...
public abstract class Chronology {
    public abstract long add(long j, long j6, int i);
    ...
    public abstract int[] get(ReadablePeriod readablePeriod, long j, long j6);

    public abstract long getDateTimeMillis(int i, int i4, int i6, int i10);

    public abstract long getDateTimeMillis(int i, int i4, int i6, int i10, int i11, int i12, int i13);

    public abstract long getDateTimeMillis(long j, int i, int i4, int i6, int i10);
