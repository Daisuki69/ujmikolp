...
public class DateTimeFormat {
    ...
    public static class StyleFormatterCacheKey {
        ...
        public StyleFormatterCacheKey(int i, int i4, int i6, Locale locale) {
            this.locale = locale;
            this.combinedTypeAndStyle = i + (i4 << 4) + (i6 << 8);
        }
    ...
    private static DateTimeFormatter createDateTimeFormatter(int i, int i4) {
        StyleFormatter styleFormatter = new StyleFormatter(i, i4, i == 4 ? 1 : i4 == 4 ? 0 : 2);
    ...
    private static DateTimeFormatter createFormatterForStyle(String str) {
        if (str == null || str.length() != 2) {
            throw new IllegalArgumentException(AbstractC1414e.h("Invalid style specification: ", str));
        }
    ...
    private static DateTimeFormatter createFormatterForStyleIndex(int i, int i4) {
        int i6 = (i << 2) + i + i4;
        AtomicReferenceArray<DateTimeFormatter> atomicReferenceArray = cStyleCache;
        if (i6 >= atomicReferenceArray.length()) {
            return createDateTimeFormatter(i, i4);
        }
        DateTimeFormatter dateTimeFormatter = atomicReferenceArray.get(i6);
        if (dateTimeFormatter != null) {
            return dateTimeFormatter;
        }
        DateTimeFormatter dateTimeFormatterCreateDateTimeFormatter = createDateTimeFormatter(i, i4);
        while (!atomicReferenceArray.compareAndSet(i6, null, dateTimeFormatterCreateDateTimeFormatter)) {
            if (atomicReferenceArray.get(i6) != null) {
                return cStyleCache.get(i6);
            }
        }
    ...
    */
    ...
    private static String parseToken(String str, int[] iArr) {
        ...
        if ((cCharAt < 'A' || cCharAt > 'Z') && (cCharAt < 'a' || cCharAt > 'z')) {
            ...
            while (i < length) {
                ...
                if (cCharAt2 != '\'') {
                    if (!z4 && ((cCharAt2 >= 'A' && cCharAt2 <= 'Z') || (cCharAt2 >= 'a' && cCharAt2 <= 'z'))) {
                        i--;
                        break;
                    }
                    sb2.append(cCharAt2);
            ...
            while (true) {
                int i6 = i + 1;
                if (i6 >= length || str.charAt(i6) != cCharAt) {
                    break;
                }
                sb2.append(cCharAt);
                i = i6;
    ...
    public static class StyleFormatter implements InternalPrinter, InternalParser {
        ...
        public StyleFormatter(int i, int i4, int i6) {
            this.iDateStyle = i;
            this.iTimeStyle = i4;
            this.iType = i6;
        }
