...
public final class TimeOfDay extends BasePartial implements ReadablePartial, Serializable {
    ...
    public TimeOfDay withPeriodAdded(ReadablePeriod readablePeriod, int i) {
        ...
        for (int i4 = 0; i4 < readablePeriod.size(); i4++) {
            ...
            if (iIndexOf >= 0) {
                values = getField(iIndexOf).addWrapPartial(this, iIndexOf, values, FieldUtils.safeMultiply(readablePeriod.getValue(i4), i));
            }
        }
    ...
    public TimeOfDay(int i, int i4) {
        this(i, i4, 0, 0, null);
    }

    public TimeOfDay(int i, int i4, Chronology chronology) {
        this(i, i4, 0, 0, chronology);
    }

    public TimeOfDay(int i, int i4, int i6) {
        this(i, i4, i6, 0, null);
    }

    public TimeOfDay(int i, int i4, int i6, Chronology chronology) {
        this(i, i4, i6, 0, chronology);
    }

    public TimeOfDay(int i, int i4, int i6, int i10) {
        this(i, i4, i6, i10, null);
    }

    public TimeOfDay(int i, int i4, int i6, int i10, Chronology chronology) {
        super(new int[]{i, i4, i6, i10}, chronology);
    }
