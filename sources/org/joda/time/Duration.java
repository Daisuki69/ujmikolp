...
public final class Duration extends BaseDuration implements ReadableDuration, Serializable {
    ...
    public static Duration standardDays(long j) {
        return j == 0 ? ZERO : new Duration(FieldUtils.safeMultiply(j, DateTimeConstants.MILLIS_PER_DAY));
    }

    public static Duration standardHours(long j) {
        return j == 0 ? ZERO : new Duration(FieldUtils.safeMultiply(j, DateTimeConstants.MILLIS_PER_HOUR));
    }
