...
public final class DateMidnight extends BaseDateTime implements ReadableDateTime, Serializable {
    ...
    public DateMidnight(int i, int i4, int i6) {
        super(i, i4, i6, 0, 0, 0, 0);
    }

    public DateMidnight(int i, int i4, int i6, DateTimeZone dateTimeZone) {
        super(i, i4, i6, 0, 0, 0, 0, dateTimeZone);
    }

    public DateMidnight(int i, int i4, int i6, Chronology chronology) {
        super(i, i4, i6, 0, 0, 0, 0, chronology);
    }
}
