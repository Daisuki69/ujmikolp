...
public abstract class DateTimeField {
    ...
    public abstract int[] add(ReadablePartial readablePartial, int i, int[] iArr, int i4);

    public abstract long addWrapField(long j, int i);

    public abstract int[] addWrapField(ReadablePartial readablePartial, int i, int[] iArr, int i4);

    public abstract int[] addWrapPartial(ReadablePartial readablePartial, int i, int[] iArr, int i4);
    ...
    public abstract int[] set(ReadablePartial readablePartial, int i, int[] iArr, int i4);
