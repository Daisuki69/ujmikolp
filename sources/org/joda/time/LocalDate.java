...
public final class LocalDate extends BaseLocal implements ReadablePartial, Serializable {
    ...
    public LocalDate withPeriodAdded(ReadablePeriod readablePeriod, int i) {
        ...
        for (int i4 = 0; i4 < readablePeriod.size(); i4++) {
            long jSafeMultiply = FieldUtils.safeMultiply(readablePeriod.getValue(i4), i);
            DurationFieldType fieldType = readablePeriod.getFieldType(i4);
    ...
    public LocalDate(int i, int i4, int i6) {
        this(i, i4, i6, ISOChronology.getInstanceUTC());
    }

    public LocalDate(int i, int i4, int i6, Chronology chronology) {
        Chronology chronologyWithUTC = DateTimeUtils.getChronology(chronology).withUTC();
        long dateTimeMillis = chronologyWithUTC.getDateTimeMillis(i, i4, i6, 0);
        this.iChronology = chronologyWithUTC;
