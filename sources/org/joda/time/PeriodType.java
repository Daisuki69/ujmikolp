...
public class PeriodType implements Serializable {
    ...
    public boolean addIndexedField(ReadablePeriod readablePeriod, int i, int[] iArr, int i4) {
        if (i4 == 0) {
            return false;
        }
        int i6 = this.iIndices[i];
        if (i6 == -1) {
            throw new UnsupportedOperationException("Field is not supported");
        }
        iArr[i6] = FieldUtils.safeAdd(iArr[i6], i4);
        return true;
    }
    ...
    public int getIndexedField(ReadablePeriod readablePeriod, int i) {
        ...
        return readablePeriod.getValue(i4);
    }
    ...
    public boolean setIndexedField(ReadablePeriod readablePeriod, int i, int[] iArr, int i4) {
        int i6 = this.iIndices[i];
        if (i6 == -1) {
            throw new UnsupportedOperationException("Field is not supported");
        }
