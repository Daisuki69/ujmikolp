...
public class MutablePeriod extends BasePeriod implements ReadWritablePeriod, Cloneable, Serializable {
    ...
    @Override // org.joda.time.base.BasePeriod, org.joda.time.ReadWritablePeriod
    public void setValue(int i, int i4) {
        super.setValue(i, i4);
    }
    ...
    @Override // org.joda.time.base.BasePeriod, org.joda.time.ReadWritablePeriod
    public void setPeriod(int i, int i4, int i6, int i10, int i11, int i12, int i13, int i14) {
        super.setPeriod(i, i4, i6, i10, i11, i12, i13, i14);
    }

    public MutablePeriod(int i, int i4, int i6, int i10) {
        super(0, 0, 0, 0, i, i4, i6, i10, PeriodType.standard());
    }

    @Override // org.joda.time.ReadWritablePeriod
    public void add(int i, int i4, int i6, int i10, int i11, int i12, int i13, int i14) {
        setPeriod(FieldUtils.safeAdd(getYears(), i), FieldUtils.safeAdd(getMonths(), i4), FieldUtils.safeAdd(getWeeks(), i6), FieldUtils.safeAdd(getDays(), i10), FieldUtils.safeAdd(getHours(), i11), FieldUtils.safeAdd(getMinutes(), i12), FieldUtils.safeAdd(getSeconds(), i13), FieldUtils.safeAdd(getMillis(), i14));
    }
    ...
    public MutablePeriod(int i, int i4, int i6, int i10, int i11, int i12, int i13, int i14) {
    ...
    public MutablePeriod(int i, int i4, int i6, int i10, int i11, int i12, int i13, int i14, PeriodType periodType) {
    ...
    public MutablePeriod(long j, long j6) {
        super(j, j6, null, null);
    }

    public MutablePeriod(long j, long j6, PeriodType periodType) {
        super(j, j6, periodType, null);
    }

    public void setPeriod(long j, long j6) {
        setPeriod(j, j6, null);
    }

    public MutablePeriod(long j, long j6, Chronology chronology) {
        super(j, j6, null, chronology);
    }

    public void setPeriod(long j, long j6, Chronology chronology) {
        setValues(DateTimeUtils.getChronology(chronology).get(this, j, j6));
    }

    public MutablePeriod(long j, long j6, PeriodType periodType, Chronology chronology) {
