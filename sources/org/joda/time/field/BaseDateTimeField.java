...
public abstract class BaseDateTimeField extends DateTimeField {
    ...
    */
    ...
    public int getDifference(long j, long j6) {
        return getDurationField().getDifference(j, j6);
    }

    @Override // org.joda.time.DateTimeField
    public long getDifferenceAsLong(long j, long j6) {
        return getDurationField().getDifferenceAsLong(j, j6);
    }
    ...
    public long roundHalfEven(long j) {
        long jRoundFloor = roundFloor(j);
        long jRoundCeiling = roundCeiling(j);
        long j6 = j - jRoundFloor;
        long j7 = jRoundCeiling - j;
        return (j6 >= j7 && (j7 < j6 || (get(jRoundCeiling) & 1) == 0)) ? jRoundCeiling : jRoundFloor;
    }
    ...
    @Override // org.joda.time.DateTimeField
    public int[] set(ReadablePartial readablePartial, int i, int[] iArr, int i4) {
        FieldUtils.verifyValueBounds(this, i4, getMinimumValue(readablePartial, iArr), getMaximumValue(readablePartial, iArr));
        iArr[i] = i4;
        while (true) {
            i++;
    ...
    public long add(long j, long j6) {
        return getDurationField().add(j, j6);
    }
    ...
    */
    ...
    @Override // org.joda.time.DateTimeField
    public int[] addWrapField(ReadablePartial readablePartial, int i, int[] iArr, int i4) {
        return set(readablePartial, i, iArr, FieldUtils.getWrappedValue(iArr[i], i4, getMinimumValue(readablePartial), getMaximumValue(readablePartial)));
    }
