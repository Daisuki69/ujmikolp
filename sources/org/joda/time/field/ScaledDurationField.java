...
public class ScaledDurationField extends DecoratedDurationField {
    ...
    public int getDifference(long j, long j6) {
        return getWrappedField().getDifference(j, j6) / this.iScalar;
    }

    @Override // org.joda.time.field.DecoratedDurationField, org.joda.time.DurationField
    public long getDifferenceAsLong(long j, long j6) {
        return getWrappedField().getDifferenceAsLong(j, j6) / ((long) this.iScalar);
    }
    ...
    public int getValue(long j, long j6) {
        return getWrappedField().getValue(j, j6) / this.iScalar;
    }

    @Override // org.joda.time.field.DecoratedDurationField, org.joda.time.DurationField
    public long getValueAsLong(long j, long j6) {
        return getWrappedField().getValueAsLong(j, j6) / ((long) this.iScalar);
    }

    @Override // org.joda.time.field.DecoratedDurationField, org.joda.time.DurationField
    public long add(long j, long j6) {
        return getWrappedField().add(j, FieldUtils.safeMultiply(j6, this.iScalar));
    }
    ...
    public long getMillis(long j, long j6) {
        return getWrappedField().getMillis(FieldUtils.safeMultiply(j, this.iScalar), j6);
    }
}
