...
public class OffsetDateTimeField extends DecoratedDateTimeField {
    ...
    public OffsetDateTimeField(DateTimeField dateTimeField, DateTimeFieldType dateTimeFieldType, int i, int i4, int i6) {
        super(dateTimeField, dateTimeFieldType);
        if (i != 0) {
            this.iOffset = i;
            if (i4 < dateTimeField.getMinimumValue() + i) {
                this.iMin = dateTimeField.getMinimumValue() + i;
            } else {
                this.iMin = i4;
            }
            if (i6 > dateTimeField.getMaximumValue() + i) {
