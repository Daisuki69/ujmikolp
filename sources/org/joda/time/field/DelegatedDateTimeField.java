...
public class DelegatedDateTimeField extends DateTimeField implements Serializable {
    ...
    @Override // org.joda.time.DateTimeField
    public int[] addWrapPartial(ReadablePartial readablePartial, int i, int[] iArr, int i4) {
        return this.iField.addWrapPartial(readablePartial, i, iArr, i4);
    }
    ...
    public int[] addWrapField(ReadablePartial readablePartial, int i, int[] iArr, int i4) {
        return this.iField.addWrapField(readablePartial, i, iArr, i4);
    }
    ...
    public int[] add(ReadablePartial readablePartial, int i, int[] iArr, int i4) {
        return this.iField.add(readablePartial, i, iArr, i4);
    }
    ...
    public int[] set(ReadablePartial readablePartial, int i, int[] iArr, int i4) {
        return this.iField.set(readablePartial, i, iArr, i4);
    }
