...
public abstract class BasePeriod extends AbstractPeriod implements ReadablePeriod, Serializable {
    ...
    public BasePeriod(int i, int i4, int i6, int i10, int i11, int i12, int i13, int i14, PeriodType periodType) {
        this.iType = checkPeriodType(periodType);
        this.iValues = setPeriodInternal(i, i4, i6, i10, i11, i12, i13, i14);
    }
    ...
    public void setPeriod(int i, int i4, int i6, int i10, int i11, int i12, int i13, int i14) {
        setValues(setPeriodInternal(i, i4, i6, i10, i11, i12, i13, i14));
    }

    public BasePeriod(long j, long j6, PeriodType periodType, Chronology chronology) {
        PeriodType periodTypeCheckPeriodType = checkPeriodType(periodType);
        Chronology chronology2 = DateTimeUtils.getChronology(chronology);
        this.iType = periodTypeCheckPeriodType;
        this.iValues = chronology2.get(this, j, j6);
    }

    private int[] setPeriodInternal(int i, int i4, int i6, int i10, int i11, int i12, int i13, int i14) {
        int[] iArr = new int[size()];
        checkAndUpdate(DurationFieldType.years(), iArr, i);
        checkAndUpdate(DurationFieldType.months(), iArr, i4);
        checkAndUpdate(DurationFieldType.weeks(), iArr, i6);
        checkAndUpdate(DurationFieldType.days(), iArr, i10);
        checkAndUpdate(DurationFieldType.hours(), iArr, i11);
        checkAndUpdate(DurationFieldType.minutes(), iArr, i12);
        checkAndUpdate(DurationFieldType.seconds(), iArr, i13);
        checkAndUpdate(DurationFieldType.millis(), iArr, i14);
        return iArr;
    }
