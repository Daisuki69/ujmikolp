...
public abstract class BaseDateTime extends AbstractDateTime implements ReadableDateTime, Serializable {
    ...
    public BaseDateTime(int i, int i4, int i6, int i10, int i11, int i12, int i13) {
        this(i, i4, i6, i10, i11, i12, i13, ISOChronology.getInstance());
    }

    public BaseDateTime(int i, int i4, int i6, int i10, int i11, int i12, int i13, DateTimeZone dateTimeZone) {
        this(i, i4, i6, i10, i11, i12, i13, ISOChronology.getInstance(dateTimeZone));
    }

    public BaseDateTime(int i, int i4, int i6, int i10, int i11, int i12, int i13, Chronology chronology) {
        this.iChronology = checkChronology(chronology);
        this.iMillis = checkInstant(this.iChronology.getDateTimeMillis(i, i4, i6, i10, i11, i12, i13), this.iChronology);
        adjustForMinMax();
    }
}
