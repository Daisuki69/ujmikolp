...
public final class LocalTime extends BaseLocal implements ReadablePartial, Serializable {
    ...
    public LocalTime(int i, int i4) {
        this(i, i4, 0, 0, ISOChronology.getInstanceUTC());
    }

    public LocalTime(int i, int i4, int i6) {
        this(i, i4, i6, 0, ISOChronology.getInstanceUTC());
    }

    public LocalTime(int i, int i4, int i6, int i10) {
        this(i, i4, i6, i10, ISOChronology.getInstanceUTC());
    }

    public LocalTime(int i, int i4, int i6, int i10, Chronology chronology) {
        Chronology chronologyWithUTC = DateTimeUtils.getChronology(chronology).withUTC();
        long dateTimeMillis = chronologyWithUTC.getDateTimeMillis(0L, i, i4, i6, i10);
        this.iChronology = chronologyWithUTC;
