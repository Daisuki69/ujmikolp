...
public final class Interval extends BaseInterval implements ReadableInterval, Serializable {
    ...
    public Interval(long j, long j6, DateTimeZone dateTimeZone) {
        super(j, j6, ISOChronology.getInstance(dateTimeZone));
    }

    public Interval(long j, long j6, Chronology chronology) {
