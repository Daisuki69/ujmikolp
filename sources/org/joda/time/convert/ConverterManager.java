...
public final class ConverterManager {
    ...
    public String toString() {
        ...
        sb2.append(this.iInstantConverters.size());
        sb2.append(" instant,");
        sb2.append(this.iPartialConverters.size());
        sb2.append(" partial,");
        sb2.append(this.iDurationConverters.size());
        sb2.append(" duration,");
        sb2.append(this.iPeriodConverters.size());
        sb2.append(" period,");
        return s.o(sb2, " interval]", this.iIntervalConverters.size());
    }
}
