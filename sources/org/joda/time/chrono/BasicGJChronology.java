...
abstract class BasicGJChronology extends BasicChronology {
    ...
    static {
        ...
        while (i < 11) {
            ...
            int i4 = i + 1;
            MIN_TOTAL_MILLIS_BY_MONTH_ARRAY[i4] = j;
            j6 += ((long) MAX_DAYS_PER_MONTH_ARRAY[i]) * 86400000;
            MAX_TOTAL_MILLIS_BY_MONTH_ARRAY[i4] = j6;
            i = i4;
        }
    }
    ...
    public int getDaysInYearMonth(int i, int i4) {
        return isLeapYear(i) ? MAX_DAYS_PER_MONTH_ARRAY[i4 - 1] : MIN_DAYS_PER_MONTH_ARRAY[i4 - 1];
    }
    ...
    public long getTotalMillisByYearMonth(int i, int i4) {
        return isLeapYear(i) ? MAX_TOTAL_MILLIS_BY_MONTH_ARRAY[i4 - 1] : MIN_TOTAL_MILLIS_BY_MONTH_ARRAY[i4 - 1];
    }
    ...
    public long getYearDifference(long j, long j6) {
        ...
        long yearMillis2 = j6 - getYearMillis(year2);
