...
public abstract class AssembledChronology extends BaseChronology {
    ...
    private void setFields() {
        ...
        int i = 0;
        if (chronology2 != null) {
            int i4 = ((this.iHourOfDay == chronology2.hourOfDay() && this.iMinuteOfHour == this.iBase.minuteOfHour() && this.iSecondOfMinute == this.iBase.secondOfMinute() && this.iMillisOfSecond == this.iBase.millisOfSecond()) ? 1 : 0) | (this.iMillisOfDay == this.iBase.millisOfDay() ? 2 : 0);
    ...
    public long getDateTimeMillis(int i, int i4, int i6, int i10) throws IllegalArgumentException {
        Chronology chronology = this.iBase;
        return (chronology == null || (this.iBaseFlags & 6) != 6) ? super.getDateTimeMillis(i, i4, i6, i10) : chronology.getDateTimeMillis(i, i4, i6, i10);
    }
    ...
    public long getDateTimeMillis(int i, int i4, int i6, int i10, int i11, int i12, int i13) throws IllegalArgumentException {
        ...
        if (chronology != null && (this.iBaseFlags & 5) == 5) {
            return chronology.getDateTimeMillis(i, i4, i6, i10, i11, i12, i13);
        }
        return super.getDateTimeMillis(i, i4, i6, i10, i11, i12, i13);
    }
    ...
    public long getDateTimeMillis(long j, int i, int i4, int i6, int i10) throws IllegalArgumentException {
        ...
        if (chronology != null && (this.iBaseFlags & 1) == 1) {
            return chronology.getDateTimeMillis(j, i, i4, i6, i10);
        }
        return super.getDateTimeMillis(j, i, i4, i6, i10);
    }
}
