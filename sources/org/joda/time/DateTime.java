...
public final class DateTime extends BaseDateTime implements ReadableDateTime, Serializable {
    ...
    public DateTime withDate(int i, int i4, int i6) {
        Chronology chronology = getChronology();
        return withMillis(chronology.getZone().convertLocalToUTC(chronology.withUTC().getDateTimeMillis(i, i4, i6, getMillisOfDay()), false, getMillis()));
    }
    ...
    public DateTime withTime(int i, int i4, int i6, int i10) {
        Chronology chronology = getChronology();
        return withMillis(chronology.getZone().convertLocalToUTC(chronology.withUTC().getDateTimeMillis(getYear(), getMonthOfYear(), getDayOfMonth(), i, i4, i6, i10), false, getMillis()));
    }
    ...
    public DateTime(int i, int i4, int i6, int i10, int i11) {
        super(i, i4, i6, i10, i11, 0, 0);
    }

    public DateTime(int i, int i4, int i6, int i10, int i11, DateTimeZone dateTimeZone) {
        super(i, i4, i6, i10, i11, 0, 0, dateTimeZone);
    }

    public DateTime(int i, int i4, int i6, int i10, int i11, Chronology chronology) {
        super(i, i4, i6, i10, i11, 0, 0, chronology);
    }

    public DateTime(int i, int i4, int i6, int i10, int i11, int i12) {
        super(i, i4, i6, i10, i11, i12, 0);
    }

    public DateTime(int i, int i4, int i6, int i10, int i11, int i12, DateTimeZone dateTimeZone) {
        super(i, i4, i6, i10, i11, i12, 0, dateTimeZone);
    }

    public DateTime(int i, int i4, int i6, int i10, int i11, int i12, Chronology chronology) {
        super(i, i4, i6, i10, i11, i12, 0, chronology);
    }

    public DateTime(int i, int i4, int i6, int i10, int i11, int i12, int i13) {
        super(i, i4, i6, i10, i11, i12, i13);
    }

    public DateTime(int i, int i4, int i6, int i10, int i11, int i12, int i13, DateTimeZone dateTimeZone) {
        super(i, i4, i6, i10, i11, i12, i13, dateTimeZone);
    }

    public DateTime(int i, int i4, int i6, int i10, int i11, int i12, int i13, Chronology chronology) {
        super(i, i4, i6, i10, i11, i12, i13, chronology);
    }
}
