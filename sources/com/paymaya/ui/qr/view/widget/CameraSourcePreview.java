package com.paymaya.ui.qr.view.widget;
...
public class CameraSourcePreview extends ViewGroup {
    ...
    public final SurfaceView f14762b;
    public boolean c;
    ...
    public CameraSourcePreview(Context context, AttributeSet attributeSet) {
        ...
        this.f14762b = surfaceView;
        surfaceView.getHolder().addCallback(new f(this, 1));
        addView(surfaceView);
    }

    public final void a() {
        if (this.c && this.f14763d) {
            d dVar = this.e;
            SurfaceHolder holder = this.f14762b.getHolder();
            synchronized (dVar) {
    ...
    public final void onLayout(boolean z4, int i, int i4, int i6, int i10) {
        ...
        int i13 = this.f14761a.getResources().getConfiguration().orientation;
        if (i13 == 2) {
            int i14 = width;
            width = height;
            height = i14;
