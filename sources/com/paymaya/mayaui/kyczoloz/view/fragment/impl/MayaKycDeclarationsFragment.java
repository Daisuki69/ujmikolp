...
public class MayaKycDeclarationsFragment extends MayaKycBaseFragment<C0436a0> implements InterfaceC0287l {
    ...
    public final N f12511Y;

    public MayaKycDeclarationsFragment() {
        super(C0377l0.f3331a);
        this.f12511Y = new N(this, 9);
    }
    ...
    public final a K1() {
        ...
        j.n("mDeclarationsFragmentPresenter");
        throw null;
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        this.f12509W = new a(10);
        this.f12510X = (e0) aVar.f4685S.get();
        K1().h(this);
    }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        requireActivity().getOnBackPressedDispatcher().addCallback(this.f12511Y);
