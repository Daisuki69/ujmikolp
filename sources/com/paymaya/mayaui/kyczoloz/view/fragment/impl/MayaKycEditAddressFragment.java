...
public class MayaKycEditAddressFragment extends MayaKycBaseFragment<C0445d0> implements InterfaceC0291p {
    ...
    public final N f12529Y;

    public MayaKycEditAddressFragment() {
        super(M0.f3197a);
        this.f12529Y = new N(this, 12);
    }
    ...
    public final a K1() {
        ...
        j.n("mEditAddressFragmentPresenter");
        throw null;
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        this.f12527W = new a(11);
        this.f12528X = (e0) aVar.f4685S.get();
        K1().h(this);
    }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        requireActivity().getOnBackPressedDispatcher().addCallback(this.f12529Y);
