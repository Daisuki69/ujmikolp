...
public class MayaKycPurposeOfAccountFragment extends MayaKycBaseFragment<C0467m0> implements A {
    ...
    public final N f12581Y;

    public MayaKycPurposeOfAccountFragment() {
        super(G1.f3167a);
        this.f12581Y = new N(this, 20);
    }
    ...
    public final a K1() {
        ...
        j.n("mPurposeOfAccountFragmentPresenter");
        throw null;
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        this.f12579W = new a(15);
        this.f12580X = (e0) aVar.f4685S.get();
        K1().h(this);
    }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        requireActivity().getOnBackPressedDispatcher().addCallback(this.f12581Y);
