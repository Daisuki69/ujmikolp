...
import com.paymaya.domain.model.C$$AutoValue_BillerDetails;
import com.paymaya.domain.model.C$AutoValue_BillerDetails;
import g3.InterfaceC1498b;
import java.util.List;

/* JADX INFO: loaded from: classes4.dex */
public abstract class BillerDetails implements Parcelable, BillerItem {

    public static abstract class Builder {
        public abstract BillerDetails build();
        ...
        public abstract Builder mConfirmationUrl(@Nullable ImageUrlUnfiltered imageUrlUnfiltered);
        ...
        public abstract Builder mIconUrl(@Nullable ImageUrlUnfiltered imageUrlUnfiltered);

        public abstract Builder mListUrl(@Nullable ImageUrlUnfiltered imageUrlUnfiltered);
    ...
    public static Builder sBuilder() {
        return new C$$AutoValue_BillerDetails.Builder();
    }

    public static y typeAdapter(j jVar) {
        return new C$AutoValue_BillerDetails.GsonTypeAdapter(jVar);
    }
    ...
    public abstract ImageUrlUnfiltered mConfirmationUrl();
    ...
    public abstract ImageUrlUnfiltered mIconUrl();

    @Nullable
    @InterfaceC1498b("listUrl")
    public abstract ImageUrlUnfiltered mListUrl();
    ...
    public Biller toBiller() {
        return Biller.sBuilder().mName(mName()).mSlug(mSlug()).mHasOtherCharges(mHasOtherCharges()).mOtherFields(mOtherFields()).mCategorySlug(mCategorySlug()).mCategory(mCategory()).mListUrl(mListUrl() != null ? mListUrl().mAndroidImageUrl() : null).mIconUrl(mIconUrl() != null ? mIconUrl().mAndroidImageUrl() : null).mConfirmationUrl(mConfirmationUrl() != null ? mConfirmationUrl().mAndroidImageUrl() : null).mActive(mActive()).mAccountNumber(mAccountNumber()).mDynamicFields(mDynamicFields()).mMetadata(mMetadata()).build();
    }
