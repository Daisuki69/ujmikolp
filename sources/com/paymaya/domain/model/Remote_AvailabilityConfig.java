...
public class Remote_AvailabilityConfig<T extends AvailabilityConfig> {
    private String mAbsolutePath;
    private e mRemoteConfig = e.f();
    protected T mTarget;

    public Remote_AvailabilityConfig(@NonNull T t5, String str) {
        this.mTarget = t5;
    ...
    public void updateConfig() {
        AvailabilityConfig.Builder builder = this.mTarget.toBuilder();
