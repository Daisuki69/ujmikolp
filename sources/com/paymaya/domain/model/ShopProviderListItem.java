...
public interface ShopProviderListItem {
    ...
    public static final class VIEW_TYPE {
        ...
        public static final VIEW_TYPE VIEW_TYPE_PROVIDER = new VIEW_TYPE("VIEW_TYPE_PROVIDER", 0, 0);
        public static final VIEW_TYPE VIEW_TYPE_LOADING = new VIEW_TYPE("VIEW_TYPE_LOADING", 1, 1);

        private static final /* synthetic */ VIEW_TYPE[] $values() {
            return new VIEW_TYPE[]{VIEW_TYPE_PROVIDER, VIEW_TYPE_LOADING};
        }
