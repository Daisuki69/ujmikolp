...
public class ShareInviteHelper {
    public static LinkGenerator generateInviteUrl(Context context) {
        ...
        LinkGenerator linkGeneratorAddParameter = new LinkGenerator("af_app_invites").setBaseURL(string, string2, context.getPackageName()).setReferrerUID(appsFlyerUID).setReferrerCustomerId(AFb1wSDK.AFInAppEventType()).addParameter("af_siteid", context.getPackageName());
