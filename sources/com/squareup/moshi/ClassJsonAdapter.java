...
final class ClassJsonAdapter<T> extends JsonAdapter<T> {
    public static final JsonAdapter.Factory FACTORY = new JsonAdapter.Factory() { // from class: com.squareup.moshi.ClassJsonAdapter.1
        ...
        private boolean includeField(boolean z4, int i) {
            if (Modifier.isStatic(i) || Modifier.isTransient(i)) {
                return false;
            }
            return Modifier.isPublic(i) || Modifier.isProtected(i) || !z4;
        }
        ...
        public JsonAdapter<?> create(Type type, Set<? extends Annotation> set, Moshi moshi) {
            ...
            if (Util.isPlatformType(rawType)) {
                ...
                String strG = a.g(rawType, "Platform ");
                if (type instanceof ParameterizedType) {
                    strG = strG + " in " + type;
                }
                throw new IllegalArgumentException(s.i(strG, " requires explicit JsonAdapter to be registered"));
            }
