    ...
    */
    ...
    private String nextQuotedValue(ByteString byteString) throws IOException {
        ...
        while (true) {
            ...
            if (this.buffer.getByte(jIndexOfElement) != 92) {
                ...
                sb2.append(this.buffer.readUtf8(jIndexOfElement));
                this.buffer.readByte();
                return sb2.toString();
            }
            if (sb2 == null) {
    ...
    private int peekKeyword() throws IOException {
        ...
        while (i4 < length) {
            ...
            byte b10 = this.buffer.getByte(i4);
            if (b10 != str.charAt(i4) && b10 != str2.charAt(i4)) {
                return 0;
            }
            i4 = i6;
        }
    ...
    */
    ...
    private char readEscapeCharacter() throws IOException {
        ...
        if (b8 != 117) {
            ...
            throw syntaxError("Invalid escape sequence: \\" + ((char) b8));
        }
    ...
    private boolean skipToEndOfBlockComment() throws IOException {
        ...
        boolean z4 = jIndexOf != -1;
        Buffer buffer = this.buffer;
        buffer.skip(z4 ? jIndexOf + ((long) byteString.size()) : buffer.size());
        return z4;
    }
    ...
    public int nextInt() throws IOException {
        ...
        if (iDoPeek == 17) {
            ...
            try {
                int i6 = Integer.parseInt(strNextQuotedValue);
                this.peeked = 0;
                int[] iArr2 = this.pathIndices;
