...
public final class Internal {
    ...
    public static final <T> List<T> m186redactElements(List<? extends T> list, ProtoAdapter<T> protoAdapter) {
        return Internal__InternalKt.m188redactElements(list, protoAdapter);
    }
    ...
    public static final <T> T immutableCopyOfStruct(String str, T t5) {
    ...
    /* JADX INFO: renamed from: -redactElements, reason: not valid java name */
    public static final <K, V> Map<K, V> m187redactElements(Map<K, ? extends V> map, ProtoAdapter<V> protoAdapter) {
        return Internal__InternalKt.m189redactElements(map, protoAdapter);
    }
