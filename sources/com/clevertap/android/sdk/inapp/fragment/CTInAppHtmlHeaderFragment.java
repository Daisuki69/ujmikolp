...
public final class CTInAppHtmlHeaderFragment extends CTInAppBasePartialHtmlFragment {
    ...
    public final View w1(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        View viewInflate = layoutInflater.inflate(R.layout.inapp_html_header, viewGroup, false);
        j.d(viewInflate);
        ViewCompat.setOnApplyWindowInsetsListener(viewInflate, new c(new C0165x(23), 9));
        return viewInflate;
    }
}
