...
public final class RangeSliderActionRecorder {
    ...
    public RangeSliderActionRecorder(MeasurementProvider measurementProvider, UserActionFactory userActionFactory, RangeSliderInfo sliderInfo, String str, boolean z4) {
    ...
    public final void recordAction(Function0<Unit> function0) {
        ...
        userActionCreateUserAction.reportValue("toState", this.sliderInfo.getStartPuckPosition() + ".." + this.sliderInfo.getEndPuckPosition());
