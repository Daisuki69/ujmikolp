...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void calculateChildVisibleBoundsAtEndOfExpansion(@NonNull View view, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull MotionTiming motionTiming, @NonNull MotionTiming motionTiming2, float f, float f3, float f7, float f10, @NonNull RectF rectF) {
        float fCalculateValueOfAnimationAtEndOfExpansion = calculateValueOfAnimationAtEndOfExpansion(fabTransformationSpec, motionTiming, f, f7);
        float fCalculateValueOfAnimationAtEndOfExpansion2 = calculateValueOfAnimationAtEndOfExpansion(fabTransformationSpec, motionTiming2, f3, f10);
    ...
    @NonNull
    private Pair<MotionTiming, MotionTiming> calculateMotionTiming(float f, float f3, boolean z4, @NonNull FabTransformationSpec fabTransformationSpec) {
        MotionTiming timing;
    ...
    private float calculateValueOfAnimationAtEndOfExpansion(@NonNull FabTransformationSpec fabTransformationSpec, @NonNull MotionTiming motionTiming, float f, float f3) {
        long delay = motionTiming.getDelay();
        long duration = motionTiming.getDuration();
        MotionTiming timing = fabTransformationSpec.timings.getTiming("expansion");
        return AnimationUtils.lerp(f, f3, motionTiming.getInterpolator().getInterpolation((((timing.getDuration() + timing.getDelay()) + 17) - delay) / duration));
    }
    ...
    private void createDependencyTranslationAnimation(@NonNull View view, @NonNull View view2, boolean z4, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list) {
        ...
        Pair<MotionTiming, MotionTiming> pairCalculateMotionTiming = calculateMotionTiming(fCalculateTranslationX, fCalculateTranslationY, z4, fabTransformationSpec);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    private void createExpansionAnimation(@NonNull View view, View view2, boolean z4, boolean z5, @NonNull FabTransformationSpec fabTransformationSpec, float f, float f3, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z4) {
                ...
                animatorCreateCircularReveal = CircularRevealCompat.createCircularReveal(circularRevealWidget, fCalculateRevealCenterX, fCalculateRevealCenterY, MathUtils.distanceToFurthestCorner(fCalculateRevealCenterX, fCalculateRevealCenterY, 0.0f, 0.0f, f, f3));
                ...
                int i4 = (int) fCalculateRevealCenterY;
                createPreFillRadialExpansion(view2, timing.getDelay(), i, i4, f7, list);
                createPostFillRadialExpansion(view2, timing.getDelay(), timing.getDuration(), fabTransformationSpec.timings.getTotalDuration(), i, i4, fWidth, list);
    ...
    private void createPostFillRadialExpansion(View view, long j, long j6, long j7, int i, int i4, float f, @NonNull List<Animator> list) {
        long j9 = j + j6;
        if (j9 < j7) {
            Animator animatorCreateCircularReveal = ViewAnimationUtils.createCircularReveal(view, i, i4, f, f);
            animatorCreateCircularReveal.setStartDelay(j9);
            animatorCreateCircularReveal.setDuration(j7 - j9);
            list.add(animatorCreateCircularReveal);
        }
    }

    private void createPreFillRadialExpansion(View view, long j, int i, int i4, float f, @NonNull List<Animator> list) {
        if (j > 0) {
            Animator animatorCreateCircularReveal = ViewAnimationUtils.createCircularReveal(view, i, i4, f, f);
    ...
    @NonNull
    public AnimatorSet onCreateExpandedStateChangeAnimation(@NonNull final View view, @NonNull final View view2, final boolean z4, boolean z5) {
        FabTransformationSpec fabTransformationSpecOnCreateMotionSpec = onCreateMotionSpec(view2.getContext(), z4);
        if (z4) {
        ...
        createElevationAnimation(view, view2, z4, z5, fabTransformationSpecOnCreateMotionSpec, arrayList, arrayList2);
        RectF rectF = this.tmpRectF1;
        createTranslationAnimation(view, view2, z4, z5, fabTransformationSpecOnCreateMotionSpec, arrayList, arrayList2, rectF);
        float fWidth = rectF.width();
        float fHeight = rectF.height();
        createDependencyTranslationAnimation(view, view2, z4, fabTransformationSpecOnCreateMotionSpec, arrayList);
        createIconFadeAnimation(view, view2, z4, z5, fabTransformationSpecOnCreateMotionSpec, arrayList, arrayList2);
        createExpansionAnimation(view, view2, z4, z5, fabTransformationSpecOnCreateMotionSpec, fWidth, fHeight, arrayList, arrayList2);
        createColorAnimation(view, view2, z4, z5, fabTransformationSpecOnCreateMotionSpec, arrayList, arrayList2);
        createChildrenFadeAnimation(view, view2, z4, z5, fabTransformationSpecOnCreateMotionSpec, arrayList, arrayList2);
