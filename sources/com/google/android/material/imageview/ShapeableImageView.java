...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    ...
    private void updateShapeMask(int i, int i4) {
        this.destination.set(getPaddingLeft(), getPaddingTop(), i - getPaddingRight(), i4 - getPaddingBottom());
        this.pathProvider.calculatePath(this.shapeAppearanceModel, 1.0f, this.destination, this.path);
        this.maskPath.rewind();
        this.maskPath.addPath(this.path);
        this.maskRect.set(0.0f, 0.0f, i, i4);
    ...
    public void onSizeChanged(int i, int i4, int i6, int i10) {
        ...
        updateShapeMask(i, i4);
    }

    public void setContentPadding(@Dimension int i, @Dimension int i4, @Dimension int i6, @Dimension int i10) {
        this.startContentPadding = Integer.MIN_VALUE;
        this.endContentPadding = Integer.MIN_VALUE;
        super.setPadding((super.getPaddingLeft() - this.leftContentPadding) + i, (super.getPaddingTop() - this.topContentPadding) + i4, (super.getPaddingRight() - this.rightContentPadding) + i6, (super.getPaddingBottom() - this.bottomContentPadding) + i10);
    ...
    @RequiresApi(17)
    public void setContentPaddingRelative(@Dimension int i, @Dimension int i4, @Dimension int i6, @Dimension int i10) {
        super.setPaddingRelative((super.getPaddingStart() - getContentPaddingStart()) + i, (super.getPaddingTop() - this.topContentPadding) + i4, (super.getPaddingEnd() - getContentPaddingEnd()) + i6, (super.getPaddingBottom() - this.bottomContentPadding) + i10);
        this.leftContentPadding = isRtl() ? i6 : i;
        this.topContentPadding = i4;
        if (!isRtl()) {
            i = i6;
        }
    ...
    @Override // android.view.View
    public void setPadding(@Dimension int i, @Dimension int i4, @Dimension int i6, @Dimension int i10) {
        super.setPadding(getContentPaddingLeft() + i, getContentPaddingTop() + i4, getContentPaddingRight() + i6, getContentPaddingBottom() + i10);
    }

    @Override // android.view.View
    public void setPaddingRelative(@Dimension int i, @Dimension int i4, @Dimension int i6, @Dimension int i10) {
        super.setPaddingRelative(getContentPaddingStart() + i, getContentPaddingTop() + i4, getContentPaddingEnd() + i6, getContentPaddingBottom() + i10);
    }
    ...
    public ShapeableImageView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, R.styleable.ShapeableImageView, i, i4);
