...
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public boolean onMeasureChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, int i, int i4, int i6, int i10) {
        ...
        coordinatorLayout.onMeasureChild(view, i, i4, View.MeasureSpec.makeMeasureSpec(scrollRange, i11 == -1 ? 1073741824 : Integer.MIN_VALUE), i10);
        return true;
    }
