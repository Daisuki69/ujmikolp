...
public class TabLayout extends HorizontalScrollView {
    ...
    public class SlidingTabIndicator extends LinearLayout {
        ...
        private void updateOrRecreateIndicatorAnimation(boolean z4, final int i, int i4) {
        ...
        public void animateIndicatorToPosition(int i, int i4) {
            ValueAnimator valueAnimator = this.indicatorAnimator;
            if (valueAnimator != null && valueAnimator.isRunning()) {
                this.indicatorAnimator.cancel();
            }
            updateOrRecreateIndicatorAnimation(true, i, i4);
        }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int i, float f, int i4) {
            ...
            if (tabLayout != null) {
                ...
                tabLayout.setScrollPosition(i, f, i6 != 2 || this.previousScrollState == 1, (i6 == 2 && this.previousScrollState == 0) ? false : true);
            }
        }
        ...
        public void onPageSelected(int i) {
            ...
            try {
                ...
                if (tabLayout != null && tabLayout.getSelectedTabPosition() != i && i < tabLayout.getTabCount()) {
                    ...
                    tabLayout.selectTab(tabLayout.getTabAt(i), i4 == 0 || (i4 == 2 && this.previousScrollState == 0));
                }
    ...
    public final class TabView extends LinearLayout {
        ...
        private FrameLayout createPreApi18BadgeAnchorRoot() {
            yf3D09 yf3d09 = new yf3D09(getContext());
            yf3d09.setLayoutParams(new FrameLayout.LayoutParams(-2, -2));
            return yf3d09;
        }
        ...
        public void updateBackgroundDrawable(Context context) {
            ...
            if (TabLayout.this.tabRippleColorStateList != null) {
                ...
                rippleDrawable = new RippleDrawable(colorStateListConvertToRippleDrawableColor, gradientDrawable3, z4 ? null : gradientDrawable2);
            }
    ...
    private int calculateScrollXForTab(int i, float f) {
        View childAt;
        int i4 = this.mode;
        if ((i4 != 0 && i4 != 2) || (childAt = this.slidingTabIndicator.getChildAt(i)) == null) {
            return 0;
        }
        int i6 = i + 1;
    ...
    @NonNull
    private static ColorStateList createColorStateList(int i, int i4) {
    ...
    public boolean __replaced_14532_5_onInterceptTouchEvent(MotionEvent motionEvent) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        Context context = getContext();
        hxOD26.getInstance().gSVOV1(new eTp7v2(motionEvent, context instanceof Activity ? (Activity) context : null));
        return __replaced_14532_5_onInterceptTouchEvent(motionEvent);
    }
    ...
    */
    ...
    public void setScrollPosition(int i, float f, boolean z4, boolean z5) {
    ...
    public TabLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, iArr, i, i4, i6);
        ...
        try {
            ...
            if (typedArrayObtainStyledAttributes.hasValue(i10)) {
                this.tabTextColors = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, i10);
            }
            int i11 = R.styleable.TabLayout_tabSelectedTextColor;
            if (typedArrayObtainStyledAttributes.hasValue(i11)) {
                this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), typedArrayObtainStyledAttributes.getColor(i11, 0));
            }
    ...
    public void setTabTextColors(int i, int i4) {
        setTabTextColors(createColorStateList(i, i4));
    }
