...
public final class IndeterminateDrawable<S extends BaseProgressIndicatorSpec> extends DrawableWithAnimatedVisibilityChange {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        while (true) {
            ...
            int i4 = i * 2;
            drawingDelegate.fillIndicator(canvas, paint, fArr[i4], fArr[i4 + 1], iArr[i]);
            i++;
        }
    }
    ...
    public boolean setVisibleInternal(boolean z4, boolean z5, boolean z8) {
        boolean visibleInternal = super.setVisibleInternal(z4, z5, z8);
        if (!isRunning()) {
    ...
    @Override // com.google.android.material.progressindicator.DrawableWithAnimatedVisibilityChange
    public /* bridge */ /* synthetic */ boolean setVisible(boolean z4, boolean z5, boolean z8) {
        return super.setVisible(z4, z5, z8);
    }
}
