...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    public BaseProgressIndicator(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i4) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.BaseProgressIndicator, i, i4, new int[0]);
    ...
    public void setTrackCornerRadius(@Px int i) {
        S s9 = this.spec;
        if (s9.trackCornerRadius != i) {
            s9.trackCornerRadius = Math.min(i, s9.trackThickness / 2);
        }
    }

    public void setTrackThickness(@Px int i) {
        S s9 = this.spec;
        if (s9.trackThickness != i) {
            s9.trackThickness = i;
            requestLayout();
        }
    }
