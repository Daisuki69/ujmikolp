...
final class LinearIndeterminateDisjointAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private void updateSegmentPositions(int i) {
        for (int i4 = 0; i4 < 4; i4++) {
            this.segmentPositions[i4] = Math.max(0.0f, Math.min(1.0f, this.interpolatorArray[i4].getInterpolation(getFractionInRange(i, DELAY_TO_MOVE_SEGMENT_ENDS[i4], DURATION_TO_MOVE_SEGMENT_ENDS[i4]))));
        }
    }
