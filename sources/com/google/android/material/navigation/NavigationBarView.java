...
public abstract class NavigationBarView extends FrameLayout {
    ...
    public NavigationBarView(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i4) {
        ...
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, iArr, i, i4, i6, i10);
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i11)) {
            navigationBarMenuViewCreateNavigationBarMenuView.setIconTintList(tintTypedArrayObtainTintedStyledAttributes.getColorStateList(i11));
        } else {
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i10)) {
            setItemTextAppearanceActive(tintTypedArrayObtainTintedStyledAttributes.getResourceId(i10, 0));
        }
        int i12 = R.styleable.NavigationBarView_itemTextColor;
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i12)) {
            setItemTextColor(tintTypedArrayObtainTintedStyledAttributes.getColorStateList(i12));
        }
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i13)) {
            setItemPaddingTop(tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(i13, 0));
        }
        int i14 = R.styleable.NavigationBarView_itemPaddingBottom;
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i14)) {
            setItemPaddingBottom(tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(i14, 0));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(R.styleable.NavigationBarView_elevation)) {
            setElevation(tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(r9, 0));
        }
