...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public static class ActiveIndicatorTransform {
        ...
        public float calculateAlpha(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f3) {
            return AnimationUtils.lerp(0.0f, 1.0f, f3 == 0.0f ? 0.8f : 0.0f, f3 == 0.0f ? 1.0f : 0.2f, f);
        }

        public float calculateScaleX(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f3) {
            return AnimationUtils.lerp(SCALE_X_HIDDEN, 1.0f, f);
        }

        public float calculateScaleY(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f3) {
            return 1.0f;
        }

        public void updateForProgress(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f3, @NonNull View view) {
            view.setScaleX(calculateScaleX(f, f3));
            view.setScaleY(calculateScaleY(f, f3));
            view.setAlpha(calculateAlpha(f, f3));
        }
    }
    ...
    public static class ActiveIndicatorUnlabeledTransform extends ActiveIndicatorTransform {
        ...
        public float calculateScaleY(float f, float f3) {
            return calculateScaleX(f, f3);
        }
    }
    ...
    private void calculateTextScaleFactors(float f, float f3) {
        this.shiftAmount = f - f3;
        this.scaleUpFactor = (f3 * 1.0f) / f;
        this.scaleDownFactor = (f * 1.0f) / f3;
    }
    ...
    private void maybeAnimateActiveIndicatorToProgress(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) final float f) {
    ...
    public void setActiveIndicatorProgress(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f, float f3) {
        View view = this.activeIndicatorView;
        if (view != null) {
            this.activeIndicatorTransform.updateForProgress(f, f3, view);
        }
    ...
    private static void setViewScaleValues(@NonNull View view, float f, float f3, int i) {
        view.setScaleX(f);
        view.setScaleY(f3);
        view.setVisibility(i);
    }

    private static void setViewTopMarginAndGravity(@NonNull View view, int i, int i4) {
    ...
    @Override // android.view.View
    public void onSizeChanged(final int i, int i4, int i6, int i10) {
