...
final class IndicatorViewController {
    ...
    private void createCaptionAnimators(@NonNull List<Animator> list, boolean z4, @Nullable TextView textView, int i, int i4, int i6) {
        if (textView == null || !z4) {
            return;
        }
        if (i == i6 || i == i4) {
            list.add(createCaptionOpacityAnimator(textView, i6 == i));
            if (i6 == i) {
    ...
    private int getIndicatorPadding(boolean z4, @DimenRes int i, int i4) {
        return z4 ? this.context.getResources().getDimensionPixelSize(i) : i4;
    }
    ...
    private void setCaptionViewVisibilities(int i, int i4) {
    ...
    private void updateCaptionViewsVisibility(final int i, final int i4, boolean z4) {
        ...
        if (z4) {
            ...
            indicatorViewController.createCaptionAnimators(arrayList, this.helperTextEnabled, this.helperTextView, 2, i, i4);
            indicatorViewController.createCaptionAnimators(arrayList, indicatorViewController.errorEnabled, indicatorViewController.errorView, 1, i, i4);
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.textfield.IndicatorViewController.1
                ...
                public void onAnimationEnd(Animator animator) {
                    IndicatorViewController.this.captionDisplayed = i4;
            ...
            indicatorViewController = this;
            setCaptionViewVisibilities(i, i4);
        }
    ...
    public void addIndicator(TextView textView, int i) {
        if (this.indicatorArea == null && this.captionArea == null) {
            d8NVX3 d8nvx3 = new d8NVX3(this.context);
            this.indicatorArea = d8nvx3;
            d8nvx3.setOrientation(0);
            this.textInputView.addView(this.indicatorArea, -1, -2);
            this.captionArea = new yf3D09(this.context);
