...
class MaterialButtonHelper {
    ...
    private MaterialShapeDrawable getMaterialShapeDrawable(boolean z4) {
        ...
        return IS_MIN_LOLLIPOP ? (MaterialShapeDrawable) ((LayerDrawable) ((InsetDrawable) this.rippleDrawable.getDrawable(0)).getDrawable()).getDrawable(!z4 ? 1 : 0) : (MaterialShapeDrawable) this.rippleDrawable.getDrawable(!z4 ? 1 : 0);
    }
    ...
    private void setVerticalInsets(@Dimension int i, @Dimension int i4) {
        ...
        ViewCompat.setPaddingRelative(this.materialButton, paddingStart, (paddingTop + i) - i6, paddingEnd, (paddingBottom + i4) - i10);
    }
    ...
    public void setRippleColor(@Nullable ColorStateList colorStateList) {
        if (this.rippleColor != colorStateList) {
            ...
            if (z4 && (this.materialButton.getBackground() instanceof RippleDrawable)) {
                ...
                if (z4 || !(this.materialButton.getBackground() instanceof RippleDrawableCompat)) {
                    return;
                }
    ...
    public void updateMaskBounds(int i, int i4) {
        Drawable drawable = this.maskDrawable;
        if (drawable != null) {
            drawable.setBounds(this.insetLeft, this.insetTop, i4 - this.insetRight, i - this.insetBottom);
        }
    }
