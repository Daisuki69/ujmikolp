...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public interface OnButtonCheckedListener {
        void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup, @IdRes int i, boolean z4);
    }
    ...
    private void checkInternal(@IdRes int i, boolean z4) {
        if (i == -1) {
            s.y(i, "Button ID is not valid: ", LOG_TAG);
            return;
        }
    ...
    private void dispatchOnButtonChecked(@IdRes int i, boolean z4) {
        Iterator<OnButtonCheckedListener> it = this.onButtonCheckedListeners.iterator();
        while (it.hasNext()) {
            it.next().onButtonChecked(this, i, z4);
        }
    }
    ...
    @Nullable
    private CornerData getNewCornerData(int i, int i4, int i6) {
    ...
    private void setCheckedStateForView(@IdRes int i, boolean z4) {
        View viewFindViewById = findViewById(i);
        if (viewFindViewById instanceof MaterialButton) {
            this.skipCheckedStateTracker = true;
            ((MaterialButton) viewFindViewById).setChecked(z4);
    ...
    public MaterialButtonToggleGroup(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, R.styleable.MaterialButtonToggleGroup, i, i4, new int[0]);
