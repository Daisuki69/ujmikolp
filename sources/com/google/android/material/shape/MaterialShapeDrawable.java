...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    private void maybeDrawCompatShadow(@NonNull Canvas canvas) {
        if (hasCompatShadow()) {
            ...
            canvas.drawBitmap(bitmapCreateBitmap, f, f3, (Paint) null);
            bitmapCreateBitmap.recycle();
            canvas.restore();
        }
    }

    private static int modulateAlpha(int i, int i4) {
        return ((i4 + (i4 >>> 7)) * i) >>> 8;
    }
    ...
    @Deprecated
    public void getPathForSize(int i, int i4, @NonNull Path path) {
        calculatePathForSize(new RectF(0.0f, 0.0f, i, i4), path);
    }
    ...
    public boolean isPointInTransparentRegion(int i, int i4) {
        return getTransparentRegion().contains(i, i4);
    }
    ...
    public void setPadding(int i, int i4, int i6, int i10) {
        ...
        this.drawableState.padding.set(i, i4, i6, i10);
        invalidateSelf();
    }
    ...
    public MaterialShapeDrawable(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i4) {
        this(ShapeAppearanceModel.builder(context, attributeSet, i, i4).build());
    }
