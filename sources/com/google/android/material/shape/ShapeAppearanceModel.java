...
public class ShapeAppearanceModel {
    ...
    @NonNull
    public static Builder builder(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i4) {
        return builder(context, attributeSet, i, i4, 0);
    }
    ...
    @NonNull
    public static Builder builder(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i4, int i6) {
        return builder(context, attributeSet, i, i4, new AbsoluteCornerSize(i6));
    }

    @NonNull
    public static Builder builder(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i4, @NonNull CornerSize cornerSize) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.MaterialShape, i, i4);
    ...
    @NonNull
    public static Builder builder(Context context, @StyleRes int i, @StyleRes int i4) {
        return builder(context, i, i4, 0);
    }

    @NonNull
    private static Builder builder(Context context, @StyleRes int i, @StyleRes int i4, int i6) {
        return builder(context, i, i4, new AbsoluteCornerSize(i6));
    }

    @NonNull
    private static Builder builder(Context context, @StyleRes int i, @StyleRes int i4, @NonNull CornerSize cornerSize) {
        if (i4 != 0) {
        ...
        try {
            ...
            int i10 = typedArrayObtainStyledAttributes.getInt(R.styleable.ShapeAppearance_cornerFamilyTopLeft, i6);
            int i11 = typedArrayObtainStyledAttributes.getInt(R.styleable.ShapeAppearance_cornerFamilyTopRight, i6);
            int i12 = typedArrayObtainStyledAttributes.getInt(R.styleable.ShapeAppearance_cornerFamilyBottomRight, i6);
            int i13 = typedArrayObtainStyledAttributes.getInt(R.styleable.ShapeAppearance_cornerFamilyBottomLeft, i6);
