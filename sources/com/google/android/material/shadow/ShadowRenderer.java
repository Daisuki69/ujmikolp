...
public class ShadowRenderer {
    ...
    public void drawCornerShadow(@NonNull Canvas canvas, @Nullable Matrix matrix, @NonNull RectF rectF, int i, float f, float f3) {
        float f7;
        boolean z4 = f3 < 0.0f;
        ...
        canvas.drawArc(rectF, f7, f3, true, this.cornerShadowPaint);
        canvas.restore();
    }
