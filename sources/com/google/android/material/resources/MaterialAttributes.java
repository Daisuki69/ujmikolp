...
public class MaterialAttributes {
    ...
    public static boolean resolveBoolean(@NonNull Context context, @AttrRes int i, boolean z4) {
        TypedValue typedValueResolve = resolve(context, i);
        return (typedValueResolve == null || typedValueResolve.type != 18) ? z4 : typedValueResolve.data != 0;
    }
    ...
    @Px
    public static int resolveDimension(@NonNull Context context, @AttrRes int i, @DimenRes int i4) {
        TypedValue typedValueResolve = resolve(context, i);
    ...
    public static int resolveInteger(@NonNull Context context, @AttrRes int i, int i4) {
        TypedValue typedValueResolve = resolve(context, i);
