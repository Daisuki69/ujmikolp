...
final class ColorResourcesTableCreator {
    ...
    public static class ColorResource {
        ...
        public ColorResource(int i, String str, int i4) {
            this.name = str;
            this.value = i4;
    ...
    public static class ResChunkHeader {
        ...
        public ResChunkHeader(short s9, short s10, int i) {
            this.type = s9;
            this.headerSize = s10;
            this.chunkSize = i;
        }
    ...
    public static class ResEntry {
        ...
        public ResEntry(int i, @ColorInt int i4) {
    ...
    public static class StringPoolChunk {
        ...
        public StringPoolChunk(boolean z4, String... strArr) {
            ...
            int i6 = length + i4;
            this.styledSpansStart = z5 ? size3 + i6 : 0;
            int i10 = size3 + i6 + (z5 ? size : 0);
            this.chunkSize = i10;
            this.header = new ResChunkHeader((short) 1, HEADER_SIZE, i10);
        }
    }
        ...
        public TypeChunk(List<ColorResource> list, Set<Short> set, int i) {
            ...
            for (short s9 = 0; s9 < i; s9 = (short) (s9 + 1)) {
                if (set.contains(Short.valueOf(s9))) {
                    this.offsetTable[s9] = i6;
                    i6 += 16;
                } else {
                    this.offsetTable[s9] = -1;
                }
            }
    ...
    public static class TypeSpecChunk {
        ...
        public TypeSpecChunk(List<ColorResource> list) {
            this.entryCount = ((ColorResource) s.e(1, list)).entryId + 1;
    ...
    public static byte[] create(Context context, Map<Integer, Integer> map) throws IOException {
        ...
        for (Map.Entry<Integer, Integer> entry : map.entrySet()) {
            ...
            if (!context.getResources().getResourceTypeName(entry.getKey().intValue()).equals("color")) {
                ...
                sb2.append(colorResource2.name);
                sb2.append(", typeId=");
                throw new IllegalArgumentException(a.e(colorResource2.typeId & 255, sb2));
            }
    ...
    public static byte[] stringToByteArray(String str) {
        ...
        for (int i = 0; i < charArray.length; i++) {
            ...
            int i4 = i * 2;
            bArr[i4 + 2] = bArrCharToByteArray[0];
            bArr[i4 + 3] = bArrCharToByteArray[1];
        }
        bArr[length + 2] = 0;
        bArr[length + 3] = 0;
        return bArr;
