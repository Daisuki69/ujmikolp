...
public final class MaterialCalendar<S> extends PickerFragment<S> {
                        ...
                        if (l6 != null && pair.second != null) {
                            ...
                            for (int i = spanCount; i <= spanCount2; i++) {
                                ...
                                if (viewFindViewByPosition3 != null) {
                                    ...
                                    canvas.drawRect(i == spanCount ? (viewFindViewByPosition.getWidth() / 2) + viewFindViewByPosition.getLeft() : 0, top, i == spanCount2 ? (viewFindViewByPosition2.getWidth() / 2) + viewFindViewByPosition2.getLeft() : recyclerView.getWidth(), bottom, MaterialCalendar.this.calendarStyle.rangeFill);
                                }
                            }
                        }
                    }
    ...
    private static int getDialogPickerHeight(@NonNull Context context) {
        ...
        return s.b(dimensionPixelOffset, dimensionPixelSize, (resources.getDimensionPixelOffset(R.dimen.mtrl_calendar_month_vertical_padding) * (i - 1)) + (resources.getDimensionPixelSize(R.dimen.mtrl_calendar_day_height) * i), resources.getDimensionPixelOffset(R.dimen.mtrl_calendar_bottom_padding));
    }
