...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(viewFindViewById, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker.3
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                ...
                if (i >= 0) {
                    viewFindViewById.getLayoutParams().height = i + i4;
                    View view2 = viewFindViewById;
                    view2.setLayoutParams(view2.getLayoutParams());
                }
                View view3 = viewFindViewById;
                view3.setPadding(view3.getPaddingLeft(), paddingTop + i4, viewFindViewById.getPaddingRight(), viewFindViewById.getPaddingBottom());
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        vjtnx1 vjtnx1Var = new vjtnx1(requireContext(), getThemeResId(requireContext()));
        Context context = vjtnx1Var.getContext();
        ...
        this.background.setElevation(ViewCompat.getElevation(vjtnx1Var.getWindow().getDecorView()));
        return vjtnx1Var;
    }
