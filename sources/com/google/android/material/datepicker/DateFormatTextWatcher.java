...
abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    public DateFormatTextWatcher(final String str, DateFormat dateFormat, @NonNull TextInputLayout textInputLayout, CalendarConstraints calendarConstraints) {
        ...
        this.setErrorCallback = new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher.1
            ...
            public void run() {
                ...
                textInputLayout2.setError(context.getString(R.string.mtrl_picker_invalid_format) + Global.NEWLINE + String.format(context.getString(R.string.mtrl_picker_invalid_format_use), str) + Global.NEWLINE + String.format(context.getString(R.string.mtrl_picker_invalid_format_example), dateFormat2.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis()))));
    ...
    public void onTextChanged(@NonNull CharSequence charSequence, int i, int i4, int i6) {
