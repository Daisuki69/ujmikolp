...
class UtcDates {
    ...
    private static int findCharactersInDateFormatPattern(@NonNull String str, @NonNull String str2, int i, int i4) {
    ...
    private static String removeYearFromDateFormatPattern(@NonNull String str) {
        ...
        return str.replace(str.substring(findCharactersInDateFormatPattern(str, iFindCharactersInDateFormatPattern2 < str.length() ? "EMd," : "EMd", -1, iFindCharactersInDateFormatPattern) + 1, iFindCharactersInDateFormatPattern2), Global.BLANK).trim();
    }
