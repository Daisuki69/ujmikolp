...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public void updateTime(int i, int i4, int i6) {
        ...
        String str2 = String.format(locale, TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(i4));
    ...
    public void setHandRotation(float f, boolean z4) {
        this.clockHandView.setHandRotation(f, z4);
    }
    ...
    public TimePickerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() { // from class: com.google.android.material.timepicker.TimePickerView.2
            ...
            public void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup2, int i4, boolean z4) {
                int i6 = i4 == R.id.material_clock_period_pm_button ? 1 : 0;
