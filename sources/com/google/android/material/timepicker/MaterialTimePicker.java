...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    private Pair<Integer, Integer> dataForMode(int i) {
        ...
        throw new IllegalArgumentException(s.f(i, "no icon for mode: "));
    }
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        vjtnx1 vjtnx1Var = new vjtnx1(requireContext(), getThemeResId());
        ...
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, i, i4);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, R.styleable.MaterialTimePicker, i, i4);
