...
public class MotionSpec {
    ...
    public <T> ObjectAnimator getAnimator(@NonNull String str, @NonNull T t5, @NonNull Property<T, ?> property) {
        ObjectAnimator objectAnimatorOfPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(t5, getPropertyValues(str));
    ...
    public String toString() {
        return Global.NEWLINE + getClass().getName() + '{' + Integer.toHexString(System.identityHashCode(this)) + " timings: " + this.timings + "}\n";
    }
}
