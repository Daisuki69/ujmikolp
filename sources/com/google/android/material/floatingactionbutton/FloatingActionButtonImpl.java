...
class FloatingActionButtonImpl {
    ...
    public void calculateImageMatrixFromScale(float f, @NonNull Matrix matrix) {
        ...
        matrix.postScale(f, f, i4 / 2.0f, i4 / 2.0f);
    }

    @NonNull
    private AnimatorSet createAnimator(@NonNull MotionSpec motionSpec, float f, float f3, float f7) {
    ...
    private AnimatorSet createDefaultAnimator(final float f, final float f3, final float f7) {
        AnimatorSet animatorSet = new AnimatorSet();
        ArrayList arrayList = new ArrayList();
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.4
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                FloatingActionButtonImpl.this.imageMatrixScale = AnimationUtils.lerp(f10, f7, fFloatValue);
                FloatingActionButtonImpl.this.calculateImageMatrixFromScale(AnimationUtils.lerp(f10, f7, fFloatValue), matrix);
    ...
    private void workAroundOreoBug(ObjectAnimator objectAnimator) {
        ...
        objectAnimator.setEvaluator(new TypeEvaluator<Float>() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.5
            ...
            public Float evaluate(float f, Float f3, Float f7) {
                float fFloatValue = this.floatEvaluator.evaluate(f, (Number) f3, (Number) f7).floatValue();
                if (fFloatValue < 0.1f) {
                    fFloatValue = 0.0f;
                }
