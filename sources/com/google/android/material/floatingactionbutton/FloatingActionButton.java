...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    public class ShadowDelegateImpl implements ShadowViewDelegate {
        ...
        @Override // com.google.android.material.shadow.ShadowViewDelegate
        public void setShadowPadding(int i, int i4, int i6, int i10) {
            FloatingActionButton.this.shadowPadding.set(i, i4, i6, i10);
            FloatingActionButton floatingActionButton = FloatingActionButton.this;
            floatingActionButton.setPadding(floatingActionButton.imagePadding + i, FloatingActionButton.this.imagePadding + i4, FloatingActionButton.this.imagePadding + i6, FloatingActionButton.this.imagePadding + i10);
        }
    }
    ...
    private static int resolveAdjustedSize(int i, int i4) {
    ...
    public void onMeasure(int i, int i4) {
        ...
        int iMin = Math.min(resolveAdjustedSize(sizeDimension, i), resolveAdjustedSize(sizeDimension, i4));
    ...
    public FloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.FloatingActionButton, i, i4, new int[0]);
        ...
        ShapeAppearanceModel shapeAppearanceModelBuild = ShapeAppearanceModel.builder(context2, attributeSet, i, i4, ShapeAppearanceModel.PILL).build();
        boolean z4 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.FloatingActionButton_ensureMinTouchTargetSize, false);
    ...
    public void hide(@Nullable OnVisibilityChangedListener onVisibilityChangedListener, boolean z4) {
        getImpl().hide(wrapOnVisibilityChangedListener(onVisibilityChangedListener), z4);
    }

    public void show(@Nullable OnVisibilityChangedListener onVisibilityChangedListener, boolean z4) {
