...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    public class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public ChangeSizeStrategy(AnimatorTracker animatorTracker, Size size, boolean z4) {
    ...
    public static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public void extendOrShow(@NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            extendedFloatingActionButton.performMotion(z4 ? extendedFloatingActionButton.extendStrategy : extendedFloatingActionButton.showStrategy, z4 ? this.internalAutoShrinkCallback : this.internalAutoHideCallback);
        }
        ...
        public void shrinkOrHide(@NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            boolean z4 = this.autoShrinkEnabled;
            extendedFloatingActionButton.performMotion(z4 ? extendedFloatingActionButton.shrinkStrategy : extendedFloatingActionButton.hideStrategy, z4 ? this.internalAutoShrinkCallback : this.internalAutoHideCallback);
        }
    ...
    @Override // android.widget.TextView, android.view.View
    public void setPaddingRelative(int i, int i4, int i6, int i10) {
        super.setPaddingRelative(i, i4, i6, i10);
        if (!this.isExtended || this.isTransforming) {
            return;
        }
    ...
    public ExtendedFloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.ExtendedFloatingActionButton, i, i4, new int[0]);
        ...
        typedArrayObtainStyledAttributes.recycle();
        setShapeAppearanceModel(ShapeAppearanceModel.builder(context2, attributeSet, i, i4, ShapeAppearanceModel.PILL).build());
        saveOriginalTextCsl();
    }
