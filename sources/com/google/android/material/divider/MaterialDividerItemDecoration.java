...
public class MaterialDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void drawForHorizontalOrientation(@NonNull Canvas canvas, @NonNull RecyclerView recyclerView) {
        ...
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            this.dividerDrawable.setBounds((iRound - this.dividerDrawable.getIntrinsicWidth()) - this.thickness, i, iRound, i4);
    ...
    private void drawForVerticalOrientation(@NonNull Canvas canvas, @NonNull RecyclerView recyclerView) {
        ...
        int i = paddingLeft + (z4 ? this.insetEnd : this.insetStart);
        int i4 = width - (z4 ? this.insetStart : this.insetEnd);
        int childCount = recyclerView.getChildCount();
        ...
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            this.dividerDrawable.setBounds(i, (iRound - this.dividerDrawable.getIntrinsicHeight()) - this.thickness, i4, iRound);
            this.dividerDrawable.draw(canvas);
        }
        canvas.restore();
    }
    ...
    public void setOrientation(int i) {
        if (i != 0 && i != 1) {
            throw new IllegalArgumentException(s.g(i, "Invalid orientation: ", ". It should be either HORIZONTAL or VERTICAL"));
        }
        this.orientation = i;
    }
    ...
    public MaterialDividerItemDecoration(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i4) {
