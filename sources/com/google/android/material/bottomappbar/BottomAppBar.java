...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        @Override // com.google.android.material.behavior.HideBottomViewOnScrollBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
        public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull BottomAppBar bottomAppBar, @NonNull View view, @NonNull View view2, int i, int i4) {
            return bottomAppBar.getHideOnScroll() && super.onStartNestedScroll(coordinatorLayout, bottomAppBar, view, view2, i, i4);
        }
    ...
    private void createMenuViewTranslationAnimation(final int i, final boolean z4, @NonNull List<Animator> list) {
        final ActionMenuView actionMenuView = getActionMenuView();
        if (actionMenuView == null) {
            return;
        }
        Animator animatorOfFloat = ObjectAnimator.ofFloat(actionMenuView, "alpha", 1.0f);
        if (Math.abs(actionMenuView.getTranslationX() - getActionMenuViewTranslationX(actionMenuView, i, z4)) <= 1.0f) {
            ...
            objectAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.bottomappbar.BottomAppBar.7
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    BottomAppBar.this.translateActionMenuView(actionMenuView, i, z4, z5);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void maybeAnimateMenuView(int i, boolean z4) {
        ...
        createMenuViewTranslationAnimation(i, z4, arrayList);
        AnimatorSet animatorSet = new AnimatorSet();
    ...
    private void translateActionMenuView(@NonNull ActionMenuView actionMenuView, int i, boolean z4) {
        translateActionMenuView(actionMenuView, i, z4, false);
    }
    ...
    public int getActionMenuViewTranslationX(@NonNull ActionMenuView actionMenuView, int i, boolean z4) {
        if (i != 1 || !z4) {
            return 0;
        }
        boolean zIsLayoutRtl = ViewUtils.isLayoutRtl(this);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void translateActionMenuView(@NonNull final ActionMenuView actionMenuView, final int i, final boolean z4, boolean z5) {
        Runnable runnable = new Runnable() { // from class: com.google.android.material.bottomappbar.BottomAppBar.8
            @Override // java.lang.Runnable
            public void run() {
                actionMenuView.setTranslationX(BottomAppBar.this.getActionMenuViewTranslationX(r0, i, z4));
            }
        };
        if (z5) {
    ...
    public BottomAppBar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.BottomAppBar, i, i4, new int[0]);
        ...
        int i6 = R.styleable.BottomAppBar_navigationIconTint;
        ...
        ViewUtils.doOnApplyWindowInsets(this, attributeSet, i, i4, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.3
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, @NonNull WindowInsetsCompat windowInsetsCompat, @NonNull ViewUtils.RelativePadding relativePadding) {
                ...
                if (BottomAppBar.this.paddingLeftSystemWindowInsets) {
                    z4 = BottomAppBar.this.leftInset != windowInsetsCompat.getSystemWindowInsetLeft();
                ...
                if (BottomAppBar.this.paddingRightSystemWindowInsets) {
                    boolean z8 = BottomAppBar.this.rightInset != windowInsetsCompat.getSystemWindowInsetRight();
