...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    public class ChipTouchHelper extends ExploreByTouchHelper {
        ...
        public int getVirtualViewAt(float f, float f3) {
            return (Chip.this.hasCloseIcon() && Chip.this.getCloseIconTouchBounds().contains(f, f3)) ? 1 : 0;
        }
    ...
    private void insetChipBackgroundDrawable(int i, int i4, int i6, int i10) {
        this.insetBackgroundDrawable = new InsetDrawable((Drawable) this.chipDrawable, i, i4, i6, i10);
    }
    ...
    public boolean ensureAccessibleTouchTarget(@Dimension int i) {
        ...
        insetChipBackgroundDrawable(i4, i6, i4, i6);
        updateBackgroundDrawable();
        return true;
    }
    ...
    public void onFocusChanged(boolean z4, int i, Rect rect) {
        ...
        if (this.touchHelperEnabled) {
            this.touchHelper.onFocusChanged(z4, i, rect);
        }
    }
    ...
    */
    ...
    public void setCompoundDrawablesRelativeWithIntrinsicBounds(int i, int i4, int i6, int i10) {
        ...
        super.setCompoundDrawablesRelativeWithIntrinsicBounds(i, i4, i6, i10);
    }
    ...
    public void setCompoundDrawablesWithIntrinsicBounds(int i, int i4, int i6, int i10) {
        ...
        super.setCompoundDrawablesWithIntrinsicBounds(i, i4, i6, i10);
    }
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        ChipDrawable chipDrawableCreateFromAttributes = ChipDrawable.createFromAttributes(context2, attributeSet, i, i4);
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.Chip, i, i4, new int[0]);
        ...
        super.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.google.android.material.chip.Chip.2
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean z4) {
                if (Chip.this.onCheckedChangeListenerInternal != null) {
                    Chip.this.onCheckedChangeListenerInternal.onCheckedChanged(Chip.this, z4);
                }
                if (Chip.this.onCheckedChangeListener != null) {
                    Chip.this.onCheckedChangeListener.onCheckedChanged(compoundButton, z4);
                }
            }
        });
    }
