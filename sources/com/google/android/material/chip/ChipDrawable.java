...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private ChipDrawable(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i4) {
    ...
    @NonNull
    public static ChipDrawable createFromAttributes(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i4) {
        ChipDrawable chipDrawable = new ChipDrawable(context, attributeSet, i, i4);
        chipDrawable.loadFromAttributes(attributeSet, i, i4);
        return chipDrawable;
    }
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i4) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, com.google.android.material.R.styleable.Chip, i, i4, new int[0]);
    ...
    private boolean onStateChange(@NonNull int[] iArr, @NonNull int[] iArr2) {
        ...
        boolean z5 = hasState(getState(), R.attr.state_checked) && this.checkable;
