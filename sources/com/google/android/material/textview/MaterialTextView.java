...
public class MaterialTextView extends AppCompatTextView {
    ...
    private static int findViewAppearanceResourceId(@NonNull Resources.Theme theme, @Nullable AttributeSet attributeSet, int i, int i4) {
        TypedArray typedArrayObtainStyledAttributes = theme.obtainStyledAttributes(attributeSet, R.styleable.MaterialTextView, i, i4);
    ...
    private static boolean viewAttrsHasLineHeight(@NonNull Context context, @NonNull Resources.Theme theme, @Nullable AttributeSet attributeSet, int i, int i4) {
        TypedArray typedArrayObtainStyledAttributes = theme.obtainStyledAttributes(attributeSet, R.styleable.MaterialTextView, i, i4);
    ...
    public MaterialTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i4) {
        ...
        if (canApplyTextAppearanceLineHeight(context2)) {
            ...
            if (viewAttrsHasLineHeight(context2, theme, attributeSet, i, i4) || (iFindViewAppearanceResourceId = findViewAppearanceResourceId(theme, attributeSet, i, i4)) == -1) {
                return;
            }
