...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    @Override // androidx.cardview.widget.CardView, android.view.ViewGroup
    ...
    public void setAncestorContentPadding(int i, int i4, int i6, int i10) {
        super.setContentPadding(i, i4, i6, i10);
    }
    ...
    @Override // androidx.cardview.widget.CardView
    public void setContentPadding(int i, int i4, int i6, int i10) {
        this.cardViewHelper.setUserContentPadding(i, i4, i6, i10);
    }
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, com.google.android.material.R.styleable.MaterialCardView, i, i4, new int[0]);
        MaterialCardViewHelper materialCardViewHelper = new MaterialCardViewHelper(this, attributeSet, i, i4);
