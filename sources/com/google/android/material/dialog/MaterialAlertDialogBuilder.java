...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    ...
    public MaterialAlertDialogBuilder(@NonNull Context context, int i) {
        ...
        this.backgroundInsets = MaterialDialogs.getDialogBackgroundInsets(context2, i4, i6);
        int color = MaterialColors.getColor(context2, R.attr.colorSurface, getClass().getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context2, null, i4, i6);
    ...
    @Override // androidx.appcompat.app.AlertDialog.Builder
    @NonNull
    public MaterialAlertDialogBuilder setSingleChoiceItems(@ArrayRes int i, int i4, @Nullable DialogInterface.OnClickListener onClickListener) {
        return (MaterialAlertDialogBuilder) super.setSingleChoiceItems(i, i4, onClickListener);
    }
