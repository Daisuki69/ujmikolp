...
public final class BadgeState {
    ...
    public BadgeState(Context context, @XmlRes int i, @AttrRes int i4, @StyleRes int i6, @Nullable State state) {
        Locale locale;
        ...
        TypedArray typedArrayGenerateTypedArray = generateTypedArray(context, state.badgeResId, i4, i6);
        ...
        if (state.number != -2) {
            ...
            if (typedArrayGenerateTypedArray.hasValue(i10)) {
                state2.number = typedArrayGenerateTypedArray.getInt(i10, 0);
            } else {
                state2.number = -1;
            }
        }
    ...
    private TypedArray generateTypedArray(Context context, @XmlRes int i, @AttrRes int i4, @StyleRes int i6) {
        ...
        return ThemeEnforcement.obtainStyledAttributes(context, drawableXml, R.styleable.Badge, i4, styleAttribute == 0 ? i6 : styleAttribute, new int[0]);
    }
