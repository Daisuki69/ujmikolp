...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public static final class SnackbarLayout extends BaseTransientBottomBar.SnackbarBaseLayout {
        ...
        @Override // com.google.android.material.snackbar.BaseTransientBottomBar.SnackbarBaseLayout, android.view.ViewGroup
    ...
    @NonNull
    public static Snackbar make(@NonNull View view, @StringRes int i, int i4) {
        return make(view, view.getResources().getText(i), i4);
    }
}
