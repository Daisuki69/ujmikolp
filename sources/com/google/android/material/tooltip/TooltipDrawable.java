...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private TooltipDrawable(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i4) {
    ...
    @NonNull
    public static TooltipDrawable createFromAttributes(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i4) {
        TooltipDrawable tooltipDrawable = new TooltipDrawable(context, attributeSet, i, i4);
        tooltipDrawable.loadFromAttributes(attributeSet, i, i4);
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i4) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, R.styleable.Tooltip, i, i4, new int[0]);
        ...
        if (textAppearance != null) {
            ...
            if (typedArrayObtainStyledAttributes.hasValue(i6)) {
                textAppearance.setTextColor(MaterialResources.getColorStateList(this.context, typedArrayObtainStyledAttributes, i6));
            }
        }
    ...
    public void setRevealFraction(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f) {
