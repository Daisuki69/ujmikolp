...
public class PublicKeyCredentialCreationOptions extends RequestOptions {
    ...
    public static final class Builder {
        ...
        public PublicKeyCredentialCreationOptions build() {
            ...
            return new PublicKeyCredentialCreationOptions(publicKeyCredentialRpEntity, publicKeyCredentialUserEntity, bArr, list, d10, list2, authenticatorSelectionCriteria, num, tokenBinding, attestationConveyancePreference == null ? null : attestationConveyancePreference.toString(), this.zzk);
        }
