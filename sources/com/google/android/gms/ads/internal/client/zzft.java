...
public final class zzft extends AbstractSafeParcelable {
    ...
    public zzft(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) int i, @SafeParcelable.Param(id = 3) zzm zzmVar, @SafeParcelable.Param(id = 4) int i4) {
        this.zza = str;
        this.zzb = i;
        this.zzc = zzmVar;
        this.zzd = i4;
