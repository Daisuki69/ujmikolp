...
public final class zzs extends zzbw {
    ...
    public final String zzN() {
        ...
        return s.q(new StringBuilder(strZzO.length() + 1 + String.valueOf(encodedQuery).length()), strZzO, "#", encodedQuery);
    }
    ...
    public final String zzO() {
        ...
        return s.q(new StringBuilder(String.valueOf(strZza).length() + 8 + String.valueOf(str).length()), "https://", strZza, str);
    }
    ...
    @Override // com.google.android.gms.ads.internal.client.zzbx
    public final void zzz(boolean z4) throws RemoteException {
    }
}
