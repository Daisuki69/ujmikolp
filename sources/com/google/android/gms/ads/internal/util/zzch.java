    ...
    public static List zza(String str) {
        ...
        synchronized (obj) {
            ...
            try {
                ...
                map3.put(MediaRouteProviderProtocol.SERVICE_DATA_ERROR, e.getClass().getSimpleName());
                ...
                map32.put(MediaRouteProviderProtocol.SERVICE_DATA_ERROR, e.getClass().getSimpleName());
