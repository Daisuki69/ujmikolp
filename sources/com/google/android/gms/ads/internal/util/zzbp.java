...
public final class zzbp {
            ...
            if (objOpt != null) {
                if (objOpt instanceof Boolean) {
                    ...
                    if (jSONArray.length() != 0) {
                        ...
                        int i = 0;
                        Object objOpt2 = null;
                        for (int i4 = 0; objOpt2 == null && i4 < length; i4++) {
                            objOpt2 = !jSONArray.isNull(i4) ? jSONArray.opt(i4) : null;
                        }
                        if (objOpt2 == null) {
                            ...
                            String strK = s.k("JSONArray with unsupported type ", objOpt2.getClass().getCanonicalName(), " for key:", next);
                            int i10 = zze.zza;
    ...
    public static String zzm(@Nullable zzfco zzfcoVar) {
        if (zzfcoVar == null) {
            return null;
        }
