...
public abstract class DeferredLifecycleHelper<T extends LifecycleDelegate> {
    ...
    public static void showGooglePlayUnavailableMessage(@NonNull FrameLayout frameLayout) {
        ...
        d8NVX3 d8nvx3 = new d8NVX3(frameLayout.getContext());
        d8nvx3.setOrientation(1);
        d8nvx3.setLayoutParams(new FrameLayout.LayoutParams(-2, -2));
        frameLayout.addView(d8nvx3);
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        yf3D09 yf3d09 = new yf3D09(layoutInflater.getContext());
        zaf(bundle, new zad(this, yf3d09, layoutInflater, viewGroup, bundle));
        if (this.zaa == null) {
            handleGooglePlayUnavailable(yf3d09);
        }
        return yf3d09;
    }
