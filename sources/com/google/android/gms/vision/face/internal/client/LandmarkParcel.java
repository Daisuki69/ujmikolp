...
public final class LandmarkParcel extends AbstractSafeParcelable {
    ...
    @UsedByNative("wrapper.cc")
    public LandmarkParcel(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) float f, @SafeParcelable.Param(id = 3) float f3, @SafeParcelable.Param(id = 4) int i4) {
        this.zzd = i;
        this.zza = f;
        this.zzb = f3;
        this.zzc = i4;
