...
public final class TextRecognizer extends Detector<TextBlock> {
    ...
    public final SparseArray<TextBlock> detect(@RecentlyNonNull Frame frame) {
        ...
        if (frame.getBitmap() != null) {
            ...
            new YuvImage(bArr, format, i, i4, null).compressToJpeg(new Rect(0, 0, i, i4), 100, byteArrayOutputStream);
        ...
        for (int i10 = 0; i10 < sparseArray.size(); i10++) {
            sparseArray3.append(sparseArray.keyAt(i10), new TextBlock((SparseArray) sparseArray.valueAt(i10)));
        }
        return sparseArray3;
    }
