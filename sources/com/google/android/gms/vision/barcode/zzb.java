...
public final class zzb implements Parcelable.Creator<Barcode> {
    ...
    public final /* synthetic */ Barcode createFromParcel(Parcel parcel) {
        ...
        return new Barcode(i, strCreateString, strCreateString2, i4, pointArr, email, phone, sms, wiFi, urlBookmark, geoPoint, calendarEvent, contactInfo, driverLicense, bArrCreateByteArray, z4);
    }
