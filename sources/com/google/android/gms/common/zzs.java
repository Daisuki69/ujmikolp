...
public final class zzs extends AbstractSafeParcelable {
    ...
    public zzs(String str, zzj zzjVar, boolean z4, boolean z5) {
        this.zza = str;
        this.zzb = zzjVar;
        this.zzc = z4;
        this.zzd = z5;
    ...
    public zzs(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) IBinder iBinder, @SafeParcelable.Param(id = 3) boolean z4, @SafeParcelable.Param(id = 4) boolean z5) {
        this.zza = str;
        zzk zzkVar = null;
        if (iBinder != null) {
            try {
