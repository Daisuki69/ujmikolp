...
public abstract class BaseGmsClient<T extends IInterface> {
    ...
    public void dump(@NonNull String str, @NonNull FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @NonNull String[] strArr) {
        ...
        if (this.zzh > 0) {
            ...
            long j = this.zzh;
            printWriterAppend.println(j + Global.BLANK + simpleDateFormat.format(new Date(j)));
        }
        if (this.zzg > 0) {
            ...
            long j6 = this.zzg;
            printWriterAppend2.println(j6 + Global.BLANK + simpleDateFormat.format(new Date(j6)));
        }
        if (this.zzj > 0) {
            printWriter.append((CharSequence) str).append("lastFailedStatus=").append((CharSequence) CommonStatusCodes.getStatusCodeString(this.zzi));
            PrintWriter printWriterAppend3 = printWriter.append(" lastFailedTime=");
            long j7 = this.zzj;
            printWriterAppend3.println(j7 + Global.BLANK + simpleDateFormat.format(new Date(j7)));
        }
    }
    ...
    @KeepForSdk
    public void onPostInitHandler(int i, @Nullable IBinder iBinder, @Nullable Bundle bundle, int i4) {
        this.zzb.sendMessage(this.zzb.obtainMessage(1, i4, -1, new zzf(this, i, iBinder, bundle)));
    }
    ...
    public final void zzl(int i, @Nullable Bundle bundle, int i4) {
        this.zzb.sendMessage(this.zzb.obtainMessage(7, i4, -1, new zzg(this, i, bundle)));
    }
