...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(s.f(i, "Overread allowed size end="), parcel);
        }
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        if (i < iDataPosition || i > parcel.dataSize()) {
            throw new ParseException(a.c(iDataPosition, i, "Size read is invalid start=", " end="), parcel);
        }
        return i;
    }

    private static void zza(Parcel parcel, int i, int i4, int i6) {
        if (i4 == i6) {
            return;
        }
        throw new ParseException(s.p(s.u("Expected size ", i6, " got ", i4, " (0x"), Integer.toHexString(i4), ")"), parcel);
    }
    ...
    private static void zzb(Parcel parcel, int i, int i4) {
        ...
        throw new ParseException(s.p(s.u("Expected size ", i4, " got ", size, " (0x"), Integer.toHexString(size), ")"), parcel);
    }
}
