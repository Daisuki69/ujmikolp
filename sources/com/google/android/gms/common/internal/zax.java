...
public final class zax extends AbstractSafeParcelable {
    ...
    public zax(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i4, @SafeParcelable.Param(id = 3) int i6, @Nullable @SafeParcelable.Param(id = 4) Scope[] scopeArr) {
        this.zaa = i;
        this.zab = i4;
        this.zac = i6;
        this.zad = scopeArr;
