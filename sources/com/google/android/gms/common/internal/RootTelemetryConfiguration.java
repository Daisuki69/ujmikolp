...
public class RootTelemetryConfiguration extends AbstractSafeParcelable {
    ...
    public RootTelemetryConfiguration(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) boolean z4, @SafeParcelable.Param(id = 3) boolean z5, @SafeParcelable.Param(id = 4) int i4, @SafeParcelable.Param(id = 5) int i6) {
        this.zza = i;
        this.zzb = z4;
        this.zzc = z5;
        this.zzd = i4;
