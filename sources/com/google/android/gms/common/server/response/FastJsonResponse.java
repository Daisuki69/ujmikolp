...
public abstract class FastJsonResponse {
    ...
    private final void zaE(Field field, @Nullable Object obj) {
        ...
        switch (i) {
            ...
            case 3:
            default:
                throw new IllegalStateException(s.f(i, "Unsupported type for conversion: "));
            case 4:
                if (objZae != null) {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @NonNull
        @KeepForSdk
        public static Field withConverter(@NonNull String str, int i, @NonNull FieldConverter<?, ?> fieldConverter, boolean z4) {
            fieldConverter.zaa();
            fieldConverter.zab();
            return new Field(7, z4, 0, false, str, i, null, fieldConverter);
        }
        ...
        public Field(int i, boolean z4, int i4, boolean z5, @NonNull String str, int i6, @Nullable Class cls, @Nullable FieldConverter fieldConverter) {
            this.zai = 1;
            this.zaa = i;
            this.zab = z4;
            this.zac = i4;
