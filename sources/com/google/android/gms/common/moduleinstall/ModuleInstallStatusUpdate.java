...
public class ModuleInstallStatusUpdate extends AbstractSafeParcelable {
    ...
    public static class ProgressInfo {
        ...
        public ProgressInfo(long j, long j6) {
            Preconditions.checkNotZero(j6);
            this.zaa = j;
            this.zab = j6;
        }
    ...
    @KeepForSdk
    public ModuleInstallStatusUpdate(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) @InstallState int i4, @Nullable @SafeParcelable.Param(id = 3) Long l6, @Nullable @SafeParcelable.Param(id = 4) Long l8, @SafeParcelable.Param(id = 5) int i6) {
        this.zaa = i;
        this.zab = i4;
        this.zac = l6;
        this.zad = l8;
        this.zae = i6;
        this.zaf = (l6 == null || l8 == null || l8.longValue() == 0) ? null : new ProgressInfo(l6.longValue(), l8.longValue());
    }
