...
public class ApiFeatureRequest extends AbstractSafeParcelable {
    ...
    public ApiFeatureRequest(@NonNull @SafeParcelable.Param(id = 1) List list, @SafeParcelable.Param(id = 2) boolean z4, @Nullable @SafeParcelable.Param(id = 3) String str, @Nullable @SafeParcelable.Param(id = 4) String str2) {
    ...
    public static ApiFeatureRequest zaa(List list, boolean z4) {
