...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Activity activity, int i, int i4) {
    ...
    @ResultIgnorabilityUnspecified
    public boolean showErrorDialogFragment(@NonNull Activity activity, int i, int i4) {
        return showErrorDialogFragment(activity, i, i4, (DialogInterface.OnCancelListener) null);
    }
    ...
    public final Dialog zaa(@NonNull Context context, int i, @Nullable zag zagVar, @Nullable DialogInterface.OnCancelListener onCancelListener, @Nullable DialogInterface.OnClickListener onClickListener) {
        ...
        Log.w("GoogleApiAvailability", s.f(i, "Creating dialog for Google Play services availability issue. ConnectionResult="), new IllegalArgumentException());
        ...
        if (PlatformVersion.isAtLeastO()) {
            ...
            if (str2 == null) {
                ...
                if (notificationChannel == null) {
                    notificationManager.createNotificationChannel(AbstractC1066i.g(string));
    ...
    @ResultIgnorabilityUnspecified
    public final boolean zag(@NonNull Activity activity, @NonNull LifecycleFragment lifecycleFragment, int i, int i4, @Nullable DialogInterface.OnCancelListener onCancelListener) {
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Activity activity, int i, int i4, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        return zaa(activity, i, zag.zab(activity, getErrorResolutionIntent(activity, i, "d"), i4), onCancelListener, null);
    }
    ...
    @ResultIgnorabilityUnspecified
    public boolean showErrorDialogFragment(@NonNull Activity activity, int i, int i4, @Nullable DialogInterface.OnCancelListener onCancelListener) {
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Fragment fragment, int i, int i4) {
        return getErrorDialog(fragment, i, i4, (DialogInterface.OnCancelListener) null);
    }
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Fragment fragment, int i, int i4, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        return zaa(fragment.requireContext(), i, zag.zac(fragment, getErrorResolutionIntent(fragment.requireContext(), i, "d"), i4), onCancelListener, null);
    }
}
