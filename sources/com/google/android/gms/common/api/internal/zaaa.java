...
final class zaaa implements zaca {
    ...
    public static /* bridge */ /* synthetic */ void zan(zaaa zaaaVar, int i, boolean z4) {
        zaaaVar.zab.zac(i, z4);
        zaaaVar.zak = null;
        zaaaVar.zaj = null;
    }
    ...
    public final void zas(String str, @Nullable FileDescriptor fileDescriptor, PrintWriter printWriter, @Nullable String[] strArr) {
        printWriter.append((CharSequence) str).append("authClient").println(Global.COLON);
        this.zae.zas(String.valueOf(str).concat("  "), fileDescriptor, printWriter, strArr);
        printWriter.append((CharSequence) str).append("anonClient").println(Global.COLON);
