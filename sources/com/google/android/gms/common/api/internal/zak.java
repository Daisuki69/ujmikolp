...
public final class zak extends zap {
    ...
    public final void onStart() {
        super.onStart();
        SparseArray sparseArray = this.zad;
        Log.d("AutoManageHelper", "onStart " + this.zaa + Global.BLANK + String.valueOf(sparseArray));
    ...
    public final void zad(int i, GoogleApiClient googleApiClient, @Nullable GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        Preconditions.checkState(this.zad.indexOfKey(i) < 0, s.f(i, "Already managing a GoogleApiClient with id "));
        zam zamVar = (zam) this.zab.get();
        Log.d("AutoManageHelper", "starting AutoManage for client " + i + Global.BLANK + this.zaa + Global.BLANK + String.valueOf(zamVar));
