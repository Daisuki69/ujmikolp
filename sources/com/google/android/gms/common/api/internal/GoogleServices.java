...
public final class GoogleServices {
    ...
    public Status checkGoogleAppId(String str) {
        ...
        return (str2 == null || str2.equals(str)) ? Status.RESULT_SUCCESS : new Status(10, s.j("Initialize was called with two different Google App IDs.  Only the first app ID will be used: '", this.zzc, "'."));
    }
