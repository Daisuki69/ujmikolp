...
public final class ListenerHolder<L> {
    ...
    @KeepForSdk
    public ListenerHolder(@NonNull Looper looper, @NonNull L l6, @NonNull String str) {
        this.zaa = new HandlerExecutor(looper);
        this.zab = Preconditions.checkNotNull(l6, "Listener must not be null");
        this.zac = new ListenerKey(l6, Preconditions.checkNotEmpty(str));
    }
    ...
    @KeepForSdk
    public ListenerHolder(@NonNull Executor executor, @NonNull L l6, @NonNull String str) {
