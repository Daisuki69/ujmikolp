...
public final class zabe extends GoogleApiClient implements zabz {
    ...
    public final void zam(GoogleApiClient googleApiClient, StatusPendingResult statusPendingResult, boolean z4) {
        Common.zaa.zaa(googleApiClient).setResultCallback(new zabb(this, statusPendingResult, z4, googleApiClient));
    }
    ...
    public final <A extends Api.AnyClient, R extends Result, T extends BaseImplementation.ApiMethodImpl<R, A>> T enqueue(@NonNull T t5) {
        Api<?> api = t5.getApi();
        Preconditions.checkArgument(this.zac.containsKey(t5.getClientKey()), "GoogleApiClient is not configured to use " + (api != null ? api.zad() : "the API") + " required for this call.");
        this.zaj.lock();
        try {
            zaca zacaVar = this.zal;
            if (zacaVar == null) {
    ...
    @Override // com.google.android.gms.common.api.GoogleApiClient
    public final <L> ListenerHolder<L> registerListener(@NonNull L l6) {
        this.zaj.lock();
        try {
            return this.zau.zaa(l6, this.zao, "NO_TYPE");
        } finally {
            this.zaj.unlock();
        }
    }
