...
public class GoogleApiManager implements Handler.Callback {
    ...
    public static Status zaF(ApiKey apiKey, ConnectionResult connectionResult) {
        return new Status(connectionResult, s.k("API: ", apiKey.zaa(), " is not available on this device. Connection failed with: ", String.valueOf(connectionResult)));
    }
    ...
    public final boolean handleMessage(@NonNull Message message) {
        ...
        switch (i) {
            ...
            case 5:
                ...
                if (zabqVar == null) {
                    Log.wtf("GoogleApiManager", s.g(i4, "Could not find API instance ", " while trying to fail enqueued calls."), new Exception());
                } else if (connectionResult.getErrorCode() == 13) {
                    zabqVar.zaE(new Status(17, s.k("Error resolution was canceled by the user, original error message: ", this.zaj.getErrorString(connectionResult.getErrorCode()), ": ", connectionResult.getErrorMessage())));
                } else {
    ...
    public final void zaw(MethodInvocation methodInvocation, int i, long j, int i4) {
        this.zar.sendMessage(this.zar.obtainMessage(18, new zace(methodInvocation, i, j, i4)));
    }
