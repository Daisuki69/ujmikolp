...
public abstract class GoogleApiClient {
    ...
    @NonNull
    @KeepForSdk
    public <L> ListenerHolder<L> registerListener(@NonNull L l6) {
        throw new UnsupportedOperationException();
    }
    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                boolean z5 = mapZad.get(api2) != null;
                ...
                if (clientBuildClient.providesSignIn()) {
                    if (api != null) {
                        throw new IllegalStateException(a.j(api2.zad(), " cannot be used with ", api.zad()));
                    }
                    api = api2;
                }
            }
            if (api != null) {
                if (z4) {
                    throw new IllegalStateException(s.j("With using ", api.zad(), ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
