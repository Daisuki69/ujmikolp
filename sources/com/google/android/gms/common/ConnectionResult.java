...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public ConnectionResult(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i4, @Nullable @SafeParcelable.Param(id = 3) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(id = 4) String str) {
        this.zza = i;
        this.zzb = i4;
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    default:
                        return s.g(i, "UNKNOWN_ERROR_CODE(", ")");
                }
        }
    }
