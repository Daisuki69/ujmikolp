...
public final class DataHolder extends AbstractSafeParcelable implements Closeable, AutoCloseable {
    ...
    */
    ...
    @KeepForSdk
    public boolean getBoolean(@NonNull String str, int i, int i4) {
        zae(str, i);
    ...
    @NonNull
    @KeepForSdk
    public byte[] getByteArray(@NonNull String str, int i, int i4) {
        zae(str, i);
    ...
    @KeepForSdk
    public int getInteger(@NonNull String str, int i, int i4) {
        zae(str, i);
        return this.zah[i4].getInt(i, this.zab.getInt(str));
    }

    @KeepForSdk
    public long getLong(@NonNull String str, int i, int i4) {
        zae(str, i);
    ...
    @NonNull
    @KeepForSdk
    public String getString(@NonNull String str, int i, int i4) {
        zae(str, i);
    ...
    @KeepForSdk
    public boolean hasNull(@NonNull String str, int i, int i4) {
        zae(str, i);
    ...
    public final double zaa(@NonNull String str, int i, int i4) {
        zae(str, i);
        return this.zah[i4].getDouble(i, this.zab.getInt(str));
    }

    public final float zab(@NonNull String str, int i, int i4) {
        zae(str, i);
        return this.zah[i4].getFloat(i, this.zab.getInt(str));
    }

    public final void zac(@NonNull String str, int i, int i4, @NonNull CharArrayBuffer charArrayBuffer) {
        zae(str, i);
    ...
    public DataHolder(@SafeParcelable.Param(id = 1000) int i, @SafeParcelable.Param(id = 1) String[] strArr, @SafeParcelable.Param(id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(id = 3) int i4, @Nullable @SafeParcelable.Param(id = 4) Bundle bundle) {
        this.zae = false;
        this.zak = true;
        this.zaa = i;
        this.zag = strArr;
