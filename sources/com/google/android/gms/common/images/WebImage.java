...
public final class WebImage extends AbstractSafeParcelable {
    ...
    public WebImage(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) Uri uri, @SafeParcelable.Param(id = 3) int i4, @SafeParcelable.Param(id = 4) int i6) {
        this.zaa = i;
        this.zab = uri;
        this.zac = i4;
        this.zad = i6;
    ...
    public String toString() {
        ...
        StringBuilder sbU = s.u("Image ", i, "x", i4, Global.BLANK);
        sbU.append(string);
        return sbU.toString();
    }
    ...
    public WebImage(@NonNull Uri uri, int i, int i4) throws IllegalArgumentException {
        this(1, uri, i, i4);
        if (uri == null) {
