...
public final class zzgq {
    ...
    public final synchronized void zzb(int i, int i4, long j, long j6, int i6) {
        ...
        this.zzc.log(new TelemetryData(0, Arrays.asList(new MethodInvocation(36301, i4, 0, j, j6, null, null, 0, i6)))).addOnFailureListener(new OnFailureListener() { // from class: com.google.android.gms.measurement.internal.zzgp
