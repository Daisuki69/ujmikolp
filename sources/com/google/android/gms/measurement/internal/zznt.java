...
public final class zznt {
    ...
    @MainThread
    public final int zzc(final Intent intent, int i, final int i4) {
        if (intent == null) {
        ...
        zzicVarZzy.zzaU();
        zzguVarZzaV.zzk().zzc("Local AppMeasurementService called. startId, action", Integer.valueOf(i4), action);
        if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
            zzk(zzpg.zza(context), new Runnable() { // from class: com.google.android.gms.measurement.internal.zzns
                @Override // java.lang.Runnable
                public final /* synthetic */ void run() {
                    this.zza.zzf(i4, zzguVarZzaV, intent);
                }
            });
        }
        return 2;
