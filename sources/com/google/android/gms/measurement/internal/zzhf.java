...
public final class zzhf {
    ...
    public final void zza(String str, long j) {
        ...
        long j6 = sharedPreferencesZzd.getLong(str2, 0L);
        if (j6 <= 0) {
            SharedPreferences.Editor editorEdit = zzhhVar.zzd().edit();
    ...
    public final Pair zzb() {
        ...
        String string = svM7M6.getString(zzhhVar.zzd(), this.zzd, null);
        long j6 = zzhhVar.zzd().getLong(this.zzc, 0L);
        zzc();
        return (string == null || j6 <= 0) ? zzhh.zza : new Pair(string, Long.valueOf(j6));
    }
}
