...
public final class zzpp extends zzjf {
    ...
    public static long zzP(byte[] bArr) {
        ...
        for (int i4 = length - 1; i4 >= 0 && i4 >= bArr.length - 8; i4--) {
            j += (((long) bArr[i4]) & 255) << i;
            i += 8;
        }
        return j;
    }

    public static boolean zzQ(Context context, boolean z4) {
    ...
    @WorkerThread
    public static void zzav(zzlu zzluVar, Bundle bundle, boolean z4) {
        ...
        if (bundle != null && zzluVar == null && z4) {
            bundle.remove("_sn");
            bundle.remove("_sc");
            bundle.remove("_si");
        }
    ...
    private final Object zzay(int i, Object obj, boolean z4, boolean z5, String str) {
        if (obj == null) {
            return null;
        }
    ...
    public final String zzC(String str, int i, boolean z4) {
        if (str == null) {
            return null;
        }
    ...
    */
    ...
    public final Bundle zzF(String str, String str2, Bundle bundle, List list, boolean z4) {
        int iZzq;
        List list2 = list;
        ...
        for (String str3 : new TreeSet(bundle.keySet())) {
            ...
            if (iZzq != 0) {
                ...
                int iZzD = zzD(str, str2, str3, bundle.get(str3), bundle2, list2, z4, zZzaA);
                if (iZzD == 17) {
                ...
                if (zzh(str3) && (i = i + 1) > iZzc) {
                    if (!zzicVar.zzc().zzp(null, zzfy.zzbe) || !z5) {
                        zzicVar.zzaV().zzd().zzc(c.m(new StringBuilder(String.valueOf(iZzc).length() + 37), "Event can't contain more than ", iZzc, " params"), zzicVar.zzl().zza(str2), zzicVar.zzl().zze(bundle));
                    }
                    zzax(bundle2, 5);
                    bundle2.remove(str3);
                    z5 = true;
    ...
    public final void zzG(zzgv zzgvVar, int i) {
        ...
        for (String str : new TreeSet(bundle.keySet())) {
            if (zzh(str) && (i4 = i4 + 1) > i) {
                zzic zzicVar = this.zzu;
                if (!zzicVar.zzc().zzp(null, zzfy.zzbe) || !z4) {
                    zzicVar.zzaV().zzd().zzc(c.m(new StringBuilder(String.valueOf(i).length() + 37), "Event can't contain more than ", i, " params"), zzicVar.zzl().zza(zzgvVar.zza), zzicVar.zzl().zze(bundle));
                    zzax(bundle, 5);
                }
                bundle.remove(str);
                z4 = true;
    ...
    public final void zzH(Parcelable[] parcelableArr, int i) {
        ...
        for (Parcelable parcelable : parcelableArr) {
            ...
            boolean z4 = false;
            for (String str : new TreeSet(bundle.keySet())) {
                if (zzh(str) && !zzaA(str, zzjn.zzd) && (i4 = i4 + 1) > i) {
                    zzic zzicVar = this.zzu;
                    if (!zzicVar.zzc().zzp(null, zzfy.zzbe) || !z4) {
                        zzicVar.zzaV().zzd().zzc(c.m(new StringBuilder(String.valueOf(i).length() + 60), "Param can't contain more than ", i, " item-scoped custom parameters"), zzicVar.zzl().zzb(str), zzicVar.zzl().zze(bundle));
                    }
                    zzax(bundle, 28);
                    bundle.remove(str);
                    z4 = true;
    ...
    public final void zzN(zzpo zzpoVar, String str, int i, String str2, String str3, int i4) {
        Bundle bundle = new Bundle();
        zzax(bundle, i);
    ...
    public final zzbg zzac(String str, String str2, Bundle bundle, String str3, long j, boolean z4, boolean z5) {
        if (TextUtils.isEmpty(str2)) {
            return null;
        }
        if (zzn(str2) != 0) {
    ...
    public final boolean zzad(Context context, String str) {
        ...
        try {
            ...
            this.zzu.zzaV().zzb().zzb("Error obtaining certificate", e7);
            return true;
        }
    }
    ...
    public final boolean zzag(int i, boolean z4) {
    ...
    public final long zzaj(long j, long j6) {
        return ((j6 * 60000) + j) / 86400000;
    }
    ...
    public final void zzak(Bundle bundle, long j) {
        ...
        if (j6 != 0) {
            this.zzu.zzaV().zze().zzb("Params already contained engagement", Long.valueOf(j6));
        } else {
            j6 = 0;
        }
    ...
    public final void zzap(com.google.android.gms.internal.measurement.zzcu zzcuVar, boolean z4) {
        Bundle bundle = new Bundle();
    ...
    public final URL zzat(long j, String str, String str2, long j6, String str3) {
        try {
            Preconditions.checkNotEmpty(str2);
            Preconditions.checkNotEmpty(str);
            String strConcat = "https://www.googleadservices.com/pagead/conversion/app/deeplink?id_type=adid&sdk_version=" + ("v133005." + zzah()) + "&rdid=" + str2 + "&bundleid=" + str + "&retry=" + j6;
    ...
    public final void zzba() {
        ...
        if (jNextLong == 0) {
            ...
            if (jNextLong == 0) {
                AbstractC1173g.B(this.zzu, "Utils falling back to Random for random id");
            }
        }
    ...
    public final void zzz(String str, String str2, String str3, Bundle bundle, List list, boolean z4) {
        int iZzq;
        String str4;
        int iZzD;
        List list2 = list;
        ...
        for (String str5 : new TreeSet(bundle.keySet())) {
            ...
            if (iZzq != 0) {
                ...
                if (zzt(bundle.get(str5))) {
                    ...
                    str4 = null;
                    iZzD = zzD(str, str2, str5, bundle.get(str5), bundle, list2, z4, false);
                }
                if (iZzD != 0 && !"_ev".equals(str5)) {
                    ...
                    if (!zzag(231100000, true)) {
                        ...
                        if (!zzicVar.zzc().zzp(str4, zzfy.zzbe) || !z5) {
                            zzicVar.zzaV().zzd().zzc(c.m(new StringBuilder(String.valueOf(i).length() + 55), "Item can't contain more than ", i, " item-scoped custom params"), zzicVar.zzl().zza(str2), zzicVar.zzl().zze(bundle));
                        }
                        zzax(bundle, 28);
                        bundle.remove(str5);
                        list2 = list;
