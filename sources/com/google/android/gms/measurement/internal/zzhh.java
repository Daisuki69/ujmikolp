...
final class zzhh extends zzjf {
    ...
    public final zzaz zzj() {
        zzg();
        return zzaz.zzg(svM7M6.getString(zzd(), "dma_consent_settings", null));
    }
    ...
    public final zzjl zzl() {
        zzg();
        return zzjl.zzf(svM7M6.getString(zzd(), "consent_settings", "G1"), zzd().getInt("consent_source", 100));
    }

    @WorkerThread
    public final boolean zzm(zzod zzodVar) {
        zzg();
        String string = svM7M6.getString(zzd(), "stored_tcf_param", "");
