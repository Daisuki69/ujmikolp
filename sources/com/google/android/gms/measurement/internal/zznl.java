...
public final class zznl extends zzg {
    ...
    private final void zzaf(Runnable runnable) throws IllegalStateException {
        ...
        zzicVar.zzc();
        if (size >= 1000) {
            AbstractC1173g.v(zzicVar, "Discarding data. Max runnable queue size reached");
            return;
        }
        list.add(runnable);
        this.zzh.zzb(60000L);
    ...
    @WorkerThread
    private final zzr zzah(boolean z4) {
        Pair pairZzb;
        zzic zzicVar = this.zzu;
        zzicVar.zzaU();
        ...
        if (z4) {
            ...
            if (zzicVar2.zzd().zzb != null && (pairZzb = zzicVar2.zzd().zzb.zzb()) != null && pairZzb != zzhh.zza) {
                ...
                strQ = s.q(new StringBuilder(strValueOf.length() + 1 + String.valueOf(str).length()), strValueOf, Global.COLON, str);
            }
        }
        return zzgiVarZzv.zzh(strQ);
    }
    ...
    public final void zzI() {
        ...
        if (listQueryIntentServices == null || listQueryIntentServices.isEmpty()) {
            AbstractC1173g.v(zzicVar, "Unable to use remote or local measurement implementation. Please register the AppMeasurementService service in the app manifest");
            return;
        }
    ...
    */
    ...
    public final /* synthetic */ void zzQ() {
        ...
        if (zzgbVar == null) {
            AbstractC1173g.v(this.zzu, "Failed to send storage consent settings to service");
            return;
        }
        try {
            zzr zzrVarZzah = zzah(false);
    ...
    public final /* synthetic */ void zzR() {
        zzgb zzgbVar = this.zzb;
        if (zzgbVar == null) {
            AbstractC1173g.v(this.zzu, "Failed to send Dma consent settings to service");
            return;
        }
        try {
            zzr zzrVarZzah = zzah(false);
    ...
    public final /* synthetic */ void zzU(zzr zzrVar, zzaf zzafVar) {
        zzgb zzgbVar = this.zzb;
        if (zzgbVar == null) {
            AbstractC1173g.v(this.zzu, "[sgtm] Discarding data. Failed to update batch upload status.");
            return;
        }
        try {
    ...
    */
    ...
    @WorkerThread
    public final void zzt(AtomicReference atomicReference, String str, String str2, String str3, boolean z4) {
        zzg();
        zzb();
        zzaf(new zzmx(this, atomicReference, null, str2, str3, zzah(false), z4));
    }

    @WorkerThread
    public final void zzu(com.google.android.gms.internal.measurement.zzcu zzcuVar, String str, String str2, boolean z4) {
        zzg();
        zzb();
        zzaf(new zzmc(this, str, str2, zzah(false), z4, zzcuVar));
    }

    @WorkerThread
    public final void zzv(AtomicReference atomicReference, boolean z4) {
        zzg();
        zzb();
        zzaf(new zzmd(this, atomicReference, zzah(false), z4));
    }
