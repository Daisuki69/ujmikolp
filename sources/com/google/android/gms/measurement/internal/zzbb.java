...
public final class zzbb {
    ...
    public zzbb(zzic zzicVar, String str, String str2, String str3, long j, long j6, Bundle bundle) {
        zzbe zzbeVar;
    ...
    public final String toString() {
        ...
        c.A(sb2, "Event{appId='", str, "', name='", str2);
        return s.q(sb2, "', params=", string, "}");
    }
    ...
    private zzbb(zzic zzicVar, String str, String str2, String str3, long j, long j6, zzbe zzbeVar) {
        Preconditions.checkNotEmpty(str2);
        Preconditions.checkNotEmpty(str3);
