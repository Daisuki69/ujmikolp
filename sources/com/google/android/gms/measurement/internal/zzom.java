...
public final class zzom extends AbstractSafeParcelable {
    ...
    public zzom(@SafeParcelable.Param(id = 1) long j, @SafeParcelable.Param(id = 2) byte[] bArr, @SafeParcelable.Param(id = 3) String str, @SafeParcelable.Param(id = 4) Bundle bundle, @SafeParcelable.Param(id = 5) int i, @SafeParcelable.Param(id = 6) long j6, @SafeParcelable.Param(id = 7) String str2) {
        this.zza = j;
        this.zzb = bArr;
        this.zzc = str;
        this.zzd = bundle;
