...
abstract class zzab {
    ...
    private static Boolean zzd(String str, int i, boolean z4, String str2, List list, String str3, zzgu zzguVar) {
        if (i == 7) {
    ...
    @VisibleForTesting
    public static Boolean zze(Boolean bool, boolean z4) {
        if (bool == null) {
            return null;
        }
