...
public final class zzjd extends zzga {
    ...
    @BinderThread
    private final void zzN(zzr zzrVar, boolean z4) {
    ...
    @BinderThread
    private final void zzO(String str, boolean z4) {
    ...
    public final /* synthetic */ void zzK(Bundle bundle, String str, zzr zzrVar) {
        ...
        try {
            ...
            zzavVarZzj2.zzu.zzaV().zzb().zzc("Error storing default event parameters. appId", zzgu.zzl(str), e7);
        }
    ...
    @Override // com.google.android.gms.measurement.internal.zzgb
    @BinderThread
    public final List zzj(zzr zzrVar, boolean z4) {
        zzN(zzrVar, false);
        String str = zzrVar.zza;
    ...
    @Override // com.google.android.gms.measurement.internal.zzgb
    @BinderThread
    public final List zzp(String str, String str2, boolean z4, zzr zzrVar) {
        zzN(zzrVar, false);
    ...
    @Override // com.google.android.gms.measurement.internal.zzgb
    @BinderThread
    public final List zzq(String str, String str2, String str3, boolean z4) {
        zzO(str, true);
        try {
    ...
    public final List zzx(zzr zzrVar, Bundle bundle) {
        ...
        try {
            ...
            this.zza.zzaV().zzb().zzc("Failed to get trigger URIs. appId", zzgu.zzl(zzrVar.zza), e7);
            return Collections.EMPTY_LIST;
        }
    }
