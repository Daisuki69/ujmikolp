...
public class AppMeasurementDynamiteService extends com.google.android.gms.internal.measurement.zzcq {
    ...
    @Override // com.google.android.gms.internal.measurement.zzcr
    public void getUserProperties(String str, String str2, boolean z4, com.google.android.gms.internal.measurement.zzcu zzcuVar) throws RemoteException {
        zzb();
        this.zza.zzaW().zzj(new zzk(this, zzcuVar, str, str2, z4));
    }
    ...
    public void initialize(IObjectWrapper iObjectWrapper, com.google.android.gms.internal.measurement.zzdd zzddVar, long j) throws RemoteException {
        ...
        if (zzicVar == null) {
            ...
            AbstractC1173g.B(zzicVar, "Attempting to initialize multiple times");
        }
    }
    ...
    public void logEvent(@NonNull String str, @NonNull String str2, @NonNull Bundle bundle, boolean z4, boolean z5, long j) throws RemoteException {
        zzb();
        this.zza.zzj().zzC(str, str2, bundle, z4, z5, j);
    }
    ...
    public void setConditionalUserProperty(@NonNull Bundle bundle, long j) throws RemoteException {
        zzb();
        if (bundle == null) {
            AbstractC1173g.v(this.zza, "Conditional user property must not be null");
        } else {
    ...
    public void setDataCollectionEnabled(boolean z4) throws RemoteException {
        ...
        zzlj zzljVarZzj = this.zza.zzj();
        zzljVarZzj.zzb();
        zzljVarZzj.zzu.zzaW().zzj(new zzjy(zzljVarZzj, z4));
    }
    ...
    public void setMeasurementEnabled(boolean z4, long j) throws RemoteException {
        zzb();
        this.zza.zzj().zzn(Boolean.valueOf(z4));
    }
    ...
    public void setUserId(@NonNull final String str, long j) throws RemoteException {
        ...
        if (str != null && TextUtils.isEmpty(str)) {
            AbstractC1173g.B(zzljVarZzj.zzu, "User ID must be non-empty or null");
        } else {
    ...
    @Override // com.google.android.gms.internal.measurement.zzcr
    public void setUserProperty(@NonNull String str, @NonNull String str2, @NonNull IObjectWrapper iObjectWrapper, boolean z4, long j) throws RemoteException {
        zzb();
        this.zza.zzj().zzL(str, str2, ObjectWrapper.unwrap(iObjectWrapper), z4, j);
    }
