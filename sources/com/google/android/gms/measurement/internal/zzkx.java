...
final class zzkx implements Runnable {
    ...
    public zzkx(zzky zzkyVar, boolean z4, Uri uri, String str, String str2) {
        this.zza = z4;
        this.zzb = uri;
        this.zzc = str;
        this.zzd = str2;
    ...
    public final void run() {
        ...
        try {
            ...
            if (zzicVar.zzc().zzp(null, zzfy.zzaG)) {
                ...
                zzljVar.zzK(TtmlNode.TEXT_EMPHASIS_AUTO, "_ldl", null, true);
                return;
            }
            if (!str.contains("gclid") || (!str.contains("utm_campaign") && !str.contains("utm_source") && !str.contains("utm_medium") && !str.contains("utm_term") && !str.contains("utm_content"))) {
                ...
                zzljVar.zzK(TtmlNode.TEXT_EMPHASIS_AUTO, "_ldl", str, true);
            }
