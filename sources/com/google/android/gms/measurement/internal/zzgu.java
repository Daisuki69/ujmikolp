...
public final class zzgu extends zzjf {
    ...
    public static String zzo(boolean z4, String str, Object obj, Object obj2, Object obj3) {
        String strZzp = zzp(z4, obj);
        String strZzp2 = zzp(z4, obj2);
        String strZzp3 = zzp(z4, obj3);
    ...
    @VisibleForTesting
    public static String zzp(boolean z4, Object obj) {
        String className;
        if (obj == null) {
            return "";
        }
        ...
        if (obj instanceof Long) {
            ...
            String str = cCharAt == '-' ? Global.HYPHEN : "";
            StringBuilder sb2 = new StringBuilder(c.b(str.length() + length + 3, String.valueOf(jRound2).length(), str));
            c.z(sb2, str, jRound, "...");
            return c.j(jRound2, str, sb2);
        }
        if (obj instanceof Boolean) {
            return obj.toString();
        }
        if (!(obj instanceof Throwable)) {
            return obj instanceof zzgt ? ((zzgt) obj).zza() : z4 ? Global.HYPHEN : obj.toString();
        }
    ...
    public final void zzm(int i, boolean z4, boolean z5, String str, Object obj, Object obj2, Object obj3) {
        if (!z4 && Log.isLoggable(zzn(), i)) {
