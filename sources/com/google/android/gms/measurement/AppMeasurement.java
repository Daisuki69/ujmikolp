...
public class AppMeasurement {
    ...
    @VisibleForTesting
    @WorkerThread
    public Map<String, Object> getUserProperties(@NonNull String str, @NonNull @Size(max = 24, min = 1) String str2, boolean z4) {
        return this.zzb.zzd(str, str2, z4);
    }
