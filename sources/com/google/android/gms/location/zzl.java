...
public final class zzl extends AbstractSafeParcelable {
    ...
    public zzl(@SafeParcelable.Param(id = 1) long j, @SafeParcelable.Param(id = 2) boolean z4, @Nullable @SafeParcelable.Param(id = 3) WorkSource workSource, @Nullable @SafeParcelable.Param(id = 4) String str, @Nullable @SafeParcelable.Param(id = 5) int[] iArr, @SafeParcelable.Param(id = 6) boolean z5, @Nullable @SafeParcelable.Param(id = 7) String str2, @SafeParcelable.Param(id = 8) long j6, @Nullable @SafeParcelable.Param(id = 9) String str3) {
        this.zza = j;
        this.zzb = z4;
        this.zzc = workSource;
        this.zzd = str;
