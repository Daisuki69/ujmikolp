...
public class SleepSegmentEvent extends AbstractSafeParcelable {
    ...
    public SleepSegmentEvent(@SafeParcelable.Param(id = 1) long j, @SafeParcelable.Param(id = 2) long j6, @SafeParcelable.Param(id = 3) int i, @SafeParcelable.Param(id = 4) int i4, @SafeParcelable.Param(id = 5) int i6) {
        Preconditions.checkArgument(j <= j6, "endTimeMillis must be greater than or equal to startTimeMillis");
        this.zza = j;
        this.zzb = j6;
        this.zzc = i;
        this.zzd = i4;
