...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @VisibleForTesting
    public ActivityRecognitionResult(@NonNull DetectedActivity detectedActivity, long j, long j6) {
        this(Collections.singletonList(detectedActivity), j, j6, 0, null);
    }
    ...
    */
    ...
    public String toString() {
        ...
        a.C(sb2, "ActivityRecognitionResult [probableActivities=", strValueOf, ", timeMillis=");
        sb2.append(j);
    ...
    public ActivityRecognitionResult(@NonNull List<DetectedActivity> list, long j, long j6) {
        this(list, j, j6, 0, null);
    }

    @ShowFirstParty
    @SafeParcelable.Constructor
    public ActivityRecognitionResult(@NonNull @SafeParcelable.Param(id = 1) List list, @SafeParcelable.Param(id = 2) long j, @SafeParcelable.Param(id = 3) long j6, @SafeParcelable.Param(id = 4) int i, @Nullable @SafeParcelable.Param(id = 5) Bundle bundle) {
        Preconditions.checkArgument(list != null && list.size() > 0, "Must have at least 1 detected activity");
        Preconditions.checkArgument(j > 0 && j6 > 0, "Must set times");
        this.zza = list;
        this.zzb = j;
        this.zzc = j6;
        this.zzd = i;
