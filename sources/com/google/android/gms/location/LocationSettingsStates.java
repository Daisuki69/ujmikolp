...
public final class LocationSettingsStates extends AbstractSafeParcelable {
    ...
    public LocationSettingsStates(@SafeParcelable.Param(id = 1) boolean z4, @SafeParcelable.Param(id = 2) boolean z5, @SafeParcelable.Param(id = 3) boolean z8, @SafeParcelable.Param(id = 4) boolean z9, @SafeParcelable.Param(id = 5) boolean z10, @SafeParcelable.Param(id = 6) boolean z11) {
        this.zza = z4;
        this.zzb = z5;
        this.zzc = z8;
        this.zzd = z9;
