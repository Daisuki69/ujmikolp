...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public LocationAvailability(@SafeParcelable.Param(id = 4) int i, @SafeParcelable.Param(id = 1) int i4, @SafeParcelable.Param(id = 2) int i6, @SafeParcelable.Param(id = 3) long j, @SafeParcelable.Param(id = 5) zzbv[] zzbvVarArr, @SafeParcelable.Param(id = 6) boolean z4) {
