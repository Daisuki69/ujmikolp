...
public final class BeginSignInRequest extends AbstractSafeParcelable {
    ...
    public static final class GoogleIdTokenRequestOptions extends AbstractSafeParcelable {
        ...
        public GoogleIdTokenRequestOptions(@SafeParcelable.Param(id = 1) boolean z4, @Nullable @SafeParcelable.Param(id = 2) String str, @Nullable @SafeParcelable.Param(id = 3) String str2, @SafeParcelable.Param(id = 4) boolean z5, @Nullable @SafeParcelable.Param(id = 5) String str3, @Nullable @SafeParcelable.Param(id = 6) List list, @SafeParcelable.Param(id = 7) boolean z8) {
            boolean z9 = true;
            if (z5 && z8) {
                z9 = false;
            }
