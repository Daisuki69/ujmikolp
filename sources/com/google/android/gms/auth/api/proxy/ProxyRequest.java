...
public class ProxyRequest extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull String str) {
            ...
            if (!Patterns.WEB_URL.matcher(str).matches()) {
                throw new IllegalArgumentException(s.j("The supplied url [ ", str, "] is not match Patterns.WEB_URL!"));
            }
            this.zza = str;
        }
        ...
        public Builder setHttpMethod(int i) {
            ...
            Preconditions.checkArgument(z4, "Unrecognized http method code.");
            this.zzb = i;
            return this;
        }
    ...
    public ProxyRequest(@SafeParcelable.Param(id = 1000) int i, @SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) int i4, @SafeParcelable.Param(id = 3) long j, @SafeParcelable.Param(id = 4) byte[] bArr, @SafeParcelable.Param(id = 5) Bundle bundle) {
        this.zza = i;
        this.url = str;
        this.httpMethod = i4;
    ...
    public String toString() {
        return a.d(this.httpMethod, "ProxyRequest[ url: ", this.url, ", method: ", " ]");
    }
