...
public final class CredentialPickerConfig extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public CredentialPickerConfig(@SafeParcelable.Param(id = 1000) int i, @SafeParcelable.Param(id = 1) boolean z4, @SafeParcelable.Param(id = 2) boolean z5, @SafeParcelable.Param(id = 3) boolean z8, @SafeParcelable.Param(id = 4) int i4) {
        this.zba = i;
        this.zbb = z4;
        this.zbc = z5;
        if (i < 2) {
            this.zbd = true == z8 ? 3 : 1;
        } else {
            this.zbd = i4;
        }
    }
