...
public final class zzw extends zzbz {
    ...
    public final Object getFieldValue(FastJsonResponse.Field field) {
        ...
        throw new IllegalStateException(s.f(field.getSafeParcelableFieldId(), "Unknown SafeParcelable id="));
    }
    ...
    public final void setDecodedBytesInternal(FastJsonResponse.Field field, String str, byte[] bArr) {
        int safeParcelableFieldId = field.getSafeParcelableFieldId();
        if (safeParcelableFieldId != 4) {
            throw new IllegalArgumentException(s.g(safeParcelableFieldId, "Field with id=", " is not known to be an byte array."));
        }
        this.zzf = bArr;
    ...
    public final void setIntegerInternal(FastJsonResponse.Field field, String str, int i) {
        int safeParcelableFieldId = field.getSafeParcelableFieldId();
        if (safeParcelableFieldId != 3) {
            throw new IllegalArgumentException(s.g(safeParcelableFieldId, "Field with id=", " is not known to be an int."));
        }
        this.zze = i;
        this.zza.add(Integer.valueOf(safeParcelableFieldId));
    }
    ...
    public zzw(@SafeParcelable.Indicator Set set, @SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) int i4, @SafeParcelable.Param(id = 4) byte[] bArr, @SafeParcelable.Param(id = 5) PendingIntent pendingIntent, @SafeParcelable.Param(id = 6) DeviceMetaData deviceMetaData) {
        this.zza = set;
        this.zzb = i;
        this.zzd = str;
        this.zze = i4;
