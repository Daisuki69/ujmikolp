...
public class DeviceMetaData extends AbstractSafeParcelable {
    ...
    public DeviceMetaData(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) boolean z4, @SafeParcelable.Param(id = 3) long j, @SafeParcelable.Param(id = 4) boolean z5) {
        this.zza = i;
        this.zzb = z4;
        this.zzc = j;
        this.zzd = z5;
