...
public final class zzwr {
    ...
    public final synchronized void zzc(int i, int i4, long j, long j6) {
        ...
        this.zza.log(new TelemetryData(0, Arrays.asList(new MethodInvocation(i, i4, 0, j, j6, null, null, 0, -1)))).addOnFailureListener(new OnFailureListener() { // from class: com.google.android.gms.internal.mlkit_vision_barcode.zzwq
