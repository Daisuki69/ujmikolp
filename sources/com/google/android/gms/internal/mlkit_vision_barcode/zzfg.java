...
final class zzfg implements InterfaceC2296d {
    ...
    static {
        ...
        zzd = new InterfaceC2295c() { // from class: com.google.android.gms.internal.mlkit_vision_barcode.zzff
            @Override // u2.InterfaceC2293a
            public final void encode(Object obj, Object obj2) throws IOException {
                zzfg.zzg((Map.Entry) obj, (InterfaceC2296d) obj2);
            }
        };
    }

    public zzfg(OutputStream outputStream, Map map, Map map2, InterfaceC2295c interfaceC2295c) {
    ...
    private static int zzh(C2294b c2294b) {
        zzfe zzfeVar = (zzfe) c2294b.b(zzfe.class);
        if (zzfeVar != null) {
            return zzfeVar.zza();
        }
    ...
    private static zzfe zzj(C2294b c2294b) {
        zzfe zzfeVar = (zzfe) c2294b.b(zzfe.class);
        if (zzfeVar != null) {
            return zzfeVar;
        }
    ...
    private final zzfg zzk(InterfaceC2295c interfaceC2295c, C2294b c2294b, Object obj, boolean z4) throws IOException {
    ...
    private final zzfg zzl(InterfaceC2297e interfaceC2297e, C2294b c2294b, Object obj, boolean z4) throws IOException {
    ...
    public final zzfg zzd(@NonNull C2294b c2294b, int i, boolean z4) throws IOException {
        if (!z4 || i != 0) {
            zzfe zzfeVarZzj = zzj(c2294b);
    ...
    public final zzfg zze(@NonNull C2294b c2294b, long j, boolean z4) throws IOException {
        if (!z4 || j != 0) {
            zzfe zzfeVarZzj = zzj(c2294b);
            int iOrdinal = zzfeVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
