...
public final class zzbj extends zzav {
    ...
    public final zzao zza(String str, zzg zzgVar, List list) {
        ...
        if (iOrdinal == 3) {
            zzao zzaoVarZza = zzgVar.zza((zzao) AbstractC1173g.o(zzbk.ASSIGN, 2, list, 0));
            if (!(zzaoVarZza instanceof zzas)) {
                throw new IllegalArgumentException(AbstractC1414e.h("Expected string for assign var. got ", zzaoVarZza.getClass().getCanonicalName()));
            }
            if (!zzgVar.zzd(zzaoVarZza.zzc())) {
                throw new IllegalArgumentException(AbstractC1414e.h("Attempting to assign undefined value ", zzaoVarZza.zzc()));
            }
        ...
        if (iOrdinal == 14) {
            ...
            if (list.size() % 2 != 0) {
                throw new IllegalArgumentException(s.f(list.size(), "CONST requires an even number of arguments, found "));
            }
            while (i < list.size() - 1) {
                zzao zzaoVarZza3 = zzgVar.zza((zzao) list.get(i));
                if (!(zzaoVarZza3 instanceof zzas)) {
                    throw new IllegalArgumentException(AbstractC1414e.h("Expected string for const name. got ", zzaoVarZza3.getClass().getCanonicalName()));
                }
        ...
        if (iOrdinal == 33) {
            zzao zzaoVarZza5 = zzgVar.zza((zzao) AbstractC1173g.o(zzbk.GET, 1, list, 0));
            if (zzaoVarZza5 instanceof zzas) {
                return zzgVar.zzh(zzaoVarZza5.zzc());
            }
            throw new IllegalArgumentException(AbstractC1414e.h("Expected string for get var. got ", zzaoVarZza5.getClass().getCanonicalName()));
        }
        if (iOrdinal == 49) {
        ...
        if (iOrdinal == 58) {
            zzao zzaoVarZza6 = zzgVar.zza((zzao) AbstractC1173g.o(zzbk.SET_PROPERTY, 3, list, 0));
            ...
            if (zzaoVarZza6 == zzao.zzf || zzaoVarZza6 == zzao.zzg) {
                throw new IllegalStateException(s.k("Can't set property ", zzaoVarZza7.zzc(), " of ", zzaoVarZza6.zzc()));
            }
        ...
        if (iOrdinal == 18) {
            ...
            if (list.size() % 2 != 0) {
                throw new IllegalArgumentException(s.f(list.size(), "CREATE_OBJECT requires an even number of arguments, found "));
            }
        ...
        if (iOrdinal == 35 || iOrdinal == 36) {
            zzao zzaoVarZza12 = zzgVar.zza((zzao) AbstractC1173g.o(zzbk.GET_PROPERTY, 2, list, 0));
            ...
            if (zzaoVarZza12 instanceof zzas) {
                if (SessionDescription.ATTR_LENGTH.equals(zzaoVarZza13.zzc())) {
        ...
        switch (iOrdinal) {
            case 62:
                zzao zzaoVarZza14 = zzgVar.zza((zzao) AbstractC1173g.o(zzbk.TYPEOF, 1, list, 0));
            ...
            case 64:
                ...
                while (it2.hasNext()) {
                    ...
                    if (!(zzaoVarZza15 instanceof zzas)) {
                        throw new IllegalArgumentException(AbstractC1414e.h("Expected string for var name. got ", zzaoVarZza15.getClass().getCanonicalName()));
                    }
