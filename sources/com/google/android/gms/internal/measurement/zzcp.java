...
public final class zzcp extends zzbl implements zzcr {
    ...
    @Override // com.google.android.gms.internal.measurement.zzcr
    public final void getUserProperties(String str, String str2, boolean z4, zzcu zzcuVar) throws RemoteException {
        Parcel parcelZza = zza();
        parcelZza.writeString(str);
        parcelZza.writeString(str2);
        int i = zzbn.zza;
    ...
    @Override // com.google.android.gms.internal.measurement.zzcr
    public final void setMeasurementEnabled(boolean z4, long j) throws RemoteException {
        Parcel parcelZza = zza();
        int i = zzbn.zza;
        parcelZza.writeInt(z4 ? 1 : 0);
        parcelZza.writeLong(j);
