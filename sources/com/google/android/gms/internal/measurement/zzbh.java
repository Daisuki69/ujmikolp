...
public final class zzbh extends zzav {
    ...
    public final zzao zza(String str, zzg zzgVar, List list) {
        ...
        if (iOrdinal == 0) {
            zzao zzaoVarZza = zzgVar.zza((zzao) AbstractC1173g.o(zzbk.ADD, 2, list, 0));
        ...
        if (iOrdinal == 21) {
            return new zzah(Double.valueOf(zzgVar.zza((zzao) AbstractC1173g.o(zzbk.DIVIDE, 2, list, 0)).zzd().doubleValue() / zzgVar.zza((zzao) list.get(1)).zzd().doubleValue()));
        }
        if (iOrdinal == 59) {
            zzao zzaoVarZza3 = zzgVar.zza((zzao) AbstractC1173g.o(zzbk.SUBTRACT, 2, list, 0));
        ...
        switch (iOrdinal) {
            case 44:
                return new zzah(Double.valueOf(zzgVar.zza((zzao) AbstractC1173g.o(zzbk.MODULUS, 2, list, 0)).zzd().doubleValue() % zzgVar.zza((zzao) list.get(1)).zzd().doubleValue()));
            case 45:
                return new zzah(Double.valueOf(zzgVar.zza((zzao) list.get(1)).zzd().doubleValue() * zzgVar.zza((zzao) AbstractC1173g.o(zzbk.MULTIPLY, 2, list, 0)).zzd().doubleValue()));
            case 46:
                return new zzah(Double.valueOf(-zzgVar.zza((zzao) AbstractC1173g.o(zzbk.NEGATE, 1, list, 0)).zzd().doubleValue()));
            default:
                return zzb(str);
        }
    }
