...
public final class zzax extends zzav {
    ...
    private static boolean zzd(zzao zzaoVar, zzao zzaoVar2) {
        ...
        boolean z4 = zzaoVar instanceof zzah;
        if (z4 && (zzaoVar2 instanceof zzas)) {
            return zzd(zzaoVar, new zzah(zzaoVar2.zzd()));
        }
        boolean z5 = zzaoVar instanceof zzas;
        if (z5 && (zzaoVar2 instanceof zzah)) {
        ...
        if ((z5 || z4) && (zzaoVar2 instanceof zzak)) {
