...
public abstract class zzmf<MessageType extends zzmf<MessageType, BuilderType>, BuilderType extends zzmb<MessageType, BuilderType>> extends zzks<MessageType, BuilderType> {
    ...
    public static final boolean zzd(zzmf zzmfVar, boolean z4) {
    ...
    public final int zzcd(zznx zznxVar) {
        if (zzcf()) {
            ...
            throw new IllegalStateException(AbstractC1173g.q(androidx.media3.datasource.cache.c.a(iZze, 42), iZze, "serialized size must be non-negative, was "));
        }
        ...
        if (iZze2 < 0) {
            throw new IllegalStateException(AbstractC1173g.q(androidx.media3.datasource.cache.c.a(iZze2, 42), iZze2, "serialized size must be non-negative, was "));
        }
    ...
    public final int zzcn() {
        if (zzcf()) {
            ...
            throw new IllegalStateException(AbstractC1173g.q(androidx.media3.datasource.cache.c.a(iZzc, 42), iZzc, "serialized size must be non-negative, was "));
        }
        int i = this.zzb & Integer.MAX_VALUE;
        if (i != Integer.MAX_VALUE) {
            return i;
        ...
        int iZzc2 = zzc(null);
        if (iZzc2 < 0) {
            throw new IllegalStateException(AbstractC1173g.q(androidx.media3.datasource.cache.c.a(iZzc2, 42), iZzc2, "serialized size must be non-negative, was "));
        }
