...
public final class zzay extends zzav {
    ...
    private static zzao zzc(zzg zzgVar, List list) {
        ...
        if (!(zzaoVarZza2 instanceof zzae)) {
            throw new IllegalArgumentException(AbstractC1414e.h("FN requires an ArrayValue of parameter names found ", zzaoVarZza2.getClass().getCanonicalName()));
        }
    ...
    public final zzao zza(String str, zzg zzgVar, List list) {
        ...
        if (iOrdinal == 2) {
            zzao zzaoVarZza = zzgVar.zza((zzao) AbstractC1173g.o(zzbk.APPLY, 3, list, 0));
            String strZzc = zzgVar.zza((zzao) list.get(1)).zzc();
            zzao zzaoVarZza2 = zzgVar.zza((zzao) list.get(2));
            if (!(zzaoVarZza2 instanceof zzae)) {
                throw new IllegalArgumentException(AbstractC1414e.h("Function arguments for Apply are not a list found ", zzaoVarZza2.getClass().getCanonicalName()));
            }
            if (strZzc.isEmpty()) {
        ...
        if (iOrdinal == 57) {
            return list.isEmpty() ? zzao.zzj : new zzag("return", zzgVar.zza((zzao) AbstractC1173g.o(zzbk.RETURN, 1, list, 0)));
        }
        if (iOrdinal != 19) {
            if (iOrdinal == 20) {
            ...
            if (iOrdinal == 60) {
                zzao zzaoVarZza6 = zzgVar.zza((zzao) AbstractC1173g.o(zzbk.SWITCH, 3, list, 0));
                ...
                for (int i = 0; i < zzaeVar.zzh(); i++) {
                    if (z4 || zzaoVarZza6.equals(zzgVar.zza(zzaeVar.zzl(i)))) {
            ...
            if (iOrdinal == 61) {
                return zzgVar.zza((zzao) AbstractC1173g.o(zzbk.TERNARY, 3, list, 0)).zze().booleanValue() ? zzgVar.zza((zzao) list.get(1)) : zzgVar.zza((zzao) list.get(2));
            }
            switch (iOrdinal) {
                case 11:
