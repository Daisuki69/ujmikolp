...
public class zzmb<MessageType extends zzmf<MessageType, BuilderType>, BuilderType extends zzmb<MessageType, BuilderType>> extends zzkr<MessageType, BuilderType> {
    ...
    public final /* bridge */ /* synthetic */ zzkr zzaS(byte[] bArr, int i, int i4) throws zzmr {
        int i6 = zzlr.zzb;
        int i10 = zznu.zza;
        zzbe(bArr, 0, i4, zzlr.zza);
        return this;
    }

    @Override // com.google.android.gms.internal.measurement.zzkr
    public final /* bridge */ /* synthetic */ zzkr zzaT(byte[] bArr, int i, int i4, zzlr zzlrVar) throws zzmr {
        zzbe(bArr, 0, i4, zzlrVar);
        return this;
    }
    ...
    public final zzmb zzbe(byte[] bArr, int i, int i4, zzlr zzlrVar) throws zzmr {
        if (!this.zza.zzcf()) {
            zzaY();
        }
        try {
            zznu.zza().zzb(this.zza.getClass()).zzi(this.zza, bArr, 0, i4, new zzkw(zzlrVar));
            return this;
        } catch (zzmr e) {
            throw e;
