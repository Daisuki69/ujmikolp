...
public final class zzgz extends zzfu<zzgz> implements Cloneable {
    ...
    public final int hashCode() {
        int iHashCode = (Arrays.hashCode(this.zzbjb) + 553293486) * 31;
        String str = this.zzbjc;
        int iHashCode2 = 0;
        int iZza = (((zzfy.zza(this.zzbjd) + ((iHashCode + (str == null ? 0 : str.hashCode())) * 31)) * 31) + 1237) * 31;
        zzfw zzfwVar = this.zzrj;
        if (zzfwVar != null && !zzfwVar.isEmpty()) {
            iHashCode2 = this.zzrj.hashCode();
        }
        return iZza + iHashCode2;
    }
