...
class zzbi extends zzbh {
    ...
    public final int zza(int i, int i4, int i6) {
        return zzci.zza(i, this.zzfp, zzac(), i6);
    }
    ...
    @Override // com.google.android.gms.internal.clearcut.zzbb
    public final zzbb zza(int i, int i4) {
        int iZzb = zzbb.zzb(0, i4, size());
    ...
    public final boolean zza(zzbb zzbbVar, int i, int i4) {
        if (i4 > zzbbVar.size()) {
            int size = size();
        ...
        if (i4 > zzbbVar.size()) {
            throw new IllegalArgumentException(AbstractC1173g.p(59, i4, zzbbVar.size(), "Ran off end of other: 0, ", ", "));
        }
        if (!(zzbbVar instanceof zzbi)) {
            return zzbbVar.zza(0, i4).equals(zza(0, i4));
        }
