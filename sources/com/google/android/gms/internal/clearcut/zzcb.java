...
public final class zzcb {
    ...
    private zzcb(String str, int i, int i4, zzcd zzcdVar, zzcq zzcqVar) {
        int i6;
        this.id = i4;
        this.zziy = zzcdVar;
        this.zzix = zzcqVar;
        int i10 = zzcc.zzje[zzcdVar.ordinal()];
        this.zziz = (i10 == 1 || i10 == 2) ? zzcqVar.zzbq() : null;
        this.zzja = (zzcdVar != zzcd.SCALAR || (i6 = zzcc.zzjf[zzcqVar.ordinal()]) == 1 || i6 == 2 || i6 == 3) ? false : true;
    }
