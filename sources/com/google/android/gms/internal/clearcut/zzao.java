...
public final class zzao {
    ...
    public final <T> zzae<T> zza(String str, T t5, zzan<T> zzanVar) {
        return zzae.zza(this, str, t5, zzanVar);
    }

    public final zzae<Boolean> zzc(String str, boolean z4) {
    ...
    private zzao(String str, Uri uri, String str2, String str3, boolean z4, boolean z5) {
        this.zzef = str;
        this.zzeg = uri;
        this.zzeh = str2;
        this.zzei = str3;
    ...
    public final zzao zzc(String str) {
        boolean z4 = this.zzej;
        if (z4) {
            throw new IllegalStateException("Cannot set GServices prefix and skip GServices");
        }
        return new zzao(this.zzef, this.zzeg, str, this.zzei, z4, this.zzek);
    }
}
