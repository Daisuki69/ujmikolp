...
final class zzdu<T> implements zzef<T> {
    ...
    public final boolean equals(T t5, T t10) {
        if (!this.zzmx.zzq(t5).equals(this.zzmx.zzq(t10))) {
            return false;
        }
        if (this.zzmo) {
            return this.zzmy.zza(t5).equals(this.zzmy.zza(t10));
        }
        return true;
    }
    ...
    public final int hashCode(T t5) {
        int iHashCode = this.zzmx.zzq(t5).hashCode();
        return this.zzmo ? (iHashCode * 53) + this.zzmy.zza(t5).hashCode() : iHashCode;
    }
    ...
    public final int zzm(T t5) {
        ...
        int iZzr = zzexVar.zzr(zzexVar.zzq(t5));
        return this.zzmo ? iZzr + this.zzmy.zza(t5).zzat() : iZzr;
    }

    @Override // com.google.android.gms.internal.clearcut.zzef
    public final boolean zzo(T t5) {
        return this.zzmy.zza(t5).isInitialized();
    }

    @Override // com.google.android.gms.internal.clearcut.zzef
    public final void zza(T t5, zzfr zzfrVar) throws IOException {
        for (T t10 : this.zzmy.zza(t5)) {
            zzca zzcaVar = (zzca) t10.getKey();
            if (zzcaVar.zzav() != zzfq.MESSAGE || zzcaVar.zzaw() || zzcaVar.zzax()) {
                throw new IllegalStateException("Found invalid MessageSet item.");
            }
            zzfrVar.zza(zzcaVar.zzc(), t10 instanceof zzct ? ((zzct) t10).zzbs().zzr() : t10.getValue());
        }
        zzex<?, ?> zzexVar = this.zzmx;
        zzexVar.zzc(zzexVar.zzq(t5), zzfrVar);
    }

    @Override // com.google.android.gms.internal.clearcut.zzef
    public final void zzc(T t5, T t10) {
        zzeh.zza(this.zzmx, t5, t10);
        if (this.zzmo) {
            zzeh.zza(this.zzmy, t5, t10);
        }
    }
