...
public abstract class zzae<T> {
    ...
    private zzae(zzao zzaoVar, String str, T t5) {
        this.zzdv = null;
        this.zzdw = null;
        this.zzdx = null;
    ...
    public static <T> zzae<T> zza(zzao zzaoVar, String str, T t5, zzan<T> zzanVar) {
        return new zzal(zzaoVar, str, t5, zzanVar);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static zzae<Boolean> zza(zzao zzaoVar, String str, boolean z4) {
        return new zzaj(zzaoVar, str, Boolean.valueOf(z4));
    }
    ...
    public static boolean zza(final String str, boolean z4) {
        ...
        if (zzn()) {
            return ((Boolean) zza(new zzam(str, z5) { // from class: com.google.android.gms.internal.clearcut.zzah
