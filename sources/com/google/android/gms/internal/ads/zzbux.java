...
public final class zzbux {
    ...
    public zzbux(JSONObject jSONObject) {
        ...
        jSONObject.optString(SessionDescription.ATTR_TYPE);
        ...
        this.zzj = zzo(jSONObject.optString(EventKeys.START_TIME)).longValue();
        this.zzk = zzo(jSONObject.optString(EventKeys.END_TIME)).longValue();
    }
