...
public class zzaus extends zzauq {
    ...
    private final synchronized void zzt(zzavx zzavxVar, zzarw zzarwVar) {
        ...
        try {
            try {
                ...
                Long l6 = zzavzVarZzq.zza;
                if (l6 != null) {
                    zzarwVar.zzh(l6.longValue());
                }
                Long l8 = zzavzVarZzq.zzb;
                if (l8 != null) {
                    zzarwVar.zzi(l8.longValue());
                }
                Long l10 = zzavzVarZzq.zzc;
                if (l10 != null) {
                    zzarwVar.zzj(l10.longValue());
                }
                if (this.zzp) {
                    Long l11 = zzavzVarZzq.zzd;
                    if (l11 != null) {
                        zzarwVar.zzv(l11.longValue());
                    }
                    Long l12 = zzavzVarZzq.zze;
                    if (l12 != null) {
                        zzarwVar.zzw(l12.longValue());
                    }
                }
            } catch (Throwable th2) {
                throw th2;
        ...
        try {
            ...
            Long l13 = zzavzVarZzm.zza;
            if (l13 != null) {
                zzaspVarZza.zza(l13.longValue());
            }
            Long l14 = zzavzVarZzm.zzb;
            if (l14 != null) {
                zzaspVarZza.zzb(l14.longValue());
            }
            zzaspVarZza.zzh(zzavzVarZzm.zzc.longValue());
            if (this.zzp) {
                Long l15 = zzavzVarZzm.zze;
                if (l15 != null) {
                    zzaspVarZza.zzc(l15.longValue());
                }
                Long l16 = zzavzVarZzm.zzd;
                if (l16 != null) {
                    zzaspVarZza.zzf(l16.longValue());
                }
                Long l17 = zzavzVarZzm.zzf;
                if (l17 != null) {
                    zzaspVarZza.zzs(l17.longValue() != 0 ? 2 : 1);
                }
                if (this.zze > 0) {
                ...
                Long l18 = zzavzVarZzm.zzi;
                if (l18 != null) {
                    zzaspVarZza.zzj(l18.longValue());
                }
                Long l19 = zzavzVarZzm.zzj;
                if (l19 != null) {
                    zzaspVarZza.zzi(l19.longValue());
                }
                Long l20 = zzavzVarZzm.zzk;
                if (l20 != null) {
                    zzaspVarZza.zzt(l20.longValue() != 0 ? 2 : 1);
                }
            }
        } catch (zzavn unused2) {
        }
    ...
    public final zzarw zza(Context context, zzari zzariVar) {
        long j;
        long jZzd;
        zzu();
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbci.zzcX)).booleanValue()) {
        ...
        if (zzavxVarZzp.zzc()) {
            ...
            zzarwVarZzi.zzl(Http2Stream.EMIT_BUFFER_SIZE);
        }
        zzs(arrayList);
        return zzarwVarZzi;
    }
    ...
    @Override // com.google.android.gms.internal.ads.zzauq
    public final zzarw zzb(Context context, View view, Activity activity) {
        zzu();
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbci.zzcX)).booleanValue()) {
            zzB.zzc();
        }
    ...
    @Override // com.google.android.gms.internal.ads.zzauq
    public final zzarw zzc(Context context, View view, Activity activity) {
        zzu();
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbci.zzcX)).booleanValue()) {
    ...
    public final void zzr(zzavx zzavxVar, zzarw zzarwVar, View view, Activity activity, boolean z4, Context context) {
        List listAsList;
        long jZzc;
        long jZzd;
        ...
        if (zzavxVar.zzc()) {
            ...
            zzarwVar.zzl(Http2Stream.EMIT_BUFFER_SIZE);
