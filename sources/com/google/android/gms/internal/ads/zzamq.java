...
public final class zzamq implements zzamd {
    ...
    private int zzr = androidx.media3.common.C.RATE_UNSET_INT;
    private int zzs = -1;
    private long zzu = -1;
    ...
    private static final void zzf(zzef zzefVar, zzef zzefVar2, boolean z4) {
    ...
    public final void zza() {
        ...
        this.zzo = 0;
        this.zzp = 0;
        this.zzr = androidx.media3.common.C.RATE_UNSET_INT;
        this.zzs = -1;
        this.zzt = 0;
        this.zzu = -1L;
        this.zzv = false;
            ...
            if (i4 == 0) {
                ...
                if (i12 == zzamrVar.zzc) {
                    ...
                    if (i13 == 1) {
                        ...
                        long j = this.zzu;
                        long j6 = zzamrVar.zzb;
                        if (j != j6) {
                            this.zzu = j6;
                            int i14 = zzamsVarZzb.zza;
                        ...
                        if (this.zzj) {
                            ...
                            this.zzh += (((double) i15) * 1000000.0d) / d10;
                        }
