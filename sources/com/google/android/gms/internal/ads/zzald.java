...
public final class zzald implements zzajv {
    ...
    public final void zza(byte[] bArr, int i, int i4, zzaju zzajuVar, zzdf zzdfVar) {
        ...
        while (zzefVar.zzd() > 0) {
            ...
            if (zzefVar.zzB() == 1987343459) {
                ...
                while (iZzB > 0) {
                    ...
                    int i6 = iZzB - 8;
                    int i10 = iZzB2 - 8;
                    String strZzj = zzeo.zzj(zzefVar.zzi(), zzefVar.zzg(), i10);
                    zzefVar.zzk(i10);
                    if (iZzB3 == 1937011815) {
        ...
        zzdfVar.zza(new zzajn(arrayList, androidx.media3.common.C.TIME_UNSET, androidx.media3.common.C.TIME_UNSET));
    }
}
