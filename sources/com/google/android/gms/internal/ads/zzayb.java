...
public final class zzayb {
    ...
    public static void zzh(Parcel parcel) {
        ...
        if (iDataAvail > 0) {
            throw new BadParcelableException(androidx.camera.core.impl.a.o(new StringBuilder(String.valueOf(iDataAvail).length() + 45), "Parcel data not fully consumed, unread size: ", iDataAvail));
        }
    }
}
