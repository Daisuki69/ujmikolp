...
public final class zzgxv extends zzgqd {
    ...
    public zzgxv(zzgzj zzgzjVar, zzgqt zzgqtVar) throws GeneralSecurityException {
        zze(zzgzjVar, zzgqtVar);
        this.zza = zzgzjVar;
    }

    private static void zze(zzgzj zzgzjVar, zzgqt zzgqtVar) throws GeneralSecurityException {
    ...
    public final zzgzj zzc(zzgqt zzgqtVar) throws GeneralSecurityException {
        zzgzj zzgzjVar = this.zza;
        zze(zzgzjVar, zzgqtVar);
        return zzgzjVar;
    }
