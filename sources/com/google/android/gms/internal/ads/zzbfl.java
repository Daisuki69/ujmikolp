...
public final class zzbfl extends AbstractSafeParcelable {
    ...
    public zzbfl(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) boolean z4, @SafeParcelable.Param(id = 3) int i4, @SafeParcelable.Param(id = 4) boolean z5, @SafeParcelable.Param(id = 5) int i6, @SafeParcelable.Param(id = 6) com.google.android.gms.ads.internal.client.zzga zzgaVar, @SafeParcelable.Param(id = 7) boolean z8, @SafeParcelable.Param(id = 8) int i10, @SafeParcelable.Param(id = 9) int i11, @SafeParcelable.Param(id = 10) boolean z9, @SafeParcelable.Param(id = 11) int i12) {
        this.zza = i;
        this.zzb = z4;
        this.zzc = i4;
        this.zzd = z5;
