...
public final class zzfpt extends AbstractSafeParcelable {
    ...
    public zzfpt(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i4, @SafeParcelable.Param(id = 5) int i6, @SafeParcelable.Param(id = 3) String str, @SafeParcelable.Param(id = 4) String str2) {
        this.zza = i;
        this.zzb = i4;
        this.zzc = str;
        this.zzd = str2;
