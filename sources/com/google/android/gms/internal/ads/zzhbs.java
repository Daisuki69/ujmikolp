    ...
    public static /* synthetic */ zzhar zzc(zzgzk zzgzkVar) throws GeneralSecurityException {
        ...
        try {
            ...
            if (zzhdoVarZzd.zzc() != 0) {
                ...
                throw new GeneralSecurityException(androidx.camera.core.impl.a.o(new StringBuilder(String.valueOf(iZzc).length() + 47), "Parsing HmacParameters failed: unknown Version ", iZzc));
            }
