...
public final class zzevq implements zzhpx {
    ...
    public static zzevo zzc(zzbyn zzbynVar, Context context, ScheduledExecutorService scheduledExecutorService, Executor executor, int i, boolean z4, boolean z5) {
        return new zzevo(zzbynVar, context, scheduledExecutorService, executor, i, z4, z5);
    }
