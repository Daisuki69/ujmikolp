...
public interface zzdjc {
    ...
    void zzc(View view, View view2, Map map, Map map2, boolean z4, @Nullable ImageView.ScaleType scaleType);

    void zzd(String str);

    void zze(Bundle bundle);

    void zzf(@Nullable View view, View view2, Map map, Map map2, boolean z4, @Nullable ImageView.ScaleType scaleType, int i);
