...
public final class zzcl {
    ...
    public /* synthetic */ zzcl(CharSequence charSequence, Layout.Alignment alignment, Layout.Alignment alignment2, Bitmap bitmap, float f, int i, int i4, float f3, int i6, int i10, float f7, float f10, float f11, boolean z4, int i11, int i12, float f12, int i13, byte[] bArr) {
