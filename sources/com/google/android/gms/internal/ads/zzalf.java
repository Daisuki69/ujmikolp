...
public final class zzalf {
    ...
    private static int zzA(int i, String str, @Nullable String str2, int i4) {
        if (str.isEmpty() || i == -1) {
            return i;
        }
        if (str.equals(str2)) {
    ...
    public final zzalf zzh(boolean z4) {
        this.zzj = 1;
        return this;
    }

    public final zzalf zzi(boolean z4) {
        this.zzk = 1;
        return this;
    }

    public final zzalf zzj(boolean z4) {
        this.zzl = 1;
        return this;
    }
    ...
    public final zzalf zzy(boolean z4) {
        this.zzp = z4;
        return this;
    }
