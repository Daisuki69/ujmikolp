...
public final class zzgvb {
    ...
    private static zzgrt zzg(zzhep zzhepVar) throws GeneralSecurityException {
        ...
        if (iOrdinal != 2) {
            ...
            if (iOrdinal != 4) {
                ...
                throw new GeneralSecurityException(androidx.camera.core.impl.a.o(new StringBuilder(String.valueOf(iZza).length() + 34), "Unable to parse OutputPrefixType: ", iZza));
            }
        }
        return zzgrt.zzb;
    }
    ...
    private static zzgrs zzh(zzhdk zzhdkVar) throws GeneralSecurityException {
        ...
        throw new GeneralSecurityException(androidx.camera.core.impl.a.o(new StringBuilder(String.valueOf(iZza).length() + 26), "Unable to parse HashType: ", iZza));
    }
