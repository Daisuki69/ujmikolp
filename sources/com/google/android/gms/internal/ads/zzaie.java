...
final class zzaie {
    ...
    public final int zzi(int i, int i4) {
        zzef zzefVar;
        zzait zzaitVarZzj = zzj();
        if (zzaitVarZzj == null) {
            return 0;
        }
        int i6 = zzaitVarZzj.zzd;
        if (i6 != 0) {
        ...
        boolean z4 = zZzb || i4 != 0;
        zzef zzefVar3 = this.zzk;
        zzefVar3.zzi()[0] = (byte) ((true != z4 ? 0 : 128) | i6);
        zzefVar3.zzh(0);
        zzaeb zzaebVar = this.zza;
        zzaebVar.zzw(zzefVar3, 1, 1);
        zzaebVar.zzw(zzefVar, i6, 1);
        if (!z4) {
            return i6 + 1;
        }
        if (!zZzb) {
        ...
        if (i4 != 0) {
            ...
            zzefVar5.zzm(bArrZzi2, 0, i11);
            int i12 = (((bArrZzi2[2] & 255) << 8) | (bArrZzi2[3] & 255)) + i4;
            bArrZzi2[2] = (byte) ((i12 >> 8) & 255);
            bArrZzi2[3] = (byte) (i12 & 255);
            zzefVar5 = zzefVar6;
        }
        zzaebVar.zzw(zzefVar5, i11, 1);
        return i10 + i11;
    }
