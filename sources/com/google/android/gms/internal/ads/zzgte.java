...
public final class zzgte implements zzgpx {
    ...
    public zzgte(zzhdw zzhdwVar, zzgpx zzgpxVar) throws GeneralSecurityException {
        if (!zze.contains(zzhdwVar.zza())) {
            ...
            throw new IllegalArgumentException(We.s.q(new StringBuilder(String.valueOf(strZza).length() + 67), "Unsupported DEK key type: ", strZza, ". Only Tink AEAD key types are supported."));
        }
