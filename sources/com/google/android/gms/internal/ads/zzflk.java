...
public final class zzflk {
    ...
    private zzflk(zzflo zzfloVar, zzflr zzflrVar, zzflw zzflwVar, zzflw zzflwVar2, boolean z4) {
        this.zzd = zzfloVar;
        this.zze = zzflrVar;
        this.zza = zzflwVar;
        if (zzflwVar2 == null) {
    ...
    public static zzflk zza(zzflo zzfloVar, zzflr zzflrVar, zzflw zzflwVar, zzflw zzflwVar2, boolean z4) {
        ...
        return new zzflk(zzfloVar, zzflrVar, zzflwVar, zzflwVar2, z4);
    }
