...
public final class zzhiy {
    ...
    static {
        ...
        zzc = zzhiyVar3;
        zzhiy zzhiyVar4 = new zzhiy("FLOAT", 3, Float.TYPE, Float.class, Float.valueOf(0.0f));
        zzd = zzhiyVar4;
        zzhiy zzhiyVar5 = new zzhiy("DOUBLE", 4, Double.TYPE, Double.class, Double.valueOf(AudioStats.AUDIO_AMPLITUDE_NONE));
        zze = zzhiyVar5;
