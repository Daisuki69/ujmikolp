...
class zzhkr extends AbstractMap {
    ...
    public final Object zzg(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i4] = new zzhko(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    private final int zzm(Comparable comparable) {
        ...
        int i6 = 0;
        if (i4 >= 0) {
            int iCompareTo = comparable.compareTo(((zzhko) this.zza[i4]).zza());
            if (iCompareTo > 0) {
                return -(i + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i6 <= i4) {
            int i10 = (i6 + i4) / 2;
            int iCompareTo2 = comparable.compareTo(((zzhko) this.zza[i10]).zza());
            if (iCompareTo2 < 0) {
                i4 = i10 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            if (!zzd(i4).equals(zzhkrVar.zzd(i4))) {
                return false;
            }
        }
        if (i != size) {
