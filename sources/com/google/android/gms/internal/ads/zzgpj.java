...
final class zzgpj extends zzgpf implements zzgpe {
    ...
    public final zzgpc scheduleAtFixedRate(Runnable runnable, long j, long j6, TimeUnit timeUnit) {
        zzgpi zzgpiVar = new zzgpi(runnable);
        return new zzgph(zzgpiVar, this.zza.scheduleAtFixedRate(zzgpiVar, j, j6, timeUnit));
    }

    @Override // com.google.android.gms.internal.ads.zzgpe, java.util.concurrent.ScheduledExecutorService
    /* JADX INFO: renamed from: zzg, reason: merged with bridge method [inline-methods] */
    public final zzgpc scheduleWithFixedDelay(Runnable runnable, long j, long j6, TimeUnit timeUnit) {
        zzgpi zzgpiVar = new zzgpi(runnable);
        return new zzgph(zzgpiVar, this.zza.scheduleWithFixedDelay(zzgpiVar, j, j6, timeUnit));
    }
}
