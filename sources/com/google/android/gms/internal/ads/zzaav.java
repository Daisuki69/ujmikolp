...
final class zzaav {
    ...
    public zzaav(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, fromInclusive = false) float f) {
        Range range = new Range(Double.valueOf(AudioStats.AUDIO_AMPLITUDE_NONE), Double.valueOf(1.0d));
        this.zzd = range;
    ...
    */
    ...
    public final long zzb(long j) {
        if (this.zza == androidx.media3.common.C.TIME_UNSET) {
            return androidx.media3.common.C.TIME_UNSET;
        }
        return (long) (((j - r0) * this.zzc) + this.zzb);
    }

    public final void zzc(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, fromInclusive = false) float f) {
        zzghc.zza(f > 0.0f);
        this.zzd = new Range(Double.valueOf(AudioStats.AUDIO_AMPLITUDE_NONE), Double.valueOf(1.0d / ((double) f)));
        zzd();
    }
