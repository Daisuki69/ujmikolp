...
public final class zzgmu {
    ...
    */
    ...
    public static boolean zzb(double d10) {
        if (d10 > AudioStats.AUDIO_AMPLITUDE_NONE && zzgmv.zzb(d10)) {
            long jZza = zzgmv.zza(d10);
            if ((jZza & ((-1) + jZza)) == 0) {
                return true;
            }
        }
    ...
    */
    ...
    public static boolean zzd(double d10) {
        if (zzgmv.zzb(d10)) {
            return d10 == AudioStats.AUDIO_AMPLITUDE_NONE || 52 - Long.numberOfTrailingZeros(zzgmv.zza(d10)) <= Math.getExponent(d10);
        }
        return false;
    }
}
