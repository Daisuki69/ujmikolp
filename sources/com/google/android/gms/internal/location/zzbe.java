...
public final class zzbe extends GmsClient {
    ...
    public final void zzD(zzbf zzbfVar, PendingIntent pendingIntent, zzai zzaiVar) throws RemoteException {
        getContext();
        ((zzam) getService()).zzz(new zzbh(1, zzbfVar, null, null, pendingIntent, zzaiVar, AbstractC1173g.q(25, pendingIntent.hashCode(), "PendingIntent@")));
    }
    ...
    public final void zzF(boolean z4, IStatusCallback iStatusCallback) throws RemoteException {
        if (zzG(com.google.android.gms.location.zzy.zzg)) {
            ((zzam) getService()).zzx(z4, iStatusCallback);
        } else {
            ((zzam) getService()).zzw(z4);
            iStatusCallback.onResult(Status.RESULT_SUCCESS);
        }
        this.zzj = z4;
    }
