...
public final class zzal extends zza implements zzam {
    ...
    @Override // com.google.android.gms.internal.location.zzam
    public final void zzr(long j, boolean z4, PendingIntent pendingIntent) throws RemoteException {
        Parcel parcelZza = zza();
    ...
    public final void zzw(boolean z4) throws RemoteException {
        Parcel parcelZza = zza();
        zzc.zzb(parcelZza, z4);
        zzB(12, parcelZza);
    }

    @Override // com.google.android.gms.internal.location.zzam
    public final void zzx(boolean z4, IStatusCallback iStatusCallback) throws RemoteException {
        Parcel parcelZza = zza();
        zzc.zzb(parcelZza, z4);
        zzc.zzd(parcelZza, iStatusCallback);
        zzB(84, parcelZza);
