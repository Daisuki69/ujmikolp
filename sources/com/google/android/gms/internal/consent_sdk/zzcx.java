...
public final class zzcx {
    public static int zza(int i, int i4, String str) {
        ...
        if (i < 0) {
            ...
            strZza = zzcy.zza("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i), Integer.valueOf(i4));
        }
    ...
    public static void zzc(int i, int i4, int i6) {
        if (i < 0 || i4 < i || i4 > i6) {
            throw new IndexOutOfBoundsException((i < 0 || i > i6) ? zzd(i, i6, "start index") : (i4 < 0 || i4 > i6) ? zzd(i4, i6, "end index") : zzcy.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i4), Integer.valueOf(i)));
        }
    }
    ...
    private static String zzd(int i, int i4, String str) {
        ...
        if (i4 >= 0) {
            return zzcy.zza("%s (%s) must not be greater than size (%s)", str, Integer.valueOf(i), Integer.valueOf(i4));
        }
        throw new IllegalArgumentException(s.f(i4, "negative size: "));
    }
}
