...
public final class zzf extends AbstractSafeParcelable {
    ...
    public zzf(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i4, @SafeParcelable.Param(id = 3) float f, @SafeParcelable.Param(id = 4) float f3, @SafeParcelable.Param(id = 5) float f7, @SafeParcelable.Param(id = 6) float f10, @SafeParcelable.Param(id = 7) float f11, @SafeParcelable.Param(id = 8) float f12, @SafeParcelable.Param(id = 14) float f13, @SafeParcelable.Param(id = 9) zzn[] zznVarArr, @SafeParcelable.Param(id = 10) float f14, @SafeParcelable.Param(id = 11) float f15, @SafeParcelable.Param(id = 12) float f16, @SafeParcelable.Param(id = 13) zzd[] zzdVarArr, @SafeParcelable.Param(id = 15) float f17) {
        this.zza = i;
        this.zzb = i4;
        this.zzc = f;
        this.zzd = f3;
