...
public enum zzmv implements zzba {
    ...
    ACCELERATION_ANALYTICS(MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_ROUTE_VOLUME_CHANGED),
    PIPELINE_ACCELERATION_ANALYTICS(MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_ROUTE_PRESENTATION_DISPLAY_CHANGED),
    ...
    AGGREGATED_ON_DEVICE_EXPLICIT_CONTENT_DETECTION(MfaTencentErrorResult.TENCENT_ERROR_LOCAL_REF_FAILED),
    AGGREGATED_ON_DEVICE_FACE_MESH_DETECTION(MfaTencentErrorResult.TENCENT_ERROR_USER_STOPS),
    AGGREGATED_ON_DEVICE_IMAGE_QUALITY_ANALYSIS_DETECTION(MfaTencentErrorResult.TENCENT_ERROR_INNER_ERROR_CODE),
    AGGREGATED_ON_DEVICE_IMAGE_CAPTIONING_INFERENCE(MfaTencentErrorResult.TENCENT_ERROR_APP_SWITCH),
    AGGREGATED_ON_DEVICE_DOCUMENT_DETECT_PROCESS(MfaTencentErrorResult.TENCENT_ERROR_CAMERA_PERMISSION),
    AGGREGATED_ON_DEVICE_DOCUMENT_CROP_PROCESS(MfaTencentErrorResult.TENCENT_ERROR_INIT_SDK),
    AGGREGATED_ON_DEVICE_DOCUMENT_ENHANCE_PROCESS(MfaTencentErrorResult.TENCENT_ERROR_FACE_DETECTION_TIMED_OUT),
    AGGREGATED_ON_DEVICE_STAIN_REMOVAL_PROCESS(MfaTencentErrorResult.TENCENT_ERROR_PERMISSION_CHECK),
    AGGREGATED_ON_DEVICE_SHADOW_REMOVAL_PROCESS(MfaTencentErrorResult.TENCENT_ERROR_APP_STOP),
    AGGREGATED_ON_DEVICE_SUBJECT_SEGMENTATION_INFERENCE(MfaTencentErrorResult.TENCENT_ERROR_LIVE_DATA),
    ...
    ON_DEVICE_FACE_MESH_CLOSE(MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_PROVIDER_REMOVED),
