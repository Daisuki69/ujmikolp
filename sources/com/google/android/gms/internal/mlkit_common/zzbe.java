...
final class zzbe implements InterfaceC2296d {
    ...
    static {
        ...
        zzd = new InterfaceC2295c() { // from class: com.google.android.gms.internal.mlkit_common.zzbd
            @Override // u2.InterfaceC2293a
            public final void encode(Object obj, Object obj2) throws IOException {
                zzbe.zzg((Map.Entry) obj, (InterfaceC2296d) obj2);
            }
        };
    }

    public zzbe(OutputStream outputStream, Map map, Map map2, InterfaceC2295c interfaceC2295c) {
    ...
    private static int zzh(C2294b c2294b) {
        zzbc zzbcVar = (zzbc) c2294b.b(zzbc.class);
        if (zzbcVar != null) {
            return zzbcVar.zza();
        }
    ...
    private static zzbc zzj(C2294b c2294b) {
        zzbc zzbcVar = (zzbc) c2294b.b(zzbc.class);
        if (zzbcVar != null) {
            return zzbcVar;
        }
    ...
    private final zzbe zzk(InterfaceC2295c interfaceC2295c, C2294b c2294b, Object obj, boolean z4) throws IOException {
    ...
    private final zzbe zzl(InterfaceC2297e interfaceC2297e, C2294b c2294b, Object obj, boolean z4) throws IOException {
    ...
    public final zzbe zzd(@NonNull C2294b c2294b, int i, boolean z4) throws IOException {
        if (!z4 || i != 0) {
            zzbc zzbcVarZzj = zzj(c2294b);
    ...
    public final zzbe zze(@NonNull C2294b c2294b, long j, boolean z4) throws IOException {
        if (!z4 || j != 0) {
            zzbc zzbcVarZzj = zzj(c2294b);
            int iOrdinal = zzbcVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
