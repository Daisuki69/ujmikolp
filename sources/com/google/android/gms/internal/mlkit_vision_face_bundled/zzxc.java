...
final class zzxc {
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.mlkit_vision_face_bundled.zzxc.<clinit>():void");
    }
    ...
    public static void zzD(Object obj, long j, byte b8) {
        zzxb zzxbVar = zzf;
        long j6 = (-4) & j;
        int i = zzxbVar.zza.getInt(obj, j6);
        int i4 = ((~((int) j)) & 3) << 3;
        zzxbVar.zza.putInt(obj, j6, ((255 & b8) << i4) | (i & (~(255 << i4))));
    }
    ...
    public static void zzE(Object obj, long j, byte b8) {
        ...
        long j6 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        zzxbVar.zza.putInt(obj, j6, ((255 & b8) << i) | (zzxbVar.zza.getInt(obj, j6) & (~(255 << i))));
    }
    ...
    public static /* bridge */ /* synthetic */ void zzh(Throwable th2) {
        Logger.getLogger(zzxc.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th2.toString()));
    }
