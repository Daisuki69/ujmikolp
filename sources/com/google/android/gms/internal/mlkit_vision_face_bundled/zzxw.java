                            ...
                            default:
                                switch (i) {
                                    case MfaTencentErrorResult.TENCENT_ERROR_LIVE_DATA /* 220 */:
                                        return 221;
                                    case 221:
                                        return MfaTencentErrorResult.TENCENT_ERROR_LOCAL_TIME_OUT;
                                    case MfaTencentErrorResult.TENCENT_ERROR_LOCAL_TIME_OUT /* 222 */:
                                        return MfaTencentErrorResult.TENCENT_ERROR_PREPARE_TIME_OUT;
                                    ...
                                    case 226:
                                        return 227;
                                    case 227:
                                        return MfaTencentErrorResult.TENCENT_ERROR_NO_FACE_WHILE_CAPTURING;
                                    default:
                                        switch (i) {
                                            case 238:
                                                return 239;
