...
final class zzbo implements InterfaceC2296d {
    ...
    static {
        ...
        zzd = new InterfaceC2295c() { // from class: com.google.android.gms.internal.mlkit_vision_face_bundled.zzbn
            @Override // u2.InterfaceC2293a
            public final void encode(Object obj, Object obj2) throws IOException {
                zzbo.zzg((Map.Entry) obj, (InterfaceC2296d) obj2);
            }
        };
    }

    public zzbo(OutputStream outputStream, Map map, Map map2, InterfaceC2295c interfaceC2295c) {
    ...
    private static int zzh(C2294b c2294b) {
        zzbm zzbmVar = (zzbm) c2294b.b(zzbm.class);
        if (zzbmVar != null) {
            return zzbmVar.zza();
        }
    ...
    private static zzbm zzj(C2294b c2294b) {
        zzbm zzbmVar = (zzbm) c2294b.b(zzbm.class);
        if (zzbmVar != null) {
            return zzbmVar;
        }
    ...
    private final zzbo zzk(InterfaceC2295c interfaceC2295c, C2294b c2294b, Object obj, boolean z4) throws IOException {
    ...
    private final zzbo zzl(InterfaceC2297e interfaceC2297e, C2294b c2294b, Object obj, boolean z4) throws IOException {
    ...
    public final zzbo zzd(@NonNull C2294b c2294b, int i, boolean z4) throws IOException {
        if (!z4 || i != 0) {
            zzbm zzbmVarZzj = zzj(c2294b);
            int iOrdinal = zzbmVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
                zzn(zzbmVarZzj.zza() << 3);
                zzn(i);
                return this;
            }
            if (iOrdinal == 1) {
    ...
    public final zzbo zze(@NonNull C2294b c2294b, long j, boolean z4) throws IOException {
        if (!z4 || j != 0) {
            zzbm zzbmVarZzj = zzj(c2294b);
            int iOrdinal = zzbmVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
    ...
    public final zzbo zzf(@Nullable Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        InterfaceC2295c interfaceC2295c = (InterfaceC2295c) this.zzf.get(obj.getClass());
