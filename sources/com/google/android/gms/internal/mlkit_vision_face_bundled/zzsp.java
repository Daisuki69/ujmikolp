...
public final class zzsp extends AbstractSafeParcelable {
    ...
    public zzsp(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i4, @SafeParcelable.Param(id = 3) int i6, @SafeParcelable.Param(id = 4) int i10, @SafeParcelable.Param(id = 5) long j) {
        this.zza = i;
        this.zzb = i4;
        this.zzc = i6;
        this.zzd = i10;
