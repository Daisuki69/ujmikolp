...
public final class zzs extends AbstractSafeParcelable {
    ...
    public zzs(@SafeParcelable.Param(id = 2) int i, @SafeParcelable.Param(id = 3) int i4, @SafeParcelable.Param(id = 4) int i6, @SafeParcelable.Param(id = 5) long j, @SafeParcelable.Param(id = 6) int i10) {
        this.zza = i;
        this.zzb = i4;
        this.zzc = i6;
        this.zzd = j;
