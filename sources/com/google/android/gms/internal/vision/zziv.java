...
public final class zziv {
    ...
    private zziv(String str, int i, int i4, zzix zzixVar, zzjm zzjmVar) {
        int i6;
        this.zzba = i4;
        this.zzbb = zzixVar;
        this.zzaz = zzjmVar;
        int i10 = zziy.zza[zzixVar.ordinal()];
        if (i10 == 1 || i10 == 2) {
            this.zzbc = zzjmVar.zza();
        } else {
            this.zzbc = null;
        }
        this.zzbd = (zzixVar != zzix.SCALAR || (i6 = zziy.zzb[zzjmVar.ordinal()]) == 1 || i6 == 2 || i6 == 3) ? false : true;
    }
