...
public final class zzfi {
    ...
    public static final class zzg extends zzjb<zzg, zza> implements zzkm {
        ...
        public static final class zza extends zzjb.zzb<zzg, zza> implements zzkm {
            ...
            public final zza zzb(boolean z4) {
                if (this.zzb) {
                    zzb();
                    this.zzb = false;
                }
            ...
            public final zza zza(boolean z4) {
                if (this.zzb) {
                    zzb();
                    this.zzb = false;
                }
    ...
    public static final class zza extends zzjb<zza, C0038zza> implements zzkm {
        ...
        public static final class C0038zza extends zzjb.zzb<zza, C0038zza> implements zzkm {
            private C0038zza() {
                super(zza.zzf);
            }
            ...
            public final C0038zza zzb(String str) {
                if (this.zzb) {
                    zzb();
                    this.zzb = false;
                }
            ...
            public /* synthetic */ C0038zza(zzfk zzfkVar) {
                this();
            }
        }
