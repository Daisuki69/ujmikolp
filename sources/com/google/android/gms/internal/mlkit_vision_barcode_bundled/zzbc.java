...
public final class zzbc extends AbstractSafeParcelable {
    ...
    public zzbc(@SafeParcelable.Param(id = 1) zzbt zzbtVar, @SafeParcelable.Param(id = 2) zzbv zzbvVar, @SafeParcelable.Param(id = 3) boolean z4, @SafeParcelable.Param(id = 4) boolean z5) {
        this.zza = zzbtVar;
        this.zzb = zzbvVar;
        this.zzd = z5;
    }
