...
public abstract class zzeh<MessageType extends zzeh<MessageType, BuilderType>, BuilderType extends zzeb<MessageType, BuilderType>> extends zzcq<MessageType, BuilderType> {
    ...
    public static final boolean zzX(zzeh zzehVar, boolean z4) {
    ...
    private static zzeh zze(zzeh zzehVar, byte[] bArr, int i, int i4, zzds zzdsVar) throws zzer {
        if (i4 == 0) {
            return zzehVar;
        }
        ...
        try {
            ...
            zzgeVarZzb.zzh(zzehVarZzK, bArr, 0, i4, new zzcu(zzdsVar));
    ...
    public final int zzF() {
        if (zzY()) {
            ...
            throw new IllegalStateException(s.f(iZzc, "serialized size must be non-negative, was "));
        }
        int i = this.zzd & Integer.MAX_VALUE;
        if (i != Integer.MAX_VALUE) {
            return i;
        ...
        int iZzc2 = zzc(null);
        if (iZzc2 < 0) {
            throw new IllegalStateException(s.f(iZzc2, "serialized size must be non-negative, was "));
        }
