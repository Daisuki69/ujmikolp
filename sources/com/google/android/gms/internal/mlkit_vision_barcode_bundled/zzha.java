...
final class zzha {
    public static /* bridge */ /* synthetic */ void zza(byte b8, byte b10, byte b11, byte b12, char[] cArr, int i) throws zzer {
        if (!zze(b10)) {
  ...
  0x0016: PHI (r2v3 byte) = (r2v2 byte), (r2v9 byte) binds: [B:9:0x0011, B:11:0x0015] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public static /* bridge */ /* synthetic */ void zzc(byte b8, byte b10, char[] cArr, int i) throws zzer {
        if (b8 < -62 || zze(b10)) {
            throw new zzer("Protocol message had invalid UTF-8.");
        }
