...
public class FlagProviderImpl extends com.google.android.gms.flags.zzd {
    ...
    public boolean getBooleanFlagValue(String str, boolean z4, int i) {
        return !this.zzu ? z4 : zzb.zza(this.zzv, str, Boolean.valueOf(z4)).booleanValue();
    }

    @Override // com.google.android.gms.flags.zzc
    public int getIntFlagValue(String str, int i, int i4) {
