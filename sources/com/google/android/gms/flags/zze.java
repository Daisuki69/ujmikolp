...
public final class zze extends com.google.android.gms.internal.flags.zza implements zzc {
    ...
    public final boolean getBooleanFlagValue(String str, boolean z4, int i) throws RemoteException {
        Parcel parcelZza = zza();
        parcelZza.writeString(str);
        com.google.android.gms.internal.flags.zzc.writeBoolean(parcelZza, z4);
    ...
    @Override // com.google.android.gms.flags.zzc
    public final int getIntFlagValue(String str, int i, int i4) throws RemoteException {
        Parcel parcelZza = zza();
        parcelZza.writeString(str);
        parcelZza.writeInt(i);
        parcelZza.writeInt(i4);
        Parcel parcelZza2 = zza(3, parcelZza);
        int i6 = parcelZza2.readInt();
        parcelZza2.recycle();
        return i6;
    }
