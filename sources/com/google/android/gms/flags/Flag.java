...
public abstract class Flag<T> {
    ...
    public static class LongFlag extends Flag<Long> {
        public LongFlag(int i, String str, Long l6) {
            super(i, str, l6);
        }
    ...
    private Flag(int i, String str, T t5) {
        this.zze = i;
        this.mKey = str;
        this.zzf = t5;
    ...
    @KeepForSdk
    @Deprecated
    public static IntegerFlag define(int i, String str, int i4) {
        return new IntegerFlag(i, str, Integer.valueOf(i4));
    }
