...
public abstract class PigeonApiPermissionRequest {
    ...
    public static final class Companion {
        ...
        public static final void setUpMessageHandlers$lambda$1$lambda$0(PigeonApiPermissionRequest pigeonApiPermissionRequest, Object obj, InterfaceC2041d reply) {
            ...
            kotlin.jvm.internal.j.e(obj2, "null cannot be cast to non-null type android.webkit.PermissionRequest");
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final void setUpMessageHandlers$lambda$3$lambda$2(PigeonApiPermissionRequest pigeonApiPermissionRequest, Object obj, InterfaceC2041d reply) {
            List<Object> listWrapError;
            kotlin.jvm.internal.j.g(reply, "reply");
            kotlin.jvm.internal.j.e(obj, "null cannot be cast to non-null type kotlin.collections.List<kotlin.Any?>");
        ...
        public final void setUpMessageHandlers(pg.j binaryMessenger, final PigeonApiPermissionRequest pigeonApiPermissionRequest) {
            ...
            C2042e c2042e = new C2042e(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.PermissionRequest.grant", androidWebkitLibraryPigeonCodec, null);
            if (pigeonApiPermissionRequest != null) {
                final int i = 0;
                c2042e.b(new InterfaceC2040c() { // from class: io.flutter.plugins.webviewflutter.p
                    @Override // pg.InterfaceC2040c
                    public final void onMessage(Object obj, InterfaceC2041d interfaceC2041d) {
                        switch (i) {
                            case 0:
                                PigeonApiPermissionRequest.Companion.setUpMessageHandlers$lambda$1$lambda$0(pigeonApiPermissionRequest, obj, (C1421c) interfaceC2041d);
                                break;
                            default:
                                PigeonApiPermissionRequest.Companion.setUpMessageHandlers$lambda$3$lambda$2(pigeonApiPermissionRequest, obj, (C1421c) interfaceC2041d);
                                break;
                        }
                    }
                });
            ...
            C2042e c2042e2 = new C2042e(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.PermissionRequest.deny", androidWebkitLibraryPigeonCodec, null);
            if (pigeonApiPermissionRequest == null) {
                c2042e2.b(null);
            } else {
                final int i4 = 1;
                c2042e2.b(new InterfaceC2040c() { // from class: io.flutter.plugins.webviewflutter.p
                    @Override // pg.InterfaceC2040c
                    public final void onMessage(Object obj, InterfaceC2041d interfaceC2041d) {
                        switch (i4) {
                            case 0:
    ...
    public final void pigeon_newInstance(PermissionRequest pigeon_instanceArg, Function1<? super C1037h<Unit>, Unit> callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new C2042e(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.PermissionRequest.pigeon_newInstance", getPigeonRegistrar().getCodec(), null).a(C1132s.g(Long.valueOf(jAddHostCreatedInstance), resources(pigeon_instanceArg)), new C1636b(13, callback));
        }
    }
