...
public abstract class PigeonApiFileChooserParams {
    ...
    public final void pigeon_newInstance(WebChromeClient.FileChooserParams pigeon_instanceArg, Function1<? super C1037h<Unit>, Unit> callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new C2042e(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.FileChooserParams.pigeon_newInstance", getPigeonRegistrar().getCodec(), null).a(C1132s.g(Long.valueOf(jAddHostCreatedInstance), Boolean.valueOf(zIsCaptureEnabled), acceptTypes(pigeon_instanceArg), mode(pigeon_instanceArg), filenameHint(pigeon_instanceArg)), new C1636b(8, callback));
        }
    }
}
