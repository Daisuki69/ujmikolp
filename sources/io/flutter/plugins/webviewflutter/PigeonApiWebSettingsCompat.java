...
public abstract class PigeonApiWebSettingsCompat {
    ...
    public static final class Companion {
        ...
        public static final void setUpMessageHandlers$lambda$1$lambda$0(PigeonApiWebSettingsCompat pigeonApiWebSettingsCompat, Object obj, InterfaceC2041d reply) {
        ...
        public final void setUpMessageHandlers(pg.j binaryMessenger, PigeonApiWebSettingsCompat pigeonApiWebSettingsCompat) {
            ...
            C2042e c2042e = new C2042e(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.WebSettingsCompat.setPaymentRequestEnabled", androidWebkitLibraryPigeonCodec, null);
            if (pigeonApiWebSettingsCompat != null) {
                c2042e.b(new C1644j(pigeonApiWebSettingsCompat, 6));
            } else {
                c2042e.b(null);
            }
        }
    ...
    public final void pigeon_newInstance(WebSettingsCompat pigeon_instanceArg, Function1<? super C1037h<Unit>, Unit> callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new C2042e(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.WebSettingsCompat.pigeon_newInstance", getPigeonRegistrar().getCodec(), null).a(cj.r.c(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg))), new v(6, callback));
        }
    }
