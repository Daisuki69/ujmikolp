...
public class ProxyApiRegistrar extends AndroidWebkitLibraryPigeonProxyApiRegistrar {
    ...
    public ProxyApiRegistrar(@NonNull pg.j jVar, @NonNull Context context, @NonNull FlutterAssetManager flutterAssetManager) {
        super(jVar);
    ...
    public String createUnsupportedVersionMessage(@NonNull String str, @NonNull String str2) {
        return androidx.media3.datasource.cache.c.l(str, " requires ", str2, ".");
    }
