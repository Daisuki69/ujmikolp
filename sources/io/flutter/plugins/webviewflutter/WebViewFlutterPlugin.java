...
public class WebViewFlutterPlugin implements FlutterPlugin, ActivityAware {
    ...
    public void onAttachedToEngine(@NonNull FlutterPlugin.FlutterPluginBinding flutterPluginBinding) {
        ...
        ((com.google.firebase.messaging.p) flutterPluginBinding.getPlatformViewRegistry()).x("plugins.flutter.io/webview", new FlutterViewFactory(this.proxyApiRegistrar.getInstanceManager()));
