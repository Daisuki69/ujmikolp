...
public abstract class PigeonApiWebViewFeature {
    ...
    public static final class Companion {
        ...
        public static final void setUpMessageHandlers$lambda$1$lambda$0(PigeonApiWebViewFeature pigeonApiWebViewFeature, Object obj, InterfaceC2041d reply) {
            ...
            try {
                listWrapError = cj.r.c(Boolean.valueOf(pigeonApiWebViewFeature.isFeatureSupported((String) obj2)));
            } catch (Throwable th2) {
        ...
        public final void setUpMessageHandlers(pg.j binaryMessenger, PigeonApiWebViewFeature pigeonApiWebViewFeature) {
            ...
            C2042e c2042e = new C2042e(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.WebViewFeature.isFeatureSupported", androidWebkitLibraryPigeonCodec, null);
            if (pigeonApiWebViewFeature != null) {
                c2042e.b(new C1644j(pigeonApiWebViewFeature, 7));
            } else {
                c2042e.b(null);
            }
        }
    ...
    public final void pigeon_newInstance(WebViewFeature pigeon_instanceArg, Function1<? super C1037h<Unit>, Unit> callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new C2042e(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.WebViewFeature.pigeon_newInstance", getPigeonRegistrar().getCodec(), null).a(cj.r.c(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg))), new v(28, callback));
        }
    }
}
