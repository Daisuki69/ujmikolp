...
public abstract class PigeonApiWebResourceErrorCompat {
    ...
    public final void pigeon_newInstance(WebResourceErrorCompat pigeon_instanceArg, Function1<? super C1037h<Unit>, Unit> callback) {
        int i = 2;
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new C2042e(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.WebResourceErrorCompat.pigeon_newInstance", getPigeonRegistrar().getCodec(), null).a(C1132s.g(Long.valueOf(jAddHostCreatedInstance), Long.valueOf(jErrorCode), description(pigeon_instanceArg)), new v(i, callback));
        }
    }
}
