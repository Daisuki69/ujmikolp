...
public abstract class PigeonApiWebStorage {
    ...
    public static final class Companion {
        ...
        public static final void setUpMessageHandlers$lambda$1$lambda$0(PigeonApiWebStorage pigeonApiWebStorage, Object obj, InterfaceC2041d reply) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final void setUpMessageHandlers$lambda$3$lambda$2(PigeonApiWebStorage pigeonApiWebStorage, Object obj, InterfaceC2041d reply) {
            List<Object> listWrapError;
            kotlin.jvm.internal.j.g(reply, "reply");
            kotlin.jvm.internal.j.e(obj, "null cannot be cast to non-null type kotlin.collections.List<kotlin.Any?>");
            Object obj2 = ((List) obj).get(0);
            kotlin.jvm.internal.j.e(obj2, "null cannot be cast to non-null type android.webkit.WebStorage");
            try {
        ...
        public final void setUpMessageHandlers(pg.j binaryMessenger, final PigeonApiWebStorage pigeonApiWebStorage) {
            ...
            C2042e c2042e = new C2042e(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.WebStorage.instance", androidWebkitLibraryPigeonCodec, null);
            if (pigeonApiWebStorage != null) {
                final int i = 0;
                c2042e.b(new InterfaceC2040c() { // from class: io.flutter.plugins.webviewflutter.y
                    @Override // pg.InterfaceC2040c
                    public final void onMessage(Object obj, InterfaceC2041d interfaceC2041d) {
                        switch (i) {
                            case 0:
                                PigeonApiWebStorage.Companion.setUpMessageHandlers$lambda$1$lambda$0(pigeonApiWebStorage, obj, (C1421c) interfaceC2041d);
                                break;
                            default:
                                PigeonApiWebStorage.Companion.setUpMessageHandlers$lambda$3$lambda$2(pigeonApiWebStorage, obj, (C1421c) interfaceC2041d);
                                break;
                        }
                    }
                });
            ...
            C2042e c2042e2 = new C2042e(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.WebStorage.deleteAllData", androidWebkitLibraryPigeonCodec, null);
            if (pigeonApiWebStorage == null) {
                c2042e2.b(null);
            } else {
                final int i4 = 1;
                c2042e2.b(new InterfaceC2040c() { // from class: io.flutter.plugins.webviewflutter.y
                    @Override // pg.InterfaceC2040c
                    public final void onMessage(Object obj, InterfaceC2041d interfaceC2041d) {
                        switch (i4) {
                            case 0:
    ...
    public final void pigeon_newInstance(WebStorage pigeon_instanceArg, Function1<? super C1037h<Unit>, Unit> callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new C2042e(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.WebStorage.pigeon_newInstance", getPigeonRegistrar().getCodec(), null).a(cj.r.c(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg))), new v(7, callback));
        }
    }
}
