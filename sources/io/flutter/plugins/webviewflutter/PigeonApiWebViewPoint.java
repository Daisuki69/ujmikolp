...
public abstract class PigeonApiWebViewPoint {
    ...
    public final void pigeon_newInstance(WebViewPoint pigeon_instanceArg, Function1<? super C1037h<Unit>, Unit> callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new C2042e(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.WebViewPoint.pigeon_newInstance", getPigeonRegistrar().getCodec(), null).a(C1132s.g(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg)), Long.valueOf(x(pigeon_instanceArg)), Long.valueOf(y(pigeon_instanceArg))), new v(29, callback));
        }
    }
