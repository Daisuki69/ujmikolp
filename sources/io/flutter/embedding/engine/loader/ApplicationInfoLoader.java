...
public final class ApplicationInfoLoader {
    ...
    private static boolean getBoolean(Bundle bundle, String str, boolean z4) {
    ...
    private static void parseDomain(XmlResourceParser xmlResourceParser, JSONArray jSONArray, boolean z4) throws XmlPullParserException, IOException {
    ...
    private static void parseDomainConfig(XmlResourceParser xmlResourceParser, JSONArray jSONArray, boolean z4) throws XmlPullParserException, IOException {
