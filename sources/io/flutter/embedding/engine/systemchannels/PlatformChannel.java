...
public class PlatformChannel {
    ...
    @NonNull
    @VisibleForTesting
    final s parsingMethodCallHandler;
    ...
    public enum Brightness {
        ...
        public static Brightness fromValue(@NonNull String str) throws NoSuchFieldException {
            ...
            throw new NoSuchFieldException(AbstractC1414e.h("No such Brightness: ", str));
        }
    }
    ...
    public enum ClipboardContentFormat {
        ...
        public static ClipboardContentFormat fromValue(@NonNull String str) throws NoSuchFieldException {
            ...
            throw new NoSuchFieldException(AbstractC1414e.h("No such ClipboardContentFormat: ", str));
        }
    }
    ...
    public enum DeviceOrientation {
        ...
        public static DeviceOrientation fromValue(@NonNull String str) throws NoSuchFieldException {
            ...
            throw new NoSuchFieldException(AbstractC1414e.h("No such DeviceOrientation: ", str));
        }
    }
    ...
    public enum HapticFeedbackType {
        ...
        public static HapticFeedbackType fromValue(@Nullable String str) throws NoSuchFieldException {
            ...
            throw new NoSuchFieldException(AbstractC1414e.h("No such HapticFeedbackType: ", str));
        }
    }
    ...
    public enum SoundType {
        ...
        public static SoundType fromValue(@NonNull String str) throws NoSuchFieldException {
            ...
            throw new NoSuchFieldException(AbstractC1414e.h("No such SoundType: ", str));
        }
    }
    ...
    public enum SystemUiMode {
        ...
        public static SystemUiMode fromValue(@NonNull String str) throws NoSuchFieldException {
            ...
            throw new NoSuchFieldException(AbstractC1414e.h("No such SystemUiMode: ", str));
        }
    }
    ...
    public enum SystemUiOverlay {
        ...
        public static SystemUiOverlay fromValue(@NonNull String str) throws NoSuchFieldException {
            ...
            throw new NoSuchFieldException(AbstractC1414e.h("No such SystemUiOverlay: ", str));
        }
    }

    public PlatformChannel(@NonNull DartExecutor dartExecutor) {
        s sVar = new s() { // from class: io.flutter.embedding.engine.systemchannels.PlatformChannel.1
            ...
            */
            public void onMethodCall(@androidx.annotation.NonNull pg.r r6, @androidx.annotation.NonNull pg.t r7) {
                /*
                    Method dump skipped, instruction units count: 714
                    To view this dump add '--comments-level debug' option
                */
                throw new UnsupportedOperationException("Method not decompiled: io.flutter.embedding.engine.systemchannels.PlatformChannel.AnonymousClass1.onMethodCall(pg.r, pg.t):void");
            }
        };
        this.parsingMethodCallHandler = sVar;
        u uVar = new u(dartExecutor, "flutter/platform", p.f19111a, null);
        this.channel = uVar;
        uVar.b(sVar);
    }
    ...
    */
    ...
    public List<SystemUiOverlay> decodeSystemUiOverlays(@NonNull JSONArray jSONArray) throws JSONException, NoSuchFieldException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            int i4 = AnonymousClass2.$SwitchMap$io$flutter$embedding$engine$systemchannels$PlatformChannel$SystemUiOverlay[SystemUiOverlay.fromValue(jSONArray.getString(i)).ordinal()];
            if (i4 == 1) {
    ...
    public void systemChromeChanged(boolean z4) {
        this.channel.a("SystemChrome.systemUIChange", Arrays.asList(Boolean.valueOf(z4)), null);
    }
}
