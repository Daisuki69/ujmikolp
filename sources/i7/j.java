...
public final class j extends RecyclerView.ViewHolder implements H7.c {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final D7.a f2250a;
    ...
    public final Guideline f2252d;
    public final Guideline e;
    public final TextView f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public final TextView f2253g;
    public final TextView h;
    public final Context i;
    public final l j;

    public j(u1 u1Var, D7.a aVar) {
        super(u1Var.f4227b);
        this.f2250a = aVar;
        this.f2251b = true;
        ...
        this.f2252d = u1Var.f4228d;
        this.e = u1Var.c;
        this.f = u1Var.e;
        this.f2253g = u1Var.f4229g;
        this.h = u1Var.f;
    ...
    public final void c() {
        ...
        this.f2252d.setGuidelineBegin(dimensionPixelSize);
