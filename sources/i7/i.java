...
public final class i extends RecyclerView.ViewHolder implements H7.b {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final D7.h f2244a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final ConstraintLayout f2245b;
    public final Guideline c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final Guideline f2246d;
    ...
    public final Context f2248k;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public final J5.c f2249l;

    public i(s1 s1Var, D7.h hVar) {
        super(s1Var.f4206b);
        this.f2244a = hVar;
        ...
        this.f2245b = constraintLayoutContainer;
        this.c = s1Var.e;
        this.f2246d = s1Var.f4207d;
        this.e = s1Var.f;
        this.f = s1Var.f4209k;
        this.f2247g = s1Var.h;
        this.h = s1Var.f4208g;
    ...
    public final Locale a() {
        Locale locale = this.f2248k.getResources().getConfiguration().locale;
    ...
    public final void b(String str) {
        this.f2247g.setText(str);
    }

    @Override // H7.b
    public final void c() {
        int dimensionPixelSize = this.f2248k.getResources().getDimensionPixelSize(R.dimen.maya_margin_normal);
        this.c.setGuidelineBegin(dimensionPixelSize);
        this.f2246d.setGuidelineEnd(dimensionPixelSize);
    }
    ...
    @Override // H7.b
    public final void e() {
        int dimensionPixelSize = this.f2248k.getResources().getDimensionPixelSize(R.dimen.maya_margin_large);
        this.c.setGuidelineBegin(dimensionPixelSize);
        this.f2246d.setGuidelineEnd(dimensionPixelSize);
    }
    ...
    public final String j() {
        String string = this.f2248k.getString(R.string.pma_label_peso);
    ...
    @Override // H7.b
    public final void n() {
        TextViewCompat.setTextAppearance(this.h, R.style.JekoBoldTextBody_Accent);
    }
    ...
    @Override // H7.b
    public final void q() {
        TextViewCompat.setTextAppearance(this.h, R.style.JekoBoldTextBody_Primary);
    }
    ...
    public final String t() {
        String string = this.f2248k.getString(R.string.maya_label_masked_amount);
        kotlin.jvm.internal.j.f(string, "getString(...)");
        return string;
    }
    ...
    @Override // H7.b
    public final void w() {
        TextViewCompat.setTextAppearance(this.h, R.style.JekoBoldTextBody_Quaternary);
    }
