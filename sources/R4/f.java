...
public final class f extends AbstractC1616j implements Function2 {
    ...
    public final /* synthetic */ PayMayaApplication f5464b;
    public final /* synthetic */ k c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public f(PayMayaApplication payMayaApplication, Function2 function2, InterfaceC1526a interfaceC1526a) {
        super(2, interfaceC1526a);
        this.f5464b = payMayaApplication;
        this.c = (k) function2;
    }
    ...
    public final InterfaceC1526a create(Object obj, InterfaceC1526a interfaceC1526a) {
        return new f(this.f5464b, this.c, interfaceC1526a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.f5463a = 1;
            if (j.f5471a.b(this.f5464b, 10, this.c, this) == enumC1578a) {
                return enumC1578a;
            }
        } else {
            if (i != 1) {
