...
public final class e extends AbstractC1616j implements Function2 {
    ...
    public final /* synthetic */ PayMayaApplication f5462b;
    public final /* synthetic */ k c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public e(PayMayaApplication payMayaApplication, Function2 function2, InterfaceC1526a interfaceC1526a) {
        super(2, interfaceC1526a);
        this.f5462b = payMayaApplication;
        this.c = (k) function2;
    }
    ...
    public final InterfaceC1526a create(Object obj, InterfaceC1526a interfaceC1526a) {
        return new e(this.f5462b, this.c, interfaceC1526a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            j jVar = j.f5471a;
            this.f5461a = 1;
            if (jVar.b(this.f5462b, 10, this.c, this) == enumC1578a) {
                return enumC1578a;
            }
        } else {
            if (i != 1) {
