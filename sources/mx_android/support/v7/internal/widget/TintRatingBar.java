...
public class TintRatingBar extends RatingBar {
    ...
    public TintRatingBar(Context context, AttributeSet attributeSet, int i) {
        ...
        Drawable drawable2 = tintTypedArrayObtainStyledAttributes.getDrawable(1);
        if (drawable2 != null) {
    ...
    private Drawable tileify(Drawable drawable, boolean z4) {
        if (drawable instanceof DrawableWrapper) {
            ...
            if (wrappedDrawable != null) {
                drawableWrapper.setWrappedDrawable(tileify(wrappedDrawable, z4));
            }
        } else {
    ...
    protected synchronized void onMeasure(int i, int i4) {
