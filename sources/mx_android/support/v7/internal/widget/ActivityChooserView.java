...
import mx_android.support.v7.internal.widget.ActivityChooserModel;
...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mModelDataSetOberver = new DataSetObserver() { // from class: mx_android.support.v7.internal.widget.ActivityChooserView.1
        ...
        this.mOnGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: mx_android.support.v7.internal.widget.ActivityChooserView.2
        ...
        frameLayout2.setOnTouchListener(new ListPopupWindow.ForwardingListener(frameLayout2) { // from class: mx_android.support.v7.internal.widget.ActivityChooserView.3
        ...
        activityChooserViewAdapter.registerDataSetObserver(new DataSetObserver() { // from class: mx_android.support.v7.internal.widget.ActivityChooserView.4
            @Override // android.database.DataSetObserver
            public void onChanged() {
                super.onChanged();
    ...
    @Override // mx_android.support.v7.internal.widget.ActivityChooserModel.ActivityChooserModelClient
    ...
    protected void onMeasure(int i, int i4) {
        ...
        measureChild(linearLayoutCompat, i, i4);
        setMeasuredDimension(linearLayoutCompat.getMeasuredWidth(), linearLayoutCompat.getMeasuredHeight());
    }

    @Override // android.view.ViewGroup, android.view.View
    protected void onLayout(boolean z4, int i, int i4, int i6, int i10) {
        this.mActivityChooserContent.layout(0, 0, i6 - i, i10 - i4);
        if (isShowingPopup()) {
            return;
        }
        dismissPopup();
