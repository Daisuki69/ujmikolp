...
class DrawableWrapper extends Drawable implements Drawable.Callback {
    ...
    public void setBounds(int i, int i4, int i6, int i10) {
        super.setBounds(i, i4, i6, i10);
        this.mDrawable.setBounds(i, i4, i6, i10);
    }
    ...
    public void setHotspot(float f, float f3) {
        DrawableCompat.setHotspot(this.mDrawable, f, f3);
    }

    @Override // android.graphics.drawable.Drawable
    public void setHotspotBounds(int i, int i4, int i6, int i10) {
        DrawableCompat.setHotspotBounds(this.mDrawable, i, i4, i6, i10);
    }
