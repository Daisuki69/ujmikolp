...
final class MediaRouterJellybean {
    ...
    public static Object createRouteCategory(Object obj, String str, boolean z4) {
        return ((android.media.MediaRouter) obj).createRouteCategory(str, z4);
    }
            ...
            if ((routeInfo.getSupportedTypes() & 8388608) == 0) {
                ...
                if (method != null) {
                    try {
                        ...
                        Log.w(MediaRouterJellybean.TAG, "Cannot programmatically select non-user route.  Media routing may not work.", e7);
                    }
                } else {
    ...
    static class VolumeCallbackProxy<T extends VolumeCallback> extends MediaRouter.VolumeCallback {
        ...
        public VolumeCallbackProxy(T t5) {
            this.mCallback = t5;
        }
