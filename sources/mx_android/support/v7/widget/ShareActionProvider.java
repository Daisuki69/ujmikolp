...
import mx_android.support.v7.internal.widget.ActivityChooserView;
...
public class ShareActionProvider extends ActionProvider {
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (iMin < activityCount) {
            ...
            for (int i4 = 0; i4 < activityCount; i4++) {
                ...
                subMenuAddSubMenu.add(0, i4, i4, activity2.loadLabel(packageManager)).setIcon(activity2.loadIcon(packageManager)).setOnMenuItemClickListener(this.mOnMenuItemClickListener);
            }
        }
    }
    ...
    private class ShareActivityChooserModelPolicy implements ActivityChooserModel.OnChooseActivityListener {
        ...
        @Override // mx_android.support.v7.internal.widget.ActivityChooserModel.OnChooseActivityListener
