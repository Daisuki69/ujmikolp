...
class TextToSpeechICSMR1 {
    ...
    static void setUtteranceProgressListener(TextToSpeech textToSpeech, final UtteranceProgressListenerICSMR1 utteranceProgressListenerICSMR1) {
        if (Build.VERSION.SDK_INT >= 15) {
            textToSpeech.setOnUtteranceProgressListener(new UtteranceProgressListener() { // from class: mx_android.support.v4.speech.tts.TextToSpeechICSMR1.1
            ...
            textToSpeech.setOnUtteranceCompletedListener(new TextToSpeech.OnUtteranceCompletedListener() { // from class: mx_android.support.v4.speech.tts.TextToSpeechICSMR1.2
