...
class AccessibilityNodeInfoCompatIcs {
    ...
    public static void setCheckable(Object obj, boolean z4) {
        ((AccessibilityNodeInfo) obj).setCheckable(z4);
    }

    public static void setChecked(Object obj, boolean z4) {
        ((AccessibilityNodeInfo) obj).setChecked(z4);
    }
    ...
    public static void setClickable(Object obj, boolean z4) {
        ((AccessibilityNodeInfo) obj).setClickable(z4);
    }
    ...
    public static void setEnabled(Object obj, boolean z4) {
        ((AccessibilityNodeInfo) obj).setEnabled(z4);
    }

    public static void setFocusable(Object obj, boolean z4) {
        ((AccessibilityNodeInfo) obj).setFocusable(z4);
    }

    public static void setFocused(Object obj, boolean z4) {
        ((AccessibilityNodeInfo) obj).setFocused(z4);
    }

    public static void setLongClickable(Object obj, boolean z4) {
        ((AccessibilityNodeInfo) obj).setLongClickable(z4);
    }
    ...
    public static void setPassword(Object obj, boolean z4) {
        ((AccessibilityNodeInfo) obj).setPassword(z4);
    }

    public static void setScrollable(Object obj, boolean z4) {
        ((AccessibilityNodeInfo) obj).setScrollable(z4);
    }

    public static void setSelected(Object obj, boolean z4) {
        ((AccessibilityNodeInfo) obj).setSelected(z4);
    }
