...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attributeSet) {
        ...
        this.mPrevText.setOnClickListener(new View.OnClickListener() { // from class: mx_android.support.v4.view.PagerTabStrip.1
        ...
        this.mNextText.setOnClickListener(new View.OnClickListener() { // from class: mx_android.support.v4.view.PagerTabStrip.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                PagerTabStrip.this.mPager.setCurrentItem(PagerTabStrip.this.mPager.getCurrentItem() + 1);
            }
    ...
    @Override // mx_android.support.v4.view.PagerTitleStrip
    public void setTextSpacing(int i) {
        int i4 = this.mMinTextSpacing;
        if (i < i4) {
            i = i4;
        }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (action == 2 && (Math.abs(x6 - this.mInitialMotionX) > this.mTouchSlop || Math.abs(y7 - this.mInitialMotionY) > this.mTouchSlop)) {
    ...
    void updateTextPositions(int i, float f, boolean z4) {
        ...
        super.updateTextPositions(i, f, z4);
