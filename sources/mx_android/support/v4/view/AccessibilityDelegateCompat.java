...
import mx_android.support.v4.view.AccessibilityDelegateCompatIcs;
import mx_android.support.v4.view.AccessibilityDelegateCompatJellyBean;
...
public class AccessibilityDelegateCompat {
    ...
    static class AccessibilityDelegateStubImpl implements AccessibilityDelegateImpl {
        @Override // mx_android.support.v4.view.AccessibilityDelegateCompat.AccessibilityDelegateImpl
    ...
    static class AccessibilityDelegateIcsImpl extends AccessibilityDelegateStubImpl {
        ...
        @Override // mx_android.support.v4.view.AccessibilityDelegateCompat.AccessibilityDelegateStubImpl, mx_android.support.v4.view.AccessibilityDelegateCompat.AccessibilityDelegateImpl
        public Object newAccessiblityDelegateDefaultImpl() {
        ...
        public Object newAccessiblityDelegateBridge(final AccessibilityDelegateCompat accessibilityDelegateCompat) {
            return AccessibilityDelegateCompatIcs.newAccessibilityDelegateBridge(new AccessibilityDelegateCompatIcs.AccessibilityDelegateBridge() { // from class: mx_android.support.v4.view.AccessibilityDelegateCompat.AccessibilityDelegateIcsImpl.1
                @Override // mx_android.support.v4.view.AccessibilityDelegateCompatIcs.AccessibilityDelegateBridge
    ...
    static class AccessibilityDelegateJellyBeanImpl extends AccessibilityDelegateIcsImpl {
        ...
        @Override // mx_android.support.v4.view.AccessibilityDelegateCompat.AccessibilityDelegateIcsImpl, mx_android.support.v4.view.AccessibilityDelegateCompat.AccessibilityDelegateStubImpl, mx_android.support.v4.view.AccessibilityDelegateCompat.AccessibilityDelegateImpl
        public Object newAccessiblityDelegateBridge(final AccessibilityDelegateCompat accessibilityDelegateCompat) {
            return AccessibilityDelegateCompatJellyBean.newAccessibilityDelegateBridge(new AccessibilityDelegateCompatJellyBean.AccessibilityDelegateBridgeJellyBean() { // from class: mx_android.support.v4.view.AccessibilityDelegateCompat.AccessibilityDelegateJellyBeanImpl.1
                @Override // mx_android.support.v4.view.AccessibilityDelegateCompatJellyBean.AccessibilityDelegateBridgeJellyBean
                public boolean dispatchPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
                    return accessibilityDelegateCompat.dispatchPopulateAccessibilityEvent(view, accessibilityEvent);
                }
