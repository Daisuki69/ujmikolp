...
import mx_android.support.v4.view.MenuItemCompatIcs;
...
public class MenuItemCompat {
    ...
    static class BaseMenuVersionImpl implements MenuVersionImpl {
        @Override // mx_android.support.v4.view.MenuItemCompat.MenuVersionImpl
    ...
    static class IcsMenuVersionImpl extends HoneycombMenuVersionImpl {
        ...
        @Override // mx_android.support.v4.view.MenuItemCompat.HoneycombMenuVersionImpl, mx_android.support.v4.view.MenuItemCompat.MenuVersionImpl
        public boolean expandActionView(MenuItem menuItem) {
        ...
        public MenuItem setOnActionExpandListener(MenuItem menuItem, final OnActionExpandListener onActionExpandListener) {
            ...
            return MenuItemCompatIcs.setOnActionExpandListener(menuItem, new MenuItemCompatIcs.SupportActionExpandProxy() { // from class: mx_android.support.v4.view.MenuItemCompat.IcsMenuVersionImpl.1
                @Override // mx_android.support.v4.view.MenuItemCompatIcs.SupportActionExpandProxy
