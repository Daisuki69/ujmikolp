...
public class TransportMediator extends TransportController {
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer transportPerformer) {
        ...
        TransportMediatorCallback transportMediatorCallback = new TransportMediatorCallback() { // from class: mx_android.support.v4.media.TransportMediator.1
            @Override // mx_android.support.v4.media.TransportMediatorCallback
        ...
        this.mTransportKeyCallback = transportMediatorCallback;
        this.mKeyEventCallback = new KeyEvent.Callback() { // from class: mx_android.support.v4.media.TransportMediator.2
            ...
            @Override // android.view.KeyEvent.Callback
            public boolean onKeyMultiple(int i, int i4, KeyEvent keyEvent) {
                return false;
            }
        ...
        this.mView = view;
        this.mDispatcherState = KeyEventCompat.getKeyDispatcherState(view);
        if (Build.VERSION.SDK_INT >= 18) {
            this.mController = new TransportMediatorJellybeanMR2(context, audioManager, view, transportMediatorCallback);
        } else {
    ...
    @Override // mx_android.support.v4.media.TransportController
