...
import mx_android.support.v4.media.routing.MediaRouterJellybean;
        ...
        public void run() {
            if (this.mActivelyScanningWifiDisplays) {
                try {
                    ...
                    Log.w(MediaRouterJellybeanMr1.TAG, "Cannot scan for wifi displays.", e7);
                }
                this.mHandler.postDelayed(this, C.DEFAULT_SEEK_FORWARD_INCREMENT_MS);
            }
        }
    }
