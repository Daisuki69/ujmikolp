...
class MediaControllerCompatApi21 {
    ...
    public static void setVolumeTo(Object obj, int i, int i4) {
        ((MediaController) obj).setVolumeTo(i, i4);
    }

    public static void adjustVolume(Object obj, int i, int i4) {
        ((MediaController) obj).adjustVolume(i, i4);
    }
