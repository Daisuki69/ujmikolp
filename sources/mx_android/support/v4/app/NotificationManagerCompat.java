...
import mx_android.support.v4.app.INotificationSideChannel;

/* JADX INFO: loaded from: classes7.dex */
public class NotificationManagerCompat {
    public static final String ACTION_BIND_SIDE_CHANNEL = "mx_android.support.BIND_NOTIFICATION_SIDE_CHANNEL";
    public static final String EXTRA_USE_SIDE_CHANNEL = "mx_android.support.useSideChannel";
    ...
    static class ImplBase implements Impl {
        @Override // mx_android.support.v4.app.NotificationManagerCompat.Impl
    ...
    static class ImplEclair extends ImplBase {
        ...
        @Override // mx_android.support.v4.app.NotificationManagerCompat.ImplBase, mx_android.support.v4.app.NotificationManagerCompat.Impl
        public void cancelNotification(NotificationManager notificationManager, String str, int i) {
    ...
    public static Set<String> getEnabledListenerPackages(Context context) {
        ...
        if (string != null && !string.equals(sEnabledNotificationListeners)) {
            String[] strArrSplit = string.split(Global.COLON);
    ...
    private static class NotifyTask implements Task {
        ...
        @Override // mx_android.support.v4.app.NotificationManagerCompat.Task
