...
public abstract class FragmentTransaction {
    ...
    public abstract FragmentTransaction setCustomAnimations(int i, int i4);

    public abstract FragmentTransaction setCustomAnimations(int i, int i4, int i6, int i10);
