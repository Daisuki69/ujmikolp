...
final class FragmentState implements Parcelable {
    public static final Parcelable.Creator<FragmentState> CREATOR = new Parcelable.Creator<FragmentState>() { // from class: mx_android.support.v4.app.FragmentState.1
    ...
    public Fragment instantiate(FragmentActivity fragmentActivity, Fragment fragment) {
        ...
        if (FragmentManagerImpl.DEBUG) {
            Log.v(androidx.fragment.app.FragmentManager.TAG, "Instantiated fragment " + this.mInstance);
        }
