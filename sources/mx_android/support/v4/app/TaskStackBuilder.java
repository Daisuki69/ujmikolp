...
public class TaskStackBuilder implements Iterable<Intent> {
    ...
    interface TaskStackBuilderImpl {
        PendingIntent getPendingIntent(Context context, Intent[] intentArr, int i, int i4, Bundle bundle);
    }
    ...
    static class TaskStackBuilderImplBase implements TaskStackBuilderImpl {
        ...
        @Override // mx_android.support.v4.app.TaskStackBuilder.TaskStackBuilderImpl
        public PendingIntent getPendingIntent(Context context, Intent[] intentArr, int i, int i4, Bundle bundle) {
            Intent intent = new Intent(intentArr[intentArr.length - 1]);
            intent.addFlags(268435456);
            return PendingIntent.getActivity(context, i, intent, i4);
        }
    }
    ...
    static class TaskStackBuilderImplHoneycomb implements TaskStackBuilderImpl {
        ...
        public PendingIntent getPendingIntent(Context context, Intent[] intentArr, int i, int i4, Bundle bundle) {
            ...
            return TaskStackBuilderHoneycomb.getActivitiesPendingIntent(context, i, intentArr, i4);
        }
    }
    ...
    static class TaskStackBuilderImplJellybean implements TaskStackBuilderImpl {
        ...
        public PendingIntent getPendingIntent(Context context, Intent[] intentArr, int i, int i4, Bundle bundle) {
            intentArr[0] = new Intent(intentArr[0]).addFlags(268484608);
            return TaskStackBuilderJellybean.getActivitiesPendingIntent(context, i, intentArr, i4, bundle);
        }
    }
    ...
    public PendingIntent getPendingIntent(int i, int i4) {
        return getPendingIntent(i, i4, null);
    }

    public PendingIntent getPendingIntent(int i, int i4, Bundle bundle) {
        if (this.mIntents.isEmpty()) {
        ...
        Intent[] intentArr = (Intent[]) arrayList.toArray(new Intent[arrayList.size()]);
        intentArr[0] = new Intent(intentArr[0]).addFlags(268484608);
        return IMPL.getPendingIntent(this.mSourceContext, intentArr, i, i4, bundle);
    }
