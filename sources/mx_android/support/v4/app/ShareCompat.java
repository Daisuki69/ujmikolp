...
public class ShareCompat {
    public static final String EXTRA_CALLING_ACTIVITY = "mx_android.support.v4.app.EXTRA_CALLING_ACTIVITY";
    public static final String EXTRA_CALLING_PACKAGE = "mx_android.support.v4.app.EXTRA_CALLING_PACKAGE";
    ...
    static class ShareCompatImplBase implements ShareCompatImpl {
        ...
        @Override // mx_android.support.v4.app.ShareCompat.ShareCompatImpl
        ...
        private static void withinStyle(StringBuilder sb2, CharSequence charSequence, int i, int i4) {
            while (i < i4) {
                ...
                if (cCharAt == '<') {
                    ...
                    sb2.append("&#" + ((int) cCharAt) + Global.SEMICOLON);
                } else if (cCharAt == ' ') {
                    while (true) {
                        int i6 = i + 1;
                        if (i6 >= i4 || charSequence.charAt(i6) != ' ') {
                            break;
                        }
                        sb2.append("&nbsp;");
                        i = i6;
    ...
    static class ShareCompatImplICS extends ShareCompatImplBase {
        ...
        @Override // mx_android.support.v4.app.ShareCompat.ShareCompatImplBase, mx_android.support.v4.app.ShareCompat.ShareCompatImpl
        public void configureMenuItem(MenuItem menuItem, IntentBuilder intentBuilder) {
    ...
    static class ShareCompatImplJB extends ShareCompatImplICS {
        @Override // mx_android.support.v4.app.ShareCompat.ShareCompatImplICS
        boolean shouldAddChooserIntent(MenuItem menuItem) {
            return false;
        }
    ...
    public static class IntentBuilder {
        ...
        public Intent getIntent() {
            ...
            boolean z4 = arrayList4 != null && arrayList4.size() > 1;
