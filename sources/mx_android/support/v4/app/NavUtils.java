...
import mx_android.support.v4.content.IntentCompat;

/* JADX INFO: loaded from: classes7.dex */
public class NavUtils {
    private static final NavUtilsImpl IMPL;
    public static final String PARENT_ACTIVITY = "mx_android.support.PARENT_ACTIVITY";
    ...
    static class NavUtilsImplBase implements NavUtilsImpl {
        ...
        @Override // mx_android.support.v4.app.NavUtils.NavUtilsImpl
    ...
    static class NavUtilsImplJB extends NavUtilsImplBase {
        ...
        @Override // mx_android.support.v4.app.NavUtils.NavUtilsImplBase, mx_android.support.v4.app.NavUtils.NavUtilsImpl
        public Intent getParentActivityIntent(Activity activity) {
    ...
    public static void navigateUpFromSameTask(Activity activity) {
        ...
        if (parentActivityIntent == null) {
            throw new IllegalArgumentException("Activity " + activity.getClass().getSimpleName() + " does not have a parent activity name specified. (Did you forget to add the mx_android.support.PARENT_ACTIVITY <meta-data>  element in your manifest?)");
        }
