...
import mx_android.support.v4.app.LoaderManager;
import mx_android.support.v4.content.Loader;
import mx_android.support.v4.util.DebugUtils;
import mx_android.support.v4.util.SparseArrayCompat;
...
class LoaderManagerImpl extends LoaderManager {
    ...
    final class LoaderInfo implements Loader.OnLoadCompleteListener<Object> {
        ...
        void finishRetain() {
            if (this.mRetaining) {
                ...
                if (z4 != this.mRetainingStarted && !z4) {
                    stop();
                }
            }
        ...
        void destroy() {
            ...
            boolean z4 = this.mDeliveredData;
            this.mDeliveredData = false;
            if (this.mCallbacks != null && this.mLoader != null && this.mHaveData && z4) {
                if (LoaderManagerImpl.DEBUG) {
        ...
        @Override // mx_android.support.v4.content.Loader.OnLoadCompleteListener
    ...
    LoaderManagerImpl(String str, FragmentActivity fragmentActivity, boolean z4) {
        this.mWho = str;
    ...
    @Override // mx_android.support.v4.app.LoaderManager
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (this.mInactiveLoaders.size() > 0) {
            ...
            String str3 = str + "    ";
            for (int i4 = 0; i4 < this.mInactiveLoaders.size(); i4++) {
                LoaderInfo loaderInfoValueAt2 = this.mInactiveLoaders.valueAt(i4);
                printWriter.print(str);
                printWriter.print("  #");
    ...
    public boolean hasRunningLoaders() {
        ...
        for (int i = 0; i < size; i++) {
            LoaderInfo loaderInfoValueAt = this.mLoaders.valueAt(i);
            z4 |= loaderInfoValueAt.mStarted && !loaderInfoValueAt.mDeliveredData;
        }
        return z4;
    }
}
