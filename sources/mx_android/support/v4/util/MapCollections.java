...
abstract class MapCollections<K, V> {
    ...
    protected abstract Object colGetEntry(int i, int i4);
    ...
    protected abstract void colPut(K k8, V v7);

    protected abstract void colRemoveAt(int i);

    protected abstract V colSetValue(int i, V v7);
    ...
    final class MapIterator implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public V setValue(V v7) {
            ...
            return (V) MapCollections.this.colSetValue(this.mIndex, v7);
        }
    ...
    public Object[] toArrayHelper(int i) {
        ...
        for (int i4 = 0; i4 < iColGetSize; i4++) {
            objArr[i4] = colGetEntry(i4, i);
        }
        return objArr;
    }
