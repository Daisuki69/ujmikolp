...
public class LruCache<K, V> {
    ...
    protected void entryRemoved(boolean z4, K k8, V v7, V v8) {
    }
    ...
    public final V get(K k8) {
        ...
        synchronized (this) {
            ...
            synchronized (this) {
                this.createCount++;
                vPut = this.map.put(k8, vCreate);
                if (vPut != null) {
                    this.map.put(k8, vPut);
                } else {
                    this.size += safeSizeOf(k8, vCreate);
                }
            }
            if (vPut != null) {
                entryRemoved(false, k8, vCreate, vPut);
                return vPut;
            }
    ...
    public final V put(K k8, V v7) {
        ...
        synchronized (this) {
            ...
            vPut = this.map.put(k8, v7);
            if (vPut != null) {
                this.size -= safeSizeOf(k8, vPut);
            }
        }
        if (vPut != null) {
            entryRemoved(false, k8, vPut, v7);
        }
        trimToSize(this.maxSize);
        return vPut;
    }
    ...
    */
    public void trimToSize(int r5) {
        ...
        L75:
            goto L74
        */
        throw new UnsupportedOperationException("Method not decompiled: mx_android.support.v4.util.LruCache.trimToSize(int):void");
    }
    ...
    public final V remove(K k8) {
        ...
        synchronized (this) {
            vRemove = this.map.remove(k8);
            if (vRemove != null) {
                this.size -= safeSizeOf(k8, vRemove);
            }
        }
        if (vRemove != null) {
            entryRemoved(false, k8, vRemove, null);
        }
        return vRemove;
    }
    ...
    public final synchronized String toString() {
        ...
        i = this.hitCount;
        i4 = this.missCount + i;
        return String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(i4 != 0 ? (i * 100) / i4 : 0));
    }
}
