package mx_android.support.v4.graphics;
...
public class BitmapCompat {
    ...
    interface BitmapImpl {
        ...
        void setHasMipMap(Bitmap bitmap, boolean z4);
    }

    static class BaseBitmapImpl implements BitmapImpl {
        @Override // mx_android.support.v4.graphics.BitmapCompat.BitmapImpl
        public boolean hasMipMap(Bitmap bitmap) {
            return false;
        }

        @Override // mx_android.support.v4.graphics.BitmapCompat.BitmapImpl
        public void setHasMipMap(Bitmap bitmap, boolean z4) {
        }
    ...
    static class HcMr1BitmapCompatImpl extends BaseBitmapImpl {
        ...
        @Override // mx_android.support.v4.graphics.BitmapCompat.BaseBitmapImpl, mx_android.support.v4.graphics.BitmapCompat.BitmapImpl
        public int getAllocationByteCount(Bitmap bitmap) {
    ...
    static class JbMr2BitmapCompatImpl extends HcMr1BitmapCompatImpl {
        ...
        @Override // mx_android.support.v4.graphics.BitmapCompat.BaseBitmapImpl, mx_android.support.v4.graphics.BitmapCompat.BitmapImpl
        public void setHasMipMap(Bitmap bitmap, boolean z4) {
            BitmapCompatJellybeanMR2.setHasMipMap(bitmap, z4);
        }
    }
    ...
    static class KitKatBitmapCompatImpl extends JbMr2BitmapCompatImpl {
        ...
        @Override // mx_android.support.v4.graphics.BitmapCompat.HcMr1BitmapCompatImpl, mx_android.support.v4.graphics.BitmapCompat.BaseBitmapImpl, mx_android.support.v4.graphics.BitmapCompat.BitmapImpl
        public int getAllocationByteCount(Bitmap bitmap) {
