...
public class FileProvider extends ContentProvider {
    ...
    private static final String META_DATA_FILE_PROVIDER_PATHS = "mx_android.support.FILE_PROVIDER_PATHS";
        ...
        synchronized (sCache) {
            ...
            if (pathStrategy == null) {
                try {
                    ...
                    throw new IllegalArgumentException("Failed to parse mx_android.support.FILE_PROVIDER_PATHS meta-data", e);
                } catch (XmlPullParserException e7) {
                    throw new IllegalArgumentException("Failed to parse mx_android.support.FILE_PROVIDER_PATHS meta-data", e7);
                }
            }
        }
        return pathStrategy;
    ...
    private static PathStrategy parsePathStrategy(Context context, String str) throws XmlPullParserException, IOException {
        ...
        if (xmlResourceParserLoadXmlMetaData == null) {
            throw new IllegalArgumentException("Missing mx_android.support.FILE_PROVIDER_PATHS meta-data");
        }
        while (true) {
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        @Override // mx_android.support.v4.content.FileProvider.PathStrategy
