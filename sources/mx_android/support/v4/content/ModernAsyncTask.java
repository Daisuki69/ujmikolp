...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static {
        ThreadFactory threadFactory = new ThreadFactory() { // from class: mx_android.support.v4.content.ModernAsyncTask.1
    ...
    public ModernAsyncTask() {
        WorkerRunnable<Params, Result> workerRunnable = new WorkerRunnable<Params, Result>() { // from class: mx_android.support.v4.content.ModernAsyncTask.2
        ...
        this.mFuture = new FutureTask<Result>(workerRunnable) { // from class: mx_android.support.v4.content.ModernAsyncTask.3
    ...
    /* JADX INFO: renamed from: mx_android.support.v4.content.ModernAsyncTask$4, reason: invalid class name */
    static /* synthetic */ class AnonymousClass4 {
        static final /* synthetic */ int[] $SwitchMap$mx_android$support$v4$content$ModernAsyncTask$Status;

        static {
            int[] iArr = new int[Status.values().length];
            $SwitchMap$mx_android$support$v4$content$ModernAsyncTask$Status = iArr;
            try {
                iArr[Status.RUNNING.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$mx_android$support$v4$content$ModernAsyncTask$Status[Status.FINISHED.ordinal()] = 2;
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        if (this.mStatus != Status.PENDING) {
            int i = AnonymousClass4.$SwitchMap$mx_android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()];
            if (i == 1) {
