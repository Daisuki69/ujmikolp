...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    public static float constrain(float f, float f3, float f7) {
        return f > f7 ? f7 : f < f3 ? f3 : f;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static int constrain(int i, int i4, int i6) {
        return i > i6 ? i6 : i < i4 ? i4 : i;
    }
    ...
    public abstract void scrollTargetBy(int i, int i4);

    public AutoScrollHelper(View view) {
        this.mTarget = view;
        DisplayMetrics displayMetrics = Resources.getSystem().getDisplayMetrics();
        int i = (int) ((displayMetrics.density * 1575.0f) + 0.5f);
        int i4 = (int) ((displayMetrics.density * 315.0f) + 0.5f);
        float f = i;
    ...
    */
    public boolean onTouch(android.view.View r6, android.view.MotionEvent r7) {
        ...
        L1e:
            ...
            mx_android.support.v4.widget.AutoScrollHelper$ClampedScroller r7 = r5.mScroller
        ...
        L61:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: mx_android.support.v4.widget.AutoScrollHelper.onTouch(android.view.View, android.view.MotionEvent):boolean");
    }
    ...
    private float computeTargetVelocity(int i, float f, float f3, float f7) {
        float edgeValue = getEdgeValue(this.mRelativeEdges[i], f3, this.mMaximumEdges[i], f);
        if (edgeValue == 0.0f) {
            return 0.0f;
        }
        float f10 = this.mRelativeVelocity[i];
        float f11 = this.mMinimumVelocity[i];
        float f12 = this.mMaximumVelocity[i];
        float f13 = f10 * f7;
        if (edgeValue > 0.0f) {
    ...
    private float getEdgeValue(float f, float f3, float f7, float f10) {
        float interpolation;
        float fConstrain = constrain(f * f3, 0.0f, f7);
        float fConstrainEdgeValue = constrainEdgeValue(f3 - f10, fConstrain) - constrainEdgeValue(f10, fConstrain);
    ...
    private static class ClampedScroller {
        ...
        private float getValueAt(long j) {
            ...
            return (1.0f - f) + (f * AutoScrollHelper.constrain((j - j6) / this.mEffectiveRampDown, 0.0f, 1.0f));
        }
