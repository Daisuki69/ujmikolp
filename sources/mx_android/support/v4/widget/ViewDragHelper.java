...
import mx_android.support.v4.view.VelocityTrackerCompat;
...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new Interpolator() { // from class: mx_android.support.v4.widget.ViewDragHelper.1
    ...
    private final Runnable mSetIdleRunnable = new Runnable() { // from class: mx_android.support.v4.widget.ViewDragHelper.2
    ...
    public boolean smoothSlideViewTo(View view, int i, int i4) {
        this.mCapturedView = view;
        this.mActivePointerId = -1;
    ...
    public boolean settleCapturedViewAt(int i, int i4) {
        ...
        return forceSettleCapturedViewAt(i, i4, (int) VelocityTrackerCompat.getXVelocity(this.mVelocityTracker, this.mActivePointerId), (int) VelocityTrackerCompat.getYVelocity(this.mVelocityTracker, this.mActivePointerId));
    }
    ...
    private int computeSettleDuration(View view, int i, int i4, int i6, int i10) {
        ...
        return (int) ((computeAxisDuration(i, iClampMag, this.mCallback.getViewHorizontalDragRange(view)) * f11) + (computeAxisDuration(i4, iClampMag2, this.mCallback.getViewVerticalDragRange(view)) * (f7 / f10)));
    }
    ...
    private int computeAxisDuration(int i, int i4, int i6) {
        ...
        if (iAbs2 > 0) {
            ...
            iAbs = (int) (((Math.abs(i) / i6) + 1.0f) * 256.0f);
        }
    ...
    public void flingCapturedView(int i, int i4, int i6, int i10) {
        ...
        this.mScroller.fling(this.mCapturedView.getLeft(), this.mCapturedView.getTop(), (int) VelocityTrackerCompat.getXVelocity(this.mVelocityTracker, this.mActivePointerId), (int) VelocityTrackerCompat.getYVelocity(this.mVelocityTracker, this.mActivePointerId), i, i6, i4, i10);
        setDragState(2);
    }
    ...
    private void saveLastMotion(MotionEvent motionEvent) {
        ...
        for (int i = 0; i < pointerCount; i++) {
            ...
            float x6 = MotionEventCompat.getX(motionEvent, i);
            float y7 = MotionEventCompat.getY(motionEvent, i);
    ...
    protected boolean canScroll(View view, boolean z4, int i, int i4, int i6, int i10) {
        int i11;
        ...
        return z4 && (ViewCompat.canScrollHorizontally(view, -i) || ViewCompat.canScrollVertically(view, -i4));
    }
    ...
    */
    public boolean shouldInterceptTouchEvent(android.view.MotionEvent r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: mx_android.support.v4.widget.ViewDragHelper.shouldInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void processTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 2) {
            ...
            while (i4 < pointerCount) {
                ...
                float x10 = MotionEventCompat.getX(motionEvent, i4);
                float y11 = MotionEventCompat.getY(motionEvent, i4);
        ...
        if (this.mDragState == 1 && pointerId4 == this.mActivePointerId) {
            ...
            while (true) {
                ...
                if (pointerId5 != this.mActivePointerId) {
                    View viewFindTopChildUnder3 = findTopChildUnder((int) MotionEventCompat.getX(motionEvent, i4), (int) MotionEventCompat.getY(motionEvent, i4));
    ...
    /* JADX WARN: Type inference failed for: r3v3, types: [mx_android.support.v4.widget.ViewDragHelper$Callback] */
    ...
    private boolean checkNewEdgeDrag(float f, float f3, int i, int i4) {
        ...
        if (fAbs >= fAbs2 * 0.5f || !this.mCallback.onEdgeLock(i4)) {
            return (this.mEdgeDragsInProgress[i] & i4) == 0 && fAbs > ((float) this.mTouchSlop);
        }
    ...
    private void dragTo(int i, int i4, int i6, int i10) {
        ...
        if (i10 != 0) {
            ...
            this.mCapturedView.offsetTopAndBottom(i4 - top);
        }
        int i12 = i4;
        if (i6 == 0 && i10 == 0) {
            return;
    ...
    public boolean isViewUnder(View view, int i, int i4) {
