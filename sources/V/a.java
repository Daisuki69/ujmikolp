...
public final class a implements e {
    ...
    public final n0.a f6011a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final S f6012b;

    public a(n0.a aVar, S s9) {
    ...
    */
    public final java.lang.Object a(java.lang.String r6, a.AbstractC0617a r7) throws java.io.IOException {
        ...
        Lb0:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: V.a.a(java.lang.String, a.a):java.lang.Object");
    }

    @Override // V.e
    public final Pair b(String str) {
        j.g(str, numX49.tnTj78("bPCN"));
        if (this.f6012b != null) {
            S.s(numX49.tnTj78("bPCX"), numX49.tnTj78("bPC6") + str + numX49.tnTj78("bPCa"));
        }
        return (Pair) this.f6011a.c.d().o(str);
    }

    @Override // V.e
    public final boolean c(String str) {
        j.g(str, numX49.tnTj78("bPCG"));
        if (this.f6012b != null) {
            S.s(numX49.tnTj78("bPCv"), numX49.tnTj78("bPC3") + str + numX49.tnTj78("bPCy"));
        }
        return this.f6011a.c.a().m(str);
    }

    @Override // V.e
    public final File d(String str, byte[] bArr) {
        j.g(str, numX49.tnTj78("bPC7"));
        j.g(bArr, numX49.tnTj78("bPCA"));
        return this.f6011a.c.a().a(str, bArr);
    }

    @Override // V.e
    public final boolean e(String str, Pair pair) {
        j.g(str, numX49.tnTj78("bPCY"));
        if (this.f6012b != null) {
            S.s(numX49.tnTj78("bPCp"), numX49.tnTj78("bPCT") + str + numX49.tnTj78("bPCR"));
        }
        return this.f6011a.c.d().c(str, pair);
    }

    @Override // V.e
    public final Object f(String str, AbstractC0617a abstractC0617a) {
        j.g(str, numX49.tnTj78("bPC0"));
        p pVar = (p) this.f6011a.c.d().c;
        pVar.getClass();
        ...
        if (this.f6012b != null) {
            S.s(numX49.tnTj78("bPCf"), str.concat(numX49.tnTj78("bPCg")));
        }
        boolean zEquals = abstractC0617a.equals(g.c);
        Object obj = pair.f18160a;
        if (zEquals) {
            byte[] bArr = (byte[]) obj;
            j.g(bArr, numX49.tnTj78("bPC1"));
